...
@javax.annotation.processing.Generated("com.guidewire.pl.metadata.codegen.Codegen", "", "Claim.eti;Claim.eix;Claim.etx")
enhancement GWClaimEntityEnhancement : entity.Claim {
  function applyFinancialHolds () : java.lang.Boolean {
    return (com.guidewire.pl.persistence.code.EntityInternalAccess.getImplementation(this, "gw.api.financials.FinancialHolds") as gw.api.financials.FinancialHolds).applyFinancialHolds()
  }
