...
@javax.annotation.processing.Generated("com.guidewire.pl.metadata.codegen.Codegen", "", "ClaimIndicator.eti;ClaimIndicator.eix;ClaimIndicator.etx")
enhancement GWClaimIndicatorEntityEnhancement : entity.ClaimIndicator {
  ...
  property get IconColor () : gw.api.web.color.GWColor {
    return (com.guidewire.pl.persistence.code.EntityInternalAccess.getImplementation(this, "gw.api.claim.indicator.ClaimIndicatorMethods") as gw.api.claim.indicator.ClaimIndicatorMethods).IconColor
  }
