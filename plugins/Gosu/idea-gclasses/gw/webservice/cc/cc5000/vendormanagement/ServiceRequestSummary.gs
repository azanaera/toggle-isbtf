 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc5000/vendormanagement/ServiceRequestSummary")
final class ServiceRequestSummary {
   ...
   */
  var _adjuster : gw.webservice.cc.cc5000.vendormanagement.ContactSummary as Adjuster
  ...
  construct(serviceRequest : ServiceRequest) {
    ...
    CustomerContact = new gw.webservice.cc.cc5000.vendormanagement.ContactSummary(serviceRequest.Instruction.CustomerContact)
