...
/**
 * This is the helper class for {@link gw.webservice.cc.cc5000.vendormanagement.ServiceRequestAPI}, which you should consult for documentation.
 */
@Export
internal class ServiceRequestAPIUtil {
  ...
  function getDocumentContent(specialistId: String, serviceRequestNumber: String, documentPublicId: String): gw.webservice.cc.cc5000.vendormanagement.DocumentWithContent {
    var serviceRequest = getServiceRequestEntity(specialistId, serviceRequestNumber)
  ...
  function getMessagesForSpecialist(specialistId: String): MessagesForSpecialistResults {
    ...
    var results = new ArrayList<gw.webservice.cc.cc5000.vendormanagement.Message>()
    ...
    for (message in messages) {
      ...
      results.add(new gw.webservice.cc.cc5000.vendormanagement.Message(message, true))
    }
