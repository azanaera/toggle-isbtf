...
class CheckAddressOwner extends ClaimRelatedAddressOwner implements SimpleAddressOwner {
  ...
  override property get RequiredFields() : Set<AddressOwnerFieldId> {
    return {CCAddressOwnerFieldId.CITY, CCAddressOwnerFieldId.STATE, CCAddressOwnerFieldId.ADDRESSLINE1
    ,CCAddressOwnerFieldId.COUNTRY,CCAddressOwnerFieldId.POSTALCODE}
  }
