...
class NewClaimCheck extends NewClaimCheckBase {
  ...
  property get ClaimCheckAddressOwner() : ClaimCheckAddressOwner {
    if (this.MailingAddress == null) {
      if (this.Payee != null and this.Payee.PrimaryAddress != null) {
  ...
  /**
   * @return An error message if the amount is invalid, null otherwise
   * @deprecated Split deductibles are now supported. This method now always returns null.
   */
