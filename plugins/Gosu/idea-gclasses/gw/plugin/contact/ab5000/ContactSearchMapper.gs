...
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.anonymous.types.complex.ABContactAPISearchCriteria_SpecialistServiceCodes
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.anonymous.types.complex.ABContactAPISearchCriteria_Tags
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.types.complex.ABContactAPIAddressSearch
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.types.complex.ABContactAPIProximitySearchParameters
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.types.complex.ABContactAPISearchCriteria
...
class ContactSearchMapper {
  ...
  public static function convertToABContactAPISearchCriteria(searchCriteria : ContactSearchCriteria) : ABContactAPISearchCriteria {
    ...
    searchCriteriaInfo.ContactType = ContactIntegrationMapperFactory.mapper().NameMapper.getABEntityName(searchCriteria.ContactSubtype.Code)
    ...
    searchCriteriaInfo.VendorAvailability = ScriptParameters.VendorAvailability_Ext
