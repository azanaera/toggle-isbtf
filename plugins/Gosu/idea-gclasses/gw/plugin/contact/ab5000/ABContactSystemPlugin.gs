package gw.plugin.contact.ab5000
...
uses gw.contactmapper.ab5000.ContactIntegrationMapperFactory
...
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.ABContactAPI
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.AlreadyExecutedException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.BadIdentifierException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.DataConversionException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.EntityStateException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.PermissionException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.RequiredFieldException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.SOAPException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.faults.SOAPSenderException
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.types.complex.AddressBookUIDContainer
uses wsi.remote.gw.webservice.ab.ab5000.abcontactapi.types.complex.RelatedContactInfoContainer
...
class ABContactSystemPlugin implements ContactSystemPlugin {
  ...
  private final var _pluginHelper = new gw.plugin.contact.ab5000.ContactPluginHelper()
  ...
  override function createContact(contact : Contact, transactionId:String) : ContactCreateResult {
    return handleErrors(null, contact, \->{
      ...
      var visitor = new gw.plugin.contact.ab5000.TemporaryIDContactVisitor()
        ...
        switch(eventName) {
          case CONTACT_ADDED_EVENT_NAME:
              if(ContactSystemApprovalUtil.shouldCreateInContactSystem(contact)) {
                ...
                var validationResult : wsi.remote.gw.webservice.ab.ab5000.abcontactapi.types.complex.ABContactAPIValidateCreateContactResult
                try {
  ...
  */
  ...
  override function sendAsyncUpdate(message:Message, payload:String) {
    ...
    handleErrors(null, contact, \ -> {
      ...
      if(actionType typeis CreateAction) {
        ...
        var abXML = wsi.remote.gw.webservice.ab.ab5000.beanmodel.XmlBackedInstance.parse(contactXML)
  ...
  override function updateLateBoundAddressBookUIDsForContact(contact: Contact, xml: XmlBackedInstance) : String {
    ...
    xml  = LateBoundABUIDHelper.Instance.updateABUIDsInXML(
        contact, xml, mapper.Mappings, mapper.NameMapper)
   ...
   */
  private function removeContact(xml: wsi.remote.gw.webservice.ab.ab5000.beanmodel.XmlBackedInstance, id : String) {
   ...
   */
  private function getContactFromRemote(remoteXmlInstance:wsi.remote.gw.webservice.ab.ab5000.beanmodel.XmlBackedInstance, contact : Contact, bundle : Bundle) : Contact {
    if(contact == null) {
   ...
   */
  private function retrieveReplacementContact(addressBookId : String) : wsi.remote.gw.webservice.ab.ab5000.beanmodel.XmlBackedInstance {
    // check to see if this contact has been replaced with another one
    var remoteXmlBackedInstance : wsi.remote.gw.webservice.ab.ab5000.beanmodel.XmlBackedInstance
    var newABUID : String
    var api = ContactAPI
  ...
  private function _retrieveContact(abUID:String, contact : Contact, bundle : Bundle) : Contact {
    var remoteXmlInstance : wsi.remote.gw.webservice.ab.ab5000.beanmodel.XmlBackedInstance
  ...
  private function createContactContact(addressBookUID : String, sourceContact: Contact, relatedContact : Contact, relationship: ContactRel, bundle : Bundle) : ContactContact {
    var xsdTypeName = _mapper.NameMapper.getABEntityName(ContactContact.Type.RelativeName)
