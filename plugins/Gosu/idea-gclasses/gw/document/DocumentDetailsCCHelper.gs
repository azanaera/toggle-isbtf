...
public class DocumentDetailsCCHelper extends DocumentDetailsApplicationHelper {
  ...
  /**
   * Returns the value of the 'ReceivedDate_Ext' property on all the documents.
   * If the values are not the same, null is returned.
   * @return Value for property 'ReceivedDate_Ext'.
   */
  public property get ReceivedDate_Ext() : Date { return getFields(Document.RECEIVEDDATE_EXT_PROP.get()) as Date }

  /**
   * Sets the value of the 'ReceivedDate_Ext' property on all the documents.
   *
   * @param type Value to set for property 'ReceivedDate_Ext'.
   */
  public property set ReceivedDate_Ext(date : Date) {
    setFields(Document.RECEIVEDDATE_EXT_PROP.get(), date)
  }
