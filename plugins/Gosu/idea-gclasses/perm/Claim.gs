...
class Claim {
  ...
  static property get genericassignunowned () : boolean {
  ...
  static property get genericviewpayments () : boolean {
  ...
  static property get genericviewrecoveries () : boolean {
  ...
  static property get genericviewrecoveryreserves () : boolean {
  ...
  static property get genericviewreserves () : boolean {
  ...
  static property get genericviewtransactions () : boolean {
