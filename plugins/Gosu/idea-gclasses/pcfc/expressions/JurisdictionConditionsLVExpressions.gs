...
@javax.annotation.processing.Generated("config/web/pcf/admin/workload/conditions/JurisdictionConditionsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class JurisdictionConditionsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends JurisdictionConditionsLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=Jurisdiction_Cell) at JurisdictionConditionsLV.pcf: line 29, column 45
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      jurisdiction.Jurisdiction = (__VALUE_TO_SET as typekey.Jurisdiction)
    }
    
    // 'filter' attribute on TypeKeyCell (id=Jurisdiction_Cell) at JurisdictionConditionsLV.pcf: line 29, column 45
