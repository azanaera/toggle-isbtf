...
@javax.annotation.processing.Generated("config/web/pcf/admin/wcparms/WCBenefitParameterSetPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class WCBenefitParameterSetPopupExpressions {
  ...
  public static class WCBenefitParameterSetPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function validate(wcbp : WCBenefitParameterSet) {
      ...
      var overlaps = Query.make(entity.WCBenefitParameterSet).compare(WCBenefitParameterSet#JurisdictionState, Equals, jurisdiction)
                                              .compare(WCBenefitParameterSet#ID, NotEquals, wcbp.ID)
                                              .compare(WCBenefitParameterSet#StartDate, LessThanOrEquals, endDate)
                                              .compare(WCBenefitParameterSet#EndDate, GreaterThanOrEquals, startDate).select()
