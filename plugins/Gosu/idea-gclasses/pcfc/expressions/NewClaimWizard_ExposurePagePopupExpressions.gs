...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimWizard_ExposurePagePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
    ...
    property set Wizard ($arg :  gw.api.claim.NewClaimWizardInfo) {
      setVariableValue("Wizard", 0, $arg)
          ...
          function validateAndFinish() {
            Wizard.markExposureAsManuallyModified(Exposure)
