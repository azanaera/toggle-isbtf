...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/refresh/PolicyComparisonScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PolicyComparisonScreenExpressions {
  ...
  public static class PolicyComparisonScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on TextCell (id=LabelField_Cell) at PolicyComparisonScreen.pcf: line 42, column 44
  ...
  public static class RowTreeEntryExpressionsImpl extends PolicyComparisonScreenExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=LabelField_Cell) at PolicyComparisonScreen.pcf: line 42, column 44
    function value_3 () : java.lang.String {
      return diff.Label?.elide(80)
    }
    
    // 'value' attribute on TextCell (id=OldPolicyField_Cell) at PolicyComparisonScreen.pcf: line 47, column 37
    function value_5 () : java.lang.String {
      return oldValue(diff)
    }
    
    // 'value' attribute on TextCell (id=NewPolicyField_Cell) at PolicyComparisonScreen.pcf: line 52, column 37
