...
class TeamGroupClaimsExpressions {
  ...
  public static class TeamGroupClaimsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupClaims_Print) at TeamGroupClaims.pcf: line 52, column 25
    function action_6 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupClaims_Assign) at TeamGroupClaims.pcf: line 39, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupClaims_RemoveFlag) at TeamGroupClaims.pcf: line 45, column 76
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupClaims_Print) at TeamGroupClaims.pcf: line 52, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupClaims.pcf: line 55, column 59
    ...
    // 'title' attribute on TitleBar at TeamGroupClaims.pcf: line 31, column 95
