...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/PolicySummaryVehicleLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PolicySummaryVehicleLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PolicySummaryVehicleLVExpressionsImpl {
    ...
    // 'available' attribute on CheckBoxCell (id=VehicleSelected_Cell) at PolicySummaryVehicleLV.pcf: line 32, column 37
    function available_10 () : java.lang.Boolean {
      return checkboxesAvailable
    }
    
    // 'value' attribute on CheckBoxCell (id=VehicleSelected_Cell) at PolicySummaryVehicleLV.pcf: line 32, column 37
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      vehicle.Selected = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'editable' attribute on CheckBoxCell (id=VehicleSelected_Cell) at PolicySummaryVehicleLV.pcf: line 32, column 37
    ...
    // 'value' attribute on TextCell (id=VehicleNumber_Cell) at PolicySummaryVehicleLV.pcf: line 38, column 42
    function value_19 () : java.lang.Integer {
      return vehicle.VehicleNumber
    }
    
    // 'value' attribute on TextCell (id=Vin_Cell) at PolicySummaryVehicleLV.pcf: line 42, column 32
    function value_22 () : java.lang.String {
      return vehicle.Vin
    }
    
    // 'value' attribute on TextCell (id=Make_Cell) at PolicySummaryVehicleLV.pcf: line 46, column 33
    function value_25 () : java.lang.String {
      return vehicle.Make
    }
    
    // 'value' attribute on TextCell (id=Model_Cell) at PolicySummaryVehicleLV.pcf: line 50, column 34
    function value_28 () : java.lang.String {
      return vehicle.Model
    }
    
    // 'value' attribute on TextCell (id=Color_Cell) at PolicySummaryVehicleLV.pcf: line 54, column 34
    function value_31 () : java.lang.String {
      return vehicle.Color
    }
    
    // 'value' attribute on TextCell (id=LicencePlate_Cell) at PolicySummaryVehicleLV.pcf: line 58, column 41
    function value_34 () : java.lang.String {
      return vehicle.LicensePlate
    }
    
    // 'value' attribute on TypeKeyCell (id=State_Cell) at PolicySummaryVehicleLV.pcf: line 63, column 45
  ...
  public static class PolicySummaryVehicleLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on CheckBoxCell (id=VehicleSelected_Cell) at PolicySummaryVehicleLV.pcf: line 32, column 37
    function sortValue_0 (vehicle :  entity.PolicySummaryVehicle) : java.lang.Object {
      return vehicle.Selected
    }
    ...
    // 'visible' attribute on CheckBoxCell (id=VehicleSelected_Cell) at PolicySummaryVehicleLV.pcf: line 32, column 37
