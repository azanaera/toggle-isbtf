...
class NewCheckNoAbilityToPayExpressions {
  ...
  public static class NewCheckNoAbilityToPayExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextInput (id=CreatePayment_Input) at NewCheckNoAbilityToPay.pcf: line 29, column 107
    ...
    // 'value' attribute on TextInput (id=CreatePayment_Input) at NewCheckNoAbilityToPay.pcf: line 29, column 107
