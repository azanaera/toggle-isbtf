...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/AddressBookContactDetailScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookContactDetailScreen_defaultExpressions {
  ...
  public static class AddressBookContactDetailScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=ShowActivitiesButton_Input) at AddressBookContactDetailScreen.default.pcf: line 124, column 116
    function action_30 () : void {
      helper.revealContent(ACTIVITIES)
    }
    
    // 'action' attribute on ButtonInput (id=ShowClaimsButton_Input) at AddressBookContactDetailScreen.default.pcf: line 154, column 113
    function action_38 () : void {
      helper.revealContent(CLAIMS)
    }
    
    // 'action' attribute on ButtonInput (id=ShowExposuresButton_Input) at AddressBookContactDetailScreen.default.pcf: line 184, column 116
    function action_46 () : void {
      helper.revealContent(EXPOSURES)
    }
    
    // 'action' attribute on ButtonInput (id=ShowMattersButton_Input) at AddressBookContactDetailScreen.default.pcf: line 214, column 114
