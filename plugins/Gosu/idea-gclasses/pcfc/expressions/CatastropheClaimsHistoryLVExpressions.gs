...
@javax.annotation.processing.Generated("config/web/pcf/admin/catastrophes/CatastropheClaimsHistoryLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CatastropheClaimsHistoryLVExpressions {
  ...
  public static class CatastropheClaimsHistoryLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=Eventtimestamp_Cell) at CatastropheClaimsHistoryLV.pcf: line 26, column 43
    function sortValue_0 (history :  entity.CatastropheClaimsHistory) : java.lang.Object {
      return history.EventTimestamp
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at CatastropheClaimsHistoryLV.pcf: line 30, column 40
