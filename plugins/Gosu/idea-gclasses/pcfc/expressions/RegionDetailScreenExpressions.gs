...
class RegionDetailScreenExpressions {
  ...
  public static class RegionDetailScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at RegionDetailScreen.pcf: line 58, column 23
    ...
    // 'def' attribute on PanelRef at RegionDetailScreen.pcf: line 60, column 124
    ...
    // 'editable' attribute on PanelRef at RegionDetailScreen.pcf: line 58, column 23
    ...
    // 'mode' attribute on PanelRef at RegionDetailScreen.pcf: line 58, column 23
    ...
    // 'valueRange' attribute on RangeInput (id=Country_Input) at RegionDetailScreen.pcf: line 49, column 41
    function verifyValueRangeIsAllowedType_14 ($$arg :  typekey.Country[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
