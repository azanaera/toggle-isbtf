...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimPeopleInvolvedDetailedLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimPeopleInvolvedDetailedLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends NewClaimPeopleInvolvedDetailedLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Name_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 71, column 39
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 71, column 39
    function valueRoot_23 () : java.lang.Object {
      return ClaimContact
    }
    
    // 'value' attribute on TextCell (id=Phone_Work_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 88, column 59
    function valueRoot_32 () : java.lang.Object {
      return ClaimContact.Contact
    }
    
    // 'value' attribute on TextCell (id=Address_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 94, column 76
    function valueRoot_35 () : java.lang.Object {
      return ClaimContact.Contact.PrimaryAddress
    }
    
    // 'value' attribute on TextCell (id=Name_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 71, column 39
    function value_22 () : entity.Contact {
      return ClaimContact.Contact
    }
    
    // 'value' attribute on TextCell (id=Roles_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 77, column 45
    function value_25 () : java.lang.String {
      return ClaimContact.RolesString
    }
    
    // 'value' attribute on BooleanRadioCell (id=ContactProhibited_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 82, column 51
    ...
    // 'value' attribute on TextCell (id=City_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 100, column 68
    function value_37 () : java.lang.String {
      return ClaimContact.Contact.PrimaryAddress.DisplayCity
    }
    
    // 'value' attribute on TypeKeyCell (id=State_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 106, column 38
    function value_40 () : typekey.State {
      return ClaimContact.Contact.PrimaryAddress.State
    }
    
    // 'value' attribute on TextCell (id=PostalCode_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 111, column 67
  ...
  public static class NewClaimPeopleInvolvedDetailedLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function filters_7 () : gw.api.filters.IFilter[] {
    ...
    function filters_9 () : gw.api.filters.IFilter[] {
    ...
    // 'sortBy' attribute on TextCell (id=Name_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 71, column 39
    ...
    // 'sortBy' attribute on TextCell (id=Address_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 94, column 76
    ...
    // 'sortBy' attribute on TextCell (id=City_Cell) at NewClaimPeopleInvolvedDetailedLV.pcf: line 100, column 68
