...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/AggregateLimitClaimsWorksheet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AggregateLimitClaimsWorksheetExpressions {
  ...
  public static class AggregateLimitClaimsWorksheetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=lid1_Input) at AggregateLimitClaimsWorksheet.pcf: line 40, column 107
    ...
    // 'visible' attribute on TextInput (id=lid1_Input) at AggregateLimitClaimsWorksheet.pcf: line 40, column 107
