...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/shared/ClaimSnapshotPolicyCovTermsCV.800.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyCovTermsCV_800Expressions {
  ...
  public static class ClaimSnapshotPolicyCovTermsCVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=covSortOrderCell_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 34, column 34
    function sortValue_0 (CovTerm :  dynamic.Dynamic) : java.lang.Object {
      return CovTerm.CovTermOrder
    }
    
    // 'value' attribute on TextCell (id=CovTermPattern_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 41, column 46
    function sortValue_1 (CovTerm :  dynamic.Dynamic) : java.lang.Object {
      return CovTerm.CovTermPattern
    }
    
    // 'value' attribute on TextCell (id=ModelRestriction_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 47, column 46
    function sortValue_2 (CovTerm :  dynamic.Dynamic) : java.lang.Object {
      return CovTerm.ModelRestriction
    }
    
    // 'value' attribute on TextCell (id=Amount_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 52, column 46
    function sortValue_3 (CovTerm :  dynamic.Dynamic) : java.lang.Object {
      return CovTerm.DisplayName
    }
    
    // 'value' attribute on TextCell (id=ModelAggregation_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 57, column 46
    function sortValue_4 (CovTerm :  dynamic.Dynamic) : java.lang.Object {
      return CovTerm.ModelAggregation
    }
    
    // 'value' attribute on TextCell (id=Type_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 64, column 34
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotPolicyCovTermsCVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=CovTermPattern_Cell) at ClaimSnapshotPolicyCovTermsCV.800.pcf: line 41, column 46
