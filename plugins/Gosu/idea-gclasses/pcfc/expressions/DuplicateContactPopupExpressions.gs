...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/DuplicateContactPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DuplicateContactPopupExpressions {
  ...
  public static class DuplicateContactPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=DisplayName_Cell) at DuplicateContactPopup.pcf: line 62, column 44
    function sortValue_3 (contact :  entity.Contact) : java.lang.Object {
      return contact.DisplayName
    }
    
    // 'value' attribute on TextCell (id=MatchType_Cell) at DuplicateContactPopup.pcf: line 66, column 48
    function sortValue_4 (contact :  entity.Contact) : java.lang.Object {
      return matchTypeValue(contact)
    }
    
    // 'value' attribute on TextCell (id=PrimaryAddress_Cell) at DuplicateContactPopup.pcf: line 71, column 43
    function sortValue_5 (contact :  entity.Contact) : java.lang.Object {
      return contact.PrimaryAddress
    }
    
    // 'value' attribute on TextCell (id=PhoneNumber_Cell) at DuplicateContactPopup.pcf: line 76, column 50
    function sortValue_6 (contact :  entity.Contact) : java.lang.Object {
      return contact.PrimaryPhoneValue
    }
    
    // 'value' attribute on TypeKeyCell (id=ContactSubtype_Cell) at DuplicateContactPopup.pcf: line 81, column 44
  ...
  public static class IteratorEntryExpressionsImpl extends DuplicateContactPopupExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=SelectContact_Cell) at DuplicateContactPopup.pcf: line 58, column 89
