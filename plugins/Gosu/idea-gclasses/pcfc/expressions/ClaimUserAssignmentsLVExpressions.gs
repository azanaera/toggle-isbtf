...
@javax.annotation.processing.Generated("config/web/pcf/claim/partiesinvolved/ClaimUserAssignmentsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimUserAssignmentsLVExpressions {
  ...
  public static class ClaimUserAssignmentsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on TextCell (id=Type_Cell) at ClaimUserAssignmentsLV.pcf: line 21, column 348
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at ClaimUserAssignmentsLV.pcf: line 25, column 43
    function sortValue_1 (Assignable :  entity.Assignable) : java.lang.Object {
      return Assignable.DisplayName
    }
    
    // 'value' attribute on TextCell (id=Status_Cell) at ClaimUserAssignmentsLV.pcf: line 29, column 87
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimUserAssignmentsLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Type_Cell) at ClaimUserAssignmentsLV.pcf: line 21, column 348
