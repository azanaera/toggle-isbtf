...
@javax.annotation.processing.Generated("config/web/pcf/claim/exposures/ReplacementServicesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ReplacementServicesDVExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/exposures/ReplacementServicesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ReplacementServicesDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ReplacementServicesDV.pcf: line 30, column 103
    ...
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsBeginDate_Input) at ReplacementServicesDV.pcf: line 17, column 56
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at ReplacementServicesDV.pcf: line 23, column 54
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at ReplacementServicesDV.pcf: line 23, column 54
