...
class AssignmentPopupScreenExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends AssignmentPopupScreenExpressionsImpl {
    ...
    // 'def' attribute on PanelRef at AssignmentPopupScreen.pcf: line 43, column 212
    function def_onEnter_20 (def :  pcf.AssignmentSearchDV) : void {
      def.onEnter(AssignmentPopup, gw.api.upgrade.Coercions.makeArray<typekey.AssignmentSearchType>(AssignmentPopup.Picker.AllowedAssignmentSearchTypes), SearchCriteria, PageHelper, claim)
    }
    
    // 'def' attribute on PanelRef at AssignmentPopupScreen.pcf: line 46, column 102
    ...
    // 'def' attribute on PanelRef at AssignmentPopupScreen.pcf: line 61, column 103
    function def_onEnter_28 (def :  pcf.AssignmentGroupLV) : void {
      def.onEnter(SearchResult == null ? null : SearchResult.getGroups())
    }
    
    // 'def' attribute on PanelRef at AssignmentPopupScreen.pcf: line 68, column 103
    ...
    function def_refreshVariables_21 (def :  pcf.AssignmentSearchDV) : void {
      def.refreshVariables(AssignmentPopup, gw.api.upgrade.Coercions.makeArray<typekey.AssignmentSearchType>(AssignmentPopup.Picker.AllowedAssignmentSearchTypes), SearchCriteria, PageHelper, claim)
    }
    ...
    // 'visible' attribute on PanelRef at AssignmentPopupScreen.pcf: line 46, column 102
    function visible_24 () : java.lang.Boolean {
      return (SearchCriteria.SearchType == TC_USER) and AssignmentPopup.IsAnySearchTypeSelected
    }
    
    // 'visible' attribute on PanelRef at AssignmentPopupScreen.pcf: line 61, column 103
    function visible_27 () : java.lang.Boolean {
      return (SearchCriteria.SearchType == TC_GROUP) and AssignmentPopup.IsAnySearchTypeSelected
    }
    
    // 'visible' attribute on PanelRef at AssignmentPopupScreen.pcf: line 68, column 103
    function visible_30 () : java.lang.Boolean {
      return (SearchCriteria.SearchType == TC_QUEUE) and AssignmentPopup.IsAnySearchTypeSelected
    }
