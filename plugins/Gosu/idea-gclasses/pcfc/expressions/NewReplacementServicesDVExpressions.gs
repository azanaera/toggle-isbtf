...
@javax.annotation.processing.Generated("config/web/pcf/claim/newexposure/NewReplacementServicesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewReplacementServicesDVExpressions {
  ...
  public static class NewReplacementServicesDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsBeginDate_Input) at NewReplacementServicesDV.pcf: line 17, column 56
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at NewReplacementServicesDV.pcf: line 23, column 54
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at NewReplacementServicesDV.pcf: line 23, column 54
