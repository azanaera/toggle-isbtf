...
@javax.annotation.processing.Generated("config/web/pcf/claim/subrogation/General/EditableStatuteLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableStatuteLVExpressions {
  ...
  public static class EditableStatuteLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=StatuteLimitType_Cell) at EditableStatuteLV.pcf: line 36, column 29
    ...
    // 'value' attribute on TypeKeyCell (id=JurisdictionState_Cell) at EditableStatuteLV.pcf: line 46, column 29
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at EditableStatuteLV.pcf: line 53, column 29
    ...
    // 'value' attribute on DateCell (id=StatuteDate_Cell) at EditableStatuteLV.pcf: line 60, column 29
  ...
  public static class IteratorEntryExpressionsImpl extends EditableStatuteLVExpressionsImpl {
    ...
    // 'filter' attribute on TypeKeyCell (id=JurisdictionState_Cell) at EditableStatuteLV.pcf: line 46, column 29
    function filter_13 (VALUE :  typekey.Jurisdiction, VALUES :  typekey.Jurisdiction[]) : java.lang.Boolean {
      return VALUE.hasCategory(JurisdictionType.TC_INSURANCE)
    }
    
    // 'filter' attribute on TypeKeyCell (id=StatuteLimitType_Cell) at EditableStatuteLV.pcf: line 36, column 29
    function filter_8 (VALUE :  typekey.StatuteLimitationsType, VALUES :  typekey.StatuteLimitationsType[]) : java.lang.Boolean {
