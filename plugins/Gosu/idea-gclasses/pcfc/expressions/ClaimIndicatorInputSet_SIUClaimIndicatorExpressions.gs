...
@javax.annotation.processing.Generated("config/web/pcf/claim/summary/indicator/ClaimIndicatorInputSet.SIUClaimIndicator.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimIndicatorInputSet_SIUClaimIndicatorExpressions {
  ...
  public static class ClaimIndicatorInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'label' attribute on TypeKeyInput (id=SIURefer_Input) at ClaimIndicatorInputSet.SIUClaimIndicator.pcf: line 34, column 34
    function label_4 () : java.lang.Object {
      return DisplayKey.get("Web.Claim.SIUClaimIndicator.ReferSIULabel") 
    }
    
    // 'value' attribute on TypeKeyInput (id=SIURefer_Input) at ClaimIndicatorInputSet.SIUClaimIndicator.pcf: line 34, column 34
