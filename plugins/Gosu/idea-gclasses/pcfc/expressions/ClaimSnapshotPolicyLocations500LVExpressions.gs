...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/500/ClaimSnapshotPolicyLocations500LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyLocations500LVExpressions {
  ...
  public static class ClaimSnapshotPolicyLocations500LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=PropertyNumber_Cell) at ClaimSnapshotPolicyLocations500LV.pcf: line 28, column 40
    function sortValue_1 (LocationBasedRU :  dynamic.Dynamic) : java.lang.Object {
      return (LocationBasedRU).RUNumber
    }
    
    // 'value' attribute on TextCell (id=Location_Cell) at ClaimSnapshotPolicyLocations500LV.pcf: line 33, column 40
    function sortValue_2 (LocationBasedRU :  dynamic.Dynamic) : java.lang.Object {
      return (LocationBasedRU).Property.LocationNumber
    }
    
    // 'value' attribute on TextCell (id=Building_Cell) at ClaimSnapshotPolicyLocations500LV.pcf: line 38, column 40
    function sortValue_3 (LocationBasedRU :  dynamic.Dynamic) : java.lang.Object {
      return (LocationBasedRU).Building.BuildingNumber
    }
    
    // 'value' attribute on TextCell (id=ClassCode_Cell) at ClaimSnapshotPolicyLocations500LV.pcf: line 43, column 40
    function sortValue_4 (LocationBasedRU :  dynamic.Dynamic) : java.lang.Object {
      return (LocationBasedRU).ClassCode.Code
    }
    
    // 'value' attribute on TextCell (id=Address_Cell) at ClaimSnapshotPolicyLocations500LV.pcf: line 47, column 82
    ...
    // 'value' attribute on TextCell (id=Notes_Cell) at ClaimSnapshotPolicyLocations500LV.pcf: line 52, column 40
