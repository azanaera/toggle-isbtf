...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/CheckRecurrenceDetailInputSet.single.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CheckRecurrenceDetailInputSet_singleExpressions {
  ...
  public static class CheckRecurrenceDetailInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=ScheduledSendDate_Input) at CheckRecurrenceDetailInputSet.single.pcf: line 21, column 40
    ...
    // 'validationExpression' attribute on DateInput (id=ScheduledSendDate_Input) at CheckRecurrenceDetailInputSet.single.pcf: line 21, column 40
