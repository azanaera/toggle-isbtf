...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookContactBasicsDV.Place.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookContactBasicsDV_PlaceExpressions {
  ...
  public static class AddressBookContactBasicsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=Currency_Input) at AddressBookContactBasicsDV.Place.pcf: line 37, column 67
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      contact.PreferredCurrency = (__VALUE_TO_SET as typekey.Currency)
    }
    
    // 'value' attribute on TextAreaInput (id=Notes_Input) at AddressBookContactBasicsDV.Place.pcf: line 47, column 43
    ...
    // 'visible' attribute on TypeKeyInput (id=Currency_Input) at AddressBookContactBasicsDV.Place.pcf: line 37, column 67
