...
@javax.annotation.processing.Generated("config/web/pcf/dashboard/DashboardClaimCount.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DashboardClaimCountExpressions {
  ...
  public static class DashboardClaimCountExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_24 (GroupInfo :  gw.api.dashboard.DashboardTreeGroupInfo) : java.lang.Boolean {
      return perm.User.viewedbclaimcounts
    }
    
    // 'def' attribute on PanelRef at DashboardClaimCount.pcf: line 44, column 103
    ...
    // 'def' attribute on PanelRef at DashboardClaimCount.pcf: line 49, column 103
    ...
    // 'def' attribute on PanelRef at DashboardClaimCount.pcf: line 40, column 30
    ...
    // 'label' attribute on Label at DashboardClaimCount.pcf: line 55, column 54
    function label_23 () : java.lang.String {
      return Stats.getIncurredLimitTip()
    }
    
    // 'mode' attribute on PanelRef at DashboardClaimCount.pcf: line 40, column 30
    function mode_10 () : java.lang.Object {
      return ModeSource
    }
    
    // Page (id=DashboardClaimCount) at DashboardClaimCount.pcf: line 8, column 123
    static function parent_25 (GroupInfo :  gw.api.dashboard.DashboardTreeGroupInfo) : pcf.api.Destination {
    ...
    static function title_26 (GroupInfo :  gw.api.dashboard.DashboardTreeGroupInfo) : java.lang.Object {
    ...
    // 'visible' attribute on PanelRef at DashboardClaimCount.pcf: line 44, column 103
