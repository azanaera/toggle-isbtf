...
uses java.util.Date
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/RentalServiceInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RentalServiceInputSetExpressions {
  ...
  public static class RentalServiceInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 16, column 225
    ...
    // 'action' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 18, column 285
    ...
    // 'action' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'def' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 14, column 229
    function def_onEnter_20 (def :  pcf.ClaimNewVendorOnlyPickerMenuItemSet) : void {
      def.onEnter(statictypeof (rentalServiceRequest.SpecialistAndCreateClaimContact), null, vehicleIncident.Claim)
    }
    
    // 'def' attribute on InputSetRef at RentalServiceInputSet.pcf: line 105, column 40
    ...
    // 'def' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 14, column 229
    function def_refreshVariables_21 (def :  pcf.ClaimNewVendorOnlyPickerMenuItemSet) : void {
    ...
    // 'value' attribute on DateInput (id=RentalEndDate_Input) at RentalServiceInputSet.pcf: line 57, column 33
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      RentalEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CurrencyInput (id=RentalRate_Input) at RentalServiceInputSet.pcf: line 66, column 30
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      RentalRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextInput (id=ReservationNumber_Input) at RentalServiceInputSet.pcf: line 74, column 37
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      ReservationNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    function defaultSetter_31 (__VALUE_TO_SET :  java.lang.Object) : void {
      rentalServiceRequest.SpecialistAndCreateClaimContact = (__VALUE_TO_SET as entity.Contact)
    }
    
    // 'value' attribute on DateInput (id=RentalBeginDate_Input) at RentalServiceInputSet.pcf: line 47, column 35
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      RentalBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'editable' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    function editable_26 () : java.lang.Boolean {
      return rentalServiceRequest.IsEditableInUI
    }
    
    // 'editable' attribute on InputSetRef at RentalServiceInputSet.pcf: line 105, column 40
    ...
    // 'label' attribute on InputGroup (id=RentalInputGroup) at RentalServiceInputSet.pcf: line 34, column 46
    ...
    // 'onPick' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'onToggle' attribute on InputGroup (id=RentalInputGroup) at RentalServiceInputSet.pcf: line 34, column 46
    function setter_57 (VALUE :  java.lang.Boolean) : void {
      toggleServiceRequest(VALUE)
    }
    
    // 'validationExpression' attribute on DateInput (id=RentalEndDate_Input) at RentalServiceInputSet.pcf: line 57, column 33
    ...
    // 'valueRange' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'value' attribute on TextInput (id=RentalAgencyAddress_Input) at RentalServiceInputSet.pcf: line 97, column 41
    ...
    // 'value' attribute on TextInput (id=RentalCoverage_Input) at RentalServiceInputSet.pcf: line 40, column 148
    ...
    // 'value' attribute on TextInput (id=RentalAgencyPhone_Input) at RentalServiceInputSet.pcf: line 101, column 72
    ...
    // 'valueRange' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    function verifyValueRangeIsAllowedType_34 ($$arg :  entity.Contact[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 12, column 273
    function verifyValueRangeIsAllowedType_34 ($$arg :  gw.api.database.IQueryBeanResult<entity.Contact>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 14, column 229
    function visible_19 () : java.lang.Boolean {
      return perm.Contact.createlocal
    }
    
    // 'visible' attribute on ClaimContactInput (id=RentalAgency_Input) at ClaimContactWidget.xml: line 16, column 225
    ...
    // 'visible' attribute on InputSet (id=OtherServiceRequestInfo) at RentalServiceInputSet.pcf: line 92, column 61
    function visible_52 () : java.lang.Boolean {
      return rentalServiceRequest.Specialist != null
    }
    
    // 'visible' attribute on InputSet at RentalServiceInputSet.pcf: line 36, column 34
