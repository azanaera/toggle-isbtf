...
@javax.annotation.processing.Generated("config/web/pcf/shared/documents/DocumentDetailsEditInputSet.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DocumentDetailsEditInputSet_defaultExpressions {
  ...
  public static class DocumentDetailsEditInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=Type_Ext_Input) at DocumentDetailsEditInputSet.default.pcf: line 296, column 41
    ...
    // 'value' attribute on DateInput (id=ReceivedDate_Ext_Input) at DocumentDetailsEditInputSet.default.pcf: line 310, column 57
    function defaultSetter_226 (__VALUE_TO_SET :  java.lang.Object) : void {
      documentDetailsCCHelper.ReceivedDate_Ext = (__VALUE_TO_SET as java.util.Date)
    }
    ...
    // 'valueRange' attribute on RangeInput (id=Type_Ext_Input) at DocumentDetailsEditInputSet.default.pcf: line 296, column 41
    ...
    // 'value' attribute on RangeInput (id=Type_Ext_Input) at DocumentDetailsEditInputSet.default.pcf: line 296, column 41
    function value_218 () : typekey.DocumentType {
    ...
    // 'value' attribute on DateInput (id=ReceivedDate_Ext_Input) at DocumentDetailsEditInputSet.default.pcf: line 310, column 57
    function value_225 () : java.util.Date {
      return documentDetailsCCHelper.ReceivedDate_Ext
    }
    ...
    // 'valueRange' attribute on RangeInput (id=Type_Ext_Input) at DocumentDetailsEditInputSet.default.pcf: line 296, column 41
    function verifyValueRangeIsAllowedType_222 ($$arg :  typekey.DocumentType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
