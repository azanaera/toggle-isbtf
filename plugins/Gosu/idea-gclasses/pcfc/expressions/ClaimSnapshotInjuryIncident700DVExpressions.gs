...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotInjuryIncident700DV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotInjuryIncident700DVExpressions {
  ...
  public static class ClaimSnapshotInjuryIncident700DVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Ordering_Cell) at ClaimSnapshotInjuryIncident700DV.pcf: line 64, column 36
    function sortValue_13 (BodyPartDetails :  dynamic.Dynamic) : java.lang.Object {
      return BodyPartDetails.Ordering
    }
    
    // 'value' attribute on TextCell (id=PrimaryBodyPart_Cell) at ClaimSnapshotInjuryIncident700DV.pcf: line 70, column 48
    function sortValue_14 (BodyPartDetails :  dynamic.Dynamic) : java.lang.Object {
      return BodyPartDetails.PrimaryBodyPart
    }
    
    // 'value' attribute on TextCell (id=DetailedBodyPart_Cell) at ClaimSnapshotInjuryIncident700DV.pcf: line 76, column 48
    function sortValue_15 (BodyPartDetails :  dynamic.Dynamic) : java.lang.Object {
      return BodyPartDetails.DetailedBodyPart
    }
    
    // 'value' attribute on TextInput (id=Severity_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 21, column 40
    function valueRoot_2 () : java.lang.Object {
      return InjuryIncidentInstance
    }
    
    // 'value' attribute on TextInput (id=PrimaryDoctor_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 125, column 40
    ...
    // 'value' attribute on TextInput (id=DetailedInjuryType_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 37, column 40
    ...
    // 'value' attribute on BooleanRadioInput (id=ReceivedTreatment_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 112, column 29
    function value_36 () : java.lang.Boolean {
      return treatment
    }
    
    // 'value' attribute on TextInput (id=TreatmentType_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 120, column 32
    function value_39 () : dynamic.Dynamic {
      return InjuryIncidentInstance.MedicalTreatmentType
    }
    
    // 'value' attribute on TextAreaInput (id=InjuryDescription_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 27, column 40
    ...
    // 'value' attribute on TextInput (id=LostWages_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 130, column 39
    function value_46 () : dynamic.Dynamic {
      return InjuryIncidentInstance.LostWages
    }
    
    // 'value' attribute on TextInput (id=PrimaryInjuryType_Input) at ClaimSnapshotInjuryIncident700DV.pcf: line 32, column 40
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotInjuryIncident700DVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=CompensabilityDecision_Cell) at ClaimSnapshotInjuryIncident700DV.pcf: line 85, column 37
    function value_26 () : dynamic.Dynamic {
      return BodyPartDetails.CompensabilityDecision
    }
    
    // 'value' attribute on TextCell (id=CompensabilityDecisionDate_Cell) at ClaimSnapshotInjuryIncident700DV.pcf: line 94, column 37
    function value_29 () : dynamic.Dynamic {
      return BodyPartDetails.CompensabilityDecisionDate
    }
    
    // 'value' attribute on TextCell (id=CompensabilityComments_Cell) at ClaimSnapshotInjuryIncident700DV.pcf: line 103, column 37
