...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/CompanyVendorSpecialtyInputSet.MedicalCareOrg.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CompanyVendorSpecialtyInputSet_MedicalCareOrgExpressions {
  ...
  public static class CompanyVendorSpecialtyInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=MedicalSpecialty_Input) at CompanyVendorSpecialtyInputSet.MedicalCareOrg.pcf: line 25, column 42
