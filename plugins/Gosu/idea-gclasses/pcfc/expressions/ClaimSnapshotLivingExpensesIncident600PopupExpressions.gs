...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotLivingExpensesIncident600Popup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotLivingExpensesIncident600PopupExpressions {
  ...
  public static class ClaimSnapshotLivingExpensesIncident600PopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 93, column 25
    ...
    // 'icon' attribute on TitleBar at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 31, column 33
    ...
    // 'mode' attribute on PanelRef at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 93, column 25
    function mode_33 () : java.lang.Object {
      return 600
    }
    
    // 'value' attribute on TextCell (id=StartDate_Cell) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 116, column 50
    function sortValue_34 (aLodgingProvider :  dynamic.Dynamic) : java.lang.Object {
      return aLodgingProvider.StartDate
    }
    
    // 'value' attribute on TextCell (id=EndDate_Cell) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 121, column 50
    function sortValue_35 (aLodgingProvider :  dynamic.Dynamic) : java.lang.Object {
      return aLodgingProvider.EndDate
    }
    
    // 'value' attribute on TextCell (id=Days_Cell) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 142, column 50
    function sortValue_36 (aLodgingProvider :  dynamic.Dynamic) : java.lang.Object {
      return aLodgingProvider.Days
    }
    
    // 'value' attribute on TextCell (id=Rate_Cell) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 148, column 50
    function sortValue_37 (aLodgingProvider :  dynamic.Dynamic) : java.lang.Object {
      return aLodgingProvider.LodgingRate
    }
    
    // 'value' attribute on TextCell (id=Approx_Total_Cell) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 154, column 50
    function sortValue_38 (aLodgingProvider :  dynamic.Dynamic) : java.lang.Object {
      return aLodgingProvider.LodgingTotal
    }
    
    // 'value' attribute on TextAreaCell (id=Comments_Cell) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 160, column 50
    function sortValue_39 (aLodgingProvider :  dynamic.Dynamic) : java.lang.Object {
      return aLodgingProvider.Comments
    }
    
    // 'value' attribute on TextAreaInput (id=Description_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 45, column 48
    function valueRoot_5 () : java.lang.Object {
      return incident
    }
    
    // 'value' attribute on TextInput (id=TotalLodgingEstimate_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 56, column 48
    function value_10 () : dynamic.Dynamic {
      return incident.TotalLodgingEstimate
    }
    
    // 'value' attribute on TextInput (id=TotalMealsEstimate_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 62, column 48
    function value_13 () : dynamic.Dynamic {
      return incident.TotalMealsEstimate
    }
    
    // 'value' attribute on TextInput (id=MealsDays_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 75, column 48
    function value_16 () : dynamic.Dynamic {
      return incident.MealsDays
    }
    
    // 'value' attribute on TextInput (id=MealsPeople_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 80, column 48
    function value_19 () : dynamic.Dynamic {
      return incident.MealsPeople
    }
    
    // 'value' attribute on TextInput (id=MealsRate_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 85, column 48
    ...
    // 'value' attribute on RowIterator at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 109, column 45
    function value_67 () : dynamic.Dynamic {
      return incident.LodgingProviders
    }
    
    // 'value' attribute on TextInput (id=ExpectedDuration_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 50, column 48
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotLivingExpensesIncident600PopupExpressionsImpl {
    ...
    // 'value' attribute on TextInput (id=Contact_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 128, column 52
    function valueRoot_47 () : java.lang.Object {
      return aLodgingProvider.Contact
    }
    
    // 'value' attribute on TextInput (id=Contact_PrimaryAddress_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 132, column 52
    ...
    // 'value' attribute on TextInput (id=Contact_Phone_Input) at ClaimSnapshotLivingExpensesIncident600Popup.pcf: line 136, column 52
