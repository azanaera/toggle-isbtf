...
class FNOLWizard_NewLossDetailsPanelSet_InlandMarineExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FNOLWizard_NewLossDetailsPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 161, column 29
    function def_onEnter_86 (def :  pcf.EditableFixedPropertyIncidentsLV) : void {
      def.onEnter(claim)
    }
    
    // 'def' attribute on ListViewInput at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 174, column 29
    function def_onEnter_88 (def :  pcf.EditableInjuryIncidentsLV) : void {
      def.onEnter(claim)
    }
    
    // 'def' attribute on InputSetRef at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 185, column 56
    function def_onEnter_90 (def :  pcf.CCAddressInputSet) : void {
      def.onEnter(claim.AddressOwner)
    }
    
    // 'def' attribute on ListViewInput at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 192, column 29
    function def_onEnter_92 (def :  pcf.EditableOfficialsLV) : void {
      def.onEnter(claim)
    }
    
    // 'def' attribute on ListViewInput at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 204, column 29
    ...
    // 'def' attribute on ListViewInput at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 212, column 29
    ...
    // 'value' attribute on RangeInput (id=Claim_PermissionRequired_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 54, column 50
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.PermissionRequired = (__VALUE_TO_SET as typekey.ClaimSecurityType)
    }
    
    // 'value' attribute on TextAreaInput (id=Description_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 62, column 38
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=Claim_LossCause_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 72, column 41
    function defaultSetter_27 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.LossCause = (__VALUE_TO_SET as typekey.LossCause)
    }
    
    // 'value' attribute on BooleanRadioInput (id=ArsonInvolved_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 81, column 64
    function defaultSetter_32 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.PropertyFireDamage.Arson = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on TypeKeyInput (id=LocationOfTheft_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 88, column 53
    function defaultSetter_38 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.LocationOfTheft = (__VALUE_TO_SET as typekey.LocationOfTheft)
    }
    
    // 'value' attribute on RangeInput (id=Catastrophe_CatastropheNumber_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 96, column 43
    function defaultSetter_43 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.Catastrophe = (__VALUE_TO_SET as entity.Catastrophe)
    }
    
    // 'value' attribute on TypeKeyInput (id=Notification_Fault_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 102, column 43
    function defaultSetter_50 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.FaultRating = (__VALUE_TO_SET as typekey.FaultRating)
    }
    
    // 'value' attribute on TextInput (id=Notification_AtFaultPercentage_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 113, column 50
    function defaultSetter_55 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.Fault = (__VALUE_TO_SET as java.math.BigDecimal)
    }
    
    // 'value' attribute on DateInput (id=Notification_ReportedDate_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 130, column 39
    function defaultSetter_66 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.ReportedDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on BooleanRadioInput (id=Notification_FirstNoticeSuit_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 135, column 42
    function defaultSetter_71 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.FirstNoticeSuit = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on TypeKeyInput (id=Notification_HowReported_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 141, column 48
    ...
    // 'value' attribute on CheckBoxInput (id=Status_IncidentReport_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 146, column 41
    function defaultSetter_79 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.IncidentReport = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on TypeKeyInput (id=Claim_LOBCode_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 40, column 40
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.LOBCode = (__VALUE_TO_SET as typekey.LOBCode)
    }
    
    // 'value' attribute on BooleanRadioInput (id=Status_CoverageQuestion_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 152, column 45
    ...
    // 'initialValue' attribute on Variable at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 17, column 53
    function initialValue_0 () : gw.api.claim.FnolWizardPropertyHelper {
      return new gw.api.claim.FnolWizardPropertyHelper(claim)
    }
    
    // 'onChange' attribute on PostOnChange at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 74, column 72
    function onChange_25 () : void {
      PropertyHelper.createDamageTypesPerLossCause()
    }
    
    // 'validationExpression' attribute on DateInput (id=Claim_LossDate_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 120, column 35
    ...
    // 'validationExpression' attribute on DateInput (id=Notification_ReportedDate_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 130, column 39
    ...
    // 'valueRange' attribute on RangeInput (id=Claim_PermissionRequired_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 54, column 50
    function valueRange_17 () : java.lang.Object {
      return gw.api.claim.ClaimUtil.getAvailableTypes()
    }
    
    // 'valueRange' attribute on RangeInput (id=Catastrophe_CatastropheNumber_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 96, column 43
    function valueRange_45 () : java.lang.Object {
      return gw.api.admin.CatastropheUtil.getCatastrophes()
    }
    
    // 'value' attribute on TextInput (id=Policy_PolicyNumber_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 25, column 46
    ...
    // 'value' attribute on TypeKeyInput (id=Claim_LossType_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 46, column 41
    ...
    // 'value' attribute on TypeKeyInput (id=Policy_Status_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 30, column 45
    ...
    // 'value' attribute on DateInput (id=Claim_LossDate_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 120, column 35
    ...
    // 'visible' attribute on BooleanRadioInput (id=ArsonInvolved_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 81, column 64
    function visible_30 () : java.lang.Boolean {
      return PropertyHelper.PropertyFireDamage.Present
    }
    
    // 'visible' attribute on TypeKeyInput (id=LocationOfTheft_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 88, column 53
    function visible_36 () : java.lang.Boolean {
      return claim.LossCause == TC_BURGLARY
    }
    
    // 'visible' attribute on TextInput (id=Notification_AtFaultPercentage_Input) at FNOLWizard_NewLossDetailsPanelSet.InlandMarine.pcf: line 113, column 50
