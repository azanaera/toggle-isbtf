...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/400/ClaimSnapshotPolicyLocations400LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyLocations400LVExpressions {
  ...
  public static class ClaimSnapshotPolicyLocations400LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=PropertyNumber_Cell) at ClaimSnapshotPolicyLocations400LV.pcf: line 24, column 40
    function sortValue_0 (PolicyProperty :  dynamic.Dynamic) : java.lang.Object {
      return PolicyProperty.PropertyNumber
    }
    
    // 'value' attribute on TextCell (id=Location_Cell) at ClaimSnapshotPolicyLocations400LV.pcf: line 29, column 40
    function sortValue_1 (PolicyProperty :  dynamic.Dynamic) : java.lang.Object {
      return PolicyProperty.Property.Location
    }
    
    // 'value' attribute on TextCell (id=BuildingNumber_Cell) at ClaimSnapshotPolicyLocations400LV.pcf: line 34, column 40
    function sortValue_2 (PolicyProperty :  dynamic.Dynamic) : java.lang.Object {
      return PolicyProperty.Property.BuildingNumber
    }
    
    // 'value' attribute on TextCell (id=Address_Cell) at ClaimSnapshotPolicyLocations400LV.pcf: line 38, column 79
    ...
    // 'value' attribute on TextCell (id=Notes_Cell) at ClaimSnapshotPolicyLocations400LV.pcf: line 43, column 40
