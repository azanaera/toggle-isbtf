...
class ClaimPolicyStatCodesPrintExpressions {
  ...
  public static class ClaimPolicyStatCodesPrintExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'canEdit' attribute on Page (id=ClaimPolicyStatCodesPrint) at ClaimPolicyStatCodesPrint.pcf: line 11, column 67
    ...
    // 'canVisit' attribute on Page (id=ClaimPolicyStatCodesPrint) at ClaimPolicyStatCodesPrint.pcf: line 11, column 67
    ...
    // 'parent' attribute on Page (id=ClaimPolicyStatCodesPrint) at ClaimPolicyStatCodesPrint.pcf: line 11, column 67
