...
@javax.annotation.processing.Generated("config/web/pcf/admin/accounts/AccountDetailScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AccountDetailScreenExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends AccountDetailScreenExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=AutomatedActivitiesAddClaimIndicatorHandler) at AccountDetailScreen.pcf: line 88, column 136
    ...
    // 'label' attribute on MenuItem (id=AutomatedActivitiesAddClaimIndicatorHandler) at AccountDetailScreen.pcf: line 88, column 136
    function label_15 () : java.lang.Object {
      return gw.api.specialhandling.SpecialHandlingHelper.getAccountAutomatedActivitiesAddLabel(automatedHandlerSubtype)
    }
  ...
  public static class IteratorEntryExpressionsImpl extends AccountDetailScreenExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=AutomatedNotificationsAddClaimIndicatorHandler) at AccountDetailScreen.pcf: line 57, column 139
    ...
    // 'label' attribute on MenuItem (id=AutomatedNotificationsAddClaimIndicatorHandler) at AccountDetailScreen.pcf: line 57, column 139
    function label_7 () : java.lang.Object {
      return gw.api.specialhandling.SpecialHandlingHelper.getAccountAutomatedNotificationsAddLabel(automatedHandlerSubtype)
    }
