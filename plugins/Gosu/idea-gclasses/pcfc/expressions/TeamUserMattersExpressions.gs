...
class TeamUserMattersExpressions {
  ...
  public static class TeamUserMattersExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamUserMatters_Print) at TeamUserMatters.pcf: line 44, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamUserMatters_Assign) at TeamUserMatters.pcf: line 37, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamUserMatters_Print) at TeamUserMatters.pcf: line 44, column 25
    ...
    // 'def' attribute on PanelRef at TeamUserMatters.pcf: line 47, column 50
    ...
    // 'title' attribute on TitleBar at TeamUserMatters.pcf: line 29, column 90
