...
@javax.annotation.processing.Generated("config/web/pcf/claim/newnote/NoteTemplateSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NoteTemplateSearchDVExpressions {
  ...
  public static class NoteTemplateSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=Topic_Input) at NoteTemplateSearchDV.pcf: line 16, column 44
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      NoteTemplateSearchCriteria.Topic = (__VALUE_TO_SET as typekey.NoteTopicType)
    }
    
    // 'value' attribute on TypeKeyInput (id=Language_Input) at NoteTemplateSearchDV.pcf: line 30, column 67
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      NoteTemplateSearchCriteria.Language = (__VALUE_TO_SET as typekey.LanguageType)
    }
    
    // 'value' attribute on TypeKeyInput (id=LossType_Input) at NoteTemplateSearchDV.pcf: line 36, column 39
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      NoteTemplateSearchCriteria.Lob = (__VALUE_TO_SET as typekey.LossType)
    }
    
    // 'value' attribute on TextInput (id=Keywords_Input) at NoteTemplateSearchDV.pcf: line 41, column 54
    function defaultSetter_19 (__VALUE_TO_SET :  java.lang.Object) : void {
      NoteTemplateSearchCriteria.Keywords = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=Type_Input) at NoteTemplateSearchDV.pcf: line 22, column 39
    ...
    // 'visible' attribute on TypeKeyInput (id=Language_Input) at NoteTemplateSearchDV.pcf: line 30, column 67
