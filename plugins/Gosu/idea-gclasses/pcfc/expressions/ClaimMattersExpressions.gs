...
@javax.annotation.processing.Generated("config/web/pcf/claim/litigation/ClaimMatters.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimMattersExpressions {
  ...
  public static class ClaimMattersExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_17 (Claim :  Claim) : java.lang.Boolean {
      return perm.Matter.view(Claim) and perm.System.viewmatters and (Claim.State != ClaimState.TC_DRAFT)
    }
    
    // 'def' attribute on PanelRef at ClaimMatters.pcf: line 66, column 60
    function def_onEnter_15 (def :  pcf.MattersLV) : void {
      def.onEnter(Claim.Matters, Claim, PageHelper)
    }
    
    // 'def' attribute on PanelRef at ClaimMatters.pcf: line 66, column 60
    function def_refreshVariables_16 (def :  pcf.MattersLV) : void {
