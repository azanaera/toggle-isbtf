...
class ClaimPolicyStatCodesExpressions {
  ...
  public static class ClaimPolicyStatCodesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'afterCommit' attribute on Page (id=ClaimPolicyStatCodes) at ClaimPolicyStatCodes.pcf: line 11, column 67
    function afterCommit_19 (TopLocation :  pcf.api.Location) : void {
      ClaimPolicyStatCodesForward.go(Claim)
    }
    
    // 'canEdit' attribute on Page (id=ClaimPolicyStatCodes) at ClaimPolicyStatCodes.pcf: line 11, column 67
    ...
    // 'canVisit' attribute on Page (id=ClaimPolicyStatCodes) at ClaimPolicyStatCodes.pcf: line 11, column 67
    ...
    // Page (id=ClaimPolicyStatCodes) at ClaimPolicyStatCodes.pcf: line 11, column 67
