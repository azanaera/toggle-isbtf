...
@javax.annotation.processing.Generated("config/web/pcf/admin/specialhandling/AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AutomatedHandlerTriggerInputSet_financialthresholdtriggerExpressions {
  ...
  public static class AutomatedHandlerTriggerInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=Currency_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 37, column 64
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      trigger.Currency = (__VALUE_TO_SET as typekey.Currency)
    }
    
    // 'value' attribute on CurrencyInput (id=Amount_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 46, column 40
    function defaultSetter_19 (__VALUE_TO_SET :  java.lang.Object) : void {
      trigger.ThresholdAmount = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on RangeInput (id=AutomatedHandlerFinancialThreshold_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 23, column 47
    ...
    // 'validationExpression' attribute on CurrencyInput (id=Amount_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 46, column 40
    ...
    // 'valueRange' attribute on RangeInput (id=AutomatedHandlerFinancialThreshold_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 23, column 47
    ...
    // 'value' attribute on TextInput (id=Cause_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 29, column 50
    ...
    // 'valueRange' attribute on RangeInput (id=AutomatedHandlerFinancialThreshold_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 23, column 47
    function verifyValueRangeIsAllowedType_5 ($$arg :  typekey.FinancialThreshold[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on TypeKeyInput (id=Currency_Input) at AutomatedHandlerTriggerInputSet.financialthresholdtrigger.pcf: line 37, column 64
