...
class TeamGroupQueuedActivitiesExpressions {
  ...
  public static class TeamGroupQueuedActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupQueuedActivities_Print) at TeamGroupQueuedActivities.pcf: line 45, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupQueuedActivities_Assign) at TeamGroupQueuedActivities.pcf: line 38, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupQueuedActivities_Print) at TeamGroupQueuedActivities.pcf: line 45, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupQueuedActivities.pcf: line 48, column 131
