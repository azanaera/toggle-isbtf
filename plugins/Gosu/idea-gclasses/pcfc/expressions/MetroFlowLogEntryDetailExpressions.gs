...
@javax.annotation.processing.Generated("config/web/pcf/tools/workflow/MetroFlowLogEntryDetail.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class MetroFlowLogEntryDetailExpressions {
  ...
  public static class MetroFlowLogEntryDetailExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Summary_Input) at MetroFlowLogEntryDetail.pcf: line 36, column 47
    function valueRoot_5 () : java.lang.Object {
      return LogEntry
    }
    
    // 'value' attribute on TextInput (id=LogDate_Input) at MetroFlowLogEntryDetail.pcf: line 32, column 169
    ...
    // 'value' attribute on PreFormattedTextInput (id=Description_Input) at MetroFlowLogEntryDetail.pcf: line 40, column 43
