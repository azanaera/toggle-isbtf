...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/TripIncidentAccommodationsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TripIncidentAccommodationsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TripIncidentAccommodationsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=AffectedAccommodationName_Cell) at TripIncidentAccommodationsLV.pcf: line 48, column 49
    ...
    // 'available' attribute on TextCell (id=ReasonForDenial_Cell) at TripIncidentAccommodationsLV.pcf: line 72, column 83
    ...
    // 'value' attribute on TextCell (id=ReasonForDenial_Cell) at TripIncidentAccommodationsLV.pcf: line 72, column 83
    function defaultSetter_24 (__VALUE_TO_SET :  java.lang.Object) : void {
      aTripAccommodation.ReasonForDenial = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextCell (id=ReasonForDenial_Cell) at TripIncidentAccommodationsLV.pcf: line 72, column 83
    function editable_21 () : java.lang.Boolean {
      return aTripAccommodation.Assessment == TC_DENY ? true : false
    }
    
    // 'value' attribute on TypeKeyCell (id=Assessment_Cell) at TripIncidentAccommodationsLV.pcf: line 64, column 49
    function valueRoot_18 () : java.lang.Object {
      return aTripAccommodation
    }
    
    // 'value' attribute on TextCell (id=AffectedAccommodationName_Cell) at TripIncidentAccommodationsLV.pcf: line 48, column 49
    function value_11 () : entity.TripAccommodation {
      return aTripAccommodation
    }
    
    // 'value' attribute on TextCell (id=AccommodationStatus_Cell) at TripIncidentAccommodationsLV.pcf: line 53, column 233
    ...
    // 'value' attribute on CurrencyCell (id=AccommodationCostIncurred_Cell) at TripIncidentAccommodationsLV.pcf: line 58, column 89
