...
@javax.annotation.processing.Generated("config/web/pcf/workspace/activity/ApprovalDetailDV.ReserveSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ApprovalDetailDV_ReserveSetExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/workspace/activity/ApprovalDetailDV.ReserveSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ApprovalDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 16, column 94
    function def_onEnter_0 (def :  pcf.ApprovalHistoryLV) : void {
      def.onEnter(Activity.TransactionSet.ApprovalHistory?.toTypedArray())
    }
    
    // 'def' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 38, column 40
    ...
    // 'def' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 23, column 98
    function def_onEnter_2 (def :  pcf.ReserveSetLV) : void {
      def.onEnter((Activity.TransactionSet as ReserveSet).Reserves, true)
    }
    ...
    // 'def' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 23, column 98
    function def_refreshVariables_3 (def :  pcf.ReserveSetLV) : void {
      def.refreshVariables((Activity.TransactionSet as ReserveSet).Reserves, true)
    }
    
    // 'value' attribute on TextInput (id=ApprovalRationale_Input) at ApprovalDetailDV.ReserveSet.pcf: line 32, column 42
    ...
    // 'value' attribute on DateInput (id=Details_CreateTime_Input) at ApprovalDetailDV.ReserveSet.pcf: line 54, column 53
    ...
    // 'valueType' attribute on ClaimContactInput (id=Details_CreateUser_Input) at ApprovalDetailDV.ReserveSet.pcf: line 50, column 41
    ...
    // 'visible' attribute on ListViewInput at ApprovalDetailDV.ReserveSet.pcf: line 38, column 40
    ...
    // 'visible' attribute on TextInput (id=ApprovalRationale_Input) at ApprovalDetailDV.ReserveSet.pcf: line 32, column 42
