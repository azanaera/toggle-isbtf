...
class VoidStopCheckExpressions {
  ...
  public static class VoidStopCheckExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'label' attribute on TextInput (id=LinkedServiceRequestInvoicesMessage_Input) at VoidStopCheck.pcf: line 53, column 65
    ...
    // 'visible' attribute on TextInput (id=LinkedServiceRequestInvoicesMessage_Input) at VoidStopCheck.pcf: line 53, column 65
