...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookContactBasicsDV.Person.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookContactBasicsDV_PersonExpressions {
  ...
  public static class AddressBookContactBasicsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=Notes_Input) at AddressBookContactBasicsDV.Person.pcf: line 87, column 44
    ...
    // 'value' attribute on TextInput (id=score_Input) at AddressBookContactBasicsDV.Person.pcf: line 40, column 42
    ...
    // 'visible' attribute on TextInput (id=score_Input) at AddressBookContactBasicsDV.Person.pcf: line 40, column 42
  ...
  public static class IteratorEntryExpressionsImpl extends AddressBookContactBasicsDVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=Category_Cell) at AddressBookContactBasicsDV.Person.pcf: line 59, column 53
    ...
    // 'value' attribute on TextCell (id=Score_Cell) at AddressBookContactBasicsDV.Person.pcf: line 65, column 48
