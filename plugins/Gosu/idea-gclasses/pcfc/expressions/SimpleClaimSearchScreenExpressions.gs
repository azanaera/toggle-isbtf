...
@javax.annotation.processing.Generated("config/web/pcf/search/claims/SimpleClaimSearchScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class SimpleClaimSearchScreenExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends SimpleClaimSearchScreenExpressionsImpl {
    ...
    // 'actionAvailable' attribute on TextValue (id=archiveSearchLink) at SimpleClaimSearchScreen.pcf: line 47, column 64
    function actionAvailable_7 () : java.lang.Boolean {
      return searchHelper.archiveSearchLinkAvailable()
    }
    
    // 'action' attribute on ToolbarButton (id=SimpleClaimSearchScreen_PrintButton) at SimpleClaimSearchScreen.pcf: line 40, column 27
    ...
    // 'action' attribute on TextValue (id=archiveSearchLink) at SimpleClaimSearchScreen.pcf: line 47, column 64
    function action_6 () : void {
      searchHelper.modifySearchCriteriaForAdvanceArchive(); ClaimSearch.go()
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=ClaimSearchScreen_AssignButton) at SimpleClaimSearchScreen.pcf: line 33, column 27
    ...
    // 'available' attribute on ToolbarButton (id=SimpleClaimSearchScreen_PrintButton) at SimpleClaimSearchScreen.pcf: line 40, column 27
    ...
    function search_14 () : java.lang.Object {
      new gw.api.name.SearchNameOwner(searchHelper.Criteria.NameCriteria).clearNonvisibleFields(); return searchHelper.search()
    }
    
    // 'value' attribute on TextValue (id=archiveSearchLink) at SimpleClaimSearchScreen.pcf: line 47, column 64
    function value_8 () : java.lang.String {
      return searchHelper.archiveSearchLinkLabel()
    }
    
    // 'visible' attribute on TextValue (id=archiveSearchLink) at SimpleClaimSearchScreen.pcf: line 47, column 64
