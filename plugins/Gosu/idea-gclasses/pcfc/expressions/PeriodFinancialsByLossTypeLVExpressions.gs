...
@javax.annotation.processing.Generated("config/web/pcf/dashboard/PeriodFinancialsByLossTypeLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PeriodFinancialsByLossTypeLVExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/dashboard/PeriodFinancialsByLossTypeLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends PeriodFinancialsByLossTypeLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=ByLossType_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 44, column 41
    function valueRoot_20 () : java.lang.Object {
      return DashboardStats
    }
    
    // 'value' attribute on TypeKeyCell (id=ByLossType_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 44, column 41
    function value_19 () : typekey.LossType {
      return DashboardStats.LossType
    }
    
    // 'value' attribute on TextCell (id=PeriodFinancials_ClosedClaims_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 51, column 42
    function value_22 () : java.lang.Integer {
      return DashboardStats.ClosedClaims
    }
    
    // 'value' attribute on TextCell (id=PeriodFinancials_ExpensesOnClosed_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 59, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_ClaimCostsOnClosed_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 67, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_PaidOnClosed_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 75, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_AvgPaidOnClosed_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 82, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_ExpensesInPeriod_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 90, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_ClaimCostsInPeriod_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 98, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_PaidInPeriod_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 106, column 45
    ...
    // 'value' attribute on TextCell (id=PeriodFinancials_RecoveredInPeriod_Cell) at PeriodFinancialsByLossTypeLV.pcf: line 114, column 45
  ...
  @javax.annotation.processing.Generated("config/web/pcf/dashboard/PeriodFinancialsByLossTypeLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PeriodFinancialsByLossTypeLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    public construct(widget :  Object) {
      super(widget, 0)
    }
    ...
    // '$$sumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 51, column 42
    function sumValueRoot_11 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 51, column 42
    function sumValue_10 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.ClosedClaims
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 59, column 45
    function sumValue_12 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.ExpensesOnClosed.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 67, column 45
    function sumValue_13 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.ClaimCostsOnClosed.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 75, column 45
    function sumValue_14 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.PaidOnClosed.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 90, column 45
    function sumValue_15 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.ExpensesInPeriod.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 98, column 45
    function sumValue_16 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.ClaimCostsInPeriod.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 106, column 45
    function sumValue_17 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.PaidInPeriod.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'footerSumValue' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 114, column 45
    function sumValue_18 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.RecoveredInPeriod.divide(1000).setScale(2, gw.api.util.CurrencyUtil.getRoundingMode())
    }
    
    // 'value' attribute on RowIterator at PeriodFinancialsByLossTypeLV.pcf: line 35, column 43
