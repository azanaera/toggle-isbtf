...
class ClaimSnapshotExposuresExpressions {
  ...
  public static class ClaimSnapshotExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_19 (Claim :  Claim) : java.lang.Boolean {
      return not gw.config.LOBAbstraction.ForClaim.ForLossType.isWorkComp(Claim) and gw.api.snapshot.ClaimSnapshotUtil.hasSnapshot(Claim) and perm.Claim.view(Claim) and perm.System.viewexposures and perm.System.viewsnapshot
    }
