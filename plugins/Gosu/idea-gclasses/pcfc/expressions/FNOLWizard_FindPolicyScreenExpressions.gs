...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/FNOLWizard_FindPolicyScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class FNOLWizard_FindPolicyScreenExpressions {
  ...
  public static class FNOLWizard_FindPolicyScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on BooleanRadioInput (id=ScreenMode_Input) at FNOLWizard_FindPolicyScreen.pcf: line 36, column 56
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      UseFindPolicy = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'editable' attribute on BooleanRadioInput (id=ScreenMode_Input) at FNOLWizard_FindPolicyScreen.pcf: line 36, column 56
    ...
    // 'showConfirmMessage' attribute on BooleanRadioInput (id=ScreenMode_Input) at FNOLWizard_FindPolicyScreen.pcf: line 36, column 56
