...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/checks/ApprovalHistoryLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ApprovalHistoryLVExpressions {
  ...
  public static class ApprovalHistoryLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=ApprovalHistory_Date_Cell) at ApprovalHistoryLV.pcf: line 25, column 39
    function sortValue_0 (Activity :  entity.Activity) : java.lang.Object {
      return Activity.CloseDate
    }
    
    // 'value' attribute on TextCell (id=User_Cell) at ApprovalHistoryLV.pcf: line 29, column 61
    function sortValue_1 (Activity :  entity.Activity) : java.lang.Object {
      return getApprovalUserOrGroupString( Activity )
    }
    
    // 'value' attribute on TextCell (id=Approved_Cell) at ApprovalHistoryLV.pcf: line 33, column 48
    function sortValue_2 (Activity :  entity.Activity) : java.lang.Object {
      return getApprovalString(Activity)
    }
    
    // 'value' attribute on TextCell (id=ApprovalIssue_Cell) at ApprovalHistoryLV.pcf: line 37, column 43
    function sortValue_3 (Activity :  entity.Activity) : java.lang.Object {
      return Activity.ApprovalIssue
    }
    
    // 'value' attribute on TextCell (id=ApprovalRationale_Cell) at ApprovalHistoryLV.pcf: line 41, column 47
