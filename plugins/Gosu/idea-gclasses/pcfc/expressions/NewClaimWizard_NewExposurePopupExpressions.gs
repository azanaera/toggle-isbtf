...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimWizard_NewExposurePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimWizard_NewExposurePopupExpressions {
  ...
  public static class NewClaimWizard_NewExposurePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function createExposure() : Exposure{
      var exposure = Wizard.addExposureWithNoIncident(Claim, Coverage, CoverageType, CoverageSubtype)
