...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimLostWagesBenefitsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimLostWagesBenefitsDVExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimLostWagesBenefitsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class NewClaimLostWagesBenefitsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at NewClaimLostWagesBenefitsDV.pcf: line 16, column 27
    function def_onEnter_0 (def :  pcf.EditableBenefitPeriodsLV) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on ListViewInput at NewClaimLostWagesBenefitsDV.pcf: line 152, column 27
    ...
    // 'value' attribute on DateInput (id=TTD_WaitingPeriodBegin_Input) at NewClaimLostWagesBenefitsDV.pcf: line 42, column 56
    function defaultSetter_11 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TTDBenefits.WaitPrdBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=TTD_WaitingPeriodEnd_Input) at NewClaimLostWagesBenefitsDV.pcf: line 48, column 54
    function defaultSetter_16 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TTDBenefits.WaitPrdEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TypeKeyInput (id=TTD_RetroactivePeriod_Input) at NewClaimLostWagesBenefitsDV.pcf: line 54, column 46
    function defaultSetter_21 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TTDBenefits.RetroPeriod = (__VALUE_TO_SET as typekey.RetroPeriodType)
    }
    
    // 'value' attribute on TypeKeyInput (id=TTD_PaymentFrequency_Input) at NewClaimLostWagesBenefitsDV.pcf: line 60, column 51
    function defaultSetter_25 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TTDBenefits.PaymentFrequency = (__VALUE_TO_SET as typekey.PaymentFrequencyType)
    }
    
    // 'value' attribute on CurrencyInput (id=TPD_MinStateCompRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 69, column 51
    function defaultSetter_29 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TPDBenefits.MinCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=TTD_MinStateCompRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 31, column 51
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TTDBenefits.MinCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=TPD_MaxStateCompRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 75, column 51
    function defaultSetter_33 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TPDBenefits.MaxCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TypeKeyInput (id=TPD_PaymentFrequency_Input) at NewClaimLostWagesBenefitsDV.pcf: line 81, column 51
    function defaultSetter_37 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TPDBenefits.PaymentFrequency = (__VALUE_TO_SET as typekey.PaymentFrequencyType)
    }
    
    // 'value' attribute on CurrencyInput (id=PTD_MinStateCompRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 90, column 51
    function defaultSetter_41 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PPDBenefits.MinCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=PTD_MaxStateCompRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 96, column 51
    function defaultSetter_45 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PPDBenefits.MaxCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on DateInput (id=PTD_MMIDate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 102, column 47
    ...
    // 'value' attribute on TypeKeyInput (id=PTD_PaymentFrequency_Input) at NewClaimLostWagesBenefitsDV.pcf: line 108, column 51
    function defaultSetter_55 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PPDBenefits.PaymentFrequency = (__VALUE_TO_SET as typekey.PaymentFrequencyType)
    }
    
    // 'value' attribute on CurrencyInput (id=TTD_MaxStateCompRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 37, column 51
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.TTDBenefits.MaxCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=Death_MaxBurialRate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 145, column 55
    ...
    // 'validationExpression' attribute on DateInput (id=TTD_WaitingPeriodEnd_Input) at NewClaimLostWagesBenefitsDV.pcf: line 48, column 54
    ...
    // 'validationExpression' attribute on DateInput (id=PTD_MMIDate_Input) at NewClaimLostWagesBenefitsDV.pcf: line 102, column 47
