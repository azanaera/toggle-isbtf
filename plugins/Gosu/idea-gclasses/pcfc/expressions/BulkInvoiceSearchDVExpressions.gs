...
@javax.annotation.processing.Generated("config/web/pcf/search/bulkpay/BulkInvoiceSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class BulkInvoiceSearchDVExpressions {
  ...
  public static class BulkInvoiceSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at BulkInvoiceSearchDV.pcf: line 12, column 77
    function def_onEnter_0 (def :  pcf.BulkInvoiceSearchRequiredInputSet) : void {
      def.onEnter(BulkInvoiceSearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at BulkInvoiceSearchDV.pcf: line 16, column 77
    function def_onEnter_2 (def :  pcf.BulkInvoiceSearchOptionalInputSet) : void {
      def.onEnter(BulkInvoiceSearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at BulkInvoiceSearchDV.pcf: line 20, column 41
