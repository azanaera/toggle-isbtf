...
class FinancialsSummaryExposureOnlyPrintExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/financials/summary/print/FinancialsSummaryExposureOnlyPrint.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FinancialsSummaryExposureOnlyPrintExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at FinancialsSummaryExposureOnlyPrint.pcf: line 24, column 67
    ...
    // 'initialValue' attribute on Variable at FinancialsSummaryExposureOnlyPrint.pcf: line 20, column 64
    function initialValue_0 () : gw.api.financials.summary.FinancialSummaryBridge {
      return new gw.api.financials.summary.FinancialSummaryBridge(Claim, "ExposureOnly")
    }
    
    // 'parent' attribute on Page (id=FinancialsSummaryExposureOnlyPrint) at FinancialsSummaryExposureOnlyPrint.pcf: line 8, column 77
    ...
    override property get CurrentLocation () : pcf.FinancialsSummaryExposureOnlyPrint {
      return super.CurrentLocation as pcf.FinancialsSummaryExposureOnlyPrint
    }
