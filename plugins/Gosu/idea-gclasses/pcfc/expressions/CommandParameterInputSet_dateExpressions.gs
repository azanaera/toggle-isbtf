...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/CommandParameterInputSet.date.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CommandParameterInputSet_dateExpressions {
  ...
  public static class CommandParameterInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=Date_Input) at CommandParameterInputSet.date.pcf: line 21, column 32
    ...
    // 'label' attribute on DateInput (id=Date_Input) at CommandParameterInputSet.date.pcf: line 21, column 32
