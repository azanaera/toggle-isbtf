...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleComparisonRowListInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleComparisonRowListInputSetExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends RuleComparisonRowListInputSetExpressionsImpl {
    ...
    // 'valueRange' attribute on RangeInput (id=Value_Input) at RuleComparisonRowListInputSet.pcf: line 29, column 30
    function valueRange_6 () : java.lang.Object {
      return {}
    }
    
    // 'value' attribute on RangeInput (id=Value_Input) at RuleComparisonRowListInputSet.pcf: line 29, column 30
    function value_5 () : String[] {
      return value.get()
    }
    
    // 'valueRange' attribute on RangeInput (id=Value_Input) at RuleComparisonRowListInputSet.pcf: line 29, column 30
    function verifyValueRangeIsAllowedType_7 ($$arg :  String[]) : void {
  ...
  public static class RuleComparisonRowListInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Label_Input) at RuleComparisonRowListInputSet.pcf: line 13, column 25
    ...
    // 'valueType' attribute on InputIterator (id=ValueIterator) at RuleComparisonRowListInputSet.pcf: line 22, column 75
    function verifyValueTypeIsAllowedType_11 ($$arg :  gw.api.iterator.IteratorBackingData) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
