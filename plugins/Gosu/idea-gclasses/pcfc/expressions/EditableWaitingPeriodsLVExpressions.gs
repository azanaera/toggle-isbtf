...
@javax.annotation.processing.Generated("config/web/pcf/claim/exposures/EditableWaitingPeriodsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableWaitingPeriodsLVExpressions {
  ...
  public static class EditableWaitingPeriodsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=DateStarted_Cell) at EditableWaitingPeriodsLV.pcf: line 35, column 29
    function sortValue_1 (WaitingPeriod :  entity.WCWaitingPeriod) : java.lang.Object {
      return WaitingPeriod.DateStarted
    }
    
    // 'value' attribute on DateCell (id=DateEnded_Cell) at EditableWaitingPeriodsLV.pcf: line 43, column 29
    function sortValue_2 (WaitingPeriod :  entity.WCWaitingPeriod) : java.lang.Object {
      return WaitingPeriod.DateEnded
    }
    
    // 'value' attribute on TextCell (id=WaitingDaysApplied_Cell) at EditableWaitingPeriodsLV.pcf: line 51, column 29
    function sortValue_3 (WaitingPeriod :  entity.WCWaitingPeriod) : java.lang.Object {
      return WaitingPeriod.WaitingDaysApplied
    }
    
    // 'value' attribute on TextCell (id=WaitingDaysRepaid_Cell) at EditableWaitingPeriodsLV.pcf: line 59, column 29
  ...
  public static class IteratorEntryExpressionsImpl extends EditableWaitingPeriodsLVExpressionsImpl {
    ...
    // 'validationExpression' attribute on TextCell (id=WaitingDaysApplied_Cell) at EditableWaitingPeriodsLV.pcf: line 51, column 29
    ...
    // 'validationExpression' attribute on TextCell (id=WaitingDaysRepaid_Cell) at EditableWaitingPeriodsLV.pcf: line 59, column 29
    ...
    // 'validationExpression' attribute on DateCell (id=DateStarted_Cell) at EditableWaitingPeriodsLV.pcf: line 35, column 29
