...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleComparisonCommandParametersInputSet.generateactivity.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleComparisonCommandParametersInputSet_generateactivityExpressions {
  ...
  public static class RuleComparisonCommandParametersInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef (id=subject) at RuleComparisonCommandParametersInputSet.generateactivity.pcf: line 19, column 182
    function def_onEnter_2 (def :  pcf.RuleComparisonRowLocalizedStringInputSet) : void {
      def.onEnter(commandDefinitionDiff, gw.bizrules.ruleaction.generateactivity.config.GenerateActivityCommandParameterSet.Config.SUBJECT.Name)
    }
    ...
    function def_onEnter_4 (def :  pcf.RuleComparisonRowLocalizedStringInputSet) : void {
      def.onEnter(commandDefinitionDiff, gw.bizrules.ruleaction.generateactivity.config.GenerateActivityCommandParameterSet.Config.DESCRIPTION.Name)
    }
    ...
    // 'def' attribute on InputSetRef (id=subject) at RuleComparisonCommandParametersInputSet.generateactivity.pcf: line 19, column 182
    function def_refreshVariables_3 (def :  pcf.RuleComparisonRowLocalizedStringInputSet) : void {
      def.refreshVariables(commandDefinitionDiff, gw.bizrules.ruleaction.generateactivity.config.GenerateActivityCommandParameterSet.Config.SUBJECT.Name)
    }
    ...
    // 'def' attribute on InputSetRef (id=description) at RuleComparisonCommandParametersInputSet.generateactivity.pcf: line 22, column 186
    function def_refreshVariables_5 (def :  pcf.RuleComparisonRowLocalizedStringInputSet) : void {
      def.refreshVariables(commandDefinitionDiff, gw.bizrules.ruleaction.generateactivity.config.GenerateActivityCommandParameterSet.Config.DESCRIPTION.Name)
    }
