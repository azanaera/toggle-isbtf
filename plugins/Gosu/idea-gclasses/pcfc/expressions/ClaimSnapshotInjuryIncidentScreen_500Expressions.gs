...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/500/ClaimSnapshotInjuryIncidentScreen.500.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotInjuryIncidentScreen_500Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/500/ClaimSnapshotInjuryIncidentScreen.500.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotInjuryIncidentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotInjuryIncidentScreen.500.pcf: line 17, column 62
    function def_onEnter_1 (def :  pcf.ClaimSnapshotInjuryIncident500DV) : void {
      def.onEnter(IncidentParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotInjuryIncidentScreen.500.pcf: line 17, column 62
    function def_refreshVariables_2 (def :  pcf.ClaimSnapshotInjuryIncident500DV) : void {
      def.refreshVariables(IncidentParam)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotInjuryIncidentScreen.500.pcf: line 14, column 31
