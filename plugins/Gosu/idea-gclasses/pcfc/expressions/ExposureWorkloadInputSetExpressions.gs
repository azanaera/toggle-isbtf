...
@javax.annotation.processing.Generated("config/web/pcf/claim/shared/ExposureWorkloadInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ExposureWorkloadInputSetExpressions {
  ...
  public static class ExposureWorkloadInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=SupplementalWorkloadWeight_Input) at ExposureWorkloadInputSet.pcf: line 36, column 38
    function defaultSetter_12 (__VALUE_TO_SET :  java.lang.Object) : void {
      exposure.SupplementalWorkloadWeight = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'editable' attribute on TextInput (id=SupplementalWorkloadWeight_Input) at ExposureWorkloadInputSet.pcf: line 36, column 38
    ...
    // 'value' attribute on TextInput (id=ClassificationWorkload_Input) at ExposureWorkloadInputSet.pcf: line 30, column 38
    ...
    // 'value' attribute on TextInput (id=TotalWorkloadWeight_Input) at ExposureWorkloadInputSet.pcf: line 41, column 38
    function value_16 () : java.lang.Integer {
      return exposure.WorkloadWeight
    }
    
    // 'value' attribute on TextInput (id=Classification_Input) at ExposureWorkloadInputSet.pcf: line 24, column 38
    ...
    // 'visible' attribute on TextInput (id=Classification_Input) at ExposureWorkloadInputSet.pcf: line 24, column 38
