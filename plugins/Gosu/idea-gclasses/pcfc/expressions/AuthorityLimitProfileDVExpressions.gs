...
@javax.annotation.processing.Generated("config/web/pcf/admin/authoritylimits/AuthorityLimitProfileDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AuthorityLimitProfileDVExpressions {
  ...
  public static class AuthorityLimitProfileDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=Currency_Input) at AuthorityLimitProfileDV.pcf: line 29, column 66
    ...
    // 'value' attribute on TypeKeyCell (id=LimitType_Cell) at AuthorityLimitProfileDV.pcf: line 58, column 57
    function sortValue_14 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.LimitType
    }
    
    // 'value' attribute on TypeKeyCell (id=PolicyType_Cell) at AuthorityLimitProfileDV.pcf: line 64, column 48
    function sortValue_15 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.PolicyType
    }
    
    // 'value' attribute on TypeKeyCell (id=CoverageType_Cell) at AuthorityLimitProfileDV.pcf: line 74, column 50
    function sortValue_16 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.CoverageType
    }
    
    // 'value' attribute on TypeKeyCell (id=CostType_Cell) at AuthorityLimitProfileDV.pcf: line 84, column 47
    function sortValue_17 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.CostType
    }
    
    // 'value' attribute on CurrencyCell (id=LimitAmount_Cell) at AuthorityLimitProfileDV.pcf: line 90, column 53
    ...
    // 'visible' attribute on TypeKeyInput (id=Currency_Input) at AuthorityLimitProfileDV.pcf: line 29, column 66
  ...
  public static class IteratorEntryExpressionsImpl extends AuthorityLimitProfileDVExpressionsImpl {
    ...
    // 'onChange' attribute on PostOnChange at AuthorityLimitProfileDV.pcf: line 67, column 128
    function onChange_23 () : void {
      gw.plugin.authoritylimits.AuthorityLimitsConfiguration.validateTypecodeHierarchy(AuthorityLimit)
    }
    
    // 'onChange' attribute on PostOnChange at AuthorityLimitProfileDV.pcf: line 77, column 128
