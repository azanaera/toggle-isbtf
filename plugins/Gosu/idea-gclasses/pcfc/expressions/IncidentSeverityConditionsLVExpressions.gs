...
@javax.annotation.processing.Generated("config/web/pcf/admin/workload/conditions/IncidentSeverityConditionsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class IncidentSeverityConditionsLVExpressions {
  ...
  public static class IncidentSeverityConditionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=IncidentSeverity_Cell) at IncidentSeverityConditionsLV.pcf: line 28, column 45
