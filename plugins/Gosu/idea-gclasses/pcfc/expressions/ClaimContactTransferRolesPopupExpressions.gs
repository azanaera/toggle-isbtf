...
@javax.annotation.processing.Generated("config/web/pcf/claim/partiesinvolved/ClaimContactTransferRolesPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimContactTransferRolesPopupExpressions {
  ...
  public static class ClaimContactTransferRolesPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=RemoveFromSourceContacts) at ClaimContactTransferRolesPopup.pcf: line 128, column 31
    ...
    // 'label' attribute on ListViewInput (id=SourceContact) at ClaimContactTransferRolesPopup.pcf: line 120, column 31
    ...
    // 'label' attribute on Verbatim at ClaimContactTransferRolesPopup.pcf: line 190, column 176
    ...
    // 'sortBy' attribute on TextCell (id=Name_Cell) at ClaimContactTransferRolesPopup.pcf: line 78, column 49
    ...
    // 'value' attribute on TextCell (id=Roles_Cell) at ClaimContactTransferRolesPopup.pcf: line 82, column 61
    function sortValue_12 (ChooseClaimContact :  entity.ClaimContact) : java.lang.Object {
      return ChooseClaimContact.RolesString
    }
    
    // 'value' attribute on BooleanRadioCell (id=ContactProhibited_Cell) at ClaimContactTransferRolesPopup.pcf: line 87, column 39
    function sortValue_13 (ChooseClaimContact :  entity.ClaimContact) : java.lang.Object {
      return ChooseClaimContact.ContactProhibited
    }
    
    // 'value' attribute on TextCell (id=Phone_Work_Cell) at ClaimContactTransferRolesPopup.pcf: line 92, column 75
    ...
    // 'sortBy' attribute on TextCell (id=Address_Cell) at ClaimContactTransferRolesPopup.pcf: line 97, column 92
    ...
    // 'sortBy' attribute on TextCell (id=City_Cell) at ClaimContactTransferRolesPopup.pcf: line 102, column 84
    ...
    // 'value' attribute on TypeKeyCell (id=State_Cell) at ClaimContactTransferRolesPopup.pcf: line 107, column 48
    ...
    // 'value' attribute on TextCell (id=PostalCode_Cell) at ClaimContactTransferRolesPopup.pcf: line 111, column 83
    ...
    // 'sortBy' attribute on TextCell (id=Name_Cell) at ClaimContactTransferRolesPopup.pcf: line 148, column 49
    ...
    // 'value' attribute on TextCell (id=Roles_Cell) at ClaimContactTransferRolesPopup.pcf: line 152, column 61
    function sortValue_50 (SourceClaimContact :  entity.ClaimContact) : java.lang.Object {
      return SourceClaimContact.RolesString
    }
    
    // 'value' attribute on BooleanRadioCell (id=ContactProhibited_Cell) at ClaimContactTransferRolesPopup.pcf: line 157, column 39
    function sortValue_51 (SourceClaimContact :  entity.ClaimContact) : java.lang.Object {
      return SourceClaimContact.ContactProhibited
    }
    
    // 'value' attribute on TextCell (id=Phone_Work_Cell) at ClaimContactTransferRolesPopup.pcf: line 162, column 75
    ...
    // 'sortBy' attribute on TextCell (id=Address_Cell) at ClaimContactTransferRolesPopup.pcf: line 167, column 92
    ...
    // 'sortBy' attribute on TextCell (id=City_Cell) at ClaimContactTransferRolesPopup.pcf: line 172, column 84
    ...
    // 'value' attribute on TypeKeyCell (id=State_Cell) at ClaimContactTransferRolesPopup.pcf: line 177, column 48
    ...
    // 'value' attribute on TextCell (id=PostalCode_Cell) at ClaimContactTransferRolesPopup.pcf: line 181, column 83
    ...
    // 'value' attribute on RowIterator at ClaimContactTransferRolesPopup.pcf: line 138, column 76
  ...
  public static class IteratorEntry2ExpressionsImpl extends ClaimContactTransferRolesPopupExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at ClaimContactTransferRolesPopup.pcf: line 148, column 49
    ...
    // 'value' attribute on TextCell (id=Address_Cell) at ClaimContactTransferRolesPopup.pcf: line 167, column 92
    ...
    // 'value' attribute on TextCell (id=City_Cell) at ClaimContactTransferRolesPopup.pcf: line 172, column 84
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimContactTransferRolesPopupExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at ClaimContactTransferRolesPopup.pcf: line 78, column 49
    ...
    // 'value' attribute on TextCell (id=Address_Cell) at ClaimContactTransferRolesPopup.pcf: line 97, column 92
    ...
    // 'value' attribute on TextCell (id=City_Cell) at ClaimContactTransferRolesPopup.pcf: line 102, column 84
