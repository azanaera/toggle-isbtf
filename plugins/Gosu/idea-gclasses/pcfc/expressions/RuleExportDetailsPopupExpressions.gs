...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleExportDetailsPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleExportDetailsPopupExpressions {
  ...
  public static class RuleExportDetailsPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at RuleExportDetailsPopup.pcf: line 55, column 93
    ...
    // 'value' attribute on TextInput (id=Status_Input) at RuleExportDetailsPopup.pcf: line 51, column 166
    ...
    // 'value' attribute on TextInput (id=StartedBy_Input) at RuleExportDetailsPopup.pcf: line 34, column 55
    function valueRoot_4 () : java.lang.Object {
      return exportTask.StartedBy
    }
    
    // 'value' attribute on DateInput (id=Created_Input) at RuleExportDetailsPopup.pcf: line 40, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=RuleType_Input) at RuleExportDetailsPopup.pcf: line 47, column 39
    function value_9 () : typekey.Rule {
