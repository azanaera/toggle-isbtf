...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/transactions/TransactionDetailToolbarButtonSet.payment.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TransactionDetailToolbarButtonSet_paymentExpressions {
  ...
  public static class TransactionDetailToolbarButtonSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function available_9 () : java.lang.Boolean {
      return (Payment.Check.Status == TransactionStatus.TC_ISSUED or Payment.Check.Status == TransactionStatus.TC_CLEARED) and Payment.Recodeable and perm.Payment.recode(Transaction)
    }
