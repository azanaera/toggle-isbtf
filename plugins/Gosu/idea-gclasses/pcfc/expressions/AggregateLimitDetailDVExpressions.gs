...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/AggregateLimitDetailDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AggregateLimitDetailDVExpressions {
  ...
  public static class AggregateLimitDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'available' attribute on CurrencyInput (id=AggregateLimit_LimitAmount_Input) at AggregateLimitDetailDV.pcf: line 51, column 45
    function available_15 () : java.lang.Boolean {
      return PolicyPeriodType != null
    }
    
    // 'def' attribute on ListViewInput at AggregateLimitDetailDV.pcf: line 83, column 87
    function def_onEnter_40 (def :  pcf.AggregateLimitCoveragesLV) : void {
      def.onEnter(AggregateLimitHelper, Policy, AggregateLimit)
    }
    
    // 'def' attribute on ListViewInput (id=agglimitsListView) at AggregateLimitDetailDV.pcf: line 102, column 34
    ...
    // 'value' attribute on TypeKeyInput (id=AggregateLimit_ValueType_Input) at AggregateLimitDetailDV.pcf: line 41, column 43
    function defaultSetter_12 (__VALUE_TO_SET :  java.lang.Object) : void {
      AggregateLimit.ValueType = (__VALUE_TO_SET as typekey.AggregateType)
    }
    
    // 'value' attribute on CurrencyInput (id=AggregateLimit_LimitAmount_Input) at AggregateLimitDetailDV.pcf: line 51, column 45
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      AggregateLimit.LimitAmount = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TypeKeyInput (id=aggLimitCalcCriteria_Input) at AggregateLimitDetailDV.pcf: line 72, column 51
    function defaultSetter_32 (__VALUE_TO_SET :  java.lang.Object) : void {
      AggregateLimit.AggLimitCalcCriteria = (__VALUE_TO_SET as typekey.AggLimitCalcCriteria)
    }
    
    // 'value' attribute on TextAreaInput (id=AggregateLimit_Comments_Input) at AggregateLimitDetailDV.pcf: line 79, column 42
    function defaultSetter_36 (__VALUE_TO_SET :  java.lang.Object) : void {
      AggregateLimit.Comments = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on RangeInput (id=AggregateLimit_PolicyPeriodType_Input) at AggregateLimitDetailDV.pcf: line 31, column 46
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      PolicyPeriodType = (__VALUE_TO_SET as typekey.PolicyPeriodType)
    }
    
    // 'editable' attribute on RangeInput (id=AggregateLimit_PolicyPeriodType_Input) at AggregateLimitDetailDV.pcf: line 31, column 46
    ...
    // 'editable' attribute on ListViewInput at AggregateLimitDetailDV.pcf: line 83, column 87
    ...
    // 'showConfirmMessage' attribute on RangeInput (id=AggregateLimit_PolicyPeriodType_Input) at AggregateLimitDetailDV.pcf: line 31, column 46
    function showConfirmMessage_3 () : java.lang.Boolean {
      return PolicyPeriodType != null and not AggregateLimit.CoverageLines.IsEmpty
    }
    
    // 'valueRange' attribute on RangeInput (id=AggregateLimit_PolicyPeriodType_Input) at AggregateLimitDetailDV.pcf: line 31, column 46
    ...
    // 'value' attribute on CurrencyInput (id=AggregateLimit_AmountUsed_Input) at AggregateLimitDetailDV.pcf: line 58, column 51
    function value_22 () : gw.api.financials.CurrencyAmount {
      return AggregateLimit.LimitUsed
    }
    
    // 'value' attribute on CurrencyInput (id=AggregateLimit_AmountRemaining_Input) at AggregateLimitDetailDV.pcf: line 65, column 51
    ...
    // 'value' attribute on RangeInput (id=AggregateLimit_PolicyPeriodType_Input) at AggregateLimitDetailDV.pcf: line 31, column 46
    function value_4 () : typekey.PolicyPeriodType {
      return PolicyPeriodType
    }
    
    // 'value' attribute on TextInput (id=lid1_Input) at AggregateLimitDetailDV.pcf: line 99, column 105
    ...
    // 'valueRange' attribute on RangeInput (id=AggregateLimit_PolicyPeriodType_Input) at AggregateLimitDetailDV.pcf: line 31, column 46
    function verifyValueRangeIsAllowedType_7 ($$arg :  typekey.PolicyPeriodType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on CurrencyInput (id=AggregateLimit_AmountUsed_Input) at AggregateLimitDetailDV.pcf: line 58, column 51
    function visible_21 () : java.lang.Boolean {
      return not CurrentLocation.InEditMode
    }
    
    // 'visible' attribute on TextInput (id=lid1_Input) at AggregateLimitDetailDV.pcf: line 99, column 105
