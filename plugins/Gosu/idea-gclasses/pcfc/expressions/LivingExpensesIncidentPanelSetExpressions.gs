...
@javax.annotation.processing.Generated("config/web/pcf/claim/incidents/LivingExpensesIncidentPanelSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LivingExpensesIncidentPanelSetExpressions {
  ...
  public static class LivingExpensesIncidentPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=Description_Input) at LivingExpensesIncidentPanelSet.pcf: line 24, column 47
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      incident.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=MealsDays_Input) at LivingExpensesIncidentPanelSet.pcf: line 52, column 48
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      incident.MealsDays = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on TextInput (id=MealsPeople_Input) at LivingExpensesIncidentPanelSet.pcf: line 58, column 48
    function defaultSetter_18 (__VALUE_TO_SET :  java.lang.Object) : void {
      incident.MealsPeople = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on CurrencyInput (id=MealsRate_Input) at LivingExpensesIncidentPanelSet.pcf: line 63, column 45
    ...
    // 'value' attribute on CurrencyInput (id=TotalMealsEstimate_Input) at LivingExpensesIncidentPanelSet.pcf: line 38, column 54
    ...
    // 'value' attribute on TextInput (id=ExpectedDuration_Input) at LivingExpensesIncidentPanelSet.pcf: line 28, column 60
    function value_4 () : java.lang.String {
      return incident.ExpectedDurationEstimate
    }
    
    // 'value' attribute on CurrencyInput (id=TotalLodgingEstimate_Input) at LivingExpensesIncidentPanelSet.pcf: line 33, column 56
    function value_7 () : gw.api.financials.CurrencyAmount {
      return incident.TotalLodgingEstimate
    }
    
    // 'visible' attribute on TextInput (id=ServiceRequestSubmitMessageFNOL_Input) at LivingExpensesIncidentPanelSet.pcf: line 86, column 54
    function visible_27 () : java.lang.Boolean {
      return incident.Claim.DraftClaim
    }
    
    // 'visible' attribute on TextInput (id=ServiceRequestSubmitMessage_Input) at LivingExpensesIncidentPanelSet.pcf: line 91, column 89
