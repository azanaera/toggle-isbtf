...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleExportImportFailurePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleExportImportFailurePopupExpressions {
  ...
  public static class RuleExportImportFailurePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Message_Input) at RuleExportImportFailurePopup.pcf: line 23, column 30
