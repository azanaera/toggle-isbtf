...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/ServiceRequestMessagePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ServiceRequestMessagePopupExpressions {
  ...
  public static class ServiceRequestMessagePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=MessageContent_Input) at ServiceRequestMessagePopup.pcf: line 57, column 49
    function defaultSetter_11 (__VALUE_TO_SET :  java.lang.Object) : void {
      serviceRequestMessage.Body = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyRadioInput (id=MessageType_Input) at ServiceRequestMessagePopup.pcf: line 42, column 60
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      serviceRequestMessage.Type = (__VALUE_TO_SET as typekey.ServiceRequestMessageType)
    }
    
    // 'value' attribute on TextInput (id=MessageTitle_Input) at ServiceRequestMessagePopup.pcf: line 49, column 50
