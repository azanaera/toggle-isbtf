...
@javax.annotation.processing.Generated("config/web/pcf/claim/shared/TransactionEditWrapperExchangeRateInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TransactionEditWrapperExchangeRateInputSetExpressions {
  ...
  public static class TransactionEditWrapperExchangeRateInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=ExchangeRate_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 31, column 40
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      transactionEditWrapper.ExchangeRateRate = (__VALUE_TO_SET as java.math.BigDecimal)
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 38, column 85
    function defaultSetter_16 (__VALUE_TO_SET :  java.lang.Object) : void {
      transaction.TransToReservingExchangeRate.ExchangeRateSet.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on BooleanRadioInput (id=ManualOrAutomatic_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 21, column 59
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      transactionEditWrapper.OverrideExchangeRate = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'editable' attribute on BooleanRadioInput (id=ManualOrAutomatic_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 21, column 59
    function editable_1 () : java.lang.Boolean {
      return perm.ExchangeRate.edit
    }
    
    // 'editable' attribute on TextInput (id=ExchangeRate_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 31, column 40
    function editable_7 () : java.lang.Boolean {
      return transaction.OverrideTransToReservingExchangeRate
    }
    
    // 'format' attribute on TextInput (id=ExchangeRate_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 31, column 40
    ...
    // 'value' attribute on DateInput (id=Date_Input) at TransactionEditWrapperExchangeRateInputSet.pcf: line 42, column 87
