...
@javax.annotation.processing.Generated("config/web/pcf/claim/workplan/ClaimWorkplan.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimWorkplanExpressions {
  ...
  public static class ClaimWorkplanExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=ClaimWorkplan_AssignButton) at ClaimWorkplan.pcf: line 27, column 25
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=ClaimWorkplan_SkipButton) at ClaimWorkplan.pcf: line 34, column 25
    function checkedRowAction_1 (element :  entity.Activity, CheckedValue :  entity.Activity) : void {
       CheckedValue.skip()
    }
    
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=ClaimWorkplan_CompleteButton) at ClaimWorkplan.pcf: line 41, column 25
    function checkedRowAction_2 (element :  entity.Activity, CheckedValue :  entity.Activity) : void {
       CheckedValue.complete()
    }
    
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=ClaimWorkplan_ApproveButton) at ClaimWorkplan.pcf: line 49, column 25
    function checkedRowAction_3 (element :  entity.Activity, CheckedValue :  entity.Activity) : void {
       CheckedValue.approve()
    }
    
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=ClaimWorkplan_RejectButton) at ClaimWorkplan.pcf: line 56, column 25
    function checkedRowAction_4 (element :  entity.Activity, CheckedValue :  entity.Activity) : void {
       CheckedValue.reject()
    }
    
    // 'def' attribute on PanelRef at ClaimWorkplan.pcf: line 60, column 130
