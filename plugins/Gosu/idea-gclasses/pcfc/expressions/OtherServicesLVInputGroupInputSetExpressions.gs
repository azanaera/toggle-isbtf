...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/OtherServicesLVInputGroupInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class OtherServicesLVInputGroupInputSetExpressions {
  ...
  public static class OtherServicesLVInputGroupInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'allowToggle' attribute on InputGroup (id=OtherServicesInputGroup) at OtherServicesLVInputGroupInputSet.pcf: line 35, column 52
    function available_4 () : java.lang.Boolean {
      return areAllOtherRequestsEditable()
    }
    
    // 'def' attribute on InputSetRef at OtherServicesLVInputGroupInputSet.pcf: line 37, column 117
    ...
    // 'label' attribute on InputGroup (id=OtherServicesInputGroup) at OtherServicesLVInputGroupInputSet.pcf: line 35, column 52
    function label_5 () : java.lang.Object {
      return incident != null ? DisplayKey.get("Web.ServicesScreen.OtherServices") : DisplayKey.get("Web.ServicesScreen.OtherServices.ClaimLevel")
    }
    
    // 'onToggle' attribute on InputGroup (id=OtherServicesInputGroup) at OtherServicesLVInputGroupInputSet.pcf: line 35, column 52
    function setter_6 (VALUE :  java.lang.Boolean) : void {
      toggleOtherServiceRequests(VALUE)
    }
    
    // 'childrenVisible' attribute on InputGroup (id=OtherServicesInputGroup) at OtherServicesLVInputGroupInputSet.pcf: line 35, column 52
