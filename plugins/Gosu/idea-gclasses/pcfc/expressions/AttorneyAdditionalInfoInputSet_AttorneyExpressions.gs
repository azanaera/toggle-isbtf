...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/AttorneyAdditionalInfoInputSet.Attorney.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AttorneyAdditionalInfoInputSet_AttorneyExpressions {
  ...
  public static class AttorneyAdditionalInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=AttorneyLicense_Input) at AttorneyAdditionalInfoInputSet.Attorney.pcf: line 24, column 41
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Attorney.AttorneyLicense = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=AttorneySpecialty_Input) at AttorneyAdditionalInfoInputSet.Attorney.pcf: line 30, column 43
