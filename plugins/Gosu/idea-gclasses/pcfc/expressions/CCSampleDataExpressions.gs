...
class CCSampleDataExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ScreenExpressionsImpl {
    ...
    // 'action' attribute on ButtonCell (id=LoadSampleDataButton_Cell) at CCSampleData.pcf: line 29, column 74
    function action_3 () : void {
      result = dataGroup.load()
    }
    
    // 'value' attribute on TextCell (id=DataGroupName_Cell) at CCSampleData.pcf: line 33, column 44
    ...
    // 'value' attribute on TextCell (id=DataGroupDescription_Cell) at CCSampleData.pcf: line 37, column 51
