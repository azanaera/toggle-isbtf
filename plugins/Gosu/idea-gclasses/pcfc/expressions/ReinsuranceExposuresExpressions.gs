...
@javax.annotation.processing.Generated("config/web/pcf/claim/reinsurance/ReinsuranceExposures.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ReinsuranceExposuresExpressions {
  ...
  public static class IteratorEntry2ExpressionsImpl extends IteratorEntryExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=ExposureName_Cell) at ReinsuranceExposures.pcf: line 95, column 32
  ...
  public static class IteratorEntry3ExpressionsImpl extends ReinsuranceExposuresExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=ExposureName_Cell) at ReinsuranceExposures.pcf: line 152, column 47
  ...
  public static class IteratorEntryExpressionsImpl extends ReinsuranceExposuresExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=riAgreementGroup_Cell) at ReinsuranceExposures.pcf: line 69, column 30
  ...
  public static class ReinsuranceExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=RetrieveReinsuranceButton) at ReinsuranceExposures.pcf: line 131, column 56
    ...
    // 'available' attribute on CheckedValuesToolbarButton (id=AddToAgreementGroupButton) at ReinsuranceExposures.pcf: line 123, column 92
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=AddToAgreementGroupButton) at ReinsuranceExposures.pcf: line 123, column 92
    ...
    // 'value' attribute on ToolbarRangeInput (id=SelectedAgreementDropdown_Input) at ReinsuranceExposures.pcf: line 115, column 49
    ...
    // 'sortBy' attribute on IteratorSort at ReinsuranceExposures.pcf: line 146, column 30
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=SelectedAgreementDropdown_Input) at ReinsuranceExposures.pcf: line 115, column 49
    ...
    // 'value' attribute on RowIterator (id=ExposureWithoutRIIterator) at ReinsuranceExposures.pcf: line 143, column 43
    function value_31 () : entity.Exposure[] {
      return claim.Exposures.where( \ exp -> exp.RIAgreementGroup == null)
    }
    
    // 'valueRange' attribute on ToolbarRangeInput (id=SelectedAgreementDropdown_Input) at ReinsuranceExposures.pcf: line 115, column 49
    function verifyValueRangeIsAllowedType_20 ($$arg :  entity.RIAgreementGroup[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on ToolbarRangeInput (id=SelectedAgreementDropdown_Input) at ReinsuranceExposures.pcf: line 115, column 49
    function verifyValueRangeIsAllowedType_20 ($$arg :  gw.api.database.IQueryBeanResult<entity.RIAgreementGroup>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
