...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotContactEFT700LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotContactEFT700LVExpressions {
  ...
  public static class ClaimSnapshotContactEFT700LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=AccountName_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 24, column 40
    function sortValue_0 (EFTRecord :  dynamic.Dynamic) : java.lang.Object {
      return EFTRecord.AccountName
    }
    
    // 'value' attribute on TextCell (id=BankName_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 29, column 40
    function sortValue_1 (EFTRecord :  dynamic.Dynamic) : java.lang.Object {
      return EFTRecord.BankName
    }
    
    // 'value' attribute on TextCell (id=BankAccountType_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 34, column 40
    function sortValue_2 (EFTRecord :  dynamic.Dynamic) : java.lang.Object {
      return EFTRecord.BankAccountType
    }
    
    // 'value' attribute on PrivacyCell (id=BankAccountNumber_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 40, column 40
    function sortValue_3 (EFTRecord :  dynamic.Dynamic) : java.lang.Object {
      return EFTRecord.BankAccountNumber
    }
    
    // 'value' attribute on TextCell (id=BankRoutingNumber_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 46, column 40
    function sortValue_4 (EFTRecord :  dynamic.Dynamic) : java.lang.Object {
      return EFTRecord.BankRoutingNumber
    }
    
    // 'value' attribute on TextCell (id=IsPrimary_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 51, column 40
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotContactEFT700LVExpressionsImpl {
    ...
    // 'encryptionExpression' attribute on PrivacyCell (id=BankAccountNumber_Cell) at ClaimSnapshotContactEFT700LV.pcf: line 40, column 40
