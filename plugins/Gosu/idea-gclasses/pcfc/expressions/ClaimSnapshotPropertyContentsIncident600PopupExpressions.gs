...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotPropertyContentsIncident600Popup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPropertyContentsIncident600PopupExpressions {
  ...
  public static class ClaimSnapshotPropertyContentsIncident600PopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 59, column 27
    ...
    // 'icon' attribute on TitleBar at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 35, column 33
    ...
    // 'mode' attribute on PanelRef at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 59, column 27
    function mode_16 () : java.lang.Object {
      return 600
    }
    
    // 'value' attribute on TextCell (id=ScheduledItemDescription_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 85, column 46
    function sortValue_18 (scheduledItem :  dynamic.Dynamic) : java.lang.Object {
      return scheduledItem.PropertyItem.Description
    }
    
    // 'value' attribute on TextCell (id=ScheduledItemValue_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 91, column 46
    function sortValue_19 (scheduledItem :  dynamic.Dynamic) : java.lang.Object {
      return scheduledItem.PropertyItem.AppraisedValue
    }
    
    // 'value' attribute on TextCell (id=LineItemQuantity_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 117, column 46
    function sortValue_29 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.NumberOfItems
    }
    
    // 'value' attribute on TextCell (id=LineItemName_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 124, column 46
    function sortValue_30 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.Description
    }
    
    // 'value' attribute on TextCell (id=LineItemCategory_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 130, column 46
    function sortValue_31 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.ContentCategory
    }
    
    // 'value' attribute on TextCell (id=LineItemPurchaseDate_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 145, column 39
    function sortValue_33 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.DateAcquired
    }
    
    // 'value' attribute on TextCell (id=LineItemAge_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 151, column 46
    function sortValue_35 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.Age
    }
    
    // 'value' attribute on TextCell (id=LineItemNotes_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 194, column 126
    function sortValue_37 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.ItemComment
    }
    
    // '$$sumValue' attribute on RowIterator (id=PropertyContentsScheduledItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 91, column 46
    function sumValueRoot_21 (scheduledItem :  dynamic.Dynamic) : java.lang.Object {
      return scheduledItem.PropertyItem
    }
    
    // '$$sumValue' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 169, column 35
    function sumValueRoot_43 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.ReplacementValue
    }
    
    // '$$sumValue' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 178, column 35
    function sumValueRoot_45 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.ActualCashValue
    }
    
    // '$$sumValue' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 187, column 35
    function sumValueRoot_47 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.AmountAfterLimit
    }
    
    // 'footerSumValue' attribute on RowIterator (id=PropertyContentsScheduledItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 91, column 46
    function sumValue_20 (scheduledItem :  dynamic.Dynamic) : java.lang.Object {
      return scheduledItem.PropertyItem.AppraisedValue
    }
    
    // 'footerSumValue' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 169, column 35
    function sumValue_42 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.ReplacementValue.Amount
    }
    
    // 'footerSumValue' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 178, column 35
    function sumValue_44 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.ActualCashValue.Amount
    }
    
    // 'footerSumValue' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 187, column 35
    function sumValue_46 (item :  dynamic.Dynamic) : java.lang.Object {
      return item.AmountAfterLimit.Amount
    }
    
    // 'title' attribute on TitleBar (id=ScheduledItemsTitle) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 66, column 258
    ...
    // 'value' attribute on TextAreaInput (id=Description_Input) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 51, column 50
    function valueRoot_6 () : java.lang.Object {
      return incident
    }
    
    // 'value' attribute on RowIterator (id=PropertyContentsScheduledItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 76, column 41
    ...
    // 'value' attribute on RowIterator (id=PropertyContentsLineItems) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 109, column 41
    function value_86 () : dynamic.Dynamic {
      return incident.ContentItemLine
    }
    
    // 'visible' attribute on TextCell (id=LineItemOriginalCost_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 139, column 35
    function visible_32 () : java.lang.Boolean {
      return InEditMode
    }
    
    // 'visible' attribute on TextCell (id=LineItemNotes_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 194, column 126
  ...
  public static class IteratorEntry2ExpressionsImpl extends ClaimSnapshotPropertyContentsIncident600PopupExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=LineItemOriginalCost_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 139, column 35
    ...
    // 'value' attribute on TextCell (id=LineItemDepreciationPercentage_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 160, column 35
    function value_69 () : dynamic.Dynamic {
      return item.DepreciationPercentage
    }
    
    // 'value' attribute on TextCell (id=LineItemReplacementValue_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 169, column 35
    function value_73 () : dynamic.Dynamic {
      return item.ReplacementValue
    }
    
    // 'value' attribute on TextCell (id=LineItemTotalACV_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 178, column 35
    function value_76 () : dynamic.Dynamic {
      return item.ActualCashValue
    }
    
    // 'value' attribute on TextCell (id=LineItemAmountAfterLimit_Cell) at ClaimSnapshotPropertyContentsIncident600Popup.pcf: line 187, column 35
