...
class DesktopClaimsExpressions {
  ...
  public static class DesktopClaimsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=DesktopClaims_PrintButton) at DesktopClaims.pcf: line 41, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopClaims_AssignButton) at DesktopClaims.pcf: line 33, column 25
    ...
    // 'available' attribute on ToolbarButton (id=DesktopClaims_PrintButton) at DesktopClaims.pcf: line 41, column 25
    ...
    // 'def' attribute on PanelRef at DesktopClaims.pcf: line 44, column 83
