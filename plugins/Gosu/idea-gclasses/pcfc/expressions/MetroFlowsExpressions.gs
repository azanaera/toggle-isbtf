...
class MetroFlowsExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends MetroFlowsExpressionsImpl {
    ...
    // 'action' attribute on ToolbarButton (id=MetroFlows_ResumeAllButton) at MetroFlows.pcf: line 40, column 29
    function action_3 () : void {
      gw.api.admin.WorkflowUtil.resumeAllWorkflows()
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=MetroFlows_ResumeButton) at MetroFlows.pcf: line 34, column 29
