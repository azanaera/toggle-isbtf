...
@javax.annotation.processing.Generated("config/web/pcf/claim/newexposure/NewWageBenefitsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewWageBenefitsDVExpressions {
  ...
  public static class NewWageBenefitsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on CurrencyInput (id=CompBenefits_WeeklyCompRate_Input) at NewWageBenefitsDV.pcf: line 32, column 55
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.CompBenefits.WeeklyCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TypeKeyInput (id=CompBenefits_PaymentFrequency_Input) at NewWageBenefitsDV.pcf: line 38, column 51
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.CompBenefits.PaymentFrequency = (__VALUE_TO_SET as typekey.PaymentFrequencyType)
    }
    
    // 'value' attribute on DateInput (id=CompBenefits_BenefitsBeginDate_Input) at NewWageBenefitsDV.pcf: line 21, column 58
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.CompBenefits.BenefitsBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=CompBenefits_BenefitsEndDate_Input) at NewWageBenefitsDV.pcf: line 27, column 56
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.CompBenefits.BenefitsEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=CompBenefits_BenefitsEndDate_Input) at NewWageBenefitsDV.pcf: line 27, column 56
