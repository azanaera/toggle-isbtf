...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/PaymentDeductionsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PaymentDeductionsDVExpressions {
  ...
  public static class PaymentDeductionsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'editable' attribute on CurrencyInput (id=Amount_Reportable_Input) at PaymentDeductionsDV.pcf: line 33, column 47
    function editable_6 () : java.lang.Boolean {
      return Check.isEditable()
    }
    
    // 'validationExpression' attribute on CurrencyInput (id=Amount_Reportable_Input) at PaymentDeductionsDV.pcf: line 33, column 47
    ...
    // 'value' attribute on CurrencyInput (id=Amount_Gross_Input) at PaymentDeductionsDV.pcf: line 19, column 59
    ...
    // 'value' attribute on CurrencyInput (id=Amount_Net_Input) at PaymentDeductionsDV.pcf: line 43, column 59
    function value_15 () : gw.api.financials.CurrencyAmountPair {
      return Check.NetAmountPair
    }
    
    // 'value' attribute on TextInput (id=Vendor_Input) at PaymentDeductionsDV.pcf: line 24, column 37
    function value_3 () : entity.Contact {
      return Check.Vendor
    }
    
    // 'value' attribute on CurrencyInput (id=Amount_Reportable_Input) at PaymentDeductionsDV.pcf: line 33, column 47
