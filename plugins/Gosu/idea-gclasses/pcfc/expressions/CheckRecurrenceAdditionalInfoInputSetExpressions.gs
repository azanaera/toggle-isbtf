...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/CheckRecurrenceAdditionalInfoInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CheckRecurrenceAdditionalInfoInputSetExpressions {
  ...
  public static class CheckRecurrenceAdditionalInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=TotalNumOfChecks_Input) at CheckRecurrenceAdditionalInfoInputSet.pcf: line 17, column 37
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      recurrenceHelper.CheckRecurrence.NumChecks = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'validationExpression' attribute on TextInput (id=TotalNumOfChecks_Input) at CheckRecurrenceAdditionalInfoInputSet.pcf: line 17, column 37
    ...
    // 'value' attribute on CurrencyInput (id=TotalRecurrenceAmount_Input) at CheckRecurrenceAdditionalInfoInputSet.pcf: line 25, column 57
