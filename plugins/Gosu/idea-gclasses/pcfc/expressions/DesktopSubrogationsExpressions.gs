...
@javax.annotation.processing.Generated("config/web/pcf/desktop/subrogations/DesktopSubrogations.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DesktopSubrogationsExpressions {
  ...
  public static class DesktopSubrogationsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=DesktopSubrogations_PrintButton) at DesktopSubrogations.pcf: line 22, column 25
    function action_1 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions("SubrogationsLV")
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopSubrogations_AssignButton) at DesktopSubrogations.pcf: line 30, column 25
    ...
    // 'available' attribute on ToolbarButton (id=DesktopSubrogations_PrintButton) at DesktopSubrogations.pcf: line 22, column 25
    function available_0 () : java.lang.Boolean {
      return perm.User.printlistviews
    }
    
    // 'available' attribute on CheckedValuesToolbarButton (id=DesktopSubrogations_AssignButton) at DesktopSubrogations.pcf: line 30, column 25
    ...
    // 'def' attribute on PanelRef at DesktopSubrogations.pcf: line 33, column 103
