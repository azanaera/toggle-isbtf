...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/DriversLicenseInfoInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DriversLicenseInfoInputSetExpressions {
  ...
  public static class DriversLicenseInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=LicenseNumber_Input) at DriversLicenseInfoInputSet.pcf: line 26, column 37
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Person.LicenseNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=LicenseState_Input) at DriversLicenseInfoInputSet.pcf: line 33, column 41
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      Person.LicenseState = (__VALUE_TO_SET as typekey.Jurisdiction)
    }
    
    // 'filter' attribute on TypeKeyInput (id=LicenseState_Input) at DriversLicenseInfoInputSet.pcf: line 33, column 41
