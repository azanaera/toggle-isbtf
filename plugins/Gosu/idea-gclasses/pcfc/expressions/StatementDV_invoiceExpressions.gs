...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/StatementDV.invoice.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class StatementDV_invoiceExpressions {
  ...
  public static class StatementDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=Description_Input) at StatementDV.invoice.pcf: line 38, column 73
    function defaultSetter_16 (__VALUE_TO_SET :  java.lang.Object) : void {
      currentInvoice.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.invoice.pcf: line 24, column 73
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      currentInvoice.ReferenceNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.invoice.pcf: line 24, column 73
    function editable_0 () : java.lang.Boolean {
      return currentInvoice.New
    }
    
    // 'value' attribute on TypeKeyInput (id=InvoiceStatus_Input) at StatementDV.invoice.pcf: line 30, column 78
    ...
    // 'visible' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.invoice.pcf: line 24, column 73
    function visible_1 () : java.lang.Boolean {
      return currentInvoice != null or CurrentLocation.InEditMode
    }
    
    // 'visible' attribute on TypeKeyInput (id=InvoiceStatus_Input) at StatementDV.invoice.pcf: line 30, column 78
