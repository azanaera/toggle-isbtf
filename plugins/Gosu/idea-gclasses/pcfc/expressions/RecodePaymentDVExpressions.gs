...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/transactions/RecodePaymentDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RecodePaymentDVExpressions {
  ...
  public static class RecodePaymentDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_15 (def :  pcf.EditableRecodeLineItemsLV) : void {
      def.onEnter(Payment)
    }
    
    // 'def' attribute on ListViewInput at RecodePaymentDV.pcf: line 40, column 96
    function def_refreshVariables_16 (def :  pcf.EditableRecodeLineItemsLV) : void {
    ...
    // 'value' attribute on TypeKeyInput (id=Payment_PaymentType_Input) at RecodePaymentDV.pcf: line 26, column 41
    function valueRoot_5 () : java.lang.Object {
      return Payment
    }
    
    // 'value' attribute on CurrencyInput (id=Transaction_AvailableReserves_Input) at RecodePaymentDV.pcf: line 36, column 80
    ...
    // 'visible' attribute on CurrencyInput (id=Transaction_AvailableReserves_Input) at RecodePaymentDV.pcf: line 36, column 80
