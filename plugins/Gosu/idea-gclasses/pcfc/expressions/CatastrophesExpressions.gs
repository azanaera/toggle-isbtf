...
@javax.annotation.processing.Generated("config/web/pcf/admin/catastrophes/Catastrophes.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CatastrophesExpressions {
  ...
  public static class CatastrophesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function action_dest_2 () : pcf.api.Destination {
      return pcf.NewCatastrophe.createDestination()
    }
