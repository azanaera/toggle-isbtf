...
class TeamGroupPendingExposuresExpressions {
  ...
  public static class TeamGroupPendingExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupPendingExposures_Print) at TeamGroupPendingExposures.pcf: line 45, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupPendingExposures_Assign) at TeamGroupPendingExposures.pcf: line 38, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupPendingExposures_Print) at TeamGroupPendingExposures.pcf: line 45, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupPendingExposures.pcf: line 48, column 65
