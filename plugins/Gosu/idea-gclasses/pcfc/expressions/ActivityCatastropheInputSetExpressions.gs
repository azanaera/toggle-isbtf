...
@javax.annotation.processing.Generated("config/web/pcf/shared/activity/ActivityCatastropheInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ActivityCatastropheInputSetExpressions {
  ...
  public static class ActivityCatastropheInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=CatastropheNumber_Cell) at ActivityCatastropheInputSet.pcf: line 26, column 54
    function sortValue_0 (catastrophe :  entity.Catastrophe) : java.lang.Object {
      return catastrophe.CatastropheNumber
    }
    
    // 'value' attribute on TextCell (id=CatastropheName_Cell) at ActivityCatastropheInputSet.pcf: line 30, column 41
    function sortValue_1 (catastrophe :  entity.Catastrophe) : java.lang.Object {
      return catastrophe.Name
    }
    
    // 'value' attribute on TextCell (id=CatastropheValidDates_Cell) at ActivityCatastropheInputSet.pcf: line 34, column 301
