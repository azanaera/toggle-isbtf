...
class QuickCreateCheckWizardExpressions {
  ...
  public static class QuickCreateCheckWizardExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function beforeCommit_18 (pickedValue :  java.lang.Object) : void {
      gw.api.system.bundle.BundleCommitCondition.verify(claim); wizard.Finishing = true; wizard.doFinalChecksAndSetup(true); wizard.ensureNoCheckPayeesAreRetired(); wizard.performBeforeFinish()
    }
    ...
    function onExit_6 () : void {
      wizard.validatePayments(); wizard.setInstructionsDefaults(); wizard.validateAllCheckPayees();  ext.config.check.CheckScreensHelper_Ext.CheckAddressLinesLength(wizard.Check) ;
    }
