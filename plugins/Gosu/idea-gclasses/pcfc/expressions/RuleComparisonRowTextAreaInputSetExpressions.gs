...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleComparisonRowTextAreaInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleComparisonRowTextAreaInputSetExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends RuleComparisonRowTextAreaInputSetExpressionsImpl {
    ...
    // 'tdClass' attribute on LayoutConfig at RuleComparisonRowTextAreaInputSet.pcf: line 31, column 35
    function tdClass_4 () : java.lang.String {
      return row.CssClass
    }
    
    // 'value' attribute on TextAreaInput (id=Value_Input) at RuleComparisonRowTextAreaInputSet.pcf: line 29, column 28
  ...
  public static class RuleComparisonRowTextAreaInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Label_Input) at RuleComparisonRowTextAreaInputSet.pcf: line 13, column 25
