...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotPolicyScreen.700.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyScreen_700Expressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TripCoverageLDPExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=CoverageType_Cell) at ClaimSnapshotPolicyScreen.700.pcf: line 108, column 56
    ...
    // 'value' attribute on TextCell (id=Deductible_Cell) at ClaimSnapshotPolicyScreen.700.pcf: line 114, column 56
    function value_25 () : dynamic.Dynamic {
      return TripCoverage.Deductible
    }
    
    // 'value' attribute on TextCell (id=ExposureLimit_Cell) at ClaimSnapshotPolicyScreen.700.pcf: line 120, column 56
    function value_28 () : dynamic.Dynamic {
      return TripCoverage.ExposureLimit
    }
    
    // 'value' attribute on TextCell (id=IncidentLimit_Cell) at ClaimSnapshotPolicyScreen.700.pcf: line 126, column 56
    function value_31 () : dynamic.Dynamic {
      return TripCoverage.IncidentLimit
    }
    
    // 'value' attribute on TextCell (id=Notes_Cell) at ClaimSnapshotPolicyScreen.700.pcf: line 131, column 56
