...
@javax.annotation.processing.Generated("config/web/pcf/vacation/VacationActivities.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class VacationActivitiesExpressions {
  ...
  public static class VacationActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=VacationActivities_Print) at VacationActivities.pcf: line 63, column 25
    function action_7 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=VacationActivities_Assign) at VacationActivities.pcf: line 30, column 77
    ...
    // 'available' attribute on ToolbarButton (id=VacationActivities_Print) at VacationActivities.pcf: line 63, column 25
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=VacationActivities_Skip) at VacationActivities.pcf: line 36, column 75
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=VacationActivities_Complete) at VacationActivities.pcf: line 42, column 79
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=VacationActivities_Approve) at VacationActivities.pcf: line 49, column 78
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=VacationActivities_Reject) at VacationActivities.pcf: line 55, column 77
    ...
    // 'def' attribute on PanelRef at VacationActivities.pcf: line 66, column 63
