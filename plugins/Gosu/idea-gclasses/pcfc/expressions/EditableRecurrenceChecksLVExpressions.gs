...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/checks/EditableRecurrenceChecksLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableRecurrenceChecksLVExpressions {
  ...
  public static class EditableRecurrenceChecksLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=ScheduledSendDate_Cell) at EditableRecurrenceChecksLV.pcf: line 37, column 44
    function sortValue_1 (Check :  entity.Check) : java.lang.Object {
      return Check.ScheduledSendDate
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at EditableRecurrenceChecksLV.pcf: line 45, column 49
    function sortValue_2 (Check :  entity.Check) : java.lang.Object {
      return Check.GrossAmountSettableComponent
    }
    
    // 'value' attribute on DateCell (id=ServicePeriodStart_Cell) at EditableRecurrenceChecksLV.pcf: line 50, column 41
    function sortValue_3 (Check :  entity.Check) : java.lang.Object {
      return Check.ServicePdStart
    }
    
    // 'value' attribute on DateCell (id=ServicePeriodEnd_Cell) at EditableRecurrenceChecksLV.pcf: line 55, column 39
  ...
  public static class IteratorEntryExpressionsImpl extends EditableRecurrenceChecksLVExpressionsImpl {
    ...
    // 'editable' attribute on CurrencyCell (id=Amount_Cell) at EditableRecurrenceChecksLV.pcf: line 45, column 49
    function editable_10 () : java.lang.Boolean {
      return Check.Payments.length == 1 and Check.Payments[0].LineItems.length == 1
    }
    
    // 'editable' attribute on DateCell (id=ServicePeriodStart_Cell) at EditableRecurrenceChecksLV.pcf: line 50, column 41
