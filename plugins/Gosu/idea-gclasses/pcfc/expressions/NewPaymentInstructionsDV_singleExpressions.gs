...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/NewPaymentInstructionsDV.single.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewPaymentInstructionsDV_singleExpressions {
  ...
  public static class NewPaymentInstructionsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=CheckBatching_Input) at NewPaymentInstructionsDV.single.pcf: line 36, column 44
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      Check.CheckBatching = (__VALUE_TO_SET as typekey.CheckBatching)
    }
    
    // 'value' attribute on DateInput (id=ScheduledSendDate_Input) at NewPaymentInstructionsDV.single.pcf: line 42, column 42
    function defaultSetter_18 (__VALUE_TO_SET :  java.lang.Object) : void {
      Check.ScheduledSendDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TypeKeyInput (id=CheckInstructions_Input) at NewPaymentInstructionsDV.single.pcf: line 48, column 56
    function defaultSetter_23 (__VALUE_TO_SET :  java.lang.Object) : void {
      Check.CheckInstructions = (__VALUE_TO_SET as typekey.CheckHandlingInstructions)
    }
    
    // 'filter' attribute on TypeKeyInput (id=PaymentMethod_Input) at NewPaymentInstructionsDV.single.pcf: line 30, column 44
    function filter_10 (VALUE :  typekey.PaymentMethod, VALUES :  typekey.PaymentMethod[]) : java.lang.Boolean {
    ...
    // 'validationExpression' attribute on DateInput (id=ScheduledSendDate_Input) at NewPaymentInstructionsDV.single.pcf: line 42, column 42
    ...
    // 'value' attribute on TypeKeyInput (id=PaymentMethod_Input) at NewPaymentInstructionsDV.single.pcf: line 30, column 44
