...
@javax.annotation.processing.Generated("config/web/pcf/admin/groups/OrganizationSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class OrganizationSearchDVExpressions {
  ...
  public static class OrganizationSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Name_Input) at OrganizationSearchDV.pcf: line 15, column 38
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.Name = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=ContactCity_Input) at OrganizationSearchDV.pcf: line 31, column 45
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.ContactCity = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=ContactState_Input) at OrganizationSearchDV.pcf: line 37, column 36
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.ContactState = (__VALUE_TO_SET as typekey.State)
    }
    
    // 'value' attribute on TextInput (id=ContactPostal_Input) at OrganizationSearchDV.pcf: line 42, column 47
    function defaultSetter_21 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.ContactPostal = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=Type_Input) at OrganizationSearchDV.pcf: line 21, column 43
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.Type = (__VALUE_TO_SET as typekey.BusinessType)
    }
    
    // 'value' attribute on TextInput (id=ContactName_Input) at OrganizationSearchDV.pcf: line 26, column 45
