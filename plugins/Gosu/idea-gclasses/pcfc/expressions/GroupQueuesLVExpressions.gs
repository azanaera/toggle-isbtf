...
@javax.annotation.processing.Generated("config/web/pcf/admin/groups/GroupQueuesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class GroupQueuesLVExpressions {
  ...
  public static class GroupQueuesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at GroupQueuesLV.pcf: line 36, column 41
    function sortValue_0 (AssignableQueue :  entity.AssignableQueue) : java.lang.Object {
      return AssignableQueue.Name
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at GroupQueuesLV.pcf: line 41, column 48
    function sortValue_1 (AssignableQueue :  entity.AssignableQueue) : java.lang.Object {
      return AssignableQueue.Description
    }
    
    // 'value' attribute on BooleanRadioCell (id=SubGroupVisible_Cell) at GroupQueuesLV.pcf: line 47, column 52
  ...
  public static class IteratorEntryExpressionsImpl extends GroupQueuesLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Name_Cell) at GroupQueuesLV.pcf: line 36, column 41
