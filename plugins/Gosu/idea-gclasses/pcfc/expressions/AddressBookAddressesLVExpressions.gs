...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookAddressesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookAddressesLVExpressions {
  ...
  public static class AddressBookAddressesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RadioButtonCell (id=Primary_Cell) at AddressBookAddressesLV.pcf: line 33, column 54
    function sortValue_0 (address :  entity.Address) : java.lang.Object {
      return address == contact.PrimaryAddress
    }
    
    // 'value' attribute on TypeKeyCell (id=AddressType_Cell) at AddressBookAddressesLV.pcf: line 39, column 44
    function sortValue_1 (address :  entity.Address) : java.lang.Object {
      return address.AddressType
    }
    
    // 'value' attribute on TextCell (id=DisplayName_Cell) at AddressBookAddressesLV.pcf: line 44, column 40
  ...
  public static class IteratorEntryExpressionsImpl extends AddressBookAddressesLVExpressionsImpl {
    ...
    // 'action' attribute on RadioButtonCell (id=Primary_Cell) at AddressBookAddressesLV.pcf: line 33, column 54
