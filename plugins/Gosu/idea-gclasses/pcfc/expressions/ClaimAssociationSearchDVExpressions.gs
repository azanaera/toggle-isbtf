...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/associations/ClaimAssociationSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimAssociationSearchDVExpressions {
  ...
  public static class ClaimAssociationSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=ClaimAssociation_Title_Input) at ClaimAssociationSearchDV.pcf: line 18, column 55
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      ClaimAssociationSearchCriteria.Title = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=Claim_ClaimNumber_Input) at ClaimAssociationSearchDV.pcf: line 25, column 61
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      ClaimAssociationSearchCriteria.ClaimNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on DateInput (id=Claim_LossDate_Input) at ClaimAssociationSearchDV.pcf: line 30, column 58
