...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/CommandParameterInputSet.formula.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CommandParameterInputSet_formulaExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/bizrules/CommandParameterInputSet.formula.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class CommandParameterInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'autoComplete' attribute on TextInput (id=Expression_Input) at CommandParameterInputSet.formula.pcf: line 25, column 45
    function autoComplete_9 () : gw.api.contact.AutocompleteHandler {
      return fragHolder.AutocompleteHandler
    }
    
    // 'def' attribute on MenuItemSetRef at CommandParameterInputSet.formula.pcf: line 28, column 61
    ...
    // 'value' attribute on TextInput (id=Expression_Input) at CommandParameterInputSet.formula.pcf: line 25, column 45
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      fragHolder.Fragment = (__VALUE_TO_SET as entity.ExpressionFragment)
    }
    
    // 'initialValue' attribute on Variable at CommandParameterInputSet.formula.pcf: line 15, column 60
    ...
    // 'inputConversion' attribute on TextInput (id=Expression_Input) at CommandParameterInputSet.formula.pcf: line 25, column 45
    function inputConversion_4 (VALUE :  java.lang.String) : java.lang.Object {
      return fragHolder.inputConversion(VALUE)
    }
    
    // 'label' attribute on TextInput (id=Expression_Input) at CommandParameterInputSet.formula.pcf: line 25, column 45
    function label_3 () : java.lang.Object {
      return parameterHolder.ParameterLabel
    }
    
    // 'outputConversion' attribute on TextInput (id=Expression_Input) at CommandParameterInputSet.formula.pcf: line 25, column 45
