...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookCompanyVendorSpecialtyInputSet.MedicalCareOrg.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookCompanyVendorSpecialtyInputSet_MedicalCareOrgExpressions {
  ...
  public static class AddressBookCompanyVendorSpecialtyInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=MedicalSpecialty_Input) at AddressBookCompanyVendorSpecialtyInputSet.MedicalCareOrg.pcf: line 16, column 42
