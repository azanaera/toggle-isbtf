...
class ClaimSnapshotBaggageIncidentScreen_600Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotBaggageIncidentScreen.600.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotBaggageIncidentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotBaggageIncidentScreen.600.pcf: line 20, column 67
    function def_onEnter_1 (def :  pcf.ClaimSnapshotBaggageIncident600DV) : void {
      def.onEnter(IncidentParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotBaggageIncidentScreen.600.pcf: line 20, column 67
    function def_refreshVariables_2 (def :  pcf.ClaimSnapshotBaggageIncident600DV) : void {
      def.refreshVariables(IncidentParam)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotBaggageIncidentScreen.600.pcf: line 14, column 31
