...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/StatementLineItemLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class StatementLineItemLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends StatementLineItemLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=lineItemCategory_Cell) at StatementLineItemLV.pcf: line 40, column 72
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      lineItem.Category = (__VALUE_TO_SET as typekey.ServiceRequestStatementLineItemCategory)
    }
    
    // 'value' attribute on TextCell (id=lineItemDescription_Cell) at StatementLineItemLV.pcf: line 45, column 41
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      lineItem.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on CurrencyCell (id=lineItemAmount_Cell) at StatementLineItemLV.pcf: line 52, column 35
    function defaultSetter_19 (__VALUE_TO_SET :  java.lang.Object) : void {
      lineItem.Amount = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'label' attribute on CurrencyCell (id=lineItemAmount_Cell) at StatementLineItemLV.pcf: line 52, column 35
