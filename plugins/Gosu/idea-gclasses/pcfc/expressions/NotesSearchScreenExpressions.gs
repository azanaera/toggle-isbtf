...
@javax.annotation.processing.Generated("config/web/pcf/claim/notes/NotesSearchScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NotesSearchScreenExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends SearchPanelExpressionsImpl {
    ...
    // 'action' attribute on Link (id=PrintLink) at NotesSearchScreen.pcf: line 147, column 74
    ...
    // 'label' attribute on TextInput (id=AuthoringDate_Input) at NotesSearchScreen.pcf: line 182, column 41
    ...
    // 'value' attribute on TextInput (id=Author_Input) at NotesSearchScreen.pcf: line 154, column 52
    function valueRoot_76 () : java.lang.Object {
      return Note.Author
    }
    
    // 'value' attribute on TextInput (id=Topic_Input) at NotesSearchScreen.pcf: line 161, column 54
    ...
    // 'value' attribute on TextInput (id=Topic_Input) at NotesSearchScreen.pcf: line 161, column 54
    function value_78 () : typekey.NoteTopicType {
      return Note.Topic
    }
    
    // 'value' attribute on TextInput (id=RelatedTo_Input) at NotesSearchScreen.pcf: line 167, column 52
    function value_81 () : java.lang.String {
      return Note.getNoteRelatedTo()
    }
    
    // 'value' attribute on TextInput (id=Subject_Input) at NotesSearchScreen.pcf: line 187, column 51
    function value_88 () : java.lang.String {
      return Note.Subject
    }
    
    // 'value' attribute on NoteBodyInput (id=Body_Input) at NotesSearchScreen.pcf: line 191, column 38
    function value_92 () : java.lang.String {
      return Note.Body
    }
    
    // 'visible' attribute on TextInput (id=Confidential_Input) at NotesSearchScreen.pcf: line 172, column 48
    function visible_83 () : java.lang.Boolean {
      return Note.Confidential
    }
    
    // 'visible' attribute on TextInput (id=Subject_Input) at NotesSearchScreen.pcf: line 187, column 51
  ...
  public static class SearchPanelExpressionsImpl extends NotesSearchScreenExpressionsImpl {
    ...
    function maxSearchResults_96 () : java.lang.Object {
    ...
    function value_95 () : gw.api.database.IQueryBeanResult<entity.Note> {
      return NotesList
    }
