...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotPartiesInvolvedScreen.600.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPartiesInvolvedScreen_600Expressions {
  ...
  public static class ListDetailPanelExpressionsImpl extends ClaimSnapshotPartiesInvolvedScreenExpressionsImpl {
    ...
    function def_onEnter_30 (def :  pcf.ClaimSnapshotContact600DV_Company) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_onEnter_32 (def :  pcf.ClaimSnapshotContact600DV_Person) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_onEnter_34 (def :  pcf.ClaimSnapshotContact600DV_Place) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_onEnter_36 (def :  pcf.ClaimSnapshotContact600DV_contact) : void {
      def.onEnter(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_refreshVariables_31 (def :  pcf.ClaimSnapshotContact600DV_Company) : void {
      def.refreshVariables(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_refreshVariables_33 (def :  pcf.ClaimSnapshotContact600DV_Person) : void {
      def.refreshVariables(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_refreshVariables_35 (def :  pcf.ClaimSnapshotContact600DV_Place) : void {
      def.refreshVariables(SelectedClaimContact)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPartiesInvolvedScreen.600.pcf: line 74, column 78
    function def_refreshVariables_37 (def :  pcf.ClaimSnapshotContact600DV_contact) : void {
      def.refreshVariables(SelectedClaimContact)
    }
