...
class UnsupportedToolsExpressions {
  ...
  public static class UnsupportedToolsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function firstVisitableChildDestinationMethod_13 () : pcf.api.Destination {
    ...
    function menuActions_onEnter_9 (def :  pcf.InternalToolsMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 10, column 26
    function menuActions_refreshVariables_10 (def :  pcf.InternalToolsMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'tabBar' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 10, column 26
    function tabBar_onEnter_11 (def :  pcf.InternalToolsTabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=UnsupportedTools) at UnsupportedTools.pcf: line 10, column 26
    function tabBar_refreshVariables_12 (def :  pcf.InternalToolsTabBar) : void {
      def.refreshVariables()
    }
