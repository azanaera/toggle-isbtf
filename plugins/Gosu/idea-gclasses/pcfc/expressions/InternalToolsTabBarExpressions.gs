...
@javax.annotation.processing.Generated("config/web/pcf/tools/InternalToolsTabBar.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class InternalToolsTabBarExpressions {
  ...
  public static class InternalToolsTabBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function systemAlertBar_onEnter_127 (def :  pcf.SystemAlertBar) : void {
      def.onEnter()
    }
    
    // 'systemAlertBar' attribute on TabBar (id=InternalToolsTabBar) at InternalToolsTabBar.pcf: line 7, column 39
    function systemAlertBar_refreshVariables_128 (def :  pcf.SystemAlertBar) : void {
  ...
  public static class LocationGroupMenuItem2ExpressionsImpl extends ServerToolsTabMenuItemExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ClusterPages.pcf: line 12, column 36
    function action_62 () : void {
      pcf.ClusterMembers.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ClusterPages.pcf: line 14, column 39
  ...
  public static class LocationGroupMenuItem5ExpressionsImpl extends LocationGroupMenuItem4ExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ProfilerAnalysisLG.pcf: line 43, column 65
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ProfilerAnalysisLG.pcf: line 28, column 67
    function action_90 () : void {
      pcf.ProfilerAnalysisPage.go("RestOperation")
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ProfilerAnalysisLG.pcf: line 31, column 69
    function action_92 () : void {
      pcf.ProfilerAnalysisPage.go("StartablePlugin")
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ProfilerAnalysisLG.pcf: line 34, column 61
    function action_94 () : void {
      pcf.ProfilerAnalysisPage.go("Upgrade")
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ProfilerAnalysisLG.pcf: line 37, column 60
    function action_96 () : void {
      pcf.ProfilerAnalysisPage.go("ByTime")
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ProfilerAnalysisLG.pcf: line 40, column 63
  ...
  public static class LocationGroupMenuItemExpressionsImpl extends ServerToolsTabMenuItemExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 12, column 39
    function action_10 () : void {
      pcf.ConfigurationInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 16, column 33
    function action_12 () : void {
      pcf.ArchiveInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 20, column 38
    function action_14 () : void {
      pcf.ArchiveGraphInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 22, column 39
    function action_16 () : void {
      pcf.ConsistencyChecks.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 25, column 39
    function action_18 () : void {
      pcf.DatabaseTableInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 28, column 40
    function action_20 () : void {
      pcf.DatabaseParameters.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 31, column 37
    function action_22 () : void {
      pcf.DatabaseStorage.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 34, column 42
    function action_24 () : void {
      pcf.DataDistributionInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 37, column 40
    function action_26 () : void {
      pcf.DatabaseStatistics.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 40, column 41
    function action_28 () : void {
      pcf.OracleStatspackInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 43, column 35
    function action_30 () : void {
      pcf.OracleAWRInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 46, column 48
    function action_32 () : void {
      pcf.OracleAWRUnusedIndexesInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 49, column 39
    function action_34 () : void {
      pcf.OracleOutlineInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 52, column 38
    function action_36 () : void {
      pcf.MicrosoftDMVInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 55, column 44
    function action_38 () : void {
      pcf.MicrosoftDriverLogging.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 58, column 40
    function action_40 () : void {
      pcf.PostgreSQLPerfInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 61, column 37
    function action_42 () : void {
      pcf.LoadHistoryInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 64, column 41
    function action_44 () : void {
      pcf.LoadIntegrityChecks.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 67, column 36
    function action_46 () : void {
      pcf.LoadErrorsInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 70, column 44
    function action_48 () : void {
      pcf.RuntimeEnvironmentInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 73, column 45
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at InfoPages.pcf: line 78, column 39
  ...
  public static class ServerToolsTabMenuItemExpressionsImpl extends InternalToolsTabBarExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 34, column 30
    function action_104 () : void {
      pcf.Profiler.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 36, column 31
    function action_106 () : void {
      pcf.JProfiler.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 38, column 32
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 22, column 31
    function action_56 () : void {
      pcf.InfoPages.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 24, column 28
    ...
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 26, column 37
    function action_60 () : void {
      pcf.StartablePlugin.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 28, column 34
    function action_66 () : void {
      pcf.ClusterPages.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 30, column 33
    function action_68 () : void {
      pcf.UpgradeInfo.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 32, column 42
    function action_76 () : void {
      pcf.CentipedeCacheInfoLG.go()
    }
    
    // 'location' attribute on Tab (id=ServerToolsTab) at ServerTools.pcf: line 20, column 40
  ...
  public static class UnsupportedToolsTabMenuItemExpressionsImpl extends InternalToolsTabBarExpressionsImpl {
    ...
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 16, column 33
    function action_116 () : void {
      pcf.SystemClock.go()
    }
    
    // 'location' attribute on Tab (id=UnsupportedToolsTab) at UnsupportedTools.pcf: line 18, column 34
