...
@javax.annotation.processing.Generated("config/web/pcf/claim/summary/indicator/ClaimIndicatorInputSet.LitigationClaimIndicator.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimIndicatorInputSet_LitigationClaimIndicatorExpressions {
  ...
  public static class ClaimIndicatorInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=LitigationStatusEdit_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 38, column 45
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      indicator.Claim.LitigationStatus = (__VALUE_TO_SET as typekey.LitigationStatus)
    }
    
    // 'value' attribute on BooleanRadioInput (id=FirstNoticeSuit_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 53, column 48
    ...
    // 'label' attribute on TextInput (id=DaysAfterFNOL_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 48, column 38
    function label_19 () : java.lang.Object {
      return gw.config.LOBAbstraction.ForClaim.ForLossType.isWorkComp(indicator.Claim) ? DisplayKey.get("Web.Claim.LitigationClaimIndicator.DaysAfterFirstReportOfInjury"): DisplayKey.get("Web.Claim.LitigationClaimIndicator.DaysAfterFNOL")
    }
    
    // 'optionIconColor' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
    function optionIconColor_6 (VALUE :  typekey.LitigationStatus) : gw.api.web.color.GWColor {
      return indicator.IconColor
    }
    
    // 'optionIcon' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
    function optionIcon_5 (VALUE :  typekey.LitigationStatus) : java.lang.String {
      return VALUE == TC_LITIGATED or VALUE == TC_COMPLETE ? indicator.Icon : null
    }
    
    // 'optionLabel' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
    function optionLabel_7 (VALUE :  typekey.LitigationStatus) : java.lang.String {
      return indicator.HoverText
    }
    
    // 'valueRange' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
    function valueRange_8 () : java.lang.Object {
      return LitigationStatus.getTypeKeys(false)
    }
    
    // 'value' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
    function valueRoot_4 () : java.lang.Object {
      return indicator.Claim
    }
    
    // 'value' attribute on DateInput (id=LitigationIdentified_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 43, column 32
    function value_17 () : java.util.Date {
      return litigationStart
    }
    
    // 'value' attribute on TextInput (id=DaysAfterFNOL_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 48, column 38
    ...
    // 'value' attribute on DateInput (id=NextTrialDate_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 58, column 36
    ...
    // 'valueRange' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
    function verifyValueRangeIsAllowedType_9 ($$arg :  typekey.LitigationStatus[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on RangeRadioInput (id=LitigationStatusView_Input) at ClaimIndicatorInputSet.LitigationClaimIndicator.pcf: line 31, column 30
