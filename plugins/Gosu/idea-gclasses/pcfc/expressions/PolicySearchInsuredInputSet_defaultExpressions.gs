...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/PolicySearchInsuredInputSet.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PolicySearchInsuredInputSet_defaultExpressions {
  ...
  public static class PolicySearchInsuredInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Policy_TaxId_Input) at PolicySearchInsuredInputSet.default.pcf: line 40, column 49
    function defaultSetter_19 (__VALUE_TO_SET :  java.lang.Object) : void {
      PolicySearchCriteria.TaxIdString = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=Policy_ContactType_Input) at PolicySearchInsuredInputSet.default.pcf: line 24, column 45
