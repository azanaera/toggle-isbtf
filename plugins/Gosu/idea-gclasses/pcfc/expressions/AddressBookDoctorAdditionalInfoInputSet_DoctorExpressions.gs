...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookDoctorAdditionalInfoInputSet.Doctor.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookDoctorAdditionalInfoInputSet_DoctorExpressions {
  ...
  public static class AddressBookDoctorAdditionalInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=MedicalLicense_Input) at AddressBookDoctorAdditionalInfoInputSet.Doctor.pcf: line 15, column 56
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      (personVendor as Doctor).MedicalLicense = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=DoctorSpecialty_Input) at AddressBookDoctorAdditionalInfoInputSet.Doctor.pcf: line 21, column 42
