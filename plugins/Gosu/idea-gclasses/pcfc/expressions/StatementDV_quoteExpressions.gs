...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/StatementDV.quote.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class StatementDV_quoteExpressions {
  ...
  public static class StatementDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.quote.pcf: line 38, column 55
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      currentQuote.ReferenceNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=DaysToPerformService_Input) at StatementDV.quote.pcf: line 54, column 55
    function defaultSetter_24 (__VALUE_TO_SET :  java.lang.Object) : void {
      (currentQuote as ServiceRequestQuote).ExpectedDaysToPerformService = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on TextAreaInput (id=Description_Input) at StatementDV.quote.pcf: line 74, column 55
    ...
    // 'editable' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.quote.pcf: line 38, column 55
    function editable_7 () : java.lang.Boolean {
      return currentQuote.New
    }
    
    // 'validationExpression' attribute on TextInput (id=DaysToPerformService_Input) at StatementDV.quote.pcf: line 54, column 55
    ...
    // 'value' attribute on CurrencyInput (id=quoteTotal_Input) at StatementDV.quote.pcf: line 31, column 92
    function valueRoot_4 () : java.lang.Object {
      return currentQuote
    }
    
    // 'value' attribute on DateInput (id=CreationDate_Input) at StatementDV.quote.pcf: line 45, column 101
    ...
    // 'value' attribute on DateInput (id=ApprovalDate_Input) at StatementDV.quote.pcf: line 66, column 141
    ...
    // 'visible' attribute on TextInput (id=NoQuotesMessage_Input) at StatementDV.quote.pcf: line 26, column 60
    function visible_0 () : java.lang.Boolean {
      return currentQuote == null and not isEditable
    }
    
    // 'visible' attribute on DateInput (id=CreationDate_Input) at StatementDV.quote.pcf: line 45, column 101
    function visible_15 () : java.lang.Boolean {
      return !(currentQuote == null or isEditable) or currentQuote.ServiceRequest.IsPromotion
    }
    
    // 'visible' attribute on CurrencyInput (id=quoteTotal_Input) at StatementDV.quote.pcf: line 31, column 92
    ...
    // 'visible' attribute on DateInput (id=ApprovalDate_Input) at StatementDV.quote.pcf: line 66, column 141
    ...
    // 'visible' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.quote.pcf: line 38, column 55
