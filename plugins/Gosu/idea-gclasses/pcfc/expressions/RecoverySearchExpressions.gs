...
class RecoverySearchExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends RecoverySearchExpressionsImpl {
    ...
    // 'action' attribute on ToolbarButton (id=PrintButton) at RecoverySearch.pcf: line 40, column 72
    ...
    // 'available' attribute on ToolbarButton (id=PrintButton) at RecoverySearch.pcf: line 40, column 72
