...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/EditableConcurrentEmploymentLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableConcurrentEmploymentLVExpressions {
  ...
  public static class EditableConcurrentEmploymentLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=CompanyName_Cell) at EditableConcurrentEmploymentLV.pcf: line 28, column 53
    ...
    // 'value' attribute on DateCell (id=StartDate_Cell) at EditableConcurrentEmploymentLV.pcf: line 35, column 51
    ...
    // 'value' attribute on DateCell (id=EndDate_Cell) at EditableConcurrentEmploymentLV.pcf: line 41, column 49
    ...
    // 'value' attribute on BooleanRadioCell (id=FullTime_Cell) at EditableConcurrentEmploymentLV.pcf: line 47, column 50
    ...
    // 'value' attribute on CurrencyCell (id=WeeklyWage_Cell) at EditableConcurrentEmploymentLV.pcf: line 54, column 52
    ...
    // 'value' attribute on TextCell (id=JobTitle_Cell) at EditableConcurrentEmploymentLV.pcf: line 60, column 50
    ...
    // 'value' attribute on TextCell (id=ContactNumber_Cell) at EditableConcurrentEmploymentLV.pcf: line 67, column 55
