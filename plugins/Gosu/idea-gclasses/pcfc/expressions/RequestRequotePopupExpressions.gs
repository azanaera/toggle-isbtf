...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/RequestRequotePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RequestRequotePopupExpressions {
  ...
  public static class RequestRequotePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=ReasonForRequestingRequote_Input) at RequestRequotePopup.pcf: line 36, column 36
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      requoteReason = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on DateInput (id=RequestedQuoteCompletionDate_Input) at RequestRequotePopup.pcf: line 44, column 51
    ...
    // 'validationExpression' attribute on DateInput (id=RequestedQuoteCompletionDate_Input) at RequestRequotePopup.pcf: line 44, column 51
