...
@javax.annotation.processing.Generated("config/web/pcf/search/claims/CatastropheSearchScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CatastropheSearchScreenExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends CatastropheSearchScreenExpressionsImpl {
    ...
    // 'action' attribute on ToolbarButton (id=SimpleClaimSearchScreen_PrintButton) at CatastropheSearchScreen.pcf: line 108, column 31
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=ClaimSearchScreen_AssignButton) at CatastropheSearchScreen.pcf: line 101, column 31
    ...
    // 'available' attribute on ToolbarButton (id=SimpleClaimSearchScreen_PrintButton) at CatastropheSearchScreen.pcf: line 108, column 31
    function available_16 () : java.lang.Boolean {
      return perm.User.printlistviews
    }
    
    // 'def' attribute on PanelRef at CatastropheSearchScreen.pcf: line 92, column 45
    function def_onEnter_19 (def :  pcf.SimpleClaimSearchResultsLV) : void {
      def.onEnter(catSearchClaimResults)
    }
    
    // 'def' attribute on PanelRef at CatastropheSearchScreen.pcf: line 118, column 45
    ...
    // TemplatePanel at CatastropheSearchScreen.pcf: line 69, column 22
    function renderCall_11 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    // 'value' attribute on TextInput (id=mapSelectionMessage_Input) at CatastropheSearchScreen.pcf: line 81, column 42
    function value_12 () : java.lang.String {
      return mapSelectionMessage
    }
    
    // 'value' attribute on TextInput (id=howToSelect_Input) at CatastropheSearchScreen.pcf: line 66, column 270
    ...
    // 'visible' attribute on PanelRef at CatastropheSearchScreen.pcf: line 92, column 45
    function visible_18 () : java.lang.Boolean {
      return criteria.TableVisible
    }
    
    // 'visible' attribute on Card (id=Claims) at CatastropheSearchScreen.pcf: line 89, column 76
    function visible_21 () : java.lang.Boolean {
      return criteria.TableVisible and criteria.HeatMap.hasClaims()
    }
    
    // 'visible' attribute on Card (id=Policy) at CatastropheSearchScreen.pcf: line 115, column 85
