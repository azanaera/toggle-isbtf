...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotContactDV.company.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotContactDV_CompanyExpressions {
  ...
  public static class ClaimSnapshotContactDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at ClaimSnapshotContactDV.company.pcf: line 94, column 27
    function def_onEnter_33 (def :  pcf.AddressSnapshotInputSet) : void {
      def.onEnter(asClaimContact().Contact.PrimaryAddress,null)
    }
    
    // 'def' attribute on ListViewInput at ClaimSnapshotContactDV.company.pcf: line 156, column 27
    ...
    // 'encryptionExpression' attribute on PrivacyInput (id=TaxID_Input) at ClaimSnapshotContactDV.company.pcf: line 118, column 38
    ...
    // 'value' attribute on TextCell (id=Role_Cell) at ClaimSnapshotContactDV.company.pcf: line 28, column 46
    function sortValue_0 (Role :  dynamic.Dynamic) : java.lang.Object {
      return Role.Role
    }
    
    // 'value' attribute on TextCell (id=Owner_Cell) at ClaimSnapshotContactDV.company.pcf: line 32, column 59
    function sortValue_1 (Role :  dynamic.Dynamic) : java.lang.Object {
      return util.Snapshot.getRoleOwner(Role)
    }
    
    // 'value' attribute on TextCell (id=Active_Cell) at ClaimSnapshotContactDV.company.pcf: line 36, column 65
    function sortValue_2 (Role :  dynamic.Dynamic) : java.lang.Object {
      return util.Snapshot.renderValue(Role.Active)
    }
    
    // 'value' attribute on TextCell (id=Comments_Cell) at ClaimSnapshotContactDV.company.pcf: line 41, column 46
    function sortValue_3 (Role :  dynamic.Dynamic) : java.lang.Object {
      return Role.Comments
    }
    
    // 'value' attribute on TextInput (id=Contact_Input) at ClaimSnapshotContactDV.company.pcf: line 55, column 38
    function valueRoot_16 () : java.lang.Object {
      return asClaimContact().Contact
    }
    
    // 'value' attribute on TextInput (id=AddressType_Input) at ClaimSnapshotContactDV.company.pcf: line 99, column 38
    function valueRoot_36 () : java.lang.Object {
      return asClaimContact().Contact.PrimaryAddress
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotContactDV.company.pcf: line 22, column 41
    ...
    // 'value' attribute on TextInput (id=PrimaryPhone_Input) at ClaimSnapshotContactDV.company.pcf: line 63, column 38
    function value_18 () : dynamic.Dynamic {
      return asClaimContact().Contact.PrimaryPhone
    }
    
    // 'value' attribute on TextInput (id=WorkPhone_Input) at ClaimSnapshotContactDV.company.pcf: line 68, column 38
    function value_21 () : dynamic.Dynamic {
      return asClaimContact().Contact.WorkPhone
    }
    
    // 'value' attribute on TextInput (id=FaxPhone_Input) at ClaimSnapshotContactDV.company.pcf: line 73, column 38
    function value_24 () : dynamic.Dynamic {
      return asClaimContact().Contact.FaxPhone
    }
    
    // 'value' attribute on TextInput (id=EmailAddress1_Input) at ClaimSnapshotContactDV.company.pcf: line 81, column 38
    function value_27 () : dynamic.Dynamic {
      return asClaimContact().Contact.EmailAddress1
    }
    
    // 'value' attribute on TextInput (id=EmailAddress2_Input) at ClaimSnapshotContactDV.company.pcf: line 86, column 38
    ...
    // 'value' attribute on TextInput (id=Description_Input) at ClaimSnapshotContactDV.company.pcf: line 104, column 38
    function value_38 () : dynamic.Dynamic {
      return asClaimContact().Contact.PrimaryAddress.Description
    }
    
    // 'value' attribute on TextInput (id=ValidUntil_Input) at ClaimSnapshotContactDV.company.pcf: line 109, column 38
    function value_41 () : dynamic.Dynamic {
      return asClaimContact().Contact.PrimaryAddress.ValidUntil
    }
    
    // 'value' attribute on PrivacyInput (id=TaxID_Input) at ClaimSnapshotContactDV.company.pcf: line 118, column 38
    function value_44 () : dynamic.Dynamic {
      return asClaimContact().Contact.TaxID
    }
    
    // 'value' attribute on TextInput (id=WithholdingRate_Input) at ClaimSnapshotContactDV.company.pcf: line 123, column 38
    function value_48 () : dynamic.Dynamic {
      return asClaimContact().Contact.WithholdingRate
    }
    
    // 'value' attribute on TextInput (id=TaxStatus_Input) at ClaimSnapshotContactDV.company.pcf: line 128, column 38
    function value_51 () : dynamic.Dynamic {
      return asClaimContact().Contact.TaxStatus
    }
    
    // 'value' attribute on TextInput (id=PrimaryContact_Input) at ClaimSnapshotContactDV.company.pcf: line 132, column 85
    function value_54 () : java.lang.String {
      return util.Snapshot.renderValue(asClaimContact().Contact.PrimaryContact)
    }
    
    // 'value' attribute on TextInput (id=PreferredCurrency_Input) at ClaimSnapshotContactDV.company.pcf: line 137, column 38
    function value_56 () : dynamic.Dynamic {
      return asClaimContact().Contact.PreferredCurrency
    }
    
    // 'value' attribute on TextAreaInput (id=Notes_Input) at ClaimSnapshotContactDV.company.pcf: line 147, column 38
