...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleComparisonCommandInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleComparisonCommandInputSetExpressions {
  ...
  public static class RuleComparisonCommandInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_10 (def :  pcf.RuleComparisonCommandParametersInputSet_generateactivity) : void {
      def.onEnter(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_onEnter_12 (def :  pcf.RuleComparisonCommandParametersInputSet_generatehistoryevent) : void {
      def.onEnter(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_onEnter_14 (def :  pcf.RuleComparisonCommandParametersInputSet_setfield) : void {
      def.onEnter(controller, commandDefinitionDiff)
    }
    ...
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_onEnter_4 (def :  pcf.RuleComparisonCommandParametersInputSet_createexposure) : void {
      def.onEnter(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_onEnter_6 (def :  pcf.RuleComparisonCommandParametersInputSet_createreserve) : void {
      def.onEnter(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_onEnter_8 (def :  pcf.RuleComparisonCommandParametersInputSet_default) : void {
      def.onEnter(controller, commandDefinitionDiff)
    }
    ...
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_refreshVariables_11 (def :  pcf.RuleComparisonCommandParametersInputSet_generateactivity) : void {
      def.refreshVariables(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_refreshVariables_13 (def :  pcf.RuleComparisonCommandParametersInputSet_generatehistoryevent) : void {
      def.refreshVariables(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_refreshVariables_15 (def :  pcf.RuleComparisonCommandParametersInputSet_setfield) : void {
      def.refreshVariables(controller, commandDefinitionDiff)
    }
    ...
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_refreshVariables_5 (def :  pcf.RuleComparisonCommandParametersInputSet_createexposure) : void {
      def.refreshVariables(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_refreshVariables_7 (def :  pcf.RuleComparisonCommandParametersInputSet_createreserve) : void {
      def.refreshVariables(controller, commandDefinitionDiff)
    }
    
    // 'def' attribute on InputSetRef (id=RuleActionParameters) at RuleComparisonCommandInputSet.pcf: line 20, column 34
    function def_refreshVariables_9 (def :  pcf.RuleComparisonCommandParametersInputSet_default) : void {
      def.refreshVariables(controller, commandDefinitionDiff)
    }
