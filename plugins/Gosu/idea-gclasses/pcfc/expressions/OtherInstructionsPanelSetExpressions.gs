...
@javax.annotation.processing.Generated("config/web/pcf/admin/specialhandling/OtherInstructionsPanelSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class OtherInstructionsPanelSetExpressions {
  ...
  public static class PanelIteratorEntry2ExpressionsImpl extends PanelIteratorEntryExpressionsImpl {
    ...
    // 'action' attribute on TypeKeyInput (id=instructionType_Input) at OtherInstructionsPanelSet.pcf: line 78, column 53
    ...
    // 'value' attribute on TypeKeyInput (id=instructionType_Input) at OtherInstructionsPanelSet.pcf: line 78, column 53
    function valueRoot_20 () : java.lang.Object {
      return otherInstructionTable
    }
    
    // 'value' attribute on TypeKeyInput (id=instructionType_Input) at OtherInstructionsPanelSet.pcf: line 78, column 53
    function value_19 () : typekey.InstructionType {
      return otherInstructionTable.InstructionType
    }
    
    // 'value' attribute on TextAreaInput (id=comment_Input) at OtherInstructionsPanelSet.pcf: line 98, column 49
    function value_23 () : java.lang.String {
      return otherInstructionTable.Comments
    }
    
    // 'value' attribute on TextInput (id=policyType_Input) at OtherInstructionsPanelSet.pcf: line 69, column 104
    ...
    // 'visible' attribute on TypeKeyInput (id=instructionType_Input) at OtherInstructionsPanelSet.pcf: line 78, column 53
  ...
  @javax.annotation.processing.Generated("config/web/pcf/admin/specialhandling/OtherInstructionsPanelSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PanelIteratorEntryExpressionsImpl extends OtherInstructionsPanelSetExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
  ...
  otherInstructionByPolicyType = claimPolicyType != null ? otherInstructionByCategory.where(\ o -> (o.PolicyType == claimPolicyType or o.PolicyType == null)) : otherInstructionByCategory;
    ...
    // 'value' attribute on HiddenInput (id=instructionCategoryHeader_Input) at OtherInstructionsPanelSet.pcf: line 48, column 47
