...
@javax.annotation.processing.Generated("config/web/pcf/admin/users/EditableAuthorityLimitsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableAuthorityLimitsLVExpressions {
  ...
  public static class EditableAuthorityLimitsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=LimitType_Cell) at EditableAuthorityLimitsLV.pcf: line 30, column 51
    function sortValue_0 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.LimitType
    }
    
    // 'value' attribute on TypeKeyCell (id=PolicyType_Cell) at EditableAuthorityLimitsLV.pcf: line 37, column 42
    function sortValue_1 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.PolicyType
    }
    
    // 'value' attribute on TypeKeyCell (id=CoverageType_Cell) at EditableAuthorityLimitsLV.pcf: line 48, column 45
    function sortValue_2 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.CoverageType
    }
    
    // 'value' attribute on TypeKeyCell (id=CostType_Cell) at EditableAuthorityLimitsLV.pcf: line 55, column 41
    function sortValue_3 (AuthorityLimit :  entity.AuthorityLimit) : java.lang.Object {
      return AuthorityLimit.CostType
    }
    
    // 'value' attribute on CurrencyCell (id=LimitAmount_Cell) at EditableAuthorityLimitsLV.pcf: line 62, column 47
  ...
  public static class IteratorEntryExpressionsImpl extends EditableAuthorityLimitsLVExpressionsImpl {
    ...
    // 'onChange' attribute on PostOnChange at EditableAuthorityLimitsLV.pcf: line 40, column 122
