...
class AdminExpressions {
  ...
  public static class AdminExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function firstVisitableChildDestinationMethod_100 () : pcf.api.Destination {
    ...
    function menuActions_onEnter_93 (def :  pcf.AdminMenuActions) : void {
      def.onEnter()
    }
    
    // 'menuActions' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 67
    function menuActions_refreshVariables_94 (def :  pcf.AdminMenuActions) : void {
      def.refreshVariables()
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 67
    function menuTree_onEnter_95 (def :  pcf.AdminMenuTree) : void {
      def.onEnter()
    }
    
    // 'menuTree' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 67
    function menuTree_refreshVariables_96 (def :  pcf.AdminMenuTree) : void {
      def.refreshVariables()
    }
    
    // 'parent' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 67
    static function parent_97 () : pcf.api.Destination {
      return pcf.AdminWelcome.createDestination()
    }
    
    // 'tabBar' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 67
    function tabBar_onEnter_98 (def :  pcf.TabBar) : void {
      def.onEnter()
    }
    
    // 'tabBar' attribute on LocationGroup (id=Admin) at Admin.pcf: line 11, column 67
    function tabBar_refreshVariables_99 (def :  pcf.TabBar) : void {
      def.refreshVariables()
    }
  ...
  public static class LocationGroupMenuItem5ExpressionsImpl extends LocationGroupMenuItem4ExpressionsImpl {
    ...
    // 'location' attribute on LocationGroup (id=Admin) at BusinessRules.pcf: line 12, column 35
    function action_24 () : void {
      pcf.ExposureRules.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at BusinessRules.pcf: line 14, column 34
    function action_26 () : void {
      pcf.ReserveRules.go()
    }
    
    // 'location' attribute on LocationGroup (id=Admin) at BusinessRules.pcf: line 16, column 47
