...
class HolidayDetailDV_defaultExpressions {
  ...
  public static class HolidayDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=ZoneType_Input) at HolidayDetailDV.default.pcf: line 37, column 46
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      zoneType = (__VALUE_TO_SET as typekey.ZoneType)
    }
    
    // 'value' attribute on TextAreaInput (id=Zones_Input) at HolidayDetailDV.default.pcf: line 27, column 47
    ...
    // 'valueRange' attribute on RangeInput (id=ZoneType_Input) at HolidayDetailDV.default.pcf: line 37, column 46
    ...
    // 'valueRange' attribute on RangeInput (id=ZoneType_Input) at HolidayDetailDV.default.pcf: line 37, column 46
    function verifyValueRangeIsAllowedType_12 ($$arg :  typekey.ZoneType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on TextAreaInput (id=Zones_Input) at HolidayDetailDV.default.pcf: line 27, column 47
