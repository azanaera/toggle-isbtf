...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotFixedPropertyIncidentScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotFixedPropertyIncidentScreen_defaultExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotFixedPropertyIncidentScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotFixedPropertyIncidentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotFixedPropertyIncidentScreen.default.pcf: line 23, column 73
    function def_onEnter_1 (def :  pcf.ClaimSnapshotFixedPropertyIncidentDV) : void {
      def.onEnter(Claim, IncidentParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotFixedPropertyIncidentScreen.default.pcf: line 23, column 73
    function def_refreshVariables_2 (def :  pcf.ClaimSnapshotFixedPropertyIncidentDV) : void {
      def.refreshVariables(Claim, IncidentParam)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotFixedPropertyIncidentScreen.default.pcf: line 20, column 31
