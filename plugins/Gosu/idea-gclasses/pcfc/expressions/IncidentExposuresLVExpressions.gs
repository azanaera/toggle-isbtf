...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/IncidentExposuresLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class IncidentExposuresLVExpressions {
  ...
  public static class IncidentExposuresLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=ClaimOrder_Cell) at IncidentExposuresLV.pcf: line 22, column 42
  ...
  public static class IteratorEntryExpressionsImpl extends IncidentExposuresLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=ClaimOrder_Cell) at IncidentExposuresLV.pcf: line 22, column 42
    ...
    // 'value' attribute on TextInput (id=Paid_Input) at IncidentExposuresLV.pcf: line 45, column 64
    ...
    // 'value' attribute on TextInput (id=RemainingReserves_Input) at IncidentExposuresLV.pcf: line 51, column 64
    ...
    // 'value' attribute on TextInput (id=Assignee_Input) at IncidentExposuresLV.pcf: line 35, column 53
    function value_9 () : java.lang.String {
      return exposure.AssigneeDisplayString
    }
    
    // 'visible' attribute on TextInput (id=Paid_Input) at IncidentExposuresLV.pcf: line 45, column 64
    function visible_12 () : java.lang.Boolean {
      return perm.Claim.viewpayments(exposure.Claim)
    }
    
    // 'visible' attribute on TextInput (id=RemainingReserves_Input) at IncidentExposuresLV.pcf: line 51, column 64
