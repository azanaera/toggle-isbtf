...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/PersonNameInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PersonNameInputSetExpressions {
  ...
  public static class PersonNameInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=FormerName_Input) at PersonNameInputSet.pcf: line 30, column 36
