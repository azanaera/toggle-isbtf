...
class EditableRecodeLineItemsLVExpressions {
  ...
  public static class EditableRecodeLineItemsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=LineCategory_Cell) at EditableRecodeLineItemsLV.pcf: line 31, column 45
    ...
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at EditableRecodeLineItemsLV.pcf: line 39, column 55
  ...
  public static class IteratorEntryExpressionsImpl extends EditableRecodeLineItemsLVExpressionsImpl {
    ...
    // 'editable' attribute on CurrencyCell (id=Amount_Cell) at EditableRecodeLineItemsLV.pcf: line 39, column 55
    ...
    // 'editable' attribute on TypeKeyCell (id=LineCategory_Cell) at EditableRecodeLineItemsLV.pcf: line 31, column 45
    ...
    // 'filter' attribute on TypeKeyCell (id=LineCategory_Cell) at EditableRecodeLineItemsLV.pcf: line 31, column 45
