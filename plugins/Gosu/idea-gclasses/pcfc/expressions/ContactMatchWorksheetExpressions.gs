...
@javax.annotation.processing.Generated("config/web/pcf/contacts/ContactMatchWorksheet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ContactMatchWorksheetExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/contacts/ContactMatchWorksheet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ContactMatchWorksheetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ScreenRef at ContactMatchWorksheet.pcf: line 27, column 117
    ...
    // 'initialValue' attribute on Variable at ContactMatchWorksheet.pcf: line 21, column 56
    function initialValue_0 () : gw.api.contact.ProximitySearchPageHelper {
      return new gw.api.contact.ProximitySearchPageHelper()
    }
    
    override property get CurrentLocation () : pcf.ContactMatchWorksheet {
      return super.CurrentLocation as pcf.ContactMatchWorksheet
    }
