...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/EditableGeneralLiabilityPolicyCoveragesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableGeneralLiabilityPolicyCoveragesLVExpressions {
  ...
  public static class EditableGeneralLiabilityPolicyCoveragesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'editable' attribute on RowIterator at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 23, column 43
    function editable_8 () : java.lang.Boolean {
      return !Policy.Verified
    }
    
    // 'value' attribute on TypeKeyCell (id=CoverageType_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 33, column 44
    function sortValue_0 (PolicyCoverage :  entity.PolicyCoverage) : java.lang.Object {
      return PolicyCoverage.Type
    }
    
    // 'value' attribute on TypeKeyCell (id=Currency_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 44, column 64
    function sortValue_1 (PolicyCoverage :  entity.PolicyCoverage) : java.lang.Object {
      return PolicyCoverage.Currency
    }
    
    // 'value' attribute on CurrencyCell (id=Deductible_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 53, column 69
    function sortValue_3 (PolicyCoverage :  entity.PolicyCoverage) : java.lang.Object {
      return PolicyCoverage.Deductible
    }
    
    // 'value' attribute on CurrencyCell (id=ExposureLimit_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 59, column 49
    function sortValue_5 (PolicyCoverage :  entity.PolicyCoverage) : java.lang.Object {
      return PolicyCoverage.ExposureLimit
    }
    
    // 'value' attribute on CurrencyCell (id=IncidentLimit_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 65, column 49
    function sortValue_6 (PolicyCoverage :  entity.PolicyCoverage) : java.lang.Object {
      return PolicyCoverage.IncidentLimit
    }
    
    // 'value' attribute on TextCell (id=Notes_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 71, column 41
    function sortValue_7 (PolicyCoverage :  entity.PolicyCoverage) : java.lang.Object {
      return PolicyCoverage.Notes
    }
    
    // 'toAdd' attribute on RowIterator at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 23, column 43
    function toAdd_36 (PolicyCoverage :  entity.PolicyCoverage) : void {
      Policy.addCoverage(PolicyCoverage)
    }
    
    // 'toRemove' attribute on RowIterator at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 23, column 43
    function toRemove_37 (PolicyCoverage :  entity.PolicyCoverage) : void {
      Policy.removeCoverage(PolicyCoverage)
    }
    
    // 'value' attribute on RowIterator at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 23, column 43
    function value_38 () : entity.PolicyCoverage[] {
      return Policy.Coverages
    }
    
    // 'visible' attribute on TypeKeyCell (id=Currency_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 44, column 64
    function visible_2 () : java.lang.Boolean {
      return gw.api.util.CurrencyUtil.MultiCurrencyMode
    }
    
    // 'visible' attribute on CurrencyCell (id=Deductible_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 53, column 69
  ...
  public static class IteratorEntryExpressionsImpl extends EditableGeneralLiabilityPolicyCoveragesLVExpressionsImpl {
    ...
    // 'editable' attribute on TypeKeyCell (id=Currency_Cell) at EditableGeneralLiabilityPolicyCoveragesLV.pcf: line 44, column 64
