...
@javax.annotation.processing.Generated("config/web/pcf/admin/users/UserAuthorityLimitsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class UserAuthorityLimitsDVExpressions {
  ...
  public static class UserAuthorityLimitsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=Currency_Input) at UserAuthorityLimitsDV.pcf: line 38, column 99
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      User.AuthorityProfile.Currency = (__VALUE_TO_SET as typekey.Currency)
    }
    
    // 'value' attribute on RangeInput (id=AuthorityLimitsProfile_Input) at UserAuthorityLimitsDV.pcf: line 21, column 50
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      AuthorityLimitsProfile = (__VALUE_TO_SET as entity.AuthorityLimitProfile)
    }
    
    // 'editable' attribute on RangeInput (id=AuthorityLimitsProfile_Input) at UserAuthorityLimitsDV.pcf: line 21, column 50
    ...
    // 'valueRange' attribute on RangeInput (id=AuthorityLimitsProfile_Input) at UserAuthorityLimitsDV.pcf: line 21, column 50
    ...
    // 'visible' attribute on TypeKeyInput (id=Currency_Input) at UserAuthorityLimitsDV.pcf: line 38, column 99
