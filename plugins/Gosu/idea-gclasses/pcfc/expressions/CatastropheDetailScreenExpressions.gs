...
@javax.annotation.processing.Generated("config/web/pcf/admin/catastrophes/CatastropheDetailScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CatastropheDetailScreenExpressions {
  ...
  public static class CatastropheDetailScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=ShowCatMapButton) at CatastropheDetailScreen.pcf: line 38, column 76
    ...
    // 'available' attribute on ToolbarButton (id=ShowCatMapButton) at CatastropheDetailScreen.pcf: line 38, column 76
    ...
    // 'visible' attribute on Card (id=Policy) at CatastropheDetailScreen.pcf: line 45, column 144
    function visible_15 () : java.lang.Boolean {
      return gw.api.heatmap.HeatMapGenerator.HeatMapConfigured and gw.api.heatmap.CatastropheHeatMap.isPolicyLocationDownloadConfigured()
    }
    ...
    // 'visible' attribute on ToolbarButton (id=ShowCatMapButton) at CatastropheDetailScreen.pcf: line 38, column 76
    function visible_7 () : java.lang.Boolean {
      return gw.api.heatmap.HeatMapGenerator.HeatMapConfigured
    }
