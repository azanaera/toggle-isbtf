...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/policylocations/PolicyLocationScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PolicyLocationScreenExpressions {
  ...
  public static class PolicyLocationScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=LocationNumber_Input) at PolicyLocationScreen.pcf: line 36, column 50
    ...
    // 'visible' attribute on InputSet at PolicyLocationScreen.pcf: line 42, column 111
    function visible_16 () : java.lang.Boolean {
      return not gw.config.LOBAbstraction.ForClaim.ForLossType.isWorkComp(PolicyLocation.Policy.Claim)
    }
