...
@javax.annotation.processing.Generated("config/web/pcf/admin/businesssettings/BusinessSettings.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class BusinessSettingsExpressions {
  ...
  public static class LocationGroupMenuItemExpressionsImpl extends BusinessSettingsExpressionsImpl {
    ...
    // 'location' attribute on LocationGroup (id=BusinessSettings) at BusinessRules.pcf: line 12, column 35
    function action_2 () : void {
      pcf.ExposureRules.go()
    }
    
    // 'location' attribute on LocationGroup (id=BusinessSettings) at BusinessRules.pcf: line 14, column 34
    function action_4 () : void {
      pcf.ReserveRules.go()
    }
    
    // 'location' attribute on LocationGroup (id=BusinessSettings) at BusinessRules.pcf: line 16, column 47
