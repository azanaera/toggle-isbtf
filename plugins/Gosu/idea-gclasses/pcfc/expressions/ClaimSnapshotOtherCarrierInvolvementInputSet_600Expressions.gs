...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/shared/ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotOtherCarrierInvolvementInputSet_600Expressions {
  ...
  public static class ClaimSnapshotOtherCarrierInvolvementInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Insurer_Cell) at ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf: line 40, column 44
    function sortValue_4 (OtherCoverageDet :  dynamic.Dynamic) : java.lang.Object {
      return OtherCoverageDet.Insurer
    }
    
    // 'value' attribute on TextCell (id=PolicyNumber_Cell) at ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf: line 45, column 44
    function sortValue_5 (OtherCoverageDet :  dynamic.Dynamic) : java.lang.Object {
      return OtherCoverageDet.PolicyNumber
    }
    
    // 'value' attribute on TextCell (id=ContactName_Cell) at ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf: line 50, column 44
    function sortValue_6 (OtherCoverageDet :  dynamic.Dynamic) : java.lang.Object {
      return OtherCoverageDet.ContactName
    }
    
    // 'value' attribute on TextCell (id=ContactPhone_Cell) at ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf: line 56, column 44
    function sortValue_7 (OtherCoverageDet :  dynamic.Dynamic) : java.lang.Object {
      return OtherCoverageDet.ContactPhone
    }
    
    // 'value' attribute on TextCell (id=Notes_Cell) at ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf: line 61, column 44
    function sortValue_8 (OtherCoverageDet :  dynamic.Dynamic) : java.lang.Object {
      return OtherCoverageDet.Notes
    }
    
    // 'value' attribute on BooleanRadioInput (id=OtherCoverage_Input) at ClaimSnapshotOtherCarrierInvolvementInputSet.600.pcf: line 23, column 36
