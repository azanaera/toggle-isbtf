...
class TeamGroupExposuresExpressions {
  ...
  public static class TeamGroupExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupExposures_Print) at TeamGroupExposures.pcf: line 45, column 25
    function action_5 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupExposures_Assign) at TeamGroupExposures.pcf: line 38, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupExposures_Print) at TeamGroupExposures.pcf: line 45, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupExposures.pcf: line 48, column 65
    ...
    // 'title' attribute on TitleBar at TeamGroupExposures.pcf: line 30, column 98
