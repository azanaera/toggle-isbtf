...
uses java.util.List
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/VehicleIncidentAutoBodyDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class VehicleIncidentAutoBodyDVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends VehicleIncidentAutoBodyDVExpressionsImpl {
    ...
    // 'label' attribute on TextInput (id=Coverage_Input) at VehicleIncidentAutoBodyDV.pcf: line 43, column 57
    function label_2 () : java.lang.Object {
      return coverage.DisplayName
    }
    
    // 'value' attribute on TextInput (id=Coverage_Input) at VehicleIncidentAutoBodyDV.pcf: line 43, column 57
  ...
  public static class VehicleIncidentAutoBodyDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 16, column 225
    ...
    // 'action' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 18, column 285
    ...
    // 'action' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'allowToggle' attribute on InputGroup (id=AutobodyInputGroup) at VehicleIncidentAutoBodyDV.pcf: line 32, column 48
    function available_39 () : java.lang.Boolean {
      return isEditableServiceRequest()
    }
    
    // 'def' attribute on InputSetRef at VehicleIncidentAutoBodyDV.pcf: line 72, column 43
    ...
    // 'def' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 14, column 229
    function def_onEnter_8 (def :  pcf.ClaimNewRepairShopOnlyPickerMenuItemSet) : void {
    ...
    // 'def' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 14, column 229
    function def_refreshVariables_9 (def :  pcf.ClaimNewRepairShopOnlyPickerMenuItemSet) : void {
      def.refreshVariables(statictypeof (repairServiceRequest.SpecialistAndCreateClaimContact), null, vehicleIncident.Claim)
    }
    
    // 'value' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'label' attribute on InputGroup (id=AutobodyInputGroup) at VehicleIncidentAutoBodyDV.pcf: line 32, column 48
    ...
    // 'onPick' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'onToggle' attribute on InputGroup (id=AutobodyInputGroup) at VehicleIncidentAutoBodyDV.pcf: line 32, column 48
    function setter_41 (VALUE :  java.lang.Boolean) : void {
      toggleServiceRequest(VALUE)
    }
    
    // 'valueRange' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'value' attribute on TextInput (id=RepairShopAddress_Input) at VehicleIncidentAutoBodyDV.pcf: line 65, column 43
    ...
    // 'value' attribute on TextInput (id=RepairShopPhone_Input) at VehicleIncidentAutoBodyDV.pcf: line 69, column 74
    function value_29 () : java.lang.String {
      return repairServiceRequest.Specialist.PrimaryPhoneValue
    }
    
    // 'value' attribute on InputIterator (id=Coverages) at VehicleIncidentAutoBodyDV.pcf: line 39, column 68
    ...
    // 'visible' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 16, column 225
    ...
    // 'visible' attribute on InputSet (id=OtherServiceRequestInfo) at VehicleIncidentAutoBodyDV.pcf: line 60, column 63
    function visible_36 () : java.lang.Boolean {
      return repairServiceRequest.Specialist != null
    }
    
    // 'visible' attribute on InputSet at VehicleIncidentAutoBodyDV.pcf: line 34, column 40
    function visible_37 () : java.lang.Boolean {
      return autoRepairSelected
    }
    
    // 'visible' attribute on ClaimContactInput (id=RepairShop_Input) at ClaimContactWidget.xml: line 14, column 229
