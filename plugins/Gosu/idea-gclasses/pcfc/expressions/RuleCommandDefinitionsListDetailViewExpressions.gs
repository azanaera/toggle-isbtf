...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleCommandDefinitionsListDetailView.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleCommandDefinitionsListDetailViewExpressions {
  ...
  public static class RuleCommandDefinitionsListDetailViewExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_32 (def :  pcf.CommandDefinitionDV_createexposure) : void {
      def.onEnter(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_onEnter_34 (def :  pcf.CommandDefinitionDV_createreserve) : void {
      def.onEnter(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_onEnter_36 (def :  pcf.CommandDefinitionDV_default) : void {
      def.onEnter(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_onEnter_38 (def :  pcf.CommandDefinitionDV_generateactivity) : void {
      def.onEnter(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_onEnter_40 (def :  pcf.CommandDefinitionDV_generatehistoryevent) : void {
      def.onEnter(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_onEnter_42 (def :  pcf.CommandDefinitionDV_setfield) : void {
      def.onEnter(commandDefinition)
    }
    ...
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_refreshVariables_33 (def :  pcf.CommandDefinitionDV_createexposure) : void {
      def.refreshVariables(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_refreshVariables_35 (def :  pcf.CommandDefinitionDV_createreserve) : void {
      def.refreshVariables(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_refreshVariables_37 (def :  pcf.CommandDefinitionDV_default) : void {
      def.refreshVariables(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_refreshVariables_39 (def :  pcf.CommandDefinitionDV_generateactivity) : void {
      def.refreshVariables(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_refreshVariables_41 (def :  pcf.CommandDefinitionDV_generatehistoryevent) : void {
      def.refreshVariables(commandDefinition)
    }
    
    // 'def' attribute on PanelRef (id=CommandDefinitionDV) at RuleCommandDefinitionsListDetailView.pcf: line 109, column 62
    function def_refreshVariables_43 (def :  pcf.CommandDefinitionDV_setfield) : void {
      def.refreshVariables(commandDefinition)
    }
