...
class ImportWizard_UploadDVExpressions {
  ...
  public static class ImportWizard_UploadDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=Resolution_Input) at ImportWizard_UploadDV.pcf: line 34, column 54
    function defaultSetter_11 (__VALUE_TO_SET :  java.lang.Object) : void {
      ImportDataInfo.ResolutionStrategy = (__VALUE_TO_SET as gw.api.admin.ImportDataInfo.ResolutionOption)
    }
    
    // 'value' attribute on FileInput (id=File_Input) at ImportWizard_UploadDV.pcf: line 18, column 38
    ...
    // 'validationExpression' attribute on FileInput (id=File_Input) at ImportWizard_UploadDV.pcf: line 18, column 38
    ...
    // 'valueRange' attribute on RangeInput (id=Resolution_Input) at ImportWizard_UploadDV.pcf: line 34, column 54
