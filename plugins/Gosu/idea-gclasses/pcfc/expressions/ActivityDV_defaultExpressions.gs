...
@javax.annotation.processing.Generated("config/web/pcf/workspace/activity/ActivityDV.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ActivityDV_defaultExpressions {
  ...
  public static class ActivityDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at ActivityDV.default.pcf: line 31, column 49
    function def_onEnter_13 (def :  pcf.ActivityBulkInvoiceWarningInputSet) : void {
      def.onEnter(Activity.BulkInvoice)
    }
    
    // 'def' attribute on InputSetRef at ActivityDV.default.pcf: line 33, column 51
    function def_onEnter_15 (def :  pcf.ActivityTrackingInputSet) : void {
      def.onEnter(Activity)
    }
    ...
    // 'def' attribute on InputSetRef at ActivityDV.default.pcf: line 31, column 49
    function def_refreshVariables_14 (def :  pcf.ActivityBulkInvoiceWarningInputSet) : void {
      def.refreshVariables(Activity.BulkInvoice)
    }
    
    // 'def' attribute on InputSetRef at ActivityDV.default.pcf: line 33, column 51
    function def_refreshVariables_16 (def :  pcf.ActivityTrackingInputSet) : void {
      def.refreshVariables(Activity)
    }
    ...
    // 'visible' attribute on InputSetRef at ActivityDV.default.pcf: line 31, column 49
