...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotOtherStructureIncidentCV.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotOtherStructureIncidentCV_defaultExpressions {
  ...
  public static class ClaimSnapshotOtherStructureIncidentCVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=Description_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 38, column 48
    ...
    // 'value' attribute on TextInput (id=EstimateTime_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 55, column 81
    function value_13 () : dynamic.Dynamic {
      return incident.EstRepairTime
    }
    
    // 'value' attribute on TextInput (id=LossEstimate_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 60, column 48
    function value_17 () : dynamic.Dynamic {
      return incident.LossEstimate
    }
    
    // 'value' attribute on TextInput (id=AlreadyRepaired_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 65, column 48
    function value_20 () : dynamic.Dynamic {
      return incident.AlreadyRepaired
    }
    
    // 'value' attribute on TextInput (id=FencesDamaged_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 70, column 48
    function value_23 () : dynamic.Dynamic {
      return incident.FencesDamaged
    }
    
    // 'value' attribute on TextInput (id=EstimatesReceived_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 43, column 48
    function value_4 () : dynamic.Dynamic {
      return incident.EstimatesReceived
    }
    
    // 'value' attribute on TextInput (id=EstimateCost_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 49, column 81
    function value_8 () : dynamic.Dynamic {
      return incident.EstRepairCost
    }
    
    // 'visible' attribute on TextInput (id=EstimateCost_Input) at ClaimSnapshotOtherStructureIncidentCV.default.pcf: line 49, column 81
