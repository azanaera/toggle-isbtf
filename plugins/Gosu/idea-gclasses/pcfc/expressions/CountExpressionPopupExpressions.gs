...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/CountExpressionPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CountExpressionPopupExpressions {
  ...
  public static class CountExpressionPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'autoComplete' attribute on TextInput (id=Iterable_Input) at CountExpressionPopup.pcf: line 43, column 51
    function autoComplete_11 () : gw.api.contact.AutocompleteHandler {
      return fragHolder.IterableHolder.AutocompleteHandler
    }
    
    // 'def' attribute on InputSetRef (id=IterableErrors) at CountExpressionPopup.pcf: line 48, column 88
    function def_onEnter_13 (def :  pcf.ValidationPopupErrorsInputSet) : void {
      def.onEnter(fragHolder.validateIterable(), false)
    }
    
    // 'def' attribute on PanelRef at CountExpressionPopup.pcf: line 61, column 47
    function def_onEnter_20 (def :  pcf.ConditionEnabledDV) : void {
      def.onEnter(fragHolder)
    }
    
    // 'def' attribute on PanelRef (id=ConditionBuilderPanelSet) at CountExpressionPopup.pcf: line 70, column 50
    ...
    // 'value' attribute on TextInput (id=Iterable_Input) at CountExpressionPopup.pcf: line 43, column 51
    ...
    // 'inputConversion' attribute on TextInput (id=Iterable_Input) at CountExpressionPopup.pcf: line 43, column 51
    ...
    // 'label' attribute on Label (id=IterableElementTypeDescription) at CountExpressionPopup.pcf: line 57, column 64
    ...
    // 'outputConversion' attribute on TextInput (id=Iterable_Input) at CountExpressionPopup.pcf: line 43, column 51
    ...
    // 'value' attribute on TextInput (id=Space_Input) at CountExpressionPopup.pcf: line 52, column 62
    ...
    // 'visible' attribute on TextInput (id=Space_Input) at CountExpressionPopup.pcf: line 52, column 62
    function visible_15 () : java.lang.Boolean {
      return fragHolder.validateIterable().IsEmpty
    }
    
    // 'visible' attribute on PanelRef (id=ConditionBuilderPanelSet) at CountExpressionPopup.pcf: line 70, column 50
