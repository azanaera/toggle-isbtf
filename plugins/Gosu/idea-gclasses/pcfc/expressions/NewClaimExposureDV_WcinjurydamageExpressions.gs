...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimExposureDV.Wcinjurydamage.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimExposureDV_WcinjurydamageExpressions {
  ...
  public static class NewClaimExposureDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on PolicyStatCodePickerInput (id=StatLine_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 36, column 63
    ...
    // 'value' attribute on DateInput (id=SettlementDate_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 102, column 38
    function defaultSetter_100 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.SettleDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TypeKeyInput (id=SettlementMethod_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 108, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=JurisdictionState_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 118, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=MedicalTreatment_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 81, column 51
    ...
    // 'value' attribute on BooleanRadioInput (id=PreexDisability_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 86, column 42
    ...
    // 'value' attribute on TextInput (id=PreexDisabilityInfo_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 91, column 46
    ...
    // 'filter' attribute on TypeKeyInput (id=JurisdictionState_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 118, column 43
    ...
    // 'validationExpression' attribute on DateInput (id=SettlementDate_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 102, column 38
    ...
    // 'value' attribute on TypeKeyInput (id=LossParty_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 22, column 44
    ...
    // 'value' attribute on TextInput (id=StatLine_Warning_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 43, column 65
    ...
    // 'value' attribute on TypeKeyInput (id=PrimaryCoverage_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 27, column 43
    ...
    // 'valueType' attribute on ClaimContactInput (id=AltContact_Name_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 54, column 36
    ...
    // 'valueType' attribute on ClaimContactInput (id=Exposure_Doctor_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 66, column 36
    ...
    // 'valueType' attribute on ClaimContactInput (id=Hospital_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 75, column 44
    ...
    // 'visible' attribute on TextInput (id=StatLine_Warning_Input) at NewClaimExposureDV.Wcinjurydamage.pcf: line 43, column 65
