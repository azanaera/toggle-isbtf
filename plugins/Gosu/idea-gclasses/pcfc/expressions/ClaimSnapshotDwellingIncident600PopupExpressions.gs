...
class ClaimSnapshotDwellingIncident600PopupExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotDwellingIncident600Popup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotDwellingIncident600PopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'canVisit' attribute on Popup (id=ClaimSnapshotDwellingIncident600Popup) at ClaimSnapshotDwellingIncident600Popup.pcf: line 9, column 95
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotDwellingIncident600Popup.pcf: line 29, column 25
    ...
    // 'initialValue' attribute on Variable at ClaimSnapshotDwellingIncident600Popup.pcf: line 21, column 31
    function initialValue_0 () : dynamic.Dynamic {
      return gw.api.snapshot.ClaimSnapshotUtil.getSnapshot(Claim)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotDwellingIncident600Popup.pcf: line 25, column 22
    function initialValue_1 () : String {
      return gw.api.snapshot.ClaimSnapshotUtil.getPageVersion(Snapshot)
    }
    
    // 'mode' attribute on PanelRef at ClaimSnapshotDwellingIncident600Popup.pcf: line 29, column 25
    ...
    override property get CurrentLocation () : pcf.ClaimSnapshotDwellingIncident600Popup {
      return super.CurrentLocation as pcf.ClaimSnapshotDwellingIncident600Popup
    }
