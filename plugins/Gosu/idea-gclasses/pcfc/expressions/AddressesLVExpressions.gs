...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/AddressesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressesLVExpressions {
  ...
  public static class AddressesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RadioButtonCell (id=Primary_Cell) at AddressesLV.pcf: line 41, column 54
    function sortValue_0 (address :  entity.Address) : java.lang.Object {
      return address == Contact.PrimaryAddress
    }
    
    // 'value' attribute on TypeKeyCell (id=AddressType_Cell) at AddressesLV.pcf: line 46, column 44
  ...
  public static class IteratorEntryExpressionsImpl extends AddressesLVExpressionsImpl {
    ...
    // 'action' attribute on RadioButtonCell (id=Primary_Cell) at AddressesLV.pcf: line 41, column 54
    ...
    // 'value' attribute on TextCell (id=DisplayName_Cell) at AddressesLV.pcf: line 49, column 40
