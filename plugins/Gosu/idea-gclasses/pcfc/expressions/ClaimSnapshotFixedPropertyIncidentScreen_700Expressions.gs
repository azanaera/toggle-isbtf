...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotFixedPropertyIncidentScreen.700.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotFixedPropertyIncidentScreen_700Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotFixedPropertyIncidentScreen.700.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotFixedPropertyIncidentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotFixedPropertyIncidentScreen.700.pcf: line 23, column 76
    function def_onEnter_1 (def :  pcf.ClaimSnapshotFixedPropertyIncident700DV) : void {
      def.onEnter(Claim, IncidentParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotFixedPropertyIncidentScreen.700.pcf: line 23, column 76
    function def_refreshVariables_2 (def :  pcf.ClaimSnapshotFixedPropertyIncident700DV) : void {
      def.refreshVariables(Claim, IncidentParam)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotFixedPropertyIncidentScreen.700.pcf: line 20, column 31
