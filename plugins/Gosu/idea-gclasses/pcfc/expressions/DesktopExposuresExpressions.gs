...
@javax.annotation.processing.Generated("config/web/pcf/desktop/exposures/DesktopExposures.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DesktopExposuresExpressions {
  ...
  public static class DesktopExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=DesktopExposures_PrintButton) at DesktopExposures.pcf: line 41, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopExposures_AssignButton) at DesktopExposures.pcf: line 33, column 25
    ...
    // 'available' attribute on ToolbarButton (id=DesktopExposures_PrintButton) at DesktopExposures.pcf: line 41, column 25
    ...
    // 'def' attribute on PanelRef at DesktopExposures.pcf: line 44, column 83
