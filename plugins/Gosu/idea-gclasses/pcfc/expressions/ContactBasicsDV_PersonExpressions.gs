...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/ContactBasicsDV.Person.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ContactBasicsDV_PersonExpressions {
  ...
  public static class ContactBasicsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=Notes_Input) at ContactBasicsDV.Person.pcf: line 61, column 31
