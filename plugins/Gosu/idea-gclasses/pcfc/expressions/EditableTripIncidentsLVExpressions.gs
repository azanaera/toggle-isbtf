...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/EditableTripIncidentsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableTripIncidentsLVExpressions {
  ...
  public static class EditableTripIncidentsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=TripRU_Cell) at EditableTripIncidentsLV.pcf: line 35, column 172
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at EditableTripIncidentsLV.pcf: line 41, column 45
    function sortValue_1 (TripIncident :  entity.TripIncident) : java.lang.Object {
      return TripIncident.Description
    }
    
    // 'value' attribute on CurrencyCell (id=CostIncurred_Cell) at EditableTripIncidentsLV.pcf: line 46, column 88
  ...
  public static class IteratorEntryExpressionsImpl extends EditableTripIncidentsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=TripRU_Cell) at EditableTripIncidentsLV.pcf: line 35, column 172
    ...
    // 'editable' attribute on TextCell (id=Description_Cell) at EditableTripIncidentsLV.pcf: line 41, column 45
