...
@javax.annotation.processing.Generated("config/web/pcf/admin/users/UserDetailDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class UserDetailDVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends UserDetailDVExpressionsImpl {
    ...
    // 'value' attribute on RangeCell (id=Name_Cell) at UserDetailDV.pcf: line 75, column 42
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      UserRole.Role = (__VALUE_TO_SET as entity.Role)
    }
    
    // Reflect at UserDetailDV.pcf: line 81, column 38
    function reflectionValue_28 (TRIGGER_INDEX :  int, VALUE :  entity.Role) : java.lang.Object {
      return VALUE.Description
    }
    
    // 'valueRange' attribute on RangeCell (id=Name_Cell) at UserDetailDV.pcf: line 75, column 42
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at UserDetailDV.pcf: line 79, column 51
    ...
    // 'valueRange' attribute on RangeCell (id=Name_Cell) at UserDetailDV.pcf: line 75, column 42
    function verifyValueRangeIsAllowedType_25 ($$arg :  entity.Role[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeCell (id=Name_Cell) at UserDetailDV.pcf: line 75, column 42
    function verifyValueRangeIsAllowedType_25 ($$arg :  gw.api.database.IQueryBeanResult<entity.Role>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
  ...
  public static class UserDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at UserDetailDV.pcf: line 92, column 27
    ...
    // 'value' attribute on RangeInput (id=StartupPage_Input) at UserDetailDV.pcf: line 40, column 30
    ...
    // 'toAdd' attribute on RowIterator at UserDetailDV.pcf: line 65, column 43
    function toAdd_32 (UserRole :  entity.UserRole) : void {
      User.addToRoles(UserRole)
    }
    
    // 'toRemove' attribute on RowIterator at UserDetailDV.pcf: line 65, column 43
    function toRemove_33 (UserRole :  entity.UserRole) : void {
      User.removeFromRoles(UserRole)
    }
    
    // 'valueRange' attribute on RangeInput (id=StartupPage_Input) at UserDetailDV.pcf: line 40, column 30
    ...
    // 'value' attribute on TextInput (id=Workload_Input) at UserDetailDV.pcf: line 46, column 109
    function value_16 () : java.lang.Integer {
      return getUserWorkload(User)
    }
    
    // 'value' attribute on RowIterator at UserDetailDV.pcf: line 65, column 43
    ...
    // 'valueRange' attribute on RangeInput (id=StartupPage_Input) at UserDetailDV.pcf: line 40, column 30
    function verifyValueRangeIsAllowedType_11 ($$arg :  typekey.StartupPage[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on TextInput (id=Workload_Input) at UserDetailDV.pcf: line 46, column 109
    ...
    // 'visible' attribute on RangeInput (id=StartupPage_Input) at UserDetailDV.pcf: line 40, column 30
