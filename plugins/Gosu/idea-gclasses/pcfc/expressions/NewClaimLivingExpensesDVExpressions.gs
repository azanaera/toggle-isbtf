...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimLivingExpensesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimLivingExpensesDVExpressions {
  ...
  public static class NewClaimLivingExpensesDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=Living_Expenses_Incident_Input) at NewClaimLivingExpensesDV.pcf: line 25, column 51
    function defaultSetter_9 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.LivingExpensesIncident = (__VALUE_TO_SET as entity.LivingExpensesIncident)
    }
    
    // 'valueRange' attribute on RangeInput (id=Living_Expenses_Incident_Input) at NewClaimLivingExpensesDV.pcf: line 25, column 51
    ...
    // 'value' attribute on RangeInput (id=Living_Expenses_Incident_Input) at NewClaimLivingExpensesDV.pcf: line 25, column 51
    function value_8 () : entity.LivingExpensesIncident {
      return Exposure.LivingExpensesIncident
    }
    
    // 'valueRange' attribute on RangeInput (id=Living_Expenses_Incident_Input) at NewClaimLivingExpensesDV.pcf: line 25, column 51
    function verifyValueRangeIsAllowedType_12 ($$arg :  entity.LivingExpensesIncident[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeInput (id=Living_Expenses_Incident_Input) at NewClaimLivingExpensesDV.pcf: line 25, column 51
    function verifyValueRangeIsAllowedType_12 ($$arg :  gw.api.database.IQueryBeanResult<entity.LivingExpensesIncident>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
