...
@javax.annotation.processing.Generated("config/web/pcf/admin/users/UserAttributesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class UserAttributesLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends UserAttributesLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=State_Cell) at UserAttributesLV.pcf: line 43, column 38
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      Attribute.State = (__VALUE_TO_SET as typekey.State)
    }
    
    // 'value' attribute on TextCell (id=Value_Cell) at UserAttributesLV.pcf: line 49, column 42
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      Attribute.Value = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'outputConversion' attribute on TextCell (id=Name_Cell) at UserAttributesLV.pcf: line 31, column 45
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at UserAttributesLV.pcf: line 31, column 45
