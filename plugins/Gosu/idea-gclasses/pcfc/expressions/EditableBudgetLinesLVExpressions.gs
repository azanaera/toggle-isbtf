...
@javax.annotation.processing.Generated("config/web/pcf/claim/litigation/EditableBudgetLinesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableBudgetLinesLVExpressions {
  ...
  public static class EditableBudgetLinesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=BudgetLineType_Cell) at EditableBudgetLinesLV.pcf: line 31, column 45
    function sortValue_0 (BudgetLine :  entity.BudgetLine) : java.lang.Object {
      return BudgetLine.BudgetLineType
    }
    
    // 'value' attribute on CurrencyCell (id=OriginalEstimate_Cell) at EditableBudgetLinesLV.pcf: line 40, column 47
    function sortValue_1 (BudgetLine :  entity.BudgetLine) : java.lang.Object {
      return BudgetLine.OriginalEstimate
    }
    
    // 'value' attribute on CurrencyCell (id=TotalPayments_Cell) at EditableBudgetLinesLV.pcf: line 50, column 90
    ...
    // 'value' attribute on CurrencyCell (id=Difference_Cell) at EditableBudgetLinesLV.pcf: line 58, column 42
    function sortValue_3 (BudgetLine :  entity.BudgetLine) : java.lang.Object {
      return BudgetLine.difference
    }
    
    // '$$sumValue' attribute on RowIterator at EditableBudgetLinesLV.pcf: line 40, column 47
    function sumValueRoot_5 (BudgetLine :  entity.BudgetLine) : java.lang.Object {
      return BudgetLine
    }
    
    // 'footerSumValue' attribute on RowIterator at EditableBudgetLinesLV.pcf: line 40, column 47
    function sumValue_4 (BudgetLine :  entity.BudgetLine) : java.lang.Object {
      return BudgetLine.OriginalEstimate
    }
    
    // 'footerSumValue' attribute on RowIterator at EditableBudgetLinesLV.pcf: line 50, column 90
    function sumValue_6 (BudgetLine :  entity.BudgetLine) : java.lang.Object {
      return Matter.getTotalPaidForMatterCostCategory( BudgetLine.BudgetLineType )
    }
    
    // 'footerSumValue' attribute on RowIterator at EditableBudgetLinesLV.pcf: line 58, column 42
  ...
  public static class IteratorEntryExpressionsImpl extends EditableBudgetLinesLVExpressionsImpl {
    ...
    // 'editable' attribute on TypeKeyCell (id=BudgetLineType_Cell) at EditableBudgetLinesLV.pcf: line 31, column 45
