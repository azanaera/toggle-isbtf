...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/310/ClaimSnapshotPolicyVehicles310LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyVehicles310LVExpressions {
  ...
  public static class ClaimSnapshotPolicyVehicles310LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=VehicleNumber_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 23, column 40
    function sortValue_0 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.VehicleNumber
    }
    
    // 'value' attribute on TextCell (id=Make_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 28, column 40
    function sortValue_1 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.Make
    }
    
    // 'value' attribute on TextCell (id=Model_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 33, column 40
    function sortValue_2 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.Model
    }
    
    // 'value' attribute on TextCell (id=Year_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 38, column 40
    function sortValue_3 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.Year
    }
    
    // 'value' attribute on TextCell (id=Color_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 43, column 40
    function sortValue_4 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.Color
    }
    
    // 'value' attribute on TextCell (id=VIN_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 48, column 40
    function sortValue_5 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.VIN
    }
    
    // 'value' attribute on TextCell (id=State_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 53, column 40
    function sortValue_6 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.State
    }
    
    // 'value' attribute on TextCell (id=LicensePlate_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 58, column 40
    function sortValue_7 (PolicyVehicle :  dynamic.Dynamic) : java.lang.Object {
      return PolicyVehicle.Vehicle.LicensePlate
    }
    
    // 'value' attribute on TextCell (id=Lienholders_Cell) at ClaimSnapshotPolicyVehicles310LV.pcf: line 62, column 81
