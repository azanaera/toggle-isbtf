...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotPolicyLocationPanelSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyLocationPanelSetExpressions {
  ...
  public static class ClaimSnapshotPolicyLocationLDPExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    function def_onEnter_112 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyLocationPanelSet.pcf: line 254, column 43
    function def_onEnter_114 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyLocationPanelSet.pcf: line 254, column 43
    function def_onEnter_116 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyLocationPanelSet.pcf: line 254, column 43
    function def_refreshVariables_113 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyLocationPanelSet.pcf: line 254, column 43
    function def_refreshVariables_115 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyLocationPanelSet.pcf: line 254, column 43
    function def_refreshVariables_117 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.refreshVariables(SelectedCoverage)
    }
