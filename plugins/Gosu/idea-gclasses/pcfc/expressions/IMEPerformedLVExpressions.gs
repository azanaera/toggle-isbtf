...
@javax.annotation.processing.Generated("config/web/pcf/claim/shared/exposures/IMEPerformedLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class IMEPerformedLVExpressions {
  ...
  public static class IMEPerformedLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=IMEPerformed_IMEType_Cell) at IMEPerformedLV.pcf: line 28, column 40
    function sortValue_0 (IMEPerformed :  entity.IMEPerformed) : java.lang.Object {
      return IMEPerformed.IMEType
    }
    
    // 'value' attribute on DateCell (id=IMEPerformed_IMEDate_Cell) at IMEPerformedLV.pcf: line 34, column 41
