...
@javax.annotation.processing.Generated("config/web/pcf/claim/incidents/ChoosePropertyContentsScheduledItemPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ChoosePropertyContentsScheduledItemPopupExpressions {
  ...
  public static class ChoosePropertyContentsScheduledItemPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=ItemDescription_Cell) at ChoosePropertyContentsScheduledItemPopup.pcf: line 51, column 41
    function sortValue_3 (item :  entity.PropertyItem) : java.lang.Object {
      return item.Description
    }
    
    // 'value' attribute on CurrencyCell (id=ItemValue_Cell) at ChoosePropertyContentsScheduledItemPopup.pcf: line 55, column 44
    function sortValue_4 (item :  entity.PropertyItem) : java.lang.Object {
      return item.AppraisedValue
    }
    
    // 'value' attribute on RowIterator (id=HighValueItems) at ChoosePropertyContentsScheduledItemPopup.pcf: line 43, column 45
  ...
  public static class IteratorEntryExpressionsImpl extends ChoosePropertyContentsScheduledItemPopupExpressionsImpl {
    ...
    // 'checkBoxVisible' attribute on RowIterator (id=HighValueItems) at ChoosePropertyContentsScheduledItemPopup.pcf: line 43, column 45
