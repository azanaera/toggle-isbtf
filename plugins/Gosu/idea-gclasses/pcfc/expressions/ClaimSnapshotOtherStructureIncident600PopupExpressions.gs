...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotOtherStructureIncident600Popup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotOtherStructureIncident600PopupExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotOtherStructureIncident600Popup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotOtherStructureIncident600PopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'canVisit' attribute on Popup (id=ClaimSnapshotOtherStructureIncident600Popup) at ClaimSnapshotOtherStructureIncident600Popup.pcf: line 9, column 101
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotOtherStructureIncident600Popup.pcf: line 29, column 25
    ...
    // 'initialValue' attribute on Variable at ClaimSnapshotOtherStructureIncident600Popup.pcf: line 21, column 31
    function initialValue_0 () : dynamic.Dynamic {
      return gw.api.snapshot.ClaimSnapshotUtil.getSnapshot(Claim)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotOtherStructureIncident600Popup.pcf: line 25, column 22
    function initialValue_1 () : String {
      return gw.api.snapshot.ClaimSnapshotUtil.getPageVersion(Snapshot)
    }
    
    // 'mode' attribute on PanelRef at ClaimSnapshotOtherStructureIncident600Popup.pcf: line 29, column 25
    ...
    override property get CurrentLocation () : pcf.ClaimSnapshotOtherStructureIncident600Popup {
      return super.CurrentLocation as pcf.ClaimSnapshotOtherStructureIncident600Popup
    }
