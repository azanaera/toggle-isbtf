...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/ValidationErrorsInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ValidationErrorsInputSetExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ValidationErrorsInputSetExpressionsImpl {
    ...
    // 'labelAbove' attribute on TextInput (id=ValidationError_Input) at ValidationErrorsInputSet.pcf: line 45, column 24
    function labelAbove_8 () : java.lang.Boolean {
      return labelAbove
    }
    
    // 'value' attribute on TextInput (id=ValidationError_Input) at ValidationErrorsInputSet.pcf: line 45, column 24
  ...
  public static class ValidationErrorsInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'iconColor' attribute on Link (id=ValidationErrorIcon) at ValidationErrorsInputSet.pcf: line 31, column 35
    ...
    // 'label' attribute on Link (id=Label) at ValidationErrorsInputSet.pcf: line 34, column 29
    function label_3 () : java.lang.Object {
      return firstError
    }
    
    // 'value' attribute on InputIterator at ValidationErrorsInputSet.pcf: line 40, column 38
