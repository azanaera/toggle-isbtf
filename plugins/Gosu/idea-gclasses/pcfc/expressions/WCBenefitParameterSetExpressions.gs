...
@javax.annotation.processing.Generated("config/web/pcf/admin/wcparms/WCBenefitParameterSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class WCBenefitParameterSetExpressions {
  ...
  public static class WCBenefitParameterSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=AddWCBenefitParameterSet) at WCBenefitParameterSet.pcf: line 25, column 59
    ...
    // 'def' attribute on PanelRef at WCBenefitParameterSet.pcf: line 33, column 63
