...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotIncidentAssessDV.600.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotIncidentAssessDV_600Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotIncidentAssessDV.600.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotIncidentAssessDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'initialValue' attribute on Variable at ClaimSnapshotIncidentAssessDV.600.pcf: line 20, column 31
    function initialValue_0 () : dynamic.Dynamic {
      return incidentParam
    }
    
    // 'value' attribute on TextCell (id=Name_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 102, column 46
    function sortValue_28 (AssessmentSource :  dynamic.Dynamic) : java.lang.Object {
      return AssessmentSource.SourceName
    }
    
    // 'value' attribute on TextCell (id=Source_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 107, column 46
    function sortValue_29 (AssessmentSource :  dynamic.Dynamic) : java.lang.Object {
      return AssessmentSource.SourceType
    }
    
    // 'value' attribute on ClaimContactCell (id=Assessor_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 114, column 46
    function sortValue_30 (AssessmentSource :  dynamic.Dynamic) : java.lang.Object {
      return AssessmentSource.Assessor
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 119, column 46
    function sortValue_31 (AssessmentSource :  dynamic.Dynamic) : java.lang.Object {
      return AssessmentSource.Description
    }
    
    // 'value' attribute on TextCell (id=Category_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 143, column 46
    function sortValue_58 (assessmentItem :  dynamic.Dynamic) : java.lang.Object {
      return assessmentItem.PropertyCategory
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 149, column 46
    function sortValue_59 (assessmentItem :  dynamic.Dynamic) : java.lang.Object {
      return assessmentItem.Description
    }
    
    // 'value' attribute on TextCell (id=Action_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 154, column 46
    function sortValue_60 (assessmentItem :  dynamic.Dynamic) : java.lang.Object {
      return assessmentItem.Action
    }
    
    // 'value' attribute on TextCell (id=EstimateAmount_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 161, column 33
    function sortValue_61 (assessmentItem :  dynamic.Dynamic) : java.lang.Object {
      return assessmentItem.EstimateAmount
    }
    
    // 'value' attribute on TextCell (id=Comment_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 166, column 46
    function sortValue_62 (assessmentItem :  dynamic.Dynamic) : java.lang.Object {
      return assessmentItem.ItemComment
    }
    
    // 'value' attribute on RangeCell (id=AssessmentSource_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 172, column 46
    function sortValue_63 (assessmentItem :  dynamic.Dynamic) : java.lang.Object {
      return assessmentItem.AssessmentSource
    }
    
    // 'value' attribute on TextInput (id=InternalUser_Name_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 64, column 38
    function valueRoot_19 () : java.lang.Object {
      return incident.InternalUser
    }
    
    // 'value' attribute on TextInput (id=Display_Name_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 28, column 38
    ...
    // 'value' attribute on DateInput (id=TargetCloseDate_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 48, column 38
    function value_10 () : dynamic.Dynamic {
      return incident.AssessmentTargetCloseDate
    }
    
    // 'value' attribute on DateInput (id=CloseDate_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 56, column 75
    ...
    // 'value' attribute on TextInput (id=General_Comment_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 69, column 38
    function value_21 () : dynamic.Dynamic {
      return incident.AssessmentComment
    }
    
    // 'value' attribute on CurrencyInput (id=ApproveTotal_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 74, column 51
    function value_24 () : gw.api.financials.CurrencyAmount {
      return approvedTotal(incident.ItemLine)
    }
    
    // 'value' attribute on CurrencyInput (id=ReviewTotal_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 79, column 49
    function value_26 () : gw.api.financials.CurrencyAmount {
      return reviewTotal(incident.ItemLine)
    }
    
    // 'value' attribute on TextInput (id=General_Description_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 34, column 38
    function value_4 () : dynamic.Dynamic {
      return incident.AssessmentName
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotIncidentAssessDV.600.pcf: line 95, column 41
    function value_57 () : dynamic.Dynamic {
      return incident.SourceLine
    }
    
    // 'value' attribute on TextInput (id=Status_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 40, column 37
    function value_7 () : dynamic.Dynamic {
      return incident.AssessmentStatus
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotIncidentAssessDV.600.pcf: line 137, column 41
    function value_83 () : dynamic.Dynamic {
      return incident.ItemLine
    }
    
    // 'visible' attribute on DateInput (id=CloseDate_Input) at ClaimSnapshotIncidentAssessDV.600.pcf: line 56, column 75
  ...
  public static class IteratorEntry2ExpressionsImpl extends ClaimSnapshotIncidentAssessDVExpressionsImpl {
    ...
    // 'valueRange' attribute on RangeCell (id=AssessmentSource_Cell) at ClaimSnapshotIncidentAssessDV.600.pcf: line 172, column 46
