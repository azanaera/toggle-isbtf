...
@javax.annotation.processing.Generated("config/web/pcf/claim/exposures/ExposureDetailScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ExposureDetailScreenExpressions {
  ...
  public static class ExposureDetailScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_24 (def :  pcf.ExposureDetailDV_Employerliability) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_26 (def :  pcf.ExposureDetailDV_Generaldamage) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_28 (def :  pcf.ExposureDetailDV_LivingExpenses) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_30 (def :  pcf.ExposureDetailDV_Lossofusedamage) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_32 (def :  pcf.ExposureDetailDV_Lostwages) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_34 (def :  pcf.ExposureDetailDV_Medpay) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_36 (def :  pcf.ExposureDetailDV_OtherStructure) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_38 (def :  pcf.ExposureDetailDV_Personalpropertydamage) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_40 (def :  pcf.ExposureDetailDV_Pipdamages) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_42 (def :  pcf.ExposureDetailDV_Propertydamage) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_44 (def :  pcf.ExposureDetailDV_Towonly) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_46 (def :  pcf.ExposureDetailDV_TripCancellationDelay) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_48 (def :  pcf.ExposureDetailDV_Vehicledamage) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_onEnter_50 (def :  pcf.ExposureDetailDV_Wcinjurydamage) : void {
      def.onEnter(Exposure, unusedServiceRequests)
    }
    ...
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_25 (def :  pcf.ExposureDetailDV_Employerliability) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_27 (def :  pcf.ExposureDetailDV_Generaldamage) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_29 (def :  pcf.ExposureDetailDV_LivingExpenses) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_31 (def :  pcf.ExposureDetailDV_Lossofusedamage) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_33 (def :  pcf.ExposureDetailDV_Lostwages) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_35 (def :  pcf.ExposureDetailDV_Medpay) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_37 (def :  pcf.ExposureDetailDV_OtherStructure) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_39 (def :  pcf.ExposureDetailDV_Personalpropertydamage) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_41 (def :  pcf.ExposureDetailDV_Pipdamages) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_43 (def :  pcf.ExposureDetailDV_Propertydamage) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_45 (def :  pcf.ExposureDetailDV_Towonly) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_47 (def :  pcf.ExposureDetailDV_TripCancellationDelay) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_49 (def :  pcf.ExposureDetailDV_Vehicledamage) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
    
    // 'def' attribute on PanelRef at ExposureDetailScreen.pcf: line 64, column 37
    function def_refreshVariables_51 (def :  pcf.ExposureDetailDV_Wcinjurydamage) : void {
      def.refreshVariables(Exposure, unusedServiceRequests)
    }
