...
class VacationExposuresExpressions {
  ...
  public static class VacationExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=VacationExposures_Print) at VacationExposures.pcf: line 40, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=VacationExposures_Assign) at VacationExposures.pcf: line 32, column 25
    ...
    // 'available' attribute on ToolbarButton (id=VacationExposures_Print) at VacationExposures.pcf: line 40, column 25
    ...
    // 'def' attribute on PanelRef at VacationExposures.pcf: line 43, column 64
