...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/ActivityRules/activityassignee/AssigneeAdditionalInfoInputSet.queue.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AssigneeAdditionalInfoInputSet_queueExpressions {
  ...
  public static class AssigneeAdditionalInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'pickLocation' attribute on PickerInput (id=QueuePicker_Input) at AssigneeAdditionalInfoInputSet.queue.pcf: line 25, column 35
    ...
    // 'conversionExpression' attribute on PickerInput (id=QueuePicker_Input) at AssigneeAdditionalInfoInputSet.queue.pcf: line 25, column 35
    function conversionExpression_2 (PickedValue :  gw.api.assignment.Assignee) : AssignableQueue {
      return PickedValue as AssignableQueue
    }
    
    // 'value' attribute on PickerInput (id=QueuePicker_Input) at AssigneeAdditionalInfoInputSet.queue.pcf: line 25, column 35
    ...
    // 'value' attribute on PickerInput (id=QueuePicker_Input) at AssigneeAdditionalInfoInputSet.queue.pcf: line 25, column 35
    function value_3 () : AssignableQueue {
      return state.Queue
    }
