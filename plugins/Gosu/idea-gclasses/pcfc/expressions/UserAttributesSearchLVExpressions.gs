...
@javax.annotation.processing.Generated("config/web/pcf/admin/users/UserAttributesSearchLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class UserAttributesSearchLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends UserAttributesSearchLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at UserAttributesSearchLV.pcf: line 23, column 35
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at UserAttributesSearchLV.pcf: line 27, column 42
    function value_6 () : java.lang.String {
      return Attribute.Description
    }
    
    // 'value' attribute on TypeKeyCell (id=Type_Cell) at UserAttributesSearchLV.pcf: line 32, column 50
