...
class TeamUserSubrogationsExpressions {
  ...
  public static class TeamUserSubrogationsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Print) at TeamUserSubrogations.pcf: line 34, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions("SubrogationsLV")
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Assign) at TeamUserSubrogations.pcf: line 27, column 25
    ...
    // 'available' attribute on ToolbarButton (id=Print) at TeamUserSubrogations.pcf: line 34, column 25
    ...
    // 'def' attribute on PanelRef at TeamUserSubrogations.pcf: line 37, column 91
    ...
    // 'title' attribute on TitleBar at TeamUserSubrogations.pcf: line 20, column 91
