...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/checks/PaymentTransferDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PaymentTransferDVExpressions {
  ...
  public static class PaymentTransferDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on CurrencyInput (id=NetTotalIncurred_Input) at PaymentTransferDV.pcf: line 38, column 47
    function valueRoot_12 () : java.lang.Object {
      return gw.api.financials.FinancialsCalculationsForEditedTransaction.getTotalIncurredNet(Payment)
    }
    
    // 'value' attribute on TypeKeyInput (id=PaymentType_Input) at PaymentTransferDV.pcf: line 24, column 41
    function valueRoot_4 () : java.lang.Object {
      return Payment
    }
    
    // 'value' attribute on CurrencyInput (id=AvailableReserves_Input) at PaymentTransferDV.pcf: line 33, column 80
    ...
    // 'visible' attribute on CurrencyInput (id=AvailableReserves_Input) at PaymentTransferDV.pcf: line 33, column 80
