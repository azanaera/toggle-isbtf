...
@javax.annotation.processing.Generated("config/web/pcf/claim/exposures/PIPSummaryDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PIPSummaryDVExpressions {
  ...
  public static class PIPSummaryDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at PIPSummaryDV.pcf: line 159, column 47
    function def_onEnter_103 (def :  pcf.Medicare_ExtInputSet) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on ListViewInput at PIPSummaryDV.pcf: line 163, column 105
    function def_onEnter_105 (def :  pcf.SettlementInformation_ExtLV) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at PIPSummaryDV.pcf: line 170, column 51
    function def_onEnter_107 (def :  pcf.ExposureWorkloadInputSet) : void {
      def.onEnter(Exposure)
    }
    ...
    // 'def' attribute on ListViewInput at PIPSummaryDV.pcf: line 274, column 27
    function def_onEnter_182 (def :  pcf.EditableOtherCoverageDetailsLV) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at PIPSummaryDV.pcf: line 307, column 49
    function def_onEnter_199 (def :  pcf.DeductibleInfoInputSet) : void {
      def.onEnter(Exposure)
    }
    ...
    // 'def' attribute on InputSetRef at PIPSummaryDV.pcf: line 159, column 47
    function def_refreshVariables_104 (def :  pcf.Medicare_ExtInputSet) : void {
      def.refreshVariables(Exposure)
    }
    
    // 'def' attribute on ListViewInput at PIPSummaryDV.pcf: line 163, column 105
    function def_refreshVariables_106 (def :  pcf.SettlementInformation_ExtLV) : void {
      def.refreshVariables(Exposure)
    }
    
    // 'def' attribute on InputSetRef at PIPSummaryDV.pcf: line 170, column 51
    function def_refreshVariables_108 (def :  pcf.ExposureWorkloadInputSet) : void {
      def.refreshVariables(Exposure)
    }
    ...
    // 'def' attribute on ListViewInput at PIPSummaryDV.pcf: line 274, column 27
    function def_refreshVariables_183 (def :  pcf.EditableOtherCoverageDetailsLV) : void {
      def.refreshVariables(Exposure)
    }
    
    // 'def' attribute on InputSetRef at PIPSummaryDV.pcf: line 307, column 49
    function def_refreshVariables_200 (def :  pcf.DeductibleInfoInputSet) : void {
      def.refreshVariables(Exposure)
    }
    ...
    // 'value' attribute on BooleanRadioInput (id=PIPDamages_SSDIEligible_Input) at PIPSummaryDV.pcf: line 180, column 40
    ...
    // 'value' attribute on CurrencyInput (id=LostWagesBenefits_WeeklyCompRate_Input) at PIPSummaryDV.pcf: line 217, column 54
    ...
    // 'value' attribute on TextInput (id=LostWagesBenefits_Description_Input) at PIPSummaryDV.pcf: line 222, column 51
    ...
    // 'value' attribute on TypeKeyInput (id=JurisdictionState_Input) at PIPSummaryDV.pcf: line 247, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=RepresentationLevel_Ext_Input) at PIPSummaryDV.pcf: line 254, column 54
    ...
    // 'value' attribute on TypeKeyInput (id=EscalationLevel_Ext_Input) at PIPSummaryDV.pcf: line 260, column 50
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_OtherCoverage_Input) at PIPSummaryDV.pcf: line 269, column 41
    ...
    // 'filter' attribute on TypeKeyInput (id=JurisdictionState_Input) at PIPSummaryDV.pcf: line 247, column 43
    function filter_168 (VALUE :  typekey.Jurisdiction, VALUES :  typekey.Jurisdiction[]) : java.lang.Boolean {
    ...
    // 'value' attribute on Reflect at PIPSummaryDV.pcf: line 195, column 53
    function reflectionValue_133 (TRIGGER_INDEX :  int, VALUE :  entity.Company) : java.lang.Object {
      return VALUE.PrimaryAddressDisplayValue
    }
    
    // 'value' attribute on Reflect at PIPSummaryDV.pcf: line 203, column 53
    function reflectionValue_138 (TRIGGER_INDEX :  int, VALUE :  entity.Company) : java.lang.Object {
      return VALUE.PrimaryContact.DisplayName
    }
    
    // 'value' attribute on Reflect at PIPSummaryDV.pcf: line 211, column 44
    function reflectionValue_143 (TRIGGER_INDEX :  int, VALUE :  entity.Company) : java.lang.Object {
    ...
    // 'value' attribute on TextInput (id=Provider_PrimaryAddress_Input) at PIPSummaryDV.pcf: line 192, column 68
    function valueRoot_136 () : java.lang.Object {
      return Exposure.disbenprovider
    }
    
    // 'value' attribute on TextInput (id=Provider_PrimaryContact_Input) at PIPSummaryDV.pcf: line 200, column 68
    ...
    // 'value' attribute on CurrencyInput (id=RemainingReserves_Input) at PIPSummaryDV.pcf: line 287, column 57
    ...
    // 'value' attribute on ClaimContactInput (id=DisBenefits_Provider_Input) at ClaimContactWidget.xml: line 12, column 273
    function value_123 () : entity.Company {
      return Exposure.disbenprovider
    }
    ...
    // 'value' attribute on TextInput (id=Provider_PrimaryPhone_Input) at PIPSummaryDV.pcf: line 208, column 59
    ...
    // 'value' attribute on TypeKeyInput (id=Exposure_Segment_Input) at PIPSummaryDV.pcf: line 230, column 43
    function value_156 () : typekey.ClaimSegment {
      return Exposure.Segment
    }
    
    // 'value' attribute on TypeKeyInput (id=Exposure_Strategy_Input) at PIPSummaryDV.pcf: line 235, column 44
    function value_159 () : typekey.ClaimStrategy {
      return Exposure.Strategy
    }
    
    // 'value' attribute on TypeKeyInput (id=Exposure_ValidationLevel_Input) at PIPSummaryDV.pcf: line 240, column 46
    function value_162 () : typekey.ValidationLevel {
      return Exposure.ValidationLevel
    }
    
    // 'value' attribute on TypeKeyInput (id=JurisdictionState_Input) at PIPSummaryDV.pcf: line 247, column 43
    function value_165 () : typekey.Jurisdiction {
      return Exposure.JurisdictionState
    }
    
    // 'value' attribute on TypeKeyInput (id=RepresentationLevel_Ext_Input) at PIPSummaryDV.pcf: line 254, column 54
    function value_170 () : typekey.RepresentationLevel_Ext {
      return Exposure.RepresentationLevel_Ext
    }
    
    // 'value' attribute on TypeKeyInput (id=EscalationLevel_Ext_Input) at PIPSummaryDV.pcf: line 260, column 50
    function value_174 () : typekey.EscalationLevel_Ext {
    ...
    // 'value' attribute on CurrencyInput (id=FuturePayments_Input) at PIPSummaryDV.pcf: line 291, column 54
    function value_187 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.FuturePayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalPayments_Input) at PIPSummaryDV.pcf: line 295, column 53
    function value_190 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalPayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalRecoveries_Input) at PIPSummaryDV.pcf: line 299, column 55
    function value_193 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalRecoveries
    }
    
    // 'value' attribute on CurrencyInput (id=TotalIncurredNet_Input) at PIPSummaryDV.pcf: line 304, column 56
    ...
    // 'valueType' attribute on ClaimContactInput (id=DisBenefits_Provider_Input) at PIPSummaryDV.pcf: line 188, column 37
