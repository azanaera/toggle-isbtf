...
@javax.annotation.processing.Generated("config/web/pcf/claim/exposures/EditableMedicalActionsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableMedicalActionsLVExpressions {
  ...
  public static class EditableMedicalActionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=ActionDate_Cell) at EditableMedicalActionsLV.pcf: line 29, column 45
    function sortValue_0 (MedicalAction :  entity.MedicalAction) : java.lang.Object {
      return MedicalAction.ActionDate
    }
    
    // 'value' attribute on TextCell (id=ProviderName_Cell) at EditableMedicalActionsLV.pcf: line 34, column 47
    function sortValue_1 (MedicalAction :  entity.MedicalAction) : java.lang.Object {
      return MedicalAction.ProviderName
    }
    
    // 'value' attribute on TypeKeyCell (id=ActionType_Cell) at EditableMedicalActionsLV.pcf: line 41, column 50
    function sortValue_2 (MedicalAction :  entity.MedicalAction) : java.lang.Object {
      return MedicalAction.MedicalActionType
    }
    
    // 'value' attribute on TypeKeyCell (id=FutureActionRequired_Cell) at EditableMedicalActionsLV.pcf: line 47, column 56
    function sortValue_3 (MedicalAction :  entity.MedicalAction) : java.lang.Object {
      return MedicalAction.FutureActionReq
    }
    
    // 'value' attribute on DateCell (id=NextAppointment_Cell) at EditableMedicalActionsLV.pcf: line 52, column 50
    function sortValue_4 (MedicalAction :  entity.MedicalAction) : java.lang.Object {
      return MedicalAction.NextAppointment
    }
    
    // 'value' attribute on TextCell (id=ActionNote_Cell) at EditableMedicalActionsLV.pcf: line 57, column 39
