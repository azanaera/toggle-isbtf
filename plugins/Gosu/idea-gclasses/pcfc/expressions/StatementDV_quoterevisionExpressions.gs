...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/StatementDV.quoterevision.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class StatementDV_quoterevisionExpressions {
  ...
  public static class StatementDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at StatementDV.quoterevision.pcf: line 54, column 27
    ...
    // 'value' attribute on TextInput (id=DaysToPerformService_Input) at StatementDV.quoterevision.pcf: line 42, column 71
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      (currentQuote as ServiceRequestQuote).ExpectedDaysToPerformService = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on TextAreaInput (id=Description_Input) at StatementDV.quoterevision.pcf: line 50, column 25
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      currentQuote.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.quoterevision.pcf: line 27, column 71
    function defaultSetter_3 (__VALUE_TO_SET :  java.lang.Object) : void {
      currentQuote.ReferenceNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.quoterevision.pcf: line 27, column 71
    function editable_0 () : java.lang.Boolean {
      return currentQuote.New
    }
    
    // 'validationExpression' attribute on TextInput (id=DaysToPerformService_Input) at StatementDV.quoterevision.pcf: line 42, column 71
    ...
    // 'value' attribute on CurrencyInput (id=PreviousTotal_Input) at StatementDV.quoterevision.pcf: line 33, column 25
    function value_8 () : gw.api.financials.CurrencyAmount {
      return previousTotal
    }
    
    // 'visible' attribute on TextInput (id=ReferenceNumber_Input) at StatementDV.quoterevision.pcf: line 27, column 71
