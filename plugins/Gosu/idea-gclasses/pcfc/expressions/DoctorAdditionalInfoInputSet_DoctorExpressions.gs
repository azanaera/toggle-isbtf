...
class DoctorAdditionalInfoInputSet_DoctorExpressions {
  ...
  public static class DoctorAdditionalInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=MedicalLicense_Input) at DoctorAdditionalInfoInputSet.Doctor.pcf: line 24, column 38
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Doctor.MedicalLicense = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=DoctorSpecialty_Input) at DoctorAdditionalInfoInputSet.Doctor.pcf: line 30, column 42
