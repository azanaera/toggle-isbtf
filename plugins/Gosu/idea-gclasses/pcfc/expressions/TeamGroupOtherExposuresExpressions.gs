...
class TeamGroupOtherExposuresExpressions {
  ...
  public static class TeamGroupOtherExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupOtherExposures_Print) at TeamGroupOtherExposures.pcf: line 45, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupOtherExposures_Assign) at TeamGroupOtherExposures.pcf: line 38, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupOtherExposures_Print) at TeamGroupOtherExposures.pcf: line 45, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupOtherExposures.pcf: line 48, column 65
