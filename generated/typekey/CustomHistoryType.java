...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CustomHistoryType.tti;CustomHistoryType.tix;CustomHistoryType.ttx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
public class CustomHistoryType implements gw.entity.TypeKey {
  /**
   * Auto: No fault rating
   * Claim exception: Fault rating not set on auto claim
   */
  public static final typekey.CustomHistoryType TC_A_N_F_R = new typekey.CustomHistoryType("a_n_f_r");
  
  /**
   * Guidewire catastrophe rules
   * Change to catastrophe values
   */
  public static final typekey.CustomHistoryType TC_CATASTROPHE = new typekey.CustomHistoryType("catastrophe");
  
  /**
   * Coverage Changed
   * Coverage Changed
   */
  public static final typekey.CustomHistoryType TC_COVERAGE_CHANGED_EXT = new typekey.CustomHistoryType("coverage_changed_ext");
  
  /**
   * New Coverage Created
   */
  public static final typekey.CustomHistoryType TC_COVERAGE_CREATED_EXT = new typekey.CustomHistoryType("coverage_created_ext");
  
  /**
   * Create recovery bill
   * Create recovery bill
   */
  public static final typekey.CustomHistoryType TC_CREATE_RECOVERY_BILL = new typekey.CustomHistoryType("create_recovery_bill");
   ...
   * Email sent
   */
  public static final typekey.CustomHistoryType TC_EMAIL = new typekey.CustomHistoryType("email");
   ...
   * Warning
   */
  public static final typekey.CustomHistoryType TC_WARNING = new typekey.CustomHistoryType("warning");
