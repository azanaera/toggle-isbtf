...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BatchProcessType.tti;BatchProcessType.tix;BatchProcessType.ttx")
...
public class BatchProcessType implements gw.entity.TypeKey {
   ...
   * Transitions invoices from 'CreatingChecks' status to 'AwaitingSubmission' or 'InvalidInvoiceItems' status once the invoice is ready
   */
   ...
   * Processes bulk invoice items across lifecycle
   */
  public static final typekey.BatchProcessType TC_INVOICEITEMPROCESSING = new typekey.BatchProcessType("InvoiceItemProcessing");
  
  /**
   * Invoice Processing
   * Processes invoices for parallel processing of bulk invoice items
   */
  public static final typekey.BatchProcessType TC_INVOICEPROCESSING = new typekey.BatchProcessType("InvoiceProcessing");
   ...
   * Check Escalation
   */
  public static final typekey.BatchProcessType TC_TOGGLE_CHECKESCALATION_EXT = new typekey.BatchProcessType("Toggle_CheckEscalation_Ext");
  
  /**
   * Payment Recode
   * Payment Recode
   */
  public static final typekey.BatchProcessType TC_TOGGLE_PAYMENTRECODE_EXT = new typekey.BatchProcessType("Toggle_PaymentRecode_Ext");
  
  /**
   * Recovery Escalation
   * Recovery Escalation
   */
  public static final typekey.BatchProcessType TC_TOGGLE_RECOVERYESCALATION_EXT = new typekey.BatchProcessType("Toggle_RecoveryEscalation_Ext");
  
  /**
   * Reserve And Recovery Reserve Escalation
   * Reserve And Recovery Reserve Escalation
   */
  public static final typekey.BatchProcessType TC_TOGGLE_RESERVEANDRECOVERYRESERVEESCALATION_EXT = new typekey.BatchProcessType("Toggle_ReserveAndRecoveryReserveEscalation_Ext");
   ...
   */
  @java.lang.Deprecated
  public static final typekey.BatchProcessType TC_TRANSACTIONESCALATION_EXT = new typekey.BatchProcessType("TransactionEscalation_Ext");
