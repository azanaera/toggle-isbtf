...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InsuranceSubLine.tti;InsuranceSubLine.tix;InsuranceSubLine.ttx")
...
public class InsuranceSubLine implements gw.entity.TypeKey {
   ...
   * Homeowners
   */
  public static final typekey.InsuranceSubLine TC_HOPHOMEOWNERS = new typekey.InsuranceSubLine("hopHomeowners");
  
  /**
   * Homeowners with replacement cost
   * Homeowners with replacement cost
   */
  public static final typekey.InsuranceSubLine TC_HOPHOMEOWNERS_RC = new typekey.InsuranceSubLine("hopHomeowners_rc");
   ...
   * Mobile homeowners
   */
  public static final typekey.InsuranceSubLine TC_MOBILE_HOPHOMEOWNERS = new typekey.InsuranceSubLine("mobile_hopHomeowners");
