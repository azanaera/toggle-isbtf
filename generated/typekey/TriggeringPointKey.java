...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TriggeringPointKey.tti;TriggeringPointKey.tix;TriggeringPointKey.ttx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
public class TriggeringPointKey implements gw.entity.TypeKey {
  /**
   * Creation
   * Trigger action when object is created
   */
  public static final typekey.TriggeringPointKey TC_CREATION = new typekey.TriggeringPointKey("Creation");
  
  /**
   * Exception
   * Trigger action when exception batch is run
   */
  public static final typekey.TriggeringPointKey TC_EXCEPTION = new typekey.TriggeringPointKey("Exception");
  
  /**
   * Update
   * Trigger action when object is updated
   */
  public static final typekey.TriggeringPointKey TC_UPDATE = new typekey.TriggeringPointKey("Update");
