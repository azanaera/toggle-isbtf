...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SystemPermissionType.tti;SystemPermissionType.tix;SystemPermissionType.ttx")
...
public class SystemPermissionType implements gw.entity.TypeKey {
   ...
   */
  public static final typekey.SystemPermissionType TC_EDIT_COVERAGES_EXT = new typekey.SystemPermissionType("edit_coverages_ext");
  ...
  /**
   * Exceed Payment Limits
   * Exceed Payment Limits for exposure and incidents
   */
  public static final typekey.SystemPermissionType TC_EXCEED_PAYMENT_LIMIT_EXT = new typekey.SystemPermissionType("exceed_payment_limit_ext");
  ...
  /**
   * Approve Exposure Rule
   * Permission to approve Rule
   */
  public static final typekey.SystemPermissionType TC_EXPOSURERULEAPPROVE = new typekey.SystemPermissionType("exposureruleapprove");
  
  /**
   * Deploy Exposure Rule
   * Permission to deploy Rule
   */
  public static final typekey.SystemPermissionType TC_EXPOSURERULEDEPLOY = new typekey.SystemPermissionType("exposureruledeploy");
  
  /**
   * Edit Exposure Rule
   * Permission to edit Rule
   */
  public static final typekey.SystemPermissionType TC_EXPOSURERULEEDIT = new typekey.SystemPermissionType("exposureruleedit");
  
  /**
   * Import Exposure Rule
   * Permission to import Rule
   */
  public static final typekey.SystemPermissionType TC_EXPOSURERULEIMPORT = new typekey.SystemPermissionType("exposureruleimport");
  
  /**
   * View Exposure Rule
   * Permission to view Rule
   */
  public static final typekey.SystemPermissionType TC_EXPOSURERULEVIEW = new typekey.SystemPermissionType("exposureruleview");
  ...
  /**
   * Approve Reserve Rule
   * Permission to approve Rule
   */
  public static final typekey.SystemPermissionType TC_RESERVERULEAPPROVE = new typekey.SystemPermissionType("reserveruleapprove");
  
  /**
   * Deploy Reserve Rule
   * Permission to deploy Rule
   */
  public static final typekey.SystemPermissionType TC_RESERVERULEDEPLOY = new typekey.SystemPermissionType("reserveruledeploy");
  
  /**
   * Edit Reserve Rule
   * Permission to edit Rule
   */
  public static final typekey.SystemPermissionType TC_RESERVERULEEDIT = new typekey.SystemPermissionType("reserveruleedit");
  
  /**
   * Import Reserve Rule
   * Permission to import Rule
   */
  public static final typekey.SystemPermissionType TC_RESERVERULEIMPORT = new typekey.SystemPermissionType("reserveruleimport");
  
  /**
   * View Reserve Rule
   * Permission to view Rule
   */
  public static final typekey.SystemPermissionType TC_RESERVERULEVIEW = new typekey.SystemPermissionType("reserveruleview");
