...
public class EmploymentStatusType implements gw.entity.TypeKey {
   ...
   * Minor child
   */
  public static final typekey.EmploymentStatusType TC_MINOR = new typekey.EmploymentStatusType("minor");
   ...
   * Student
   */
  public static final typekey.EmploymentStatusType TC_STUDENT = new typekey.EmploymentStatusType("student");
