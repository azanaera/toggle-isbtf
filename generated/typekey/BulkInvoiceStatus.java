...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BulkInvoiceStatus.tti;BulkInvoiceStatus.tix;BulkInvoiceStatus.ttx")
...
public class BulkInvoiceStatus implements gw.entity.TypeKey {
  ...
  /**
   * Creating checks
   * Checks are being created for the invoice
   */
  public static final typekey.BulkInvoiceStatus TC_CREATINGCHECKS = new typekey.BulkInvoiceStatus("creatingchecks");
   ...
   * The invoice encountered a problem during processing
   */
  public static final typekey.BulkInvoiceStatus TC_ERRORDURINGPROCESSING = new typekey.BulkInvoiceStatus("errorduringprocessing");
  
  /**
   * Initiating check creation
   * The invoice is ready for the check creation process to begin
   */
  public static final typekey.BulkInvoiceStatus TC_INITIATINGCHECKCREATION = new typekey.BulkInvoiceStatus("initiatingcheckcreation");
  
  /**
   * Initiating delete
   * The invoice is ready for the delete process to begin
   */
  public static final typekey.BulkInvoiceStatus TC_INITIATINGDELETE = new typekey.BulkInvoiceStatus("initiatingdelete");
  
  /**
   * Initiating escalation
   * The invoice is ready for the escalation process to begin
   */
  public static final typekey.BulkInvoiceStatus TC_INITIATINGESCALATION = new typekey.BulkInvoiceStatus("initiatingescalation");
  
  /**
   * Initiating stop
   * The invoice is ready for the stop process to begin
   */
  public static final typekey.BulkInvoiceStatus TC_INITIATINGSTOP = new typekey.BulkInvoiceStatus("initiatingstop");
  
  /**
   * Initiating void
   * The invoice is ready for the void process to begin
   */
  public static final typekey.BulkInvoiceStatus TC_INITIATINGVOID = new typekey.BulkInvoiceStatus("initiatingvoid");
  ...
  /**
   * Processing delete
   * The invoice is being deleted
   */
  public static final typekey.BulkInvoiceStatus TC_PROCESSINGDELETE = new typekey.BulkInvoiceStatus("processingdelete");
  
  /**
   * Processing escalation
   * The invoice is being escalated
   */
  public static final typekey.BulkInvoiceStatus TC_PROCESSINGESCALATION = new typekey.BulkInvoiceStatus("processingescalation");
  
  /**
   * Processing stop
   * The invoice is being stopped
   */
  public static final typekey.BulkInvoiceStatus TC_PROCESSINGSTOP = new typekey.BulkInvoiceStatus("processingstop");
  
  /**
   * Processing void
   * The invoice is being voided
   */
  public static final typekey.BulkInvoiceStatus TC_PROCESSINGVOID = new typekey.BulkInvoiceStatus("processingvoid");
  ...
  /**
   * Retired
   * The invoice has been retired
   */
  public static final typekey.BulkInvoiceStatus TC_RETIRED = new typekey.BulkInvoiceStatus("retired");
  ...
  public static final gw.entity.ITypeFilter<typekey.BulkInvoiceStatus> TF_ASYNCPROCESSING = new com.guidewire.commons.entity.type2.TypeFilterImpl<typekey.BulkInvoiceStatus>("BulkInvoiceStatus", "AsyncProcessing");
  
  public static final gw.entity.ITypeFilter<typekey.BulkInvoiceStatus> TF_PARALLELPROCESSING = new com.guidewire.commons.entity.type2.TypeFilterImpl<typekey.BulkInvoiceStatus>("BulkInvoiceStatus", "ParallelProcessing");
