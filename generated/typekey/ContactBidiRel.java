...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ContactBidiRel.tti;ContactBidiRel.tix;ContactBidiRel.ttx")
...
public class ContactBidiRel implements gw.entity.TypeKey {
   ...
   * Attorney
   */
  public static final typekey.ContactBidiRel TC_ATTORNEY_EXT = new typekey.ContactBidiRel("attorney_ext");
   ...
   * Child Vendor
   */
  public static final typekey.ContactBidiRel TC_CHILDVENDOR_EXT = new typekey.ContactBidiRel("ChildVendor_Ext");
  
  /**
   * Client
   * Client
   */
  public static final typekey.ContactBidiRel TC_CLIENT_EXT = new typekey.ContactBidiRel("client_ext");
  ...
  /**
   * Farmers Consultant For
   * Farmers Consultant For
   */
  public static final typekey.ContactBidiRel TC_FARMERSCONSULTANTFOR_EXT = new typekey.ContactBidiRel("FarmersConsultantFor_Ext");
  
  /**
   * Farmers Consultant
   * Farmers Consultant
   */
  public static final typekey.ContactBidiRel TC_FARMERSCONSULTANT_EXT = new typekey.ContactBidiRel("FarmersConsultant_Ext");
  
  /**
   * Grantor
   * Grantor
   */
  public static final typekey.ContactBidiRel TC_GRANTOR_EXT = new typekey.ContactBidiRel("grantor_ext");
   ...
   * Other
   */
  public static final typekey.ContactBidiRel TC_OTHEROTHER_EXT = new typekey.ContactBidiRel("otherother_ext");
  
  /**
   * Other
   * Other
   */
  public static final typekey.ContactBidiRel TC_OTHER_EXT = new typekey.ContactBidiRel("other_ext");
  
  /**
   * Parent Vendor
   * Parent Vendor
   */
  public static final typekey.ContactBidiRel TC_PARENTVENDOR_EXT = new typekey.ContactBidiRel("ParentVendor_Ext");
  
  /**
   * Power of Attorney
   * Power of Attorney
   */
  public static final typekey.ContactBidiRel TC_POA_EXT = new typekey.ContactBidiRel("poa_ext");
