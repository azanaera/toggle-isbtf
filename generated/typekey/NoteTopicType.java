...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "NoteTopicType.tti;NoteTopicType.tix;NoteTopicType.ttx")
...
public class NoteTopicType implements gw.entity.TypeKey {
   ...
   * Case Review
   */
  public static final typekey.NoteTopicType TC_CASE_REVIEW_EXT = new typekey.NoteTopicType("case_review_ext");
  
  /**
   * Initial Contact w/CImt or Rep
   * Initial Contact w/CImt or Rep
   */
  public static final typekey.NoteTopicType TC_CONTACT_WITH_CLAIMANT_EXT = new typekey.NoteTopicType("contact_with_claimant_ext");
  
  /**
   * Initial Contact w/Insd or Rep
   * Initial Contact w/Insd or Rep
   */
  public static final typekey.NoteTopicType TC_CONTACT_WITH_INSURED_EXT = new typekey.NoteTopicType("contact_with_insured_ext");
   ...
   * Liability
   */
  public static final typekey.NoteTopicType TC_LIABILITY_EXT = new typekey.NoteTopicType("liability_ext");
   ...
   * Negotiation
   */
  public static final typekey.NoteTopicType TC_NEGOTIATION_EXT = new typekey.NoteTopicType("negotiation_ext");
