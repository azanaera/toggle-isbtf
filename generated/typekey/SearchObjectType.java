...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SearchObjectType.tti;SearchObjectType.tix;SearchObjectType.ttx")
...
public class SearchObjectType implements gw.entity.TypeKey {
   ...
   * Activity search
   */
  public static final typekey.SearchObjectType TC_ACTIVITY = new typekey.SearchObjectType("activity");
  
  /**
   * Claim Search
   * Claim search
   */
  public static final typekey.SearchObjectType TC_CLAIM = new typekey.SearchObjectType("claim");
  
  /**
   * ClaimInfo Search
   * ClaimInfo search
   */
  public static final typekey.SearchObjectType TC_CLAIMINFO = new typekey.SearchObjectType("claimInfo");
  
  /**
   * Note Search
   * Note Search
   */
  public static final typekey.SearchObjectType TC_NOTE = new typekey.SearchObjectType("note");
  
  /**
   * Payment Search
   * Payment search
   */
  public static final typekey.SearchObjectType TC_PAYMENT = new typekey.SearchObjectType("payment");
  
  /**
   * Recovery Search
   * Recovery search
   */
  public static final typekey.SearchObjectType TC_RECOVERY = new typekey.SearchObjectType("recovery");
