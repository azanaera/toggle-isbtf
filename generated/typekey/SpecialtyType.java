...
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SpecialtyType.tti;SpecialtyType.tix;SpecialtyType.ttx")
...
public class SpecialtyType implements gw.entity.TypeKey {
   ...
   * Acupuncture
   */
  public static final typekey.SpecialtyType TC_ACUPUNCTURE_EXT = new typekey.SpecialtyType("Acupuncture_Ext");
   ...
   * Osteopathic
   */
  public static final typekey.SpecialtyType TC_OSTEOPATHIC_EXT = new typekey.SpecialtyType("Osteopathic_Ext");
  
  /**
   * Pain Management
   * Pain Management
   */
  public static final typekey.SpecialtyType TC_PAINMANAGEMENT_EXT = new typekey.SpecialtyType("PainManagement_Ext");
   ...
   * Podiatry
   */
  public static final typekey.SpecialtyType TC_PODIATRY_EXT = new typekey.SpecialtyType("Podiatry_Ext");
  
  /**
   * Prosthetics
   * Prosthetics
   */
  public static final typekey.SpecialtyType TC_PROSTHETICS_EXT = new typekey.SpecialtyType("Prosthetics_Ext");
   ...
   * Psychology/Psychiatry
   */
  public static final typekey.SpecialtyType TC_PSYCHOLOGYPSYCHIATRY_EXT = new typekey.SpecialtyType("PsychologyPsychiatry_Ext");
   ...
   * Radiology
   */
  public static final typekey.SpecialtyType TC_RADIOLOGY_EXT = new typekey.SpecialtyType("Radiology_Ext");
