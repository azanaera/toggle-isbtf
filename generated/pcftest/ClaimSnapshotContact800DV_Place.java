...
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.ActiveHeader;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.CommentsHeader;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.OwnerHeader;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.RoleHeader;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV._ListPaging;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.entry;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.entry._Select;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotContact800DV.place.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotContact800DV_Place extends ClaimSnapshotContact800DV {
  public final static String CHECKSUM = "5bebcec81143c5389890fc63415c0fdc";
  
  public ClaimSnapshotContact800DV_Place(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ClaimRolesLV getClaimRolesLV() {
    return getOrCreateProperty("ClaimRolesLV", "ClaimRolesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.class);
  }
  
  public ClaimRolesLV_tb getClaimRolesLV_tb() {
    return getOrCreateProperty("ClaimRolesLV_tb", "ClaimRolesLV_tb", null, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV_tb.class);
  }
  ...
  public static class ClaimRolesLV extends PCFElement {
    ...
    public ActiveHeader getActiveHeader() {
      return getOrCreateProperty("ActiveHeader", "ActiveHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.ActiveHeader.class);
    }
    
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.CommentsHeader.class);
    }
    
    public OwnerHeader getOwnerHeader() {
      return getOrCreateProperty("OwnerHeader", "OwnerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.OwnerHeader.class);
    }
    
    public RoleHeader getRoleHeader() {
      return getOrCreateProperty("RoleHeader", "RoleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.RoleHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotContact800DV_Place.ClaimRolesLV.entry._ViewDetail.class);
      }
