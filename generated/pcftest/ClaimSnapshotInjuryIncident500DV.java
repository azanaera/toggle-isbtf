...
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.CompensabilityCommentsHeader;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.CompensabilityDecisionDateHeader;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.CompensabilityDecisionHeader;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.DetailedBodyPartHeader;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.OrderingHeader;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.PrimaryBodyPartHeader;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.entry;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.entry._Select;
import pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.entry._ViewDetail;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/500/ClaimSnapshotInjuryIncident500DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotInjuryIncident500DV extends DetailViewElement {
  public final static String CHECKSUM = "4028c8c8ada886bcffa30da016a96660";
  
  public ClaimSnapshotInjuryIncident500DV(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public InjuryIncidentInputSet getInjuryIncidentInputSet() {
    return getOrCreateProperty("InjuryIncidentInputSet", "InjuryIncidentInputSet", null, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.class);
  }
  ...
  public static class InjuryIncidentInputSet extends PCFElement {
    ...
    public CompensabilityCommentsHeader getCompensabilityCommentsHeader() {
      return getOrCreateProperty("CompensabilityCommentsHeader", "CompensabilityCommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.CompensabilityCommentsHeader.class);
    }
    
    public CompensabilityDecisionDateHeader getCompensabilityDecisionDateHeader() {
      return getOrCreateProperty("CompensabilityDecisionDateHeader", "CompensabilityDecisionDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.CompensabilityDecisionDateHeader.class);
    }
    
    public CompensabilityDecisionHeader getCompensabilityDecisionHeader() {
      return getOrCreateProperty("CompensabilityDecisionHeader", "CompensabilityDecisionHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.CompensabilityDecisionHeader.class);
    }
    
    public DetailedBodyPartHeader getDetailedBodyPartHeader() {
      return getOrCreateProperty("DetailedBodyPartHeader", "DetailedBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.DetailedBodyPartHeader.class);
    }
    ...
    public OrderingHeader getOrderingHeader() {
      return getOrCreateProperty("OrderingHeader", "OrderingHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.OrderingHeader.class);
    }
    
    public PrimaryBodyPartHeader getPrimaryBodyPartHeader() {
      return getOrCreateProperty("PrimaryBodyPartHeader", "PrimaryBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.PrimaryBodyPartHeader.class);
    }
    ...
    public IteratorEntries<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.entry.class, gw.smoketest.platform.web.IteratorEntries.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotInjuryIncident500DV.InjuryIncidentInputSet.entry._ViewDetail.class);
      }
