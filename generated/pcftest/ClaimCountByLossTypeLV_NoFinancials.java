...
import pcftest.ClaimCountByLossTypeLV_NoFinancials.ByLossTypeHeader;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_FlaggedHeader;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_LitigatedHeader;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_NoticeOnlyHeader;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_OpenClaimsHeader;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_OpenExposuresHeader;
import pcftest.ClaimCountByLossTypeLV_NoFinancials._ListPaging;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.entry;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.entry.ByLossType;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.entry._Select;
import pcftest.ClaimCountByLossTypeLV_NoFinancials.entry._ViewDetail;
import typekey.LossType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/dashboard/ClaimCountByLossTypeLV.NoFinancials.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimCountByLossTypeLV_NoFinancials extends ClaimCountByLossTypeLV {
  public final static String CHECKSUM = "a0bf73d0858629c932255ef004065589";
  
  public ClaimCountByLossTypeLV_NoFinancials(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ByLossTypeHeader getByLossTypeHeader() {
    return getOrCreateProperty("ByLossTypeHeader", "ByLossTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLossTypeLV_NoFinancials.ByLossTypeHeader.class);
  }
  ...
  public ClaimCount_FlaggedHeader getClaimCount_FlaggedHeader() {
    return getOrCreateProperty("ClaimCount_FlaggedHeader", "ClaimCount_FlaggedHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_FlaggedHeader.class);
  }
  ...
  public ClaimCount_LitigatedHeader getClaimCount_LitigatedHeader() {
    return getOrCreateProperty("ClaimCount_LitigatedHeader", "ClaimCount_LitigatedHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_LitigatedHeader.class);
  }
  ...
  public ClaimCount_NoticeOnlyHeader getClaimCount_NoticeOnlyHeader() {
    return getOrCreateProperty("ClaimCount_NoticeOnlyHeader", "ClaimCount_NoticeOnlyHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_NoticeOnlyHeader.class);
  }
  ...
  public ClaimCount_OpenClaimsHeader getClaimCount_OpenClaimsHeader() {
    return getOrCreateProperty("ClaimCount_OpenClaimsHeader", "ClaimCount_OpenClaimsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_OpenClaimsHeader.class);
  }
  ...
  public ClaimCount_OpenExposuresHeader getClaimCount_OpenExposuresHeader() {
    return getOrCreateProperty("ClaimCount_OpenExposuresHeader", "ClaimCount_OpenExposuresHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLossTypeLV_NoFinancials.ClaimCount_OpenExposuresHeader.class);
  }
  ...
  public IteratorEntriesWithPaging<entry> get_Entries() {
    return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimCountByLossTypeLV_NoFinancials.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
  }
  
  public _ListPaging get_ListPaging() {
    return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimCountByLossTypeLV_NoFinancials._ListPaging.class);
  }
  ...
  public static class entry extends RowElement {
    ...
    public ByLossType getByLossType() {
      return getOrCreateProperty("ByLossType", "ByLossType", null, pcftest.ClaimCountByLossTypeLV_NoFinancials.entry.ByLossType.class);
    }
    ...
    public _Select get_Select() {
      return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimCountByLossTypeLV_NoFinancials.entry._Select.class);
    }
    
    public _ViewDetail get_ViewDetail() {
      return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimCountByLossTypeLV_NoFinancials.entry._ViewDetail.class);
    }
