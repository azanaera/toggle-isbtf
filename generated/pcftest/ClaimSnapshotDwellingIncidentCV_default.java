...
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.DamageTypesIterator;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.NumberOfRoomsHeader;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.RoomTypeHeader;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV._ListPaging;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.entry._Select;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.entry._ViewDetail;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.Dwelling_AssessmentCardTab;
import pcftest.ClaimSnapshotDwellingIncidentCV_default.Dwelling_DetailsCardTab;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotDwellingIncidentCV.default.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotDwellingIncidentCV_default extends ClaimSnapshotDwellingIncidentCV {
  public final static String CHECKSUM = "4c3151dbe4bfd1ebdcc54b67ef7b225c";
  
  public ClaimSnapshotDwellingIncidentCV_default(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public DamageDV getDamageDV() {
    return getOrCreateProperty("DamageDV", "DamageDV", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.class);
  }
  ...
  public Dwelling_AssessmentCardTab getDwelling_AssessmentCardTab() {
    return getOrCreateProperty("Dwelling_AssessmentCardTab", "Dwelling_AssessmentCardTab", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.Dwelling_AssessmentCardTab.class);
  }
  
  public Dwelling_DetailsCardTab getDwelling_DetailsCardTab() {
    return getOrCreateProperty("Dwelling_DetailsCardTab", "Dwelling_DetailsCardTab", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.Dwelling_DetailsCardTab.class);
  }
  ...
  public static class DamageDV extends DetailViewElement {
    ...
    public DamageTypesIterator getDamageTypesIterator() {
      return getOrCreateProperty("DamageTypesIterator", "DamageTypesIterator", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.DamageTypesIterator.class);
    }
    ...
    public NumberOfRoomsHeader getNumberOfRoomsHeader() {
      return getOrCreateProperty("NumberOfRoomsHeader", "NumberOfRoomsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.NumberOfRoomsHeader.class);
    }
    ...
    public RoomTypeHeader getRoomTypeHeader() {
      return getOrCreateProperty("RoomTypeHeader", "RoomTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.RoomTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV._ListPaging.class);
    }
    ...
    public static class DamageTypesIterator extends PCFElement {
      ...
      @SuppressWarnings(value = "unchecked")
      public IteratorEntries<pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.DamageTypesIterator.entry> get_Entries() {
        return getOrCreateEntries(null, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.DamageTypesIterator.entry.class, gw.smoketest.platform.web.IteratorEntries.class);
      }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotDwellingIncidentCV_default.DamageDV.entry._ViewDetail.class);
      }
