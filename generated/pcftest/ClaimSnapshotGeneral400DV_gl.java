...
import pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV;
import pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.MetroReportOrderDateHeader;
import pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.MetroReportStatusHeader;
import pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.MetroReportTypeHeader;
import pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV_tb;
import pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV;
import pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.NameHeader;
import pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.ReportNumberHeader;
import pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.TypeHeader;
import pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/400/ClaimSnapshotGeneral400DV.gl.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotGeneral400DV_gl extends ClaimSnapshotGeneral400DV {
  public final static String CHECKSUM = "ef3942e9131d02140feccc79a713d071";
  
  public ClaimSnapshotGeneral400DV_gl(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public MetroReportsLV getMetroReportsLV() {
    return getOrCreateProperty("MetroReportsLV", "MetroReportsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.class);
  }
  
  public MetroReportsLV_tb getMetroReportsLV_tb() {
    return getOrCreateProperty("MetroReportsLV_tb", "MetroReportsLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV_tb.class);
  }
  
  public OfficialsLV getOfficialsLV() {
    return getOrCreateProperty("OfficialsLV", "OfficialsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.class);
  }
  
  public OfficialsLV_tb getOfficialsLV_tb() {
    return getOrCreateProperty("OfficialsLV_tb", "OfficialsLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV_tb.class);
  }
  ...
  public static class MetroReportsLV extends PCFElement {
    ...
    public MetroReportOrderDateHeader getMetroReportOrderDateHeader() {
      return getOrCreateProperty("MetroReportOrderDateHeader", "MetroReportOrderDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.MetroReportOrderDateHeader.class);
    }
    
    public MetroReportStatusHeader getMetroReportStatusHeader() {
      return getOrCreateProperty("MetroReportStatusHeader", "MetroReportStatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.MetroReportStatusHeader.class);
    }
    
    public MetroReportTypeHeader getMetroReportTypeHeader() {
      return getOrCreateProperty("MetroReportTypeHeader", "MetroReportTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.MetroReportTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_gl.MetroReportsLV.entry._ViewDetail.class);
      }
  ...
  public static class OfficialsLV extends PCFElement {
    ...
    public NameHeader getNameHeader() {
      return getOrCreateProperty("NameHeader", "NameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.NameHeader.class);
    }
    
    public ReportNumberHeader getReportNumberHeader() {
      return getOrCreateProperty("ReportNumberHeader", "ReportNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.ReportNumberHeader.class);
    }
    
    public TypeHeader getTypeHeader() {
      return getOrCreateProperty("TypeHeader", "TypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.TypeHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_gl.OfficialsLV.entry._ViewDetail.class);
      }
