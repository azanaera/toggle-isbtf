...
import pcftest.QuickClaimDV_GL.Claim_LOBCode;
import pcftest.QuickClaimDV_GL.Claim_LossCause;
import pcftest.QuickClaimDV_GL.Claim_LossType;
import pcftest.QuickClaimDV_GL.Claim_ReportedByType;
import pcftest.QuickClaimDV_GL.Claimant_Picker;
import pcftest.QuickClaimDV_GL.Claimant_Type;
import pcftest.QuickClaimDV_GL.CommonAssign;
import pcftest.QuickClaimDV_GL.CommonAssign.CommonAssign_PickerButton;
import pcftest.QuickClaimDV_GL.EditableOfficialsLV_tb;
import pcftest.QuickClaimDV_GL.EditableOfficialsLV_tb.Add;
import pcftest.QuickClaimDV_GL.EditableOfficialsLV_tb.Remove;
import pcftest.QuickClaimDV_GL.Exposure_LossParty;
import pcftest.QuickClaimDV_GL.Exposure_PrimaryCoverage;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.AssigneeHeader;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.ForAssignHeader;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV._ListPaging;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry.Assignee;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry.Assignee.Assignee_PickerButton;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry._Select;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry._ViewDetail;
import pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV_tb;
import pcftest.QuickClaimDV_GL.Notification_Fault;
import pcftest.QuickClaimDV_GL.Notification_HowReported;
import pcftest.QuickClaimDV_GL.Policy_Status;
import pcftest.QuickClaimDV_GL.ReportedBy_Name;
...
@Generated(comments = "config/web/pcf/claim/FNOL/QuickClaimDV.GL.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class QuickClaimDV_GL extends QuickClaimDV {
  public final static String CHECKSUM = "f523b4fd1f2febfce107dc90107e3433";
  
  public QuickClaimDV_GL(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Claim_LOBCode getClaim_LOBCode() {
    return getOrCreateProperty("Claim_LOBCode", "Claim_LOBCode", null, pcftest.QuickClaimDV_GL.Claim_LOBCode.class);
  }
  
  public Claim_LossCause getClaim_LossCause() {
    return getOrCreateProperty("Claim_LossCause", "Claim_LossCause", null, pcftest.QuickClaimDV_GL.Claim_LossCause.class);
  }
  ...
  public Claim_LossType getClaim_LossType() {
    return getOrCreateProperty("Claim_LossType", "Claim_LossType", null, pcftest.QuickClaimDV_GL.Claim_LossType.class);
  }
  ...
  public Claim_ReportedByType getClaim_ReportedByType() {
    return getOrCreateProperty("Claim_ReportedByType", "Claim_ReportedByType", null, pcftest.QuickClaimDV_GL.Claim_ReportedByType.class);
  }
  ...
  public Claimant_Picker getClaimant_Picker() {
    return getOrCreateProperty("Claimant_Picker", "Claimant_Picker", null, pcftest.QuickClaimDV_GL.Claimant_Picker.class);
  }
  
  public Claimant_Type getClaimant_Type() {
    return getOrCreateProperty("Claimant_Type", "Claimant_Type", null, pcftest.QuickClaimDV_GL.Claimant_Type.class);
  }
  ...
  public CommonAssign getCommonAssign() {
    return getOrCreateProperty("CommonAssign", "CommonAssign", null, pcftest.QuickClaimDV_GL.CommonAssign.class);
  }
  ...
  public EditableOfficialsLV_tb getEditableOfficialsLV_tb() {
    return getOrCreateProperty("EditableOfficialsLV_tb", "EditableOfficialsLV_tb", null, pcftest.QuickClaimDV_GL.EditableOfficialsLV_tb.class);
  }
  
  public Exposure_LossParty getExposure_LossParty() {
    return getOrCreateProperty("Exposure_LossParty", "Exposure_LossParty", null, pcftest.QuickClaimDV_GL.Exposure_LossParty.class);
  }
  
  public Exposure_PrimaryCoverage getExposure_PrimaryCoverage() {
    return getOrCreateProperty("Exposure_PrimaryCoverage", "Exposure_PrimaryCoverage", null, pcftest.QuickClaimDV_GL.Exposure_PrimaryCoverage.class);
  }
  ...
  public NewClaimWizardAssignLV getNewClaimWizardAssignLV() {
    return getOrCreateProperty("NewClaimWizardAssignLV", "NewClaimWizardAssignLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.class);
  }
  
  public NewClaimWizardAssignLV_tb getNewClaimWizardAssignLV_tb() {
    return getOrCreateProperty("NewClaimWizardAssignLV_tb", "NewClaimWizardAssignLV_tb", null, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV_tb.class);
  }
  ...
  public Notification_Fault getNotification_Fault() {
    return getOrCreateProperty("Notification_Fault", "Notification_Fault", null, pcftest.QuickClaimDV_GL.Notification_Fault.class);
  }
  ...
  public Notification_HowReported getNotification_HowReported() {
    return getOrCreateProperty("Notification_HowReported", "Notification_HowReported", null, pcftest.QuickClaimDV_GL.Notification_HowReported.class);
  }
  ...
  public Policy_Status getPolicy_Status() {
    return getOrCreateProperty("Policy_Status", "Policy_Status", null, pcftest.QuickClaimDV_GL.Policy_Status.class);
  }
  ...
  public ReportedBy_Name getReportedBy_Name() {
    return getOrCreateProperty("ReportedBy_Name", "ReportedBy_Name", null, pcftest.QuickClaimDV_GL.ReportedBy_Name.class);
  }
  ...
  public static class Claimant_Picker extends SelectElement {
    ...
    public pcftest.QuickClaimDV_GL.Claimant_Picker.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.QuickClaimDV_GL.Claimant_Picker.MenuItem_Search.class);
    }
    
    public pcftest.QuickClaimDV_GL.Claimant_Picker.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.QuickClaimDV_GL.Claimant_Picker.MenuItem_ViewDetails.class);
    }
  ...
  public static class CommonAssign extends SelectElement {
    ...
    public CommonAssign_PickerButton getCommonAssign_PickerButton() {
      return getOrCreateProperty("CommonAssign_PickerButton", "CommonAssign_PickerButton", null, pcftest.QuickClaimDV_GL.CommonAssign.CommonAssign_PickerButton.class);
    }
  ...
  public static class EditableOfficialsLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.QuickClaimDV_GL.EditableOfficialsLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.QuickClaimDV_GL.EditableOfficialsLV_tb.Remove.class);
    }
  ...
  public static class NewClaimWizardAssignLV extends PCFElement {
    ...
    public AssigneeHeader getAssigneeHeader() {
      return getOrCreateProperty("AssigneeHeader", "AssigneeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.AssigneeHeader.class);
    }
    
    public ForAssignHeader getForAssignHeader() {
      return getOrCreateProperty("ForAssignHeader", "ForAssignHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.ForAssignHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV._ListPaging.class);
    }
    ...
    @SimplePropertyProcessing
    @Generated(comments = "config/web/pcf/claim/FNOL/QuickClaimDV.GL.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
    public static class ForAssignHeader extends ValueElement {
      public ForAssignHeader(ISmokeTest helper, PCFElementId componentId)  {
        super(helper, componentId);
      }
    ...
    public static class entry extends RowElement {
      ...
      public Assignee getAssignee() {
        return getOrCreateProperty("Assignee", "Assignee", null, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry.Assignee.class);
      }
      
      public ValueElement getForAssign() {
        return getOrCreateProperty("ForAssign", "ForAssign", null, gw.smoketest.platform.web.ValueElement.class);
      }
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry._ViewDetail.class);
      }
      ...
      public static class Assignee extends SelectElement {
        ...
        public Assignee_PickerButton getAssignee_PickerButton() {
          return getOrCreateProperty("Assignee_PickerButton", "Assignee_PickerButton", null, pcftest.QuickClaimDV_GL.NewClaimWizardAssignLV.entry.Assignee.Assignee_PickerButton.class);
        }
  ...
  public static class ReportedBy_Name extends SelectElement {
    ...
    public pcftest.QuickClaimDV_GL.ReportedBy_Name.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.QuickClaimDV_GL.ReportedBy_Name.MenuItem_Search.class);
    }
    
    public pcftest.QuickClaimDV_GL.ReportedBy_Name.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.QuickClaimDV_GL.ReportedBy_Name.MenuItem_ViewDetails.class);
    }
