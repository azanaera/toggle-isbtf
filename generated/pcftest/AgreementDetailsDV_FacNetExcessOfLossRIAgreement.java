...
import pcftest.AgreementDetailsDV_FacNetExcessOfLossRIAgreement.AgreementCurrency;
import typekey.Currency;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/reinsurance/AgreementDetailsDV.FacNetExcessOfLossRIAgreement.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class AgreementDetailsDV_FacNetExcessOfLossRIAgreement extends AgreementDetailsDV {
  public final static String CHECKSUM = "a812508720281b8baadf5e3dc0777024";
  
  public AgreementDetailsDV_FacNetExcessOfLossRIAgreement(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public AgreementCurrency getAgreementCurrency() {
    return getOrCreateProperty("AgreementCurrency", "AgreementCurrency", null, pcftest.AgreementDetailsDV_FacNetExcessOfLossRIAgreement.AgreementCurrency.class);
  }
