...
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV._ListPaging;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.entry;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.entry._Select;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotExposureWageBenefits600DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureWageBenefits600DV extends DetailViewElement {
  public final static String CHECKSUM = "6593ce2d1eea0195ac27382d9393a21c";
  
  public ClaimSnapshotExposureWageBenefits600DV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureWageBenefits600DV.WorkStatusChangesLV.entry._ViewDetail.class);
      }
