...
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV._ListPaging;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.entry;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.entry._Select;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotExposure800DV.LossOfUseDamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure800DV_LossOfUseDamage extends ClaimSnapshotExposure800DV {
  public final static String CHECKSUM = "e406ee0b6eec02d94a89785c731ab5fa";
  
  public ClaimSnapshotExposure800DV_LossOfUseDamage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV_tb.class);
  }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure800DV_LossOfUseDamage.OtherCoverageDetLV.entry._ViewDetail.class);
      }
