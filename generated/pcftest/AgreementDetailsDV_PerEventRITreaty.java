...
import pcftest.AgreementDetailsDV_PerEventRITreaty.AgreementCurrency;
import typekey.Currency;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/reinsurance/AgreementDetailsDV.PerEventRITreaty.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class AgreementDetailsDV_PerEventRITreaty extends AgreementDetailsDV {
  public final static String CHECKSUM = "7d23acf610faa901045cf8b261824b7b";
  
  public AgreementDetailsDV_PerEventRITreaty(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public AgreementCurrency getAgreementCurrency() {
    return getOrCreateProperty("AgreementCurrency", "AgreementCurrency", null, pcftest.AgreementDetailsDV_PerEventRITreaty.AgreementCurrency.class);
  }
