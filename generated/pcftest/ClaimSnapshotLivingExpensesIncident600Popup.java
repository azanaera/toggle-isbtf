...
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.Approx_TotalHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.ClaimSnapshotLivingExpensesIncident600Popup_UpLink;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.CommentsHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.DaysHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.EndDateHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.LocationHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.RateHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.StartDateHeader;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup._ListPaging;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup._Paging;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.__crumb__;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup._msgs;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.entry;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.entry._Select;
import pcftest.ClaimSnapshotLivingExpensesIncident600Popup.entry._ViewDetail;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotLivingExpensesIncident600Popup.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotLivingExpensesIncident600Popup extends PCFLocation {
  public final static String CHECKSUM = "e69e7bd0ef1709da0c2d98c885bb64b5";
  
  public ClaimSnapshotLivingExpensesIncident600Popup(ISmokeTest helper)  {
    super(helper, new gw.smoketest.platform.web.PCFElementId("ClaimSnapshotLivingExpensesIncident600Popup"));
  }
  
  public Approx_TotalHeader getApprox_TotalHeader() {
    return getOrCreateProperty("Approx_TotalHeader", "Approx_TotalHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.Approx_TotalHeader.class);
  }
  ...
  public ClaimSnapshotLivingExpensesIncident600Popup_UpLink getClaimSnapshotLivingExpensesIncident600Popup_UpLink() {
    return getOrCreateProperty("ClaimSnapshotLivingExpensesIncident600Popup_UpLink", "ClaimSnapshotLivingExpensesIncident600Popup_UpLink", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.ClaimSnapshotLivingExpensesIncident600Popup_UpLink.class);
  }
  
  public CommentsHeader getCommentsHeader() {
    return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.CommentsHeader.class);
  }
  
  public DaysHeader getDaysHeader() {
    return getOrCreateProperty("DaysHeader", "DaysHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.DaysHeader.class);
  }
  ...
  public EndDateHeader getEndDateHeader() {
    return getOrCreateProperty("EndDateHeader", "EndDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.EndDateHeader.class);
  }
  ...
  public LocationHeader getLocationHeader() {
    return getOrCreateProperty("LocationHeader", "LocationHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.LocationHeader.class);
  }
  ...
  public RateHeader getRateHeader() {
    return getOrCreateProperty("RateHeader", "RateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.RateHeader.class);
  }
  
  public StartDateHeader getStartDateHeader() {
    return getOrCreateProperty("StartDateHeader", "StartDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.StartDateHeader.class);
  }
  ...
  public IteratorEntriesWithPaging<entry> get_Entries() {
    return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
  }
  
  public _ListPaging get_ListPaging() {
    return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup._ListPaging.class);
  }
  
  public _Paging get_Paging() {
    return getOrCreateProperty("_Paging", "_Paging", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup._Paging.class);
  }
  
  public __crumb__ get__crumb__() {
    return getOrCreateProperty("__crumb__", "__crumb__", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.__crumb__.class);
  }
  
  public _msgs get_msgs() {
    return getOrCreateProperty("_msgs", "_msgs", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup._msgs.class);
  }
  ...
  @SimplePropertyProcessing
  @Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotLivingExpensesIncident600Popup.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotLivingExpensesIncident600Popup_UpLink extends ClickableActionElement {
    public ClaimSnapshotLivingExpensesIncident600Popup_UpLink(ISmokeTest helper, PCFElementId componentId)  {
      super(helper, componentId);
    }
  ...
  public static class entry extends RowElement {
    ...
    public _Select get_Select() {
      return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.entry._Select.class);
    }
    
    public _ViewDetail get_ViewDetail() {
      return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotLivingExpensesIncident600Popup.entry._ViewDetail.class);
    }
