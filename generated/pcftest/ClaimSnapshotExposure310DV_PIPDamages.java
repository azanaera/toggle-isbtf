...
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV._ListPaging;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.entry;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.entry._Select;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/310/ClaimSnapshotExposure310DV.PIPDamages.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure310DV_PIPDamages extends ClaimSnapshotExposure310DV {
  public final static String CHECKSUM = "6e62c7a0dab790c20e2e11fa3703b91b";
  
  public ClaimSnapshotExposure310DV_PIPDamages(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure310DV_PIPDamages.WorkStatusChangesLV.entry._ViewDetail.class);
      }
