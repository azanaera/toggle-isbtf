...
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.LienholderHeader;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.OwnerTypeHeader;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV._ListPaging;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.entry;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.entry._Select;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.entry._ViewDetail;
import pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/400/ClaimSnapshotFixedPropertyIncident400DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotFixedPropertyIncident400DV extends DetailViewElement {
  public final static String CHECKSUM = "245c0ebb7d07e403f14cad3647db3bce";
  
  public ClaimSnapshotFixedPropertyIncident400DV(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public ValueElement getAddress_AddressLine1() {
    return getOrCreateProperty("Address_AddressLine1", "Address_AddressLine1", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public ValueElement getAddress_AddressLine2() {
    return getOrCreateProperty("Address_AddressLine2", "Address_AddressLine2", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public ValueElement getAddress_City() {
    return getOrCreateProperty("Address_City", "Address_City", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public ValueElement getAddress_PostalCode() {
    return getOrCreateProperty("Address_PostalCode", "Address_PostalCode", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public ValueElement getAddress_State() {
    return getOrCreateProperty("Address_State", "Address_State", null, gw.smoketest.platform.web.ValueElement.class);
  }
  ...
  public ValueElement getPropertyAttribute_FireProtDetails() {
    return getOrCreateProperty("PropertyAttribute_FireProtDetails", "PropertyAttribute_FireProtDetails", null, gw.smoketest.platform.web.ValueElement.class);
  }
  ...
  public PropertyLienholdersLV getPropertyLienholdersLV() {
    return getOrCreateProperty("PropertyLienholdersLV", "PropertyLienholdersLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.class);
  }
  
  public PropertyLienholdersLV_tb getPropertyLienholdersLV_tb() {
    return getOrCreateProperty("PropertyLienholdersLV_tb", "PropertyLienholdersLV_tb", null, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV_tb.class);
  }
  ...
  public static class PropertyLienholdersLV extends PCFElement {
    ...
    public LienholderHeader getLienholderHeader() {
      return getOrCreateProperty("LienholderHeader", "LienholderHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.LienholderHeader.class);
    }
    
    public OwnerTypeHeader getOwnerTypeHeader() {
      return getOrCreateProperty("OwnerTypeHeader", "OwnerTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.OwnerTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotFixedPropertyIncident400DV.PropertyLienholdersLV.entry._ViewDetail.class);
      }
