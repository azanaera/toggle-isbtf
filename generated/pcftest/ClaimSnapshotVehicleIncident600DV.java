...
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.CitationsArray_CitationAuthorityHeader;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.CitationsArray_CitationNumberHeader;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.CitationsArray_CitationTypeHeader;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV._ListPaging;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.entry;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.entry._Select;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.entry._ViewDetail;
import pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotVehicleIncident600DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotVehicleIncident600DV extends DetailViewElement {
  public final static String CHECKSUM = "207ddd84564e69b4cc588c0c97f9dca8";
  
  public ClaimSnapshotVehicleIncident600DV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public DriverCitationsLV getDriverCitationsLV() {
    return getOrCreateProperty("DriverCitationsLV", "DriverCitationsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.class);
  }
  
  public DriverCitationsLV_tb getDriverCitationsLV_tb() {
    return getOrCreateProperty("DriverCitationsLV_tb", "DriverCitationsLV_tb", null, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV_tb.class);
  }
  ...
  public static class DriverCitationsLV extends PCFElement {
    ...
    public CitationsArray_CitationAuthorityHeader getCitationsArray_CitationAuthorityHeader() {
      return getOrCreateProperty("CitationsArray_CitationAuthorityHeader", "CitationsArray_CitationAuthorityHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.CitationsArray_CitationAuthorityHeader.class);
    }
    
    public CitationsArray_CitationNumberHeader getCitationsArray_CitationNumberHeader() {
      return getOrCreateProperty("CitationsArray_CitationNumberHeader", "CitationsArray_CitationNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.CitationsArray_CitationNumberHeader.class);
    }
    
    public CitationsArray_CitationTypeHeader getCitationsArray_CitationTypeHeader() {
      return getOrCreateProperty("CitationsArray_CitationTypeHeader", "CitationsArray_CitationTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.CitationsArray_CitationTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotVehicleIncident600DV.DriverCitationsLV.entry._ViewDetail.class);
      }
