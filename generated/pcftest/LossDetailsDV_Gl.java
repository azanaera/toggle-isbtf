...
import pcftest.LossDetailsDV_Gl.Claim_Properties;
import pcftest.LossDetailsDV_Gl.Claim_Properties.EditableFixedPropertyIncidentsLV_tb;
import pcftest.LossDetailsDV_Gl.EditableContributingFactorsLV_tb;
import pcftest.LossDetailsDV_Gl.EditableInjuryIncidentsLV_tb;
import pcftest.LossDetailsDV_Gl.EditableOfficialsLV_tb;
import pcftest.LossDetailsDV_Gl.MainContact_Picker;
import pcftest.LossDetailsDV_Gl.MetroReportsLV_tb;
import pcftest.LossDetailsDV_Gl.Notification_Fault;
import pcftest.LossDetailsDV_Gl.Notification_HowReported;
import pcftest.LossDetailsDV_Gl.Notification_MainContactType;
import pcftest.LossDetailsDV_Gl.Notification_ReportedByType;
import pcftest.LossDetailsDV_Gl.ReportedBy_Picker;
import typekey.FaultRating;
import typekey.HowReportedType;
import typekey.PersonRelationType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/lossdetails/LossDetailsDV.Gl.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class LossDetailsDV_Gl extends LossDetailsDV {
  public final static String CHECKSUM = "676aa962c68c1beae77e311901e1c694";
  
  public LossDetailsDV_Gl(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Claim_Properties getClaim_Properties() {
    return getOrCreateProperty("Claim_Properties", "Claim_Properties", null, pcftest.LossDetailsDV_Gl.Claim_Properties.class);
  }
  ...
  public EditableContributingFactorsLV_tb getEditableContributingFactorsLV_tb() {
    return getOrCreateProperty("EditableContributingFactorsLV_tb", "EditableContributingFactorsLV_tb", null, pcftest.LossDetailsDV_Gl.EditableContributingFactorsLV_tb.class);
  }
  ...
  public EditableInjuryIncidentsLV_tb getEditableInjuryIncidentsLV_tb() {
    return getOrCreateProperty("EditableInjuryIncidentsLV_tb", "EditableInjuryIncidentsLV_tb", null, pcftest.LossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.class);
  }
  ...
  public EditableOfficialsLV_tb getEditableOfficialsLV_tb() {
    return getOrCreateProperty("EditableOfficialsLV_tb", "EditableOfficialsLV_tb", null, pcftest.LossDetailsDV_Gl.EditableOfficialsLV_tb.class);
  }
  
  public pcftest.LossDetailsDV_Gl.LossCause getLossCause() {
    return getOrCreateProperty("LossCause", "LossCause", null, pcftest.LossDetailsDV_Gl.LossCause.class);
  }
  ...
  public MainContact_Picker getMainContact_Picker() {
    return getOrCreateProperty("MainContact_Picker", "MainContact_Picker", null, pcftest.LossDetailsDV_Gl.MainContact_Picker.class);
  }
  ...
  public MetroReportsLV_tb getMetroReportsLV_tb() {
    return getOrCreateProperty("MetroReportsLV_tb", "MetroReportsLV_tb", null, pcftest.LossDetailsDV_Gl.MetroReportsLV_tb.class);
  }
  ...
  public DateElement getNotification_DateReportedToInsured() {
    return getOrCreateProperty("Notification_DateReportedToInsured", "Notification_DateReportedToInsured", null, gw.smoketest.platform.web.DateElement.class);
  }
  
  public DateElement getNotification_DateReportedofManifestation() {
    return getOrCreateProperty("Notification_DateReportedofManifestation", "Notification_DateReportedofManifestation", null, gw.smoketest.platform.web.DateElement.class);
  }
  
  public Notification_Fault getNotification_Fault() {
    return getOrCreateProperty("Notification_Fault", "Notification_Fault", null, pcftest.LossDetailsDV_Gl.Notification_Fault.class);
  }
  ...
  public Notification_HowReported getNotification_HowReported() {
    return getOrCreateProperty("Notification_HowReported", "Notification_HowReported", null, pcftest.LossDetailsDV_Gl.Notification_HowReported.class);
  }
  
  public Notification_MainContactType getNotification_MainContactType() {
    return getOrCreateProperty("Notification_MainContactType", "Notification_MainContactType", null, pcftest.LossDetailsDV_Gl.Notification_MainContactType.class);
  }
  
  public Notification_ReportedByType getNotification_ReportedByType() {
    return getOrCreateProperty("Notification_ReportedByType", "Notification_ReportedByType", null, pcftest.LossDetailsDV_Gl.Notification_ReportedByType.class);
  }
  
  public ReportedBy_Picker getReportedBy_Picker() {
    return getOrCreateProperty("ReportedBy_Picker", "ReportedBy_Picker", null, pcftest.LossDetailsDV_Gl.ReportedBy_Picker.class);
  }
  ...
  public static class Claim_Properties extends PCFElement {
    ...
    public EditableFixedPropertyIncidentsLV_tb getEditableFixedPropertyIncidentsLV_tb() {
      return getOrCreateProperty("EditableFixedPropertyIncidentsLV_tb", "EditableFixedPropertyIncidentsLV_tb", null, pcftest.LossDetailsDV_Gl.Claim_Properties.EditableFixedPropertyIncidentsLV_tb.class);
    }
    ...
    public static class EditableFixedPropertyIncidentsLV_tb extends PCFElement {
      ...
      public pcftest.LossDetailsDV_Gl.Claim_Properties.EditableFixedPropertyIncidentsLV_tb.Add getAdd() {
        return getOrCreateProperty("Add", "Add", null, pcftest.LossDetailsDV_Gl.Claim_Properties.EditableFixedPropertyIncidentsLV_tb.Add.class);
      }
      
      public pcftest.LossDetailsDV_Gl.Claim_Properties.EditableFixedPropertyIncidentsLV_tb.Remove getRemove() {
        return getOrCreateProperty("Remove", "Remove", null, pcftest.LossDetailsDV_Gl.Claim_Properties.EditableFixedPropertyIncidentsLV_tb.Remove.class);
      }
  ...
  public static class EditableContributingFactorsLV_tb extends PCFElement {
    ...
    public pcftest.LossDetailsDV_Gl.EditableContributingFactorsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.LossDetailsDV_Gl.EditableContributingFactorsLV_tb.Add.class);
    }
    
    public pcftest.LossDetailsDV_Gl.EditableContributingFactorsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.LossDetailsDV_Gl.EditableContributingFactorsLV_tb.Remove.class);
    }
  ...
  public static class EditableInjuryIncidentsLV_tb extends PCFElement {
    ...
    public pcftest.LossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.LossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Add.class);
    }
    
    public pcftest.LossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.LossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Remove.class);
    }
  ...
  public static class EditableOfficialsLV_tb extends PCFElement {
    ...
    public pcftest.LossDetailsDV_Gl.EditableOfficialsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.LossDetailsDV_Gl.EditableOfficialsLV_tb.Add.class);
    }
    
    public pcftest.LossDetailsDV_Gl.EditableOfficialsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.LossDetailsDV_Gl.EditableOfficialsLV_tb.Remove.class);
    }
  ...
  public static class MainContact_Picker extends SelectElement {
    ...
    public pcftest.LossDetailsDV_Gl.MainContact_Picker.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.LossDetailsDV_Gl.MainContact_Picker.MenuItem_Search.class);
    }
    
    public pcftest.LossDetailsDV_Gl.MainContact_Picker.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.LossDetailsDV_Gl.MainContact_Picker.MenuItem_ViewDetails.class);
    }
  ...
  public static class MetroReportsLV_tb extends PCFElement {
    ...
    public pcftest.LossDetailsDV_Gl.MetroReportsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.LossDetailsDV_Gl.MetroReportsLV_tb.Add.class);
    }
    
    public pcftest.LossDetailsDV_Gl.MetroReportsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.LossDetailsDV_Gl.MetroReportsLV_tb.Remove.class);
    }
  ...
  public static class ReportedBy_Picker extends SelectElement {
    ...
    public pcftest.LossDetailsDV_Gl.ReportedBy_Picker.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.LossDetailsDV_Gl.ReportedBy_Picker.MenuItem_Search.class);
    }
    
    public pcftest.LossDetailsDV_Gl.ReportedBy_Picker.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.LossDetailsDV_Gl.ReportedBy_Picker.MenuItem_ViewDetails.class);
    }
