...
import pcftest.ClaimSnapshotExposure700DV_Content.Contents_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotExposure700DV.Content.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure700DV_Content extends ClaimSnapshotExposure700DV {
  public final static String CHECKSUM = "86f208597737366a7cb35b5e526a68a6";
  
  public ClaimSnapshotExposure700DV_Content(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Contents_Incident getContents_Incident() {
    return getOrCreateProperty("Contents_Incident", "Contents_Incident", null, pcftest.ClaimSnapshotExposure700DV_Content.Contents_Incident.class);
  }
  ...
  public static class Contents_Incident extends ValueElement {
    ...
    public ClaimSnapshotPropertyContentsIncident700Popup click() {
      return clickThis(pcftest.ClaimSnapshotPropertyContentsIncident700Popup.class);
    }
