...
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Claim_LOBCode;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Claim_LossCause;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Claim_LossType;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableFixedPropertyIncidentsLV_tb;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableInjuryIncidentsLV_tb;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableOfficialsLV_tb;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.MetroReportsLV_tb;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Notification_Fault;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Notification_HowReported;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Policy_Status;
import pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.PriorClaimsLV_tb;
...
@Generated(comments = "config/web/pcf/claim/FNOL/FNOLWizard_NewLossDetailsPanelSet.CommercialPackage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class FNOLWizard_NewLossDetailsPanelSet_CommercialPackage extends FNOLWizard_NewLossDetailsPanelSet {
  public final static String CHECKSUM = "92c0d16f224a3158104f46c8d9efc9b8";
  
  public FNOLWizard_NewLossDetailsPanelSet_CommercialPackage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Claim_LOBCode getClaim_LOBCode() {
    return getOrCreateProperty("Claim_LOBCode", "Claim_LOBCode", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Claim_LOBCode.class);
  }
  
  public Claim_LossCause getClaim_LossCause() {
    return getOrCreateProperty("Claim_LossCause", "Claim_LossCause", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Claim_LossCause.class);
  }
  ...
  public Claim_LossType getClaim_LossType() {
    return getOrCreateProperty("Claim_LossType", "Claim_LossType", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Claim_LossType.class);
  }
  ...
  public EditableFixedPropertyIncidentsLV_tb getEditableFixedPropertyIncidentsLV_tb() {
    return getOrCreateProperty("EditableFixedPropertyIncidentsLV_tb", "EditableFixedPropertyIncidentsLV_tb", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableFixedPropertyIncidentsLV_tb.class);
  }
  ...
  public EditableInjuryIncidentsLV_tb getEditableInjuryIncidentsLV_tb() {
    return getOrCreateProperty("EditableInjuryIncidentsLV_tb", "EditableInjuryIncidentsLV_tb", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableInjuryIncidentsLV_tb.class);
  }
  ...
  public EditableOfficialsLV_tb getEditableOfficialsLV_tb() {
    return getOrCreateProperty("EditableOfficialsLV_tb", "EditableOfficialsLV_tb", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableOfficialsLV_tb.class);
  }
  
  public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.LocationOfTheft getLocationOfTheft() {
    return getOrCreateProperty("LocationOfTheft", "LocationOfTheft", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.LocationOfTheft.class);
  }
  ...
  public MetroReportsLV_tb getMetroReportsLV_tb() {
    return getOrCreateProperty("MetroReportsLV_tb", "MetroReportsLV_tb", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.MetroReportsLV_tb.class);
  }
  ...
  public Notification_Fault getNotification_Fault() {
    return getOrCreateProperty("Notification_Fault", "Notification_Fault", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Notification_Fault.class);
  }
  ...
  public Notification_HowReported getNotification_HowReported() {
    return getOrCreateProperty("Notification_HowReported", "Notification_HowReported", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Notification_HowReported.class);
  }
  ...
  public Policy_Status getPolicy_Status() {
    return getOrCreateProperty("Policy_Status", "Policy_Status", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.Policy_Status.class);
  }
  ...
  public PriorClaimsLV_tb getPriorClaimsLV_tb() {
    return getOrCreateProperty("PriorClaimsLV_tb", "PriorClaimsLV_tb", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.PriorClaimsLV_tb.class);
  }
  ...
  public static class EditableFixedPropertyIncidentsLV_tb extends PCFElement {
    ...
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableFixedPropertyIncidentsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableFixedPropertyIncidentsLV_tb.Add.class);
    }
    
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableFixedPropertyIncidentsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableFixedPropertyIncidentsLV_tb.Remove.class);
    }
  ...
  public static class EditableInjuryIncidentsLV_tb extends PCFElement {
    ...
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableInjuryIncidentsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableInjuryIncidentsLV_tb.Add.class);
    }
    
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableInjuryIncidentsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableInjuryIncidentsLV_tb.Remove.class);
    }
  ...
  public static class EditableOfficialsLV_tb extends PCFElement {
    ...
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableOfficialsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableOfficialsLV_tb.Add.class);
    }
    
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableOfficialsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.EditableOfficialsLV_tb.Remove.class);
    }
  ...
  public static class MetroReportsLV_tb extends PCFElement {
    ...
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.MetroReportsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.MetroReportsLV_tb.Add.class);
    }
    
    public pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.MetroReportsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.FNOLWizard_NewLossDetailsPanelSet_CommercialPackage.MetroReportsLV_tb.Remove.class);
    }
