...
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV._ListPaging;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.entry;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.entry._Select;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV_tb;
import pcftest.ClaimSnapshotExposure700DV_PropertyDamage.Property_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotExposure700DV.PropertyDamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure700DV_PropertyDamage extends ClaimSnapshotExposure700DV {
  public final static String CHECKSUM = "013492273c9100301ef835ddfdaeb777";
  
  public ClaimSnapshotExposure700DV_PropertyDamage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV_tb.class);
  }
  ...
  public Property_Incident getProperty_Incident() {
    return getOrCreateProperty("Property_Incident", "Property_Incident", null, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.Property_Incident.class);
  }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure700DV_PropertyDamage.OtherCoverageDetLV.entry._ViewDetail.class);
      }
