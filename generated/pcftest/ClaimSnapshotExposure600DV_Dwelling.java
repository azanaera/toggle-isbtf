...
import pcftest.ClaimSnapshotExposure600DV_Dwelling.Dwelling_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotExposure600DV.Dwelling.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure600DV_Dwelling extends ClaimSnapshotExposure600DV {
  public final static String CHECKSUM = "b670a8ca80e24fabdce28f6d9b7b4bb6";
  
  public ClaimSnapshotExposure600DV_Dwelling(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Dwelling_Incident getDwelling_Incident() {
    return getOrCreateProperty("Dwelling_Incident", "Dwelling_Incident", null, pcftest.ClaimSnapshotExposure600DV_Dwelling.Dwelling_Incident.class);
  }
  ...
  public static class Dwelling_Incident extends ValueElement {
    ...
    public ClaimSnapshotDwellingIncident600Popup click() {
      return clickThis(pcftest.ClaimSnapshotDwellingIncident600Popup.class);
    }
