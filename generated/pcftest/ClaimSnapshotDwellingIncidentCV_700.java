...
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.DamageTypesIterator;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.NumberOfRoomsHeader;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.RoomTypeHeader;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV._ListPaging;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.entry._Select;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.entry._ViewDetail;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.DebrisRemovalInputSet;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.Dwelling_AssessmentCardTab;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.Dwelling_DetailsCardTab;
import pcftest.ClaimSnapshotDwellingIncidentCV_700.EMSInputSet;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotDwellingIncidentCV.700.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotDwellingIncidentCV_700 extends ClaimSnapshotDwellingIncidentCV {
  public final static String CHECKSUM = "84642cd73dc8dbcbc80a7e6102a37fc3";
  
  public ClaimSnapshotDwellingIncidentCV_700(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public DamageDV getDamageDV() {
    return getOrCreateProperty("DamageDV", "DamageDV", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.class);
  }
  
  public DebrisRemovalInputSet getDebrisRemovalInputSet() {
    return getOrCreateProperty("DebrisRemovalInputSet", "DebrisRemovalInputSet", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DebrisRemovalInputSet.class);
  }
  ...
  public Dwelling_AssessmentCardTab getDwelling_AssessmentCardTab() {
    return getOrCreateProperty("Dwelling_AssessmentCardTab", "Dwelling_AssessmentCardTab", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.Dwelling_AssessmentCardTab.class);
  }
  
  public Dwelling_DetailsCardTab getDwelling_DetailsCardTab() {
    return getOrCreateProperty("Dwelling_DetailsCardTab", "Dwelling_DetailsCardTab", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.Dwelling_DetailsCardTab.class);
  }
  
  public EMSInputSet getEMSInputSet() {
    return getOrCreateProperty("EMSInputSet", "EMSInputSet", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.EMSInputSet.class);
  }
  ...
  public static class DamageDV extends DetailViewElement {
    ...
    public DamageTypesIterator getDamageTypesIterator() {
      return getOrCreateProperty("DamageTypesIterator", "DamageTypesIterator", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.DamageTypesIterator.class);
    }
    ...
    public NumberOfRoomsHeader getNumberOfRoomsHeader() {
      return getOrCreateProperty("NumberOfRoomsHeader", "NumberOfRoomsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.NumberOfRoomsHeader.class);
    }
    ...
    public RoomTypeHeader getRoomTypeHeader() {
      return getOrCreateProperty("RoomTypeHeader", "RoomTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.RoomTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV._ListPaging.class);
    }
    ...
    public static class DamageTypesIterator extends PCFElement {
      ...
      @SuppressWarnings(value = "unchecked")
      public IteratorEntries<pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.DamageTypesIterator.entry> get_Entries() {
        return getOrCreateEntries(null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.DamageTypesIterator.entry.class, gw.smoketest.platform.web.IteratorEntries.class);
      }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotDwellingIncidentCV_700.DamageDV.entry._ViewDetail.class);
      }
