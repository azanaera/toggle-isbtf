...
import pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePagePopup_UpLink;
import pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen;
import pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.Cancel;
import pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.Edit;
import pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.Update;
import pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen._msgs;
import pcftest.NewClaimWizard_ExposurePagePopup._Paging;
import pcftest.NewClaimWizard_ExposurePagePopup.__crumb__;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimWizard_ExposurePagePopup.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimWizard_ExposurePagePopup extends PCFLocation {
  public final static String CHECKSUM = "ebab6008b33819b6d2aa5bd3925dfc7b";
  
  public NewClaimWizard_ExposurePagePopup(ISmokeTest helper)  {
    super(helper, new gw.smoketest.platform.web.PCFElementId("NewClaimWizard_ExposurePagePopup"));
  }
  
  public NewClaimWizard_ExposurePagePopup_UpLink getNewClaimWizard_ExposurePagePopup_UpLink() {
    return getOrCreateProperty("NewClaimWizard_ExposurePagePopup_UpLink", "NewClaimWizard_ExposurePagePopup_UpLink", null, pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePagePopup_UpLink.class);
  }
  
  public NewClaimWizard_ExposurePageScreen getNewClaimWizard_ExposurePageScreen() {
    return getOrCreateProperty("NewClaimWizard_ExposurePageScreen", "NewClaimWizard_ExposurePageScreen", null, pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.class);
  }
  
  public _Paging get_Paging() {
    return getOrCreateProperty("_Paging", "_Paging", null, pcftest.NewClaimWizard_ExposurePagePopup._Paging.class);
  }
  
  public __crumb__ get__crumb__() {
    return getOrCreateProperty("__crumb__", "__crumb__", null, pcftest.NewClaimWizard_ExposurePagePopup.__crumb__.class);
  }
  ...
  @SimplePropertyProcessing
  @Generated(comments = "config/web/pcf/claim/FNOL/NewClaimWizard_ExposurePagePopup.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
  public static class NewClaimWizard_ExposurePagePopup_UpLink extends ClickableActionElement {
    public NewClaimWizard_ExposurePagePopup_UpLink(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public static class NewClaimWizard_ExposurePageScreen extends PCFElement {
    ...
    public Cancel getCancel() {
      return getOrCreateProperty("Cancel", "Cancel", null, pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.Cancel.class);
    }
    
    public Edit getEdit() {
      return getOrCreateProperty("Edit", "Edit", null, pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.Edit.class);
    }
    ...
    public Update getUpdate() {
      return getOrCreateProperty("Update", "Update", null, pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen.Update.class);
    }
    
    public _msgs get_msgs() {
      return getOrCreateProperty("_msgs", "_msgs", null, pcftest.NewClaimWizard_ExposurePagePopup.NewClaimWizard_ExposurePageScreen._msgs.class);
    }
