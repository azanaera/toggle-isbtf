...
import pcftest.VehAssessItemDetailsDV.Action;
import pcftest.VehAssessItemDetailsDV.Category;
import typekey.AssessmentAction;
import typekey.VehicleLineItemCategory;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/assessment/AssessmentItem/VehAssessItemDetailsDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class VehAssessItemDetailsDV extends DetailViewElement {
  public final static String CHECKSUM = "9c8dcaebf2084593de4a34fca577f7da";
  
  public VehAssessItemDetailsDV(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public Action getAction() {
    return getOrCreateProperty("Action", "Action", null, pcftest.VehAssessItemDetailsDV.Action.class);
  }
  ...
  public Category getCategory() {
    return getOrCreateProperty("Category", "Category", null, pcftest.VehAssessItemDetailsDV.Category.class);
  }
