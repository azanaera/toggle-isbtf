...
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV_tb;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.PIPDamages.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureDV_PIPDamages extends ClaimSnapshotExposureDV {
  public final static String CHECKSUM = "62b1c1b117e18eb8371f4355e9f0054d";
  
  public ClaimSnapshotExposureDV_PIPDamages(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV_tb.class);
  }
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.OtherCoverageDetLV.entry._ViewDetail.class);
      }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureDV_PIPDamages.WorkStatusChangesLV.entry._ViewDetail.class);
      }
