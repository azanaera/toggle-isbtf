...
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV._ListPaging;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.entry;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.entry._Select;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV_tb;
import pcftest.ClaimSnapshotExposureDV_TowOnly.Vehicle_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.Towonly.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureDV_TowOnly extends ClaimSnapshotExposureDV {
  public final static String CHECKSUM = "43a98aef6e6ef591accb96f06491ae20";
  
  public ClaimSnapshotExposureDV_TowOnly(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV_tb.class);
  }
  ...
  public Vehicle_Incident getVehicle_Incident() {
    return getOrCreateProperty("Vehicle_Incident", "Vehicle_Incident", null, pcftest.ClaimSnapshotExposureDV_TowOnly.Vehicle_Incident.class);
  }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureDV_TowOnly.OtherCoverageDetLV.entry._ViewDetail.class);
      }
