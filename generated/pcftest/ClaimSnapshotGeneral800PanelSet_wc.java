...
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.DetailedBodyPartHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.PrimaryBodyPartHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV_tb;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.CompanyNameHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.EndDateHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.FullTimeHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.JobTitleHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.StartDateHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.WeeklyWageHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV_tb;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.NameHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.ReportNumberHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.TypeHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV_tb;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotGeneral800PanelSet.wc.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotGeneral800PanelSet_wc extends ClaimSnapshotGeneral800PanelSet {
  public final static String CHECKSUM = "b1ab716269f147800dcfccc3edecf972";
  
  public ClaimSnapshotGeneral800PanelSet_wc(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public ClaimSnapshotGeneral800DV getClaimSnapshotGeneral800DV() {
    return getOrCreateProperty("ClaimSnapshotGeneral800DV", "ClaimSnapshotGeneral800DV", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.class);
  }
  ...
  public static class ClaimSnapshotGeneral800DV extends DetailViewElement {
    ...
    public BodyPartsLV getBodyPartsLV() {
      return getOrCreateProperty("BodyPartsLV", "BodyPartsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.class);
    }
    
    public BodyPartsLV_tb getBodyPartsLV_tb() {
      return getOrCreateProperty("BodyPartsLV_tb", "BodyPartsLV_tb", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV_tb.class);
    }
    ...
    public ConcurrentEmplLV getConcurrentEmplLV() {
      return getOrCreateProperty("ConcurrentEmplLV", "ConcurrentEmplLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.class);
    }
    
    public ConcurrentEmplLV_tb getConcurrentEmplLV_tb() {
      return getOrCreateProperty("ConcurrentEmplLV_tb", "ConcurrentEmplLV_tb", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV_tb.class);
    }
    ...
    public OfficialsLV getOfficialsLV() {
      return getOrCreateProperty("OfficialsLV", "OfficialsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.class);
    }
    
    public OfficialsLV_tb getOfficialsLV_tb() {
      return getOrCreateProperty("OfficialsLV_tb", "OfficialsLV_tb", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV_tb.class);
    }
    ...
    public WorkStatusChangesLV getWorkStatusChangesLV() {
      return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.class);
    }
    
    public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
      return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV_tb.class);
    }
    ...
    public static class BodyPartsLV extends PCFElement {
      ...
      public DetailedBodyPartHeader getDetailedBodyPartHeader() {
        return getOrCreateProperty("DetailedBodyPartHeader", "DetailedBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.DetailedBodyPartHeader.class);
      }
      
      public PrimaryBodyPartHeader getPrimaryBodyPartHeader() {
        return getOrCreateProperty("PrimaryBodyPartHeader", "PrimaryBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.PrimaryBodyPartHeader.class);
      }
      ...
      public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.entry> get_Entries() {
        return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
      }
      
      public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV._ListPaging get_ListPaging() {
        return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV._ListPaging.class);
      }
      ...
      public static class entry extends RowElement {
        ...
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.entry._Select get_Select() {
          return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.entry._Select.class);
        }
        
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.entry._ViewDetail get_ViewDetail() {
          return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.BodyPartsLV.entry._ViewDetail.class);
        }
    ...
    public static class ConcurrentEmplLV extends PCFElement {
      ...
      public CompanyNameHeader getCompanyNameHeader() {
        return getOrCreateProperty("CompanyNameHeader", "CompanyNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.CompanyNameHeader.class);
      }
      
      public EndDateHeader getEndDateHeader() {
        return getOrCreateProperty("EndDateHeader", "EndDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.EndDateHeader.class);
      }
      
      public FullTimeHeader getFullTimeHeader() {
        return getOrCreateProperty("FullTimeHeader", "FullTimeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.FullTimeHeader.class);
      }
      
      public JobTitleHeader getJobTitleHeader() {
        return getOrCreateProperty("JobTitleHeader", "JobTitleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.JobTitleHeader.class);
      }
      
      public StartDateHeader getStartDateHeader() {
        return getOrCreateProperty("StartDateHeader", "StartDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.StartDateHeader.class);
      }
      
      public WeeklyWageHeader getWeeklyWageHeader() {
        return getOrCreateProperty("WeeklyWageHeader", "WeeklyWageHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.WeeklyWageHeader.class);
      }
      ...
      @SuppressWarnings(value = "unchecked")
      public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.entry> get_Entries() {
        return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
      }
      
      public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV._ListPaging get_ListPaging() {
        return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV._ListPaging.class);
      }
      ...
      public static class entry extends RowElement {
        ...
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.entry._Select get_Select() {
          return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.entry._Select.class);
        }
        
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.entry._ViewDetail get_ViewDetail() {
          return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.ConcurrentEmplLV.entry._ViewDetail.class);
        }
    ...
    public static class OfficialsLV extends PCFElement {
      ...
      public NameHeader getNameHeader() {
        return getOrCreateProperty("NameHeader", "NameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.NameHeader.class);
      }
      
      public ReportNumberHeader getReportNumberHeader() {
        return getOrCreateProperty("ReportNumberHeader", "ReportNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.ReportNumberHeader.class);
      }
      
      public TypeHeader getTypeHeader() {
        return getOrCreateProperty("TypeHeader", "TypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.TypeHeader.class);
      }
      ...
      @SuppressWarnings(value = "unchecked")
      public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.entry> get_Entries() {
        return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
      }
      
      public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV._ListPaging get_ListPaging() {
        return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV._ListPaging.class);
      }
      ...
      public static class entry extends RowElement {
        ...
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.entry._Select get_Select() {
          return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.entry._Select.class);
        }
        
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.entry._ViewDetail get_ViewDetail() {
          return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.OfficialsLV.entry._ViewDetail.class);
        }
    ...
    public static class WorkStatusChangesLV extends PCFElement {
      ...
      public CommentsHeader getCommentsHeader() {
        return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.CommentsHeader.class);
      }
      
      public StatusDateHeader getStatusDateHeader() {
        return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.StatusDateHeader.class);
      }
      
      public StatusHeader getStatusHeader() {
        return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.StatusHeader.class);
      }
      ...
      @SuppressWarnings(value = "unchecked")
      public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.entry> get_Entries() {
        return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
      }
      
      public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV._ListPaging get_ListPaging() {
        return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV._ListPaging.class);
      }
      ...
      public static class entry extends RowElement {
        ...
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.entry._Select get_Select() {
          return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.entry._Select.class);
        }
        
        public pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.entry._ViewDetail get_ViewDetail() {
          return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral800PanelSet_wc.ClaimSnapshotGeneral800DV.WorkStatusChangesLV.entry._ViewDetail.class);
        }
