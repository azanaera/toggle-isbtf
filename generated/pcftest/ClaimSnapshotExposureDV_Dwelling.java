...
import pcftest.ClaimSnapshotExposureDV_Dwelling.Dwelling_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.Dwelling.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureDV_Dwelling extends ClaimSnapshotExposureDV {
  public final static String CHECKSUM = "37c581076cb7c145b032d8511e48ca06";
  
  public ClaimSnapshotExposureDV_Dwelling(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Dwelling_Incident getDwelling_Incident() {
    return getOrCreateProperty("Dwelling_Incident", "Dwelling_Incident", null, pcftest.ClaimSnapshotExposureDV_Dwelling.Dwelling_Incident.class);
  }
  ...
  public static class Dwelling_Incident extends ValueElement {
    ...
    public ClaimSnapshotDwellingIncidentPopup click() {
      return clickThis(pcftest.ClaimSnapshotDwellingIncidentPopup.class);
    }
