...
@Generated(comments = "config/web/pcf/claim/newother/NewEvaluationDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewEvaluationDV extends DetailViewElement {
  public final static String CHECKSUM = "b0446f7bbc45a9addd3d8466f393f4ed";
  
  public NewEvaluationDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ValueElement getSettlementCostEstimate_Name() {
    return getOrCreateProperty("SettlementCostEstimate_Name", "SettlementCostEstimate_Name", null, gw.smoketest.platform.web.ValueElement.class);
  }
