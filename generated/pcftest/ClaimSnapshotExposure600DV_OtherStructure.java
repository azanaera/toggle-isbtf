...
import pcftest.ClaimSnapshotExposure600DV_OtherStructure.Other_Structure_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotExposure600DV.OtherStructure.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure600DV_OtherStructure extends ClaimSnapshotExposure600DV {
  public final static String CHECKSUM = "068e0ab7753cfa4f4ba843883afc79da";
  
  public ClaimSnapshotExposure600DV_OtherStructure(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Other_Structure_Incident getOther_Structure_Incident() {
    return getOrCreateProperty("Other_Structure_Incident", "Other_Structure_Incident", null, pcftest.ClaimSnapshotExposure600DV_OtherStructure.Other_Structure_Incident.class);
  }
  ...
  public static class Other_Structure_Incident extends ValueElement {
    ...
    public ClaimSnapshotOtherStructureIncident600Popup click() {
      return clickThis(pcftest.ClaimSnapshotOtherStructureIncident600Popup.class);
    }
