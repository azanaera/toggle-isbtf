...
import pcftest.ClaimSnapshotExposureDV_LivingExpenses.Contents_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.LivingExpenses.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureDV_LivingExpenses extends ClaimSnapshotExposureDV {
  public final static String CHECKSUM = "4465e521807e74a12029b02e361d8074";
  
  public ClaimSnapshotExposureDV_LivingExpenses(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Contents_Incident getContents_Incident() {
    return getOrCreateProperty("Contents_Incident", "Contents_Incident", null, pcftest.ClaimSnapshotExposureDV_LivingExpenses.Contents_Incident.class);
  }
  ...
  public static class Contents_Incident extends ValueElement {
    ...
    public ClaimSnapshotLivingExpensesIncidentPopup click() {
      return clickThis(pcftest.ClaimSnapshotLivingExpensesIncidentPopup.class);
    }
