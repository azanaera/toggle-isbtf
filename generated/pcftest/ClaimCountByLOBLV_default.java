...
import pcftest.ClaimCountByLOBLV_default.ByLineOfBusinessHeader;
import pcftest.ClaimCountByLOBLV_default.ClaimCount_FlaggedHeader;
import pcftest.ClaimCountByLOBLV_default.ClaimCount_LitigatedHeader;
import pcftest.ClaimCountByLOBLV_default.ClaimCount_NoticeOnlyHeader;
import pcftest.ClaimCountByLOBLV_default.ClaimCount_OpenClaimsHeader;
import pcftest.ClaimCountByLOBLV_default.ClaimCount_OpenExposuresHeader;
import pcftest.ClaimCountByLOBLV_default.ClaimCount_OverIncurredLimitHeader;
import pcftest.ClaimCountByLOBLV_default._ListPaging;
import pcftest.ClaimCountByLOBLV_default.entry;
import pcftest.ClaimCountByLOBLV_default.entry.ByLineOfBusiness;
import pcftest.ClaimCountByLOBLV_default.entry._Select;
import pcftest.ClaimCountByLOBLV_default.entry._ViewDetail;
import typekey.LOBCode;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/dashboard/ClaimCountByLOBLV.default.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimCountByLOBLV_default extends ClaimCountByLOBLV {
  public final static String CHECKSUM = "929344736541f8c2c296602ea2e005e6";
  
  public ClaimCountByLOBLV_default(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ByLineOfBusinessHeader getByLineOfBusinessHeader() {
    return getOrCreateProperty("ByLineOfBusinessHeader", "ByLineOfBusinessHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ByLineOfBusinessHeader.class);
  }
  ...
  public ClaimCount_FlaggedHeader getClaimCount_FlaggedHeader() {
    return getOrCreateProperty("ClaimCount_FlaggedHeader", "ClaimCount_FlaggedHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ClaimCount_FlaggedHeader.class);
  }
  ...
  public ClaimCount_LitigatedHeader getClaimCount_LitigatedHeader() {
    return getOrCreateProperty("ClaimCount_LitigatedHeader", "ClaimCount_LitigatedHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ClaimCount_LitigatedHeader.class);
  }
  ...
  public ClaimCount_NoticeOnlyHeader getClaimCount_NoticeOnlyHeader() {
    return getOrCreateProperty("ClaimCount_NoticeOnlyHeader", "ClaimCount_NoticeOnlyHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ClaimCount_NoticeOnlyHeader.class);
  }
  ...
  public ClaimCount_OpenClaimsHeader getClaimCount_OpenClaimsHeader() {
    return getOrCreateProperty("ClaimCount_OpenClaimsHeader", "ClaimCount_OpenClaimsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ClaimCount_OpenClaimsHeader.class);
  }
  ...
  public ClaimCount_OpenExposuresHeader getClaimCount_OpenExposuresHeader() {
    return getOrCreateProperty("ClaimCount_OpenExposuresHeader", "ClaimCount_OpenExposuresHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ClaimCount_OpenExposuresHeader.class);
  }
  ...
  public ClaimCount_OverIncurredLimitHeader getClaimCount_OverIncurredLimitHeader() {
    return getOrCreateProperty("ClaimCount_OverIncurredLimitHeader", "ClaimCount_OverIncurredLimitHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimCountByLOBLV_default.ClaimCount_OverIncurredLimitHeader.class);
  }
  ...
  public IteratorEntriesWithPaging<entry> get_Entries() {
    return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimCountByLOBLV_default.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
  }
  
  public _ListPaging get_ListPaging() {
    return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimCountByLOBLV_default._ListPaging.class);
  }
  ...
  public static class entry extends RowElement {
    ...
    public ByLineOfBusiness getByLineOfBusiness() {
      return getOrCreateProperty("ByLineOfBusiness", "ByLineOfBusiness", null, pcftest.ClaimCountByLOBLV_default.entry.ByLineOfBusiness.class);
    }
    ...
    public _Select get_Select() {
      return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimCountByLOBLV_default.entry._Select.class);
    }
    
    public _ViewDetail get_ViewDetail() {
      return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimCountByLOBLV_default.entry._ViewDetail.class);
    }
