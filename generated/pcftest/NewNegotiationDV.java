...
import pcftest.NewNegotiationDV.EditableNegotiationLinesLV_tb;
import pcftest.NewNegotiationDV.EditableNegotiationLinesLV_tb.Add;
import pcftest.NewNegotiationDV.EditableNegotiationLinesLV_tb.Remove;
import pcftest.NewNegotiationDV.General_NegContact;
import pcftest.NewNegotiationDV.General_NegContact.MenuItem_Search;
import pcftest.NewNegotiationDV.General_NegContact.MenuItem_ViewDetails;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/newother/NewNegotiationDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewNegotiationDV extends DetailViewElement {
  public final static String CHECKSUM = "1f69ee35ed684f5c652a6340ea56491d";
  
  public NewNegotiationDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public EditableNegotiationLinesLV_tb getEditableNegotiationLinesLV_tb() {
    return getOrCreateProperty("EditableNegotiationLinesLV_tb", "EditableNegotiationLinesLV_tb", null, pcftest.NewNegotiationDV.EditableNegotiationLinesLV_tb.class);
  }
  ...
  public General_NegContact getGeneral_NegContact() {
    return getOrCreateProperty("General_NegContact", "General_NegContact", null, pcftest.NewNegotiationDV.General_NegContact.class);
  }
  ...
  public static class EditableNegotiationLinesLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewNegotiationDV.EditableNegotiationLinesLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewNegotiationDV.EditableNegotiationLinesLV_tb.Remove.class);
    }
  ...
  public static class General_NegContact extends SelectElement {
    ...
    public MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.NewNegotiationDV.General_NegContact.MenuItem_Search.class);
    }
    
    public MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.NewNegotiationDV.General_NegContact.MenuItem_ViewDetails.class);
    }
