...
import pcftest.ClaimSnapshotExposure800DV_LivingExpenses.Contents_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotExposure800DV.LivingExpenses.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure800DV_LivingExpenses extends ClaimSnapshotExposure800DV {
  public final static String CHECKSUM = "ee30df7219acee9364da134de1266aec";
  
  public ClaimSnapshotExposure800DV_LivingExpenses(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Contents_Incident getContents_Incident() {
    return getOrCreateProperty("Contents_Incident", "Contents_Incident", null, pcftest.ClaimSnapshotExposure800DV_LivingExpenses.Contents_Incident.class);
  }
  ...
  public static class Contents_Incident extends ValueElement {
    ...
    public ClaimSnapshotLivingExpensesIncident800Popup click() {
      return clickThis(pcftest.ClaimSnapshotLivingExpensesIncident800Popup.class);
    }
