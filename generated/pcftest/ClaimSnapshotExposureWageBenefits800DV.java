...
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV._ListPaging;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.entry;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.entry._Select;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotExposureWageBenefits800DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureWageBenefits800DV extends DetailViewElement {
  public final static String CHECKSUM = "7852d6111979ef3236e5fd2848b087e9";
  
  public ClaimSnapshotExposureWageBenefits800DV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureWageBenefits800DV.WorkStatusChangesLV.entry._ViewDetail.class);
      }
