...
import pcftest.ClaimSnapshotExposure800DV_Dwelling.Dwelling_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotExposure800DV.Dwelling.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure800DV_Dwelling extends ClaimSnapshotExposure800DV {
  public final static String CHECKSUM = "f67cfdff46e954de17045dba99975284";
  
  public ClaimSnapshotExposure800DV_Dwelling(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Dwelling_Incident getDwelling_Incident() {
    return getOrCreateProperty("Dwelling_Incident", "Dwelling_Incident", null, pcftest.ClaimSnapshotExposure800DV_Dwelling.Dwelling_Incident.class);
  }
  ...
  public static class Dwelling_Incident extends ValueElement {
    ...
    public ClaimSnapshotDwellingIncident800Popup click() {
      return clickThis(pcftest.ClaimSnapshotDwellingIncident800Popup.class);
    }
