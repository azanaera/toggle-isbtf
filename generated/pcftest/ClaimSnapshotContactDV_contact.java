...
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.ActiveHeader;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.CommentsHeader;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.OwnerHeader;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.RoleHeader;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV._ListPaging;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.entry;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.entry._Select;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV_tb;
import pcftest.ClaimSnapshotContactDV_contact.ClaimSnapshotContactEFTLV_tb;
import pcftest.ClaimSnapshotContactDV_contact.ClaimSnapshotContactEFTLV_tb.Add;
import pcftest.ClaimSnapshotContactDV_contact.ClaimSnapshotContactEFTLV_tb.Remove;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotContactDV.contact.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotContactDV_contact extends ClaimSnapshotContactDV {
  public final static String CHECKSUM = "7b82ac3a8043f2e4d6f5a16abb3f9f50";
  
  public ClaimSnapshotContactDV_contact(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ClaimRolesLV getClaimRolesLV() {
    return getOrCreateProperty("ClaimRolesLV", "ClaimRolesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.class);
  }
  
  public ClaimRolesLV_tb getClaimRolesLV_tb() {
    return getOrCreateProperty("ClaimRolesLV_tb", "ClaimRolesLV_tb", null, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV_tb.class);
  }
  ...
  public ClaimSnapshotContactEFTLV_tb getClaimSnapshotContactEFTLV_tb() {
    return getOrCreateProperty("ClaimSnapshotContactEFTLV_tb", "ClaimSnapshotContactEFTLV_tb", null, pcftest.ClaimSnapshotContactDV_contact.ClaimSnapshotContactEFTLV_tb.class);
  }
  ...
  public static class ClaimRolesLV extends PCFElement {
    ...
    public ActiveHeader getActiveHeader() {
      return getOrCreateProperty("ActiveHeader", "ActiveHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.ActiveHeader.class);
    }
    
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.CommentsHeader.class);
    }
    
    public OwnerHeader getOwnerHeader() {
      return getOrCreateProperty("OwnerHeader", "OwnerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.OwnerHeader.class);
    }
    
    public RoleHeader getRoleHeader() {
      return getOrCreateProperty("RoleHeader", "RoleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.RoleHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotContactDV_contact.ClaimRolesLV.entry._ViewDetail.class);
      }
  ...
  public static class ClaimSnapshotContactEFTLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.ClaimSnapshotContactDV_contact.ClaimSnapshotContactEFTLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.ClaimSnapshotContactDV_contact.ClaimSnapshotContactEFTLV_tb.Remove.class);
    }
