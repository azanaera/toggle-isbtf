...
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.CompensabilityCommentsHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionDateHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.DetailedBodyPartHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.PrimaryBodyPartHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV_tb;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotExposure700DV.BodilyInjuryDamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure700DV_BodilyInjuryDamage extends ClaimSnapshotExposure700DV {
  public final static String CHECKSUM = "a756a2d10a18190fe30a0e820a27df5b";
  
  public ClaimSnapshotExposure700DV_BodilyInjuryDamage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public BodyPartsLV getBodyPartsLV() {
    return getOrCreateProperty("BodyPartsLV", "BodyPartsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.class);
  }
  
  public BodyPartsLV_tb getBodyPartsLV_tb() {
    return getOrCreateProperty("BodyPartsLV_tb", "BodyPartsLV_tb", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV_tb.class);
  }
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV_tb.class);
  }
  ...
  public static class BodyPartsLV extends PCFElement {
    ...
    public CompensabilityCommentsHeader getCompensabilityCommentsHeader() {
      return getOrCreateProperty("CompensabilityCommentsHeader", "CompensabilityCommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.CompensabilityCommentsHeader.class);
    }
    
    public CompensabilityDecisionDateHeader getCompensabilityDecisionDateHeader() {
      return getOrCreateProperty("CompensabilityDecisionDateHeader", "CompensabilityDecisionDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionDateHeader.class);
    }
    
    public CompensabilityDecisionHeader getCompensabilityDecisionHeader() {
      return getOrCreateProperty("CompensabilityDecisionHeader", "CompensabilityDecisionHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionHeader.class);
    }
    
    public DetailedBodyPartHeader getDetailedBodyPartHeader() {
      return getOrCreateProperty("DetailedBodyPartHeader", "DetailedBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.DetailedBodyPartHeader.class);
    }
    
    public PrimaryBodyPartHeader getPrimaryBodyPartHeader() {
      return getOrCreateProperty("PrimaryBodyPartHeader", "PrimaryBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.PrimaryBodyPartHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.BodyPartsLV.entry._ViewDetail.class);
      }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure700DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._ViewDetail.class);
      }
