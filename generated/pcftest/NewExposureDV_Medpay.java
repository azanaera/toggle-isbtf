...
import pcftest.NewExposureDV_Medpay.AltContact_Name;
import pcftest.NewExposureDV_Medpay.Claimant_Picker;
import pcftest.NewExposureDV_Medpay.Claimant_Type;
import pcftest.NewExposureDV_Medpay.CoverageSubType;
import pcftest.NewExposureDV_Medpay.EditableOtherCoverageDetailsLV_tb;
import pcftest.NewExposureDV_Medpay.EditableOtherCoverageDetailsLV_tb.Add;
import pcftest.NewExposureDV_Medpay.EditableOtherCoverageDetailsLV_tb.Remove;
import pcftest.NewExposureDV_Medpay.JurisdictionState;
import pcftest.NewExposureDV_Medpay.LossParty;
import pcftest.NewExposureDV_Medpay.PrimaryCoverage;
import pcftest.NewExposureDV_Medpay.StatLine;
import pcftest.NewExposureDV_Medpay.StatLine.StatLine_PickerButton;
...
@Generated(comments = "config/web/pcf/claim/newexposure/NewExposureDV.Medpay.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewExposureDV_Medpay extends NewExposureDV {
  public final static String CHECKSUM = "196ec42ea6f7fdcf1982c88ea30b789d";
  
  public NewExposureDV_Medpay(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public AltContact_Name getAltContact_Name() {
    return getOrCreateProperty("AltContact_Name", "AltContact_Name", null, pcftest.NewExposureDV_Medpay.AltContact_Name.class);
  }
  ...
  public Claimant_Picker getClaimant_Picker() {
    return getOrCreateProperty("Claimant_Picker", "Claimant_Picker", null, pcftest.NewExposureDV_Medpay.Claimant_Picker.class);
  }
  ...
  public Claimant_Type getClaimant_Type() {
    return getOrCreateProperty("Claimant_Type", "Claimant_Type", null, pcftest.NewExposureDV_Medpay.Claimant_Type.class);
  }
  ...
  public CoverageSubType getCoverageSubType() {
    return getOrCreateProperty("CoverageSubType", "CoverageSubType", null, pcftest.NewExposureDV_Medpay.CoverageSubType.class);
  }
  ...
  public EditableOtherCoverageDetailsLV_tb getEditableOtherCoverageDetailsLV_tb() {
    return getOrCreateProperty("EditableOtherCoverageDetailsLV_tb", "EditableOtherCoverageDetailsLV_tb", null, pcftest.NewExposureDV_Medpay.EditableOtherCoverageDetailsLV_tb.class);
  }
  
  public pcftest.NewExposureDV_Medpay.EscalationLevel_Ext getEscalationLevel_Ext() {
    return getOrCreateProperty("EscalationLevel_Ext", "EscalationLevel_Ext", null, pcftest.NewExposureDV_Medpay.EscalationLevel_Ext.class);
  }
  
  public JurisdictionState getJurisdictionState() {
    return getOrCreateProperty("JurisdictionState", "JurisdictionState", null, pcftest.NewExposureDV_Medpay.JurisdictionState.class);
  }
  
  public LossParty getLossParty() {
    return getOrCreateProperty("LossParty", "LossParty", null, pcftest.NewExposureDV_Medpay.LossParty.class);
  }
  
  public PrimaryCoverage getPrimaryCoverage() {
    return getOrCreateProperty("PrimaryCoverage", "PrimaryCoverage", null, pcftest.NewExposureDV_Medpay.PrimaryCoverage.class);
  }
  
  public pcftest.NewExposureDV_Medpay.RepresentationLevel_Ext getRepresentationLevel_Ext() {
    return getOrCreateProperty("RepresentationLevel_Ext", "RepresentationLevel_Ext", null, pcftest.NewExposureDV_Medpay.RepresentationLevel_Ext.class);
  }
  
  public StatLine getStatLine() {
    return getOrCreateProperty("StatLine", "StatLine", null, pcftest.NewExposureDV_Medpay.StatLine.class);
  }
  ...
  public static class AltContact_Name extends SelectElement {
    ...
    public pcftest.NewExposureDV_Medpay.AltContact_Name.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.NewExposureDV_Medpay.AltContact_Name.MenuItem_Search.class);
    }
    
    public pcftest.NewExposureDV_Medpay.AltContact_Name.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.NewExposureDV_Medpay.AltContact_Name.MenuItem_ViewDetails.class);
    }
  ...
  public static class Claimant_Picker extends SelectElement {
    ...
    public pcftest.NewExposureDV_Medpay.Claimant_Picker.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.NewExposureDV_Medpay.Claimant_Picker.MenuItem_Search.class);
    }
    
    public pcftest.NewExposureDV_Medpay.Claimant_Picker.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.NewExposureDV_Medpay.Claimant_Picker.MenuItem_ViewDetails.class);
    }
  ...
  public static class EditableOtherCoverageDetailsLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewExposureDV_Medpay.EditableOtherCoverageDetailsLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewExposureDV_Medpay.EditableOtherCoverageDetailsLV_tb.Remove.class);
    }
  ...
  public static class StatLine extends SelectElement {
    ...
    public StatLine_PickerButton getStatLine_PickerButton() {
      return getOrCreateProperty("StatLine_PickerButton", "StatLine_PickerButton", null, pcftest.NewExposureDV_Medpay.StatLine.StatLine_PickerButton.class);
    }
