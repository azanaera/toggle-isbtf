...
import pcftest.ClaimSnapshotExposureDV_Content.Contents_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.Content.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureDV_Content extends ClaimSnapshotExposureDV {
  public final static String CHECKSUM = "d0a3c5efcc77c8149090d126c3fe0217";
  
  public ClaimSnapshotExposureDV_Content(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Contents_Incident getContents_Incident() {
    return getOrCreateProperty("Contents_Incident", "Contents_Incident", null, pcftest.ClaimSnapshotExposureDV_Content.Contents_Incident.class);
  }
  ...
  public static class Contents_Incident extends ValueElement {
    ...
    public ClaimSnapshotPropertyContentsIncidentPopup click() {
      return clickThis(pcftest.ClaimSnapshotPropertyContentsIncidentPopup.class);
    }
