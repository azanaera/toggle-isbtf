...
import pcftest.NewClaimPIPDeathBenefitsDV.LostWagesBenefits_PaymentFrequency;
import typekey.PaymentFrequencyType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimPIPDeathBenefitsDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimPIPDeathBenefitsDV extends DetailViewElement {
  public final static String CHECKSUM = "241b5b1eeba0e6231236ed39e0fc7bb4";
  
  public NewClaimPIPDeathBenefitsDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public LostWagesBenefits_PaymentFrequency getLostWagesBenefits_PaymentFrequency() {
    return getOrCreateProperty("LostWagesBenefits_PaymentFrequency", "LostWagesBenefits_PaymentFrequency", null, pcftest.NewClaimPIPDeathBenefitsDV.LostWagesBenefits_PaymentFrequency.class);
  }
