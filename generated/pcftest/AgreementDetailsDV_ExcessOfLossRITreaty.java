...
import pcftest.AgreementDetailsDV_ExcessOfLossRITreaty.AgreementCurrency;
import typekey.Currency;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/reinsurance/AgreementDetailsDV.ExcessOfLossRITreaty.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class AgreementDetailsDV_ExcessOfLossRITreaty extends AgreementDetailsDV {
  public final static String CHECKSUM = "8b925749f82041f47c2850c0d8b738d3";
  
  public AgreementDetailsDV_ExcessOfLossRITreaty(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public AgreementCurrency getAgreementCurrency() {
    return getOrCreateProperty("AgreementCurrency", "AgreementCurrency", null, pcftest.AgreementDetailsDV_ExcessOfLossRITreaty.AgreementCurrency.class);
  }
