...
import pcftest.RegionDetailDV_US.RegionZonesLV_tb;
import pcftest.RegionDetailDV_US.RegionZonesLV_tb.Add;
import pcftest.RegionDetailDV_US.RegionZonesLV_tb.Remove;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/admin/regions/RegionDetailDV.US.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class RegionDetailDV_US extends RegionDetailDV {
  public final static String CHECKSUM = "c43be4c0c14abc8f151eb45a6706917e";
  
  public RegionDetailDV_US(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public RegionZonesLV_tb getRegionZonesLV_tb() {
    return getOrCreateProperty("RegionZonesLV_tb", "RegionZonesLV_tb", null, pcftest.RegionDetailDV_US.RegionZonesLV_tb.class);
  }
  ...
  public static class RegionZonesLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.RegionDetailDV_US.RegionZonesLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.RegionDetailDV_US.RegionZonesLV_tb.Remove.class);
    }
