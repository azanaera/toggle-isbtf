...
import pcftest.NewWageBenefitsDV.CompBenefits_PaymentFrequency;
import typekey.PaymentFrequencyType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/newexposure/NewWageBenefitsDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewWageBenefitsDV extends DetailViewElement {
  public final static String CHECKSUM = "ba2c6ec0d76ecc7c68bc71d610d433c9";
  
  public NewWageBenefitsDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public CompBenefits_PaymentFrequency getCompBenefits_PaymentFrequency() {
    return getOrCreateProperty("CompBenefits_PaymentFrequency", "CompBenefits_PaymentFrequency", null, pcftest.NewWageBenefitsDV.CompBenefits_PaymentFrequency.class);
  }
