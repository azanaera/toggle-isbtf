...
import pcftest.ClaimSnapshotOtherStructureIncidentCV_default.Dwelling_AssessmentCardTab;
import pcftest.ClaimSnapshotOtherStructureIncidentCV_default.OtherIncident_DetailsCardTab;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotOtherStructureIncidentCV.default.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotOtherStructureIncidentCV_default extends ClaimSnapshotOtherStructureIncidentCV {
  public final static String CHECKSUM = "b24cff920bd415ccf1d355b72906b41c";
  
  public ClaimSnapshotOtherStructureIncidentCV_default(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Dwelling_AssessmentCardTab getDwelling_AssessmentCardTab() {
    return getOrCreateProperty("Dwelling_AssessmentCardTab", "Dwelling_AssessmentCardTab", null, pcftest.ClaimSnapshotOtherStructureIncidentCV_default.Dwelling_AssessmentCardTab.class);
  }
  ...
  public OtherIncident_DetailsCardTab getOtherIncident_DetailsCardTab() {
    return getOrCreateProperty("OtherIncident_DetailsCardTab", "OtherIncident_DetailsCardTab", null, pcftest.ClaimSnapshotOtherStructureIncidentCV_default.OtherIncident_DetailsCardTab.class);
  }
