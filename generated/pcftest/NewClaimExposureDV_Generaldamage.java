...
import pcftest.NewClaimExposureDV_Generaldamage.Claimant_Picker;
import pcftest.NewClaimExposureDV_Generaldamage.Claimant_Picker.MenuItem_Search;
import pcftest.NewClaimExposureDV_Generaldamage.Claimant_Picker.MenuItem_ViewDetails;
import pcftest.NewClaimExposureDV_Generaldamage.Claimant_Type;
import pcftest.NewClaimExposureDV_Generaldamage.EditableOtherCoverageDetailsLV_tb;
import pcftest.NewClaimExposureDV_Generaldamage.EditableOtherCoverageDetailsLV_tb.Add;
import pcftest.NewClaimExposureDV_Generaldamage.EditableOtherCoverageDetailsLV_tb.Remove;
import pcftest.NewClaimExposureDV_Generaldamage.Exposure_CoverageSubType;
import pcftest.NewClaimExposureDV_Generaldamage.Exposure_JurisdictionState;
import pcftest.NewClaimExposureDV_Generaldamage.Exposure_LossParty;
import pcftest.NewClaimExposureDV_Generaldamage.Exposure_PrimaryCoverage;
import pcftest.NewClaimExposureDV_Generaldamage.Exposure_StatLine;
import pcftest.NewClaimExposureDV_Generaldamage.Exposure_StatLine.Exposure_StatLine_PickerButton;
import pcftest.NewClaimExposureDV_Generaldamage.Severity;
...
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimExposureDV.Generaldamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimExposureDV_Generaldamage extends NewClaimExposureDV {
  public final static String CHECKSUM = "12fd2aa27914eaaf0a94a9accce2a356";
  
  public NewClaimExposureDV_Generaldamage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Claimant_Picker getClaimant_Picker() {
    return getOrCreateProperty("Claimant_Picker", "Claimant_Picker", null, pcftest.NewClaimExposureDV_Generaldamage.Claimant_Picker.class);
  }
  ...
  public Claimant_Type getClaimant_Type() {
    return getOrCreateProperty("Claimant_Type", "Claimant_Type", null, pcftest.NewClaimExposureDV_Generaldamage.Claimant_Type.class);
  }
  ...
  public EditableOtherCoverageDetailsLV_tb getEditableOtherCoverageDetailsLV_tb() {
    return getOrCreateProperty("EditableOtherCoverageDetailsLV_tb", "EditableOtherCoverageDetailsLV_tb", null, pcftest.NewClaimExposureDV_Generaldamage.EditableOtherCoverageDetailsLV_tb.class);
  }
  ...
  public Exposure_CoverageSubType getExposure_CoverageSubType() {
    return getOrCreateProperty("Exposure_CoverageSubType", "Exposure_CoverageSubType", null, pcftest.NewClaimExposureDV_Generaldamage.Exposure_CoverageSubType.class);
  }
  
  public Exposure_JurisdictionState getExposure_JurisdictionState() {
    return getOrCreateProperty("Exposure_JurisdictionState", "Exposure_JurisdictionState", null, pcftest.NewClaimExposureDV_Generaldamage.Exposure_JurisdictionState.class);
  }
  
  public Exposure_LossParty getExposure_LossParty() {
    return getOrCreateProperty("Exposure_LossParty", "Exposure_LossParty", null, pcftest.NewClaimExposureDV_Generaldamage.Exposure_LossParty.class);
  }
  
  public Exposure_PrimaryCoverage getExposure_PrimaryCoverage() {
    return getOrCreateProperty("Exposure_PrimaryCoverage", "Exposure_PrimaryCoverage", null, pcftest.NewClaimExposureDV_Generaldamage.Exposure_PrimaryCoverage.class);
  }
  
  public Exposure_StatLine getExposure_StatLine() {
    return getOrCreateProperty("Exposure_StatLine", "Exposure_StatLine", null, pcftest.NewClaimExposureDV_Generaldamage.Exposure_StatLine.class);
  }
  ...
  public Severity getSeverity() {
    return getOrCreateProperty("Severity", "Severity", null, pcftest.NewClaimExposureDV_Generaldamage.Severity.class);
  }
  ...
  public static class Claimant_Picker extends SelectElement {
    ...
    public MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.NewClaimExposureDV_Generaldamage.Claimant_Picker.MenuItem_Search.class);
    }
    
    public MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.NewClaimExposureDV_Generaldamage.Claimant_Picker.MenuItem_ViewDetails.class);
    }
  ...
  public static class EditableOtherCoverageDetailsLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimExposureDV_Generaldamage.EditableOtherCoverageDetailsLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimExposureDV_Generaldamage.EditableOtherCoverageDetailsLV_tb.Remove.class);
    }
  ...
  public static class Exposure_StatLine extends SelectElement {
    ...
    public Exposure_StatLine_PickerButton getExposure_StatLine_PickerButton() {
      return getOrCreateProperty("Exposure_StatLine_PickerButton", "Exposure_StatLine_PickerButton", null, pcftest.NewClaimExposureDV_Generaldamage.Exposure_StatLine.Exposure_StatLine_PickerButton.class);
    }
