...
import pcftest.NewClaimExposureDV_Employerliability.JurisdictionState;
import pcftest.NewClaimExposureDV_Employerliability.LossParty;
import pcftest.NewClaimExposureDV_Employerliability.PrimaryCoverage;
import pcftest.NewClaimExposureDV_Employerliability.Segment;
import pcftest.NewClaimExposureDV_Employerliability.SettlementMethod;
import pcftest.NewClaimExposureDV_Employerliability.StatLine;
import pcftest.NewClaimExposureDV_Employerliability.StatLine.StatLine_PickerButton;
import pcftest.NewClaimExposureDV_Employerliability.Strategy;
...
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimExposureDV.Employerliability.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimExposureDV_Employerliability extends NewClaimExposureDV {
  public final static String CHECKSUM = "b9cbe3d875b738aaa435813233a9e443";
  
  public NewClaimExposureDV_Employerliability(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public JurisdictionState getJurisdictionState() {
    return getOrCreateProperty("JurisdictionState", "JurisdictionState", null, pcftest.NewClaimExposureDV_Employerliability.JurisdictionState.class);
  }
  ...
  public LossParty getLossParty() {
    return getOrCreateProperty("LossParty", "LossParty", null, pcftest.NewClaimExposureDV_Employerliability.LossParty.class);
  }
  
  public PrimaryCoverage getPrimaryCoverage() {
    return getOrCreateProperty("PrimaryCoverage", "PrimaryCoverage", null, pcftest.NewClaimExposureDV_Employerliability.PrimaryCoverage.class);
  }
  
  public Segment getSegment() {
    return getOrCreateProperty("Segment", "Segment", null, pcftest.NewClaimExposureDV_Employerliability.Segment.class);
  }
  ...
  public SettlementMethod getSettlementMethod() {
    return getOrCreateProperty("SettlementMethod", "SettlementMethod", null, pcftest.NewClaimExposureDV_Employerliability.SettlementMethod.class);
  }
  
  public StatLine getStatLine() {
    return getOrCreateProperty("StatLine", "StatLine", null, pcftest.NewClaimExposureDV_Employerliability.StatLine.class);
  }
  ...
  public Strategy getStrategy() {
    return getOrCreateProperty("Strategy", "Strategy", null, pcftest.NewClaimExposureDV_Employerliability.Strategy.class);
  }
  ...
  public static class StatLine extends SelectElement {
    ...
    public StatLine_PickerButton getStatLine_PickerButton() {
      return getOrCreateProperty("StatLine_PickerButton", "StatLine_PickerButton", null, pcftest.NewClaimExposureDV_Employerliability.StatLine.StatLine_PickerButton.class);
    }
