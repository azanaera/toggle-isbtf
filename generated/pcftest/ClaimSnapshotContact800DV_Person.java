...
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.ActiveHeader;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.CommentsHeader;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.OwnerHeader;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.RoleHeader;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV._ListPaging;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.entry;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.entry._Select;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV_tb;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimSnapshotContactEFT800LV_tb;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimSnapshotContactEFT800LV_tb.Add;
import pcftest.ClaimSnapshotContact800DV_Person.ClaimSnapshotContactEFT800LV_tb.Remove;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotContact800DV.person.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotContact800DV_Person extends ClaimSnapshotContact800DV {
  public final static String CHECKSUM = "652f495152b06e1f25e3f5f83e938f6d";
  
  public ClaimSnapshotContact800DV_Person(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ClaimRolesLV getClaimRolesLV() {
    return getOrCreateProperty("ClaimRolesLV", "ClaimRolesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.class);
  }
  
  public ClaimRolesLV_tb getClaimRolesLV_tb() {
    return getOrCreateProperty("ClaimRolesLV_tb", "ClaimRolesLV_tb", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV_tb.class);
  }
  ...
  public ClaimSnapshotContactEFT800LV_tb getClaimSnapshotContactEFT800LV_tb() {
    return getOrCreateProperty("ClaimSnapshotContactEFT800LV_tb", "ClaimSnapshotContactEFT800LV_tb", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimSnapshotContactEFT800LV_tb.class);
  }
  ...
  public static class ClaimRolesLV extends PCFElement {
    ...
    public ActiveHeader getActiveHeader() {
      return getOrCreateProperty("ActiveHeader", "ActiveHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.ActiveHeader.class);
    }
    
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.CommentsHeader.class);
    }
    
    public OwnerHeader getOwnerHeader() {
      return getOrCreateProperty("OwnerHeader", "OwnerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.OwnerHeader.class);
    }
    
    public RoleHeader getRoleHeader() {
      return getOrCreateProperty("RoleHeader", "RoleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.RoleHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimRolesLV.entry._ViewDetail.class);
      }
  ...
  public static class ClaimSnapshotContactEFT800LV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimSnapshotContactEFT800LV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.ClaimSnapshotContact800DV_Person.ClaimSnapshotContactEFT800LV_tb.Remove.class);
    }
