...
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.CompensabilityCommentsHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionDateHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.DetailedBodyPartHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.PrimaryBodyPartHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV_tb;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.BodilyInjuryDamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureDV_BodilyInjuryDamage extends ClaimSnapshotExposureDV {
  public final static String CHECKSUM = "7229babd015224b3c4db95dc5a128025";
  
  public ClaimSnapshotExposureDV_BodilyInjuryDamage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public BodyPartsLV getBodyPartsLV() {
    return getOrCreateProperty("BodyPartsLV", "BodyPartsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.class);
  }
  
  public BodyPartsLV_tb getBodyPartsLV_tb() {
    return getOrCreateProperty("BodyPartsLV_tb", "BodyPartsLV_tb", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV_tb.class);
  }
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV_tb.class);
  }
  ...
  public static class BodyPartsLV extends PCFElement {
    ...
    public CompensabilityCommentsHeader getCompensabilityCommentsHeader() {
      return getOrCreateProperty("CompensabilityCommentsHeader", "CompensabilityCommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.CompensabilityCommentsHeader.class);
    }
    
    public CompensabilityDecisionDateHeader getCompensabilityDecisionDateHeader() {
      return getOrCreateProperty("CompensabilityDecisionDateHeader", "CompensabilityDecisionDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionDateHeader.class);
    }
    
    public CompensabilityDecisionHeader getCompensabilityDecisionHeader() {
      return getOrCreateProperty("CompensabilityDecisionHeader", "CompensabilityDecisionHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.CompensabilityDecisionHeader.class);
    }
    
    public DetailedBodyPartHeader getDetailedBodyPartHeader() {
      return getOrCreateProperty("DetailedBodyPartHeader", "DetailedBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.DetailedBodyPartHeader.class);
    }
    
    public PrimaryBodyPartHeader getPrimaryBodyPartHeader() {
      return getOrCreateProperty("PrimaryBodyPartHeader", "PrimaryBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.PrimaryBodyPartHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.BodyPartsLV.entry._ViewDetail.class);
      }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureDV_BodilyInjuryDamage.OtherCoverageDetLV.entry._ViewDetail.class);
      }
