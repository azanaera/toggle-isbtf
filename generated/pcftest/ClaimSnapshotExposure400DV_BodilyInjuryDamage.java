...
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV._ListPaging;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.entry;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._Select;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/400/ClaimSnapshotExposure400DV.BodilyInjuryDamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure400DV_BodilyInjuryDamage extends ClaimSnapshotExposure400DV {
  public final static String CHECKSUM = "6bd6e3e452ef813615c0394a055ae5ec";
  
  public ClaimSnapshotExposure400DV_BodilyInjuryDamage(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV_tb.class);
  }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure400DV_BodilyInjuryDamage.OtherCoverageDetLV.entry._ViewDetail.class);
      }
