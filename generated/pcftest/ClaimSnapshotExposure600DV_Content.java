...
import pcftest.ClaimSnapshotExposure600DV_Content.Contents_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotExposure600DV.Content.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure600DV_Content extends ClaimSnapshotExposure600DV {
  public final static String CHECKSUM = "4f0dbe5f977d8edff516a4e13e4ebcc3";
  
  public ClaimSnapshotExposure600DV_Content(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Contents_Incident getContents_Incident() {
    return getOrCreateProperty("Contents_Incident", "Contents_Incident", null, pcftest.ClaimSnapshotExposure600DV_Content.Contents_Incident.class);
  }
  ...
  public static class Contents_Incident extends ValueElement {
    ...
    public ClaimSnapshotPropertyContentsIncident600Popup click() {
      return clickThis(pcftest.ClaimSnapshotPropertyContentsIncident600Popup.class);
    }
