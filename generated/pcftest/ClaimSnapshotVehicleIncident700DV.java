...
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.CitationsArray_CitationAuthorityHeader;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.CitationsArray_CitationNumberHeader;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.CitationsArray_CitationTypeHeader;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV._ListPaging;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.entry;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.entry._Select;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.entry._ViewDetail;
import pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotVehicleIncident700DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotVehicleIncident700DV extends DetailViewElement {
  public final static String CHECKSUM = "2e7eccc92408da86130b0536dff0efb8";
  
  public ClaimSnapshotVehicleIncident700DV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public DriverCitationsLV getDriverCitationsLV() {
    return getOrCreateProperty("DriverCitationsLV", "DriverCitationsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.class);
  }
  
  public DriverCitationsLV_tb getDriverCitationsLV_tb() {
    return getOrCreateProperty("DriverCitationsLV_tb", "DriverCitationsLV_tb", null, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV_tb.class);
  }
  ...
  public static class DriverCitationsLV extends PCFElement {
    ...
    public CitationsArray_CitationAuthorityHeader getCitationsArray_CitationAuthorityHeader() {
      return getOrCreateProperty("CitationsArray_CitationAuthorityHeader", "CitationsArray_CitationAuthorityHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.CitationsArray_CitationAuthorityHeader.class);
    }
    
    public CitationsArray_CitationNumberHeader getCitationsArray_CitationNumberHeader() {
      return getOrCreateProperty("CitationsArray_CitationNumberHeader", "CitationsArray_CitationNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.CitationsArray_CitationNumberHeader.class);
    }
    
    public CitationsArray_CitationTypeHeader getCitationsArray_CitationTypeHeader() {
      return getOrCreateProperty("CitationsArray_CitationTypeHeader", "CitationsArray_CitationTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.CitationsArray_CitationTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotVehicleIncident700DV.DriverCitationsLV.entry._ViewDetail.class);
      }
