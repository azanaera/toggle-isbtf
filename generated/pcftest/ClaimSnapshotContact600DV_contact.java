...
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.ActiveHeader;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.CommentsHeader;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.OwnerHeader;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.RoleHeader;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV._ListPaging;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.entry;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.entry._Select;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV_tb;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimSnapshotContactEFT600LV_tb;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimSnapshotContactEFT600LV_tb.Add;
import pcftest.ClaimSnapshotContact600DV_contact.ClaimSnapshotContactEFT600LV_tb.Remove;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/600/ClaimSnapshotContact600DV.contact.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotContact600DV_contact extends ClaimSnapshotContact600DV {
  public final static String CHECKSUM = "2b5dbaa191522bb4f00c733f942a6117";
  
  public ClaimSnapshotContact600DV_contact(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ClaimRolesLV getClaimRolesLV() {
    return getOrCreateProperty("ClaimRolesLV", "ClaimRolesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.class);
  }
  
  public ClaimRolesLV_tb getClaimRolesLV_tb() {
    return getOrCreateProperty("ClaimRolesLV_tb", "ClaimRolesLV_tb", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV_tb.class);
  }
  ...
  public ClaimSnapshotContactEFT600LV_tb getClaimSnapshotContactEFT600LV_tb() {
    return getOrCreateProperty("ClaimSnapshotContactEFT600LV_tb", "ClaimSnapshotContactEFT600LV_tb", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimSnapshotContactEFT600LV_tb.class);
  }
  ...
  public static class ClaimRolesLV extends PCFElement {
    ...
    public ActiveHeader getActiveHeader() {
      return getOrCreateProperty("ActiveHeader", "ActiveHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.ActiveHeader.class);
    }
    
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.CommentsHeader.class);
    }
    
    public OwnerHeader getOwnerHeader() {
      return getOrCreateProperty("OwnerHeader", "OwnerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.OwnerHeader.class);
    }
    
    public RoleHeader getRoleHeader() {
      return getOrCreateProperty("RoleHeader", "RoleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.RoleHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimRolesLV.entry._ViewDetail.class);
      }
  ...
  public static class ClaimSnapshotContactEFT600LV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimSnapshotContactEFT600LV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.ClaimSnapshotContact600DV_contact.ClaimSnapshotContactEFT600LV_tb.Remove.class);
    }
