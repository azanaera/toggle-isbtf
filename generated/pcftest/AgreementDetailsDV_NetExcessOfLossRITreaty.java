...
import pcftest.AgreementDetailsDV_NetExcessOfLossRITreaty.AgreementCurrency;
import typekey.Currency;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/reinsurance/AgreementDetailsDV.NetExcessOfLossRITreaty.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class AgreementDetailsDV_NetExcessOfLossRITreaty extends AgreementDetailsDV {
  public final static String CHECKSUM = "c7b4746dda96b3f4c8770a00aa8936ee";
  
  public AgreementDetailsDV_NetExcessOfLossRITreaty(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public AgreementCurrency getAgreementCurrency() {
    return getOrCreateProperty("AgreementCurrency", "AgreementCurrency", null, pcftest.AgreementDetailsDV_NetExcessOfLossRITreaty.AgreementCurrency.class);
  }
