...
import pcftest.ApprovalDetailDV_ReserveSet.ApprovalHistoryLV_tb;
import pcftest.ApprovalDetailDV_ReserveSet.Details_CreateUser;
import pcftest.ApprovalDetailDV_ReserveSet.Details_CreateUser.MenuItem_Search;
import pcftest.ApprovalDetailDV_ReserveSet.Details_CreateUser.MenuItem_ViewDetails;
import pcftest.ApprovalDetailDV_ReserveSet.ReserveSetLV_tb;
import pcftest.ApprovalDetailDV_ReserveSet.UnmodifiableTransactionSetDocumentsLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/workspace/activity/ApprovalDetailDV.ReserveSet.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ApprovalDetailDV_ReserveSet extends ApprovalDetailDV {
  public final static String CHECKSUM = "4f1542b2f7ef082175c3fe98a15de8de";
  
  public ApprovalDetailDV_ReserveSet(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ApprovalHistoryLV_tb getApprovalHistoryLV_tb() {
    return getOrCreateProperty("ApprovalHistoryLV_tb", "ApprovalHistoryLV_tb", null, pcftest.ApprovalDetailDV_ReserveSet.ApprovalHistoryLV_tb.class);
  }
  ...
  public Details_CreateUser getDetails_CreateUser() {
    return getOrCreateProperty("Details_CreateUser", "Details_CreateUser", null, pcftest.ApprovalDetailDV_ReserveSet.Details_CreateUser.class);
  }
  ...
  public ReserveSetLV_tb getReserveSetLV_tb() {
    return getOrCreateProperty("ReserveSetLV_tb", "ReserveSetLV_tb", null, pcftest.ApprovalDetailDV_ReserveSet.ReserveSetLV_tb.class);
  }
  ...
  public UnmodifiableTransactionSetDocumentsLV_tb getUnmodifiableTransactionSetDocumentsLV_tb() {
    return getOrCreateProperty("UnmodifiableTransactionSetDocumentsLV_tb", "UnmodifiableTransactionSetDocumentsLV_tb", null, pcftest.ApprovalDetailDV_ReserveSet.UnmodifiableTransactionSetDocumentsLV_tb.class);
  }
  ...
  public static class Details_CreateUser extends SelectElement {
    ...
    public MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.ApprovalDetailDV_ReserveSet.Details_CreateUser.MenuItem_Search.class);
    }
    
    public MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.ApprovalDetailDV_ReserveSet.Details_CreateUser.MenuItem_ViewDetails.class);
    }
