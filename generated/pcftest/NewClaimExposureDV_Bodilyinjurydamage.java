...
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.AltContact_Name;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Picker;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Type;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.CoverageSubType;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.EditableOtherCoverageDetailsLV_tb;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.EditableOtherCoverageDetailsLV_tb.Add;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.EditableOtherCoverageDetailsLV_tb.Remove;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.JurisdictionState;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.LossParty;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.PrimaryCoverage;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.StatLine;
import pcftest.NewClaimExposureDV_Bodilyinjurydamage.StatLine.StatLine_PickerButton;
...
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimExposureDV.Bodilyinjurydamage.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimExposureDV_Bodilyinjurydamage extends NewClaimExposureDV {
  public final static String CHECKSUM = "26331fe342f31e132434937284da13c4";
  
  public NewClaimExposureDV_Bodilyinjurydamage(ISmokeTest helper, PCFElementId componentId)  {
    super(helper, componentId);
  }
  
  public AltContact_Name getAltContact_Name() {
    return getOrCreateProperty("AltContact_Name", "AltContact_Name", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.AltContact_Name.class);
  }
  ...
  public Claimant_Picker getClaimant_Picker() {
    return getOrCreateProperty("Claimant_Picker", "Claimant_Picker", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Picker.class);
  }
  ...
  public Claimant_Type getClaimant_Type() {
    return getOrCreateProperty("Claimant_Type", "Claimant_Type", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Type.class);
  }
  ...
  public CoverageSubType getCoverageSubType() {
    return getOrCreateProperty("CoverageSubType", "CoverageSubType", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.CoverageSubType.class);
  }
  ...
  public EditableOtherCoverageDetailsLV_tb getEditableOtherCoverageDetailsLV_tb() {
    return getOrCreateProperty("EditableOtherCoverageDetailsLV_tb", "EditableOtherCoverageDetailsLV_tb", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.EditableOtherCoverageDetailsLV_tb.class);
  }
  
  public JurisdictionState getJurisdictionState() {
    return getOrCreateProperty("JurisdictionState", "JurisdictionState", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.JurisdictionState.class);
  }
  
  public LossParty getLossParty() {
    return getOrCreateProperty("LossParty", "LossParty", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.LossParty.class);
  }
  
  public PrimaryCoverage getPrimaryCoverage() {
    return getOrCreateProperty("PrimaryCoverage", "PrimaryCoverage", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.PrimaryCoverage.class);
  }
  
  public StatLine getStatLine() {
    return getOrCreateProperty("StatLine", "StatLine", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.StatLine.class);
  }
  ...
  public static class AltContact_Name extends SelectElement {
    ...
    public pcftest.NewClaimExposureDV_Bodilyinjurydamage.AltContact_Name.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.AltContact_Name.MenuItem_Search.class);
    }
    
    public pcftest.NewClaimExposureDV_Bodilyinjurydamage.AltContact_Name.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.AltContact_Name.MenuItem_ViewDetails.class);
    }
  ...
  public static class Claimant_Picker extends SelectElement {
    ...
    public pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Picker.MenuItem_Search getMenuItem_Search() {
      return getOrCreateProperty("MenuItem_Search", "MenuItem_Search", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Picker.MenuItem_Search.class);
    }
    
    public pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Picker.MenuItem_ViewDetails getMenuItem_ViewDetails() {
      return getOrCreateProperty("MenuItem_ViewDetails", "MenuItem_ViewDetails", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.Claimant_Picker.MenuItem_ViewDetails.class);
    }
  ...
  public static class EditableOtherCoverageDetailsLV_tb extends PCFElement {
    ...
    public Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.EditableOtherCoverageDetailsLV_tb.Add.class);
    }
    
    public Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.EditableOtherCoverageDetailsLV_tb.Remove.class);
    }
  ...
  public static class StatLine extends SelectElement {
    ...
    public StatLine_PickerButton getStatLine_PickerButton() {
      return getOrCreateProperty("StatLine_PickerButton", "StatLine_PickerButton", null, pcftest.NewClaimExposureDV_Bodilyinjurydamage.StatLine.StatLine_PickerButton.class);
    }
