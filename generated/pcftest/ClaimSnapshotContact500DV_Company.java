...
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.ActiveHeader;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.CommentsHeader;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.OwnerHeader;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.RoleHeader;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV._ListPaging;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.entry;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.entry._Select;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/500/ClaimSnapshotContact500DV.company.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotContact500DV_Company extends ClaimSnapshotContact500DV {
  public final static String CHECKSUM = "beb14fd386fd10ef42fab1803f9b6913";
  
  public ClaimSnapshotContact500DV_Company(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ClaimRolesLV getClaimRolesLV() {
    return getOrCreateProperty("ClaimRolesLV", "ClaimRolesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.class);
  }
  
  public ClaimRolesLV_tb getClaimRolesLV_tb() {
    return getOrCreateProperty("ClaimRolesLV_tb", "ClaimRolesLV_tb", null, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV_tb.class);
  }
  ...
  public static class ClaimRolesLV extends PCFElement {
    ...
    public ActiveHeader getActiveHeader() {
      return getOrCreateProperty("ActiveHeader", "ActiveHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.ActiveHeader.class);
    }
    
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.CommentsHeader.class);
    }
    
    public OwnerHeader getOwnerHeader() {
      return getOrCreateProperty("OwnerHeader", "OwnerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.OwnerHeader.class);
    }
    
    public RoleHeader getRoleHeader() {
      return getOrCreateProperty("RoleHeader", "RoleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.RoleHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotContact500DV_Company.ClaimRolesLV.entry._ViewDetail.class);
      }
