...
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.ActiveHeader;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.CommentsHeader;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.OwnerHeader;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.RoleHeader;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV._ListPaging;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.entry;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.entry._Select;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/500/ClaimSnapshotContact500DV.contact.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotContact500DV_contact extends ClaimSnapshotContact500DV {
  public final static String CHECKSUM = "30bc0ffcd1a86764523f7df2daf70199";
  
  public ClaimSnapshotContact500DV_contact(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public ClaimRolesLV getClaimRolesLV() {
    return getOrCreateProperty("ClaimRolesLV", "ClaimRolesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.class);
  }
  
  public ClaimRolesLV_tb getClaimRolesLV_tb() {
    return getOrCreateProperty("ClaimRolesLV_tb", "ClaimRolesLV_tb", null, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV_tb.class);
  }
  ...
  public static class ClaimRolesLV extends PCFElement {
    ...
    public ActiveHeader getActiveHeader() {
      return getOrCreateProperty("ActiveHeader", "ActiveHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.ActiveHeader.class);
    }
    
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.CommentsHeader.class);
    }
    
    public OwnerHeader getOwnerHeader() {
      return getOrCreateProperty("OwnerHeader", "OwnerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.OwnerHeader.class);
    }
    
    public RoleHeader getRoleHeader() {
      return getOrCreateProperty("RoleHeader", "RoleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.RoleHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotContact500DV_contact.ClaimRolesLV.entry._ViewDetail.class);
      }
