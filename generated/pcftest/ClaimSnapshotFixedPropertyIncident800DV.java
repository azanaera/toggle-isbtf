...
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.LienholderHeader;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.OwnerTypeHeader;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV._ListPaging;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.entry;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.entry._Select;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.entry._ViewDetail;
import pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotFixedPropertyIncident800DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotFixedPropertyIncident800DV extends DetailViewElement {
  public final static String CHECKSUM = "7e02c10a7f67c4e7c927baa2b4532b13";
  
  public ClaimSnapshotFixedPropertyIncident800DV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public PropertyLienholdersLV getPropertyLienholdersLV() {
    return getOrCreateProperty("PropertyLienholdersLV", "PropertyLienholdersLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.class);
  }
  
  public PropertyLienholdersLV_tb getPropertyLienholdersLV_tb() {
    return getOrCreateProperty("PropertyLienholdersLV_tb", "PropertyLienholdersLV_tb", null, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV_tb.class);
  }
  ...
  public static class PropertyLienholdersLV extends PCFElement {
    ...
    public LienholderHeader getLienholderHeader() {
      return getOrCreateProperty("LienholderHeader", "LienholderHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.LienholderHeader.class);
    }
    
    public OwnerTypeHeader getOwnerTypeHeader() {
      return getOrCreateProperty("OwnerTypeHeader", "OwnerTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.OwnerTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotFixedPropertyIncident800DV.PropertyLienholdersLV.entry._ViewDetail.class);
      }
