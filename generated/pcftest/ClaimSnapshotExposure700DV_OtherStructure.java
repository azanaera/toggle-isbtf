...
import pcftest.ClaimSnapshotExposure700DV_OtherStructure.Other_Structure_Incident;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotExposure700DV.OtherStructure.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure700DV_OtherStructure extends ClaimSnapshotExposure700DV {
  public final static String CHECKSUM = "80b2df50f29b7ab0e1dccf3389acaea4";
  
  public ClaimSnapshotExposure700DV_OtherStructure(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Other_Structure_Incident getOther_Structure_Incident() {
    return getOrCreateProperty("Other_Structure_Incident", "Other_Structure_Incident", null, pcftest.ClaimSnapshotExposure700DV_OtherStructure.Other_Structure_Incident.class);
  }
  ...
  public static class Other_Structure_Incident extends ValueElement {
    ...
    public ClaimSnapshotOtherStructureIncident700Popup click() {
      return clickThis(pcftest.ClaimSnapshotOtherStructureIncident700Popup.class);
    }
