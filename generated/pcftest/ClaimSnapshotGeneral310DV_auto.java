...
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.NameHeader;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.ReportNumberHeader;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.TypeHeader;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV._ListPaging;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.entry;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.entry._Select;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.entry._ViewDetail;
import pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/310/ClaimSnapshotGeneral310DV.auto.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotGeneral310DV_auto extends ClaimSnapshotGeneral310DV {
  public final static String CHECKSUM = "69140ac644642160d0632fcab6c4d17d";
  
  public ClaimSnapshotGeneral310DV_auto(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OfficialsLV getOfficialsLV() {
    return getOrCreateProperty("OfficialsLV", "OfficialsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.class);
  }
  
  public OfficialsLV_tb getOfficialsLV_tb() {
    return getOrCreateProperty("OfficialsLV_tb", "OfficialsLV_tb", null, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV_tb.class);
  }
  ...
  public static class OfficialsLV extends PCFElement {
    ...
    public NameHeader getNameHeader() {
      return getOrCreateProperty("NameHeader", "NameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.NameHeader.class);
    }
    
    public ReportNumberHeader getReportNumberHeader() {
      return getOrCreateProperty("ReportNumberHeader", "ReportNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.ReportNumberHeader.class);
    }
    
    public TypeHeader getTypeHeader() {
      return getOrCreateProperty("TypeHeader", "TypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.TypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral310DV_auto.OfficialsLV.entry._ViewDetail.class);
      }
