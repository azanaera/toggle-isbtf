...
import pcftest.NewClaimLossDetailsDV_Gl.Claim_LOBCode;
import pcftest.NewClaimLossDetailsDV_Gl.Claim_LossCause;
import pcftest.NewClaimLossDetailsDV_Gl.Claim_LossType;
import pcftest.NewClaimLossDetailsDV_Gl.EditableFixedPropertyIncidentsLV_tb;
import pcftest.NewClaimLossDetailsDV_Gl.EditableInjuryIncidentsLV_tb;
import pcftest.NewClaimLossDetailsDV_Gl.EditableOfficialsLV_tb;
import pcftest.NewClaimLossDetailsDV_Gl.MetroReportsLV_tb;
import pcftest.NewClaimLossDetailsDV_Gl.Notification_Fault;
import pcftest.NewClaimLossDetailsDV_Gl.Notification_HowReported;
import pcftest.NewClaimLossDetailsDV_Gl.Policy_Status;
import pcftest.NewClaimLossDetailsDV_Gl.PriorClaimsLV_tb;
...
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimLossDetailsDV.Gl.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimLossDetailsDV_Gl extends NewClaimLossDetailsDV {
  public final static String CHECKSUM = "4814f20756b6763df95d142528c04733";
  
  public NewClaimLossDetailsDV_Gl(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Claim_LOBCode getClaim_LOBCode() {
    return getOrCreateProperty("Claim_LOBCode", "Claim_LOBCode", null, pcftest.NewClaimLossDetailsDV_Gl.Claim_LOBCode.class);
  }
  
  public Claim_LossCause getClaim_LossCause() {
    return getOrCreateProperty("Claim_LossCause", "Claim_LossCause", null, pcftest.NewClaimLossDetailsDV_Gl.Claim_LossCause.class);
  }
  ...
  public Claim_LossType getClaim_LossType() {
    return getOrCreateProperty("Claim_LossType", "Claim_LossType", null, pcftest.NewClaimLossDetailsDV_Gl.Claim_LossType.class);
  }
  ...
  public EditableFixedPropertyIncidentsLV_tb getEditableFixedPropertyIncidentsLV_tb() {
    return getOrCreateProperty("EditableFixedPropertyIncidentsLV_tb", "EditableFixedPropertyIncidentsLV_tb", null, pcftest.NewClaimLossDetailsDV_Gl.EditableFixedPropertyIncidentsLV_tb.class);
  }
  ...
  public EditableInjuryIncidentsLV_tb getEditableInjuryIncidentsLV_tb() {
    return getOrCreateProperty("EditableInjuryIncidentsLV_tb", "EditableInjuryIncidentsLV_tb", null, pcftest.NewClaimLossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.class);
  }
  ...
  public EditableOfficialsLV_tb getEditableOfficialsLV_tb() {
    return getOrCreateProperty("EditableOfficialsLV_tb", "EditableOfficialsLV_tb", null, pcftest.NewClaimLossDetailsDV_Gl.EditableOfficialsLV_tb.class);
  }
  ...
  public MetroReportsLV_tb getMetroReportsLV_tb() {
    return getOrCreateProperty("MetroReportsLV_tb", "MetroReportsLV_tb", null, pcftest.NewClaimLossDetailsDV_Gl.MetroReportsLV_tb.class);
  }
  ...
  public Notification_Fault getNotification_Fault() {
    return getOrCreateProperty("Notification_Fault", "Notification_Fault", null, pcftest.NewClaimLossDetailsDV_Gl.Notification_Fault.class);
  }
  ...
  public Notification_HowReported getNotification_HowReported() {
    return getOrCreateProperty("Notification_HowReported", "Notification_HowReported", null, pcftest.NewClaimLossDetailsDV_Gl.Notification_HowReported.class);
  }
  ...
  public Policy_Status getPolicy_Status() {
    return getOrCreateProperty("Policy_Status", "Policy_Status", null, pcftest.NewClaimLossDetailsDV_Gl.Policy_Status.class);
  }
  ...
  public PriorClaimsLV_tb getPriorClaimsLV_tb() {
    return getOrCreateProperty("PriorClaimsLV_tb", "PriorClaimsLV_tb", null, pcftest.NewClaimLossDetailsDV_Gl.PriorClaimsLV_tb.class);
  }
  ...
  public static class EditableFixedPropertyIncidentsLV_tb extends PCFElement {
    ...
    public pcftest.NewClaimLossDetailsDV_Gl.EditableFixedPropertyIncidentsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimLossDetailsDV_Gl.EditableFixedPropertyIncidentsLV_tb.Add.class);
    }
    
    public pcftest.NewClaimLossDetailsDV_Gl.EditableFixedPropertyIncidentsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimLossDetailsDV_Gl.EditableFixedPropertyIncidentsLV_tb.Remove.class);
    }
  ...
  public static class EditableInjuryIncidentsLV_tb extends PCFElement {
    ...
    public pcftest.NewClaimLossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimLossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Add.class);
    }
    
    public pcftest.NewClaimLossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimLossDetailsDV_Gl.EditableInjuryIncidentsLV_tb.Remove.class);
    }
  ...
  public static class EditableOfficialsLV_tb extends PCFElement {
    ...
    public pcftest.NewClaimLossDetailsDV_Gl.EditableOfficialsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimLossDetailsDV_Gl.EditableOfficialsLV_tb.Add.class);
    }
    
    public pcftest.NewClaimLossDetailsDV_Gl.EditableOfficialsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimLossDetailsDV_Gl.EditableOfficialsLV_tb.Remove.class);
    }
  ...
  public static class MetroReportsLV_tb extends PCFElement {
    ...
    public pcftest.NewClaimLossDetailsDV_Gl.MetroReportsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimLossDetailsDV_Gl.MetroReportsLV_tb.Add.class);
    }
    
    public pcftest.NewClaimLossDetailsDV_Gl.MetroReportsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimLossDetailsDV_Gl.MetroReportsLV_tb.Remove.class);
    }
