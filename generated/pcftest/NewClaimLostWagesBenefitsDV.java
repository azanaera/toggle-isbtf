...
import pcftest.NewClaimLostWagesBenefitsDV.EditableBenefitPeriodsLV_tb;
import pcftest.NewClaimLostWagesBenefitsDV.EditableSettlementsLV_tb;
import pcftest.NewClaimLostWagesBenefitsDV.PPD_PaymentFrequency;
import pcftest.NewClaimLostWagesBenefitsDV.PTD_PaymentFrequency;
import pcftest.NewClaimLostWagesBenefitsDV.TPD_PaymentFrequency;
import pcftest.NewClaimLostWagesBenefitsDV.TTD_PaymentFrequency;
import pcftest.NewClaimLostWagesBenefitsDV.TTD_RetroactivePeriod;
import typekey.PaymentFrequencyType;
import typekey.RetroPeriodType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/FNOL/NewClaimLostWagesBenefitsDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewClaimLostWagesBenefitsDV extends DetailViewElement {
  public final static String CHECKSUM = "ebf04736eb8a2f1031d1375f65552792";
  
  public NewClaimLostWagesBenefitsDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public EditableBenefitPeriodsLV_tb getEditableBenefitPeriodsLV_tb() {
    return getOrCreateProperty("EditableBenefitPeriodsLV_tb", "EditableBenefitPeriodsLV_tb", null, pcftest.NewClaimLostWagesBenefitsDV.EditableBenefitPeriodsLV_tb.class);
  }
  ...
  public EditableSettlementsLV_tb getEditableSettlementsLV_tb() {
    return getOrCreateProperty("EditableSettlementsLV_tb", "EditableSettlementsLV_tb", null, pcftest.NewClaimLostWagesBenefitsDV.EditableSettlementsLV_tb.class);
  }
  ...
  public PPD_PaymentFrequency getPPD_PaymentFrequency() {
    return getOrCreateProperty("PPD_PaymentFrequency", "PPD_PaymentFrequency", null, pcftest.NewClaimLostWagesBenefitsDV.PPD_PaymentFrequency.class);
  }
  ...
  public PTD_PaymentFrequency getPTD_PaymentFrequency() {
    return getOrCreateProperty("PTD_PaymentFrequency", "PTD_PaymentFrequency", null, pcftest.NewClaimLostWagesBenefitsDV.PTD_PaymentFrequency.class);
  }
  ...
  public TPD_PaymentFrequency getTPD_PaymentFrequency() {
    return getOrCreateProperty("TPD_PaymentFrequency", "TPD_PaymentFrequency", null, pcftest.NewClaimLostWagesBenefitsDV.TPD_PaymentFrequency.class);
  }
  ...
  public TTD_PaymentFrequency getTTD_PaymentFrequency() {
    return getOrCreateProperty("TTD_PaymentFrequency", "TTD_PaymentFrequency", null, pcftest.NewClaimLostWagesBenefitsDV.TTD_PaymentFrequency.class);
  }
  
  public TTD_RetroactivePeriod getTTD_RetroactivePeriod() {
    return getOrCreateProperty("TTD_RetroactivePeriod", "TTD_RetroactivePeriod", null, pcftest.NewClaimLostWagesBenefitsDV.TTD_RetroactivePeriod.class);
  }
  ...
  public static class EditableBenefitPeriodsLV_tb extends PCFElement {
    ...
    public pcftest.NewClaimLostWagesBenefitsDV.EditableBenefitPeriodsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimLostWagesBenefitsDV.EditableBenefitPeriodsLV_tb.Add.class);
    }
    
    public pcftest.NewClaimLostWagesBenefitsDV.EditableBenefitPeriodsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimLostWagesBenefitsDV.EditableBenefitPeriodsLV_tb.Remove.class);
    }
  ...
  public static class EditableSettlementsLV_tb extends PCFElement {
    ...
    public pcftest.NewClaimLostWagesBenefitsDV.EditableSettlementsLV_tb.Add getAdd() {
      return getOrCreateProperty("Add", "Add", null, pcftest.NewClaimLostWagesBenefitsDV.EditableSettlementsLV_tb.Add.class);
    }
    
    public pcftest.NewClaimLostWagesBenefitsDV.EditableSettlementsLV_tb.Remove getRemove() {
      return getOrCreateProperty("Remove", "Remove", null, pcftest.NewClaimLostWagesBenefitsDV.EditableSettlementsLV_tb.Remove.class);
    }
