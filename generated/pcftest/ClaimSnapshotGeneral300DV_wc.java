...
import pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV;
import pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.CompensabilityHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.DetailedBodyPartHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.PrimaryBodyPartHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV_tb;
import pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV;
import pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.CompanyNameHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.FullTimeHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.JobTitleHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.WeeklyWageHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV_tb;
import pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV;
import pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.NameHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.ReportNumberHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.TypeHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV_tb;
import pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV;
import pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.AmountHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.InitialContactHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.ReferenceNumberHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV_tb;
import pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV;
import pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/300/ClaimSnapshotGeneral300DV.wc.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotGeneral300DV_wc extends ClaimSnapshotGeneral300DV {
  public final static String CHECKSUM = "60432805256288d4da46a19f66a0ebf4";
  
  public ClaimSnapshotGeneral300DV_wc(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public BodyPartsLV getBodyPartsLV() {
    return getOrCreateProperty("BodyPartsLV", "BodyPartsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.class);
  }
  
  public BodyPartsLV_tb getBodyPartsLV_tb() {
    return getOrCreateProperty("BodyPartsLV_tb", "BodyPartsLV_tb", null, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV_tb.class);
  }
  ...
  public ConcurrentEmplLV getConcurrentEmplLV() {
    return getOrCreateProperty("ConcurrentEmplLV", "ConcurrentEmplLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.class);
  }
  
  public ConcurrentEmplLV_tb getConcurrentEmplLV_tb() {
    return getOrCreateProperty("ConcurrentEmplLV_tb", "ConcurrentEmplLV_tb", null, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV_tb.class);
  }
  ...
  public OfficialsLV getOfficialsLV() {
    return getOrCreateProperty("OfficialsLV", "OfficialsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.class);
  }
  
  public OfficialsLV_tb getOfficialsLV_tb() {
    return getOrCreateProperty("OfficialsLV_tb", "OfficialsLV_tb", null, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV_tb.class);
  }
  
  public OtherBenefitsLV getOtherBenefitsLV() {
    return getOrCreateProperty("OtherBenefitsLV", "OtherBenefitsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.class);
  }
  
  public OtherBenefitsLV_tb getOtherBenefitsLV_tb() {
    return getOrCreateProperty("OtherBenefitsLV_tb", "OtherBenefitsLV_tb", null, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV_tb.class);
  }
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class BodyPartsLV extends PCFElement {
    ...
    public CompensabilityHeader getCompensabilityHeader() {
      return getOrCreateProperty("CompensabilityHeader", "CompensabilityHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.CompensabilityHeader.class);
    }
    
    public DetailedBodyPartHeader getDetailedBodyPartHeader() {
      return getOrCreateProperty("DetailedBodyPartHeader", "DetailedBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.DetailedBodyPartHeader.class);
    }
    
    public PrimaryBodyPartHeader getPrimaryBodyPartHeader() {
      return getOrCreateProperty("PrimaryBodyPartHeader", "PrimaryBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.PrimaryBodyPartHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral300DV_wc.BodyPartsLV.entry._ViewDetail.class);
      }
  ...
  public static class ConcurrentEmplLV extends PCFElement {
    ...
    public CompanyNameHeader getCompanyNameHeader() {
      return getOrCreateProperty("CompanyNameHeader", "CompanyNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.CompanyNameHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.EndDateHeader getEndDateHeader() {
      return getOrCreateProperty("EndDateHeader", "EndDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.EndDateHeader.class);
    }
    
    public FullTimeHeader getFullTimeHeader() {
      return getOrCreateProperty("FullTimeHeader", "FullTimeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.FullTimeHeader.class);
    }
    
    public JobTitleHeader getJobTitleHeader() {
      return getOrCreateProperty("JobTitleHeader", "JobTitleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.JobTitleHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.StartDateHeader getStartDateHeader() {
      return getOrCreateProperty("StartDateHeader", "StartDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.StartDateHeader.class);
    }
    
    public WeeklyWageHeader getWeeklyWageHeader() {
      return getOrCreateProperty("WeeklyWageHeader", "WeeklyWageHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.WeeklyWageHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral300DV_wc.ConcurrentEmplLV.entry._ViewDetail.class);
      }
  ...
  public static class OfficialsLV extends PCFElement {
    ...
    public NameHeader getNameHeader() {
      return getOrCreateProperty("NameHeader", "NameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.NameHeader.class);
    }
    
    public ReportNumberHeader getReportNumberHeader() {
      return getOrCreateProperty("ReportNumberHeader", "ReportNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.ReportNumberHeader.class);
    }
    
    public TypeHeader getTypeHeader() {
      return getOrCreateProperty("TypeHeader", "TypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.TypeHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral300DV_wc.OfficialsLV.entry._ViewDetail.class);
      }
  ...
  public static class OtherBenefitsLV extends PCFElement {
    ...
    public AmountHeader getAmountHeader() {
      return getOrCreateProperty("AmountHeader", "AmountHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.AmountHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.CommentsHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.EndDateHeader getEndDateHeader() {
      return getOrCreateProperty("EndDateHeader", "EndDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.EndDateHeader.class);
    }
    
    public InitialContactHeader getInitialContactHeader() {
      return getOrCreateProperty("InitialContactHeader", "InitialContactHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.InitialContactHeader.class);
    }
    
    public ReferenceNumberHeader getReferenceNumberHeader() {
      return getOrCreateProperty("ReferenceNumberHeader", "ReferenceNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.ReferenceNumberHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.StartDateHeader getStartDateHeader() {
      return getOrCreateProperty("StartDateHeader", "StartDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.StartDateHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral300DV_wc.OtherBenefitsLV.entry._ViewDetail.class);
      }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral300DV_wc.WorkStatusChangesLV.entry._ViewDetail.class);
      }
