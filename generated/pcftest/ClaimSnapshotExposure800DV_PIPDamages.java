...
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.ContactNameHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.ContactPhoneHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.InsurerHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.NotesHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.PolicyNumberHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV_tb;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotExposure800DV.PIPDamages.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposure800DV_PIPDamages extends ClaimSnapshotExposure800DV {
  public final static String CHECKSUM = "7335f0b6777f61198ab50d206802e523";
  
  public ClaimSnapshotExposure800DV_PIPDamages(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public OtherCoverageDetLV getOtherCoverageDetLV() {
    return getOrCreateProperty("OtherCoverageDetLV", "OtherCoverageDetLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.class);
  }
  
  public OtherCoverageDetLV_tb getOtherCoverageDetLV_tb() {
    return getOrCreateProperty("OtherCoverageDetLV_tb", "OtherCoverageDetLV_tb", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV_tb.class);
  }
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class OtherCoverageDetLV extends PCFElement {
    ...
    public ContactNameHeader getContactNameHeader() {
      return getOrCreateProperty("ContactNameHeader", "ContactNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.ContactNameHeader.class);
    }
    
    public ContactPhoneHeader getContactPhoneHeader() {
      return getOrCreateProperty("ContactPhoneHeader", "ContactPhoneHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.ContactPhoneHeader.class);
    }
    
    public InsurerHeader getInsurerHeader() {
      return getOrCreateProperty("InsurerHeader", "InsurerHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.InsurerHeader.class);
    }
    
    public NotesHeader getNotesHeader() {
      return getOrCreateProperty("NotesHeader", "NotesHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.NotesHeader.class);
    }
    
    public PolicyNumberHeader getPolicyNumberHeader() {
      return getOrCreateProperty("PolicyNumberHeader", "PolicyNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.PolicyNumberHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.OtherCoverageDetLV.entry._ViewDetail.class);
      }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposure800DV_PIPDamages.WorkStatusChangesLV.entry._ViewDetail.class);
      }
