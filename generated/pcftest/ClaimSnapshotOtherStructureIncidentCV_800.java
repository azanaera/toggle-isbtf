...
import pcftest.ClaimSnapshotOtherStructureIncidentCV_800.Dwelling_AssessmentCardTab;
import pcftest.ClaimSnapshotOtherStructureIncidentCV_800.OtherIncident_DetailsCardTab;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotOtherStructureIncidentCV.800.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotOtherStructureIncidentCV_800 extends ClaimSnapshotOtherStructureIncidentCV {
  public final static String CHECKSUM = "f84ba6c010c8aaf05506913999e61190";
  
  public ClaimSnapshotOtherStructureIncidentCV_800(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public Dwelling_AssessmentCardTab getDwelling_AssessmentCardTab() {
    return getOrCreateProperty("Dwelling_AssessmentCardTab", "Dwelling_AssessmentCardTab", null, pcftest.ClaimSnapshotOtherStructureIncidentCV_800.Dwelling_AssessmentCardTab.class);
  }
  ...
  public OtherIncident_DetailsCardTab getOtherIncident_DetailsCardTab() {
    return getOrCreateProperty("OtherIncident_DetailsCardTab", "OtherIncident_DetailsCardTab", null, pcftest.ClaimSnapshotOtherStructureIncidentCV_800.OtherIncident_DetailsCardTab.class);
  }
