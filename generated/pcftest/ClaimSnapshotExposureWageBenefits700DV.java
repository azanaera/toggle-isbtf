...
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.CommentsHeader;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV._ListPaging;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.entry;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.entry._Select;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.entry._ViewDetail;
import pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/700/ClaimSnapshotExposureWageBenefits700DV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotExposureWageBenefits700DV extends DetailViewElement {
  public final static String CHECKSUM = "ad23bce51cce47338dac9e6bb1ebd40c";
  
  public ClaimSnapshotExposureWageBenefits700DV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotExposureWageBenefits700DV.WorkStatusChangesLV.entry._ViewDetail.class);
      }
