...
import pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV;
import pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.CompensabilityHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.DetailedBodyPartHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.PrimaryBodyPartHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV_tb;
import pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV;
import pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.CompanyNameHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.FullTimeHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.JobTitleHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.WeeklyWageHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV_tb;
import pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV;
import pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.MetroReportOrderDateHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.MetroReportStatusHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.MetroReportTypeHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV_tb;
import pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV;
import pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.NameHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.ReportNumberHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.TypeHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV_tb;
import pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV;
import pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.AmountHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.InitialContactHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.ReferenceNumberHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV_tb;
import pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV;
import pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.StatusDateHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.StatusHeader;
import pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV_tb;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/400/ClaimSnapshotGeneral400DV.wc.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotGeneral400DV_wc extends ClaimSnapshotGeneral400DV {
  public final static String CHECKSUM = "3a988c65d12a45e7277f7d07805bc20d";
  
  public ClaimSnapshotGeneral400DV_wc(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public BodyPartsLV getBodyPartsLV() {
    return getOrCreateProperty("BodyPartsLV", "BodyPartsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.class);
  }
  
  public BodyPartsLV_tb getBodyPartsLV_tb() {
    return getOrCreateProperty("BodyPartsLV_tb", "BodyPartsLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV_tb.class);
  }
  ...
  public ConcurrentEmplLV getConcurrentEmplLV() {
    return getOrCreateProperty("ConcurrentEmplLV", "ConcurrentEmplLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.class);
  }
  
  public ConcurrentEmplLV_tb getConcurrentEmplLV_tb() {
    return getOrCreateProperty("ConcurrentEmplLV_tb", "ConcurrentEmplLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV_tb.class);
  }
  ...
  public DateElement getDateCompDcsnDue() {
    return getOrCreateProperty("DateCompDcsnDue", "DateCompDcsnDue", null, gw.smoketest.platform.web.DateElement.class);
  }
  
  public DateElement getDateCompDcsnMade() {
    return getOrCreateProperty("DateCompDcsnMade", "DateCompDcsnMade", null, gw.smoketest.platform.web.DateElement.class);
  }
  
  public DateElement getDateFormGivenToEmp() {
    return getOrCreateProperty("DateFormGivenToEmp", "DateFormGivenToEmp", null, gw.smoketest.platform.web.DateElement.class);
  }
  
  public DateElement getDateFormRetByEmp() {
    return getOrCreateProperty("DateFormRetByEmp", "DateFormRetByEmp", null, gw.smoketest.platform.web.DateElement.class);
  }
  ...
  public DateElement getExposureBegan() {
    return getOrCreateProperty("ExposureBegan", "ExposureBegan", null, gw.smoketest.platform.web.DateElement.class);
  }
  
  public DateElement getExposureEnded() {
    return getOrCreateProperty("ExposureEnded", "ExposureEnded", null, gw.smoketest.platform.web.DateElement.class);
  }
  ...
  public BooleanValueElement getMedCase_CurrentConditions() {
    return getOrCreateProperty("MedCase_CurrentConditions", "MedCase_CurrentConditions", null, gw.smoketest.platform.web.BooleanValueElement.class);
  }
  
  public BooleanValueElement getMedCase_DiagnosticConsistent() {
    return getOrCreateProperty("MedCase_DiagnosticConsistent", "MedCase_DiagnosticConsistent", null, gw.smoketest.platform.web.BooleanValueElement.class);
  }
  ...
  public BooleanValueElement getMedCase_FurtherTreatment() {
    return getOrCreateProperty("MedCase_FurtherTreatment", "MedCase_FurtherTreatment", null, gw.smoketest.platform.web.BooleanValueElement.class);
  }
  ...
  public ValueElement getMedCase_ObjFindings() {
    return getOrCreateProperty("MedCase_ObjFindings", "MedCase_ObjFindings", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public BooleanValueElement getMedCase_PreexDisability() {
    return getOrCreateProperty("MedCase_PreexDisability", "MedCase_PreexDisability", null, gw.smoketest.platform.web.BooleanValueElement.class);
  }
  
  public ValueElement getMedCase_PreexDisabilityInfo() {
    return getOrCreateProperty("MedCase_PreexDisabilityInfo", "MedCase_PreexDisabilityInfo", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public ValueElement getMedCase_SubjComplaints() {
    return getOrCreateProperty("MedCase_SubjComplaints", "MedCase_SubjComplaints", null, gw.smoketest.platform.web.ValueElement.class);
  }
  
  public BooleanValueElement getMedCase_TreatedPatientBefore() {
    return getOrCreateProperty("MedCase_TreatedPatientBefore", "MedCase_TreatedPatientBefore", null, gw.smoketest.platform.web.BooleanValueElement.class);
  }
  ...
  public MetroReportsLV getMetroReportsLV() {
    return getOrCreateProperty("MetroReportsLV", "MetroReportsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.class);
  }
  
  public MetroReportsLV_tb getMetroReportsLV_tb() {
    return getOrCreateProperty("MetroReportsLV_tb", "MetroReportsLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV_tb.class);
  }
  ...
  public OfficialsLV getOfficialsLV() {
    return getOrCreateProperty("OfficialsLV", "OfficialsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.class);
  }
  
  public OfficialsLV_tb getOfficialsLV_tb() {
    return getOrCreateProperty("OfficialsLV_tb", "OfficialsLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV_tb.class);
  }
  
  public OtherBenefitsLV getOtherBenefitsLV() {
    return getOrCreateProperty("OtherBenefitsLV", "OtherBenefitsLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.class);
  }
  
  public OtherBenefitsLV_tb getOtherBenefitsLV_tb() {
    return getOrCreateProperty("OtherBenefitsLV_tb", "OtherBenefitsLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV_tb.class);
  }
  ...
  public WorkStatusChangesLV getWorkStatusChangesLV() {
    return getOrCreateProperty("WorkStatusChangesLV", "WorkStatusChangesLV", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListView, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.class);
  }
  
  public WorkStatusChangesLV_tb getWorkStatusChangesLV_tb() {
    return getOrCreateProperty("WorkStatusChangesLV_tb", "WorkStatusChangesLV_tb", null, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV_tb.class);
  }
  ...
  public static class BodyPartsLV extends PCFElement {
    ...
    public CompensabilityHeader getCompensabilityHeader() {
      return getOrCreateProperty("CompensabilityHeader", "CompensabilityHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.CompensabilityHeader.class);
    }
    
    public DetailedBodyPartHeader getDetailedBodyPartHeader() {
      return getOrCreateProperty("DetailedBodyPartHeader", "DetailedBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.DetailedBodyPartHeader.class);
    }
    
    public PrimaryBodyPartHeader getPrimaryBodyPartHeader() {
      return getOrCreateProperty("PrimaryBodyPartHeader", "PrimaryBodyPartHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.PrimaryBodyPartHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_wc.BodyPartsLV.entry._ViewDetail.class);
      }
  ...
  public static class ConcurrentEmplLV extends PCFElement {
    ...
    public CompanyNameHeader getCompanyNameHeader() {
      return getOrCreateProperty("CompanyNameHeader", "CompanyNameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.CompanyNameHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.EndDateHeader getEndDateHeader() {
      return getOrCreateProperty("EndDateHeader", "EndDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.EndDateHeader.class);
    }
    
    public FullTimeHeader getFullTimeHeader() {
      return getOrCreateProperty("FullTimeHeader", "FullTimeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.FullTimeHeader.class);
    }
    
    public JobTitleHeader getJobTitleHeader() {
      return getOrCreateProperty("JobTitleHeader", "JobTitleHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.JobTitleHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.StartDateHeader getStartDateHeader() {
      return getOrCreateProperty("StartDateHeader", "StartDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.StartDateHeader.class);
    }
    
    public WeeklyWageHeader getWeeklyWageHeader() {
      return getOrCreateProperty("WeeklyWageHeader", "WeeklyWageHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.WeeklyWageHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_wc.ConcurrentEmplLV.entry._ViewDetail.class);
      }
  ...
  public static class MetroReportsLV extends PCFElement {
    ...
    public MetroReportOrderDateHeader getMetroReportOrderDateHeader() {
      return getOrCreateProperty("MetroReportOrderDateHeader", "MetroReportOrderDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.MetroReportOrderDateHeader.class);
    }
    
    public MetroReportStatusHeader getMetroReportStatusHeader() {
      return getOrCreateProperty("MetroReportStatusHeader", "MetroReportStatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.MetroReportStatusHeader.class);
    }
    
    public MetroReportTypeHeader getMetroReportTypeHeader() {
      return getOrCreateProperty("MetroReportTypeHeader", "MetroReportTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.MetroReportTypeHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_wc.MetroReportsLV.entry._ViewDetail.class);
      }
  ...
  public static class OfficialsLV extends PCFElement {
    ...
    public NameHeader getNameHeader() {
      return getOrCreateProperty("NameHeader", "NameHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.NameHeader.class);
    }
    
    public ReportNumberHeader getReportNumberHeader() {
      return getOrCreateProperty("ReportNumberHeader", "ReportNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.ReportNumberHeader.class);
    }
    
    public TypeHeader getTypeHeader() {
      return getOrCreateProperty("TypeHeader", "TypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.TypeHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_wc.OfficialsLV.entry._ViewDetail.class);
      }
  ...
  public static class OtherBenefitsLV extends PCFElement {
    ...
    public AmountHeader getAmountHeader() {
      return getOrCreateProperty("AmountHeader", "AmountHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.AmountHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.CommentsHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.EndDateHeader getEndDateHeader() {
      return getOrCreateProperty("EndDateHeader", "EndDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.EndDateHeader.class);
    }
    
    public InitialContactHeader getInitialContactHeader() {
      return getOrCreateProperty("InitialContactHeader", "InitialContactHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.InitialContactHeader.class);
    }
    
    public ReferenceNumberHeader getReferenceNumberHeader() {
      return getOrCreateProperty("ReferenceNumberHeader", "ReferenceNumberHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.ReferenceNumberHeader.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.StartDateHeader getStartDateHeader() {
      return getOrCreateProperty("StartDateHeader", "StartDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.StartDateHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_wc.OtherBenefitsLV.entry._ViewDetail.class);
      }
  ...
  public static class WorkStatusChangesLV extends PCFElement {
    ...
    public pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.CommentsHeader getCommentsHeader() {
      return getOrCreateProperty("CommentsHeader", "CommentsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.CommentsHeader.class);
    }
    
    public StatusDateHeader getStatusDateHeader() {
      return getOrCreateProperty("StatusDateHeader", "StatusDateHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.StatusDateHeader.class);
    }
    
    public StatusHeader getStatusHeader() {
      return getOrCreateProperty("StatusHeader", "StatusHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.StatusHeader.class);
    }
    ...
    @SuppressWarnings(value = "unchecked")
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV._ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV._ListPaging.class);
    }
    ...
    public static class entry extends RowElement {
      ...
      public pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.entry._Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.entry._Select.class);
      }
      
      public pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.entry._ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotGeneral400DV_wc.WorkStatusChangesLV.entry._ViewDetail.class);
      }
