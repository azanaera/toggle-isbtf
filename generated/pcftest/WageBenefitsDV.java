...
import pcftest.WageBenefitsDV.CompBenefits_PaymentFrequency;
import typekey.PaymentFrequencyType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/exposures/WageBenefitsDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class WageBenefitsDV extends DetailViewElement {
  public final static String CHECKSUM = "783e9ea23ef0a201cefb619ea9b3c8ea";
  
  public WageBenefitsDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public CompBenefits_PaymentFrequency getCompBenefits_PaymentFrequency() {
    return getOrCreateProperty("CompBenefits_PaymentFrequency", "CompBenefits_PaymentFrequency", null, pcftest.WageBenefitsDV.CompBenefits_PaymentFrequency.class);
  }
