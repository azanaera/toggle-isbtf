...
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.DamageTypesIterator;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.NumberOfRoomsHeader;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.RoomTypeHeader;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV._ListPaging;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.entry._Select;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.entry._ViewDetail;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.Dwelling_AssessmentCardTab;
import pcftest.ClaimSnapshotDwellingIncidentCV_800.Dwelling_DetailsCardTab;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/snapshot/800/ClaimSnapshotDwellingIncidentCV.800.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class ClaimSnapshotDwellingIncidentCV_800 extends ClaimSnapshotDwellingIncidentCV {
  public final static String CHECKSUM = "d52b49a1d340b0f64f632b4c38edacf2";
  
  public ClaimSnapshotDwellingIncidentCV_800(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public DamageDV getDamageDV() {
    return getOrCreateProperty("DamageDV", "DamageDV", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.class);
  }
  ...
  public Dwelling_AssessmentCardTab getDwelling_AssessmentCardTab() {
    return getOrCreateProperty("Dwelling_AssessmentCardTab", "Dwelling_AssessmentCardTab", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.Dwelling_AssessmentCardTab.class);
  }
  
  public Dwelling_DetailsCardTab getDwelling_DetailsCardTab() {
    return getOrCreateProperty("Dwelling_DetailsCardTab", "Dwelling_DetailsCardTab", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.Dwelling_DetailsCardTab.class);
  }
  ...
  public static class DamageDV extends DetailViewElement {
    ...
    public DamageTypesIterator getDamageTypesIterator() {
      return getOrCreateProperty("DamageTypesIterator", "DamageTypesIterator", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.DamageTypesIterator.class);
    }
    ...
    public NumberOfRoomsHeader getNumberOfRoomsHeader() {
      return getOrCreateProperty("NumberOfRoomsHeader", "NumberOfRoomsHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.NumberOfRoomsHeader.class);
    }
    ...
    public RoomTypeHeader getRoomTypeHeader() {
      return getOrCreateProperty("RoomTypeHeader", "RoomTypeHeader", gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewHeader, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.RoomTypeHeader.class);
    }
    ...
    public IteratorEntriesWithPaging<pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.entry> get_Entries() {
      return getOrCreateEntries(gw.smoketest.platform.web.PCFElementId.PCFElementScope.ListViewRowIteratorEntry, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.entry.class, gw.smoketest.platform.web.IteratorEntriesWithPaging.class);
    }
    
    public _ListPaging get_ListPaging() {
      return getOrCreateProperty("_ListPaging", "_ListPaging", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV._ListPaging.class);
    }
    ...
    public static class DamageTypesIterator extends PCFElement {
      ...
      @SuppressWarnings(value = "unchecked")
      public IteratorEntries<pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.DamageTypesIterator.entry> get_Entries() {
        return getOrCreateEntries(null, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.DamageTypesIterator.entry.class, gw.smoketest.platform.web.IteratorEntries.class);
      }
    ...
    public static class entry extends RowElement {
      ...
      public _Select get_Select() {
        return getOrCreateProperty("_Select", "_Select", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.entry._Select.class);
      }
      
      public _ViewDetail get_ViewDetail() {
        return getOrCreateProperty("_ViewDetail", "_ViewDetail", null, pcftest.ClaimSnapshotDwellingIncidentCV_800.DamageDV.entry._ViewDetail.class);
      }
