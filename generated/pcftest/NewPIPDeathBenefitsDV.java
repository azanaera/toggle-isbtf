...
import pcftest.NewPIPDeathBenefitsDV.LostWagesBenefits_PaymentFrequency;
import typekey.PaymentFrequencyType;

@SimplePropertyProcessing
@Generated(comments = "config/web/pcf/claim/newexposure/NewPIPDeathBenefitsDV.pcf", date = "", value = "com.guidewire.pcfgen.PCFClassGenerator")
public class NewPIPDeathBenefitsDV extends DetailViewElement {
  public final static String CHECKSUM = "bdaea684892606151070d31824b00f1f";
  
  public NewPIPDeathBenefitsDV(ISmokeTest helper, PCFElementId componentId)  {
  ...
  public LostWagesBenefits_PaymentFrequency getLostWagesBenefits_PaymentFrequency() {
    return getOrCreateProperty("LostWagesBenefits_PaymentFrequency", "LostWagesBenefits_PaymentFrequency", null, pcftest.NewPIPDeathBenefitsDV.LostWagesBenefits_PaymentFrequency.class);
  }
