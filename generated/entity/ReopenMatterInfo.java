 ...
 * ReopenMatterInfo
 * 
 *             Temporary entity that holds transitional internal state information during the reopen matter operation. 
 *             This is an internal, virtual entity, the system does not store it.
 *             
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReopenMatterInfo.eti;ReopenMatterInfo.eix;ReopenMatterInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReopenMatterInfo")
public class ReopenMatterInfo extends entity.MatterCloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReopenMatterInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReopenMatterInfo>("entity.ReopenMatterInfo");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> REOPENREASON_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "reopenReason");
   ...
   */
  public ReopenMatterInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReopenMatterInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ReopenMatterInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReopenMatterInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ReopenMatterInfoInternal)super.__getInternalInterface();
  }
  ...
  public typekey.MatterReopenedReason getreopenReason() {
    return (typekey.MatterReopenedReason)__getInternalInterface().getFieldValue(REOPENREASON_PROP.get());
  }
  ...
  public void setreopenReason(typekey.MatterReopenedReason value) {
    __getInternalInterface().setFieldValue(REOPENREASON_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReopenMatterInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReopenMatterInfo.this.__getDelegateManager();
    }
    ...
    public typekey.NoteTopicType getLitigationNoteTopic() {
      return ((gw.api.matter.MatterCloseReopenNoteMethods)__getDelegateManager().getImplementation("gw.api.matter.MatterCloseReopenNoteMethods")).getLitigationNoteTopic();
    }
  ...
  static {
    ...
    config.put("gw.api.matter.MatterCloseReopenNoteMethods", "gw.api.matter.MatterCloseReopenNoteMethodsImpl");
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.matter.impl.ReopenMatterInfoImpl");
    config.put("gw.cc.matter.entity.MatterCloseReopenInfo", "com.guidewire.cc.domain.matter.impl.ReopenMatterInfoImpl");
    config.put("gw.cc.matter.entity.ReopenMatterInfo", "com.guidewire.cc.domain.matter.impl.ReopenMatterInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReopenMatterInfo.class, config);
    com.guidewire._generated.entity.ReopenMatterInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReopenMatterInfo, com.guidewire._generated.entity.ReopenMatterInfoInternal>() {
      public java.lang.Object getImplementation(entity.ReopenMatterInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReopenMatterInfoInternal getInternalInterface(entity.ReopenMatterInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReopenMatterInfo newEmptyInstance() {
        return new entity.ReopenMatterInfo((java.lang.Void)null);
      }
