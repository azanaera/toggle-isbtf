...
/**
 * AppCritIncidentType
 * Incident Type Applicability Criteria
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AppCritIncidentType.eti;AppCritIncidentType.eix;AppCritIncidentType.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AppCritIncidentType")
public class AppCritIncidentType extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritIncidentType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritIncidentType>("entity.AppCritIncidentType");
  ...
  private com.guidewire._generated.entity.AppCritIncidentTypeInternal _internal;
   ...
   */
  public AppCritIncidentType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritIncidentType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritIncidentTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritIncidentTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritIncidentTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritIncidentType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritIncidentTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritIncidentType.class, config);
    com.guidewire._generated.entity.AppCritIncidentTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritIncidentType, com.guidewire._generated.entity.AppCritIncidentTypeInternal>() {
      public java.lang.Object getImplementation(entity.AppCritIncidentType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritIncidentTypeInternal getInternalInterface(entity.AppCritIncidentType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritIncidentType newEmptyInstance() {
        return new entity.AppCritIncidentType((java.lang.Void)null);
      }
