 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PersonVendor.eti;PersonVendor.eix;PersonVendor.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PersonVendor")
public class PersonVendor extends entity.Person {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PersonVendor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PersonVendor>("entity.PersonVendor");
   ...
   */
  public PersonVendor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PersonVendor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonVendorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonVendorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonVendorInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonVendorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PersonVendor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PersonVendor.class, config);
    com.guidewire._generated.entity.PersonVendorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PersonVendor, com.guidewire._generated.entity.PersonVendorInternal>() {
      public java.lang.Object getImplementation(entity.PersonVendor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonVendorInternal getInternalInterface(entity.PersonVendor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PersonVendor newEmptyInstance() {
        return new entity.PersonVendor((java.lang.Void)null);
      }
