...
/**
 * TotalPaidClaimMetric
 * Paid
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TotalPaidClaimMetric.eti;TotalPaidClaimMetric.eix;TotalPaidClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TotalPaidClaimMetric")
public class TotalPaidClaimMetric extends entity.MoneyClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TotalPaidClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TotalPaidClaimMetric>("entity.TotalPaidClaimMetric");
   ...
   */
  public TotalPaidClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TotalPaidClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TotalPaidClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TotalPaidClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TotalPaidClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TotalPaidClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TotalPaidClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.financials.TotalPaidClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TotalPaidClaimMetric.class, config);
    com.guidewire._generated.entity.TotalPaidClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TotalPaidClaimMetric, com.guidewire._generated.entity.TotalPaidClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.TotalPaidClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TotalPaidClaimMetricInternal getInternalInterface(entity.TotalPaidClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TotalPaidClaimMetric newEmptyInstance() {
        return new entity.TotalPaidClaimMetric((java.lang.Void)null);
      }
