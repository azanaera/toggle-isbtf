...
/**
 * InboundChunkWorkItem
 * Custom work item for processing inbound chunk.
 */
...
@gw.entity.EntityName(value = "InboundChunkWorkItem")
public class InboundChunkWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InboundChunkWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InboundChunkWorkItem>("entity.InboundChunkWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> INBOUNDRECORDS_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "InboundRecords");
  ...
  private com.guidewire._generated.entity.InboundChunkWorkItemInternal _internal;
   ...
   */
  public InboundChunkWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InboundChunkWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InboundChunkWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InboundChunkWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.InboundChunk getInboundRecords() {
    return (entity.InboundChunk)__getInternalInterface().getFieldValue(INBOUNDRECORDS_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InboundChunkWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InboundChunkWorkItem.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getInboundRecordsID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(INBOUNDRECORDS_PROP.get());
    }
    ...
    public void setInboundRecordsID(gw.pl.persistence.core.Key value) {
      setFieldValue(INBOUNDRECORDS_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InboundChunkWorkItem.class, config);
    com.guidewire._generated.entity.InboundChunkWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InboundChunkWorkItem, com.guidewire._generated.entity.InboundChunkWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.InboundChunkWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InboundChunkWorkItemInternal getInternalInterface(entity.InboundChunkWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InboundChunkWorkItem newEmptyInstance() {
        return new entity.InboundChunkWorkItem((java.lang.Void)null);
      }
