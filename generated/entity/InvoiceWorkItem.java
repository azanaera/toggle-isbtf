...
/**
 * InvoiceWorkItem
 * Work item for a bulk invoice that is ready for processing
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InvoiceWorkItem.eti;InvoiceWorkItem.eix;InvoiceWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "InvoiceWorkItem")
public class InvoiceWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InvoiceWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InvoiceWorkItem>("entity.InvoiceWorkItem");
  ...
  private com.guidewire._generated.entity.InvoiceWorkItemInternal _internal;
   ...
   */
  public InvoiceWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InvoiceWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InvoiceWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InvoiceWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InvoiceWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InvoiceWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InvoiceWorkItem.class, config);
    com.guidewire._generated.entity.InvoiceWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InvoiceWorkItem, com.guidewire._generated.entity.InvoiceWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.InvoiceWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InvoiceWorkItemInternal getInternalInterface(entity.InvoiceWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InvoiceWorkItem newEmptyInstance() {
        return new entity.InvoiceWorkItem((java.lang.Void)null);
      }
