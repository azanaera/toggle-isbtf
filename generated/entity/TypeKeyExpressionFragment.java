 ...
 * ExpressionFragment for arbitrary typekey expression
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TypeKeyExpressionFragment.eti;TypeKeyExpressionFragment.eix;TypeKeyExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TypeKeyExpressionFragment")
public class TypeKeyExpressionFragment extends entity.ExpressionFragment {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TypeKeyExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TypeKeyExpressionFragment>("entity.TypeKeyExpressionFragment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LISTNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ListName");
   ...
   */
  public TypeKeyExpressionFragment()  {
   ...
   */
  public TypeKeyExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TypeKeyExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TypeKeyExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TypeKeyExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TypeKeyExpressionFragmentInternal)super.__getInternalInterface();
  }
  ...
  /**
   * Gets the value of the ListName field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getListName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LISTNAME_PROP.get());
  }
  
  public gw.entity.TypeKey getTypeKeyValue() {
    return ((com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods")).getTypeKeyValue();
  }
  
  public gw.entity.ITypeList getTypeList() {
    return ((com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods")).getTypeList();
  }
  ...
  /**
   * Sets the value of the ListName field.
   */
  public void setListName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LISTNAME_PROP.get(), value);
  }
  
  public void setTypeKeyValue(gw.entity.TypeKey arg0) {
    ((com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods")).setTypeKeyValue(arg0);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TypeKeyExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TypeKeyExpressionFragment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.TypeKeyExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.TypeKeyExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.TypeKeyExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.TypeKeyExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.TypeKeyExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.TypeKeyExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TypeKeyExpressionFragment.class, config);
    com.guidewire._generated.entity.TypeKeyExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TypeKeyExpressionFragment, com.guidewire._generated.entity.TypeKeyExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.TypeKeyExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TypeKeyExpressionFragmentInternal getInternalInterface(entity.TypeKeyExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TypeKeyExpressionFragment newEmptyInstance() {
        return new entity.TypeKeyExpressionFragment((java.lang.Void)null);
      }
