...
@gw.entity.EntityName(value = "EFTData")
public class EFTData extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.OverlapTable, entity.EFTDataDelegate, entity.AddressBookLinkable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.EFTData> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.EFTData>("entity.EFTData");
  ...
  private com.guidewire._generated.entity.EFTDataInternal _internal;
   ...
   */
  public EFTData(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected EFTData(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.EFTDataInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.EFTDataInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.EFTDataInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.EFTData.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.contact.entity.EFTData", "com.guidewire.cc.domain.contact.impl.EFTDataImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.EFTData.class, config);
    com.guidewire._generated.entity.EFTDataInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.EFTData, com.guidewire._generated.entity.EFTDataInternal>() {
      public java.lang.Object getImplementation(entity.EFTData bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.EFTDataInternal getInternalInterface(entity.EFTData bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.EFTData newEmptyInstance() {
        return new entity.EFTData((java.lang.Void)null);
      }
