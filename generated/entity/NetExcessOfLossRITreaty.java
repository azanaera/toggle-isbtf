 ...
 * Net excess of loss non-proportional reinsurance treaty agreement.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "NetExcessOfLossRITreaty.eti;NetExcessOfLossRITreaty.eix;NetExcessOfLossRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "NetExcessOfLossRITreaty")
public class NetExcessOfLossRITreaty extends entity.NonProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.NetExcessOfLossRITreaty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.NetExcessOfLossRITreaty>("entity.NetExcessOfLossRITreaty");
   ...
   */
  public NetExcessOfLossRITreaty()  {
   ...
   */
  public NetExcessOfLossRITreaty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected NetExcessOfLossRITreaty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.NetExcessOfLossRITreatyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.NetExcessOfLossRITreatyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.NetExcessOfLossRITreatyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.NetExcessOfLossRITreatyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.NetExcessOfLossRITreaty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.NetExcessOfLossRITreaty", "com.guidewire.cc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.NonProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.NetExcessOfLossRITreatyImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.NetExcessOfLossRITreaty.class, config);
    com.guidewire._generated.entity.NetExcessOfLossRITreatyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.NetExcessOfLossRITreaty, com.guidewire._generated.entity.NetExcessOfLossRITreatyInternal>() {
      public java.lang.Object getImplementation(entity.NetExcessOfLossRITreaty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.NetExcessOfLossRITreatyInternal getInternalInterface(entity.NetExcessOfLossRITreaty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.NetExcessOfLossRITreaty newEmptyInstance() {
        return new entity.NetExcessOfLossRITreaty((java.lang.Void)null);
      }
