 ...
 * BuildingRU
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BuildingRU.eti;BuildingRU.eix;BuildingRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BuildingRU")
public class BuildingRU extends entity.LocationBasedRU {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BuildingRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BuildingRU>("entity.BuildingRU");
   ...
   */
  public BuildingRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BuildingRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BuildingRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BuildingRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BuildingRUInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BuildingRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BuildingRU.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.BuildingRU", "com.guidewire.cc.domain.policy.impl.BuildingRUImpl");
    config.put("gw.cc.policy.entity.LocationBasedRU", "com.guidewire.cc.domain.policy.impl.BuildingRUImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.BuildingRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BuildingRU.class, config);
    com.guidewire._generated.entity.BuildingRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BuildingRU, com.guidewire._generated.entity.BuildingRUInternal>() {
      public java.lang.Object getImplementation(entity.BuildingRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BuildingRUInternal getInternalInterface(entity.BuildingRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BuildingRU newEmptyInstance() {
        return new entity.BuildingRU((java.lang.Void)null);
      }
