...
/**
 * DecimalClaimMetricLimit
 * Decimal based claim metric limit.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DecimalClaimMetricLimit.eti;DecimalClaimMetricLimit.eix;DecimalClaimMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DecimalClaimMetricLimit")
public class DecimalClaimMetricLimit extends entity.ClaimMetricLimit implements entity.DecimalMetricLimitDelegate, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DecimalClaimMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DecimalClaimMetricLimit>("entity.DecimalClaimMetricLimit");
   ...
   */
  public DecimalClaimMetricLimit()  {
   ...
   */
  public DecimalClaimMetricLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DecimalClaimMetricLimit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DecimalClaimMetricLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DecimalClaimMetricLimitInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DecimalClaimMetricLimitInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DecimalClaimMetricLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DecimalClaimMetricLimit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.metric.impl.ClaimMetricLimitInternal", "com.guidewire.cc.domain.claim.metric.impl.DecimalClaimMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.CopyOnWriteMetricLimitDelegateInternal", "com.guidewire.cc.domain.claim.metric.impl.DecimalClaimMetricLimitImpl");
    ...
    config.put("gw.api.metric.MetricLimit", "gw.api.claim.metric.DecimalClaimMetricLimitMethodsImpl");
    config.put("gw.api.metric.MetricLimitMethods", "gw.api.claim.metric.DecimalClaimMetricLimitMethodsImpl");
    config.put("gw.cc.claim.metric.entity.ClaimMetricLimit", "com.guidewire.cc.domain.claim.metric.impl.DecimalClaimMetricLimitImpl");
    config.put("gw.cc.claim.metric.entity.DecimalClaimMetricLimit", "com.guidewire.cc.domain.claim.metric.impl.DecimalClaimMetricLimitImpl");
    config.put("gw.cc.metric.entity.CopyOnWriteMetricLimitDelegate", "com.guidewire.cc.domain.claim.metric.impl.DecimalClaimMetricLimitImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DecimalClaimMetricLimit.class, config);
    com.guidewire._generated.entity.DecimalClaimMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DecimalClaimMetricLimit, com.guidewire._generated.entity.DecimalClaimMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.DecimalClaimMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DecimalClaimMetricLimitInternal getInternalInterface(entity.DecimalClaimMetricLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DecimalClaimMetricLimit newEmptyInstance() {
        return new entity.DecimalClaimMetricLimit((java.lang.Void)null);
      }
