 ...
 * DynamicActionConfig
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DynamicActionConfig.eti;DynamicActionConfig.eix;DynamicActionConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DynamicActionConfig")
public class DynamicActionConfig extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DynamicActionConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DynamicActionConfig>("entity.DynamicActionConfig");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CRITERIA_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Criteria");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ENABLED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Enabled");
  ...
  private com.guidewire._generated.entity.DynamicActionConfigInternal _internal;
   ...
   */
  public DynamicActionConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DynamicActionConfig(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DynamicActionConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DynamicActionConfigInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToCriteria(entity.BaseCriterionConfig element) {
    __getInternalInterface().addArrayElement(CRITERIA_PROP.get(), element);
  }
  ...
  public typekey.ResultingAction getAction() {
    return (typekey.ResultingAction)__getInternalInterface().getFieldValue(ACTION_PROP.get());
  }
  ...
  public typekey.DynamicActionCategory getCategory() {
    return (typekey.DynamicActionCategory)__getInternalInterface().getFieldValue(CATEGORY_PROP.get());
  }
  ...
  public entity.BaseCriterionConfig[] getCriteria() {
    return (entity.BaseCriterionConfig[])__getInternalInterface().getFieldValue(CRITERIA_PROP.get());
  }
  ...
  public java.lang.Boolean isEnabled() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ENABLED_PROP.get());
  }
  ...
  public void removeFromCriteria(entity.BaseCriterionConfig element) {
    __getInternalInterface().removeArrayElement(CRITERIA_PROP.get(), element);
  }
  ...
  public void removeFromCriteria(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(CRITERIA_PROP.get(), elementID);
  }
  ...
  public void setCriteria(entity.BaseCriterionConfig[] value) {
    __getInternalInterface().setFieldValue(CRITERIA_PROP.get(), value);
  }
  ...
  public void setEnabled(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ENABLED_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DynamicActionConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DynamicActionConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DynamicActionConfig.class, config);
    com.guidewire._generated.entity.DynamicActionConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DynamicActionConfig, com.guidewire._generated.entity.DynamicActionConfigInternal>() {
      public java.lang.Object getImplementation(entity.DynamicActionConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DynamicActionConfigInternal getInternalInterface(entity.DynamicActionConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DynamicActionConfig newEmptyInstance() {
        return new entity.DynamicActionConfig((java.lang.Void)null);
      }
