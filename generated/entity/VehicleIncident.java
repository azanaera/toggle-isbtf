 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "VehicleIncident.eti;VehicleIncident.eix;VehicleIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "VehicleIncident")
public class VehicleIncident extends entity.MobilePropertyIncident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CELLPHONECOUNTRY_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CellPhoneCountry_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CELLPHONEEXTENSION_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CellPhoneExtension_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CELLPHONE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CellPhone_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CHILDSAFETYSEAT_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ChildSafetySeat_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> GLASSREPAIRANDREPLACE_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "GlassRepairAndReplace_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LOCATIONTYPE_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LocationType_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> NONRATEDDRIVER_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "NonRatedDriver_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> POTENTIALSIDEHUSTLE_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PotentialSideHustle_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SIDEHUSTLEPHASE_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SideHustlePhase_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> VEHICLELOCATION_EXT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "VehicleLocation_Ext");
  ...
  /**
   * Gets the value of the CellPhoneCountry_Ext field.
   * Mobile phone country.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.PhoneCountryCode getCellPhoneCountry_Ext() {
    return (typekey.PhoneCountryCode)__getInternalInterface().getFieldValue(CELLPHONECOUNTRY_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the CellPhoneExtension_Ext field.
   * Mobile phone extension.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getCellPhoneExtension_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CELLPHONEEXTENSION_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the CellPhone_Ext field.
   * Mobile phone number associated with the contact.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getCellPhone_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CELLPHONE_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the ChildSafetySeat_Ext field.
   * Child safety seat?
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.ChildSafetySeat_Ext getChildSafetySeat_Ext() {
    return (typekey.ChildSafetySeat_Ext)__getInternalInterface().getFieldValue(CHILDSAFETYSEAT_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the GlassRepairAndReplace_Ext field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.GlassRepairAndReplace_Ext getGlassRepairAndReplace_Ext() {
    return (typekey.GlassRepairAndReplace_Ext)__getInternalInterface().getFieldValue(GLASSREPAIRANDREPLACE_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the LocationType_Ext field.
   * Vehicle Damage Location
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.VehicleDamageLocation_Ext getLocationType_Ext() {
    return (typekey.VehicleDamageLocation_Ext)__getInternalInterface().getFieldValue(LOCATIONTYPE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the NonRatedDriver_Ext field.
   * Non-rated driver?
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.NonRatedDriver_Ext getNonRatedDriver_Ext() {
    return (typekey.NonRatedDriver_Ext)__getInternalInterface().getFieldValue(NONRATEDDRIVER_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the PotentialSideHustle_Ext field.
   * Potential side hustle involved?
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.PotentialSideHustle_Ext getPotentialSideHustle_Ext() {
    return (typekey.PotentialSideHustle_Ext)__getInternalInterface().getFieldValue(POTENTIALSIDEHUSTLE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the SideHustlePhase_Ext field.
   * Side hustle phase?
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.SideHustlePhase_Ext getSideHustlePhase_Ext() {
    return (typekey.SideHustlePhase_Ext)__getInternalInterface().getFieldValue(SIDEHUSTLEPHASE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the VehicleLocation_Ext field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Address getVehicleLocation_Ext() {
    return (entity.Address)__getInternalInterface().getFieldValue(VEHICLELOCATION_EXT_PROP.get());
  }
   ...
   * @deprecated VehicleDriveable is deprecated. Use VehicleOperable instead
   */
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  ...
  /**
   * Sets the value of the CellPhoneCountry_Ext field.
   */
  public void setCellPhoneCountry_Ext(typekey.PhoneCountryCode value) {
    __getInternalInterface().setFieldValue(CELLPHONECOUNTRY_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the CellPhoneExtension_Ext field.
   */
  public void setCellPhoneExtension_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CELLPHONEEXTENSION_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the CellPhone_Ext field.
   */
  public void setCellPhone_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CELLPHONE_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ChildSafetySeat_Ext field.
   */
  public void setChildSafetySeat_Ext(typekey.ChildSafetySeat_Ext value) {
    __getInternalInterface().setFieldValue(CHILDSAFETYSEAT_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the GlassRepairAndReplace_Ext field.
   */
  public void setGlassRepairAndReplace_Ext(typekey.GlassRepairAndReplace_Ext value) {
    __getInternalInterface().setFieldValue(GLASSREPAIRANDREPLACE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the LocationType_Ext field.
   */
  public void setLocationType_Ext(typekey.VehicleDamageLocation_Ext value) {
    __getInternalInterface().setFieldValue(LOCATIONTYPE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the NonRatedDriver_Ext field.
   */
  public void setNonRatedDriver_Ext(typekey.NonRatedDriver_Ext value) {
    __getInternalInterface().setFieldValue(NONRATEDDRIVER_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the PotentialSideHustle_Ext field.
   */
  public void setPotentialSideHustle_Ext(typekey.PotentialSideHustle_Ext value) {
    __getInternalInterface().setFieldValue(POTENTIALSIDEHUSTLE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the SideHustlePhase_Ext field.
   */
  public void setSideHustlePhase_Ext(typekey.SideHustlePhase_Ext value) {
    __getInternalInterface().setFieldValue(SIDEHUSTLEPHASE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the VehicleLocation_Ext field.
   */
  public void setVehicleLocation_Ext(entity.Address value) {
    __getInternalInterface().setFieldValue(VEHICLELOCATION_EXT_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.VehicleIncidentInternal {
    ...
    public gw.pl.persistence.core.Key getVehicleLocation_ExtID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(VEHICLELOCATION_EXT_PROP.get());
    }
    ...
    public void setVehicleLocation_ExtID(gw.pl.persistence.core.Key value) {
      setFieldValue(VEHICLELOCATION_EXT_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.VehicleIncidentClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.VehicleIncidentCoverageSupplier");
