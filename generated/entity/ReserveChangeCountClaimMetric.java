...
/**
 * ReserveChangeCountClaimMetric
 * Number of Reserve Changes
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReserveChangeCountClaimMetric.eti;ReserveChangeCountClaimMetric.eix;ReserveChangeCountClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReserveChangeCountClaimMetric")
public class ReserveChangeCountClaimMetric extends entity.IntegerClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReserveChangeCountClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReserveChangeCountClaimMetric>("entity.ReserveChangeCountClaimMetric");
   ...
   */
  public ReserveChangeCountClaimMetric()  {
   ...
   */
  public ReserveChangeCountClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReserveChangeCountClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReserveChangeCountClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.financials.ReserveChangeCountClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReserveChangeCountClaimMetric.class, config);
    com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReserveChangeCountClaimMetric, com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.ReserveChangeCountClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReserveChangeCountClaimMetricInternal getInternalInterface(entity.ReserveChangeCountClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReserveChangeCountClaimMetric newEmptyInstance() {
        return new entity.ReserveChangeCountClaimMetric((java.lang.Void)null);
      }
