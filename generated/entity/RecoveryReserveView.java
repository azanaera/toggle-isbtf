...
/**
 * RecoveryReserveView
 * Aggregates the information needed to display a RecoveryReserve using the RecoveryReserve filter of the Financials Transactions page. Subtype of TransactionView.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RecoveryReserveView.eti;RecoveryReserveView.eix;RecoveryReserveView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RecoveryReserveView")
public class RecoveryReserveView extends entity.TransactionView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RecoveryReserveView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RecoveryReserveView>("entity.RecoveryReserveView");
   ...
   */
  public RecoveryReserveView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RecoveryReserveView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RecoveryReserveViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RecoveryReserveViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RecoveryReserveViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RecoveryReserveViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RecoveryReserveView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.financials.entity.RecoveryReserveView", "com.guidewire.cc.domain.financials.impl.RecoveryReserveViewImpl");
    config.put("gw.cc.financials.entity.TransactionView", "com.guidewire.cc.domain.financials.impl.RecoveryReserveViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RecoveryReserveView.class, config);
    com.guidewire._generated.entity.RecoveryReserveViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RecoveryReserveView, com.guidewire._generated.entity.RecoveryReserveViewInternal>() {
      public java.lang.Object getImplementation(entity.RecoveryReserveView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RecoveryReserveViewInternal getInternalInterface(entity.RecoveryReserveView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RecoveryReserveView newEmptyInstance() {
        return new entity.RecoveryReserveView((java.lang.Void)null);
      }
