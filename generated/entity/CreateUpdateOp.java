 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CreateUpdateOp.eti;CreateUpdateOp.eix;CreateUpdateOp.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CreateUpdateOp")
public class CreateUpdateOp extends entity.UpdateOp {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CreateUpdateOp> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CreateUpdateOp>("entity.CreateUpdateOp");
   ...
   */
  public CreateUpdateOp(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CreateUpdateOp(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CreateUpdateOpInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CreateUpdateOpInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CreateUpdateOpInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CreateUpdateOpInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CreateUpdateOp.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CreateUpdateOp.class, config);
    com.guidewire._generated.entity.CreateUpdateOpInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CreateUpdateOp, com.guidewire._generated.entity.CreateUpdateOpInternal>() {
      public java.lang.Object getImplementation(entity.CreateUpdateOp bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CreateUpdateOpInternal getInternalInterface(entity.CreateUpdateOp bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CreateUpdateOp newEmptyInstance() {
        return new entity.CreateUpdateOp((java.lang.Void)null);
      }
