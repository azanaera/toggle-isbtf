 ...
 * Days Open
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DaysOpenClaimMetric.eti;DaysOpenClaimMetric.eix;DaysOpenClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DaysOpenClaimMetric")
public class DaysOpenClaimMetric extends entity.TimeBasedClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DaysOpenClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DaysOpenClaimMetric>("entity.DaysOpenClaimMetric");
   ...
   */
  public DaysOpenClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DaysOpenClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DaysOpenClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DaysOpenClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DaysOpenClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DaysOpenClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DaysOpenClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.general.DaysOpenClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DaysOpenClaimMetric.class, config);
    com.guidewire._generated.entity.DaysOpenClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DaysOpenClaimMetric, com.guidewire._generated.entity.DaysOpenClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.DaysOpenClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DaysOpenClaimMetricInternal getInternalInterface(entity.DaysOpenClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DaysOpenClaimMetric newEmptyInstance() {
        return new entity.DaysOpenClaimMetric((java.lang.Void)null);
      }
