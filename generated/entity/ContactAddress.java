 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ContactAddress.eti;ContactAddress.eix;ContactAddress.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ContactAddress")
public class ContactAddress extends com.guidewire.pl.persistence.code.BeanBase implements entity.CommonContactAddress, entity.AddressBookLinkable, entity.Versionable, entity.Extractable, entity.OverlapTable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ContactAddress> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ContactAddress>("entity.ContactAddress");
  ...
  private com.guidewire._generated.entity.ContactAddressInternal _internal;
   ...
   */
  public ContactAddress(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ContactAddress(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContactAddressInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContactAddressInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContactAddressInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContactAddress.this.__getDelegateManager();
    }
    ...
    public entity.Address getCommonAddress() {
      return ((com.guidewire.pl.domain.contact.impl.CommonContactAddressImplCallback)__getDelegateManager().getImplementation("com.guidewire.pl.domain.contact.impl.CommonContactAddressImplCallback")).getCommonAddress();
    }
    ...
    public void setCommonAddress(entity.Address address) {
      ((com.guidewire.pl.domain.contact.impl.CommonContactAddressImplCallback)__getDelegateManager().getImplementation("com.guidewire.pl.domain.contact.impl.CommonContactAddressImplCallback")).setCommonAddress(address);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.contact.impl.ContactAddressCoreExtMethods", "com.guidewire.cc.domain.contact.impl.ContactAddressCoreExtMethodsImpl");
    config.put("com.guidewire.commons.entity.Keyable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.commons.entity.Sourceable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.pl.domain.contact.impl.CommonContactAddressImplCallback", "com.guidewire.pl.domain.contact.impl.ContactAddressImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContactAddress.class, config);
    com.guidewire._generated.entity.ContactAddressInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContactAddress, com.guidewire._generated.entity.ContactAddressInternal>() {
      public java.lang.Object getImplementation(entity.ContactAddress bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContactAddressInternal getInternalInterface(entity.ContactAddress bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContactAddress newEmptyInstance() {
        return new entity.ContactAddress((java.lang.Void)null);
      }
