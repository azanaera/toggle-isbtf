 ...
 * Quota share proportional reinsurance agreement.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FacProportionalRIAgreement.eti;FacProportionalRIAgreement.eix;FacProportionalRIAgreement.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FacProportionalRIAgreement")
public class FacProportionalRIAgreement extends entity.ProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FacProportionalRIAgreement> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FacProportionalRIAgreement>("entity.FacProportionalRIAgreement");
   ...
   */
  public FacProportionalRIAgreement()  {
   ...
   */
  public FacProportionalRIAgreement(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FacProportionalRIAgreement(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.FacProportionalRIAgreementInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FacProportionalRIAgreementInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.FacProportionalRIAgreementInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FacProportionalRIAgreementInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FacProportionalRIAgreement.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.FacProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("gw.cc.reinsurance.entity.ProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.FacProportionalRIAgreementImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FacProportionalRIAgreement.class, config);
    com.guidewire._generated.entity.FacProportionalRIAgreementInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FacProportionalRIAgreement, com.guidewire._generated.entity.FacProportionalRIAgreementInternal>() {
      public java.lang.Object getImplementation(entity.FacProportionalRIAgreement bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FacProportionalRIAgreementInternal getInternalInterface(entity.FacProportionalRIAgreement bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FacProportionalRIAgreement newEmptyInstance() {
        return new entity.FacProportionalRIAgreement((java.lang.Void)null);
      }
