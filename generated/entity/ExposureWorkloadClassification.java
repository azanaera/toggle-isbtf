...
/**
 * ExposureWorkloadClassification
 * Exposure Workload Classification
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureWorkloadClassification.eti;ExposureWorkloadClassification.eix;ExposureWorkloadClassification.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExposureWorkloadClassification")
public class ExposureWorkloadClassification extends entity.WorkloadClassification {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureWorkloadClassification> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureWorkloadClassification>("entity.ExposureWorkloadClassification");
   ...
   */
  public ExposureWorkloadClassification()  {
   ...
   */
  public ExposureWorkloadClassification(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExposureWorkloadClassification(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ExposureWorkloadClassificationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExposureWorkloadClassificationInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ExposureWorkloadClassificationInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExposureWorkloadClassificationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExposureWorkloadClassification.this.__getDelegateManager();
    }
    ...
    public entity.ClassificationCondition getConditionsBySubtype(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.ClassificationCondition)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.WorkloadClassification_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.WorkloadClassification_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.WorkloadClassification_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.WorkloadClassification_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("gw.api.assignment.workload.classifications.WorkloadClassificationMethods", "gw.assignment.workload.classifications.ExposureWorkloadClassificationMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExposureWorkloadClassification.class, config);
    com.guidewire._generated.entity.ExposureWorkloadClassificationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExposureWorkloadClassification, com.guidewire._generated.entity.ExposureWorkloadClassificationInternal>() {
      public java.lang.Object getImplementation(entity.ExposureWorkloadClassification bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureWorkloadClassificationInternal getInternalInterface(entity.ExposureWorkloadClassification bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExposureWorkloadClassification newEmptyInstance() {
        return new entity.ExposureWorkloadClassification((java.lang.Void)null);
      }
