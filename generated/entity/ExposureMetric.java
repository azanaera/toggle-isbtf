...
/**
 * ExposureMetric
 * Metrics related to a exposure
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureMetric.eti;ExposureMetric.eix;ExposureMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
public abstract class ExposureMetric extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.MetricLimitTimeDelegate, entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureMetric>("entity.ExposureMetric");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> METRICLIMITDENORM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "MetricLimitDenorm");
  ...
  private com.guidewire._generated.entity.ExposureMetricInternal _internal;
  
  protected ExposureMetric(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.ExposureMetricInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.ExposureMetricInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ExposureMetric value) {
  ...
  static {
    com.guidewire._generated.entity.ExposureMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.ExposureMetric, com.guidewire._generated.entity.ExposureMetricInternal>() {
      public java.lang.Object getImplementation(entity.ExposureMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureMetricInternal getInternalInterface(entity.ExposureMetric bean) {
        if(bean == null) {
          return null;
        };
