 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RuleVersion.eti;RuleVersion.eix;RuleVersion.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RuleVersion")
public class RuleVersion extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionAware, entity.Versionable {
   ...
   */
  public RuleVersion(gw.pl.persistence.core.BundleProvider bundleProvider)  {
  ...
  protected com.guidewire._generated.entity.RuleVersionInternal __createInternalInterface() {
   ...
   * The business rule definition of this version.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RuleVersionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RuleVersion.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.domain.RuleVersionDomainMethods", "com.guidewire.bizrules.domain.RuleVersionImpl");
    config.put("com.guidewire.bizrules.management.RuleVersionAwareInternal", "com.guidewire.bizrules.domain.RuleVersionImpl");
    config.put("com.guidewire.bizrules.management.RuleVersionInternalMethods", "com.guidewire.bizrules.domain.RuleVersionImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.bizrules.domain.RuleVersionImpl");
    config.put("com.guidewire.pl.system.bundle.RemoveCallback", "com.guidewire.bizrules.domain.RuleVersionImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.bizrules.domain.RuleVersionImpl");
    config.put("com.guidewire.pl.system.entity.PreInitCallback", "com.guidewire.bizrules.domain.RuleVersionImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RuleVersion.class, config);
    com.guidewire._generated.entity.RuleVersionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RuleVersion, com.guidewire._generated.entity.RuleVersionInternal>() {
      ...
      public entity.RuleVersion newEmptyInstance() {
        return new entity.RuleVersion((java.lang.Void)null);
      }
