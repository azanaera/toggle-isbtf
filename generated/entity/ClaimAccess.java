 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimAccess.eti;ClaimAccess.eix;ClaimAccess.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimAccess")
public class ClaimAccess extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.ClaimAccessData, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimAccess> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimAccess>("entity.ClaimAccess");
  ...
  private com.guidewire._generated.entity.ClaimAccessInternal _internal;
   ...
   */
  public ClaimAccess(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimAccess(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ClaimAccessInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimAccessInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimAccessInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimAccess.this.__getDelegateManager();
    }
    ...
    public boolean isDuplicate(entity.ClaimAccess other) {
      return ((com.guidewire.cc.domain.claim.impl.ClaimAccessInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.claim.impl.ClaimAccessInternal")).isDuplicate(other);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.impl.ClaimAccessInternal", "com.guidewire.cc.domain.claim.impl.ClaimAccessImpl");
    ...
    config.put("gw.cc.claim.entity.ClaimAccess", "com.guidewire.cc.domain.claim.impl.ClaimAccessImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimAccess.class, config);
    com.guidewire._generated.entity.ClaimAccessInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimAccess, com.guidewire._generated.entity.ClaimAccessInternal>() {
      public java.lang.Object getImplementation(entity.ClaimAccess bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimAccessInternal getInternalInterface(entity.ClaimAccess bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimAccess newEmptyInstance() {
        return new entity.ClaimAccess((java.lang.Void)null);
      }
