...
/**
 * RestProfilerConfig
 * Profiler configuration for a rest operation
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RestProfilerConfig.eti;RestProfilerConfig.eix;RestProfilerConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RestProfilerConfig")
public class RestProfilerConfig extends entity.ProfilerConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RestProfilerConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RestProfilerConfig>("entity.RestProfilerConfig");
   ...
   */
  public RestProfilerConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RestProfilerConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RestProfilerConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RestProfilerConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RestProfilerConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RestProfilerConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RestProfilerConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RestProfilerConfig.class, config);
    com.guidewire._generated.entity.RestProfilerConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RestProfilerConfig, com.guidewire._generated.entity.RestProfilerConfigInternal>() {
      public java.lang.Object getImplementation(entity.RestProfilerConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RestProfilerConfigInternal getInternalInterface(entity.RestProfilerConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RestProfilerConfig newEmptyInstance() {
        return new entity.RestProfilerConfig((java.lang.Void)null);
      }
