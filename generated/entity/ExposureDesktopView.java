...
/**
 * ExposureDesktopView
 * Desktop Exposure view entity.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureDesktopView.eti;ExposureDesktopView.eix;ExposureDesktopView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExposureDesktopView")
public class ExposureDesktopView extends entity.ExposureAbstractView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureDesktopView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureDesktopView>("entity.ExposureDesktopView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CLAIMCLAIMANT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ClaimClaimant");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> EXPOSURECLAIM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ExposureClaim");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final gw.api.exposure.PublicExposureDesktopViewFinder finder = gw.cc.exposure.entity.ExposureDesktopView.finder;
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public ExposureDesktopView()  {
   ...
   */
  public ExposureDesktopView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExposureDesktopView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ExposureDesktopViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExposureDesktopViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ExposureDesktopViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExposureDesktopViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExposureDesktopView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.ExposureAbstractView", "com.guidewire.cc.domain.exposure.impl.ExposureDesktopViewImpl");
    config.put("gw.cc.exposure.entity.ExposureDesktopView", "com.guidewire.cc.domain.exposure.impl.ExposureDesktopViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExposureDesktopView.class, config);
    com.guidewire._generated.entity.ExposureDesktopViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExposureDesktopView, com.guidewire._generated.entity.ExposureDesktopViewInternal>() {
      public java.lang.Object getImplementation(entity.ExposureDesktopView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureDesktopViewInternal getInternalInterface(entity.ExposureDesktopView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExposureDesktopView newEmptyInstance() {
        return new entity.ExposureDesktopView((java.lang.Void)null);
      }
