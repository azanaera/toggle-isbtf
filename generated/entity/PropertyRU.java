...
/**
 * PropertyRU
 * RiskUnit containing a policy.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PropertyRU.eti;PropertyRU.eix;PropertyRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PropertyRU")
public class PropertyRU extends entity.LocationBasedRU {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PropertyRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PropertyRU>("entity.PropertyRU");
   ...
   */
  public PropertyRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PropertyRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PropertyRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PropertyRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PropertyRUInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the CoverageForm field.
   * Coverage form for Homeowners
   */
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PropertyRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PropertyRU.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.LocationBasedRU", "com.guidewire.cc.domain.policy.impl.PropertyRUImpl");
    config.put("gw.cc.policy.entity.PropertyRU", "com.guidewire.cc.domain.policy.impl.PropertyRUImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.PropertyRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PropertyRU.class, config);
    com.guidewire._generated.entity.PropertyRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PropertyRU, com.guidewire._generated.entity.PropertyRUInternal>() {
      public java.lang.Object getImplementation(entity.PropertyRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PropertyRUInternal getInternalInterface(entity.PropertyRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PropertyRU newEmptyInstance() {
        return new entity.PropertyRU((java.lang.Void)null);
      }
