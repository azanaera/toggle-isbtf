 ...
 * Building
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Building.eti;Building.eix;Building.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Building")
public class Building extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Building> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Building>("entity.Building");
   ...
   */
  public Building(gw.pl.persistence.core.BundleProvider bundleProvider)  {
  ...
  static {
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.policy.impl.BuildingImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.policy.impl.BuildingImpl");
    config.put("gw.cc.policy.entity.Building", "com.guidewire.cc.domain.policy.impl.BuildingImpl");
