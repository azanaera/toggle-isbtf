 ...
 * Report of an incident involving the loss of use of propery.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LivingExpensesIncident.eti;LivingExpensesIncident.eix;LivingExpensesIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LivingExpensesIncident")
public class LivingExpensesIncident extends entity.PropertyIncident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LivingExpensesIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LivingExpensesIncident>("entity.LivingExpensesIncident");
   ...
   */
  public LivingExpensesIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LivingExpensesIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LivingExpensesIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LivingExpensesIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LivingExpensesIncidentInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LivingExpensesIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LivingExpensesIncident.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.LivingExpensesIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.LivingExpensesIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.LivingExpensesIncidentImpl");
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.InsuredClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.LivingExpenseIncidentCoverageSupplier");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.LivingExpensesIncidentImpl");
    config.put("gw.cc.exposure.entity.LivingExpensesIncident", "com.guidewire.cc.domain.exposure.impl.LivingExpensesIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.LivingExpensesIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LivingExpensesIncident.class, config);
    com.guidewire._generated.entity.LivingExpensesIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LivingExpensesIncident, com.guidewire._generated.entity.LivingExpensesIncidentInternal>() {
      public java.lang.Object getImplementation(entity.LivingExpensesIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LivingExpensesIncidentInternal getInternalInterface(entity.LivingExpensesIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LivingExpensesIncident newEmptyInstance() {
        return new entity.LivingExpensesIncident((java.lang.Void)null);
      }
