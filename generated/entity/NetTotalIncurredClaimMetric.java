...
/**
 * NetTotalIncurredClaimMetric
 * Total Incurred
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "NetTotalIncurredClaimMetric.eti;NetTotalIncurredClaimMetric.eix;NetTotalIncurredClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "NetTotalIncurredClaimMetric")
public class NetTotalIncurredClaimMetric extends entity.MoneyClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.NetTotalIncurredClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.NetTotalIncurredClaimMetric>("entity.NetTotalIncurredClaimMetric");
   ...
   */
  public NetTotalIncurredClaimMetric()  {
   ...
   */
  public NetTotalIncurredClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected NetTotalIncurredClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.NetTotalIncurredClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.financials.NetTotalIncurredClaimMetricMethodsImpl");
    config.put("gw.cc.claim.metric.entity.ClaimMetric", "com.guidewire.cc.domain.claim.metric.impl.MoneyClaimMetricImpl");
    config.put("gw.cc.claim.metric.entity.MoneyClaimMetric", "com.guidewire.cc.domain.claim.metric.impl.MoneyClaimMetricImpl");
    config.put("gw.cc.metric.entity.MetricLimitTimeDelegate", "com.guidewire.cc.domain.metric.impl.MetricLimitTimeDelegateImpl");
    config.put("gw.cc.metric.entity.MoneyMetricDelegate", "com.guidewire.cc.domain.claim.metric.impl.MoneyClaimMetricImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.NetTotalIncurredClaimMetric.class, config);
    com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.NetTotalIncurredClaimMetric, com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.NetTotalIncurredClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.NetTotalIncurredClaimMetricInternal getInternalInterface(entity.NetTotalIncurredClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.NetTotalIncurredClaimMetric newEmptyInstance() {
        return new entity.NetTotalIncurredClaimMetric((java.lang.Void)null);
      }
