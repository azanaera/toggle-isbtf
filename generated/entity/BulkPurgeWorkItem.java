...
/**
 * BulkPurgeWorkItem
 * Represents a unit of work pending for purging.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BulkPurgeWorkItem.eti;BulkPurgeWorkItem.eix;BulkPurgeWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BulkPurgeWorkItem")
public class BulkPurgeWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BulkPurgeWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BulkPurgeWorkItem>("entity.BulkPurgeWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ITEM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Item");
  ...
  private com.guidewire._generated.entity.BulkPurgeWorkItemInternal _internal;
   ...
   */
  public BulkPurgeWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BulkPurgeWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BulkPurgeWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BulkPurgeWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.Long getItem() {
    return (java.lang.Long)__getInternalInterface().getFieldValue(ITEM_PROP.get());
  }
  ...
  public void setItem(java.lang.Long value) {
    __getInternalInterface().setFieldValue(ITEM_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BulkPurgeWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BulkPurgeWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BulkPurgeWorkItem.class, config);
    com.guidewire._generated.entity.BulkPurgeWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BulkPurgeWorkItem, com.guidewire._generated.entity.BulkPurgeWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.BulkPurgeWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BulkPurgeWorkItemInternal getInternalInterface(entity.BulkPurgeWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BulkPurgeWorkItem newEmptyInstance() {
        return new entity.BulkPurgeWorkItem((java.lang.Void)null);
      }
