...
/**
 * ClaimRpt
 * Calculated financial values for claims.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimRpt.eti;ClaimRpt.eix;ClaimRpt.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimRpt")
public class ClaimRpt extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimRpt> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimRpt>("entity.ClaimRpt");
  ...
  private com.guidewire._generated.entity.ClaimRptInternal _internal;
   ...
   */
  public ClaimRpt(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimRpt(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ClaimRptInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimRptInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   * @return Claim.Currency of this ClaimRpt's Claim
   */
  public typekey.Currency getClaimCurrency() {
    return ((gw.cc.financials.entity.ClaimRpt)__getDelegateManager().getImplementation("gw.cc.financials.entity.ClaimRpt")).getClaimCurrency();
  }
  ...
  /**
   * The gross total incurred amount of a claim.  This amount is the
   * open reserves plus total payments on the claim.
   */
  public gw.api.financials.CurrencyAmount getTotalIncurredGross() {
    return ((gw.cc.financials.entity.ClaimRpt)__getDelegateManager().getImplementation("gw.cc.financials.entity.ClaimRpt")).getTotalIncurredGross();
  }
  
  /**
   * The net total incurred amount of a claim.  This amount is the
   * open reserves plus total payments minus total recoveries on the claim.
   */
  public gw.api.financials.CurrencyAmount getTotalIncurredNet() {
    return ((gw.cc.financials.entity.ClaimRpt)__getDelegateManager().getImplementation("gw.cc.financials.entity.ClaimRpt")).getTotalIncurredNet();
  }
  
  /**
   * The open recovery reserves of a claim.  This amount is the open reserves
   * plus total payments minus total recoveries on the claim (or equivalently,
  ...
  public gw.api.financials.CurrencyAmount getTotalIncurredNetMinusOpenRecoveryReserves() {
    return ((gw.cc.financials.entity.ClaimRpt)__getDelegateManager().getImplementation("gw.cc.financials.entity.ClaimRpt")).getTotalIncurredNetMinusOpenRecoveryReserves();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimRptInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimRpt.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.impl.ClaimRptInternal", "com.guidewire.cc.domain.financials.impl.ClaimRptImpl");
    ...
    config.put("gw.cc.financials.entity.ClaimRpt", "com.guidewire.cc.domain.financials.impl.ClaimRptImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimRpt.class, config);
    com.guidewire._generated.entity.ClaimRptInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimRpt, com.guidewire._generated.entity.ClaimRptInternal>() {
      public java.lang.Object getImplementation(entity.ClaimRpt bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimRptInternal getInternalInterface(entity.ClaimRpt bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimRpt newEmptyInstance() {
        return new entity.ClaimRpt((java.lang.Void)null);
      }
