 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DaysInitialContactWithInsuredClaimMetric.eti;DaysInitialContactWithInsuredClaimMetric.eix;DaysInitialContactWithInsuredClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DaysInitialContactWithInsuredClaimMetric")
public class DaysInitialContactWithInsuredClaimMetric extends entity.TimeBasedClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DaysInitialContactWithInsuredClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DaysInitialContactWithInsuredClaimMetric>("entity.DaysInitialContactWithInsuredClaimMetric");
   ...
   */
  public DaysInitialContactWithInsuredClaimMetric()  {
   ...
   */
  public DaysInitialContactWithInsuredClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DaysInitialContactWithInsuredClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DaysInitialContactWithInsuredClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.general.DaysInitialContactWithInsuredClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DaysInitialContactWithInsuredClaimMetric.class, config);
    com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DaysInitialContactWithInsuredClaimMetric, com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.DaysInitialContactWithInsuredClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DaysInitialContactWithInsuredClaimMetricInternal getInternalInterface(entity.DaysInitialContactWithInsuredClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DaysInitialContactWithInsuredClaimMetric newEmptyInstance() {
        return new entity.DaysInitialContactWithInsuredClaimMetric((java.lang.Void)null);
      }
