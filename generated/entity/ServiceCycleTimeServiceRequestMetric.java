...
/**
 * ServiceCycleTimeServiceRequestMetric
 * Initial Response Time from Specialist
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ServiceCycleTimeServiceRequestMetric.eti;ServiceCycleTimeServiceRequestMetric.eix;ServiceCycleTimeServiceRequestMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ServiceCycleTimeServiceRequestMetric")
public class ServiceCycleTimeServiceRequestMetric extends entity.TimeBasedServiceRequestMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ServiceCycleTimeServiceRequestMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ServiceCycleTimeServiceRequestMetric>("entity.ServiceCycleTimeServiceRequestMetric");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TIMESPENTWORKING_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TimeSpentWorking");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> WAITINGSTARTTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "WaitingStartTime");
   ...
   */
  public ServiceCycleTimeServiceRequestMetric()  {
   ...
   */
  public ServiceCycleTimeServiceRequestMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ServiceCycleTimeServiceRequestMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.Integer getTimeSpentWorking() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(TIMESPENTWORKING_PROP.get());
  }
  ...
  public java.util.Date getWaitingStartTime() {
    return (java.util.Date)__getInternalInterface().getFieldValue(WAITINGSTARTTIME_PROP.get());
  }
  ...
  public void setTimeSpentWorking(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(TIMESPENTWORKING_PROP.get(), value);
  }
  ...
  public void setWaitingStartTime(java.util.Date value) {
    __getInternalInterface().setFieldValue(WAITINGSTARTTIME_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ServiceCycleTimeServiceRequestMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.CalculatedLimitMethods", "gw.api.vendormanagement.metric.ServiceRequestMetricMethodsImpl");
    config.put("gw.api.metric.MetricMethods", "gw.vendormanagement.metric.ServiceCycleTimeServiceRequestMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ServiceCycleTimeServiceRequestMetric.class, config);
    com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ServiceCycleTimeServiceRequestMetric, com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternal>() {
      public java.lang.Object getImplementation(entity.ServiceCycleTimeServiceRequestMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ServiceCycleTimeServiceRequestMetricInternal getInternalInterface(entity.ServiceCycleTimeServiceRequestMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ServiceCycleTimeServiceRequestMetric newEmptyInstance() {
        return new entity.ServiceCycleTimeServiceRequestMetric((java.lang.Void)null);
      }
