 ...
 * ReopenClaimInfo
 * 
 *         Holds transitional internal state information during the reopen claim operation. The system does not store this entity.
 *       
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReopenClaimInfo.eti;ReopenClaimInfo.eix;ReopenClaimInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReopenClaimInfo")
public class ReopenClaimInfo extends entity.ClaimCloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReopenClaimInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReopenClaimInfo>("entity.ReopenClaimInfo");
   ...
   */
  public ReopenClaimInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReopenClaimInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ReopenClaimInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReopenClaimInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ReopenClaimInfoInternal)super.__getInternalInterface();
  }
  ...
  public typekey.ClaimReopenedReason getreopenReason() {
    return (typekey.ClaimReopenedReason)__getInternalInterface().getFieldValue(REOPENREASON_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReopenClaimInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReopenClaimInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.ClaimCloseReopenInfo", "com.guidewire.cc.domain.claim.impl.ReopenClaimInfoImpl");
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.claim.impl.ReopenClaimInfoImpl");
    config.put("gw.cc.claim.entity.ReopenClaimInfo", "com.guidewire.cc.domain.claim.impl.ReopenClaimInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReopenClaimInfo.class, config);
    com.guidewire._generated.entity.ReopenClaimInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReopenClaimInfo, com.guidewire._generated.entity.ReopenClaimInfoInternal>() {
      public java.lang.Object getImplementation(entity.ReopenClaimInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReopenClaimInfoInternal getInternalInterface(entity.ReopenClaimInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReopenClaimInfo newEmptyInstance() {
        return new entity.ReopenClaimInfo((java.lang.Void)null);
      }
