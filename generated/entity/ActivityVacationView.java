 ...
 * <p>Aggregates the information needed to display one activity row in the activity vaction page (subtype of ActivityView).</p>
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ActivityVacationView.eti;ActivityVacationView.eix;ActivityVacationView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ActivityVacationView")
public class ActivityVacationView extends entity.ActivityView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ActivityVacationView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ActivityVacationView>("entity.ActivityVacationView");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMCONTACTID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimContactID");
  ...
  public static final com.guidewire.cc.domain.activity.PublicActivityVacationViewFinder finder = gw.cc.activity.entity.ActivityVacationView.finder;
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public ActivityVacationView()  {
   ...
   */
  public ActivityVacationView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ActivityVacationView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ActivityVacationViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ActivityVacationViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ActivityVacationViewInternal)super.__getInternalInterface();
  }
   ...
   * @return true if the given Activity can be approved, false otherwise
   */
  public boolean canApprove() {
    return ((gw.cc.activity.entity.ActivityVacationView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivityVacationView")).canApprove();
  }
   ...
   * @return true if the Activity can be completed, false otherwise
   */
  public boolean canComplete() {
    return ((gw.cc.activity.entity.ActivityVacationView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivityVacationView")).canComplete();
  }
  ...
  public boolean canSkip() {
    return ((gw.cc.activity.entity.ActivityVacationView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivityVacationView")).canSkip();
  }
  ...
  public java.lang.String getClaimant() {
    return ((gw.cc.activity.entity.ActivityVacationView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivityVacationView")).getClaimant();
  }
  ...
  public java.lang.String getExposure() {
    return ((gw.cc.activity.entity.ActivityVacationView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivityVacationView")).getExposure();
  }
  ...
  public boolean isUpdatedSinceLastViewed() {
    return ((gw.cc.activity.entity.ActivityVacationView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivityVacationView")).isUpdatedSinceLastViewed();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ActivityVacationViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ActivityVacationView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.activity.entity.ActivityVacationView", "com.guidewire.cc.domain.activity.impl.ActivityVacationViewImpl");
    config.put("gw.cc.activity.entity.ActivityView", "com.guidewire.cc.domain.activity.impl.ActivityVacationViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ActivityVacationView.class, config);
    com.guidewire._generated.entity.ActivityVacationViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ActivityVacationView, com.guidewire._generated.entity.ActivityVacationViewInternal>() {
      public java.lang.Object getImplementation(entity.ActivityVacationView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ActivityVacationViewInternal getInternalInterface(entity.ActivityVacationView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ActivityVacationView newEmptyInstance() {
        return new entity.ActivityVacationView((java.lang.Void)null);
      }
