...
/**
 * AppCritExposureType
 * Exposure Type Applicability Criteria 
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AppCritExposureType.eti;AppCritExposureType.eix;AppCritExposureType.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AppCritExposureType")
public class AppCritExposureType extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritExposureType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritExposureType>("entity.AppCritExposureType");
  ...
  private com.guidewire._generated.entity.AppCritExposureTypeInternal _internal;
   ...
   */
  public AppCritExposureType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritExposureType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritExposureTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritExposureTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritExposureTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritExposureType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritExposureTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritExposureType.class, config);
    com.guidewire._generated.entity.AppCritExposureTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritExposureType, com.guidewire._generated.entity.AppCritExposureTypeInternal>() {
      public java.lang.Object getImplementation(entity.AppCritExposureType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritExposureTypeInternal getInternalInterface(entity.AppCritExposureType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritExposureType newEmptyInstance() {
        return new entity.AppCritExposureType((java.lang.Void)null);
      }
