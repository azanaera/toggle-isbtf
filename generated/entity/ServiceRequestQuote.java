...
/**
 * ServiceRequestQuote
 * A quote received from a specialist for a Service Request.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ServiceRequestQuote.eti;ServiceRequestQuote.eix;ServiceRequestQuote.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ServiceRequestQuote")
public class ServiceRequestQuote extends entity.ServiceRequestStatement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ServiceRequestQuote> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ServiceRequestQuote>("entity.ServiceRequestQuote");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EXPECTEDDAYSTOPERFORMSERVICE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ExpectedDaysToPerformService");
   ...
   */
  public ServiceRequestQuote(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ServiceRequestQuote(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ServiceRequestQuoteInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ServiceRequestQuoteInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ServiceRequestQuoteInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the ExpectedDaysToPerformService field.
   * Number of business days the specialist expects it will take to perform the service.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Integer getExpectedDaysToPerformService() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(EXPECTEDDAYSTOPERFORMSERVICE_PROP.get());
  }
  
  /**
   * Sets the value of the ExpectedDaysToPerformService field.
   */
  public void setExpectedDaysToPerformService(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(EXPECTEDDAYSTOPERFORMSERVICE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ServiceRequestQuoteInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ServiceRequestQuote.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ServiceRequestQuote.class, config);
    com.guidewire._generated.entity.ServiceRequestQuoteInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ServiceRequestQuote, com.guidewire._generated.entity.ServiceRequestQuoteInternal>() {
      public java.lang.Object getImplementation(entity.ServiceRequestQuote bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ServiceRequestQuoteInternal getInternalInterface(entity.ServiceRequestQuote bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ServiceRequestQuote newEmptyInstance() {
        return new entity.ServiceRequestQuote((java.lang.Void)null);
      }
