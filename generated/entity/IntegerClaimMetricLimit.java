 ...
 * Integer based claim metric limit.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "IntegerClaimMetricLimit.eti;IntegerClaimMetricLimit.eix;IntegerClaimMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "IntegerClaimMetricLimit")
public class IntegerClaimMetricLimit extends entity.ClaimMetricLimit implements entity.IntegerMetricLimitDelegate, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.IntegerClaimMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.IntegerClaimMetricLimit>("entity.IntegerClaimMetricLimit");
   ...
   */
  public IntegerClaimMetricLimit()  {
   ...
   */
  public IntegerClaimMetricLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected IntegerClaimMetricLimit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IntegerClaimMetricLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IntegerClaimMetricLimitInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IntegerClaimMetricLimitInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IntegerClaimMetricLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IntegerClaimMetricLimit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.metric.impl.ClaimMetricLimitInternal", "com.guidewire.cc.domain.claim.metric.impl.IntegerClaimMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.CopyOnWriteMetricLimitDelegateInternal", "com.guidewire.cc.domain.claim.metric.impl.IntegerClaimMetricLimitImpl");
    ...
    config.put("gw.api.metric.MetricLimit", "gw.api.claim.metric.IntegerClaimMetricLimitMethodsImpl");
    config.put("gw.api.metric.MetricLimitMethods", "gw.api.claim.metric.IntegerClaimMetricLimitMethodsImpl");
    config.put("gw.cc.claim.metric.entity.ClaimMetricLimit", "com.guidewire.cc.domain.claim.metric.impl.IntegerClaimMetricLimitImpl");
    config.put("gw.cc.claim.metric.entity.IntegerClaimMetricLimit", "com.guidewire.cc.domain.claim.metric.impl.IntegerClaimMetricLimitImpl");
    config.put("gw.cc.metric.entity.CopyOnWriteMetricLimitDelegate", "com.guidewire.cc.domain.claim.metric.impl.IntegerClaimMetricLimitImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IntegerClaimMetricLimit.class, config);
    com.guidewire._generated.entity.IntegerClaimMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IntegerClaimMetricLimit, com.guidewire._generated.entity.IntegerClaimMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.IntegerClaimMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IntegerClaimMetricLimitInternal getInternalInterface(entity.IntegerClaimMetricLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IntegerClaimMetricLimit newEmptyInstance() {
        return new entity.IntegerClaimMetricLimit((java.lang.Void)null);
      }
