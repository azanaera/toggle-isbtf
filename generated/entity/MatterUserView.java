 ...
 * MatterUserView
 * 
 *             Aggregates the information needed to display one matter row in the user administration page (subtype of MatterView).
 *             
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MatterUserView.eti;MatterUserView.eix;MatterUserView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MatterUserView")
public class MatterUserView extends entity.MatterView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MatterUserView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MatterUserView>("entity.MatterUserView");
  ...
  public static final gw.api.matter.PublicMatterUserViewFinder finder = gw.cc.matter.entity.MatterUserView.finder;
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public MatterUserView()  {
   ...
   */
  public MatterUserView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MatterUserView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.MatterUserViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MatterUserViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.MatterUserViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MatterUserViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MatterUserView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.matter.entity.MatterUserView", "com.guidewire.cc.domain.matter.impl.MatterUserViewImpl");
    config.put("gw.cc.matter.entity.MatterView", "com.guidewire.cc.domain.matter.impl.MatterUserViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MatterUserView.class, config);
    com.guidewire._generated.entity.MatterUserViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MatterUserView, com.guidewire._generated.entity.MatterUserViewInternal>() {
      public java.lang.Object getImplementation(entity.MatterUserView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MatterUserViewInternal getInternalInterface(entity.MatterUserView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MatterUserView newEmptyInstance() {
        return new entity.MatterUserView((java.lang.Void)null);
      }
