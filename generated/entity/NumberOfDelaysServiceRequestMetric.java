 ...
 * Counts the number of times the specialist delays the expected completion date
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "NumberOfDelaysServiceRequestMetric.eti;NumberOfDelaysServiceRequestMetric.eix;NumberOfDelaysServiceRequestMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "NumberOfDelaysServiceRequestMetric")
public class NumberOfDelaysServiceRequestMetric extends entity.IntegerServiceRequestMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.NumberOfDelaysServiceRequestMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.NumberOfDelaysServiceRequestMetric>("entity.NumberOfDelaysServiceRequestMetric");
   ...
   */
  public NumberOfDelaysServiceRequestMetric()  {
   ...
   */
  public NumberOfDelaysServiceRequestMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected NumberOfDelaysServiceRequestMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.NumberOfDelaysServiceRequestMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.vendormanagement.metric.NumberOfDelaysServiceRequestMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.NumberOfDelaysServiceRequestMetric.class, config);
    com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.NumberOfDelaysServiceRequestMetric, com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternal>() {
      public java.lang.Object getImplementation(entity.NumberOfDelaysServiceRequestMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.NumberOfDelaysServiceRequestMetricInternal getInternalInterface(entity.NumberOfDelaysServiceRequestMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.NumberOfDelaysServiceRequestMetric newEmptyInstance() {
        return new entity.NumberOfDelaysServiceRequestMetric((java.lang.Void)null);
      }
