...
/**
 * PercentPaidLossCostsClaimMetric
 * Paid Loss Costs as % of Total Paid
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PercentPaidLossCostsClaimMetric.eti;PercentPaidLossCostsClaimMetric.eix;PercentPaidLossCostsClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PercentPaidLossCostsClaimMetric")
public class PercentPaidLossCostsClaimMetric extends entity.PercentClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PercentPaidLossCostsClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PercentPaidLossCostsClaimMetric>("entity.PercentPaidLossCostsClaimMetric");
   ...
   */
  public PercentPaidLossCostsClaimMetric()  {
   ...
   */
  public PercentPaidLossCostsClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PercentPaidLossCostsClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PercentPaidLossCostsClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.financials.PercentPaidLossCostsClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PercentPaidLossCostsClaimMetric.class, config);
    com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PercentPaidLossCostsClaimMetric, com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.PercentPaidLossCostsClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PercentPaidLossCostsClaimMetricInternal getInternalInterface(entity.PercentPaidLossCostsClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PercentPaidLossCostsClaimMetric newEmptyInstance() {
        return new entity.PercentPaidLossCostsClaimMetric((java.lang.Void)null);
      }
