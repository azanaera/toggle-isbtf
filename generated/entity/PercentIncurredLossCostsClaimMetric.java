...
/**
 * PercentIncurredLossCostsClaimMetric
 * Incurred Loss Costs as % of Net Total Incurred
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PercentIncurredLossCostsClaimMetric.eti;PercentIncurredLossCostsClaimMetric.eix;PercentIncurredLossCostsClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PercentIncurredLossCostsClaimMetric")
public class PercentIncurredLossCostsClaimMetric extends entity.PercentClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PercentIncurredLossCostsClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PercentIncurredLossCostsClaimMetric>("entity.PercentIncurredLossCostsClaimMetric");
   ...
   */
  public PercentIncurredLossCostsClaimMetric()  {
   ...
   */
  public PercentIncurredLossCostsClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PercentIncurredLossCostsClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PercentIncurredLossCostsClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.financials.PercentIncurredLossCostsClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PercentIncurredLossCostsClaimMetric.class, config);
    com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PercentIncurredLossCostsClaimMetric, com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.PercentIncurredLossCostsClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PercentIncurredLossCostsClaimMetricInternal getInternalInterface(entity.PercentIncurredLossCostsClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PercentIncurredLossCostsClaimMetric newEmptyInstance() {
        return new entity.PercentIncurredLossCostsClaimMetric((java.lang.Void)null);
      }
