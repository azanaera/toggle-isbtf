 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimContactRole.eti;ClaimContactRole.eix;ClaimContactRole.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimContactRole")
public class ClaimContactRole extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable, entity.EventAware {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ADDDATE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AddDate_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ISEXCLUDED_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IsExcluded_Ext");
  ...
  public static final java.lang.String CLAIMCONTACTROLEADDED_EVENT = "ClaimContactRoleAdded";
  
  public static final java.lang.String CLAIMCONTACTROLECHANGED_EVENT = "ClaimContactRoleChanged";
  
  public static final java.lang.String CLAIMCONTACTROLEREMOVED_EVENT = "ClaimContactRoleRemoved";
  ...
  /**
   * Gets the value of the AddDate_Ext field.
   * the add date from the sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getAddDate_Ext() {
    return (java.util.Date)__getInternalInterface().getFieldValue(ADDDATE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the IsExcluded_Ext field.
   * Indicates if a contact is an Excluded party from Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isIsExcluded_Ext() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ISEXCLUDED_EXT_PROP.get());
  }
  ...
  /**
   * Sets the value of the AddDate_Ext field.
   */
  public void setAddDate_Ext(java.util.Date value) {
    __getInternalInterface().setFieldValue(ADDDATE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the IsExcluded_Ext field.
   */
  public void setIsExcluded_Ext(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ISEXCLUDED_EXT_PROP.get(), value);
  }
