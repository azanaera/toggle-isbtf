...
/**
 * OutboundFileLocalConfig
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OutboundFileLocalConfig.eti;OutboundFileLocalConfig.eix;OutboundFileLocalConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OutboundFileLocalConfig")
public class OutboundFileLocalConfig extends entity.OutboundFileConfig implements com.guidewire.outboundfile.config.OutboundFileConfigMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OutboundFileLocalConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OutboundFileLocalConfig>("entity.OutboundFileLocalConfig");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERMANENTDIRECTORY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PermanentDirectory");
   ...
   */
  public OutboundFileLocalConfig()  {
   ...
   */
  public OutboundFileLocalConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OutboundFileLocalConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.OutboundFileLocalConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OutboundFileLocalConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.OutboundFileLocalConfigInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getPermanentDirectory() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(PERMANENTDIRECTORY_PROP.get());
  }
  ...
  public void setPermanentDirectory(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PERMANENTDIRECTORY_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OutboundFileLocalConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OutboundFileLocalConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.outboundfile.config.OutboundFileConfigMethods", "com.guidewire.outboundfile.config.OutboundFileLocalConfigImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OutboundFileLocalConfig.class, config);
    com.guidewire._generated.entity.OutboundFileLocalConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OutboundFileLocalConfig, com.guidewire._generated.entity.OutboundFileLocalConfigInternal>() {
      public java.lang.Object getImplementation(entity.OutboundFileLocalConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OutboundFileLocalConfigInternal getInternalInterface(entity.OutboundFileLocalConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OutboundFileLocalConfig newEmptyInstance() {
        return new entity.OutboundFileLocalConfig((java.lang.Void)null);
      }
