 ...
 * Excess of loss non-proportional reinsurance treaty agreement.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExcessOfLossRITreaty.eti;ExcessOfLossRITreaty.eix;ExcessOfLossRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExcessOfLossRITreaty")
public class ExcessOfLossRITreaty extends entity.NonProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExcessOfLossRITreaty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExcessOfLossRITreaty>("entity.ExcessOfLossRITreaty");
   ...
   */
  public ExcessOfLossRITreaty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExcessOfLossRITreaty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ExcessOfLossRITreatyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExcessOfLossRITreatyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ExcessOfLossRITreatyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExcessOfLossRITreatyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExcessOfLossRITreaty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.ExcessOfLossRITreaty", "com.guidewire.cc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.NonProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.ExcessOfLossRITreatyImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExcessOfLossRITreaty.class, config);
    com.guidewire._generated.entity.ExcessOfLossRITreatyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExcessOfLossRITreaty, com.guidewire._generated.entity.ExcessOfLossRITreatyInternal>() {
      public java.lang.Object getImplementation(entity.ExcessOfLossRITreaty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExcessOfLossRITreatyInternal getInternalInterface(entity.ExcessOfLossRITreaty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExcessOfLossRITreaty newEmptyInstance() {
        return new entity.ExcessOfLossRITreaty((java.lang.Void)null);
      }
