...
@javax.annotation.processing.Generated("com.guidewire.pl.metadata.codegen.Codegen", "", "ClaimMetric.eti;ClaimMetric.eix;ClaimMetric.etx")
enhancement GWClaimMetricEntityEnhancement : entity.ClaimMetric {
  ...
  property get DisplayColor () : gw.api.web.color.GWColor {
