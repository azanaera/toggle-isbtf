 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Document.eti;Document.eix;Document.etx")
...
public class Document extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.Extractable, entity.EventAware {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RECEIVEDDATE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ReceivedDate_Ext");
  ...
  /**
   * Gets the value of the ReceivedDate_Ext field.
   * Received Date
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getReceivedDate_Ext() {
    return (java.util.Date)__getInternalInterface().getFieldValue(RECEIVEDDATE_EXT_PROP.get());
  }
  ...
  /**
   * Sets the value of the ReceivedDate_Ext field.
   */
  public void setReceivedDate_Ext(java.util.Date value) {
    __getInternalInterface().setFieldValue(RECEIVEDDATE_EXT_PROP.get(), value);
  }
