 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FinancialCriterion.eti;FinancialCriterion.eix;FinancialCriterion.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FinancialCriterion")
public class FinancialCriterion extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, com.guidewire.pl.system.service.search.SearchCriterionChoice {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FinancialCriterion> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FinancialCriterion>("entity.FinancialCriterion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AMOUNTEND_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AmountEnd");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AMOUNTSTART_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AmountStart");
  ...
  private com.guidewire._generated.entity.FinancialCriterionInternal _internal;
   ...
   */
  public FinancialCriterion(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FinancialCriterion(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.FinancialCriterionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FinancialCriterionInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.FinancialCriterion value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FinancialCriterionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FinancialCriterion.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.custom.FinancialCriterionPublicMethods", "com.guidewire.pl.domain.custom.impl.FinancialCriterionImpl");
    config.put("com.guidewire.pl.domain.custom.impl.FinancialCriterionInternalMethods", "com.guidewire.pl.domain.custom.impl.FinancialCriterionImpl");
    ...
    config.put("com.guidewire.pl.system.service.search.SearchCriterionChoice", "com.guidewire.pl.domain.custom.impl.FinancialCriterionImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FinancialCriterion.class, config);
    com.guidewire._generated.entity.FinancialCriterionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FinancialCriterion, com.guidewire._generated.entity.FinancialCriterionInternal>() {
      public java.lang.Object getImplementation(entity.FinancialCriterion bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FinancialCriterionInternal getInternalInterface(entity.FinancialCriterion bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FinancialCriterion newEmptyInstance() {
        return new entity.FinancialCriterion((java.lang.Void)null);
      }
