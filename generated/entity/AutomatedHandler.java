 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AutomatedHandler.eti;AutomatedHandler.eix;AutomatedHandler.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
public abstract class AutomatedHandler extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, gw.api.specialhandling.AutomatedHandlerMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AutomatedHandler> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AutomatedHandler>("entity.AutomatedHandler");
  ...
  private com.guidewire._generated.entity.AutomatedHandlerInternal _internal;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  protected AutomatedHandler(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.AutomatedHandlerInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.AutomatedHandlerInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.AutomatedHandler value) {
  ...
  static {
    com.guidewire._generated.entity.AutomatedHandlerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.AutomatedHandler, com.guidewire._generated.entity.AutomatedHandlerInternal>() {
      public java.lang.Object getImplementation(entity.AutomatedHandler bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AutomatedHandlerInternal getInternalInterface(entity.AutomatedHandler bean) {
        if(bean == null) {
          return null;
        };
