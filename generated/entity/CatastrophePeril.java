...
/**
 * CatastrophePeril
 * Details of perils associated to a catastrophe.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CatastrophePeril.eti;CatastrophePeril.eix;CatastrophePeril.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CatastrophePeril")
public class CatastrophePeril extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CatastrophePeril> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CatastrophePeril>("entity.CatastrophePeril");
  ...
  private com.guidewire._generated.entity.CatastrophePerilInternal _internal;
   ...
   */
  public CatastrophePeril(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CatastrophePeril(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CatastrophePerilInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CatastrophePerilInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CatastrophePerilInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CatastrophePeril.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.catastrophe.entity.CatastrophePeril", "com.guidewire.cc.domain.catastrophe.impl.CatastrophePerilImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CatastrophePeril.class, config);
    com.guidewire._generated.entity.CatastrophePerilInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CatastrophePeril, com.guidewire._generated.entity.CatastrophePerilInternal>() {
      public java.lang.Object getImplementation(entity.CatastrophePeril bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CatastrophePerilInternal getInternalInterface(entity.CatastrophePeril bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CatastrophePeril newEmptyInstance() {
        return new entity.CatastrophePeril((java.lang.Void)null);
      }
