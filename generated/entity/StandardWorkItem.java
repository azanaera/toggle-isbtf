 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "StandardWorkItem.eti;StandardWorkItem.eix;StandardWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "StandardWorkItem")
public class StandardWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.StandardWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.StandardWorkItem>("entity.StandardWorkItem");
  ...
  private com.guidewire._generated.entity.StandardWorkItemInternal _internal;
   ...
   */
  public StandardWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected StandardWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.StandardWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.StandardWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.StandardWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.StandardWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.StandardWorkItem.class, config);
    com.guidewire._generated.entity.StandardWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.StandardWorkItem, com.guidewire._generated.entity.StandardWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.StandardWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.StandardWorkItemInternal getInternalInterface(entity.StandardWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.StandardWorkItem newEmptyInstance() {
        return new entity.StandardWorkItem((java.lang.Void)null);
      }
