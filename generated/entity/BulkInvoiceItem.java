 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BulkInvoiceItem.eti;BulkInvoiceItem.eix;BulkInvoiceItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BulkInvoiceItem")
public class BulkInvoiceItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, gw.api.financials.BulkInvoiceItemMethods {
  ...
  /**
   * Retrieves the list of possible valid PaymentTypes for this BulkInvoiceItem.
   *  <p/>
   *  Pre-condition: The BulkInvoiceItem must have an associated ReserveLine (even if it's a new ReserveLine).
   * @return a list of the valid PaymentType values
   */
  public java.util.List<typekey.PaymentType> getValidPaymentTypes() {
    return ((gw.cc.financials.bulkpay.entity.BulkInvoiceItem)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoiceItem")).getValidPaymentTypes();
  }
  ...
  /**
   * Returns whether this item's claim has been purged
   */
  public boolean isItemClaimPurged() {
    return ((gw.cc.financials.bulkpay.entity.BulkInvoiceItem)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoiceItem")).isItemClaimPurged();
  }
  ...
  /**
   * Do any validation required on this invoice item to determine whether check creation should proceed.
   * If validation fails, the item's Explanation should be populated with a description of what failed.
   * Optionally, any fixable problems can be corrected here.
   * 
   * Other than setting the Explanation field if validation fails, or fixing problems, changes to the invoice item
   * or any other entity should be avoided.
   * @return true if the invoice item passed validation, false otherwise
   */
  public boolean validateForSubmission() {
    return ((gw.api.financials.BulkInvoiceItemMethods)__getDelegateManager().getImplementation("gw.api.financials.BulkInvoiceItemMethods")).validateForSubmission();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BulkInvoiceItemInternal {
    ...
    public void deleteExistingCheck() {
      ((com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInternal")).deleteExistingCheck();
    }
    ...
    public void processCheckForSubmission() {
      ((com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInternal")).processCheckForSubmission();
    }
    ...
    public boolean shouldProcess() {
      return ((com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInternal")).shouldProcess();
    }
  ...
  static {
    ...
    config.put("gw.api.financials.BulkInvoiceItemMethods", "gw.entity.BulkInvoiceItemMethodsImpl");
