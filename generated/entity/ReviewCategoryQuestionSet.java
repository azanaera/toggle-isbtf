 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReviewCategoryQuestionSet.eti;ReviewCategoryQuestionSet.eix;ReviewCategoryQuestionSet.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReviewCategoryQuestionSet")
public class ReviewCategoryQuestionSet extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReviewCategoryQuestionSet> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReviewCategoryQuestionSet>("entity.ReviewCategoryQuestionSet");
  ...
  private com.guidewire._generated.entity.ReviewCategoryQuestionSetInternal _internal;
   ...
   */
  public ReviewCategoryQuestionSet()  {
   ...
   */
  public ReviewCategoryQuestionSet(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReviewCategoryQuestionSet(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ReviewCategoryQuestionSetInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReviewCategoryQuestionSetInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void setReviewType(entity.ReviewType value) {
    __getInternalInterface().setFieldValue(REVIEWTYPE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReviewCategoryQuestionSetInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReviewCategoryQuestionSet.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.contact.entity.ReviewCategoryQuestionSet", "com.guidewire.cc.domain.contact.impl.ReviewCategoryQuestionSetImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReviewCategoryQuestionSet.class, config);
    com.guidewire._generated.entity.ReviewCategoryQuestionSetInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReviewCategoryQuestionSet, com.guidewire._generated.entity.ReviewCategoryQuestionSetInternal>() {
      public java.lang.Object getImplementation(entity.ReviewCategoryQuestionSet bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReviewCategoryQuestionSetInternal getInternalInterface(entity.ReviewCategoryQuestionSet bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReviewCategoryQuestionSet newEmptyInstance() {
        return new entity.ReviewCategoryQuestionSet((java.lang.Void)null);
      }
