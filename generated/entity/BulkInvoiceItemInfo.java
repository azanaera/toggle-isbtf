 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BulkInvoiceItemInfo.eti;BulkInvoiceItemInfo.eix;BulkInvoiceItemInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BulkInvoiceItemInfo")
public class BulkInvoiceItemInfo extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BulkInvoiceItemInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BulkInvoiceItemInfo>("entity.BulkInvoiceItemInfo");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BULKINVOICEITEMPUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BulkInvoiceItemPublicID");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> CHECKARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "CheckArray");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RESERVELINEWRAPPER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "ReserveLineWrapper");
  ...
  private com.guidewire._generated.entity.BulkInvoiceItemInfoInternal _internal;
   ...
   */
  public BulkInvoiceItemInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BulkInvoiceItemInfo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BulkInvoiceItemInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BulkInvoiceItemInfoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getBulkInvoiceItemPublicID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(BULKINVOICEITEMPUBLICID_PROP.get());
  }
  ...
  public entity.Check[] getCheckArray() {
    return (entity.Check[])__getInternalInterface().getFieldValue(CHECKARRAY_PROP.get());
  }
  ...
  public entity.ReserveLineWrapper getReserveLineWrapper() {
    return (entity.ReserveLineWrapper)__getInternalInterface().getFieldValue(RESERVELINEWRAPPER_PROP.get());
  }
  ...
  public void setBulkInvoiceItemPublicID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(BULKINVOICEITEMPUBLICID_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Check field.
   */
  private void setCheck(entity.Check value) {
   ...
   */
  private void setCheckArray(entity.Check[] value) {
    __getInternalInterface().setFieldValue(CHECKARRAY_PROP.get(), value);
  }
  ...
  public void setReserveLineWrapper(entity.ReserveLineWrapper value) {
    __getInternalInterface().setFieldValue(RESERVELINEWRAPPER_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BulkInvoiceItemInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BulkInvoiceItemInfo.this.__getDelegateManager();
    }
    ...
    public void addToCheckArray(entity.Check element) {
      __getInternalInterface().addArrayElement(CHECKARRAY_PROP.get(), element);
    }
    ...
    public gw.pl.persistence.core.Key getReserveLineWrapperID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RESERVELINEWRAPPER_PROP.get());
    }
    ...
    public void removeFromCheckArray(entity.Check element) {
      __getInternalInterface().removeArrayElement(CHECKARRAY_PROP.get(), element);
    }
    ...
    public void removeFromCheckArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(CHECKARRAY_PROP.get(), elementID);
    }
    ...
    public void setReserveLineWrapperID(gw.pl.persistence.core.Key value) {
      setFieldValue(RESERVELINEWRAPPER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInfoImpl");
    config.put("gw.cc.financials.bulkpay.entity.BulkInvoiceItemInfo", "com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceItemInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BulkInvoiceItemInfo.class, config);
    com.guidewire._generated.entity.BulkInvoiceItemInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BulkInvoiceItemInfo, com.guidewire._generated.entity.BulkInvoiceItemInfoInternal>() {
      public java.lang.Object getImplementation(entity.BulkInvoiceItemInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BulkInvoiceItemInfoInternal getInternalInterface(entity.BulkInvoiceItemInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BulkInvoiceItemInfo newEmptyInstance() {
        return new entity.BulkInvoiceItemInfo((java.lang.Void)null);
      }
