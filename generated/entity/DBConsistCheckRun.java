 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DBConsistCheckRun.eti;DBConsistCheckRun.eix;DBConsistCheckRun.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DBConsistCheckRun")
public class DBConsistCheckRun extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DBConsistCheckRun> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DBConsistCheckRun>("entity.DBConsistCheckRun");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> DBCONSISTCHECKQUERYEXECS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "DBConsistCheckQueryExecs");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMBEROFTHREADS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumberOfThreads");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TOTALNUMCHECKS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TotalNumChecks");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.DBConsistCheckRunInternal _internal;
   ...
   */
  public DBConsistCheckRun(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DBConsistCheckRun(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DBConsistCheckRunInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DBConsistCheckRunInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * 
   * @return All query executions for this run.
   */
  public java.util.List<entity.DBConsistCheckQueryExec> getAllQueryExecs() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getAllQueryExecs();
  }
  ...
  public entity.DBConsistCheckQueryExec[] getDBConsistCheckQueryExecs() {
    return (entity.DBConsistCheckQueryExec[])__getInternalInterface().getFieldValue(DBCONSISTCHECKQUERYEXECS_PROP.get());
  }
  ...
  /**
   * 
   * @return Count of all consistency checks in this run
   */
  public int getNumAllExec() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getNumAllExec();
  }
  
  /**
   * 
   * @return Count of consistency checks with errors in this run
   */
  public int getNumErrorExecs() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getNumErrorExecs();
  }
  
  /**
   * 
   * @return Count of consistency checks in the run that have finished.
   */
  public int getNumExecsFinished() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getNumExecsFinished();
  }
  
  /**
   * 
   * @return Count of consistency checks in the run that have started but not finished.
   */
  public int getNumExecsInProgress() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getNumExecsInProgress();
  }
  
  /**
   * 
   * @return Count of consistency checks in the run that have not yet started.
   */
  public int getNumExecsNotStarted() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getNumExecsNotStarted();
  }
  ...
  /**
   * 
   * @return All query executions that returned error rows
   */
  public java.util.List<entity.DBConsistCheckQueryExec> getQueryExecsWithErrors() {
    return ((com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods")).getQueryExecsWithErrors();
  }
  ...
  public void removeFromDBConsistCheckQueryExecs(entity.DBConsistCheckQueryExec element) {
    __getInternalInterface().removeArrayElement(DBCONSISTCHECKQUERYEXECS_PROP.get(), element);
  }
  ...
  public void removeFromDBConsistCheckQueryExecs(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(DBCONSISTCHECKQUERYEXECS_PROP.get(), elementID);
  }
  ...
  public void setDBConsistCheckQueryExecs(entity.DBConsistCheckQueryExec[] value) {
    __getInternalInterface().setFieldValue(DBCONSISTCHECKQUERYEXECS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DBConsistCheckRunInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DBConsistCheckRun.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.database.DBConsistCheckRunPublicMethods", "com.guidewire.pl.domain.database.impl.DBConsistCheckRunImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DBConsistCheckRun.class, config);
    com.guidewire._generated.entity.DBConsistCheckRunInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DBConsistCheckRun, com.guidewire._generated.entity.DBConsistCheckRunInternal>() {
      public java.lang.Object getImplementation(entity.DBConsistCheckRun bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DBConsistCheckRunInternal getInternalInterface(entity.DBConsistCheckRun bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DBConsistCheckRun newEmptyInstance() {
        return new entity.DBConsistCheckRun((java.lang.Void)null);
      }
