...
/**
 * ClaimVacationView
 * View entity for efficiently displaying Claims on the Desktop page.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimVacationView.eti;ClaimVacationView.eix;ClaimVacationView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimVacationView")
public class ClaimVacationView extends entity.ClaimAssignmentView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimVacationView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimVacationView>("entity.ClaimVacationView");
  ...
  public static final gw.api.claim.PublicClaimVacationViewFinder finder = gw.cc.claim.entity.ClaimVacationView.finder;
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public ClaimVacationView()  {
   ...
   */
  public ClaimVacationView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimVacationView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimVacationViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimVacationViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimVacationViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimVacationViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimVacationView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.ClaimAbstractView", "com.guidewire.cc.domain.claim.impl.ClaimVacationViewImpl");
    config.put("gw.cc.claim.entity.ClaimAssignmentView", "com.guidewire.cc.domain.claim.impl.ClaimVacationViewImpl");
    config.put("gw.cc.claim.entity.ClaimVacationView", "com.guidewire.cc.domain.claim.impl.ClaimVacationViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimVacationView.class, config);
    com.guidewire._generated.entity.ClaimVacationViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimVacationView, com.guidewire._generated.entity.ClaimVacationViewInternal>() {
      public java.lang.Object getImplementation(entity.ClaimVacationView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimVacationViewInternal getInternalInterface(entity.ClaimVacationView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimVacationView newEmptyInstance() {
        return new entity.ClaimVacationView((java.lang.Void)null);
      }
