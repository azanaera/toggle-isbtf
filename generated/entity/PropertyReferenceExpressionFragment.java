 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PropertyReferenceExpressionFragment.eti;PropertyReferenceExpressionFragment.eix;PropertyReferenceExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PropertyReferenceExpressionFragment")
public class PropertyReferenceExpressionFragment extends entity.ExpressionFragment {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PropertyReferenceExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PropertyReferenceExpressionFragment>("entity.PropertyReferenceExpressionFragment");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FULLPROPERTYDENORM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FullPropertyDenorm");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> GENERATEORIGINALVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "GenerateOriginalValue");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ROOTOBJECTEXPRESSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RootObjectExpression");
   ...
   */
  public PropertyReferenceExpressionFragment()  {
   ...
   */
  public PropertyReferenceExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PropertyReferenceExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternal)super.__getInternalInterface();
  }
  
  public java.lang.String getFullProperty() {
    return ((com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods")).getFullProperty();
  }
  ...
  public java.lang.String getFullPropertyDenorm() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FULLPROPERTYDENORM_PROP.get());
  }
  
  public gw.lang.reflect.IPropertyInfo getPropertyInfo() {
    return ((com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods")).getPropertyInfo();
  }
  ...
  public java.lang.String getRootObjectExpression() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ROOTOBJECTEXPRESSION_PROP.get());
  }
  ...
  public java.lang.Boolean isGenerateOriginalValue() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(GENERATEORIGINALVALUE_PROP.get());
  }
  
  /**
   * Sets the value of the FullPropertyDenorm field.
   */
  private void setFullPropertyDenorm(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FULLPROPERTYDENORM_PROP.get(), value);
  }
  ...
  public void setGenerateOriginalValue(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(GENERATEORIGINALVALUE_PROP.get(), value);
  }
  
  /**
   * Sets the value of the PropertyName field.
   */
  private void setPropertyName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(PROPERTYNAME_PROP.get(), value);
  }
  
  public void setPropertyNameAndDenorm(java.lang.String arg0) {
    ((com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods")).setPropertyNameAndDenorm(arg0);
  }
  
  /**
   * Sets the value of the RootObjectExpression field.
   */
  private void setRootObjectExpression(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ROOTOBJECTEXPRESSION_PROP.get(), value);
  }
  
  public void setRootObjectExpressionAndDenorm(java.lang.String arg0) {
    ((com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods")).setRootObjectExpressionAndDenorm(arg0);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PropertyReferenceExpressionFragment.this.__getDelegateManager();
    }
    ...
    public void setPropertyInfo(gw.lang.reflect.IPropertyInfo arg0) {
      ((com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentInternalMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentInternalMethods")).setPropertyInfo(arg0);
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.PropertyReferenceExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentInternalMethods", "com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.PropertyReferenceExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PropertyReferenceExpressionFragment.class, config);
    com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PropertyReferenceExpressionFragment, com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.PropertyReferenceExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PropertyReferenceExpressionFragmentInternal getInternalInterface(entity.PropertyReferenceExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PropertyReferenceExpressionFragment newEmptyInstance() {
        return new entity.PropertyReferenceExpressionFragment((java.lang.Void)null);
      }
