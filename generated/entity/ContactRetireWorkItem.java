...
/**
 * ContactRetireWorkItem
 * Queue of Contacts which should be checked to see if they can be retired. Work items are recorded as the ID value of (ClaimCenter) Contact entities. This is a system-internal entity.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ContactRetireWorkItem.eti;ContactRetireWorkItem.eix;ContactRetireWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ContactRetireWorkItem")
public class ContactRetireWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ContactRetireWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ContactRetireWorkItem>("entity.ContactRetireWorkItem");
  ...
  private com.guidewire._generated.entity.ContactRetireWorkItemInternal _internal;
   ...
   */
  public ContactRetireWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ContactRetireWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContactRetireWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContactRetireWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   * The public ID of the Contact we want to retire.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContactRetireWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContactRetireWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.contact.entity.ContactRetireWorkItem", "com.guidewire.cc.domain.contact.impl.ContactRetireWorkItemImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContactRetireWorkItem.class, config);
    com.guidewire._generated.entity.ContactRetireWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContactRetireWorkItem, com.guidewire._generated.entity.ContactRetireWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.ContactRetireWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContactRetireWorkItemInternal getInternalInterface(entity.ContactRetireWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContactRetireWorkItem newEmptyInstance() {
        return new entity.ContactRetireWorkItem((java.lang.Void)null);
      }
