 ...
 * Report of an incident involving a fixed property - usually a building
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FixedPropertyIncident.eti;FixedPropertyIncident.eix;FixedPropertyIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FixedPropertyIncident")
public class FixedPropertyIncident extends entity.PropertyIncident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FixedPropertyIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FixedPropertyIncident>("entity.FixedPropertyIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ALARMTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "AlarmType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CLASSTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ClassType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> EXTWALLMAT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ExtWallMat");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FIREPROTDETAILS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FireProtDetails");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> HAZARDINVOLVED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "HazardInvolved");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LOSSAREA_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LossArea");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> MOLDINVOLVED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "MoldInvolved");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMSPRINKOPER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumSprinkOper");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMSPRINKLER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumSprinkler");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> OCCUPANCYTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "OccupancyType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PROPERTY_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Property");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ROOFMATERIAL_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RoofMaterial");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SPRINKRETSERV_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SprinkRetServ");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> SPRINKLERTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "SprinklerType");
   ...
   */
  public FixedPropertyIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FixedPropertyIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.FixedPropertyIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FixedPropertyIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.FixedPropertyIncidentInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FixedPropertyIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FixedPropertyIncident.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.FixedPropertyIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.FixedPropertyIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.FixedPropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.FixedPropertyIncidentClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.FixedPropertyIncidentCoverageSupplier");
    config.put("gw.cc.exposure.entity.FixedPropertyIncident", "com.guidewire.cc.domain.exposure.impl.FixedPropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.FixedPropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.FixedPropertyIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FixedPropertyIncident.class, config);
    com.guidewire._generated.entity.FixedPropertyIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FixedPropertyIncident, com.guidewire._generated.entity.FixedPropertyIncidentInternal>() {
      public java.lang.Object getImplementation(entity.FixedPropertyIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FixedPropertyIncidentInternal getInternalInterface(entity.FixedPropertyIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FixedPropertyIncident newEmptyInstance() {
        return new entity.FixedPropertyIncident((java.lang.Void)null);
      }
