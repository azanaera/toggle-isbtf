...
/**
 * ExposureAssignmentView
 * Exposure view entity with assignment detail attributes.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureAssignmentView.eti;ExposureAssignmentView.eix;ExposureAssignmentView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExposureAssignmentView")
public class ExposureAssignmentView extends entity.ExposureDesktopView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureAssignmentView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureAssignmentView>("entity.ExposureAssignmentView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ASSIGNEDQUEUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AssignedQueue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ASSIGNEDUSER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AssignedUser");
   ...
   */
  public ExposureAssignmentView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExposureAssignmentView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ExposureAssignmentViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExposureAssignmentViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ExposureAssignmentViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExposureAssignmentViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExposureAssignmentView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.ExposureAbstractView", "com.guidewire.cc.domain.exposure.impl.ExposureAssignmentViewImpl");
    config.put("gw.cc.exposure.entity.ExposureAssignmentView", "com.guidewire.cc.domain.exposure.impl.ExposureAssignmentViewImpl");
    config.put("gw.cc.exposure.entity.ExposureDesktopView", "com.guidewire.cc.domain.exposure.impl.ExposureAssignmentViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExposureAssignmentView.class, config);
    com.guidewire._generated.entity.ExposureAssignmentViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExposureAssignmentView, com.guidewire._generated.entity.ExposureAssignmentViewInternal>() {
      public java.lang.Object getImplementation(entity.ExposureAssignmentView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureAssignmentViewInternal getInternalInterface(entity.ExposureAssignmentView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExposureAssignmentView newEmptyInstance() {
        return new entity.ExposureAssignmentView((java.lang.Void)null);
      }
