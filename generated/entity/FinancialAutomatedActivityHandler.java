...
/**
 * FinancialAutomatedActivityHandler
 * 
 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FinancialAutomatedActivityHandler.eti;FinancialAutomatedActivityHandler.eix;FinancialAutomatedActivityHandler.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FinancialAutomatedActivityHandler")
public class FinancialAutomatedActivityHandler extends entity.AutomatedActivityHandler implements gw.api.specialhandling.AutomatedHandlerMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FinancialAutomatedActivityHandler> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FinancialAutomatedActivityHandler>("entity.FinancialAutomatedActivityHandler");
   ...
   */
  public FinancialAutomatedActivityHandler()  {
   ...
   */
  public FinancialAutomatedActivityHandler(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FinancialAutomatedActivityHandler(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FinancialAutomatedActivityHandler.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.specialhandling.AutomatedHandlerMethods", "gw.specialhandling.FinancialAutomatedActivityHandlerMethodsImpl");
    config.put("gw.cc.specialhandling.entity.AutomatedActivityHandler", "com.guidewire.cc.domain.specialhandling.impl.FinancialAutomatedActivityHandlerImpl");
    config.put("gw.cc.specialhandling.entity.AutomatedHandler", "com.guidewire.cc.domain.specialhandling.impl.FinancialAutomatedActivityHandlerImpl");
    config.put("gw.cc.specialhandling.entity.FinancialAutomatedActivityHandler", "com.guidewire.cc.domain.specialhandling.impl.FinancialAutomatedActivityHandlerImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FinancialAutomatedActivityHandler.class, config);
    com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FinancialAutomatedActivityHandler, com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternal>() {
      public java.lang.Object getImplementation(entity.FinancialAutomatedActivityHandler bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FinancialAutomatedActivityHandlerInternal getInternalInterface(entity.FinancialAutomatedActivityHandler bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FinancialAutomatedActivityHandler newEmptyInstance() {
        return new entity.FinancialAutomatedActivityHandler((java.lang.Void)null);
      }
