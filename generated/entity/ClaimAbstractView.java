 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimAbstractView.eti;ClaimAbstractView.eix;ClaimAbstractView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimAbstractView")
public class ClaimAbstractView extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimAbstractView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimAbstractView>("entity.ClaimAbstractView");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMANTDENORM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimantDenorm");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> INSURED_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Insured");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INSUREDDENORM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InsuredDenorm");
  ...
  private com.guidewire._generated.entity.ClaimAbstractViewInternal _internal;
   ...
   */
  public ClaimAbstractView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimAbstractView(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ClaimAbstractViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimAbstractViewInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ClaimAbstractView value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimAbstractViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimAbstractView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.ClaimAbstractView", "com.guidewire.cc.domain.claim.impl.ClaimAbstractViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimAbstractView.class, config);
    com.guidewire._generated.entity.ClaimAbstractViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimAbstractView, com.guidewire._generated.entity.ClaimAbstractViewInternal>() {
      public java.lang.Object getImplementation(entity.ClaimAbstractView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimAbstractViewInternal getInternalInterface(entity.ClaimAbstractView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimAbstractView newEmptyInstance() {
        return new entity.ClaimAbstractView((java.lang.Void)null);
      }
