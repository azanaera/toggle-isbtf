 ...
 *   
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Vehicle.eti;Vehicle.eix;Vehicle.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Vehicle")
public class Vehicle extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BUSINESSUSE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BusinessUse_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EFFECTIVEDATE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EffectiveDate_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EXPIRATIONDATE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ExpirationDate_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RIDESHAREUSE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RideshareUse_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VEHICLESTATUS_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VehicleStatus_Ext");
  ...
  /**
   * Gets the value of the EffectiveDate_Ext field.
   * This is the effective date of the related vehicle on the policy and the information is expected to come from the Policy Search integration. 
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getEffectiveDate_Ext() {
    return (java.util.Date)__getInternalInterface().getFieldValue(EFFECTIVEDATE_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the ExpirationDate_Ext field.
   * This is the expiration date of the related vehicle on the policy and the information is expected to come from the Policy Search integration. 
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getExpirationDate_Ext() {
    return (java.util.Date)__getInternalInterface().getFieldValue(EXPIRATIONDATE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the VehicleStatus_Ext field.
   * This is the status of the vehicle and the information is expected to come from the Policy Search integration. 
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.PolicyStatus getVehicleStatus_Ext() {
    return (typekey.PolicyStatus)__getInternalInterface().getFieldValue(VEHICLESTATUS_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the BusinessUse_Ext field.
   * Indicates if the vehicle is used for Business from Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isBusinessUse_Ext() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(BUSINESSUSE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the RideshareUse_Ext field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isRideshareUse_Ext() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(RIDESHAREUSE_EXT_PROP.get());
  }
  ...
  /**
   * Sets the value of the BusinessUse_Ext field.
   */
  public void setBusinessUse_Ext(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(BUSINESSUSE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the EffectiveDate_Ext field.
   */
  public void setEffectiveDate_Ext(java.util.Date value) {
    __getInternalInterface().setFieldValue(EFFECTIVEDATE_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ExpirationDate_Ext field.
   */
  public void setExpirationDate_Ext(java.util.Date value) {
    __getInternalInterface().setFieldValue(EXPIRATIONDATE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the RideshareUse_Ext field.
   */
  public void setRideshareUse_Ext(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(RIDESHAREUSE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the VehicleStatus_Ext field.
   */
  public void setVehicleStatus_Ext(typekey.PolicyStatus value) {
    __getInternalInterface().setFieldValue(VEHICLESTATUS_EXT_PROP.get(), value);
  }
