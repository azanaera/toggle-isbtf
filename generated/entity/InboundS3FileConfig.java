 ...
 * InboundS3FileConfig
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InboundS3FileConfig.eti;InboundS3FileConfig.eix;InboundS3FileConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "InboundS3FileConfig")
public class InboundS3FileConfig extends entity.InboundFileConfig implements com.guidewire.inboundfile.config.InboundFileConfigMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InboundS3FileConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InboundS3FileConfig>("entity.InboundS3FileConfig");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVES3BUCKET_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchiveS3Bucket");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVES3PREFIX_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchiveS3Prefix");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INPUTS3BUCKET_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InputS3Bucket");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INPUTS3PREFIX_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InputS3Prefix");
   ...
   */
  public InboundS3FileConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InboundS3FileConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.InboundS3FileConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InboundS3FileConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.InboundS3FileConfigInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getArchiveS3Bucket() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ARCHIVES3BUCKET_PROP.get());
  }
  ...
  public java.lang.String getArchiveS3Prefix() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ARCHIVES3PREFIX_PROP.get());
  }
  ...
  public java.lang.String getInputS3Bucket() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INPUTS3BUCKET_PROP.get());
  }
  ...
  public java.lang.String getInputS3Prefix() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INPUTS3PREFIX_PROP.get());
  }
  ...
  public void setArchiveS3Bucket(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ARCHIVES3BUCKET_PROP.get(), value);
  }
  ...
  public void setArchiveS3Prefix(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ARCHIVES3PREFIX_PROP.get(), value);
  }
  ...
  public void setInputS3Bucket(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INPUTS3BUCKET_PROP.get(), value);
  }
  ...
  public void setInputS3Prefix(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INPUTS3PREFIX_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InboundS3FileConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InboundS3FileConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.inboundfile.config.InboundFileConfigMethods", "com.guidewire.inboundfile.config.InboundFileS3ConfigImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InboundS3FileConfig.class, config);
    com.guidewire._generated.entity.InboundS3FileConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InboundS3FileConfig, com.guidewire._generated.entity.InboundS3FileConfigInternal>() {
      public java.lang.Object getImplementation(entity.InboundS3FileConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InboundS3FileConfigInternal getInternalInterface(entity.InboundS3FileConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InboundS3FileConfig newEmptyInstance() {
        return new entity.InboundS3FileConfig((java.lang.Void)null);
      }
