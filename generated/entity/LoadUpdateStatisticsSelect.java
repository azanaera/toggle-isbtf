...
/**
 * LoadUpdateStatisticsSelect
 * Timed loader update statistics selects.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LoadUpdateStatisticsSelect.eti;LoadUpdateStatisticsSelect.eix;LoadUpdateStatisticsSelect.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LoadUpdateStatisticsSelect")
public class LoadUpdateStatisticsSelect extends com.guidewire.pl.persistence.code.BeanBase implements entity.TimedLoaderObject, entity.OrdereddLoaderObject, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LoadUpdateStatisticsSelect> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LoadUpdateStatisticsSelect>("entity.LoadUpdateStatisticsSelect");
  ...
  private com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternal _internal;
   ...
   */
  public LoadUpdateStatisticsSelect(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LoadUpdateStatisticsSelect(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LoadUpdateStatisticsSelect.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LoadUpdateStatisticsSelect.class, config);
    com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LoadUpdateStatisticsSelect, com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternal>() {
      public java.lang.Object getImplementation(entity.LoadUpdateStatisticsSelect bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LoadUpdateStatisticsSelectInternal getInternalInterface(entity.LoadUpdateStatisticsSelect bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LoadUpdateStatisticsSelect newEmptyInstance() {
        return new entity.LoadUpdateStatisticsSelect((java.lang.Void)null);
      }
