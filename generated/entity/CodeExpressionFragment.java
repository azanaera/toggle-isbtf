 ...
 * ExpressionFragment for arbitrary code expression
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CodeExpressionFragment.eti;CodeExpressionFragment.eix;CodeExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CodeExpressionFragment")
public class CodeExpressionFragment extends entity.ExpressionFragment {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CodeExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CodeExpressionFragment>("entity.CodeExpressionFragment");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CODETEXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CodeText");
   ...
   */
  public CodeExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CodeExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CodeExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CodeExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CodeExpressionFragmentInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the CodeText field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getCodeText() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CODETEXT_PROP.get());
  }
  
  /**
   * Sets the value of the CodeText field.
   */
  public void setCodeText(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CODETEXT_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CodeExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CodeExpressionFragment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.CodeExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.CodeExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.CodeExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.CodeExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CodeExpressionFragment.class, config);
    com.guidewire._generated.entity.CodeExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CodeExpressionFragment, com.guidewire._generated.entity.CodeExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.CodeExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CodeExpressionFragmentInternal getInternalInterface(entity.CodeExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CodeExpressionFragment newEmptyInstance() {
        return new entity.CodeExpressionFragment((java.lang.Void)null);
      }
