 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Policy.eti;Policy.eix;Policy.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Policy")
public class Policy extends com.guidewire.pl.persistence.code.BeanBase implements entity.Validatable, entity.Extractable, entity.ClaimContactRoleOwner, entity.Retireable, entity.EventAware {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CREATEDAT_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CreatedAt_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EDITION_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Edition_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FORMNUMBER_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FormNumber_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> POLICYSTATE_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "PolicyState_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RENEWALCADENCE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RenewalCadence_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SUREPOLICYSYSTEMPERIODID_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SurePolicySystemPeriodID_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TERM_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Term_Ext");
  ...
  /**
   * Gets the value of the CreatedAt_Ext field.
   * The Datetime the policy was created at in Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getCreatedAt_Ext() {
    return (java.util.Date)__getInternalInterface().getFieldValue(CREATEDAT_EXT_PROP.get());
  }
   ...
   * Edition Number from the sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getEdition_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EDITION_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the FormNumber_Ext field.
   * The form number from the sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getFormNumber_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FORMNUMBER_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the PolicyState_Ext field.
   * The policy state from the sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.State getPolicyState_Ext() {
    return (typekey.State)__getInternalInterface().getFieldValue(POLICYSTATE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the RenewalCadence_Ext field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getRenewalCadence_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(RENEWALCADENCE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the SurePolicySystemPeriodID_Ext field.
   * The policy ID string sent from Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getSurePolicySystemPeriodID_Ext() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SUREPOLICYSYSTEMPERIODID_EXT_PROP.get());
  }
  
  /**
   * Gets the value of the Term_Ext field.
   * Term Number of policy from Sure System
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Integer getTerm_Ext() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(TERM_EXT_PROP.get());
  }
  ...
  /**
   * Sets the value of the CreatedAt_Ext field.
   */
  public void setCreatedAt_Ext(java.util.Date value) {
    __getInternalInterface().setFieldValue(CREATEDAT_EXT_PROP.get(), value);
  }
  ...
  public void setEdition_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EDITION_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the FormNumber_Ext field.
   */
  public void setFormNumber_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FORMNUMBER_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the PolicyState_Ext field.
   */
  public void setPolicyState_Ext(typekey.State value) {
    __getInternalInterface().setFieldValue(POLICYSTATE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the RenewalCadence_Ext field.
   */
  public void setRenewalCadence_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(RENEWALCADENCE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the SurePolicySystemPeriodID_Ext field.
   */
  public void setSurePolicySystemPeriodID_Ext(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SUREPOLICYSYSTEMPERIODID_EXT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Term_Ext field.
   */
  public void setTerm_Ext(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(TERM_EXT_PROP.get(), value);
  }
