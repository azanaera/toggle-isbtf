 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ArchiveWorkItem.eti;ArchiveWorkItem.eix;ArchiveWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ArchiveWorkItem")
public class ArchiveWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ArchiveWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ArchiveWorkItem>("entity.ArchiveWorkItem");
  ...
  private com.guidewire._generated.entity.ArchiveWorkItemInternal _internal;
   ...
   */
  public ArchiveWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ArchiveWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ArchiveWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ArchiveWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ArchiveWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ArchiveWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ArchiveWorkItem.class, config);
    com.guidewire._generated.entity.ArchiveWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ArchiveWorkItem, com.guidewire._generated.entity.ArchiveWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.ArchiveWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ArchiveWorkItemInternal getInternalInterface(entity.ArchiveWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ArchiveWorkItem newEmptyInstance() {
        return new entity.ArchiveWorkItem((java.lang.Void)null);
      }
