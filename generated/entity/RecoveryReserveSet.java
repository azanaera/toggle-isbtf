...
/**
 * RecoveryReserveSet
 * A TransactionSet of one or more RecoveryReserves created and submitted together for approval.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RecoveryReserveSet.eti;RecoveryReserveSet.eix;RecoveryReserveSet.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RecoveryReserveSet")
public class RecoveryReserveSet extends entity.TransactionSet {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RecoveryReserveSet> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RecoveryReserveSet>("entity.RecoveryReserveSet");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RECOVERYRESERVES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RecoveryReserves");
   ...
   */
  public RecoveryReserveSet(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RecoveryReserveSet(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RecoveryReserveSetInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RecoveryReserveSetInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RecoveryReserveSetInternal)super.__getInternalInterface();
  }
  ...
  public void addToRecoveryReserves(entity.RecoveryReserve element) {
    __getInternalInterface().addArrayElement(RECOVERYRESERVES_PROP.get(), element);
  }
  ...
  public entity.RecoveryReserve[] getRecoveryReserves() {
    return (entity.RecoveryReserve[])__getInternalInterface().getFieldValue(RECOVERYRESERVES_PROP.get());
  }
  
  /**
   * Creates a new RecoveryReserve with a status of draft, adds it to this RecoveryReserveSet and returns it. The
   * ReserveLine of this new RecoveryReserve is specified by the provided Exposure, CostType, CostCategory and
   * ReservingCurrency. A NULL Exposure indicates that this is a claim-level RecoveryReserve. Also, the Transaction
   * Currency of the new RecoveryReserve will be set to the same as Reserving Currency (or Claim Currency, if Reserving
   * Currency is null).
   * @param exposure The Exposure of this new RecoveryReserve - can be NULL, in which case this will be a
   *                 claim-level Transaction
   * @param costType The CostType of this new RecoveryReserve - cannot be NULL.
   * @param costCategory the CostCategory of this new RecoveryReserve - cannot be NULL.
   * @param recoveryCategory the RecoveryCategory of this new RecoveryReserve - cannot be NULL.
   * @param reservingCurrency The Reserving Currency of this new RecoveryReserve - can be NULL (defaults to Claim Currency).
   * @return the new RecoveryReserve.
   */
  public entity.RecoveryReserve newRecoveryReserve(entity.Exposure exposure, typekey.CostType costType, typekey.CostCategory costCategory, typekey.RecoveryCategory recoveryCategory, typekey.Currency reservingCurrency) {
    return ((gw.cc.financials.recovery.entity.RecoveryReserveSet)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.RecoveryReserveSet")).newRecoveryReserve(exposure, costType, costCategory, recoveryCategory, reservingCurrency);
  }
  
  /**
   * This method must be called on a new RecoveryReserveSet before the database commit occurs.
   * 
   * Calls Presetup Rules on the RecoveryReserveSet, then submits it for approval.
   * Also, ensures that each transaction in the RecoveryReserveSet has an associated ReserveLine.
   * @throws IllegalStateException if the RecoveryReserveSet has a transaction whose status
   *                                                    is not valid for the action being performed.
   * @throws RecoveryReservesNotAllowedException if the system is not configured to allow recovery reserves,
   *                                                    i.e., the 'UseRecoveryReserves' parameter is false.
   */
  public gw.plugin.approval.ApprovalResult prepareForCommit() throws com.guidewire.cc.system.exception.RecoveryReservesNotAllowedException {
    return ((gw.cc.financials.recovery.entity.RecoveryReserveSet)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.RecoveryReserveSet")).prepareForCommit();
  }
  ...
  public void removeFromRecoveryReserves(entity.RecoveryReserve element) {
    __getInternalInterface().removeArrayElement(RECOVERYRESERVES_PROP.get(), element);
  }
  ...
  public void removeFromRecoveryReserves(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(RECOVERYRESERVES_PROP.get(), elementID);
  }
  ...
  public void setRecoveryReserves(entity.RecoveryReserve[] value) {
    __getInternalInterface().setFieldValue(RECOVERYRESERVES_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RecoveryReserveSetInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RecoveryReserveSet.this.__getDelegateManager();
    }
    ...
    public typekey.CreatedVia getCreatedVia() {
      return (typekey.CreatedVia)__getInternalInterface().getFieldValue(CREATEDVIA_PROP.get());
    }
    ...
    public entity.RecoveryReserve newTransaction(entity.Exposure exposure, typekey.CostType costType, typekey.CostCategory costCategory, typekey.RecoveryCategory recoveryCategory, typekey.Currency reservingCurrency, boolean setReserveLine) {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetInternal")).newTransaction(exposure, costType, costCategory, recoveryCategory, reservingCurrency, setReserveLine);
    }
    ...
    public gw.plugin.approval.ApprovalResult prepareForSave(boolean runPreSetupRules) throws com.guidewire.pl.system.exception.InsufficientAuthorityException, com.guidewire.pl.system.exception.InsufficientPermissionException, com.guidewire.cc.system.exception.MultipleLineItemsNotAllowedException, com.guidewire.cc.system.exception.NegativeCalculationException, com.guidewire.cc.system.exception.RecoveryReservesNotAllowedException {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetInternal")).prepareForSave(runPreSetupRules);
    }
    ...
    public void setCreatedVia(typekey.CreatedVia value) {
      __getInternalInterface().setFieldValue(CREATEDVIA_PROP.get(), value);
    }
    ...
    public void verifyVersionIsNotReadOnly() {
      ((com.guidewire.cc.domain.financials.impl.TransactionSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.impl.TransactionSetInternal")).verifyVersionIsNotReadOnly();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.impl.TransactionSetInternal", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetInternal", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("com.guidewire.commons.entity.Keyable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.commons.entity.Sourceable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.pl.domain.approval.impl.ApprovableInternalMethods", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    ...
    config.put("com.guidewire.pl.domain.validation.ValidatablePublicMethods", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("com.guidewire.pl.domain.validation.impl.ValidatableInternalMethods", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("com.guidewire.pl.persistence.core.BeanMethods", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("gw.cc.financials.entity.TransactionSet", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("gw.cc.financials.recovery.entity.RecoveryReserveSet", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryReserveSetImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RecoveryReserveSet.class, config);
    com.guidewire._generated.entity.RecoveryReserveSetInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RecoveryReserveSet, com.guidewire._generated.entity.RecoveryReserveSetInternal>() {
      public java.lang.Object getImplementation(entity.RecoveryReserveSet bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RecoveryReserveSetInternal getInternalInterface(entity.RecoveryReserveSet bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RecoveryReserveSet newEmptyInstance() {
        return new entity.RecoveryReserveSet((java.lang.Void)null);
      }
