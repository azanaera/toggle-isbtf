...
/**
 * GosuServletProfilerConfig
 * Profiler configuration for a gosu servlet
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GosuServletProfilerConfig.eti;GosuServletProfilerConfig.eix;GosuServletProfilerConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GosuServletProfilerConfig")
public class GosuServletProfilerConfig extends entity.ProfilerConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GosuServletProfilerConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GosuServletProfilerConfig>("entity.GosuServletProfilerConfig");
   ...
   */
  public GosuServletProfilerConfig()  {
   ...
   */
  public GosuServletProfilerConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GosuServletProfilerConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GosuServletProfilerConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GosuServletProfilerConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GosuServletProfilerConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GosuServletProfilerConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GosuServletProfilerConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GosuServletProfilerConfig.class, config);
    com.guidewire._generated.entity.GosuServletProfilerConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GosuServletProfilerConfig, com.guidewire._generated.entity.GosuServletProfilerConfigInternal>() {
      public java.lang.Object getImplementation(entity.GosuServletProfilerConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GosuServletProfilerConfigInternal getInternalInterface(entity.GosuServletProfilerConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GosuServletProfilerConfig newEmptyInstance() {
        return new entity.GosuServletProfilerConfig((java.lang.Void)null);
      }
