 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Adjudicator.eti;Adjudicator.eix;Adjudicator.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Adjudicator")
public class Adjudicator extends entity.Person {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Adjudicator> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Adjudicator>("entity.Adjudicator");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ADJUDICATORLICENSE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AdjudicatorLicense");
   ...
   */
  public Adjudicator(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Adjudicator(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AdjudicatorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AdjudicatorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AdjudicatorInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getAdjudicatorLicense() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ADJUDICATORLICENSE_PROP.get());
  }
  ...
  public void setAdjudicatorLicense(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ADJUDICATORLICENSE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AdjudicatorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Adjudicator.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Adjudicator.class, config);
    com.guidewire._generated.entity.AdjudicatorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Adjudicator, com.guidewire._generated.entity.AdjudicatorInternal>() {
      public java.lang.Object getImplementation(entity.Adjudicator bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AdjudicatorInternal getInternalInterface(entity.Adjudicator bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Adjudicator newEmptyInstance() {
        return new entity.Adjudicator((java.lang.Void)null);
      }
