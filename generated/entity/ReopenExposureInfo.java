 ...
 * ReopenExposureInfo
 * 
 *       Holds transitional internal state information during the reopen exposure
 *       operation. This is an internal, virtual entity, the system does not store it.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReopenExposureInfo.eti;ReopenExposureInfo.eix;ReopenExposureInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReopenExposureInfo")
public class ReopenExposureInfo extends entity.ExpCloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReopenExposureInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReopenExposureInfo>("entity.ReopenExposureInfo");
   ...
   */
  public ReopenExposureInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReopenExposureInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ReopenExposureInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReopenExposureInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ReopenExposureInfoInternal)super.__getInternalInterface();
  }
  ...
  public typekey.ExposureReopenedReason getreopenReason() {
    return (typekey.ExposureReopenedReason)__getInternalInterface().getFieldValue(REOPENREASON_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReopenExposureInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReopenExposureInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.exposure.impl.ReopenExposureInfoImpl");
    config.put("gw.cc.exposure.entity.ExpCloseReopenInfo", "com.guidewire.cc.domain.exposure.impl.ReopenExposureInfoImpl");
    config.put("gw.cc.exposure.entity.ReopenExposureInfo", "com.guidewire.cc.domain.exposure.impl.ReopenExposureInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReopenExposureInfo.class, config);
    com.guidewire._generated.entity.ReopenExposureInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReopenExposureInfo, com.guidewire._generated.entity.ReopenExposureInfoInternal>() {
      public java.lang.Object getImplementation(entity.ReopenExposureInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReopenExposureInfoInternal getInternalInterface(entity.ReopenExposureInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReopenExposureInfo newEmptyInstance() {
        return new entity.ReopenExposureInfo((java.lang.Void)null);
      }
