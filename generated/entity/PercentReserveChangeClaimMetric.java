...
/**
 * PercentReserveChangeClaimMetric
 * % of Reserve Change from Initial Reserve
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PercentReserveChangeClaimMetric.eti;PercentReserveChangeClaimMetric.eix;PercentReserveChangeClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PercentReserveChangeClaimMetric")
public class PercentReserveChangeClaimMetric extends entity.PercentClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PercentReserveChangeClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PercentReserveChangeClaimMetric>("entity.PercentReserveChangeClaimMetric");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INITIALRESERVE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InitialReserve");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TOTALRESERVECHANGE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TotalReserveChange");
   ...
   */
  public PercentReserveChangeClaimMetric()  {
   ...
   */
  public PercentReserveChangeClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PercentReserveChangeClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternal)super.__getInternalInterface();
  }
  ...
  public java.math.BigDecimal getInitialReserve() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(INITIALRESERVE_PROP.get());
  }
  ...
  public java.math.BigDecimal getTotalReserveChange() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(TOTALRESERVECHANGE_PROP.get());
  }
  ...
  public void setInitialReserve(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(INITIALRESERVE_PROP.get(), value);
  }
  ...
  public void setTotalReserveChange(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(TOTALRESERVECHANGE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PercentReserveChangeClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.financials.PercentReserveChangeClaimMetricMethodsImpl");
    config.put("gw.cc.claim.metric.entity.ClaimMetric", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricImpl");
    config.put("gw.cc.claim.metric.entity.PercentClaimMetric", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PercentReserveChangeClaimMetric.class, config);
    com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PercentReserveChangeClaimMetric, com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.PercentReserveChangeClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PercentReserveChangeClaimMetricInternal getInternalInterface(entity.PercentReserveChangeClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PercentReserveChangeClaimMetric newEmptyInstance() {
        return new entity.PercentReserveChangeClaimMetric((java.lang.Void)null);
      }
