 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Reserve.eti;Reserve.eix;Reserve.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Reserve")
public class Reserve extends entity.Transaction implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Reserve> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Reserve>("entity.Reserve");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> OFFSETPAYMENTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "OffsetPayments");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final java.lang.String RESERVEADDED_EVENT = "ReserveAdded";
  
  public static final java.lang.String RESERVECHANGED_EVENT = "ReserveChanged";
  
  public static final java.lang.String RESERVEREMOVED_EVENT = "ReserveRemoved";
  
  public static final java.lang.String RESERVESTATUSCHANGED_EVENT = "ReserveStatusChanged";
  
  public static final java.lang.String RESERVESUBMITTED_EVENT = "ReserveSubmitted";
   ...
   */
  public Reserve(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Reserve(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ReserveInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReserveInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ReserveInternal)super.__getInternalInterface();
  }
  
  /**
   * Retrieves all Reserves from this reserve's TransactionSet, regardless of whether the reserves are part of a ReserveSet,
   * or if they are instead associated with a CheckSet (as CheckSetReserves).
   * @return an array of Reserves
   */
  public entity.Reserve[] getGroupedReserves() {
    return ((gw.cc.financials.reserve.entity.Reserve)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.Reserve")).getGroupedReserves();
  }
  
  /**
   * If this Reserve exists to offset a payment directly, because the payment exceeds reserves, this method
   * returns the payment being offset.  If no such payment exists, this method returns NULL.
   * @return the Payment being offset by this Reserve, if any.
   */
  public entity.Payment getOffsetPayment() {
    return ((gw.cc.financials.reserve.entity.Reserve)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.Reserve")).getOffsetPayment();
  }
  ...
  public entity.PaymentReserve[] getOffsetPayments() {
    return (entity.PaymentReserve[])__getInternalInterface().getFieldValue(OFFSETPAYMENTS_PROP.get());
  }
  
  /**
   * Returns whether this reserve is a zeroing offset, i.e. if its offset payment is not null.
   * @return true if this reserve is a zeroing offset
   */
  public boolean isZeroingOffset() {
    return ((gw.cc.financials.reserve.entity.Reserve)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.Reserve")).isZeroingOffset();
  }
  
  /**
   * Sets the value of the OffsetPayments field.
   */
  private void setOffsetPayments(entity.PaymentReserve[] value) {
    __getInternalInterface().setFieldValue(OFFSETPAYMENTS_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReserveInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Reserve.this.__getDelegateManager();
    }
    ...
    public void addToOffsetPayments(entity.PaymentReserve element) {
      __getInternalInterface().addArrayElement(OFFSETPAYMENTS_PROP.get(), element);
    }
    ...
    public void removeFromOffsetPayments(entity.PaymentReserve element) {
      __getInternalInterface().removeArrayElement(OFFSETPAYMENTS_PROP.get(), element);
    }
    ...
    public void removeFromOffsetPayments(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(OFFSETPAYMENTS_PROP.get(), elementID);
    }
    ...
    public void verifyExposureNotClosed() throws com.guidewire.cc.system.exception.ClosedExposureException {
      ((com.guidewire.cc.domain.financials.reserve.impl.ReserveInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.reserve.impl.ReserveInternal")).verifyExposureNotClosed();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.impl.TransactionInternal", "com.guidewire.cc.domain.financials.reserve.impl.ReserveImpl");
    config.put("com.guidewire.cc.domain.financials.reserve.impl.ReserveInternal", "com.guidewire.cc.domain.financials.reserve.impl.ReserveImpl");
    ...
    config.put("com.guidewire.cc.domain.financials.taccount.impl.TransactionTAccountOperationsDelegateInternal", "com.guidewire.cc.domain.financials.reserve.impl.ReserveImpl");
    ...
    config.put("gw.cc.financials.entity.Transaction", "com.guidewire.cc.domain.financials.reserve.impl.ReserveImpl");
    config.put("gw.cc.financials.reserve.entity.Reserve", "com.guidewire.cc.domain.financials.reserve.impl.ReserveImpl");
    config.put("gw.cc.financials.taccount.entity.TransactionTAccountOperationsDelegate", "com.guidewire.cc.domain.financials.reserve.impl.ReserveImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Reserve.class, config);
    com.guidewire._generated.entity.ReserveInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Reserve, com.guidewire._generated.entity.ReserveInternal>() {
      public java.lang.Object getImplementation(entity.Reserve bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReserveInternal getInternalInterface(entity.Reserve bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Reserve newEmptyInstance() {
        return new entity.Reserve((java.lang.Void)null);
      }
