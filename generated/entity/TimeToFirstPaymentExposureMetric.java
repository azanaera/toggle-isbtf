...
/**
 * TimeToFirstPaymentExposureMetric
 * Time to First Payment
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TimeToFirstPaymentExposureMetric.eti;TimeToFirstPaymentExposureMetric.eix;TimeToFirstPaymentExposureMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TimeToFirstPaymentExposureMetric")
public class TimeToFirstPaymentExposureMetric extends entity.TimeBasedExposureMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TimeToFirstPaymentExposureMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TimeToFirstPaymentExposureMetric>("entity.TimeToFirstPaymentExposureMetric");
   ...
   */
  public TimeToFirstPaymentExposureMetric()  {
   ...
   */
  public TimeToFirstPaymentExposureMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TimeToFirstPaymentExposureMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TimeToFirstPaymentExposureMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.exposure.metric.financials.TimeToFirstPaymentExposureMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TimeToFirstPaymentExposureMetric.class, config);
    com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TimeToFirstPaymentExposureMetric, com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternal>() {
      public java.lang.Object getImplementation(entity.TimeToFirstPaymentExposureMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TimeToFirstPaymentExposureMetricInternal getInternalInterface(entity.TimeToFirstPaymentExposureMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TimeToFirstPaymentExposureMetric newEmptyInstance() {
        return new entity.TimeToFirstPaymentExposureMetric((java.lang.Void)null);
      }
