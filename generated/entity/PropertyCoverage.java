 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PropertyCoverage.eti;PropertyCoverage.eix;PropertyCoverage.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PropertyCoverage")
public class PropertyCoverage extends entity.RUCoverage {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PropertyCoverage> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PropertyCoverage>("entity.PropertyCoverage");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> COVERAGEBASIS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CoverageBasis");
   ...
   */
  public PropertyCoverage(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PropertyCoverage(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PropertyCoverageInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PropertyCoverageInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PropertyCoverageInternal)super.__getInternalInterface();
  }
  ...
  public java.math.BigDecimal getCoinsurance() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(COINSURANCE_PROP.get());
  }
  ...
  public typekey.CoverageBasis getCoverageBasis() {
    return (typekey.CoverageBasis)__getInternalInterface().getFieldValue(COVERAGEBASIS_PROP.get());
  }
  ...
  public void setCoverageBasis(typekey.CoverageBasis value) {
    __getInternalInterface().setFieldValue(COVERAGEBASIS_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PropertyCoverageInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PropertyCoverage.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.Coverage", "com.guidewire.cc.domain.policy.impl.PropertyCoverageImpl");
    config.put("gw.cc.policy.entity.PropertyCoverage", "com.guidewire.cc.domain.policy.impl.PropertyCoverageImpl");
    config.put("gw.cc.policy.entity.RUCoverage", "com.guidewire.cc.domain.policy.impl.PropertyCoverageImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PropertyCoverage.class, config);
    com.guidewire._generated.entity.PropertyCoverageInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PropertyCoverage, com.guidewire._generated.entity.PropertyCoverageInternal>() {
      public java.lang.Object getImplementation(entity.PropertyCoverage bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PropertyCoverageInternal getInternalInterface(entity.PropertyCoverage bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PropertyCoverage newEmptyInstance() {
        return new entity.PropertyCoverage((java.lang.Void)null);
      }
