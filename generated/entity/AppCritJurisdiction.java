...
/**
 * AppCritJurisdiction
 * Jurisdiction Applicability Criteria 
 */
...
@gw.entity.EntityName(value = "AppCritJurisdiction")
public class AppCritJurisdiction extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritJurisdiction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritJurisdiction>("entity.AppCritJurisdiction");
  ...
  private com.guidewire._generated.entity.AppCritJurisdictionInternal _internal;
   ...
   */
  public AppCritJurisdiction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritJurisdiction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritJurisdictionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritJurisdictionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritJurisdictionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritJurisdiction.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritJurisdictionImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritJurisdiction.class, config);
    com.guidewire._generated.entity.AppCritJurisdictionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritJurisdiction, com.guidewire._generated.entity.AppCritJurisdictionInternal>() {
      public java.lang.Object getImplementation(entity.AppCritJurisdiction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritJurisdictionInternal getInternalInterface(entity.AppCritJurisdiction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritJurisdiction newEmptyInstance() {
        return new entity.AppCritJurisdiction((java.lang.Void)null);
      }
