...
/**
 * ActivityDesktopView
 * <p>Aggregates the information needed to display one activity row in the activity desktop page (subtype of ActivityView).</p>
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ActivityDesktopView.eti;ActivityDesktopView.eix;ActivityDesktopView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ActivityDesktopView")
public class ActivityDesktopView extends entity.ActivityView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ActivityDesktopView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ActivityDesktopView>("entity.ActivityDesktopView");
  ...
  public static final gw.api.activity.PublicActivityDesktopViewFinder finder = gw.cc.activity.entity.ActivityDesktopView.finder;
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public ActivityDesktopView()  {
   ...
   */
  public ActivityDesktopView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ActivityDesktopView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ActivityDesktopViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ActivityDesktopViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ActivityDesktopViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ActivityDesktopViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ActivityDesktopView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.system.entity.PermissionAssignableCheck", "com.guidewire.cc.domain.activity.impl.ActivityDesktopViewImpl");
    config.put("gw.cc.activity.entity.ActivityDesktopView", "com.guidewire.cc.domain.activity.impl.ActivityDesktopViewImpl");
    config.put("gw.cc.activity.entity.ActivityView", "com.guidewire.cc.domain.activity.impl.ActivityDesktopViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ActivityDesktopView.class, config);
    com.guidewire._generated.entity.ActivityDesktopViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ActivityDesktopView, com.guidewire._generated.entity.ActivityDesktopViewInternal>() {
      public java.lang.Object getImplementation(entity.ActivityDesktopView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ActivityDesktopViewInternal getInternalInterface(entity.ActivityDesktopView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ActivityDesktopView newEmptyInstance() {
        return new entity.ActivityDesktopView((java.lang.Void)null);
      }
