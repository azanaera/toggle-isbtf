 ...
 * GeneralLiabilityRU
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GeneralLiabilityRU.eti;GeneralLiabilityRU.eix;GeneralLiabilityRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GeneralLiabilityRU")
public class GeneralLiabilityRU extends entity.LocationBasedRU {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GeneralLiabilityRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GeneralLiabilityRU>("entity.GeneralLiabilityRU");
   ...
   */
  public GeneralLiabilityRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GeneralLiabilityRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GeneralLiabilityRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GeneralLiabilityRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GeneralLiabilityRUInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GeneralLiabilityRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GeneralLiabilityRU.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.GeneralLiabilityRU", "com.guidewire.cc.domain.policy.impl.GeneralLiabilityRUImpl");
    config.put("gw.cc.policy.entity.LocationBasedRU", "com.guidewire.cc.domain.policy.impl.GeneralLiabilityRUImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.GeneralLiabilityRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GeneralLiabilityRU.class, config);
    com.guidewire._generated.entity.GeneralLiabilityRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GeneralLiabilityRU, com.guidewire._generated.entity.GeneralLiabilityRUInternal>() {
      public java.lang.Object getImplementation(entity.GeneralLiabilityRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GeneralLiabilityRUInternal getInternalInterface(entity.GeneralLiabilityRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GeneralLiabilityRU newEmptyInstance() {
        return new entity.GeneralLiabilityRU((java.lang.Void)null);
      }
