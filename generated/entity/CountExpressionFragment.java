 ...
 * Expression fragment representing a COUNT expression, which evaluates to the number of elements in a list which match a given condition
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CountExpressionFragment.eti;CountExpressionFragment.eix;CountExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CountExpressionFragment")
public class CountExpressionFragment extends entity.FilteredIterableExpressionFragment {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CountExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CountExpressionFragment>("entity.CountExpressionFragment");
   ...
   */
  public CountExpressionFragment()  {
   ...
   */
  public CountExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CountExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CountExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CountExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CountExpressionFragmentInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CountExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CountExpressionFragment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.FilteredIterableExpressionFragmentValidationMethods", "com.guidewire.bizrules.codegenerator.FilteredIterableExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.CountExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.domain.ConditionExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.FilteredIterableExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.FilteredIterableExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.FilteredIterableExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.FilteredIterableExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.FilteredIterableExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.FilteredIterableExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CountExpressionFragment.class, config);
    com.guidewire._generated.entity.CountExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CountExpressionFragment, com.guidewire._generated.entity.CountExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.CountExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CountExpressionFragmentInternal getInternalInterface(entity.CountExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CountExpressionFragment newEmptyInstance() {
        return new entity.CountExpressionFragment((java.lang.Void)null);
      }
