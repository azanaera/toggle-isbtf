 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AccountSpecialHandling.eti;AccountSpecialHandling.eix;AccountSpecialHandling.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AccountSpecialHandling")
public class AccountSpecialHandling extends entity.SpecialHandling {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AccountSpecialHandling> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AccountSpecialHandling>("entity.AccountSpecialHandling");
   ...
   */
  public AccountSpecialHandling(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AccountSpecialHandling(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AccountSpecialHandlingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AccountSpecialHandlingInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AccountSpecialHandlingInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AccountSpecialHandlingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AccountSpecialHandling.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.specialhandling.entity.AccountSpecialHandling", "com.guidewire.cc.domain.specialhandling.impl.AccountSpecialHandlingImpl");
    config.put("gw.cc.specialhandling.entity.SpecialHandling", "com.guidewire.cc.domain.specialhandling.impl.AccountSpecialHandlingImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AccountSpecialHandling.class, config);
    com.guidewire._generated.entity.AccountSpecialHandlingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AccountSpecialHandling, com.guidewire._generated.entity.AccountSpecialHandlingInternal>() {
      public java.lang.Object getImplementation(entity.AccountSpecialHandling bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AccountSpecialHandlingInternal getInternalInterface(entity.AccountSpecialHandling bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AccountSpecialHandling newEmptyInstance() {
        return new entity.AccountSpecialHandling((java.lang.Void)null);
      }
