...
/**
 * PercentClaimMetricLimit
 * Percent based claim metric limit.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PercentClaimMetricLimit.eti;PercentClaimMetricLimit.eix;PercentClaimMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PercentClaimMetricLimit")
public class PercentClaimMetricLimit extends entity.ClaimMetricLimit implements entity.PercentMetricLimitDelegate, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PercentClaimMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PercentClaimMetricLimit>("entity.PercentClaimMetricLimit");
   ...
   */
  public PercentClaimMetricLimit()  {
   ...
   */
  public PercentClaimMetricLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PercentClaimMetricLimit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PercentClaimMetricLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PercentClaimMetricLimitInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PercentClaimMetricLimitInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PercentClaimMetricLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PercentClaimMetricLimit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.metric.impl.ClaimMetricLimitInternal", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.CopyOnWriteMetricLimitDelegateInternal", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricLimitImpl");
    ...
    config.put("gw.api.metric.MetricLimit", "gw.api.claim.metric.PercentClaimMetricLimitMethodsImpl");
    config.put("gw.api.metric.MetricLimitMethods", "gw.api.claim.metric.PercentClaimMetricLimitMethodsImpl");
    config.put("gw.cc.claim.metric.entity.ClaimMetricLimit", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricLimitImpl");
    config.put("gw.cc.claim.metric.entity.PercentClaimMetricLimit", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricLimitImpl");
    config.put("gw.cc.metric.entity.CopyOnWriteMetricLimitDelegate", "com.guidewire.cc.domain.claim.metric.impl.PercentClaimMetricLimitImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PercentClaimMetricLimit.class, config);
    com.guidewire._generated.entity.PercentClaimMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PercentClaimMetricLimit, com.guidewire._generated.entity.PercentClaimMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.PercentClaimMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PercentClaimMetricLimitInternal getInternalInterface(entity.PercentClaimMetricLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PercentClaimMetricLimit newEmptyInstance() {
        return new entity.PercentClaimMetricLimit((java.lang.Void)null);
      }
