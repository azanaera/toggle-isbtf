 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AuthorityLimit.eti;AuthorityLimit.eix;AuthorityLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AuthorityLimit")
public class AuthorityLimit extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AuthorityLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AuthorityLimit>("entity.AuthorityLimit");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PROFILE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Profile");
  ...
  private com.guidewire._generated.entity.AuthorityLimitInternal _internal;
   ...
   */
  public AuthorityLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AuthorityLimit(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AuthorityLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AuthorityLimitInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * Gets the Currency for this AuthorityLimit
   * @return the Currency for this AuthorityLimit
   */
  public typekey.Currency getCurrency() {
    return ((gw.cc.community.entity.AuthorityLimit)__getDelegateManager().getImplementation("gw.cc.community.entity.AuthorityLimit")).getCurrency();
  }
  ...
  public typekey.AuthorityLimitType getLimitType() {
    return (typekey.AuthorityLimitType)__getInternalInterface().getFieldValue(LIMITTYPE_PROP.get());
  }
  ...
  public entity.AuthorityLimitProfile getProfile() {
    return (entity.AuthorityLimitProfile)__getInternalInterface().getFieldValue(PROFILE_PROP.get());
  }
  ...
  public void setProfile(entity.AuthorityLimitProfile value) {
    __getInternalInterface().setFieldValue(PROFILE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AuthorityLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AuthorityLimit.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getProfileID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PROFILE_PROP.get());
    }
    ...
    public void setProfileID(gw.pl.persistence.core.Key value) {
      setFieldValue(PROFILE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.community.impl.AuthorityLimitInternal", "com.guidewire.cc.domain.community.impl.AuthorityLimitImpl");
    ...
    config.put("gw.cc.community.entity.AuthorityLimit", "com.guidewire.cc.domain.community.impl.AuthorityLimitImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AuthorityLimit.class, config);
    com.guidewire._generated.entity.AuthorityLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AuthorityLimit, com.guidewire._generated.entity.AuthorityLimitInternal>() {
      public java.lang.Object getImplementation(entity.AuthorityLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AuthorityLimitInternal getInternalInterface(entity.AuthorityLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AuthorityLimit newEmptyInstance() {
        return new entity.AuthorityLimit((java.lang.Void)null);
      }
