 ...
 * Integer based exposure metric limit.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "IntegerExposureMetricLimit.eti;IntegerExposureMetricLimit.eix;IntegerExposureMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "IntegerExposureMetricLimit")
public class IntegerExposureMetricLimit extends entity.ExposureMetricLimit implements entity.IntegerMetricLimitDelegate, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.IntegerExposureMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.IntegerExposureMetricLimit>("entity.IntegerExposureMetricLimit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INTEGERREDVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IntegerRedValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INTEGERTARGETVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IntegerTargetValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INTEGERYELLOWVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "IntegerYellowValue");
   ...
   */
  public IntegerExposureMetricLimit()  {
   ...
   */
  public IntegerExposureMetricLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected IntegerExposureMetricLimit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.IntegerExposureMetricLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.IntegerExposureMetricLimitInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.IntegerExposureMetricLimitInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.Integer getIntegerRedValue() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(INTEGERREDVALUE_PROP.get());
  }
  ...
  public java.lang.Integer getIntegerTargetValue() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(INTEGERTARGETVALUE_PROP.get());
  }
  ...
  public java.lang.Integer getIntegerYellowValue() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(INTEGERYELLOWVALUE_PROP.get());
  }
  ...
  public void setIntegerRedValue(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(INTEGERREDVALUE_PROP.get(), value);
  }
  ...
  public void setIntegerTargetValue(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(INTEGERTARGETVALUE_PROP.get(), value);
  }
  ...
  public void setIntegerYellowValue(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(INTEGERYELLOWVALUE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.IntegerExposureMetricLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.IntegerExposureMetricLimit.this.__getDelegateManager();
    }
    ...
    public gw.api.metric.EditableMetricLimitValues createEditableValues() {
      return ((com.guidewire.cc.domain.metric.impl.IntegerMetricLimitDelegateInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.metric.impl.IntegerMetricLimitDelegateInternal")).createEditableValues();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.exposure.metric.impl.ExposureMetricLimitInternal", "com.guidewire.cc.domain.exposure.metric.impl.IntegerExposureMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.CopyOnWriteMetricLimitDelegateInternal", "com.guidewire.cc.domain.exposure.metric.impl.IntegerExposureMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.IntegerMetricLimitDelegateInternal", "com.guidewire.cc.domain.metric.impl.IntegerMetricLimitDelegateImpl");
    ...
    config.put("gw.api.metric.MetricLimit", "gw.api.exposure.metric.IntegerExposureMetricLimitMethodsImpl");
    config.put("gw.api.metric.MetricLimitMethods", "gw.api.exposure.metric.IntegerExposureMetricLimitMethodsImpl");
    config.put("gw.cc.exposure.metric.entity.ExposureMetricLimit", "com.guidewire.cc.domain.exposure.metric.impl.IntegerExposureMetricLimitImpl");
    config.put("gw.cc.exposure.metric.entity.IntegerExposureMetricLimit", "com.guidewire.cc.domain.exposure.metric.impl.IntegerExposureMetricLimitImpl");
    config.put("gw.cc.metric.entity.CopyOnWriteMetricLimitDelegate", "com.guidewire.cc.domain.exposure.metric.impl.IntegerExposureMetricLimitImpl");
    config.put("gw.cc.metric.entity.IntegerMetricLimitDelegate", "com.guidewire.cc.domain.metric.impl.IntegerMetricLimitDelegateImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.IntegerExposureMetricLimit.class, config);
    com.guidewire._generated.entity.IntegerExposureMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.IntegerExposureMetricLimit, com.guidewire._generated.entity.IntegerExposureMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.IntegerExposureMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.IntegerExposureMetricLimitInternal getInternalInterface(entity.IntegerExposureMetricLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.IntegerExposureMetricLimit newEmptyInstance() {
        return new entity.IntegerExposureMetricLimit((java.lang.Void)null);
      }
