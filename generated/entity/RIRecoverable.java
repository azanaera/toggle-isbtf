 ...
 *   
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RIRecoverable.eti;RIRecoverable.eix;RIRecoverable.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RIRecoverable")
public class RIRecoverable extends entity.RITransaction {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RIRecoverable> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RIRecoverable>("entity.RIRecoverable");
   ...
   */
  public RIRecoverable(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RIRecoverable(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RIRecoverableInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RIRecoverableInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RIRecoverableInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RIRecoverableInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RIRecoverable.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.financials.entity.RITransaction", "com.guidewire.cc.domain.financials.ri.impl.RIRecoverableImpl");
    config.put("gw.cc.financials.ri.entity.RIRecoverable", "com.guidewire.cc.domain.financials.ri.impl.RIRecoverableImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RIRecoverable.class, config);
    com.guidewire._generated.entity.RIRecoverableInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RIRecoverable, com.guidewire._generated.entity.RIRecoverableInternal>() {
      public java.lang.Object getImplementation(entity.RIRecoverable bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RIRecoverableInternal getInternalInterface(entity.RIRecoverable bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RIRecoverable newEmptyInstance() {
        return new entity.RIRecoverable((java.lang.Void)null);
      }
