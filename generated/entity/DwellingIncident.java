...
/**
 * DwellingIncident
 * Report of an incident involving a dwelling
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DwellingIncident.eti;DwellingIncident.eix;DwellingIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DwellingIncident")
public class DwellingIncident extends entity.FixedPropertyIncident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DwellingIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DwellingIncident>("entity.DwellingIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DAMAGEDAREASIZE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DamagedAreaSize");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DEBRISREMOVALIND_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DebrisRemovalInd");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> DWELLINGROOMDAMAGES_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "DwellingRoomDamages");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EMSIND_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EMSInd");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FIREPROTECTIONAVAILABLE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FireProtectionAvailable");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MATERIALSDAMAGED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MaterialsDamaged");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMBEROFPEOPLEONPOLICY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumberOfPeopleOnPolicy");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PROPERTYSIZE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PropertySize");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> YEARSINHOME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "YearsInHome");
   ...
   */
  public DwellingIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DwellingIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DwellingIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DwellingIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DwellingIncidentInternal)super.__getInternalInterface();
  }
  ...
  public void addToDwellingRoomDamages(entity.DwellingRoomDamage element) {
    __getInternalInterface().addArrayElement(DWELLINGROOMDAMAGES_PROP.get(), element);
  }
  ...
  public java.lang.Integer getDamagedAreaSize() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(DAMAGEDAREASIZE_PROP.get());
  }
  ...
  public entity.DwellingRoomDamage[] getDwellingRoomDamages() {
    return (entity.DwellingRoomDamage[])__getInternalInterface().getFieldValue(DWELLINGROOMDAMAGES_PROP.get());
  }
  ...
  public java.lang.String getMaterialsDamaged() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MATERIALSDAMAGED_PROP.get());
  }
  ...
  public java.lang.Integer getNumberOfPeopleOnPolicy() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMBEROFPEOPLEONPOLICY_PROP.get());
  }
  ...
  public java.lang.Integer getPropertySize() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(PROPERTYSIZE_PROP.get());
  }
  ...
  public java.util.Date getYearBuilt() {
    return (java.util.Date)__getInternalInterface().getFieldValue(YEARBUILT_PROP.get());
  }
  ...
  public java.lang.Integer getYearsInHome() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(YEARSINHOME_PROP.get());
  }
  ...
  public java.lang.Boolean isDebrisRemovalInd() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(DEBRISREMOVALIND_PROP.get());
  }
  ...
  public java.lang.Boolean isEMSInd() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(EMSIND_PROP.get());
  }
  ...
  public java.lang.Boolean isFireProtectionAvailable() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(FIREPROTECTIONAVAILABLE_PROP.get());
  }
  ...
  public void removeFromDwellingRoomDamages(entity.DwellingRoomDamage element) {
    __getInternalInterface().removeArrayElement(DWELLINGROOMDAMAGES_PROP.get(), element);
  }
  ...
  public void removeFromDwellingRoomDamages(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(DWELLINGROOMDAMAGES_PROP.get(), elementID);
  }
  ...
  public void setDamagedAreaSize(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(DAMAGEDAREASIZE_PROP.get(), value);
  }
  ...
  public void setDebrisRemovalInd(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(DEBRISREMOVALIND_PROP.get(), value);
  }
  ...
  public void setDwellingRoomDamages(entity.DwellingRoomDamage[] value) {
    __getInternalInterface().setFieldValue(DWELLINGROOMDAMAGES_PROP.get(), value);
  }
  ...
  public void setEMSInd(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(EMSIND_PROP.get(), value);
  }
  ...
  public void setFireProtectionAvailable(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(FIREPROTECTIONAVAILABLE_PROP.get(), value);
  }
  ...
  public void setMaterialsDamaged(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MATERIALSDAMAGED_PROP.get(), value);
  }
  ...
  public void setNumberOfPeopleOnPolicy(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMBEROFPEOPLEONPOLICY_PROP.get(), value);
  }
  ...
  public void setPropertySize(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(PROPERTYSIZE_PROP.get(), value);
  }
  ...
  public void setYearsInHome(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(YEARSINHOME_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DwellingIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DwellingIncident.this.__getDelegateManager();
    }
    ...
    /**
     * Creates an exposure for the incident for the given coverageType and coverageSubtype.
     * <pre>If it already exists then it does nothing.</pre>
     * <pre>If the claim state is not {@link typekey.ClaimState#TC_OPEN} or {@link typekey.ClaimState#TC_DRAFT} then it does nothing.</pre>
     * <pre>If the claim state is not {@link typekey.ClaimState#TC_OPEN} then the new exposure gets persisted.</pre>
     * @param coverageType the exposure coverage type
     * @param coverageSubtype the exposure coverage sub type
     * @return the newly created exposure, or null
     */
    public entity.Exposure createExposure(typekey.CoverageType coverageType, typekey.CoverageSubtype coverageSubtype) {
      return ((gw.cc.exposure.entity.Incident)__getDelegateManager().getImplementation("gw.cc.exposure.entity.Incident")).createExposure(coverageType, coverageSubtype);
    }
    ...
    public typekey.AlarmType getAlarmType() {
      return (typekey.AlarmType)__getInternalInterface().getFieldValue(ALARMTYPE_PROP.get());
    }
    ...
    /**
     * The list of properties suitable for setting on this incident. Includes all the policy properties except those that
     * are already in use by other incidents
     * @return array of available properties, may be zero length but is never null
     */
    public entity.PolicyLocation[] getAvailableProperties() {
      return ((gw.cc.exposure.entity.FixedPropertyIncident)__getDelegateManager().getImplementation("gw.cc.exposure.entity.FixedPropertyIncident")).getAvailableProperties();
    }
    ...
    public entity.Contact getClaimantForExposure() {
      return ((gw.cc.exposure.entity.ClaimantSupplier)__getDelegateManager().getImplementation("gw.cc.exposure.entity.ClaimantSupplier")).getClaimantForExposure();
    }
    
    public typekey.ClaimantType getClaimantTypeForExposure() {
      return ((gw.cc.exposure.entity.ClaimantSupplier)__getDelegateManager().getImplementation("gw.cc.exposure.entity.ClaimantSupplier")).getClaimantTypeForExposure();
    }
    ...
    public typekey.ClassType getClassType() {
      return (typekey.ClassType)__getInternalInterface().getFieldValue(CLASSTYPE_PROP.get());
    }
    ...
    /**
     * Returns the Coverage with the given CoverageType associated with this CoverageSupplier.
     * @param coverageType 
     * @return the coverage with <code>coverageType</code> or <code>null</code> if there are no coverages corresponding to
     * <code>coverageType</code>
     */
    public entity.Coverage getCoverageByType(typekey.CoverageType coverageType) {
      return ((gw.cc.exposure.entity.CoverageSupplier)__getDelegateManager().getImplementation("gw.cc.exposure.entity.CoverageSupplier")).getCoverageByType(coverageType);
    }
    ...
    public typekey.ExtWallMat getExtWallMat() {
      return (typekey.ExtWallMat)__getInternalInterface().getFieldValue(EXTWALLMAT_PROP.get());
    }
    ...
    public java.lang.String getFireProtDetails() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FIREPROTDETAILS_PROP.get());
    }
    ...
    public typekey.YesNo getHazardInvolved() {
      return (typekey.YesNo)__getInternalInterface().getFieldValue(HAZARDINVOLVED_PROP.get());
    }
    ...
    public typekey.LossArea getLossArea() {
      return (typekey.LossArea)__getInternalInterface().getFieldValue(LOSSAREA_PROP.get());
    }
    ...
    public typekey.YesNo getMoldInvolved() {
      return (typekey.YesNo)__getInternalInterface().getFieldValue(MOLDINVOLVED_PROP.get());
    }
    ...
    public java.lang.Integer getNumSprinkOper() {
      return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMSPRINKOPER_PROP.get());
    }
    ...
    public java.lang.Integer getNumSprinkler() {
      return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMSPRINKLER_PROP.get());
    }
    ...
    public typekey.OccupancyType getOccupancyType() {
      return (typekey.OccupancyType)__getInternalInterface().getFieldValue(OCCUPANCYTYPE_PROP.get());
    }
    ...
    public entity.PolicyLocation getProperty() {
      return (entity.PolicyLocation)__getInternalInterface().getFieldValue(PROPERTY_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getPropertyID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PROPERTY_PROP.get());
    }
    ...
    public typekey.RoofMaterial getRoofMaterial() {
      return (typekey.RoofMaterial)__getInternalInterface().getFieldValue(ROOFMATERIAL_PROP.get());
    }
    ...
    public typekey.SprinkRetServ getSprinkRetServ() {
      return (typekey.SprinkRetServ)__getInternalInterface().getFieldValue(SPRINKRETSERV_PROP.get());
    }
    ...
    public typekey.SprinklerType getSprinklerType() {
      return (typekey.SprinklerType)__getInternalInterface().getFieldValue(SPRINKLERTYPE_PROP.get());
    }
    ...
    public void setAlarmType(typekey.AlarmType value) {
      __getInternalInterface().setFieldValue(ALARMTYPE_PROP.get(), value);
    }
    ...
    public void setClassType(typekey.ClassType value) {
      __getInternalInterface().setFieldValue(CLASSTYPE_PROP.get(), value);
    }
    ...
    public void setExtWallMat(typekey.ExtWallMat value) {
      __getInternalInterface().setFieldValue(EXTWALLMAT_PROP.get(), value);
    }
    ...
    public void setFireProtDetails(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(FIREPROTDETAILS_PROP.get(), value);
    }
    ...
    public void setHazardInvolved(typekey.YesNo value) {
      __getInternalInterface().setFieldValue(HAZARDINVOLVED_PROP.get(), value);
    }
    ...
    public void setLossArea(typekey.LossArea value) {
      __getInternalInterface().setFieldValue(LOSSAREA_PROP.get(), value);
    }
    ...
    public void setMoldInvolved(typekey.YesNo value) {
      __getInternalInterface().setFieldValue(MOLDINVOLVED_PROP.get(), value);
    }
    ...
    public void setNumSprinkOper(java.lang.Integer value) {
      __getInternalInterface().setFieldValue(NUMSPRINKOPER_PROP.get(), value);
    }
    ...
    public void setNumSprinkler(java.lang.Integer value) {
      __getInternalInterface().setFieldValue(NUMSPRINKLER_PROP.get(), value);
    }
    ...
    public void setOccupancyType(typekey.OccupancyType value) {
      __getInternalInterface().setFieldValue(OCCUPANCYTYPE_PROP.get(), value);
    }
    ...
    public void setProperty(entity.PolicyLocation value) {
      __getInternalInterface().setFieldValue(PROPERTY_PROP.get(), value);
    }
    ...
    public void setPropertyID(gw.pl.persistence.core.Key value) {
      setFieldValue(PROPERTY_PROP.get(), value);
    }
    ...
    public void setRoofMaterial(typekey.RoofMaterial value) {
      __getInternalInterface().setFieldValue(ROOFMATERIAL_PROP.get(), value);
    }
    ...
    public void setSprinkRetServ(typekey.SprinkRetServ value) {
      __getInternalInterface().setFieldValue(SPRINKRETSERV_PROP.get(), value);
    }
    ...
    public void setSprinklerType(typekey.SprinklerType value) {
      __getInternalInterface().setFieldValue(SPRINKLERTYPE_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.InsuredClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.LossLocationCoverageSupplier");
    config.put("gw.cc.exposure.entity.DwellingIncident", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    config.put("gw.cc.exposure.entity.FixedPropertyIncident", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.DwellingIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DwellingIncident.class, config);
    com.guidewire._generated.entity.DwellingIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DwellingIncident, com.guidewire._generated.entity.DwellingIncidentInternal>() {
      public java.lang.Object getImplementation(entity.DwellingIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DwellingIncidentInternal getInternalInterface(entity.DwellingIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DwellingIncident newEmptyInstance() {
        return new entity.DwellingIncident((java.lang.Void)null);
      }
