 ...
 * Allows insurer to determine which coverages are invalid based upon Loss Cause. .  For example, a Comprehensive coverage typically is not applicable if the cause of loss is Collision with other Vehicle
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InvalidCoverageForCause.eti;InvalidCoverageForCause.eix;InvalidCoverageForCause.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "InvalidCoverageForCause")
public class InvalidCoverageForCause extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InvalidCoverageForCause> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InvalidCoverageForCause>("entity.InvalidCoverageForCause");
  ...
  private com.guidewire._generated.entity.InvalidCoverageForCauseInternal _internal;
   ...
   */
  public InvalidCoverageForCause()  {
   ...
   */
  public InvalidCoverageForCause(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InvalidCoverageForCause(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InvalidCoverageForCauseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InvalidCoverageForCauseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InvalidCoverageForCauseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InvalidCoverageForCause.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.InvalidCoverageForCause", "com.guidewire.cc.domain.exposure.impl.InvalidCoverageForCauseImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InvalidCoverageForCause.class, config);
    com.guidewire._generated.entity.InvalidCoverageForCauseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InvalidCoverageForCause, com.guidewire._generated.entity.InvalidCoverageForCauseInternal>() {
      public java.lang.Object getImplementation(entity.InvalidCoverageForCause bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InvalidCoverageForCauseInternal getInternalInterface(entity.InvalidCoverageForCause bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InvalidCoverageForCause newEmptyInstance() {
        return new entity.InvalidCoverageForCause((java.lang.Void)null);
      }
