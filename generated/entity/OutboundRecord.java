...
/**
 * OutboundRecord
 * An outbound file record.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OutboundRecord.eti;OutboundRecord.eix;OutboundRecord.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OutboundRecord")
public class OutboundRecord extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OutboundRecord> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OutboundRecord>("entity.OutboundRecord");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BATCHID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BatchID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANVERSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanVersion");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> CONFIG_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Config");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> OUTBOUNDFILE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "OutboundFile");
  ...
  private com.guidewire._generated.entity.OutboundRecordInternal _internal;
   ...
   */
  public OutboundRecord(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OutboundRecord(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OutboundRecordInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OutboundRecordInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.lang.String getBatchID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(BATCHID_PROP.get());
  }
  ...
  public entity.OutboundFileConfig getConfig() {
    return (entity.OutboundFileConfig)__getInternalInterface().getFieldValue(CONFIG_PROP.get());
  }
  ...
  public entity.OutboundFile getOutboundFile() {
    return (entity.OutboundFile)__getInternalInterface().getFieldValue(OUTBOUNDFILE_PROP.get());
  }
  ...
  public typekey.OutboundRecordStatus getStatus() {
    return (typekey.OutboundRecordStatus)__getInternalInterface().getFieldValue(STATUS_PROP.get());
  }
  ...
  public void setBatchID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(BATCHID_PROP.get(), value);
  }
  ...
  public void setOutboundFile(entity.OutboundFile value) {
    __getInternalInterface().setFieldValue(OUTBOUNDFILE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OutboundRecordInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OutboundRecord.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getConfigID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(CONFIG_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getOutboundFileID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(OUTBOUNDFILE_PROP.get());
    }
    ...
    public void setConfigID(gw.pl.persistence.core.Key value) {
      setFieldValue(CONFIG_PROP.get(), value);
    }
    ...
    public void setOutboundFileID(gw.pl.persistence.core.Key value) {
      setFieldValue(OUTBOUNDFILE_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OutboundRecord.class, config);
    com.guidewire._generated.entity.OutboundRecordInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OutboundRecord, com.guidewire._generated.entity.OutboundRecordInternal>() {
      public java.lang.Object getImplementation(entity.OutboundRecord bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OutboundRecordInternal getInternalInterface(entity.OutboundRecord bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OutboundRecord newEmptyInstance() {
        return new entity.OutboundRecord((java.lang.Void)null);
      }
