...
/**
 * CatastropheZone
 * A zone of a catastrophe.  It contains the zone code, the zone type and the country to which the region belongs.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CatastropheZone.eti;CatastropheZone.eix;CatastropheZone.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CatastropheZone")
public class CatastropheZone extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CatastropheZone> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CatastropheZone>("entity.CatastropheZone");
  ...
  private com.guidewire._generated.entity.CatastropheZoneInternal _internal;
   ...
   */
  public CatastropheZone(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CatastropheZone(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CatastropheZoneInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CatastropheZoneInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CatastropheZoneInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CatastropheZone.this.__getDelegateManager();
    }
    ...
    public entity.Zone getZone() {
      return ((com.guidewire.cc.domain.catastrophe.impl.CatastropheZoneInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.catastrophe.impl.CatastropheZoneInternal")).getZone();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.catastrophe.impl.CatastropheZoneInternal", "com.guidewire.cc.domain.catastrophe.impl.CatastropheZoneImpl");
    ...
    config.put("gw.cc.catastrophe.entity.CatastropheZone", "com.guidewire.cc.domain.catastrophe.impl.CatastropheZoneImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CatastropheZone.class, config);
    com.guidewire._generated.entity.CatastropheZoneInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CatastropheZone, com.guidewire._generated.entity.CatastropheZoneInternal>() {
      public java.lang.Object getImplementation(entity.CatastropheZone bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CatastropheZoneInternal getInternalInterface(entity.CatastropheZone bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CatastropheZone newEmptyInstance() {
        return new entity.CatastropheZone((java.lang.Void)null);
      }
