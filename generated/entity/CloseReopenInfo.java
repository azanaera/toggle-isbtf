 ...
 * CloseReopenInfo
 * 
 *         Temporary entity that holds transitional internal state information during all close or reopen operations.
 *         This acts as a abstract base entity for ClaimCloseReopenInfo, MatterCloseReopenInfo, and ExpCloseReopenInfo.
 *       
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CloseReopenInfo.eti;CloseReopenInfo.eix;CloseReopenInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CloseReopenInfo")
public class CloseReopenInfo extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CloseReopenInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CloseReopenInfo>("entity.CloseReopenInfo");
  ...
  private com.guidewire._generated.entity.CloseReopenInfoInternal _internal;
   ...
   */
  public CloseReopenInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CloseReopenInfo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CloseReopenInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CloseReopenInfoInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.CloseReopenInfo value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CloseReopenInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CloseReopenInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.claim.impl.CloseReopenInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CloseReopenInfo.class, config);
    com.guidewire._generated.entity.CloseReopenInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CloseReopenInfo, com.guidewire._generated.entity.CloseReopenInfoInternal>() {
      public java.lang.Object getImplementation(entity.CloseReopenInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CloseReopenInfoInternal getInternalInterface(entity.CloseReopenInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CloseReopenInfo newEmptyInstance() {
        return new entity.CloseReopenInfo((java.lang.Void)null);
      }
