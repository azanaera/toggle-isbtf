 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PerEventRITreaty.eti;PerEventRITreaty.eix;PerEventRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PerEventRITreaty")
public class PerEventRITreaty extends entity.NonProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PerEventRITreaty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PerEventRITreaty>("entity.PerEventRITreaty");
   ...
   */
  public PerEventRITreaty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PerEventRITreaty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PerEventRITreatyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PerEventRITreatyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PerEventRITreatyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PerEventRITreatyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PerEventRITreaty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.NonProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.PerEventRITreaty", "com.guidewire.cc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.PerEventRITreatyImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PerEventRITreaty.class, config);
    com.guidewire._generated.entity.PerEventRITreatyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PerEventRITreaty, com.guidewire._generated.entity.PerEventRITreatyInternal>() {
      public java.lang.Object getImplementation(entity.PerEventRITreaty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PerEventRITreatyInternal getInternalInterface(entity.PerEventRITreaty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PerEventRITreaty newEmptyInstance() {
        return new entity.PerEventRITreaty((java.lang.Void)null);
      }
