 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AppCritLossCause.eti;AppCritLossCause.eix;AppCritLossCause.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AppCritLossCause")
public class AppCritLossCause extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritLossCause> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritLossCause>("entity.AppCritLossCause");
  ...
  private com.guidewire._generated.entity.AppCritLossCauseInternal _internal;
   ...
   */
  public AppCritLossCause(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritLossCause(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritLossCauseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritLossCauseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritLossCauseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritLossCause.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritLossCauseImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritLossCause.class, config);
    com.guidewire._generated.entity.AppCritLossCauseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritLossCause, com.guidewire._generated.entity.AppCritLossCauseInternal>() {
      public java.lang.Object getImplementation(entity.AppCritLossCause bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritLossCauseInternal getInternalInterface(entity.AppCritLossCause bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritLossCause newEmptyInstance() {
        return new entity.AppCritLossCause((java.lang.Void)null);
      }
