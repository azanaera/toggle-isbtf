 ...
 * BatchProcessLease
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BatchProcessLease.eti;BatchProcessLease.eix;BatchProcessLease.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BatchProcessLease")
public class BatchProcessLease extends com.guidewire.pl.persistence.code.BeanBase implements entity.Lease, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BatchProcessLease> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BatchProcessLease>("entity.BatchProcessLease");
  ...
  private com.guidewire._generated.entity.BatchProcessLeaseInternal _internal;
   ...
   */
  public BatchProcessLease(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BatchProcessLease(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BatchProcessLeaseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BatchProcessLeaseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BatchProcessLeaseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BatchProcessLease.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BatchProcessLease.class, config);
    com.guidewire._generated.entity.BatchProcessLeaseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BatchProcessLease, com.guidewire._generated.entity.BatchProcessLeaseInternal>() {
      public java.lang.Object getImplementation(entity.BatchProcessLease bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BatchProcessLeaseInternal getInternalInterface(entity.BatchProcessLease bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BatchProcessLease newEmptyInstance() {
        return new entity.BatchProcessLease((java.lang.Void)null);
      }
