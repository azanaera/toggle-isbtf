 ...
 *         configurable search
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CCNameCriteria.eti;CCNameCriteria.eix;CCNameCriteria.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CCNameCriteria")
public class CCNameCriteria extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CCNameCriteria> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CCNameCriteria>("entity.CCNameCriteria");
  ...
  private com.guidewire._generated.entity.CCNameCriteriaInternal _internal;
   ...
   */
  public CCNameCriteria(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CCNameCriteria(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CCNameCriteriaInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CCNameCriteriaInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public boolean isSet() {
    return ((gw.cc.custom.entity.CCNameCriteria)__getDelegateManager().getImplementation("gw.cc.custom.entity.CCNameCriteria")).isSet();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CCNameCriteriaInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CCNameCriteria.this.__getDelegateManager();
    }
    
    public com.guidewire.pl.system.database.TableObject addClaimContactRestriction(com.guidewire.pl.system.database.TableObject claimContactTable) {
      return ((com.guidewire.cc.domain.custom.impl.CCNameCriteriaInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.custom.impl.CCNameCriteriaInternal")).addClaimContactRestriction(claimContactTable);
    }
    
    public com.guidewire.pl.system.database.TableObject addJoin(com.guidewire.pl.system.database.TableObject primary, gw.entity.ILinkPropertyInfo joinField) {
      return ((com.guidewire.cc.domain.custom.impl.CCNameCriteriaInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.custom.impl.CCNameCriteriaInternal")).addJoin(primary, joinField);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.custom.impl.CCNameCriteriaInternal", "com.guidewire.cc.domain.custom.impl.CCNameCriteriaImpl");
    ...
    config.put("gw.cc.custom.entity.CCNameCriteria", "com.guidewire.cc.domain.custom.impl.CCNameCriteriaImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CCNameCriteria.class, config);
    com.guidewire._generated.entity.CCNameCriteriaInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CCNameCriteria, com.guidewire._generated.entity.CCNameCriteriaInternal>() {
      public java.lang.Object getImplementation(entity.CCNameCriteria bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CCNameCriteriaInternal getInternalInterface(entity.CCNameCriteria bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CCNameCriteria newEmptyInstance() {
        return new entity.CCNameCriteria((java.lang.Void)null);
      }
