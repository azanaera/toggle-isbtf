 ...
 * WCCovEmpRU
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "WCCovEmpRU.eti;WCCovEmpRU.eix;WCCovEmpRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "WCCovEmpRU")
public class WCCovEmpRU extends entity.LocationBasedRU {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WCCovEmpRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WCCovEmpRU>("entity.WCCovEmpRU");
   ...
   */
  public WCCovEmpRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WCCovEmpRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WCCovEmpRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WCCovEmpRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WCCovEmpRUInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WCCovEmpRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WCCovEmpRU.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.LocationBasedRU", "com.guidewire.cc.domain.policy.impl.WCCovEmpRUImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.WCCovEmpRUImpl");
    config.put("gw.cc.policy.entity.WCCovEmpRU", "com.guidewire.cc.domain.policy.impl.WCCovEmpRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WCCovEmpRU.class, config);
    com.guidewire._generated.entity.WCCovEmpRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WCCovEmpRU, com.guidewire._generated.entity.WCCovEmpRUInternal>() {
      public java.lang.Object getImplementation(entity.WCCovEmpRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WCCovEmpRUInternal getInternalInterface(entity.WCCovEmpRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WCCovEmpRU newEmptyInstance() {
        return new entity.WCCovEmpRU((java.lang.Void)null);
      }
