 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "WorkflowTextLog.eti;WorkflowTextLog.eix;WorkflowTextLog.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "WorkflowTextLog")
public class WorkflowTextLog extends entity.WorkflowLogEntry {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WorkflowTextLog> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WorkflowTextLog>("entity.WorkflowTextLog");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SUMMARY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Summary");
   ...
   */
  public WorkflowTextLog(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WorkflowTextLog(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WorkflowTextLogInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkflowTextLogInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WorkflowTextLogInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getSummary() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SUMMARY_PROP.get());
  }
  ...
  private void setSummary(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(SUMMARY_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkflowTextLogInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkflowTextLog.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.workflow.WorkflowLogEntryPublicMethods", "com.guidewire.pl.domain.workflow.impl.WorkflowTextLogImpl");
    config.put("com.guidewire.pl.persistence.core.BeanMethods", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkflowTextLog.class, config);
    com.guidewire._generated.entity.WorkflowTextLogInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkflowTextLog, com.guidewire._generated.entity.WorkflowTextLogInternal>() {
      public java.lang.Object getImplementation(entity.WorkflowTextLog bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkflowTextLogInternal getInternalInterface(entity.WorkflowTextLog bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkflowTextLog newEmptyInstance() {
        return new entity.WorkflowTextLog((java.lang.Void)null);
      }
