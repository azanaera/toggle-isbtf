...
/**
 * ClaimWorkloadClassification
 * Claim Workload Classification
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimWorkloadClassification.eti;ClaimWorkloadClassification.eix;ClaimWorkloadClassification.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimWorkloadClassification")
public class ClaimWorkloadClassification extends entity.WorkloadClassification {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimWorkloadClassification> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimWorkloadClassification>("entity.ClaimWorkloadClassification");
   ...
   */
  public ClaimWorkloadClassification()  {
   ...
   */
  public ClaimWorkloadClassification(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimWorkloadClassification(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimWorkloadClassificationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimWorkloadClassificationInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimWorkloadClassificationInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimWorkloadClassificationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimWorkloadClassification.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.assignment.workload.classifications.WorkloadClassificationMethods", "gw.assignment.workload.classifications.ClaimWorkloadClassificationMethodsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimWorkloadClassification.class, config);
    com.guidewire._generated.entity.ClaimWorkloadClassificationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimWorkloadClassification, com.guidewire._generated.entity.ClaimWorkloadClassificationInternal>() {
      public java.lang.Object getImplementation(entity.ClaimWorkloadClassification bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimWorkloadClassificationInternal getInternalInterface(entity.ClaimWorkloadClassification bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimWorkloadClassification newEmptyInstance() {
        return new entity.ClaimWorkloadClassification((java.lang.Void)null);
      }
