 ...
 * Number of Open Escalated Activities
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OpenEscalatedActivitiesClaimMetric.eti;OpenEscalatedActivitiesClaimMetric.eix;OpenEscalatedActivitiesClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OpenEscalatedActivitiesClaimMetric")
public class OpenEscalatedActivitiesClaimMetric extends entity.IntegerClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OpenEscalatedActivitiesClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OpenEscalatedActivitiesClaimMetric>("entity.OpenEscalatedActivitiesClaimMetric");
   ...
   */
  public OpenEscalatedActivitiesClaimMetric()  {
   ...
   */
  public OpenEscalatedActivitiesClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OpenEscalatedActivitiesClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OpenEscalatedActivitiesClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.activity.OpenEscalatedActivitiesClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OpenEscalatedActivitiesClaimMetric.class, config);
    com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OpenEscalatedActivitiesClaimMetric, com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.OpenEscalatedActivitiesClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OpenEscalatedActivitiesClaimMetricInternal getInternalInterface(entity.OpenEscalatedActivitiesClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OpenEscalatedActivitiesClaimMetric newEmptyInstance() {
        return new entity.OpenEscalatedActivitiesClaimMetric((java.lang.Void)null);
      }
