 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AllEscalatedActivitiesClaimMetric.eti;AllEscalatedActivitiesClaimMetric.eix;AllEscalatedActivitiesClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AllEscalatedActivitiesClaimMetric")
public class AllEscalatedActivitiesClaimMetric extends entity.IntegerClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AllEscalatedActivitiesClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AllEscalatedActivitiesClaimMetric>("entity.AllEscalatedActivitiesClaimMetric");
   ...
   */
  public AllEscalatedActivitiesClaimMetric()  {
   ...
   */
  public AllEscalatedActivitiesClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AllEscalatedActivitiesClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AllEscalatedActivitiesClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.activity.AllEscalatedActivitiesClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AllEscalatedActivitiesClaimMetric.class, config);
    com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AllEscalatedActivitiesClaimMetric, com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.AllEscalatedActivitiesClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AllEscalatedActivitiesClaimMetricInternal getInternalInterface(entity.AllEscalatedActivitiesClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AllEscalatedActivitiesClaimMetric newEmptyInstance() {
        return new entity.AllEscalatedActivitiesClaimMetric((java.lang.Void)null);
      }
