...
/**
 * UserRoleAssignment
 * Claim-level user role assignment.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "UserRoleAssignment.eti;UserRoleAssignment.eix;UserRoleAssignment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "UserRoleAssignment")
public class UserRoleAssignment extends com.guidewire.pl.persistence.code.BeanBase implements entity.UserRoleAssignmentDelegate, entity.Extractable, entity.CCAssignable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.UserRoleAssignment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.UserRoleAssignment>("entity.UserRoleAssignment");
  ...
  private com.guidewire._generated.entity.UserRoleAssignmentInternal _internal;
   ...
   */
  public UserRoleAssignment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected UserRoleAssignment(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.UserRoleAssignmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.UserRoleAssignmentInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UserRoleAssignmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.UserRoleAssignment.this.__getDelegateManager();
    }
    ...
    public boolean assignManually(entity.User user) {
      return ((com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal")).assignManually(user);
    }
    
    public boolean assignManuallyByRoundRobin(entity.Group group) {
      return ((com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal")).assignManuallyByRoundRobin(group);
    }
    ...
    public boolean confirmManually(entity.User user) {
      return ((com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal")).confirmManually(user);
    }
    
    public boolean confirmManuallyByRoundRobin(entity.Group group) {
      return ((com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal")).confirmManuallyByRoundRobin(group);
    }
    ...
    public gw.api.assignment.UserRoleOwner getMultiUserAssignable() {
      return ((com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal")).getMultiUserAssignable();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.impl.UserRoleAssignmentInternal", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("com.guidewire.commons.entity.Keyable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.commons.entity.Sourceable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.pl.domain.assignment.AssignablePublicMethods", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    ...
    config.put("com.guidewire.pl.domain.assignment.impl.AssignableInternalMethods", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("com.guidewire.pl.system.bundle.RemoveCallback", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("com.guidewire.pl.system.entity.PermissionAssignableCheck", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("gw.cc.assignment.entity.CCAssignable", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("gw.cc.claim.entity.UserRoleAssignment", "com.guidewire.cc.domain.claim.impl.UserRoleAssignmentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.UserRoleAssignment.class, config);
    com.guidewire._generated.entity.UserRoleAssignmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.UserRoleAssignment, com.guidewire._generated.entity.UserRoleAssignmentInternal>() {
      public java.lang.Object getImplementation(entity.UserRoleAssignment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.UserRoleAssignmentInternal getInternalInterface(entity.UserRoleAssignment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.UserRoleAssignment newEmptyInstance() {
        return new entity.UserRoleAssignment((java.lang.Void)null);
      }
