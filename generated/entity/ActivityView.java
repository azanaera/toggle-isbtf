...
/**
 * ActivityView
 * <p>Aggregates the information needed to display one activity row (base entity for all other activity views).</p>
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ActivityView.eti;ActivityView.eix;ActivityView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ActivityView")
public class ActivityView extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ActivityView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ActivityView>("entity.ActivityView");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMINSUREDNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimInsuredName");
  ...
  private com.guidewire._generated.entity.ActivityViewInternal _internal;
   ...
   */
  public ActivityView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ActivityView(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ActivityViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ActivityViewInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ActivityView value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ActivityViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ActivityView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.activity.entity.ActivityView", "com.guidewire.cc.domain.activity.impl.ActivityViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ActivityView.class, config);
    com.guidewire._generated.entity.ActivityViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ActivityView, com.guidewire._generated.entity.ActivityViewInternal>() {
      public java.lang.Object getImplementation(entity.ActivityView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ActivityViewInternal getInternalInterface(entity.ActivityView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ActivityView newEmptyInstance() {
        return new entity.ActivityView((java.lang.Void)null);
      }
