 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureISOMatchReport.eti;ExposureISOMatchReport.eix;ExposureISOMatchReport.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExposureISOMatchReport")
public class ExposureISOMatchReport extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.ISOMatchReport, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureISOMatchReport> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureISOMatchReport>("entity.ExposureISOMatchReport");
  ...
  private com.guidewire._generated.entity.ExposureISOMatchReportInternal _internal;
   ...
   */
  public ExposureISOMatchReport(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExposureISOMatchReport(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ExposureISOMatchReportInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExposureISOMatchReportInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExposureISOMatchReportInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExposureISOMatchReport.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.iso.impl.ISOMatchReportInternal", "com.guidewire.cc.domain.exposure.impl.ExposureISOMatchReportImpl");
    ...
    config.put("gw.cc.exposure.entity.ExposureISOMatchReport", "com.guidewire.cc.domain.exposure.impl.ExposureISOMatchReportImpl");
    config.put("gw.cc.iso.entity.ISOMatchReport", "com.guidewire.cc.domain.exposure.impl.ExposureISOMatchReportImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExposureISOMatchReport.class, config);
    com.guidewire._generated.entity.ExposureISOMatchReportInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExposureISOMatchReport, com.guidewire._generated.entity.ExposureISOMatchReportInternal>() {
      public java.lang.Object getImplementation(entity.ExposureISOMatchReport bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureISOMatchReportInternal getInternalInterface(entity.ExposureISOMatchReport bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExposureISOMatchReport newEmptyInstance() {
        return new entity.ExposureISOMatchReport((java.lang.Void)null);
      }
