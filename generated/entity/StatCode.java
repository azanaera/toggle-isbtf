 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "StatCode.eti;StatCode.eix;StatCode.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "StatCode")
public class StatCode extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.StatCode> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.StatCode>("entity.StatCode");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INSURANCELINE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "InsuranceLine");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> INSURANCESUBLINE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "InsuranceSubLine");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> MAJORPERIL_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "MajorPeril");
  ...
  private com.guidewire._generated.entity.StatCodeInternal _internal;
   ...
   */
  public StatCode(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected StatCode(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.StatCodeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.StatCodeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.InsuranceLine getInsuranceLine() {
    return (typekey.InsuranceLine)__getInternalInterface().getFieldValue(INSURANCELINE_PROP.get());
  }
  ...
  public typekey.InsuranceSubLine getInsuranceSubLine() {
    return (typekey.InsuranceSubLine)__getInternalInterface().getFieldValue(INSURANCESUBLINE_PROP.get());
  }
  ...
  public typekey.MajorPerils getMajorPeril() {
    return (typekey.MajorPerils)__getInternalInterface().getFieldValue(MAJORPERIL_PROP.get());
  }
  ...
  public java.lang.String getVehicleNumber() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(VEHICLENUMBER_PROP.get());
  }
  ...
  public void setInsuranceLine(typekey.InsuranceLine value) {
    __getInternalInterface().setFieldValue(INSURANCELINE_PROP.get(), value);
  }
  ...
  public void setInsuranceSubLine(typekey.InsuranceSubLine value) {
    __getInternalInterface().setFieldValue(INSURANCESUBLINE_PROP.get(), value);
  }
  ...
  public void setMajorPeril(typekey.MajorPerils value) {
    __getInternalInterface().setFieldValue(MAJORPERIL_PROP.get(), value);
  }
  ...
  public void setVehicleNumber(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(VEHICLENUMBER_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.StatCodeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.StatCode.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.StatCode", "com.guidewire.cc.domain.policy.impl.StatCodeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.StatCode.class, config);
    com.guidewire._generated.entity.StatCodeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.StatCode, com.guidewire._generated.entity.StatCodeInternal>() {
      public java.lang.Object getImplementation(entity.StatCode bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.StatCodeInternal getInternalInterface(entity.StatCode bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.StatCode newEmptyInstance() {
        return new entity.StatCode((java.lang.Void)null);
      }
