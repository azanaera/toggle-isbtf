 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LegalVenue.eti;LegalVenue.eix;LegalVenue.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LegalVenue")
public class LegalVenue extends entity.Place {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LegalVenue> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LegalVenue>("entity.LegalVenue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> VENUETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "VenueType");
   ...
   */
  public LegalVenue(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LegalVenue(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LegalVenueInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LegalVenueInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LegalVenueInternal)super.__getInternalInterface();
  }
  ...
  public typekey.VenueType getVenueType() {
    return (typekey.VenueType)__getInternalInterface().getFieldValue(VENUETYPE_PROP.get());
  }
  ...
  public void setVenueType(typekey.VenueType value) {
    __getInternalInterface().setFieldValue(VENUETYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LegalVenueInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LegalVenue.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LegalVenue.class, config);
    com.guidewire._generated.entity.LegalVenueInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LegalVenue, com.guidewire._generated.entity.LegalVenueInternal>() {
      public java.lang.Object getImplementation(entity.LegalVenue bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LegalVenueInternal getInternalInterface(entity.LegalVenue bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LegalVenue newEmptyInstance() {
        return new entity.LegalVenue((java.lang.Void)null);
      }
