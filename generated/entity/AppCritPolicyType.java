...
/**
 * AppCritPolicyType
 * Policy Type Applicability Criteria 
 */
...
@gw.entity.EntityName(value = "AppCritPolicyType")
public class AppCritPolicyType extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritPolicyType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritPolicyType>("entity.AppCritPolicyType");
  ...
  private com.guidewire._generated.entity.AppCritPolicyTypeInternal _internal;
   ...
   */
  public AppCritPolicyType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritPolicyType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritPolicyTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritPolicyTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritPolicyTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritPolicyType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritPolicyTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritPolicyType.class, config);
    com.guidewire._generated.entity.AppCritPolicyTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritPolicyType, com.guidewire._generated.entity.AppCritPolicyTypeInternal>() {
      public java.lang.Object getImplementation(entity.AppCritPolicyType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritPolicyTypeInternal getInternalInterface(entity.AppCritPolicyType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritPolicyType newEmptyInstance() {
        return new entity.AppCritPolicyType((java.lang.Void)null);
      }
