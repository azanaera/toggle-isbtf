...
/**
 * TripIncident
 * Report of an incident involving a trip or travel
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TripIncident.eti;TripIncident.eix;TripIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TripIncident")
public class TripIncident extends entity.Incident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TripIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TripIncident>("entity.TripIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> TRIPACCOMMODATIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "TripAccommodations");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> TRIPRU_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "TripRU");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> TRIPSEGMENTS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "TripSegments");
   ...
   */
  public TripIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TripIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TripIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TripIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TripIncidentInternal)super.__getInternalInterface();
  }
  ...
  public void addToTripAccommodations(entity.TripAccommodation element) {
    __getInternalInterface().addArrayElement(TRIPACCOMMODATIONS_PROP.get(), element);
  }
  ...
  public void addToTripSegments(entity.TripSegment element) {
    __getInternalInterface().addArrayElement(TRIPSEGMENTS_PROP.get(), element);
  }
  ...
  public entity.TripAccommodation[] getTripAccommodations() {
    return (entity.TripAccommodation[])__getInternalInterface().getFieldValue(TRIPACCOMMODATIONS_PROP.get());
  }
  ...
  public entity.TripRU getTripRU() {
    return (entity.TripRU)__getInternalInterface().getFieldValue(TRIPRU_PROP.get());
  }
  ...
  public entity.TripSegment[] getTripSegments() {
    return (entity.TripSegment[])__getInternalInterface().getFieldValue(TRIPSEGMENTS_PROP.get());
  }
  ...
  public void removeFromTripAccommodations(entity.TripAccommodation element) {
    __getInternalInterface().removeArrayElement(TRIPACCOMMODATIONS_PROP.get(), element);
  }
  ...
  public void removeFromTripAccommodations(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(TRIPACCOMMODATIONS_PROP.get(), elementID);
  }
  ...
  public void removeFromTripSegments(entity.TripSegment element) {
    __getInternalInterface().removeArrayElement(TRIPSEGMENTS_PROP.get(), element);
  }
  ...
  public void removeFromTripSegments(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(TRIPSEGMENTS_PROP.get(), elementID);
  }
  ...
  public void setTripAccommodations(entity.TripAccommodation[] value) {
    __getInternalInterface().setFieldValue(TRIPACCOMMODATIONS_PROP.get(), value);
  }
  ...
  public void setTripRU(entity.TripRU value) {
    __getInternalInterface().setFieldValue(TRIPRU_PROP.get(), value);
  }
  ...
  public void setTripSegments(entity.TripSegment[] value) {
    __getInternalInterface().setFieldValue(TRIPSEGMENTS_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TripIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TripIncident.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getTripRUID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(TRIPRU_PROP.get());
    }
    ...
    public void setTripRUID(gw.pl.persistence.core.Key value) {
      setFieldValue(TRIPRU_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.TripIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.TripIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.TripIncidentImpl");
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.InsuredClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.TripIncidentCoverageSupplier");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.TripIncidentImpl");
    config.put("gw.cc.exposure.entity.TripIncident", "com.guidewire.cc.domain.exposure.impl.TripIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TripIncident.class, config);
    com.guidewire._generated.entity.TripIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TripIncident, com.guidewire._generated.entity.TripIncidentInternal>() {
      public java.lang.Object getImplementation(entity.TripIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TripIncidentInternal getInternalInterface(entity.TripIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TripIncident newEmptyInstance() {
        return new entity.TripIncident((java.lang.Void)null);
      }
