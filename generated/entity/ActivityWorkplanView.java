...
/**
 * ActivityWorkplanView
 * <p>Aggregates the information needed to display one activity row in the activity workplan page (subtype of ActivityView).</p>
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ActivityWorkplanView.eti;ActivityWorkplanView.eix;ActivityWorkplanView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ActivityWorkplanView")
public class ActivityWorkplanView extends entity.ActivitySearchView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ActivityWorkplanView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ActivityWorkplanView>("entity.ActivityWorkplanView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ASSIGNEDBYUSERNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AssignedByUserName");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLOSEUSERNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CloseUserName");
   ...
   */
  public ActivityWorkplanView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ActivityWorkplanView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ActivityWorkplanViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ActivityWorkplanViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ActivityWorkplanViewInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the AssignedByUserName field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getAssignedByUserName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ASSIGNEDBYUSERNAME_PROP.get());
  }
  ...
  /**
   * Gets the value of the CloseUserName field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getCloseUserName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLOSEUSERNAME_PROP.get());
  }
  ...
  /**
   * Sets the value of the AssignedByUserName field.
   */
  public void setAssignedByUserName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ASSIGNEDBYUSERNAME_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the CloseUserName field.
   */
  public void setCloseUserName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLOSEUSERNAME_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ActivityWorkplanViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ActivityWorkplanView.this.__getDelegateManager();
    }
    ...
    /**
     * Gets the value of the AssignedQueueName field.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getAssignedQueueName() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ASSIGNEDQUEUENAME_PROP.get());
    }
     ...
     * to the user.
     * @return displayable form of the current assignee
     */
    public java.lang.String getAssigneeDisplayString() {
      return ((gw.cc.activity.entity.ActivitySearchView)__getDelegateManager().getImplementation("gw.cc.activity.entity.ActivitySearchView")).getAssigneeDisplayString();
    }
    ...
    /**
     * Gets the value of the ExternalOwnerCCName field.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getExternalOwnerCCName() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EXTERNALOWNERCCNAME_PROP.get());
    }
    ...
    /**
     * Sets the value of the AssignedQueueName field.
     */
    public void setAssignedQueueName(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(ASSIGNEDQUEUENAME_PROP.get(), value);
    }
    ...
    /**
     * Sets the value of the ExternalOwnerCCName field.
     */
    public void setExternalOwnerCCName(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(EXTERNALOWNERCCNAME_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.cc.activity.entity.ActivitySearchView", "com.guidewire.cc.domain.activity.impl.ActivityWorkplanViewImpl");
    config.put("gw.cc.activity.entity.ActivityView", "com.guidewire.cc.domain.activity.impl.ActivityWorkplanViewImpl");
    config.put("gw.cc.activity.entity.ActivityWorkplanView", "com.guidewire.cc.domain.activity.impl.ActivityWorkplanViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ActivityWorkplanView.class, config);
    com.guidewire._generated.entity.ActivityWorkplanViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ActivityWorkplanView, com.guidewire._generated.entity.ActivityWorkplanViewInternal>() {
      public java.lang.Object getImplementation(entity.ActivityWorkplanView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ActivityWorkplanViewInternal getInternalInterface(entity.ActivityWorkplanView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ActivityWorkplanView newEmptyInstance() {
        return new entity.ActivityWorkplanView((java.lang.Void)null);
      }
