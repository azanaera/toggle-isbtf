 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "GeneralValidation.eti;GeneralValidation.eix;GeneralValidation.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "GeneralValidation")
public class GeneralValidation extends entity.ValidationIssue {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GeneralValidation> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GeneralValidation>("entity.GeneralValidation");
   ...
   */
  public GeneralValidation(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GeneralValidation(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.GeneralValidationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GeneralValidationInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.GeneralValidationInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GeneralValidationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GeneralValidation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GeneralValidation.class, config);
    com.guidewire._generated.entity.GeneralValidationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GeneralValidation, com.guidewire._generated.entity.GeneralValidationInternal>() {
      public java.lang.Object getImplementation(entity.GeneralValidation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GeneralValidationInternal getInternalInterface(entity.GeneralValidation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GeneralValidation newEmptyInstance() {
        return new entity.GeneralValidation((java.lang.Void)null);
      }
