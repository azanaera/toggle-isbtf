 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Recovery.eti;Recovery.eix;Recovery.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Recovery")
public class Recovery extends entity.Transaction implements entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Recovery> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Recovery>("entity.Recovery");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> OBOCLAIMCONTACT_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "OBOClaimContact");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> OFFSETTINGRECOVERYRESERVE_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "OffsettingRecoveryReserve");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PAYERDENORM_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PayerDenorm");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RECTORECRESERVESARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RecToRecReservesArray");
  ...
  public static final java.lang.String RECOVERYADDED_EVENT = "RecoveryAdded";
  
  public static final java.lang.String RECOVERYCHANGED_EVENT = "RecoveryChanged";
  
  public static final java.lang.String RECOVERYREMOVED_EVENT = "RecoveryRemoved";
  
  public static final java.lang.String RECOVERYSTATUSCHANGED_EVENT = "RecoveryStatusChanged";
  
  public static final java.lang.String RECOVERYSUBMITTED_EVENT = "RecoverySubmitted";
  
  public static final java.lang.String RECOVERYVOIDED_EVENT = "RecoveryVoided";
   ...
   */
  public Recovery(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Recovery(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RecoveryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RecoveryInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RecoveryInternal)super.__getInternalInterface();
  }
  
  /**
   * Acknowledges a message that this recovery was recoded.
   * Updates its status to RECODED.
   * @throws IllegalStateException if this recovery is not in PENDINGRECODE status
   */
  public void acknowledgeRecode() {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).acknowledgeRecode();
  }
  
  /**
   * Acknowledges a message that this recovery was transferred.
   * Updates its status to TRANSFERRED.
   * @throws IllegalStateException if this recovery is not in PENDINGTRANSFER status
   */
  public void acknowledgeTransfer() {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).acknowledgeTransfer();
  }
  
  /**
   * Acknowledges a message that that this recovery was voided.
   * Updates its status to VOIDED.
   * @throws IllegalStateException if this recovery is not in PENDINGVOID status
   */
  public void acknowledgeVoid() {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).acknowledgeVoid();
  }
  
  /**
   * Creates an onset recovery for recode or transfer. The onset has matching
   * details as its origin, with the following exceptions:
   * The onset is created in a new RecoverySet.
   * The onset initially has a null comment.
   * The onset initially has a status of DRAFT.
   * The onset initially has a lifecyclestate of NEW.
   * 
   * An offset recovery in the negative amount of the origin is also created.
   * The onset and offset recoveries are linked to the origin recovery
   * (via TransactionOffset and TransactionOnset).
   * 
   * This method is intended to be used in conjunction with recode() or transfer().
   * If this method is called but recode() or transfer() is not, a bundle commit will fail
   * because onset recoveries must have a lifecyclestate of COMMITTED before being
   * committed, and only recode() or transfer() will transition it to that state.
   * @throws IllegalStateException if this recovery is not transferrable
   * @return the newly created onset recovery
   */
  public entity.Recovery createOnsetRecovery() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).createOnsetRecovery();
  }
  
  /**
   * Called when recovery is being deleted.  This action does not require approval.
   * @throws IllegalStateException if the recovery status is not one of the
   *          following: TransactionStatus.TC_DENIED
   * @throws InsufficientPermissionException is the financials version parameter is read-only
   */
  public void deleteRecovery() throws com.guidewire.pl.system.exception.InsufficientPermissionException {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).deleteRecovery();
  }
  
  /**
   * Called when recovery is denied by downstream system.  This action does not require approval.
   * @throws IllegalStateException if the recovery status is not one of the
   *          following: TransactionStatus.TC_SUBMITTING,
   *          TransactionStatus.TC_SUBMITTED
   * @throws InsufficientPermissionException is the financials version parameter is read-only
   */
  public void denyRecovery() throws com.guidewire.pl.system.exception.InsufficientPermissionException {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).denyRecovery();
  }
  ...
  public entity.RecoveryCoding getCoding() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).getCoding();
  }
  ...
  public entity.ClaimContact getOBOClaimContact() {
    return (entity.ClaimContact)__getInternalInterface().getFieldValue(OBOCLAIMCONTACT_PROP.get());
  }
  ...
  public entity.RecoveryReserve getOffsettingRecoveryReserve() {
    return (entity.RecoveryReserve)__getInternalInterface().getFieldValue(OFFSETTINGRECOVERYRESERVE_PROP.get());
  }
  
  /**
   * Payer. Shortcut for ClaimContact.Contact.
   * @return the contact that is the On Behalf Of or responsible party of this recovery
   */
  public entity.Contact getOnBehalfOf() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).getOnBehalfOf();
  }
  
  /**
   * The original Recovery for which this transaction is an onset recovery.
   * The original is usually Recoded or Transferred.
   * null if this recovery is not an onset
   * @return the recovery for which this recovery is an onset, if any. null if not an onset.
   */
  public entity.Recovery getOnsetOriginalRecovery() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).getOnsetOriginalRecovery();
  }
  
  /**
   * Payer. Shortcut for ClaimContact.Contact.
   * @return the contact that is the payer of this recovery
   */
  public entity.Contact getPayer() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).getPayer();
  }
  ...
  public entity.Contact getPayerDenorm() {
    return (entity.Contact)__getInternalInterface().getFieldValue(PAYERDENORM_PROP.get());
  }
  ...
  public entity.RecToRecReserves[] getRecToRecReservesArray() {
    return (entity.RecToRecReserves[])__getInternalInterface().getFieldValue(RECTORECRESERVESARRAY_PROP.get());
  }
  
  /**
   * If this is an offset recovery, retrieves the recovery that is being offset.  If this is not
   * an offset recovery, returns NULL.
   * @return the recovery being offset by this recovery, if any, else returns NULL.
   */
  public entity.Recovery getRecoveryBeingOffset() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).getRecoveryBeingOffset();
  }
  ...
  /**
   * If this recovery is offsetting another recovery, returns true.
   * @return true if this recovery offsets another recovery.
   */
  public boolean isOffsetRecovery() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).isOffsetRecovery();
  }
  
  /**
   * Returns true iff all the following conditions for this recovery hold:
   * This recovery is not new.
   * This recovery has neither an onset nor an offset recovery.
   * This recovery is not an offset for another recovery.
   * This recovery has a status of SUBMITTING or SUBMITTED.
   * @return true if this recovery can be recoded, false otherwise
   */
  public boolean isRecodeable() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).isRecodeable();
  }
  
  /**
   * True if this recovery is resubmittable. Specifically, its status is one of the following:
   * <ul>
   * <li>{@link typekey.TransactionStatus#TC_DENIED}
   * </ul>
   * and it is not an offset recovery.
   * @return true if this recovery is resubmittable, false otherwise
   */
  public boolean isResubmittable() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).isResubmittable();
  }
   ...
   * This recovery is not an offset for another recovery.
   * This recovery has a status of SUBMITTING or SUBMITTED.
   * @return true if this recovery can be transferable, false otherwise
   */
  public boolean isTransferable() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).isTransferable();
  }
  
  /**
   * True if the system is configured to use recovery reserves.
   * @return true if the system is configured to use recovery reserves, false otherwise
   */
  public boolean isUseRecoveryReserves() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).isUseRecoveryReserves();
  }
  
  /**
   * <p>
   * Identifies whether a <code>Recovery</code> entity is voidable or not.  An entity is voidable if it is not a an offset
   * recovery and its <code>TransactionStatus</code> status is <code>SUBMITTING</code> or <code>SUBMITTED</code>.
   * @return True if the <code>Recovery</code> and false if it is not.
   */
  public boolean isVoidable() {
    return ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).isVoidable();
  }
  
  /**
   * Logs a message about voiding this Recovery.
   */
  public void logVoid() {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).logVoid();
  }
  
  /**
   * Recodes this recovery (the origin) to its onset recovery. The onset should have
   * first been created by calling createOnsetRecovery().
   * 
   * The origin must have a status of SUBMITTING or SUBMITTED.
   * The onset cannot be null and must be new, and it must be in NEW lifecyclestate.
   * The onset's transaction amount must match the origin's transaction amount.
   * If any of these requirements are not satisfied, an IllegalStateException
   * is thrown.
   * 
   * The onset must differ from the origin in at least one of the following fields:
   * exposure, cost type, cost category, or one of its line item's line categories.
   * If none of these fields are changed from the origin, a UserDisplayableException is thrown.
   * 
   * Upon transfer, the onset's reserve line is correctly set (if not already done so)
   * based on the exposure, cost type, and cost category.
   * The onset is transitioned to COMMITTED lifecyclestate.
   * The onset's RecoverySet's claim is set to the onset's claim.
   * The origin's status is set to PENDINGRECODE.
   * If recovery reserves are enabled, any zeroing offset on the original recovery is undone,
   * and a zeroing offset is created on the onset recovery (if necessary).
   * @throws IllegalStateException if this recovery's onset is not a valid recovery to be transferred to
   * @throws com.guidewire.pl.web.controller.UserDisplayableException if this recovery's onset
   * does not have a changed exposure/cost type/cost category/line category
   */
  public void recode() {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).recode();
  }
  
  /**
   * Called when recovery is being resumbmitted.  This action does not require approval.
   * @throws IllegalStateException if the recovery status is not one of the
   *          following: TransactionStatus.TC_DENIED
   * @throws InsufficientPermissionException is the financials version parameter is read-only
   */
  public void resubmitRecovery() throws com.guidewire.pl.system.exception.InsufficientPermissionException {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).resubmitRecovery();
  }
  ...
  public void setOBOClaimContact(entity.ClaimContact value) {
    __getInternalInterface().setFieldValue(OBOCLAIMCONTACT_PROP.get(), value);
  }
  
  /**
   * Sets the value of the OffsettingRecoveryReserve field.
   */
  private void setOffsettingRecoveryReserve(entity.RecoveryReserve value) {
    __getInternalInterface().setFieldValue(OFFSETTINGRECOVERYRESERVE_PROP.get(), value);
  }
  
  /**
   * Payer. Shortcut for ClaimContact.Contact.
   * @param value the contact to be set as the On Behalf of for this recovery
   */
  public void setOnBehalfOf(entity.Contact value) {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).setOnBehalfOf(value);
  }
  
  /**
   * Payer. Shortcut for ClaimContact.Contact.
   * @param value the contact to be set as the payer of this recovery
   */
  public void setPayer(entity.Contact value) {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).setPayer(value);
  }
  ...
  public void setPayerDenorm(entity.Contact value) {
    __getInternalInterface().setFieldValue(PAYERDENORM_PROP.get(), value);
  }
  
  /**
   * Sets the value of the RecToRecReservesArray field.
   */
  private void setRecToRecReservesArray(entity.RecToRecReserves[] value) {
    __getInternalInterface().setFieldValue(RECTORECRESERVESARRAY_PROP.get(), value);
  }
  ...
  /**
   * Transfers this recovery (the origin) to its onset recovery. The onset should have
   * first been created by calling createOnsetRecovery().
   * 
   * The origin must have a status of SUBMITTING or SUBMITTED.
   * The onset cannot be null and must be new, and it must be in NEW lifecyclestate.
   ...
   * The onset must differ from the origin in at least one of the following fields:
   * exposure, cost type, cost category, or one of its line item's line categories.
   * The onset's claim must differ from the origin's claim.
   * If any of these requirements are not satisfied, a UserDisplayableException is thrown.
   * 
   * Upon transfer, the onset's reserve line is correctly set (if not already done so)
   * based on the exposure, cost type, and cost category.
   * The onset is transitioned to COMMITTED lifecyclestate.
   * The onset's RecoverySet's claim is set to the onset's claim.
   * The origin's status is set to PENDINGTRANSFER.
   * If recovery reserves are enabled, any zeroing offset on the original recovery is undone,
   * and a zeroing offset is created on the onset recovery (if necessary).
   * @throws IllegalStateException if this recovery's onset is not a valid recovery to be transferred to
   * @throws com.guidewire.pl.web.controller.UserDisplayableException if this recovery's onset
   * does not have a changed exposure/cost type/cost category/line category, or if the onset's claim
   * has not changed
   */
  public void transfer() {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).transfer();
  }
  
  /**
   * Voids a <code>Recovery</code> entity.  This action does not require approval.
   * @throws IllegalStateException if the recovery status is not either
   * <code>TransactionStatus.SUBMITTING</code> or <code>TransactionStatus.SUBMITTED</code>.
   * @throws InsufficientPermissionException if the financials version parameter is read-only.
   */
  public void voidRecovery() throws com.guidewire.pl.system.exception.InsufficientPermissionException {
    ((gw.cc.financials.recovery.entity.Recovery)__getDelegateManager().getImplementation("gw.cc.financials.recovery.entity.Recovery")).voidRecovery();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RecoveryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Recovery.this.__getDelegateManager();
    }
    ...
    public void addToRecToRecReservesArray(entity.RecToRecReserves element) {
      __getInternalInterface().addArrayElement(RECTORECRESERVESARRAY_PROP.get(), element);
    }
    ...
    public entity.Recovery createOffsetRecovery() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).createOffsetRecovery();
    }
    ...
    public entity.RecoveryReserve createZeroingRecoveryReserve() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).createZeroingRecoveryReserve();
    }
     ...
     * Normally the Date and time when Transaction status was updated to Submitted. See Docs for other cases, such as when imported via Web Service or Staging Tables.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.util.Date getBookingDate() {
      return (java.util.Date)__getInternalInterface().getFieldValue(BOOKINGDATE_PROP.get());
    }
    ...
    public gw.pl.persistence.core.Key getOBOClaimContactID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(OBOCLAIMCONTACT_PROP.get());
    }
    
    public entity.Recovery getOffset() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).getOffset();
    }
    ...
    public gw.pl.persistence.core.Key getOffsettingRecoveryReserveID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(OFFSETTINGRECOVERYRESERVE_PROP.get());
    }
    ...
    public entity.Recovery getOnset() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).getOnset();
    }
    ...
    public gw.pl.persistence.core.Key getPayerDenormID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PAYERDENORM_PROP.get());
    }
    
    public gw.pl.persistence.core.Key getPayerID() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).getPayerID();
    }
    ...
    public entity.RecoveryReserve getZeroingOffsetRecoveryReserve() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).getZeroingOffsetRecoveryReserve();
    }
    ...
    public void removeFromRecToRecReservesArray(entity.RecToRecReserves element) {
      __getInternalInterface().removeArrayElement(RECTORECRESERVESARRAY_PROP.get(), element);
    }
    ...
    public void removeFromRecToRecReservesArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(RECTORECRESERVESARRAY_PROP.get(), elementID);
    }
    ...
    public void setBookingDate(java.util.Date value) {
      __getInternalInterface().setFieldValue(BOOKINGDATE_PROP.get(), value);
    }
    ...
    public void setOBOClaimContactID(gw.pl.persistence.core.Key value) {
      setFieldValue(OBOCLAIMCONTACT_PROP.get(), value);
    }
    ...
    public void setOffsettingRecoveryReserveID(gw.pl.persistence.core.Key value) {
      setFieldValue(OFFSETTINGRECOVERYRESERVE_PROP.get(), value);
    }
    ...
    public void setPayerDenormID(gw.pl.persistence.core.Key value) {
      setFieldValue(PAYERDENORM_PROP.get(), value);
    }
    
    public void setPayerID(gw.pl.persistence.core.Key value) {
      ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).setPayerID(value);
    }
    ...
    public void updateDenormalizedPayer() {
      ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).updateDenormalizedPayer();
    }
    
    public void updatePayerAfterTransfer() {
      ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).updatePayerAfterTransfer();
    }
    ...
    public entity.RecoveryReserve zeroRecoveryReserveInAllDimensions() {
      return ((com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal")).zeroRecoveryReserveInAllDimensions();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.impl.TransactionInternal", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    config.put("com.guidewire.cc.domain.financials.recovery.impl.RecoveryInternal", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    ...
    config.put("com.guidewire.cc.domain.financials.taccount.impl.TransactionTAccountOperationsDelegateInternal", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    config.put("com.guidewire.pl.system.bundle.RemoveCallback", "com.guidewire.cc.domain.financials.impl.TransactionImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    config.put("gw.cc.financials.entity.Transaction", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    config.put("gw.cc.financials.recovery.entity.Recovery", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    config.put("gw.cc.financials.taccount.entity.TransactionTAccountOperationsDelegate", "com.guidewire.cc.domain.financials.recovery.impl.RecoveryImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Recovery.class, config);
    com.guidewire._generated.entity.RecoveryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Recovery, com.guidewire._generated.entity.RecoveryInternal>() {
      public java.lang.Object getImplementation(entity.Recovery bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RecoveryInternal getInternalInterface(entity.Recovery bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Recovery newEmptyInstance() {
        return new entity.Recovery((java.lang.Void)null);
      }
