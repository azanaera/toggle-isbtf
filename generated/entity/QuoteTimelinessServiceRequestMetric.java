 ...
 * Actual vs. expected quote completion time.  Only applicable to quote and service and quote-only service requests.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "QuoteTimelinessServiceRequestMetric.eti;QuoteTimelinessServiceRequestMetric.eix;QuoteTimelinessServiceRequestMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "QuoteTimelinessServiceRequestMetric")
public class QuoteTimelinessServiceRequestMetric extends entity.TimeBasedServiceRequestMetric implements entity.ServiceRequestMetricEscalationDelegate {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.QuoteTimelinessServiceRequestMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.QuoteTimelinessServiceRequestMetric>("entity.QuoteTimelinessServiceRequestMetric");
   ...
   */
  public QuoteTimelinessServiceRequestMetric()  {
   ...
   */
  public QuoteTimelinessServiceRequestMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected QuoteTimelinessServiceRequestMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.QuoteTimelinessServiceRequestMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.CalculatedLimitMethods", "gw.vendormanagement.metric.QuoteTimelinessServiceRequestMetricMethodsImpl");
    config.put("gw.api.metric.MetricMethods", "gw.vendormanagement.metric.QuoteTimelinessServiceRequestMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.QuoteTimelinessServiceRequestMetric.class, config);
    com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.QuoteTimelinessServiceRequestMetric, com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternal>() {
      public java.lang.Object getImplementation(entity.QuoteTimelinessServiceRequestMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.QuoteTimelinessServiceRequestMetricInternal getInternalInterface(entity.QuoteTimelinessServiceRequestMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.QuoteTimelinessServiceRequestMetric newEmptyInstance() {
        return new entity.QuoteTimelinessServiceRequestMetric((java.lang.Void)null);
      }
