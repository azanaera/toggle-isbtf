 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Attorney.eti;Attorney.eix;Attorney.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Attorney")
public class Attorney extends entity.PersonVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Attorney> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Attorney>("entity.Attorney");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ATTORNEYLICENSE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AttorneyLicense");
   ...
   */
  public Attorney(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Attorney(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AttorneyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AttorneyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AttorneyInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getAttorneyLicense() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ATTORNEYLICENSE_PROP.get());
  }
  ...
  public void setAttorneyLicense(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ATTORNEYLICENSE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AttorneyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Attorney.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Attorney.class, config);
    com.guidewire._generated.entity.AttorneyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Attorney, com.guidewire._generated.entity.AttorneyInternal>() {
      public java.lang.Object getImplementation(entity.Attorney bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AttorneyInternal getInternalInterface(entity.Attorney bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Attorney newEmptyInstance() {
        return new entity.Attorney((java.lang.Void)null);
      }
