...
@gw.entity.EntityName(value = "DestinationLeaseHistory")
public class DestinationLeaseHistory extends com.guidewire.pl.persistence.code.BeanBase implements entity.LeaseHistory, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DestinationLeaseHistory> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DestinationLeaseHistory>("entity.DestinationLeaseHistory");
  ...
  private com.guidewire._generated.entity.DestinationLeaseHistoryInternal _internal;
   ...
   */
  public DestinationLeaseHistory()  {
   ...
   */
  public DestinationLeaseHistory(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DestinationLeaseHistory(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DestinationLeaseHistoryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DestinationLeaseHistoryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DestinationLeaseHistoryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DestinationLeaseHistory.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DestinationLeaseHistory.class, config);
    com.guidewire._generated.entity.DestinationLeaseHistoryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DestinationLeaseHistory, com.guidewire._generated.entity.DestinationLeaseHistoryInternal>() {
      public java.lang.Object getImplementation(entity.DestinationLeaseHistory bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DestinationLeaseHistoryInternal getInternalInterface(entity.DestinationLeaseHistory bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DestinationLeaseHistory newEmptyInstance() {
        return new entity.DestinationLeaseHistory((java.lang.Void)null);
      }
