 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MessageContext.eti;MessageContext.eix;MessageContext.etx")
...
public class MessageContext extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  ...
  /**
   * Creates a Message object by copying another message.
   * Messages created by this method will automatically be sent.
   * @param msg The message to copy.
   */
  public entity.Message createMessage(entity.Message msg) {
    return ((com.guidewire.pl.domain.messaging.MessageContextPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.messaging.MessageContextPublicMethods")).createMessage(msg);
  }
  
  /**
   * Creates a Message object. Messages created by this method will automatically be sent.
   * @param payLoad The non-null payload for this message.
   */
  public entity.Message createMessage(java.lang.String payLoad) {
    return ((com.guidewire.pl.domain.messaging.MessageContextPublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.messaging.MessageContextPublicMethods")).createMessage(payLoad);
  }
