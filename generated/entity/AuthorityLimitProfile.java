 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AuthorityLimitProfile.eti;AuthorityLimitProfile.eix;AuthorityLimitProfile.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AuthorityLimitProfile")
public class AuthorityLimitProfile extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable, entity.EventAware {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AuthorityLimitProfile> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AuthorityLimitProfile>("entity.AuthorityLimitProfile");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CUSTOM_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "Custom");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> LIMITS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Limits");
  ...
  private com.guidewire._generated.entity.AuthorityLimitProfileInternal _internal;
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  public static final gw.api.community.PublicAuthorityLimitProfileFinder finder = gw.cc.community.entity.AuthorityLimitProfile.finder;
  
  public static final java.lang.String AUTHORITYLIMITPROFILEADDED_EVENT = "AuthorityLimitProfileAdded";
  
  public static final java.lang.String AUTHORITYLIMITPROFILECHANGED_EVENT = "AuthorityLimitProfileChanged";
  
  public static final java.lang.String AUTHORITYLIMITPROFILEREMOVED_EVENT = "AuthorityLimitProfileRemoved";
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public AuthorityLimitProfile()  {
   ...
   */
  public AuthorityLimitProfile(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AuthorityLimitProfile(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AuthorityLimitProfileInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AuthorityLimitProfileInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToLimits(entity.AuthorityLimit element) {
    __getInternalInterface().addArrayElement(LIMITS_PROP.get(), element);
  }
  ...
  public entity.AuthorityLimitProfile_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.AuthorityLimitProfile_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.AuthorityLimit[] getLimits() {
    return (entity.AuthorityLimit[])__getInternalInterface().getFieldValue(LIMITS_PROP.get());
  }
  ...
  public entity.AuthorityLimitProfile_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.AuthorityLimitProfile_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public java.lang.Boolean isCustom() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(CUSTOM_PROP.get());
  }
   ...
   */
  @com.guidewire.pl.persistence.codegen.annotation.OverridesAccessor
  public void removeFromLimits(entity.AuthorityLimit value) {
    ((gw.cc.community.entity.AuthorityLimitProfile)__getDelegateManager().getImplementation("gw.cc.community.entity.AuthorityLimitProfile")).removeFromLimits(value);
  }
  ...
  public void removeFromLimits(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(LIMITS_PROP.get(), elementID);
  }
  ...
  public void setCustom(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(CUSTOM_PROP.get(), value);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.AuthorityLimitProfile_Description_L10N[] value) {
  ...
  public void setLimits(entity.AuthorityLimit[] value) {
    __getInternalInterface().setFieldValue(LIMITS_PROP.get(), value);
  }
   ...
   */
  private void setName_L10N_ARRAY(entity.AuthorityLimitProfile_Name_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AuthorityLimitProfileInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AuthorityLimitProfile.this.__getDelegateManager();
    }
    ...
    public void clearLimits() {
      ((com.guidewire.cc.domain.community.impl.AuthorityLimitProfileInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.community.impl.AuthorityLimitProfileInternal")).clearLimits();
    }
    ...
    public void delete() throws com.guidewire.cc.system.exception.AuthorityProfileInUseException {
      ((com.guidewire.cc.domain.community.impl.AuthorityLimitProfileInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.community.impl.AuthorityLimitProfileInternal")).delete();
    }
    ...
    public entity.AuthorityLimitProfile_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.AuthorityLimitProfile_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.AuthorityLimitProfile_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.AuthorityLimitProfile_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.community.impl.AuthorityLimitProfileInternal", "com.guidewire.cc.domain.community.impl.AuthorityLimitProfileImpl");
    ...
    config.put("gw.cc.community.entity.AuthorityLimitProfile", "com.guidewire.cc.domain.community.impl.AuthorityLimitProfileImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AuthorityLimitProfile.class, config);
    com.guidewire._generated.entity.AuthorityLimitProfileInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AuthorityLimitProfile, com.guidewire._generated.entity.AuthorityLimitProfileInternal>() {
      public java.lang.Object getImplementation(entity.AuthorityLimitProfile bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AuthorityLimitProfileInternal getInternalInterface(entity.AuthorityLimitProfile bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AuthorityLimitProfile newEmptyInstance() {
        return new entity.AuthorityLimitProfile((java.lang.Void)null);
      }
