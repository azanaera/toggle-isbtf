 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BPProfilerConfig.eti;BPProfilerConfig.eix;BPProfilerConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BPProfilerConfig")
public class BPProfilerConfig extends entity.ProfilerConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BPProfilerConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BPProfilerConfig>("entity.BPProfilerConfig");
   ...
   */
  public BPProfilerConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BPProfilerConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.BPProfilerConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BPProfilerConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.BPProfilerConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BPProfilerConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BPProfilerConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BPProfilerConfig.class, config);
    com.guidewire._generated.entity.BPProfilerConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BPProfilerConfig, com.guidewire._generated.entity.BPProfilerConfigInternal>() {
      public java.lang.Object getImplementation(entity.BPProfilerConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BPProfilerConfigInternal getInternalInterface(entity.BPProfilerConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BPProfilerConfig newEmptyInstance() {
        return new entity.BPProfilerConfig((java.lang.Void)null);
      }
