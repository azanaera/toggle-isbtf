 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ref_WC_PD_WeeksAndLimits.eti;ref_WC_PD_WeeksAndLimits.eix;ref_WC_PD_WeeksAndLimits.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ref_WC_PD_WeeksAndLimits")
public class ref_WC_PD_WeeksAndLimits extends com.guidewire.pl.persistence.code.BeanBase implements entity.WC_PD_LimitsDelegate, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ref_WC_PD_WeeksAndLimits> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ref_WC_PD_WeeksAndLimits>("entity.ref_WC_PD_WeeksAndLimits");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DISABILITYPERCENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DisabilityPercent");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PD_NUMWEEKS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PD_NumWeeks");
  ...
  private com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternal _internal;
   ...
   */
  public ref_WC_PD_WeeksAndLimits()  {
   ...
   */
  public ref_WC_PD_WeeksAndLimits(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ref_WC_PD_WeeksAndLimits(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.math.BigDecimal getDisabilityPercent() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(DISABILITYPERCENT_PROP.get());
  }
  ...
  public java.math.BigDecimal getPD_NumWeeks() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PD_NUMWEEKS_PROP.get());
  }
  ...
  public void setDisabilityPercent(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(DISABILITYPERCENT_PROP.get(), value);
  }
  ...
  public void setPD_NumWeeks(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PD_NUMWEEKS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ref_WC_PD_WeeksAndLimits.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.exposure.impl.WC_PD_LimitsDelegateInternal", "com.guidewire.cc.domain.exposure.impl.ref_WC_PD_WeeksAndLimitsImpl");
    ...
    config.put("gw.cc.exposure.entity.WC_PD_LimitsDelegate", "com.guidewire.cc.domain.exposure.impl.ref_WC_PD_WeeksAndLimitsImpl");
    config.put("gw.cc.exposure.entity.ref_WC_PD_WeeksAndLimits", "com.guidewire.cc.domain.exposure.impl.ref_WC_PD_WeeksAndLimitsImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ref_WC_PD_WeeksAndLimits.class, config);
    com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ref_WC_PD_WeeksAndLimits, com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternal>() {
      public java.lang.Object getImplementation(entity.ref_WC_PD_WeeksAndLimits bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ref_WC_PD_WeeksAndLimitsInternal getInternalInterface(entity.ref_WC_PD_WeeksAndLimits bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ref_WC_PD_WeeksAndLimits newEmptyInstance() {
        return new entity.ref_WC_PD_WeeksAndLimits((java.lang.Void)null);
      }
