...
/**
 * MoneyExposureMetricLimit
 * Money based exposure metric limit.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MoneyExposureMetricLimit.eti;MoneyExposureMetricLimit.eix;MoneyExposureMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MoneyExposureMetricLimit")
public class MoneyExposureMetricLimit extends entity.ExposureMetricLimit implements entity.MoneyMetricLimitDelegate, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MoneyExposureMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MoneyExposureMetricLimit>("entity.MoneyExposureMetricLimit");
   ...
   */
  public MoneyExposureMetricLimit()  {
   ...
   */
  public MoneyExposureMetricLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MoneyExposureMetricLimit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.MoneyExposureMetricLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MoneyExposureMetricLimitInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.MoneyExposureMetricLimitInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MoneyExposureMetricLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MoneyExposureMetricLimit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.exposure.metric.impl.ExposureMetricLimitInternal", "com.guidewire.cc.domain.exposure.metric.impl.MoneyExposureMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.CopyOnWriteMetricLimitDelegateInternal", "com.guidewire.cc.domain.exposure.metric.impl.MoneyExposureMetricLimitImpl");
    ...
    config.put("gw.api.metric.MetricLimit", "gw.api.exposure.metric.MoneyExposureMetricLimitMethodsImpl");
    config.put("gw.api.metric.MetricLimitMethods", "gw.api.exposure.metric.MoneyExposureMetricLimitMethodsImpl");
    config.put("gw.cc.exposure.metric.entity.ExposureMetricLimit", "com.guidewire.cc.domain.exposure.metric.impl.MoneyExposureMetricLimitImpl");
    config.put("gw.cc.exposure.metric.entity.MoneyExposureMetricLimit", "com.guidewire.cc.domain.exposure.metric.impl.MoneyExposureMetricLimitImpl");
    config.put("gw.cc.metric.entity.CopyOnWriteMetricLimitDelegate", "com.guidewire.cc.domain.exposure.metric.impl.MoneyExposureMetricLimitImpl");
    config.put("gw.cc.metric.entity.MoneyMetricLimitDelegate", "com.guidewire.cc.domain.exposure.metric.impl.MoneyExposureMetricLimitImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MoneyExposureMetricLimit.class, config);
    com.guidewire._generated.entity.MoneyExposureMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MoneyExposureMetricLimit, com.guidewire._generated.entity.MoneyExposureMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.MoneyExposureMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MoneyExposureMetricLimitInternal getInternalInterface(entity.MoneyExposureMetricLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MoneyExposureMetricLimit newEmptyInstance() {
        return new entity.MoneyExposureMetricLimit((java.lang.Void)null);
      }
