 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Parameter.eti;Parameter.eix;Parameter.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Parameter")
public class Parameter extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Parameter> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Parameter>("entity.Parameter");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> COMPONENTTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ComponentType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LONGTEXTVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LongTextValue");
  ...
  private com.guidewire._generated.entity.ParameterInternal _internal;
   ...
   */
  public Parameter(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Parameter(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ParameterInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ParameterInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ComponentType getComponentType() {
    return (typekey.ComponentType)__getInternalInterface().getFieldValue(COMPONENTTYPE_PROP.get());
  }
  ...
  public java.lang.String getLongTextValue() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LONGTEXTVALUE_PROP.get());
  }
  ...
  public typekey.ParameterType getParameterType() {
    return (typekey.ParameterType)__getInternalInterface().getFieldValue(PARAMETERTYPE_PROP.get());
  }
  ...
  public void setComponentType(typekey.ComponentType value) {
    __getInternalInterface().setFieldValue(COMPONENTTYPE_PROP.get(), value);
  }
  ...
  public void setLongTextValue(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LONGTEXTVALUE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ParameterInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Parameter.this.__getDelegateManager();
    }
    ...
    public java.lang.Object getValue() {
      return ((com.guidewire.pl.domain.parameter.impl.ParameterInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.parameter.impl.ParameterInternalMethods")).getValue();
    }
    ...
    public void setValue(java.lang.Object object) {
      ((com.guidewire.pl.domain.parameter.impl.ParameterInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.parameter.impl.ParameterInternalMethods")).setValue(object);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.parameter.impl.ParameterInternalMethods", "com.guidewire.pl.domain.parameter.impl.ParameterImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Parameter.class, config);
    com.guidewire._generated.entity.ParameterInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Parameter, com.guidewire._generated.entity.ParameterInternal>() {
      public java.lang.Object getImplementation(entity.Parameter bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ParameterInternal getInternalInterface(entity.Parameter bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Parameter newEmptyInstance() {
        return new entity.Parameter((java.lang.Void)null);
      }
