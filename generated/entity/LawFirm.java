 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LawFirm.eti;LawFirm.eix;LawFirm.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LawFirm")
public class LawFirm extends entity.CompanyVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LawFirm> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LawFirm>("entity.LawFirm");
   ...
   */
  public LawFirm(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LawFirm(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LawFirmInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LawFirmInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LawFirmInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LawFirmInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LawFirm.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LawFirm.class, config);
    com.guidewire._generated.entity.LawFirmInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LawFirm, com.guidewire._generated.entity.LawFirmInternal>() {
      public java.lang.Object getImplementation(entity.LawFirm bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LawFirmInternal getInternalInterface(entity.LawFirm bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LawFirm newEmptyInstance() {
        return new entity.LawFirm((java.lang.Void)null);
      }
