 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "WorkflowActionLog.eti;WorkflowActionLog.eix;WorkflowActionLog.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "WorkflowActionLog")
public class WorkflowActionLog extends entity.WorkflowLogEntry {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WorkflowActionLog> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WorkflowActionLog>("entity.WorkflowActionLog");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STEPID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StepId");
   ...
   */
  public WorkflowActionLog(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WorkflowActionLog(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WorkflowActionLogInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkflowActionLogInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WorkflowActionLogInternal)super.__getInternalInterface();
  }
  ...
  public typekey.WorkflowActionType getAction() {
    return (typekey.WorkflowActionType)__getInternalInterface().getFieldValue(ACTION_PROP.get());
  }
  ...
  public java.lang.String getStepId() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(STEPID_PROP.get());
  }
  
  /**
   * Sets the value of the Action field.
   */
  private void setAction(typekey.WorkflowActionType value) {
   ...
   */
  private void setStepId(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(STEPID_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkflowActionLogInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkflowActionLog.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.workflow.WorkflowLogEntryPublicMethods", "com.guidewire.pl.domain.workflow.impl.WorkflowActionLogImpl");
    config.put("com.guidewire.pl.persistence.core.BeanMethods", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkflowActionLog.class, config);
    com.guidewire._generated.entity.WorkflowActionLogInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkflowActionLog, com.guidewire._generated.entity.WorkflowActionLogInternal>() {
      public java.lang.Object getImplementation(entity.WorkflowActionLog bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkflowActionLogInternal getInternalInterface(entity.WorkflowActionLog bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkflowActionLog newEmptyInstance() {
        return new entity.WorkflowActionLog((java.lang.Void)null);
      }
