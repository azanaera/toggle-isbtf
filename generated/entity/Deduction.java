...
/**
 * Deduction
 * A deduction from a check, usually for tax purposes.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Deduction.eti;Deduction.eix;Deduction.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Deduction")
public class Deduction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Deduction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Deduction>("entity.Deduction");
  ...
  private com.guidewire._generated.entity.DeductionInternal _internal;
   ...
   */
  public Deduction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Deduction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.DeductionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DeductionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * defers to {@link #getReservingAmount}; in multicurrency mode, that method should be preferred
   */
  public gw.api.financials.CurrencyAmount getAmount() {
    return ((gw.cc.financials.check.entity.Deduction)__getDelegateManager().getImplementation("gw.cc.financials.check.entity.Deduction")).getAmount();
  }
  ...
  /**
   * Gets this deduction's check's currency. Required by the currencyamount datatype to resolve the check currency.
   * Care must be taken when calling this. Attempts to call this method before wiring the deduction to a check will
   * result in an exception being thrown.
   */
  public typekey.Currency getCheckCurrency() {
    return ((gw.cc.financials.check.entity.Deduction)__getDelegateManager().getImplementation("gw.cc.financials.check.entity.Deduction")).getCheckCurrency();
  }
  ...
  /**
   * Gets this deduction's claim's currency. Required by the currencyamount datatype to resolve the claim currency.
   */
  public typekey.Currency getClaimCurrency() {
    return ((gw.cc.financials.check.entity.Deduction)__getDelegateManager().getImplementation("gw.cc.financials.check.entity.Deduction")).getClaimCurrency();
  }
  ...
  /**
   * Gets this deduction's check's reserving currency. Required by the currencyamount datatype to
   * resolve the reserving currency.
   * Care must be taken when calling this. Attempts to call this method before wiring the deduction to a check and
   * the check to a payment will result in an exception being thrown.
   */
  public typekey.Currency getReservingCurrency() {
    return ((gw.cc.financials.check.entity.Deduction)__getDelegateManager().getImplementation("gw.cc.financials.check.entity.Deduction")).getReservingCurrency();
  }
  ...
  /**
   * Gets the <tt>TransactionAmount</tt> paired with the <tt>ReservingAmount</tt>.
   */
  public gw.api.financials.CurrencyAmountPair getTransactionCurrencyAmountComponent() {
    return ((gw.cc.financials.check.entity.Deduction)__getDelegateManager().getImplementation("gw.cc.financials.check.entity.Deduction")).getTransactionCurrencyAmountComponent();
  }
  ...
  /**
   * defers to {@link #setReservingAmount(gw.api.financials.CurrencyAmount) in multicurrency mode, that method should be preferred
   * @param amount 
   */
  public void setAmount(gw.api.financials.CurrencyAmount amount) {
    ((gw.cc.financials.check.entity.Deduction)__getDelegateManager().getImplementation("gw.cc.financials.check.entity.Deduction")).setAmount(amount);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DeductionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Deduction.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.check.impl.DeductionInternal", "com.guidewire.cc.domain.financials.check.impl.DeductionImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.financials.check.impl.DeductionImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.financials.check.impl.DeductionImpl");
    config.put("gw.cc.financials.check.entity.Deduction", "com.guidewire.cc.domain.financials.check.impl.DeductionImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Deduction.class, config);
    com.guidewire._generated.entity.DeductionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Deduction, com.guidewire._generated.entity.DeductionInternal>() {
      public java.lang.Object getImplementation(entity.Deduction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DeductionInternal getInternalInterface(entity.Deduction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Deduction newEmptyInstance() {
        return new entity.Deduction((java.lang.Void)null);
      }
