 ...
 *   
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TAccountLineItem.eti;TAccountLineItem.eix;TAccountLineItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TAccountLineItem")
public class TAccountLineItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.TAccountLineItemDelegate, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TAccountLineItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TAccountLineItem>("entity.TAccountLineItem");
  ...
  private com.guidewire._generated.entity.TAccountLineItemInternal _internal;
   ...
   */
  protected TAccountLineItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TAccountLineItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TAccountLineItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TAccountLineItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.TAccountTransaction getCreditingTransaction() {
    return (entity.TAccountTransaction)__getInternalInterface().getFieldValue(CREDITINGTRANSACTION_PROP.get());
  }
  ...
  public entity.TAccountTransaction getDebitingTransaction() {
    return (entity.TAccountTransaction)__getInternalInterface().getFieldValue(DEBITINGTRANSACTION_PROP.get());
  }
  ...
  public entity.TAccountTransaction getDenormTransaction() {
    return (entity.TAccountTransaction)__getInternalInterface().getFieldValue(DENORMTRANSACTION_PROP.get());
  }
  ...
  public entity.TAccount getTAccount() {
    return (entity.TAccount)__getInternalInterface().getFieldValue(TACCOUNT_PROP.get());
  }
   ...
   */
  private void setCreditingTransaction(entity.TAccountTransaction value) {
   ...
   */
  private void setDebitingTransaction(entity.TAccountTransaction value) {
   ...
   */
  private void setDenormTransaction(entity.TAccountTransaction value) {
   ...
   */
  private void setTAccount(entity.TAccount value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TAccountLineItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TAccountLineItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.taccount.TAccountLineItemDelegateAdapter", "com.guidewire.cc.domain.financials.taccount.impl.TAccountLineItemDelegateAdapterNormalImpl");
    config.put("com.guidewire.cc.domain.financials.taccount.impl.TAccountLineItemDelegateInternal", "com.guidewire.cc.domain.financials.taccount.impl.TAccountLineItemImpl");
    ...
    config.put("gw.cc.financials.taccount.entity.TAccountLineItem", "com.guidewire.cc.domain.financials.taccount.impl.TAccountLineItemImpl");
    config.put("gw.cc.financials.taccount.entity.TAccountLineItemDelegate", "com.guidewire.cc.domain.financials.taccount.impl.TAccountLineItemImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TAccountLineItem.class, config);
    com.guidewire._generated.entity.TAccountLineItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TAccountLineItem, com.guidewire._generated.entity.TAccountLineItemInternal>() {
      public java.lang.Object getImplementation(entity.TAccountLineItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TAccountLineItemInternal getInternalInterface(entity.TAccountLineItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TAccountLineItem newEmptyInstance() {
        return new entity.TAccountLineItem((java.lang.Void)null);
      }
