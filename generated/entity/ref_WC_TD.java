 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ref_WC_TD.eti;ref_WC_TD.eix;ref_WC_TD.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ref_WC_TD")
public class ref_WC_TD extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ref_WC_TD> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ref_WC_TD>("entity.ref_WC_TD");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TD_BENEFITENDDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TD_BenefitEndDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TD_BENEFITSTARTDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TD_BenefitStartDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TD_MAX_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TD_Max");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TD_MIN_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TD_Min");
  ...
  private com.guidewire._generated.entity.ref_WC_TDInternal _internal;
   ...
   */
  public ref_WC_TD(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ref_WC_TD(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ref_WC_TDInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ref_WC_TDInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.util.Date getTD_BenefitEndDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(TD_BENEFITENDDATE_PROP.get());
  }
  ...
  public java.util.Date getTD_BenefitStartDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(TD_BENEFITSTARTDATE_PROP.get());
  }
  ...
  public java.math.BigDecimal getTD_Max() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(TD_MAX_PROP.get());
  }
  ...
  public java.math.BigDecimal getTD_Min() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(TD_MIN_PROP.get());
  }
  ...
  public void setTD_BenefitEndDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(TD_BENEFITENDDATE_PROP.get(), value);
  }
  ...
  public void setTD_BenefitStartDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(TD_BENEFITSTARTDATE_PROP.get(), value);
  }
  ...
  public void setTD_Max(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(TD_MAX_PROP.get(), value);
  }
  ...
  public void setTD_Min(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(TD_MIN_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ref_WC_TDInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ref_WC_TD.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.ref_WC_TD", "com.guidewire.cc.domain.exposure.impl.ref_WC_TDImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ref_WC_TD.class, config);
    com.guidewire._generated.entity.ref_WC_TDInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ref_WC_TD, com.guidewire._generated.entity.ref_WC_TDInternal>() {
      public java.lang.Object getImplementation(entity.ref_WC_TD bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ref_WC_TDInternal getInternalInterface(entity.ref_WC_TD bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ref_WC_TD newEmptyInstance() {
        return new entity.ref_WC_TD((java.lang.Void)null);
      }
