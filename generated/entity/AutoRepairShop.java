 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AutoRepairShop.eti;AutoRepairShop.eix;AutoRepairShop.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AutoRepairShop")
public class AutoRepairShop extends entity.CompanyVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AutoRepairShop> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AutoRepairShop>("entity.AutoRepairShop");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUTOREPAIRLICENSE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AutoRepairLicense");
   ...
   */
  public AutoRepairShop(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AutoRepairShop(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.AutoRepairShopInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AutoRepairShopInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.AutoRepairShopInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getAutoRepairLicense() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(AUTOREPAIRLICENSE_PROP.get());
  }
  ...
  public void setAutoRepairLicense(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(AUTOREPAIRLICENSE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AutoRepairShopInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AutoRepairShop.this.__getDelegateManager();
    }
    ...
    /**
     * Gets the value of the ShopLocationCode_Ext field.
     * Location ID
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getShopLocationCode_Ext() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(SHOPLOCATIONCODE_EXT_PROP.get());
    }
    ...
    /**
     * Sets the value of the ShopLocationCode_Ext field.
     */
    public void setShopLocationCode_Ext(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(SHOPLOCATIONCODE_EXT_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AutoRepairShop.class, config);
    com.guidewire._generated.entity.AutoRepairShopInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AutoRepairShop, com.guidewire._generated.entity.AutoRepairShopInternal>() {
      public java.lang.Object getImplementation(entity.AutoRepairShop bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AutoRepairShopInternal getInternalInterface(entity.AutoRepairShop bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AutoRepairShop newEmptyInstance() {
        return new entity.AutoRepairShop((java.lang.Void)null);
      }
