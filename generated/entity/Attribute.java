 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Attribute.eti;Attribute.eix;Attribute.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Attribute")
public class Attribute extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Attribute> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Attribute>("entity.Attribute");
  ...
  private com.guidewire._generated.entity.AttributeInternal _internal;
   ...
   */
  public Attribute(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Attribute(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AttributeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AttributeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Attribute_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.Attribute_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  @java.lang.Deprecated
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.Attribute_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.Attribute_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
   ...
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.UserAttributeType getType() {
    return (typekey.UserAttributeType)__getInternalInterface().getFieldValue(TYPE_PROP.get());
  }
   ...
   */
  public com.guidewire.pl.system.entity.KeyList getUsersWithAttribute() {
    return ((com.guidewire.pl.domain.community.AttributePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.community.AttributePublicMethods")).getUsersWithAttribute();
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.Attribute_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.Attribute_Name_L10N[] value) {
   ...
   */
  public void setType(typekey.UserAttributeType value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AttributeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Attribute.this.__getDelegateManager();
    }
     ...
     */
    public void addToDescription_L10N_ARRAY(entity.Attribute_Description_L10N element) {
     ...
     */
    public void addToName_L10N_ARRAY(entity.Attribute_Name_L10N element) {
     ...
     */
    public entity.Attribute_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.Attribute_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
     ...
     */
    public entity.Attribute_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.Attribute_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
     ...
     */
    public void removeFromDescription_L10N_ARRAY(entity.Attribute_Description_L10N element) {
     ...
     */
    public void removeFromName_L10N_ARRAY(entity.Attribute_Name_L10N element) {
    ...
    public void safeDelete() {
      ((com.guidewire.pl.domain.community.impl.AttributeInternalMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.community.impl.AttributeInternalMethods")).safeDelete();
    }
     ...
     * Sets the value of the Description_L10N_ARRAY field.
     */
    public void setDescription_L10N_ARRAY(entity.Attribute_Description_L10N[] value) {
      __getInternalInterface().setFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get(), value);
    }
     ...
     * Sets the value of the Name_L10N_ARRAY field.
     */
    public void setName_L10N_ARRAY(entity.Attribute_Name_L10N[] value) {
      __getInternalInterface().setFieldValue(NAME_L10N_ARRAY_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.community.AttributePublicMethods", "com.guidewire.pl.domain.community.impl.AttributeImpl");
    config.put("com.guidewire.pl.domain.community.impl.AttributeInternalMethods", "com.guidewire.pl.domain.community.impl.AttributeImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.RemoveCallback", "com.guidewire.pl.domain.community.impl.AttributeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Attribute.class, config);
    com.guidewire._generated.entity.AttributeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Attribute, com.guidewire._generated.entity.AttributeInternal>() {
      public java.lang.Object getImplementation(entity.Attribute bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AttributeInternal getInternalInterface(entity.Attribute bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Attribute newEmptyInstance() {
        return new entity.Attribute((java.lang.Void)null);
      }
