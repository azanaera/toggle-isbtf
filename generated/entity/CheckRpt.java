...
/**
 * CheckRpt
 * Calculated amounts for a check.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CheckRpt.eti;CheckRpt.eix;CheckRpt.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CheckRpt")
public class CheckRpt extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CheckRpt> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CheckRpt>("entity.CheckRpt");
  ...
  private com.guidewire._generated.entity.CheckRptInternal _internal;
   ...
   */
  public CheckRpt(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CheckRpt(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.CheckRptInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CheckRptInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CheckRptInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CheckRpt.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.check.impl.CheckRptInternal", "com.guidewire.cc.domain.financials.check.impl.CheckRptImpl");
    ...
    config.put("gw.cc.financials.check.entity.CheckRpt", "com.guidewire.cc.domain.financials.check.impl.CheckRptImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CheckRpt.class, config);
    com.guidewire._generated.entity.CheckRptInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CheckRpt, com.guidewire._generated.entity.CheckRptInternal>() {
      public java.lang.Object getImplementation(entity.CheckRpt bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CheckRptInternal getInternalInterface(entity.CheckRpt bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CheckRpt newEmptyInstance() {
        return new entity.CheckRpt((java.lang.Void)null);
      }
