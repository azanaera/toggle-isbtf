...
@gw.entity.EntityName(value = "ClaimSearchView")
public class ClaimSearchView extends entity.ClaimAssignmentView implements entity.KeyableBean, gw.cc.claim.ArchivedClaimCompatible {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimSearchView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimSearchView>("entity.ClaimSearchView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ASSIGNEDGROUP_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AssignedGroup");
   ...
   */
  public ClaimSearchView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimSearchView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimSearchViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimSearchViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimSearchViewInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getAssignedGroup() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ASSIGNEDGROUP_PROP.get());
  }
  ...
  public void setAssignedGroup(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ASSIGNEDGROUP_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimSearchViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimSearchView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.ArchivedClaimCompatible", "com.guidewire.cc.domain.claim.impl.ClaimSearchViewImpl");
    config.put("gw.cc.claim.entity.ClaimAbstractView", "com.guidewire.cc.domain.claim.impl.ClaimSearchViewImpl");
    config.put("gw.cc.claim.entity.ClaimAssignmentView", "com.guidewire.cc.domain.claim.impl.ClaimSearchViewImpl");
    config.put("gw.cc.claim.entity.ClaimSearchView", "com.guidewire.cc.domain.claim.impl.ClaimSearchViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimSearchView.class, config);
    com.guidewire._generated.entity.ClaimSearchViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimSearchView, com.guidewire._generated.entity.ClaimSearchViewInternal>() {
      public java.lang.Object getImplementation(entity.ClaimSearchView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimSearchViewInternal getInternalInterface(entity.ClaimSearchView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimSearchView newEmptyInstance() {
        return new entity.ClaimSearchView((java.lang.Void)null);
      }
