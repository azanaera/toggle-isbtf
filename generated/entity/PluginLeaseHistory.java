...
@gw.entity.EntityName(value = "PluginLeaseHistory")
public class PluginLeaseHistory extends com.guidewire.pl.persistence.code.BeanBase implements entity.LeaseHistory, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PluginLeaseHistory> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PluginLeaseHistory>("entity.PluginLeaseHistory");
  ...
  private com.guidewire._generated.entity.PluginLeaseHistoryInternal _internal;
   ...
   */
  public PluginLeaseHistory(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PluginLeaseHistory(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PluginLeaseHistoryInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PluginLeaseHistoryInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PluginLeaseHistoryInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PluginLeaseHistory.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PluginLeaseHistory.class, config);
    com.guidewire._generated.entity.PluginLeaseHistoryInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PluginLeaseHistory, com.guidewire._generated.entity.PluginLeaseHistoryInternal>() {
      public java.lang.Object getImplementation(entity.PluginLeaseHistory bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PluginLeaseHistoryInternal getInternalInterface(entity.PluginLeaseHistory bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PluginLeaseHistory newEmptyInstance() {
        return new entity.PluginLeaseHistory((java.lang.Void)null);
      }
