...
/**
 * AppCritCoverageType
 * Loss Cause Applicability Criteria 
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AppCritCoverageType.eti;AppCritCoverageType.eix;AppCritCoverageType.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AppCritCoverageType")
public class AppCritCoverageType extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritCoverageType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritCoverageType>("entity.AppCritCoverageType");
  ...
  private com.guidewire._generated.entity.AppCritCoverageTypeInternal _internal;
   ...
   */
  public AppCritCoverageType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritCoverageType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritCoverageTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritCoverageTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritCoverageTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritCoverageType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritCoverageTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritCoverageType.class, config);
    com.guidewire._generated.entity.AppCritCoverageTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritCoverageType, com.guidewire._generated.entity.AppCritCoverageTypeInternal>() {
      public java.lang.Object getImplementation(entity.AppCritCoverageType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritCoverageTypeInternal getInternalInterface(entity.AppCritCoverageType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritCoverageType newEmptyInstance() {
        return new entity.AppCritCoverageType((java.lang.Void)null);
      }
