 ...
 * MessageRequestLease
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MessageRequestLease.eti;MessageRequestLease.eix;MessageRequestLease.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MessageRequestLease")
public class MessageRequestLease extends com.guidewire.pl.persistence.code.BeanBase implements entity.Lease, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MessageRequestLease> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MessageRequestLease>("entity.MessageRequestLease");
  ...
  private com.guidewire._generated.entity.MessageRequestLeaseInternal _internal;
   ...
   */
  public MessageRequestLease(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MessageRequestLease(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.MessageRequestLeaseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MessageRequestLeaseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MessageRequestLeaseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MessageRequestLease.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MessageRequestLease.class, config);
    com.guidewire._generated.entity.MessageRequestLeaseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MessageRequestLease, com.guidewire._generated.entity.MessageRequestLeaseInternal>() {
      public java.lang.Object getImplementation(entity.MessageRequestLease bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MessageRequestLeaseInternal getInternalInterface(entity.MessageRequestLease bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MessageRequestLease newEmptyInstance() {
        return new entity.MessageRequestLease((java.lang.Void)null);
      }
