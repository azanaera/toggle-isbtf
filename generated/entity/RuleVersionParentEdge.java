...
/**
 * RuleVersionParentEdge
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RuleVersionParentEdge.eti;RuleVersionParentEdge.eix;RuleVersionParentEdge.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RuleVersionParentEdge")
public class RuleVersionParentEdge extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.OrderedChild, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RuleVersionParentEdge> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RuleVersionParentEdge>("entity.RuleVersionParentEdge");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> AUDITTRAILPARENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AuditTrailParent");
  ...
  private com.guidewire._generated.entity.RuleVersionParentEdgeInternal _internal;
   ...
   */
  public RuleVersionParentEdge(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RuleVersionParentEdge(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RuleVersionParentEdgeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RuleVersionParentEdgeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RuleVersion getOwner() {
    return (entity.RuleVersion)__getInternalInterface().getFieldValue(OWNER_PROP.get());
  }
  ...
  public entity.RuleVersion getParent() {
    return (entity.RuleVersion)__getInternalInterface().getFieldValue(PARENT_PROP.get());
  }
  ...
  public java.lang.Boolean isAuditTrailParent() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(AUDITTRAILPARENT_PROP.get());
  }
  ...
  public void setAuditTrailParent(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(AUDITTRAILPARENT_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RuleVersionParentEdgeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RuleVersionParentEdge.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.bizrules.domain.RuleVersionParentEdgeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RuleVersionParentEdge.class, config);
    com.guidewire._generated.entity.RuleVersionParentEdgeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RuleVersionParentEdge, com.guidewire._generated.entity.RuleVersionParentEdgeInternal>() {
      public java.lang.Object getImplementation(entity.RuleVersionParentEdge bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RuleVersionParentEdgeInternal getInternalInterface(entity.RuleVersionParentEdge bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RuleVersionParentEdge newEmptyInstance() {
        return new entity.RuleVersionParentEdge((java.lang.Void)null);
      }
