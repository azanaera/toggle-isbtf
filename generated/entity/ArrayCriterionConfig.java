 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ArrayCriterionConfig.eti;ArrayCriterionConfig.eix;ArrayCriterionConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ArrayCriterionConfig")
public class ArrayCriterionConfig extends entity.MultiArgCriterionConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ArrayCriterionConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ArrayCriterionConfig>("entity.ArrayCriterionConfig");
   ...
   */
  public ArrayCriterionConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ArrayCriterionConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ArrayCriterionConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ArrayCriterionConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ArrayCriterionConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ArrayCriterionConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ArrayCriterionConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ArrayCriterionConfig.class, config);
    com.guidewire._generated.entity.ArrayCriterionConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ArrayCriterionConfig, com.guidewire._generated.entity.ArrayCriterionConfigInternal>() {
      public java.lang.Object getImplementation(entity.ArrayCriterionConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ArrayCriterionConfigInternal getInternalInterface(entity.ArrayCriterionConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ArrayCriterionConfig newEmptyInstance() {
        return new entity.ArrayCriterionConfig((java.lang.Void)null);
      }
