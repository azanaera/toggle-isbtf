 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Person.eti;Person.eix;Person.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Person")
public class Person extends entity.Contact implements entity.GlobalPersonName {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Person> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Person>("entity.Person");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CELLPHONECOUNTRY_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "CellPhoneCountry");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CELLPHONEEXTENSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CellPhoneExtension");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> CLAIMANTIDTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ClaimantIDType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATEOFDEATH_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateOfDeath_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EDUCATIONLEVEL_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EducationLevel");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EMPLOYEESECURITYID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EmployeeSecurityID");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FORMERNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FormerName");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> GREENCARDNUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "GreenCardNumber");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> JURISDICTIONASSIGNEDID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "JurisdictionAssignedID");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MEDICAREBENEFICIARY_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MedicareBeneficiary_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMDEPENDENTS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumDependents");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMDEPENDENTSU18_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumDependentsU18");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NUMDEPENDENTSU25_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NumDependentsU25");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SSNRELEASEAUTHORIZED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "SSNReleaseAuthorized");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TAXEXEMPTIONSENTITLED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TaxExemptionsEntitled");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TAXFILINGSTATUS_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TaxFilingStatus");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> VISANUMBER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "VisaNumber");
   ...
   */
  public Person(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Person(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PersonInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PersonInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PersonInternal)super.__getInternalInterface();
  }
  ...
  public typekey.PhoneCountryCode getCellPhoneCountry() {
    return (typekey.PhoneCountryCode)__getInternalInterface().getFieldValue(CELLPHONECOUNTRY_PROP.get());
  }
  ...
  public java.lang.String getCellPhoneExtension() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CELLPHONEEXTENSION_PROP.get());
  }
  ...
  public typekey.ClaimantIDType getClaimantIDType() {
    return (typekey.ClaimantIDType)__getInternalInterface().getFieldValue(CLAIMANTIDTYPE_PROP.get());
  }
  ...
  /**
   * Gets the value of the DateOfDeath_Ext field.
   * Date of death.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.util.Date getDateOfDeath_Ext() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATEOFDEATH_EXT_PROP.get());
  }
  ...
  public java.lang.String getEducationLevel() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EDUCATIONLEVEL_PROP.get());
  }
  ...
  public java.lang.String getEmployeeSecurityID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(EMPLOYEESECURITYID_PROP.get());
  }
  ...
  public java.lang.String getFormerName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(FORMERNAME_PROP.get());
  }
  ...
  public java.lang.String getGreenCardNumber() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(GREENCARDNUMBER_PROP.get());
  }
  ...
  public java.lang.String getJurisdictionAssignedID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(JURISDICTIONASSIGNEDID_PROP.get());
  }
  ...
  public java.lang.Integer getNumDependents() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMDEPENDENTS_PROP.get());
  }
  ...
  public java.lang.Integer getNumDependentsU18() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMDEPENDENTSU18_PROP.get());
  }
  ...
  public java.lang.Integer getNumDependentsU25() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(NUMDEPENDENTSU25_PROP.get());
  }
  ...
  public java.math.BigDecimal getTaxExemptionsEntitled() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(TAXEXEMPTIONSENTITLED_PROP.get());
  }
  ...
  public typekey.TaxFilingStatusType getTaxFilingStatus() {
    return (typekey.TaxFilingStatusType)__getInternalInterface().getFieldValue(TAXFILINGSTATUS_PROP.get());
  }
  ...
  public java.lang.String getVisaNumber() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(VISANUMBER_PROP.get());
  }
  
  /**
   * Gets the value of the MedicareBeneficiary_Ext field.
   * Medicare Beneficiary
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isMedicareBeneficiary_Ext() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(MEDICAREBENEFICIARY_EXT_PROP.get());
  }
  ...
  public java.lang.Boolean isSSNReleaseAuthorized() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(SSNRELEASEAUTHORIZED_PROP.get());
  }
  ...
  public void setCellPhoneCountry(typekey.PhoneCountryCode value) {
    __getInternalInterface().setFieldValue(CELLPHONECOUNTRY_PROP.get(), value);
  }
  ...
  public void setCellPhoneExtension(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CELLPHONEEXTENSION_PROP.get(), value);
  }
  ...
  public void setClaimantIDType(typekey.ClaimantIDType value) {
    __getInternalInterface().setFieldValue(CLAIMANTIDTYPE_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the DateOfDeath_Ext field.
   */
  public void setDateOfDeath_Ext(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATEOFDEATH_EXT_PROP.get(), value);
  }
  ...
  public void setEducationLevel(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EDUCATIONLEVEL_PROP.get(), value);
  }
  ...
  public void setEmployeeSecurityID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(EMPLOYEESECURITYID_PROP.get(), value);
  }
  ...
  public void setFormerName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(FORMERNAME_PROP.get(), value);
  }
  ...
  public void setGreenCardNumber(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(GREENCARDNUMBER_PROP.get(), value);
  }
  ...
  public void setJurisdictionAssignedID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(JURISDICTIONASSIGNEDID_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the MedicareBeneficiary_Ext field.
   */
  public void setMedicareBeneficiary_Ext(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(MEDICAREBENEFICIARY_EXT_PROP.get(), value);
  }
  ...
  public void setNumDependents(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMDEPENDENTS_PROP.get(), value);
  }
  ...
  public void setNumDependentsU18(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMDEPENDENTSU18_PROP.get(), value);
  }
  ...
  public void setNumDependentsU25(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(NUMDEPENDENTSU25_PROP.get(), value);
  }
  ...
  public void setSSNReleaseAuthorized(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(SSNRELEASEAUTHORIZED_PROP.get(), value);
  }
  ...
  public void setTaxExemptionsEntitled(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(TAXEXEMPTIONSENTITLED_PROP.get(), value);
  }
  ...
  public void setTaxFilingStatus(typekey.TaxFilingStatusType value) {
    __getInternalInterface().setFieldValue(TAXFILINGSTATUS_PROP.get(), value);
  }
  ...
  public void setVisaNumber(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(VISANUMBER_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PersonInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Person.this.__getDelegateManager();
    }
    ...
    /**
     * Gets the value of the AltPhoneCountry_Ext field.
     * Alternate phone country.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.PhoneCountryCode getAltPhoneCountry_Ext() {
      return (typekey.PhoneCountryCode)__getInternalInterface().getFieldValue(ALTPHONECOUNTRY_EXT_PROP.get());
    }
    
    /**
     * Gets the value of the AltPhoneExtension_Ext field.
     * Alternate phone extension.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getAltPhoneExtension_Ext() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ALTPHONEEXTENSION_EXT_PROP.get());
    }
    
    /**
     * Gets the value of the AltPhone_Ext field.
     * Home phone number associated with the contact.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getAltPhone_Ext() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ALTPHONE_EXT_PROP.get());
    }
    ...
    /**
     * Gets the value of the BLOCode_Ext field.
     * BLO Code
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.BLOCode_Ext getBLOCode_Ext() {
      return (typekey.BLOCode_Ext)__getInternalInterface().getFieldValue(BLOCODE_EXT_PROP.get());
    }
    ...
    /**
     * Gets the value of the DoingBusinessAs_Ext field.
     * DBA
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.String getDoingBusinessAs_Ext() {
      return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(DOINGBUSINESSAS_EXT_PROP.get());
    }
    ...
    /**
     * Gets the value of the VendorAvailability_Ext field.
     * The availability of a vendor.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.VendorAvailabilityType_Ext getVendorAvailability_Ext() {
      return (typekey.VendorAvailabilityType_Ext)__getInternalInterface().getFieldValue(VENDORAVAILABILITY_EXT_PROP.get());
    }
    ...
    /**
     * Gets the value of the Backupwithholding_Ext field.
     * Backup withholding
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.Boolean isBackupwithholding_Ext() {
      return (java.lang.Boolean)__getInternalInterface().getFieldValue(BACKUPWITHHOLDING_EXT_PROP.get());
    }
    ...
    /**
     * Gets the value of the Levy_Ext field.
     * Levy Withholding?
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public java.lang.Boolean isLevy_Ext() {
      return (java.lang.Boolean)__getInternalInterface().getFieldValue(LEVY_EXT_PROP.get());
    }
    ...
    public void markDoNotDestroy(boolean value) {
      ((com.guidewire.cc.domain.personaldata.purge.DestructionRootPinnablePublicMethods)__getDelegateManager().getImplementation("com.guidewire.cc.domain.personaldata.purge.DestructionRootPinnablePublicMethods")).markDoNotDestroy(value);
    }
    ...
    /**
     * Sets the value of the AltPhoneCountry_Ext field.
     */
    public void setAltPhoneCountry_Ext(typekey.PhoneCountryCode value) {
      __getInternalInterface().setFieldValue(ALTPHONECOUNTRY_EXT_PROP.get(), value);
    }
    
    /**
     * Sets the value of the AltPhoneExtension_Ext field.
     */
    public void setAltPhoneExtension_Ext(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(ALTPHONEEXTENSION_EXT_PROP.get(), value);
    }
    
    /**
     * Sets the value of the AltPhone_Ext field.
     */
    public void setAltPhone_Ext(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(ALTPHONE_EXT_PROP.get(), value);
    }
    ...
    /**
     * Sets the value of the BLOCode_Ext field.
     */
    public void setBLOCode_Ext(typekey.BLOCode_Ext value) {
      __getInternalInterface().setFieldValue(BLOCODE_EXT_PROP.get(), value);
    }
    
    /**
     * Sets the value of the Backupwithholding_Ext field.
     */
    public void setBackupwithholding_Ext(java.lang.Boolean value) {
      __getInternalInterface().setFieldValue(BACKUPWITHHOLDING_EXT_PROP.get(), value);
    }
    ...
    /**
     * Sets the value of the DoingBusinessAs_Ext field.
     */
    public void setDoingBusinessAs_Ext(java.lang.String value) {
      __getInternalInterface().setFieldValueForCodegen(DOINGBUSINESSAS_EXT_PROP.get(), value);
    }
    ...
    /**
     * Sets the value of the Levy_Ext field.
     */
    public void setLevy_Ext(java.lang.Boolean value) {
      __getInternalInterface().setFieldValue(LEVY_EXT_PROP.get(), value);
    }
    ...
    /**
     * Sets the value of the VendorAvailability_Ext field.
     */
    public void setVendorAvailability_Ext(typekey.VendorAvailabilityType_Ext value) {
      __getInternalInterface().setFieldValue(VENDORAVAILABILITY_EXT_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.personaldata.purge.DestructionRootPinnablePublicMethods", "com.guidewire.cc.domain.contact.ContactImpl");
    ...
    config.put("com.guidewire.pl.domain.contact.ContactPublicMethods", "com.guidewire.pl.domain.contact.impl.PersonImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Person.class, config);
    com.guidewire._generated.entity.PersonInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Person, com.guidewire._generated.entity.PersonInternal>() {
      public java.lang.Object getImplementation(entity.Person bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PersonInternal getInternalInterface(entity.Person bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Person newEmptyInstance() {
        return new entity.Person((java.lang.Void)null);
      }
