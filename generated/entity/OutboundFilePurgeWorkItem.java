...
/**
 * OutboundFilePurgeWorkItem
 * Custom work item for purging outbound files.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OutboundFilePurgeWorkItem.eti;OutboundFilePurgeWorkItem.eix;OutboundFilePurgeWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OutboundFilePurgeWorkItem")
public class OutboundFilePurgeWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OutboundFilePurgeWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OutboundFilePurgeWorkItem>("entity.OutboundFilePurgeWorkItem");
  ...
  private com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternal _internal;
   ...
   */
  public OutboundFilePurgeWorkItem()  {
   ...
   */
  public OutboundFilePurgeWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OutboundFilePurgeWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OutboundFilePurgeWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OutboundFilePurgeWorkItem.class, config);
    com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OutboundFilePurgeWorkItem, com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.OutboundFilePurgeWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OutboundFilePurgeWorkItemInternal getInternalInterface(entity.OutboundFilePurgeWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OutboundFilePurgeWorkItem newEmptyInstance() {
        return new entity.OutboundFilePurgeWorkItem((java.lang.Void)null);
      }
