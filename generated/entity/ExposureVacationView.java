...
/**
 * ExposureVacationView
 * Vacation Exposure view entity.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureVacationView.eti;ExposureVacationView.eix;ExposureVacationView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExposureVacationView")
public class ExposureVacationView extends entity.ExposureAssignmentView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureVacationView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureVacationView>("entity.ExposureVacationView");
  
  private static final com.guidewire.pl.persistence.code.DelegateMap DELEGATE_MAP;
  
  public static final gw.api.exposure.PublicExposureVacationViewFinder finder = gw.cc.exposure.entity.ExposureVacationView.finder;
  
  /**
   * Constructs a new instance of this entity in the {@link gw.transaction.Transaction#getCurrent() current} bundle.
   * @throws java.lang.NullPointerException if there is no current bundle defined
   */
  public ExposureVacationView()  {
   ...
   */
  public ExposureVacationView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExposureVacationView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ExposureVacationViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExposureVacationViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ExposureVacationViewInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExposureVacationViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExposureVacationView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.ExposureAbstractView", "com.guidewire.cc.domain.exposure.impl.ExposureVacationViewImpl");
    config.put("gw.cc.exposure.entity.ExposureAssignmentView", "com.guidewire.cc.domain.exposure.impl.ExposureVacationViewImpl");
    config.put("gw.cc.exposure.entity.ExposureDesktopView", "com.guidewire.cc.domain.exposure.impl.ExposureVacationViewImpl");
    config.put("gw.cc.exposure.entity.ExposureVacationView", "com.guidewire.cc.domain.exposure.impl.ExposureVacationViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExposureVacationView.class, config);
    com.guidewire._generated.entity.ExposureVacationViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExposureVacationView, com.guidewire._generated.entity.ExposureVacationViewInternal>() {
      public java.lang.Object getImplementation(entity.ExposureVacationView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureVacationViewInternal getInternalInterface(entity.ExposureVacationView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExposureVacationView newEmptyInstance() {
        return new entity.ExposureVacationView((java.lang.Void)null);
      }
