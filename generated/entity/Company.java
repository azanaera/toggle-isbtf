 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Company.eti;Company.eix;Company.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Company")
public class Company extends entity.Contact {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Company> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Company>("entity.Company");
   ...
   */
  public Company(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Company(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CompanyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CompanyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CompanyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CompanyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Company.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Company.class, config);
    com.guidewire._generated.entity.CompanyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Company, com.guidewire._generated.entity.CompanyInternal>() {
      public java.lang.Object getImplementation(entity.Company bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CompanyInternal getInternalInterface(entity.Company bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Company newEmptyInstance() {
        return new entity.Company((java.lang.Void)null);
      }
