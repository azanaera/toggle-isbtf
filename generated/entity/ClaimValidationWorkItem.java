 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimValidationWorkItem.eti;ClaimValidationWorkItem.eix;ClaimValidationWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimValidationWorkItem")
public class ClaimValidationWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimValidationWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimValidationWorkItem>("entity.ClaimValidationWorkItem");
  ...
  private com.guidewire._generated.entity.ClaimValidationWorkItemInternal _internal;
   ...
   */
  public ClaimValidationWorkItem()  {
   ...
   */
  public ClaimValidationWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimValidationWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ClaimValidationWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimValidationWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimValidationWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimValidationWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.ClaimValidationWorkItem", "com.guidewire.cc.domain.claim.impl.ClaimValidationWorkItemImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimValidationWorkItem.class, config);
    com.guidewire._generated.entity.ClaimValidationWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimValidationWorkItem, com.guidewire._generated.entity.ClaimValidationWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.ClaimValidationWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimValidationWorkItemInternal getInternalInterface(entity.ClaimValidationWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimValidationWorkItem newEmptyInstance() {
        return new entity.ClaimValidationWorkItem((java.lang.Void)null);
      }
