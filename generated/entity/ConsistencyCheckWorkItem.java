 ...
 * Queue of Consistency Checks to run. This is a system-internal entity.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ConsistencyCheckWorkItem.eti;ConsistencyCheckWorkItem.eix;ConsistencyCheckWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ConsistencyCheckWorkItem")
public class ConsistencyCheckWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItemSetItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ConsistencyCheckWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ConsistencyCheckWorkItem>("entity.ConsistencyCheckWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DBCONSISTCHECKRUNID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DBConsistCheckRunID");
  ...
  private com.guidewire._generated.entity.ConsistencyCheckWorkItemInternal _internal;
   ...
   */
  public ConsistencyCheckWorkItem()  {
   ...
   */
  public ConsistencyCheckWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ConsistencyCheckWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ConsistencyCheckWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ConsistencyCheckWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.ConsistencyCheckType getCheckType() {
    return (typekey.ConsistencyCheckType)__getInternalInterface().getFieldValue(CHECKTYPE_PROP.get());
  }
  ...
  public java.lang.Long getDBConsistCheckRunID() {
    return (java.lang.Long)__getInternalInterface().getFieldValue(DBCONSISTCHECKRUNID_PROP.get());
  }
  ...
  public void setDBConsistCheckRunID(java.lang.Long value) {
    __getInternalInterface().setFieldValue(DBCONSISTCHECKRUNID_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ConsistencyCheckWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ConsistencyCheckWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ConsistencyCheckWorkItem.class, config);
    com.guidewire._generated.entity.ConsistencyCheckWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ConsistencyCheckWorkItem, com.guidewire._generated.entity.ConsistencyCheckWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.ConsistencyCheckWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ConsistencyCheckWorkItemInternal getInternalInterface(entity.ConsistencyCheckWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ConsistencyCheckWorkItem newEmptyInstance() {
        return new entity.ConsistencyCheckWorkItem((java.lang.Void)null);
      }
