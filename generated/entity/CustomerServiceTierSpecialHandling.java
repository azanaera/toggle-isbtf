...
/**
 * CustomerServiceTierSpecialHandling
 * 
 *     The special handling to follow for claims linked to a given Service Tier.
 *   
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CustomerServiceTierSpecialHandling.eti;CustomerServiceTierSpecialHandling.eix;CustomerServiceTierSpecialHandling.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CustomerServiceTierSpecialHandling")
public class CustomerServiceTierSpecialHandling extends entity.SpecialHandling {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CustomerServiceTierSpecialHandling> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CustomerServiceTierSpecialHandling>("entity.CustomerServiceTierSpecialHandling");
   ...
   */
  public CustomerServiceTierSpecialHandling()  {
   ...
   */
  public CustomerServiceTierSpecialHandling(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CustomerServiceTierSpecialHandling(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CustomerServiceTierSpecialHandling.this.__getDelegateManager();
    }
    ...
    public entity.AutomatedHandler[] getAutomatedHandlersBySubtypes(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.AutomatedHandler[])__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("gw.cc.specialhandling.entity.SpecialHandling", "com.guidewire.cc.domain.specialhandling.impl.SpecialHandlingImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CustomerServiceTierSpecialHandling.class, config);
    com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CustomerServiceTierSpecialHandling, com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternal>() {
      public java.lang.Object getImplementation(entity.CustomerServiceTierSpecialHandling bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CustomerServiceTierSpecialHandlingInternal getInternalInterface(entity.CustomerServiceTierSpecialHandling bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CustomerServiceTierSpecialHandling newEmptyInstance() {
        return new entity.CustomerServiceTierSpecialHandling((java.lang.Void)null);
      }
