...
/**
 * RecoveryView
 * Aggregates the information needed to display a Recovery using the Recovery filter of the Financials Transactions page. Subtype of TransactionView.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RecoveryView.eti;RecoveryView.eix;RecoveryView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RecoveryView")
public class RecoveryView extends entity.TransactionView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RecoveryView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RecoveryView>("entity.RecoveryView");
   ...
   */
  public RecoveryView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RecoveryView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RecoveryViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RecoveryViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RecoveryViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RecoveryViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RecoveryView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.financials.entity.RecoveryView", "com.guidewire.cc.domain.financials.impl.RecoveryViewImpl");
    config.put("gw.cc.financials.entity.TransactionView", "com.guidewire.cc.domain.financials.impl.RecoveryViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RecoveryView.class, config);
    com.guidewire._generated.entity.RecoveryViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RecoveryView, com.guidewire._generated.entity.RecoveryViewInternal>() {
      public java.lang.Object getImplementation(entity.RecoveryView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RecoveryViewInternal getInternalInterface(entity.RecoveryView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RecoveryView newEmptyInstance() {
        return new entity.RecoveryView((java.lang.Void)null);
      }
