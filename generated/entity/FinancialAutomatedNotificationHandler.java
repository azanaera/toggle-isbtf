...
/**
 * FinancialAutomatedNotificationHandler
 * 
 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FinancialAutomatedNotificationHandler.eti;FinancialAutomatedNotificationHandler.eix;FinancialAutomatedNotificationHandler.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FinancialAutomatedNotificationHandler")
public class FinancialAutomatedNotificationHandler extends entity.AutomatedNotificationHandler implements gw.api.specialhandling.AutomatedHandlerMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FinancialAutomatedNotificationHandler> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FinancialAutomatedNotificationHandler>("entity.FinancialAutomatedNotificationHandler");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> FINANCIALTHRESHOLDTRIGGER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "FinancialThresholdTrigger");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> FINANCIALTHRESHOLDTRIGGERARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "FinancialThresholdTriggerArray");
   ...
   */
  public FinancialAutomatedNotificationHandler()  {
   ...
   */
  public FinancialAutomatedNotificationHandler(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FinancialAutomatedNotificationHandler(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternal)super.__getInternalInterface();
  }
  ...
  public entity.FinancialThresholdTrigger getFinancialThresholdTrigger() {
    return (entity.FinancialThresholdTrigger)__getInternalInterface().getFieldValue(FINANCIALTHRESHOLDTRIGGER_PROP.get());
  }
  ...
  public entity.FinancialThresholdTrigger[] getFinancialThresholdTriggerArray() {
    return (entity.FinancialThresholdTrigger[])__getInternalInterface().getFieldValue(FINANCIALTHRESHOLDTRIGGERARRAY_PROP.get());
  }
  ...
  public void setFinancialThresholdTrigger(entity.FinancialThresholdTrigger value) {
    __getInternalInterface().setFieldValue(FINANCIALTHRESHOLDTRIGGER_PROP.get(), value);
  }
  
  /**
   * Sets the value of the FinancialThresholdTriggerArray field.
   */
  private void setFinancialThresholdTriggerArray(entity.FinancialThresholdTrigger[] value) {
    __getInternalInterface().setFieldValue(FINANCIALTHRESHOLDTRIGGERARRAY_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FinancialAutomatedNotificationHandler.this.__getDelegateManager();
    }
    ...
    public void addToFinancialThresholdTriggerArray(entity.FinancialThresholdTrigger element) {
      __getInternalInterface().addArrayElement(FINANCIALTHRESHOLDTRIGGERARRAY_PROP.get(), element);
    }
    ...
    public gw.pl.persistence.core.Key getFinancialThresholdTriggerID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(FINANCIALTHRESHOLDTRIGGER_PROP.get());
    }
    ...
    public void removeFromFinancialThresholdTriggerArray(entity.FinancialThresholdTrigger element) {
      __getInternalInterface().removeArrayElement(FINANCIALTHRESHOLDTRIGGERARRAY_PROP.get(), element);
    }
    ...
    public void removeFromFinancialThresholdTriggerArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(FINANCIALTHRESHOLDTRIGGERARRAY_PROP.get(), elementID);
    }
    ...
    public void setFinancialThresholdTriggerID(gw.pl.persistence.core.Key value) {
      setFieldValue(FINANCIALTHRESHOLDTRIGGER_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.specialhandling.AutomatedHandlerMethods", "gw.specialhandling.FinancialAutomatedNotificationHandlerMethodsImpl");
    config.put("gw.cc.specialhandling.entity.AutomatedHandler", "com.guidewire.cc.domain.specialhandling.impl.FinancialAutomatedNotificationHandlerImpl");
    config.put("gw.cc.specialhandling.entity.AutomatedNotificationHandler", "com.guidewire.cc.domain.specialhandling.impl.FinancialAutomatedNotificationHandlerImpl");
    config.put("gw.cc.specialhandling.entity.FinancialAutomatedNotificationHandler", "com.guidewire.cc.domain.specialhandling.impl.FinancialAutomatedNotificationHandlerImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FinancialAutomatedNotificationHandler.class, config);
    com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FinancialAutomatedNotificationHandler, com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternal>() {
      public java.lang.Object getImplementation(entity.FinancialAutomatedNotificationHandler bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FinancialAutomatedNotificationHandlerInternal getInternalInterface(entity.FinancialAutomatedNotificationHandler bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FinancialAutomatedNotificationHandler newEmptyInstance() {
        return new entity.FinancialAutomatedNotificationHandler((java.lang.Void)null);
      }
