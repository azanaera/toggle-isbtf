 ...
 * Report of an incident involving some kind of mobile property - vehicle, personal property but not a building.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MobilePropertyIncident.eti;MobilePropertyIncident.eix;MobilePropertyIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MobilePropertyIncident")
public class MobilePropertyIncident extends entity.PropertyIncident {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MobilePropertyIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MobilePropertyIncident>("entity.MobilePropertyIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> LOCATIONADDRESS_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "LocationAddress");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOSSDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LossDesc");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> LOSSOCCURED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "LossOccured");
   ...
   */
  public MobilePropertyIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MobilePropertyIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.MobilePropertyIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MobilePropertyIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.MobilePropertyIncidentInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MobilePropertyIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MobilePropertyIncident.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.MobilePropertyIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.MobilePropertyIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.MobilePropertyIncidentImpl");
    ...
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.MobilePropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.MobilePropertyIncident", "com.guidewire.cc.domain.exposure.impl.MobilePropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.MobilePropertyIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MobilePropertyIncident.class, config);
    com.guidewire._generated.entity.MobilePropertyIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MobilePropertyIncident, com.guidewire._generated.entity.MobilePropertyIncidentInternal>() {
      public java.lang.Object getImplementation(entity.MobilePropertyIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MobilePropertyIncidentInternal getInternalInterface(entity.MobilePropertyIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MobilePropertyIncident newEmptyInstance() {
        return new entity.MobilePropertyIncident((java.lang.Void)null);
      }
