...
/**
 * InboundFilePurgeWorkItem
 * Custom work item for purging inbound files.
 */
...
@gw.entity.EntityName(value = "InboundFilePurgeWorkItem")
public class InboundFilePurgeWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InboundFilePurgeWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InboundFilePurgeWorkItem>("entity.InboundFilePurgeWorkItem");
  ...
  private com.guidewire._generated.entity.InboundFilePurgeWorkItemInternal _internal;
   ...
   */
  public InboundFilePurgeWorkItem()  {
   ...
   */
  public InboundFilePurgeWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InboundFilePurgeWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InboundFilePurgeWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InboundFilePurgeWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InboundFilePurgeWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InboundFilePurgeWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InboundFilePurgeWorkItem.class, config);
    com.guidewire._generated.entity.InboundFilePurgeWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InboundFilePurgeWorkItem, com.guidewire._generated.entity.InboundFilePurgeWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.InboundFilePurgeWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InboundFilePurgeWorkItemInternal getInternalInterface(entity.InboundFilePurgeWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InboundFilePurgeWorkItem newEmptyInstance() {
        return new entity.InboundFilePurgeWorkItem((java.lang.Void)null);
      }
