 ...
 * CloseExposureInfo
 * 
 *       Temporary entity that holds transitional internal state information during the
 *       close exposure operation.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CloseExposureInfo.eti;CloseExposureInfo.eix;CloseExposureInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CloseExposureInfo")
public class CloseExposureInfo extends entity.ExpCloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CloseExposureInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CloseExposureInfo>("entity.CloseExposureInfo");
   ...
   */
  public CloseExposureInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CloseExposureInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CloseExposureInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CloseExposureInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CloseExposureInfoInternal)super.__getInternalInterface();
  }
  ...
  public typekey.ExposureClosedOutcomeType getoutcome() {
    return (typekey.ExposureClosedOutcomeType)__getInternalInterface().getFieldValue(OUTCOME_PROP.get());
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CloseExposureInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CloseExposureInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.exposure.impl.CloseExposureInfoImpl");
    config.put("gw.cc.exposure.entity.CloseExposureInfo", "com.guidewire.cc.domain.exposure.impl.CloseExposureInfoImpl");
    config.put("gw.cc.exposure.entity.ExpCloseReopenInfo", "com.guidewire.cc.domain.exposure.impl.CloseExposureInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CloseExposureInfo.class, config);
    com.guidewire._generated.entity.CloseExposureInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CloseExposureInfo, com.guidewire._generated.entity.CloseExposureInfoInternal>() {
      public java.lang.Object getImplementation(entity.CloseExposureInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CloseExposureInfoInternal getInternalInterface(entity.CloseExposureInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CloseExposureInfo newEmptyInstance() {
        return new entity.CloseExposureInfo((java.lang.Void)null);
      }
