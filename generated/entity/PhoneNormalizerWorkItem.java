 ...
 * Phone Normalizer WorkItem implementation. This should work for most work queues.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PhoneNormalizerWorkItem.eti;PhoneNormalizerWorkItem.eix;PhoneNormalizerWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PhoneNormalizerWorkItem")
public class PhoneNormalizerWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PhoneNormalizerWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PhoneNormalizerWorkItem>("entity.PhoneNormalizerWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> QUEUETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "QueueType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TARGETIDS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TargetIDs");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.PhoneNormalizerWorkItemInternal _internal;
   ...
   */
  public PhoneNormalizerWorkItem()  {
   ...
   */
  public PhoneNormalizerWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PhoneNormalizerWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PhoneNormalizerWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PhoneNormalizerWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.BatchProcessType getQueueType() {
    return (typekey.BatchProcessType)__getInternalInterface().getFieldValue(QUEUETYPE_PROP.get());
  }
  ...
  public java.lang.String getTargetIDs() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TARGETIDS_PROP.get());
  }
  ...
  public void setQueueType(typekey.BatchProcessType value) {
    __getInternalInterface().setFieldValue(QUEUETYPE_PROP.get(), value);
  }
   ...
   */
  private void setTargetIDs(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TARGETIDS_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PhoneNormalizerWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PhoneNormalizerWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PhoneNormalizerWorkItem.class, config);
    com.guidewire._generated.entity.PhoneNormalizerWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PhoneNormalizerWorkItem, com.guidewire._generated.entity.PhoneNormalizerWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.PhoneNormalizerWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PhoneNormalizerWorkItemInternal getInternalInterface(entity.PhoneNormalizerWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PhoneNormalizerWorkItem newEmptyInstance() {
        return new entity.PhoneNormalizerWorkItem((java.lang.Void)null);
      }
