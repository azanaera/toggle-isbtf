...
/**
 * OutboundRecPurgeWorkItem
 * Custom work item for purging outbound records
 */
...
@gw.entity.EntityName(value = "OutboundRecPurgeWorkItem")
public class OutboundRecPurgeWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OutboundRecPurgeWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OutboundRecPurgeWorkItem>("entity.OutboundRecPurgeWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> OUTBOUNDRECORD_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "OutboundRecord");
  ...
  private com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternal _internal;
   ...
   */
  public OutboundRecPurgeWorkItem()  {
   ...
   */
  public OutboundRecPurgeWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OutboundRecPurgeWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.OutboundRecord getOutboundRecord() {
    return (entity.OutboundRecord)__getInternalInterface().getFieldValue(OUTBOUNDRECORD_PROP.get());
  }
  ...
  public void setOutboundRecord(entity.OutboundRecord value) {
    __getInternalInterface().setFieldValue(OUTBOUNDRECORD_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OutboundRecPurgeWorkItem.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getOutboundRecordID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(OUTBOUNDRECORD_PROP.get());
    }
    ...
    public void setOutboundRecordID(gw.pl.persistence.core.Key value) {
      setFieldValue(OUTBOUNDRECORD_PROP.get(), value);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OutboundRecPurgeWorkItem.class, config);
    com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OutboundRecPurgeWorkItem, com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.OutboundRecPurgeWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OutboundRecPurgeWorkItemInternal getInternalInterface(entity.OutboundRecPurgeWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OutboundRecPurgeWorkItem newEmptyInstance() {
        return new entity.OutboundRecPurgeWorkItem((java.lang.Void)null);
      }
