...
/**
 * PercentEscalatedActivitiesClaimMetric
 * % of Escalated Activities
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PercentEscalatedActivitiesClaimMetric.eti;PercentEscalatedActivitiesClaimMetric.eix;PercentEscalatedActivitiesClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PercentEscalatedActivitiesClaimMetric")
public class PercentEscalatedActivitiesClaimMetric extends entity.PercentClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PercentEscalatedActivitiesClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PercentEscalatedActivitiesClaimMetric>("entity.PercentEscalatedActivitiesClaimMetric");
   ...
   */
  public PercentEscalatedActivitiesClaimMetric()  {
   ...
   */
  public PercentEscalatedActivitiesClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PercentEscalatedActivitiesClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PercentEscalatedActivitiesClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.activity.PercentEscalatedActivitiesClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PercentEscalatedActivitiesClaimMetric.class, config);
    com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PercentEscalatedActivitiesClaimMetric, com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.PercentEscalatedActivitiesClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PercentEscalatedActivitiesClaimMetricInternal getInternalInterface(entity.PercentEscalatedActivitiesClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PercentEscalatedActivitiesClaimMetric newEmptyInstance() {
        return new entity.PercentEscalatedActivitiesClaimMetric((java.lang.Void)null);
      }
