 ...
 *   
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RITAccountTransaction.eti;RITAccountTransaction.eix;RITAccountTransaction.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RITAccountTransaction")
public class RITAccountTransaction extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.TAccountTransactionDelegate, entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RITAccountTransaction> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RITAccountTransaction>("entity.RITAccountTransaction");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> RITACCTTXNHISTARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "RitaccttxnhistArray");
  ...
  private com.guidewire._generated.entity.RITAccountTransactionInternal _internal;
   ...
   */
  protected RITAccountTransaction()  {
   ...
   */
  protected RITAccountTransaction(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RITAccountTransaction(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.RITAccountTransactionInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RITAccountTransactionInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.RITAccountLineItem[] getCreditingLineItems() {
    return (entity.RITAccountLineItem[])__getInternalInterface().getFieldValue(CREDITINGLINEITEMS_PROP.get());
  }
  ...
  public entity.RITAccountLineItem[] getDebitingLineItems() {
    return (entity.RITAccountLineItem[])__getInternalInterface().getFieldValue(DEBITINGLINEITEMS_PROP.get());
  }
  ...
  public entity.RITAccountTransaction getNextTransaction() {
    return (entity.RITAccountTransaction)__getInternalInterface().getFieldValue(NEXTTRANSACTION_PROP.get());
  }
  ...
  public entity.Ritaccttxnhist[] getRitaccttxnhistArray() {
    return (entity.Ritaccttxnhist[])__getInternalInterface().getFieldValue(RITACCTTXNHISTARRAY_PROP.get());
  }
  ...
  public entity.RITransaction getTransaction() {
    return (entity.RITransaction)__getInternalInterface().getFieldValue(TRANSACTION_PROP.get());
  }
   ...
   */
  private void setCreditingLineItems(entity.RITAccountLineItem[] value) {
   ...
   */
  private void setDebitingLineItems(entity.RITAccountLineItem[] value) {
   ...
   */
  private void setNextTransaction(entity.RITAccountTransaction value) {
   ...
   */
  private void setRitaccttxnhistArray(entity.Ritaccttxnhist[] value) {
    __getInternalInterface().setFieldValue(RITACCTTXNHISTARRAY_PROP.get(), value);
  }
  
  /**
   * Sets the value of the Transaction field.
   */
  private void setTransaction(entity.RITransaction value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RITAccountTransactionInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RITAccountTransaction.this.__getDelegateManager();
    }
    ...
    public void addToRitaccttxnhistArray(entity.Ritaccttxnhist element) {
      __getInternalInterface().addArrayElement(RITACCTTXNHISTARRAY_PROP.get(), element);
    }
    ...
    public void removeFromRitaccttxnhistArray(entity.Ritaccttxnhist element) {
      __getInternalInterface().removeArrayElement(RITACCTTXNHISTARRAY_PROP.get(), element);
    }
    ...
    public void removeFromRitaccttxnhistArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(RITACCTTXNHISTARRAY_PROP.get(), elementID);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.taccount.TAccountTransactionDelegateAdapter", "com.guidewire.cc.domain.financials.taccount.impl.TAccountTransactionDelegateAdapterRIImpl");
    config.put("com.guidewire.cc.domain.financials.taccount.impl.TAccountTransactionDelegateInternal", "com.guidewire.cc.domain.financials.taccount.impl.RITAccountTransactionImpl");
    ...
    config.put("gw.cc.financials.taccount.entity.RITAccountTransaction", "com.guidewire.cc.domain.financials.taccount.impl.RITAccountTransactionImpl");
    config.put("gw.cc.financials.taccount.entity.TAccountTransactionDelegate", "com.guidewire.cc.domain.financials.taccount.impl.RITAccountTransactionImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RITAccountTransaction.class, config);
    com.guidewire._generated.entity.RITAccountTransactionInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RITAccountTransaction, com.guidewire._generated.entity.RITAccountTransactionInternal>() {
      public java.lang.Object getImplementation(entity.RITAccountTransaction bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RITAccountTransactionInternal getInternalInterface(entity.RITAccountTransaction bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RITAccountTransaction newEmptyInstance() {
        return new entity.RITAccountTransaction((java.lang.Void)null);
      }
