...
/**
 * TransactionView
 * Abstract base view entity that aggregates the information needed to display a Transaction on the Financials Transactions page.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TransactionView.eti;TransactionView.eix;TransactionView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TransactionView")
public class TransactionView extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TransactionView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TransactionView>("entity.TransactionView");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> USER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "User");
  
  private com.guidewire.pl.persistence.code.DelegateLoader _delegateManager;
  
  private com.guidewire._generated.entity.TransactionViewInternal _internal;
   ...
   */
  public TransactionView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TransactionView(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TransactionViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TransactionViewInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.TransactionView value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TransactionViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TransactionView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.financials.entity.TransactionView", "com.guidewire.cc.domain.financials.impl.TransactionViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TransactionView.class, config);
    com.guidewire._generated.entity.TransactionViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TransactionView, com.guidewire._generated.entity.TransactionViewInternal>() {
      public java.lang.Object getImplementation(entity.TransactionView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TransactionViewInternal getInternalInterface(entity.TransactionView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TransactionView newEmptyInstance() {
        return new entity.TransactionView((java.lang.Void)null);
      }
