...
/**
 * InvoiceItemWorkItem
 * Represents a unit of work to process a bulk invoice item.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InvoiceItemWorkItem.eti;InvoiceItemWorkItem.eix;InvoiceItemWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "InvoiceItemWorkItem")
public class InvoiceItemWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InvoiceItemWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InvoiceItemWorkItem>("entity.InvoiceItemWorkItem");
  ...
  private com.guidewire._generated.entity.InvoiceItemWorkItemInternal _internal;
   ...
   */
  public InvoiceItemWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InvoiceItemWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.InvoiceItemWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InvoiceItemWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.BulkInvoiceJobType getJobType() {
    return (typekey.BulkInvoiceJobType)__getInternalInterface().getFieldValue(JOBTYPE_PROP.get());
  }
   ...
   */
  private void setJobType(typekey.BulkInvoiceJobType value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InvoiceItemWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InvoiceItemWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InvoiceItemWorkItem.class, config);
    com.guidewire._generated.entity.InvoiceItemWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InvoiceItemWorkItem, com.guidewire._generated.entity.InvoiceItemWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.InvoiceItemWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InvoiceItemWorkItemInternal getInternalInterface(entity.InvoiceItemWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InvoiceItemWorkItem newEmptyInstance() {
        return new entity.InvoiceItemWorkItem((java.lang.Void)null);
      }
