 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AttributeUser.eti;AttributeUser.eix;AttributeUser.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AttributeUser")
public class AttributeUser extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AttributeUser> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AttributeUser>("entity.AttributeUser");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATEFIELD1_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateField1");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATEFIELD2_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateField2");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DATEFIELD3_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DateField3");
  ...
  private com.guidewire._generated.entity.AttributeUserInternal _internal;
   ...
   */
  public AttributeUser(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AttributeUser(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AttributeUserInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AttributeUserInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public java.util.Date getDateField1() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATEFIELD1_PROP.get());
  }
  ...
  public java.util.Date getDateField2() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATEFIELD2_PROP.get());
  }
  ...
  public java.util.Date getDateField3() {
    return (java.util.Date)__getInternalInterface().getFieldValue(DATEFIELD3_PROP.get());
  }
  ...
  public void setDateField1(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATEFIELD1_PROP.get(), value);
  }
  ...
  public void setDateField2(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATEFIELD2_PROP.get(), value);
  }
  ...
  public void setDateField3(java.util.Date value) {
    __getInternalInterface().setFieldValue(DATEFIELD3_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AttributeUserInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AttributeUser.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AttributeUser.class, config);
    com.guidewire._generated.entity.AttributeUserInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AttributeUser, com.guidewire._generated.entity.AttributeUserInternal>() {
      public java.lang.Object getImplementation(entity.AttributeUser bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AttributeUserInternal getInternalInterface(entity.AttributeUser bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AttributeUser newEmptyInstance() {
        return new entity.AttributeUser((java.lang.Void)null);
      }
