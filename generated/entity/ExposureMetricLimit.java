...
/**
 * ExposureMetricLimit
 * Limits for metrics related to an exposure
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExposureMetricLimit.eti;ExposureMetricLimit.eix;ExposureMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
public abstract class ExposureMetricLimit extends com.guidewire.pl.persistence.code.BeanBase implements entity.CopyOnWriteMetricLimitDelegate, entity.Retireable, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExposureMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExposureMetricLimit>("entity.ExposureMetricLimit");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> EXPOSUREMETRICTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "ExposureMetricType");
  ...
  private com.guidewire._generated.entity.ExposureMetricLimitInternal _internal;
  
  public static final gw.pl.persistence.type.DynamicEntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIRED_DYNPROP = com.guidewire.pl.domain.persistence.core.RetireablePublicMethods.RETIRED_DYNPROP;
  
  protected ExposureMetricLimit(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.ExposureMetricLimitInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.ExposureMetricLimitInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ExposureMetricLimit value) {
  ...
  static {
    com.guidewire._generated.entity.ExposureMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.ExposureMetricLimit, com.guidewire._generated.entity.ExposureMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.ExposureMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExposureMetricLimitInternal getInternalInterface(entity.ExposureMetricLimit bean) {
        if(bean == null) {
          return null;
        };
