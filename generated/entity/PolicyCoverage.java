 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PolicyCoverage.eti;PolicyCoverage.eix;PolicyCoverage.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PolicyCoverage")
public class PolicyCoverage extends entity.Coverage {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PolicyCoverage> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PolicyCoverage>("entity.PolicyCoverage");
   ...
   */
  public PolicyCoverage(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PolicyCoverage(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PolicyCoverageInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PolicyCoverageInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PolicyCoverageInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PolicyCoverageInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PolicyCoverage.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.Coverage", "com.guidewire.cc.domain.policy.impl.PolicyCoverageImpl");
    config.put("gw.cc.policy.entity.PolicyCoverage", "com.guidewire.cc.domain.policy.impl.PolicyCoverageImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PolicyCoverage.class, config);
    com.guidewire._generated.entity.PolicyCoverageInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PolicyCoverage, com.guidewire._generated.entity.PolicyCoverageInternal>() {
      public java.lang.Object getImplementation(entity.PolicyCoverage bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PolicyCoverageInternal getInternalInterface(entity.PolicyCoverage bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PolicyCoverage newEmptyInstance() {
        return new entity.PolicyCoverage((java.lang.Void)null);
      }
