...
/**
 * DaysLastViewedByAdjusterClaimMetric
 * Number of days since the adjuster last viewed the claim
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DaysLastViewedByAdjusterClaimMetric.eti;DaysLastViewedByAdjusterClaimMetric.eix;DaysLastViewedByAdjusterClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DaysLastViewedByAdjusterClaimMetric")
public class DaysLastViewedByAdjusterClaimMetric extends entity.TimeBasedClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DaysLastViewedByAdjusterClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DaysLastViewedByAdjusterClaimMetric>("entity.DaysLastViewedByAdjusterClaimMetric");
   ...
   */
  public DaysLastViewedByAdjusterClaimMetric()  {
   ...
   */
  public DaysLastViewedByAdjusterClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DaysLastViewedByAdjusterClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DaysLastViewedByAdjusterClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.activity.DaysLastViewedByAdjusterClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DaysLastViewedByAdjusterClaimMetric.class, config);
    com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DaysLastViewedByAdjusterClaimMetric, com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.DaysLastViewedByAdjusterClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DaysLastViewedByAdjusterClaimMetricInternal getInternalInterface(entity.DaysLastViewedByAdjusterClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DaysLastViewedByAdjusterClaimMetric newEmptyInstance() {
        return new entity.DaysLastViewedByAdjusterClaimMetric((java.lang.Void)null);
      }
