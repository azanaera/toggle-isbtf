 ...
 * ExpressionFragment for arbitrary list expression
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ListExpressionFragment.eti;ListExpressionFragment.eix;ListExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ListExpressionFragment")
public class ListExpressionFragment extends entity.ExpressionFragment {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ListExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ListExpressionFragment>("entity.ListExpressionFragment");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> GENERATEARRAY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "GenerateArray");
   ...
   */
  public ListExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ListExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ListExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ListExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ListExpressionFragmentInternal)super.__getInternalInterface();
  }
  ...
  public entity.ListExpressionFragmentJoin[] getElements() {
    return (entity.ListExpressionFragmentJoin[])__getInternalInterface().getFieldValue(ELEMENTS_PROP.get());
  }
  
  public java.util.List<entity.ExpressionFragment> getOrderedElements() {
    return ((com.guidewire.bizrules.domain.ListExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.ListExpressionFragmentDomainMethods")).getOrderedElements();
  }
  
  public java.util.List<entity.ListExpressionFragmentJoin> getOrderedJoinElements() {
    return ((com.guidewire.bizrules.domain.ListExpressionFragmentDomainMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.domain.ListExpressionFragmentDomainMethods")).getOrderedJoinElements();
  }
  ...
  public java.lang.Boolean isGenerateArray() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(GENERATEARRAY_PROP.get());
  }
   ...
   */
  private void setElements(entity.ListExpressionFragmentJoin[] value) {
  ...
  public void setGenerateArray(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(GENERATEARRAY_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ListExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ListExpressionFragment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.ListExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.ListExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.ListExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.ListExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.ListExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.ListExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ListExpressionFragment.class, config);
    com.guidewire._generated.entity.ListExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ListExpressionFragment, com.guidewire._generated.entity.ListExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.ListExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ListExpressionFragmentInternal getInternalInterface(entity.ListExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ListExpressionFragment newEmptyInstance() {
        return new entity.ListExpressionFragment((java.lang.Void)null);
      }
