 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "WorkflowWorkItem.eti;WorkflowWorkItem.eix;WorkflowWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "WorkflowWorkItem")
public class WorkflowWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WorkflowWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WorkflowWorkItem>("entity.WorkflowWorkItem");
  ...
  private com.guidewire._generated.entity.WorkflowWorkItemInternal _internal;
   ...
   */
  public WorkflowWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WorkflowWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WorkflowWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkflowWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.WorkflowWorkItem getSubtype() {
    return (typekey.WorkflowWorkItem)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
  }
   ...
   */
  private void setSubtype(typekey.WorkflowWorkItem value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkflowWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkflowWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.pl.domain.workflow.impl.WorkflowWorkItemImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkflowWorkItem.class, config);
    com.guidewire._generated.entity.WorkflowWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkflowWorkItem, com.guidewire._generated.entity.WorkflowWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.WorkflowWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkflowWorkItemInternal getInternalInterface(entity.WorkflowWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkflowWorkItem newEmptyInstance() {
        return new entity.WorkflowWorkItem((java.lang.Void)null);
      }
