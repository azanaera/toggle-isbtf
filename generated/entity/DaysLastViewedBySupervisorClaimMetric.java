...
/**
 * DaysLastViewedBySupervisorClaimMetric
 * Number of days since the supervisor last viewed the claim
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DaysLastViewedBySupervisorClaimMetric.eti;DaysLastViewedBySupervisorClaimMetric.eix;DaysLastViewedBySupervisorClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DaysLastViewedBySupervisorClaimMetric")
public class DaysLastViewedBySupervisorClaimMetric extends entity.TimeBasedClaimMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DaysLastViewedBySupervisorClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DaysLastViewedBySupervisorClaimMetric>("entity.DaysLastViewedBySupervisorClaimMetric");
   ...
   */
  public DaysLastViewedBySupervisorClaimMetric()  {
   ...
   */
  public DaysLastViewedBySupervisorClaimMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DaysLastViewedBySupervisorClaimMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DaysLastViewedBySupervisorClaimMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.claim.metric.activity.DaysLastViewedBySupervisorClaimMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DaysLastViewedBySupervisorClaimMetric.class, config);
    com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DaysLastViewedBySupervisorClaimMetric, com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.DaysLastViewedBySupervisorClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DaysLastViewedBySupervisorClaimMetricInternal getInternalInterface(entity.DaysLastViewedBySupervisorClaimMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DaysLastViewedBySupervisorClaimMetric newEmptyInstance() {
        return new entity.DaysLastViewedBySupervisorClaimMetric((java.lang.Void)null);
      }
