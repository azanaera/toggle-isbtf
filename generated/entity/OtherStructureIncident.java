 ...
 * Report of an incident involving a secondary structure
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OtherStructureIncident.eti;OtherStructureIncident.eix;OtherStructureIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OtherStructureIncident")
public class OtherStructureIncident extends entity.FixedPropertyIncident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OtherStructureIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OtherStructureIncident>("entity.OtherStructureIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> FENCESDAMAGED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "FencesDamaged");
   ...
   */
  public OtherStructureIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OtherStructureIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.OtherStructureIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OtherStructureIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.OtherStructureIncidentInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the FencesDamaged field.
   * Whether fences were damaged
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isFencesDamaged() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(FENCESDAMAGED_PROP.get());
  }
  
  /**
   * Sets the value of the FencesDamaged field.
   */
  public void setFencesDamaged(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(FENCESDAMAGED_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OtherStructureIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OtherStructureIncident.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    ...
    config.put("gw.cc.exposure.entity.FixedPropertyIncident", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    config.put("gw.cc.exposure.entity.OtherStructureIncident", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.OtherStructureIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OtherStructureIncident.class, config);
    com.guidewire._generated.entity.OtherStructureIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OtherStructureIncident, com.guidewire._generated.entity.OtherStructureIncidentInternal>() {
      public java.lang.Object getImplementation(entity.OtherStructureIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OtherStructureIncidentInternal getInternalInterface(entity.OtherStructureIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OtherStructureIncident newEmptyInstance() {
        return new entity.OtherStructureIncident((java.lang.Void)null);
      }
