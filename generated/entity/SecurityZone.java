 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SecurityZone.eti;SecurityZone.eix;SecurityZone.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "SecurityZone")
public class SecurityZone extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.SecurityZone> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.SecurityZone>("entity.SecurityZone");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> GROUPS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "Groups");
  ...
  private com.guidewire._generated.entity.SecurityZoneInternal _internal;
   ...
   */
  public SecurityZone(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected SecurityZone(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.SecurityZoneInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.SecurityZoneInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToGroups(entity.Group element) {
    __getInternalInterface().addArrayElement(GROUPS_PROP.get(), element);
  }
  ...
  public entity.SecurityZone_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.SecurityZone_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.Group[] getGroups() {
    return (entity.Group[])__getInternalInterface().getFieldValue(GROUPS_PROP.get());
  }
  ...
  public entity.SecurityZone_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.SecurityZone_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public void removeFromGroups(entity.Group element) {
    __getInternalInterface().removeArrayElement(GROUPS_PROP.get(), element);
  }
  ...
  public void removeFromGroups(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(GROUPS_PROP.get(), elementID);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.SecurityZone_Description_L10N[] value) {
  ...
  public void setGroups(entity.Group[] value) {
    __getInternalInterface().setFieldValue(GROUPS_PROP.get(), value);
  }
   ...
   */
  private void setName_L10N_ARRAY(entity.SecurityZone_Name_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.SecurityZoneInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.SecurityZone.this.__getDelegateManager();
    }
    ...
    public entity.SecurityZone_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.SecurityZone_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.SecurityZone_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.SecurityZone_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.SecurityZone.class, config);
    com.guidewire._generated.entity.SecurityZoneInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.SecurityZone, com.guidewire._generated.entity.SecurityZoneInternal>() {
      public java.lang.Object getImplementation(entity.SecurityZone bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.SecurityZoneInternal getInternalInterface(entity.SecurityZone bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.SecurityZone newEmptyInstance() {
        return new entity.SecurityZone((java.lang.Void)null);
      }
