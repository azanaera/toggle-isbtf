 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "History.eti;History.eix;History.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "History")
public class History extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable, entity.Extractable {
  ...
  public void safeSetDescription(java.lang.String description) {
    ((com.guidewire.cc.domain.history.impl.HistoryCoreExtMethods)__getDelegateManager().getImplementation("com.guidewire.cc.domain.history.impl.HistoryCoreExtMethods")).safeSetDescription(description);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.HistoryInternal {
    ...
    public boolean isDuplicate(gw.pl.persistence.core.Key claimID, gw.pl.persistence.core.Key exposureID, gw.pl.persistence.core.Key matterID, gw.pl.persistence.core.Key userID, java.lang.String rule, typekey.HistoryType type, typekey.CustomHistoryType customType, java.lang.String description) {
      return ((com.guidewire.cc.domain.history.impl.HistoryCoreExtInternalMethods)__getDelegateManager().getImplementation("com.guidewire.cc.domain.history.impl.HistoryCoreExtInternalMethods")).isDuplicate(claimID, exposureID, matterID, userID, rule, type, customType, description);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.history.impl.HistoryCoreExtInternalMethods", "com.guidewire.cc.domain.history.impl.HistoryCoreExtMethodsImpl");
    config.put("com.guidewire.cc.domain.history.impl.HistoryCoreExtMethods", "com.guidewire.cc.domain.history.impl.HistoryCoreExtMethodsImpl");
