 ...
 * Facultative Gross Excess of Loss reinsurance agreement.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "FacExcessOfLossRIAgreement.eti;FacExcessOfLossRIAgreement.eix;FacExcessOfLossRIAgreement.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "FacExcessOfLossRIAgreement")
public class FacExcessOfLossRIAgreement extends entity.NonProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.FacExcessOfLossRIAgreement> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.FacExcessOfLossRIAgreement>("entity.FacExcessOfLossRIAgreement");
   ...
   */
  public FacExcessOfLossRIAgreement()  {
   ...
   */
  public FacExcessOfLossRIAgreement(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected FacExcessOfLossRIAgreement(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.FacExcessOfLossRIAgreement.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.FacExcessOfLossRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("gw.cc.reinsurance.entity.NonProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.FacExcessOfLossRIAgreementImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.FacExcessOfLossRIAgreement.class, config);
    com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.FacExcessOfLossRIAgreement, com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternal>() {
      public java.lang.Object getImplementation(entity.FacExcessOfLossRIAgreement bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.FacExcessOfLossRIAgreementInternal getInternalInterface(entity.FacExcessOfLossRIAgreement bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.FacExcessOfLossRIAgreement newEmptyInstance() {
        return new entity.FacExcessOfLossRIAgreement((java.lang.Void)null);
      }
