 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "OtherBenefit.eti;OtherBenefit.eix;OtherBenefit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "OtherBenefit")
public class OtherBenefit extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.OtherBenefit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.OtherBenefit>("entity.OtherBenefit");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INITIALCONTACT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InitialContact");
  ...
  private com.guidewire._generated.entity.OtherBenefitInternal _internal;
   ...
   */
  public OtherBenefit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected OtherBenefit(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.OtherBenefitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.OtherBenefitInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  /**
   * The currency related to this otherBenefit.
   * @return claim's currency
   */
  public typekey.Currency getClaimCurrency() {
    return ((gw.cc.claim.entity.OtherBenefit)__getDelegateManager().getImplementation("gw.cc.claim.entity.OtherBenefit")).getClaimCurrency();
  }
  ...
  public java.lang.String getInitialContact() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INITIALCONTACT_PROP.get());
  }
  ...
  public void setInitialContact(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INITIALCONTACT_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.OtherBenefitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.OtherBenefit.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.OtherBenefit", "com.guidewire.cc.domain.claim.impl.OtherBenefitImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.OtherBenefit.class, config);
    com.guidewire._generated.entity.OtherBenefitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.OtherBenefit, com.guidewire._generated.entity.OtherBenefitInternal>() {
      public java.lang.Object getImplementation(entity.OtherBenefit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.OtherBenefitInternal getInternalInterface(entity.OtherBenefit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.OtherBenefit newEmptyInstance() {
        return new entity.OtherBenefit((java.lang.Void)null);
      }
