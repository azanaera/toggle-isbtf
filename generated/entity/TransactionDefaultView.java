 ...
 * Aggregates the information needed to display a Transaction using the All or Custom filters of the Financials Transactions page. Subtype of TransactionView.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TransactionDefaultView.eti;TransactionDefaultView.eix;TransactionDefaultView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TransactionDefaultView")
public class TransactionDefaultView extends entity.TransactionView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TransactionDefaultView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TransactionDefaultView>("entity.TransactionDefaultView");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> TRANSACTIONSUBTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "TransactionSubtype");
   ...
   */
  public TransactionDefaultView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TransactionDefaultView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TransactionDefaultViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TransactionDefaultViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TransactionDefaultViewInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the TransactionSubtype field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.Transaction getTransactionSubtype() {
    return (typekey.Transaction)__getInternalInterface().getFieldValue(TRANSACTIONSUBTYPE_PROP.get());
  }
  
  /**
   * Returns the type of the transaction subtype, e.g., Payment, Reserve, etc.  Value is localized.
   * @return String containing the name of the transaction subtype
   */
  public java.lang.String getTransactionTypeName() {
    return ((gw.cc.financials.entity.TransactionDefaultView)__getDelegateManager().getImplementation("gw.cc.financials.entity.TransactionDefaultView")).getTransactionTypeName();
  }
  
  /**
   * Sets the value of the TransactionSubtype field.
   */
  public void setTransactionSubtype(typekey.Transaction value) {
    __getInternalInterface().setFieldValue(TRANSACTIONSUBTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TransactionDefaultViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TransactionDefaultView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.financials.entity.TransactionDefaultView", "com.guidewire.cc.domain.financials.impl.TransactionDefaultViewImpl");
    config.put("gw.cc.financials.entity.TransactionView", "com.guidewire.cc.domain.financials.impl.TransactionDefaultViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TransactionDefaultView.class, config);
    com.guidewire._generated.entity.TransactionDefaultViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TransactionDefaultView, com.guidewire._generated.entity.TransactionDefaultViewInternal>() {
      public java.lang.Object getImplementation(entity.TransactionDefaultView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TransactionDefaultViewInternal getInternalInterface(entity.TransactionDefaultView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TransactionDefaultView newEmptyInstance() {
        return new entity.TransactionDefaultView((java.lang.Void)null);
      }
