 ...
 * ExpCloseReopenInfo
 * 
 *       Holds transitional internal state information during all exposure close or
 *       reopen operations. This acts as a abstract base entity for CloseExposureInfo and
 *       ReopenExposureInfo.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ExpCloseReopenInfo.eti;ExpCloseReopenInfo.eix;ExpCloseReopenInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ExpCloseReopenInfo")
public class ExpCloseReopenInfo extends entity.CloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ExpCloseReopenInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ExpCloseReopenInfo>("entity.ExpCloseReopenInfo");
   ...
   */
  public ExpCloseReopenInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ExpCloseReopenInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ExpCloseReopenInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ExpCloseReopenInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ExpCloseReopenInfoInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ExpCloseReopenInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ExpCloseReopenInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.exposure.impl.ExpCloseReopenInfoImpl");
    config.put("gw.cc.exposure.entity.ExpCloseReopenInfo", "com.guidewire.cc.domain.exposure.impl.ExpCloseReopenInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ExpCloseReopenInfo.class, config);
    com.guidewire._generated.entity.ExpCloseReopenInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ExpCloseReopenInfo, com.guidewire._generated.entity.ExpCloseReopenInfoInternal>() {
      public java.lang.Object getImplementation(entity.ExpCloseReopenInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ExpCloseReopenInfoInternal getInternalInterface(entity.ExpCloseReopenInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ExpCloseReopenInfo newEmptyInstance() {
        return new entity.ExpCloseReopenInfo((java.lang.Void)null);
      }
