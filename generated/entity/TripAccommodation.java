...
/**
 * TripAccommodation
 * Used to track the original and changed accommodation on the travel schedule for the insured/claimant
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TripAccommodation.eti;TripAccommodation.eix;TripAccommodation.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TripAccommodation")
public class TripAccommodation extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.TripAccommodationDelegate, entity.TripExpenseCancellationDelegate, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TripAccommodation> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TripAccommodation>("entity.TripAccommodation");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> ADDNLTRIPACCOMMODATIONS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "AddnlTripAccommodations");
  ...
  private com.guidewire._generated.entity.TripAccommodationInternal _internal;
   ...
   */
  public TripAccommodation(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TripAccommodation(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.TripAccommodationInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TripAccommodationInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToAddnlTripAccommodations(entity.AddnlTripAccommodation element) {
    __getInternalInterface().addArrayElement(ADDNLTRIPACCOMMODATIONS_PROP.get(), element);
  }
  ...
  public entity.AddnlTripAccommodation[] getAddnlTripAccommodations() {
    return (entity.AddnlTripAccommodation[])__getInternalInterface().getFieldValue(ADDNLTRIPACCOMMODATIONS_PROP.get());
  }
  ...
  public typekey.Currency getClaimCurrency() {
    return ((gw.cc.exposure.entity.TripExpenseDelegate)__getDelegateManager().getImplementation("gw.cc.exposure.entity.TripExpenseDelegate")).getClaimCurrency();
  }
  ...
  public void removeFromAddnlTripAccommodations(entity.AddnlTripAccommodation element) {
    __getInternalInterface().removeArrayElement(ADDNLTRIPACCOMMODATIONS_PROP.get(), element);
  }
  ...
  public void removeFromAddnlTripAccommodations(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(ADDNLTRIPACCOMMODATIONS_PROP.get(), elementID);
  }
  ...
  public void setAddnlTripAccommodations(entity.AddnlTripAccommodation[] value) {
    __getInternalInterface().setFieldValue(ADDNLTRIPACCOMMODATIONS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TripAccommodationInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TripAccommodation.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.TripAccommodation", "com.guidewire.cc.domain.exposure.impl.TripAccommodationImpl");
    ...
    config.put("gw.cc.exposure.entity.TripExpenseCancellationDelegate", "com.guidewire.cc.domain.exposure.impl.TripAccommodationImpl");
    config.put("gw.cc.exposure.entity.TripExpenseDelegate", "com.guidewire.cc.domain.exposure.impl.TripAccommodationImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TripAccommodation.class, config);
    com.guidewire._generated.entity.TripAccommodationInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TripAccommodation, com.guidewire._generated.entity.TripAccommodationInternal>() {
      public java.lang.Object getImplementation(entity.TripAccommodation bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TripAccommodationInternal getInternalInterface(entity.TripAccommodation bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TripAccommodation newEmptyInstance() {
        return new entity.TripAccommodation((java.lang.Void)null);
      }
