...
/**
 * QuestionChoice
 * One choice in the set of choices for a question of type Choice
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "QuestionChoice.eti;QuestionChoice.eix;QuestionChoice.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "QuestionChoice")
public class QuestionChoice extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.QuestionChoice> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.QuestionChoice>("entity.QuestionChoice");
  ...
  private com.guidewire._generated.entity.QuestionChoiceInternal _internal;
   ...
   */
  public QuestionChoice(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected QuestionChoice(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.QuestionChoiceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.QuestionChoiceInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.QuestionChoice_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.QuestionChoice_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.QuestionChoice_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.QuestionChoice_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.QuestionChoice_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.QuestionChoice_Name_L10N[] value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.QuestionChoiceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.QuestionChoice.this.__getDelegateManager();
    }
    ...
    public entity.QuestionChoice_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.QuestionChoice_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.QuestionChoice_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.QuestionChoice_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("gw.cc.question.entity.QuestionChoice", "com.guidewire.cc.domain.question.impl.QuestionChoiceImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.QuestionChoice.class, config);
    com.guidewire._generated.entity.QuestionChoiceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.QuestionChoice, com.guidewire._generated.entity.QuestionChoiceInternal>() {
      public java.lang.Object getImplementation(entity.QuestionChoice bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.QuestionChoiceInternal getInternalInterface(entity.QuestionChoice bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.QuestionChoice newEmptyInstance() {
        return new entity.QuestionChoice((java.lang.Void)null);
      }
