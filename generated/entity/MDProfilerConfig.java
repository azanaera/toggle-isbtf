 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MDProfilerConfig.eti;MDProfilerConfig.eix;MDProfilerConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MDProfilerConfig")
public class MDProfilerConfig extends entity.ProfilerConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MDProfilerConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MDProfilerConfig>("entity.MDProfilerConfig");
   ...
   */
  public MDProfilerConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MDProfilerConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.MDProfilerConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MDProfilerConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.MDProfilerConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MDProfilerConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MDProfilerConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MDProfilerConfig.class, config);
    com.guidewire._generated.entity.MDProfilerConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MDProfilerConfig, com.guidewire._generated.entity.MDProfilerConfigInternal>() {
      public java.lang.Object getImplementation(entity.MDProfilerConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MDProfilerConfigInternal getInternalInterface(entity.MDProfilerConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MDProfilerConfig newEmptyInstance() {
        return new entity.MDProfilerConfig((java.lang.Void)null);
      }
