 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Doctor.eti;Doctor.eix;Doctor.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Doctor")
public class Doctor extends entity.PersonVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Doctor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Doctor>("entity.Doctor");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MEDICALLICENSE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MedicalLicense");
   ...
   */
  public Doctor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Doctor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DoctorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DoctorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DoctorInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getMedicalLicense() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(MEDICALLICENSE_PROP.get());
  }
  ...
  public void setMedicalLicense(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(MEDICALLICENSE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DoctorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Doctor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Doctor.class, config);
    com.guidewire._generated.entity.DoctorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Doctor, com.guidewire._generated.entity.DoctorInternal>() {
      public java.lang.Object getImplementation(entity.Doctor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DoctorInternal getInternalInterface(entity.Doctor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Doctor newEmptyInstance() {
        return new entity.Doctor((java.lang.Void)null);
      }
