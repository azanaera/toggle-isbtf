 ...
 * ContactTag
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ContactTag.eti;ContactTag.eix;ContactTag.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ContactTag")
public class ContactTag extends com.guidewire.pl.persistence.code.BeanBase implements entity.AddressBookLinkable, entity.Retireable, entity.Extractable, entity.OverlapTable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ContactTag> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ContactTag>("entity.ContactTag");
  ...
  private com.guidewire._generated.entity.ContactTagInternal _internal;
   ...
   */
  public ContactTag(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ContactTag(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ContactTagInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContactTagInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setContact(entity.Contact value) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContactTagInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContactTag.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.contact.impl.ContactTagCoreExtMethods", "com.guidewire.cc.domain.contact.impl.ContactTagCoreExtMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContactTag.class, config);
    com.guidewire._generated.entity.ContactTagInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContactTag, com.guidewire._generated.entity.ContactTagInternal>() {
      public java.lang.Object getImplementation(entity.ContactTag bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContactTagInternal getInternalInterface(entity.ContactTag bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContactTag newEmptyInstance() {
        return new entity.ContactTag((java.lang.Void)null);
      }
