 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "Place.eti;Place.eix;Place.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "Place")
public class Place extends entity.Contact {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.Place> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.Place>("entity.Place");
   ...
   */
  public Place(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected Place(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PlaceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PlaceInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PlaceInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PlaceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.Place.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.Place.class, config);
    com.guidewire._generated.entity.PlaceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.Place, com.guidewire._generated.entity.PlaceInternal>() {
      public java.lang.Object getImplementation(entity.Place bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PlaceInternal getInternalInterface(entity.Place bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.Place newEmptyInstance() {
        return new entity.Place((java.lang.Void)null);
      }
