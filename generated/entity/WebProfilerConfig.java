 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "WebProfilerConfig.eti;WebProfilerConfig.eix;WebProfilerConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "WebProfilerConfig")
public class WebProfilerConfig extends entity.ProfilerConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WebProfilerConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WebProfilerConfig>("entity.WebProfilerConfig");
   ...
   */
  public WebProfilerConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WebProfilerConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.WebProfilerConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WebProfilerConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.WebProfilerConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WebProfilerConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WebProfilerConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WebProfilerConfig.class, config);
    com.guidewire._generated.entity.WebProfilerConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WebProfilerConfig, com.guidewire._generated.entity.WebProfilerConfigInternal>() {
      public java.lang.Object getImplementation(entity.WebProfilerConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WebProfilerConfigInternal getInternalInterface(entity.WebProfilerConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WebProfilerConfig newEmptyInstance() {
        return new entity.WebProfilerConfig((java.lang.Void)null);
      }
