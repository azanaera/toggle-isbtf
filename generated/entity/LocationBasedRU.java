...
/**
 * LocationBasedRU
 * A RiskUnit that has a (Policy) Location associated with it.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LocationBasedRU.eti;LocationBasedRU.eix;LocationBasedRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LocationBasedRU")
public class LocationBasedRU extends entity.RiskUnit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LocationBasedRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LocationBasedRU>("entity.LocationBasedRU");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> BUILDING_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "Building");
   ...
   */
  public LocationBasedRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LocationBasedRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LocationBasedRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationBasedRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LocationBasedRUInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationBasedRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationBasedRU.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.LocationBasedRU", "com.guidewire.cc.domain.policy.impl.LocationBasedRUImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.LocationBasedRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationBasedRU.class, config);
    com.guidewire._generated.entity.LocationBasedRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationBasedRU, com.guidewire._generated.entity.LocationBasedRUInternal>() {
      public java.lang.Object getImplementation(entity.LocationBasedRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationBasedRUInternal getInternalInterface(entity.LocationBasedRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationBasedRU newEmptyInstance() {
        return new entity.LocationBasedRU((java.lang.Void)null);
      }
