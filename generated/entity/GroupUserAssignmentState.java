...
@gw.entity.EntityName(value = "GroupUserAssignmentState")
public class GroupUserAssignmentState extends com.guidewire.pl.persistence.code.BeanBase implements entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.GroupUserAssignmentState> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.GroupUserAssignmentState>("entity.GroupUserAssignmentState");
  ...
  private com.guidewire._generated.entity.GroupUserAssignmentStateInternal _internal;
   ...
   */
  public GroupUserAssignmentState()  {
   ...
   */
  public GroupUserAssignmentState(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected GroupUserAssignmentState(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.GroupUserAssignmentStateInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.GroupUserAssignmentStateInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public entity.GroupAssignmentState getGroup() {
    return (entity.GroupAssignmentState)__getInternalInterface().getFieldValue(GROUP_PROP.get());
  }
  
  /**
   * returns the associated group assignment state base
   * @return group assignment state base
   */
  public entity.GroupAssignmentState getGroupAssignmentState() {
    return ((com.guidewire.pl.domain.assignment.GroupUserAssignmentStatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.assignment.GroupUserAssignmentStatePublicMethods")).getGroupAssignmentState();
  }
   ...
   */
  public void setGroupAssignmentState(entity.GroupAssignmentState value) {
    ((com.guidewire.pl.domain.assignment.GroupUserAssignmentStatePublicMethods)__getDelegateManager().getImplementation("com.guidewire.pl.domain.assignment.GroupUserAssignmentStatePublicMethods")).setGroupAssignmentState(value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.GroupUserAssignmentStateInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.GroupUserAssignmentState.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.assignment.GroupUserAssignmentStatePublicMethods", "com.guidewire.pl.domain.assignment.impl.GroupUserAssignmentStateImpl");
    config.put("com.guidewire.pl.domain.assignment.impl.GroupUserAssignmentStateInternalMethods", "com.guidewire.pl.domain.assignment.impl.GroupUserAssignmentStateImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.GroupUserAssignmentState.class, config);
    com.guidewire._generated.entity.GroupUserAssignmentStateInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.GroupUserAssignmentState, com.guidewire._generated.entity.GroupUserAssignmentStateInternal>() {
      public java.lang.Object getImplementation(entity.GroupUserAssignmentState bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.GroupUserAssignmentStateInternal getInternalInterface(entity.GroupUserAssignmentState bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.GroupUserAssignmentState newEmptyInstance() {
        return new entity.GroupUserAssignmentState((java.lang.Void)null);
      }
