 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "NoArgCriterionConfig.eti;NoArgCriterionConfig.eix;NoArgCriterionConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "NoArgCriterionConfig")
public class NoArgCriterionConfig extends entity.BaseCriterionConfig {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.NoArgCriterionConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.NoArgCriterionConfig>("entity.NoArgCriterionConfig");
   ...
   */
  public NoArgCriterionConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected NoArgCriterionConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.NoArgCriterionConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.NoArgCriterionConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.NoArgCriterionConfigInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.NoArgCriterionConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.NoArgCriterionConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.NoArgCriterionConfig.class, config);
    com.guidewire._generated.entity.NoArgCriterionConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.NoArgCriterionConfig, com.guidewire._generated.entity.NoArgCriterionConfigInternal>() {
      public java.lang.Object getImplementation(entity.NoArgCriterionConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.NoArgCriterionConfigInternal getInternalInterface(entity.NoArgCriterionConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.NoArgCriterionConfig newEmptyInstance() {
        return new entity.NoArgCriterionConfig((java.lang.Void)null);
      }
