 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimContact.eti;ClaimContact.eix;ClaimContact.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimContact")
public class ClaimContact extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable, entity.EventAware, gw.api.contact.ContactHandle {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> HASSR22RESPONSE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "HasSR22Response_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOADCOMMANDID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LoadCommandID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> NONDRIVERREASON_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "NonDriverReason_Ext");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RELATIONSHIPTOINSURED_EXT_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RelationshipToInsured_Ext");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RETIREDVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RetiredValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REVOKEDSUSPENDEDLICENSE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RevokedSuspendedLicense_Ext");
  ...
  public static final java.lang.String CLAIMCONTACTADDED_EVENT = "ClaimContactAdded";
  
  public static final java.lang.String CLAIMCONTACTCHANGED_EVENT = "ClaimContactChanged";
  
  public static final java.lang.String CLAIMCONTACTCONTACTCHANGED_EVENT = "ClaimContactContactChanged";
  
  public static final java.lang.String CLAIMCONTACTREMOVED_EVENT = "ClaimContactRemoved";
  ...
  /**
   * Gets the value of the NonDriverReason_Ext field.
   * Non-Driver Reason for Contact from Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.NonDriverReason_Ext getNonDriverReason_Ext() {
    return (typekey.NonDriverReason_Ext)__getInternalInterface().getFieldValue(NONDRIVERREASON_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the RelationshipToInsured_Ext field.
   * Relationship of Contact to insured from Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.PersonRelationType getRelationshipToInsured_Ext() {
    return (typekey.PersonRelationType)__getInternalInterface().getFieldValue(RELATIONSHIPTOINSURED_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the HasSR22Response_Ext field.
   * Indicates if contact has Sr22 from Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isHasSR22Response_Ext() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(HASSR22RESPONSE_EXT_PROP.get());
  }
  ...
  /**
   * Gets the value of the RevokedSuspendedLicense_Ext field.
   * Indicates if contact has a revoked or suspende licenese fro Sure system
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isRevokedSuspendedLicense_Ext() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(REVOKEDSUSPENDEDLICENSE_EXT_PROP.get());
  }
  ...
  /**
   * Sets the value of the HasSR22Response_Ext field.
   */
  public void setHasSR22Response_Ext(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(HASSR22RESPONSE_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the NonDriverReason_Ext field.
   */
  public void setNonDriverReason_Ext(typekey.NonDriverReason_Ext value) {
    __getInternalInterface().setFieldValue(NONDRIVERREASON_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the RelationshipToInsured_Ext field.
   */
  public void setRelationshipToInsured_Ext(typekey.PersonRelationType value) {
    __getInternalInterface().setFieldValue(RELATIONSHIPTOINSURED_EXT_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the RevokedSuspendedLicense_Ext field.
   */
  public void setRevokedSuspendedLicense_Ext(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(REVOKEDSUSPENDEDLICENSE_EXT_PROP.get(), value);
  }
