...
/**
 * DaysOpenExposureMetric
 * Days Open
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DaysOpenExposureMetric.eti;DaysOpenExposureMetric.eix;DaysOpenExposureMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DaysOpenExposureMetric")
public class DaysOpenExposureMetric extends entity.TimeBasedExposureMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DaysOpenExposureMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DaysOpenExposureMetric>("entity.DaysOpenExposureMetric");
   ...
   */
  public DaysOpenExposureMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DaysOpenExposureMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DaysOpenExposureMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DaysOpenExposureMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DaysOpenExposureMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DaysOpenExposureMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DaysOpenExposureMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.exposure.metric.general.DaysOpenExposureMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DaysOpenExposureMetric.class, config);
    com.guidewire._generated.entity.DaysOpenExposureMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DaysOpenExposureMetric, com.guidewire._generated.entity.DaysOpenExposureMetricInternal>() {
      public java.lang.Object getImplementation(entity.DaysOpenExposureMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DaysOpenExposureMetricInternal getInternalInterface(entity.DaysOpenExposureMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DaysOpenExposureMetric newEmptyInstance() {
        return new entity.DaysOpenExposureMetric((java.lang.Void)null);
      }
