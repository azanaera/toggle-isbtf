...
/**
 * ClaimIndicatorAutomatedNotificationHandler
 * 
 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimIndicatorAutomatedNotificationHandler.eti;ClaimIndicatorAutomatedNotificationHandler.eix;ClaimIndicatorAutomatedNotificationHandler.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimIndicatorAutomatedNotificationHandler")
public class ClaimIndicatorAutomatedNotificationHandler extends entity.AutomatedNotificationHandler implements gw.api.specialhandling.AutomatedHandlerMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimIndicatorAutomatedNotificationHandler> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimIndicatorAutomatedNotificationHandler>("entity.ClaimIndicatorAutomatedNotificationHandler");
   ...
   */
  public ClaimIndicatorAutomatedNotificationHandler()  {
   ...
   */
  public ClaimIndicatorAutomatedNotificationHandler(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimIndicatorAutomatedNotificationHandler(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimIndicatorAutomatedNotificationHandler.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.specialhandling.AutomatedHandlerMethods", "gw.specialhandling.ClaimIndicatorAutomatedNotificationHandlerMethodsImpl");
    config.put("gw.cc.specialhandling.entity.AutomatedHandler", "com.guidewire.cc.domain.specialhandling.impl.ClaimIndicatorAutomatedNotificationHandlerImpl");
    config.put("gw.cc.specialhandling.entity.AutomatedNotificationHandler", "com.guidewire.cc.domain.specialhandling.impl.ClaimIndicatorAutomatedNotificationHandlerImpl");
    config.put("gw.cc.specialhandling.entity.ClaimIndicatorAutomatedNotificationHandler", "com.guidewire.cc.domain.specialhandling.impl.ClaimIndicatorAutomatedNotificationHandlerImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimIndicatorAutomatedNotificationHandler.class, config);
    com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimIndicatorAutomatedNotificationHandler, com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternal>() {
      public java.lang.Object getImplementation(entity.ClaimIndicatorAutomatedNotificationHandler bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimIndicatorAutomatedNotificationHandlerInternal getInternalInterface(entity.ClaimIndicatorAutomatedNotificationHandler bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimIndicatorAutomatedNotificationHandler newEmptyInstance() {
        return new entity.ClaimIndicatorAutomatedNotificationHandler((java.lang.Void)null);
      }
