...
/**
 * LocationMiscRU
 * A miscellaneous type of RiskUnit. Examples are Accounts Receivable, Scheduled Equipment, Signs etc.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LocationMiscRU.eti;LocationMiscRU.eix;LocationMiscRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LocationMiscRU")
public class LocationMiscRU extends entity.LocationBasedRU {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LocationMiscRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LocationMiscRU>("entity.LocationMiscRU");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> OTHERRISKTYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "OtherRiskType");
   ...
   */
  public LocationMiscRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LocationMiscRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LocationMiscRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationMiscRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LocationMiscRUInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the OtherRiskType field.
   * Type of location based miscellaneous risk unit
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.OtherRiskType getOtherRiskType() {
    return (typekey.OtherRiskType)__getInternalInterface().getFieldValue(OTHERRISKTYPE_PROP.get());
  }
  
  /**
   * Sets the value of the OtherRiskType field.
   */
  public void setOtherRiskType(typekey.OtherRiskType value) {
    __getInternalInterface().setFieldValue(OTHERRISKTYPE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationMiscRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationMiscRU.this.__getDelegateManager();
    }
    ...
    /**
     * Adds the given element to the CoverageParts array. This is achieved by setting the parent foreign key to this entity instance.
     */
    public void addToCoverageParts(entity.CoveragePart element) {
      __getInternalInterface().addArrayElement(COVERAGEPARTS_PROP.get(), element);
    }
    ...
    /**
     * Gets the value of the CoverageParts field.
     * List of coverage part types related to the risk unit.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public entity.CoveragePart[] getCoverageParts() {
      return (entity.CoveragePart[])__getInternalInterface().getFieldValue(COVERAGEPARTS_PROP.get());
    }
    ...
    /**
     * Removes the given element from the CoverageParts array. This is achieved by marking the element for removal.
     */
    public void removeFromCoverageParts(entity.CoveragePart element) {
      __getInternalInterface().removeArrayElement(COVERAGEPARTS_PROP.get(), element);
    }
    ...
    public void removeFromCoverageParts(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(COVERAGEPARTS_PROP.get(), elementID);
    }
    ...
    /**
     * Sets the value of the CoverageParts field.
     */
    public void setCoverageParts(entity.CoveragePart[] value) {
      __getInternalInterface().setFieldValue(COVERAGEPARTS_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.cc.policy.entity.LocationBasedRU", "com.guidewire.cc.domain.policy.impl.LocationMiscRUImpl");
    config.put("gw.cc.policy.entity.LocationMiscRU", "com.guidewire.cc.domain.policy.impl.LocationMiscRUImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.LocationMiscRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationMiscRU.class, config);
    com.guidewire._generated.entity.LocationMiscRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationMiscRU, com.guidewire._generated.entity.LocationMiscRUInternal>() {
      public java.lang.Object getImplementation(entity.LocationMiscRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationMiscRUInternal getInternalInterface(entity.LocationMiscRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationMiscRU newEmptyInstance() {
        return new entity.LocationMiscRU((java.lang.Void)null);
      }
