...
/**
 * LookupExpressionFragment
 * Expression fragment for the case when the expression is a lookup.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LookupExpressionFragment.eti;LookupExpressionFragment.eix;LookupExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LookupExpressionFragment")
public class LookupExpressionFragment extends entity.ConditionExpressionFragment implements com.guidewire.bizrules.codegenerator.LookupExpressionFragmentValidationMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LookupExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LookupExpressionFragment>("entity.LookupExpressionFragment");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOOKUPEXPRESSION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LookupExpression");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> RULELOOKUPREQUESTDEF_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "RuleLookupRequestDef");
   ...
   */
  public LookupExpressionFragment()  {
   ...
   */
  public LookupExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LookupExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.LookupExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LookupExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.LookupExpressionFragmentInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getLookupExpression() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(LOOKUPEXPRESSION_PROP.get());
  }
  ...
  public entity.RuleLookupRequestDef getRuleLookupRequestDef() {
    return (entity.RuleLookupRequestDef)__getInternalInterface().getFieldValue(RULELOOKUPREQUESTDEF_PROP.get());
  }
  ...
  public void setLookupExpression(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(LOOKUPEXPRESSION_PROP.get(), value);
  }
  ...
  public void setRuleLookupRequestDef(entity.RuleLookupRequestDef value) {
    __getInternalInterface().setFieldValue(RULELOOKUPREQUESTDEF_PROP.get(), value);
  }
  
  public java.util.Map<java.lang.String, java.lang.String[]> validateLookupExpression(gw.bizrules.context.provider.RuleContextDefinitionProvider arg0, entity.RuleLookupRequestDef arg1, gw.plugin.lookup.LookupMetadata arg2) {
    return ((com.guidewire.bizrules.codegenerator.LookupExpressionFragmentValidationMethods)__getDelegateManager().getImplementation("com.guidewire.bizrules.codegenerator.LookupExpressionFragmentValidationMethods")).validateLookupExpression(arg0, arg1, arg2);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LookupExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LookupExpressionFragment.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getRuleLookupRequestDefID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(RULELOOKUPREQUESTDEF_PROP.get());
    }
    ...
    public void setRuleLookupRequestDefID(gw.pl.persistence.core.Key value) {
      setFieldValue(RULELOOKUPREQUESTDEF_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.LookupExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.codegenerator.LookupExpressionFragmentValidationMethods", "com.guidewire.bizrules.codegenerator.LookupExpressionFragmentGosuTextBuilder");
    config.put("com.guidewire.bizrules.domain.ConditionExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.ConditionExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.LookupExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.LookupExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.LookupExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LookupExpressionFragment.class, config);
    com.guidewire._generated.entity.LookupExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LookupExpressionFragment, com.guidewire._generated.entity.LookupExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.LookupExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LookupExpressionFragmentInternal getInternalInterface(entity.LookupExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LookupExpressionFragment newEmptyInstance() {
        return new entity.LookupExpressionFragment((java.lang.Void)null);
      }
