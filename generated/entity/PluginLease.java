 ...
 * PluginLease
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PluginLease.eti;PluginLease.eix;PluginLease.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PluginLease")
public class PluginLease extends com.guidewire.pl.persistence.code.BeanBase implements entity.Lease, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PluginLease> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PluginLease>("entity.PluginLease");
  ...
  private com.guidewire._generated.entity.PluginLeaseInternal _internal;
   ...
   */
  public PluginLease(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PluginLease(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.PluginLeaseInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PluginLeaseInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PluginLeaseInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PluginLease.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PluginLease.class, config);
    com.guidewire._generated.entity.PluginLeaseInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PluginLease, com.guidewire._generated.entity.PluginLeaseInternal>() {
      public java.lang.Object getImplementation(entity.PluginLease bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PluginLeaseInternal getInternalInterface(entity.PluginLease bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PluginLease newEmptyInstance() {
        return new entity.PluginLease((java.lang.Void)null);
      }
