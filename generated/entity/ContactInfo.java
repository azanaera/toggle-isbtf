 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ContactInfo.eti;ContactInfo.eix;ContactInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ContactInfo")
public class ContactInfo extends com.guidewire.pl.persistence.code.BeanBase implements entity.GlobalContactName, entity.GlobalPersonName, entity.DestructionRootPinnable, entity.Editable, com.guidewire.cc.domain.personaldata.purge.DestructionRootPinnablePublicMethods {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEDADDRESSBOOKUID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivedAddressbookUID");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEDPUBLICID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchivedPublicID");
  ...
  /**
   * Gets the value of the ArchivedAddressbookUID field.
   * ABUID of the archived contact
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getArchivedAddressbookUID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ARCHIVEDADDRESSBOOKUID_PROP.get());
  }
  
  /**
   * Gets the value of the ArchivedPublicID field.
   * PublicID of the archived contact
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getArchivedPublicID() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ARCHIVEDPUBLICID_PROP.get());
  }
  ...
  /**
   * Sets the value of the ArchivedAddressbookUID field.
   */
  public void setArchivedAddressbookUID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ARCHIVEDADDRESSBOOKUID_PROP.get(), value);
  }
  
  /**
   * Sets the value of the ArchivedPublicID field.
   */
  public void setArchivedPublicID(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ARCHIVEDPUBLICID_PROP.get(), value);
  }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.personaldata.purge.DestructionRootPinnablePublicMethods", "com.guidewire.cc.domain.claim.archiving.impl.ContactInfoImpl");
