 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MedicalCareOrg.eti;MedicalCareOrg.eix;MedicalCareOrg.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MedicalCareOrg")
public class MedicalCareOrg extends entity.CompanyVendor {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MedicalCareOrg> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MedicalCareOrg>("entity.MedicalCareOrg");
   ...
   */
  public MedicalCareOrg(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MedicalCareOrg(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.MedicalCareOrgInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MedicalCareOrgInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.MedicalCareOrgInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MedicalCareOrgInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MedicalCareOrg.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MedicalCareOrg.class, config);
    com.guidewire._generated.entity.MedicalCareOrgInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MedicalCareOrg, com.guidewire._generated.entity.MedicalCareOrgInternal>() {
      public java.lang.Object getImplementation(entity.MedicalCareOrg bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MedicalCareOrgInternal getInternalInterface(entity.MedicalCareOrg bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MedicalCareOrg newEmptyInstance() {
        return new entity.MedicalCareOrg((java.lang.Void)null);
      }
