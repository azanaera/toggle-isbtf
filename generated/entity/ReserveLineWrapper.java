 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReserveLineWrapper.eti;ReserveLineWrapper.eix;ReserveLineWrapper.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReserveLineWrapper")
public class ReserveLineWrapper extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReserveLineWrapper> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReserveLineWrapper>("entity.ReserveLineWrapper");
  ...
  private com.guidewire._generated.entity.ReserveLineWrapperInternal _internal;
   ...
   */
  public ReserveLineWrapper(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReserveLineWrapper(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ReserveLineWrapperInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReserveLineWrapperInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReserveLineWrapperInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReserveLineWrapper.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getBulkInvoiceItemID() {
      return ((com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperInternal")).getBulkInvoiceItemID();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperInternal", "com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperImpl");
    ...
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperImpl");
    config.put("gw.cc.financials.bulkpay.entity.ReserveLineWrapper", "com.guidewire.cc.domain.financials.bulkpay.impl.ReserveLineWrapperImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReserveLineWrapper.class, config);
    com.guidewire._generated.entity.ReserveLineWrapperInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReserveLineWrapper, com.guidewire._generated.entity.ReserveLineWrapperInternal>() {
      public java.lang.Object getImplementation(entity.ReserveLineWrapper bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReserveLineWrapperInternal getInternalInterface(entity.ReserveLineWrapper bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReserveLineWrapper newEmptyInstance() {
        return new entity.ReserveLineWrapper((java.lang.Void)null);
      }
