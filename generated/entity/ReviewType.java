...
/**
 * ReviewType
 * Defines a type of service provider review, used to create Review entities.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReviewType.eti;ReviewType.eix;ReviewType.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReviewType")
public class ReviewType extends com.guidewire.pl.persistence.code.BeanBase implements entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReviewType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReviewType>("entity.ReviewType");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> REVIEWCATEGORYQUESTIONSETS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "ReviewCategoryQuestionSets");
  ...
  private com.guidewire._generated.entity.ReviewTypeInternal _internal;
   ...
   */
  public ReviewType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReviewType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ReviewTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReviewTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public void addToReviewCategoryQuestionSets(entity.ReviewCategoryQuestionSet element) {
    __getInternalInterface().addArrayElement(REVIEWCATEGORYQUESTIONSETS_PROP.get(), element);
  }
  ...
  public entity.ReviewType_Description_L10N[] getDescription_L10N_ARRAY() {
    return (entity.ReviewType_Description_L10N[])__getInternalInterface().getFieldValue(DESCRIPTION_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.ReviewType_Name_L10N[] getName_L10N_ARRAY() {
    return (entity.ReviewType_Name_L10N[])__getInternalInterface().getFieldValue(NAME_L10N_ARRAY_PROP.get());
  }
  ...
  public entity.ReviewCategoryQuestionSet[] getReviewCategoryQuestionSets() {
    return (entity.ReviewCategoryQuestionSet[])__getInternalInterface().getFieldValue(REVIEWCATEGORYQUESTIONSETS_PROP.get());
  }
  ...
  public void removeFromReviewCategoryQuestionSets(entity.ReviewCategoryQuestionSet element) {
    __getInternalInterface().removeArrayElement(REVIEWCATEGORYQUESTIONSETS_PROP.get(), element);
  }
  ...
  public void removeFromReviewCategoryQuestionSets(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(REVIEWCATEGORYQUESTIONSETS_PROP.get(), elementID);
  }
   ...
   */
  private void setDescription_L10N_ARRAY(entity.ReviewType_Description_L10N[] value) {
   ...
   */
  private void setName_L10N_ARRAY(entity.ReviewType_Name_L10N[] value) {
  ...
  public void setReviewCategoryQuestionSets(entity.ReviewCategoryQuestionSet[] value) {
    __getInternalInterface().setFieldValue(REVIEWCATEGORYQUESTIONSETS_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReviewTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReviewType.this.__getDelegateManager();
    }
    ...
    public entity.ReviewType_Description_L10N getDescription_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.ReviewType_Description_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
    ...
    public entity.ReviewType_Name_L10N getName_L10N_ARRAYByLanguage(com.guidewire.commons.entity.type2.IAssociativeArrayPropertyInfo property) {
      return (entity.ReviewType_Name_L10N)__getInternalInterface().getAssociativeArrayValue(property);
    }
  ...
  static {
    ...
    config.put("gw.cc.contact.entity.ReviewType", "com.guidewire.cc.domain.contact.impl.ReviewTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReviewType.class, config);
    com.guidewire._generated.entity.ReviewTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReviewType, com.guidewire._generated.entity.ReviewTypeInternal>() {
      public java.lang.Object getImplementation(entity.ReviewType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReviewTypeInternal getInternalInterface(entity.ReviewType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReviewType newEmptyInstance() {
        return new entity.ReviewType((java.lang.Void)null);
      }
