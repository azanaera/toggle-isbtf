...
@gw.entity.EntityName(value = "DeleteUpdateOp")
public class DeleteUpdateOp extends entity.UpdateOp {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DeleteUpdateOp> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DeleteUpdateOp>("entity.DeleteUpdateOp");
   ...
   */
  public DeleteUpdateOp(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DeleteUpdateOp(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DeleteUpdateOpInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DeleteUpdateOpInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DeleteUpdateOpInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DeleteUpdateOpInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DeleteUpdateOp.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DeleteUpdateOp.class, config);
    com.guidewire._generated.entity.DeleteUpdateOpInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DeleteUpdateOp, com.guidewire._generated.entity.DeleteUpdateOpInternal>() {
      public java.lang.Object getImplementation(entity.DeleteUpdateOp bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DeleteUpdateOpInternal getInternalInterface(entity.DeleteUpdateOp bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DeleteUpdateOp newEmptyInstance() {
        return new entity.DeleteUpdateOp((java.lang.Void)null);
      }
