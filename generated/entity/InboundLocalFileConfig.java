...
/**
 * InboundLocalFileConfig
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "InboundLocalFileConfig.eti;InboundLocalFileConfig.eix;InboundLocalFileConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "InboundLocalFileConfig")
public class InboundLocalFileConfig extends entity.InboundFileConfig implements com.guidewire.inboundfile.config.InboundFileConfigMethods {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.InboundLocalFileConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.InboundLocalFileConfig>("entity.InboundLocalFileConfig");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ARCHIVEDIRECTORY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ArchiveDirectory");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INPUTDIRECTORY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InputDirectory");
   ...
   */
  public InboundLocalFileConfig(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected InboundLocalFileConfig(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.InboundLocalFileConfigInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.InboundLocalFileConfigInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.InboundLocalFileConfigInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.String getArchiveDirectory() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(ARCHIVEDIRECTORY_PROP.get());
  }
  ...
  public java.lang.String getInputDirectory() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(INPUTDIRECTORY_PROP.get());
  }
  ...
  public void setArchiveDirectory(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(ARCHIVEDIRECTORY_PROP.get(), value);
  }
  ...
  public void setInputDirectory(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(INPUTDIRECTORY_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.InboundLocalFileConfigInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.InboundLocalFileConfig.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.inboundfile.config.InboundFileConfigMethods", "com.guidewire.inboundfile.config.InboundFileLocalConfigImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.InboundLocalFileConfig.class, config);
    com.guidewire._generated.entity.InboundLocalFileConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.InboundLocalFileConfig, com.guidewire._generated.entity.InboundLocalFileConfigInternal>() {
      public java.lang.Object getImplementation(entity.InboundLocalFileConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.InboundLocalFileConfigInternal getInternalInterface(entity.InboundLocalFileConfig bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.InboundLocalFileConfig newEmptyInstance() {
        return new entity.InboundLocalFileConfig((java.lang.Void)null);
      }
