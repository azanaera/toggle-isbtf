 ...
 * CloseMatterInfo
 * 
 *             Temporary entity that holds transitional internal state information during the close matter operation.
 *             This is an internal, virtual entity, the system does not store it.
 *             
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CloseMatterInfo.eti;CloseMatterInfo.eix;CloseMatterInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CloseMatterInfo")
public class CloseMatterInfo extends entity.MatterCloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CloseMatterInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CloseMatterInfo>("entity.CloseMatterInfo");
   ...
   */
  public CloseMatterInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CloseMatterInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CloseMatterInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CloseMatterInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CloseMatterInfoInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CloseMatterInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CloseMatterInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.matter.impl.CloseMatterInfoImpl");
    config.put("gw.cc.matter.entity.CloseMatterInfo", "com.guidewire.cc.domain.matter.impl.CloseMatterInfoImpl");
    config.put("gw.cc.matter.entity.MatterCloseReopenInfo", "com.guidewire.cc.domain.matter.impl.CloseMatterInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CloseMatterInfo.class, config);
    com.guidewire._generated.entity.CloseMatterInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CloseMatterInfo, com.guidewire._generated.entity.CloseMatterInfoInternal>() {
      public java.lang.Object getImplementation(entity.CloseMatterInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CloseMatterInfoInternal getInternalInterface(entity.CloseMatterInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CloseMatterInfo newEmptyInstance() {
        return new entity.CloseMatterInfo((java.lang.Void)null);
      }
