...
/**
 * AddressDeleteWorkItem
 * Notes an Address that is potentially orphaned and may be deleted if so. Work items are recorded with the PublicID value of (ClaimCenter) Address entities. This is a system-internal entity.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "AddressDeleteWorkItem.eti;AddressDeleteWorkItem.eix;AddressDeleteWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "AddressDeleteWorkItem")
public class AddressDeleteWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AddressDeleteWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AddressDeleteWorkItem>("entity.AddressDeleteWorkItem");
  ...
  private com.guidewire._generated.entity.AddressDeleteWorkItemInternal _internal;
   ...
   */
  public AddressDeleteWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AddressDeleteWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AddressDeleteWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AddressDeleteWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AddressDeleteWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AddressDeleteWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.domain.workqueue.WorkItemPublicMethods", "com.guidewire.cc.domain.contact.impl.AddressDeleteWorkItemImpl");
    config.put("com.guidewire.pl.domain.workqueue.impl.WorkItemInternalMethods", "com.guidewire.cc.domain.contact.impl.AddressDeleteWorkItemImpl");
    config.put("com.guidewire.pl.persistence.core.BeanMethods", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AddressDeleteWorkItem.class, config);
    com.guidewire._generated.entity.AddressDeleteWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AddressDeleteWorkItem, com.guidewire._generated.entity.AddressDeleteWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.AddressDeleteWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AddressDeleteWorkItemInternal getInternalInterface(entity.AddressDeleteWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AddressDeleteWorkItem newEmptyInstance() {
        return new entity.AddressDeleteWorkItem((java.lang.Void)null);
      }
