...
/**
 * PropertyIncident
 * Report of an incident involving some kind of property - vehicle, building, personal property.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PropertyIncident.eti;PropertyIncident.eix;PropertyIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PropertyIncident")
public class PropertyIncident extends entity.Incident {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PropertyIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PropertyIncident>("entity.PropertyIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ALREADYREPAIRED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AlreadyRepaired");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> APPRAISALFIRSTAPPOINTMENT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "AppraisalFirstAppointment");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> DESCOTHER_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "DescOther");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ESTDAMAGETYPE_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "EstDamageType");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ESTREPAIRCOST_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EstRepairCost");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ESTREPAIRTIME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "EstRepairTime");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> ESTIMATESRECEIVED_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "EstimatesReceived");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> EXTDAMAGETXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ExtDamagetxt");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INSPECTIONREQUIRED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InspectionRequired");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> LODGINGPROVIDERS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "LodgingProviders");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> LOSSOFUSE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "LossofUse");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MEALSDAYS_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MealsDays");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MEALSPEOPLE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MealsPeople");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MEALSRATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MealsRate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PROPERTYDESC_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PropertyDesc");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> TYPEOFPROPERTY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "TypeofProperty");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> WHENTOVIEW_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "WhenToView");
   ...
   */
  public PropertyIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PropertyIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PropertyIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PropertyIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PropertyIncidentInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PropertyIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PropertyIncident.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.PropertyIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.PropertyIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.PropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.IncidentClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.IncidentCoverageSupplier");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.PropertyIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.PropertyIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PropertyIncident.class, config);
    com.guidewire._generated.entity.PropertyIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PropertyIncident, com.guidewire._generated.entity.PropertyIncidentInternal>() {
      public java.lang.Object getImplementation(entity.PropertyIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PropertyIncidentInternal getInternalInterface(entity.PropertyIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PropertyIncident newEmptyInstance() {
        return new entity.PropertyIncident((java.lang.Void)null);
      }
