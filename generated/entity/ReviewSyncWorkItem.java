...
/**
 * ReviewSyncWorkItem
 * Queue of Reviews to be sent to ContactManager, part of Service Provider Management. Work items are recorded as the ID value of (ClaimCenter) Review entities. This is a system-internal entity.
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReviewSyncWorkItem.eti;ReviewSyncWorkItem.eix;ReviewSyncWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReviewSyncWorkItem")
public class ReviewSyncWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReviewSyncWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReviewSyncWorkItem>("entity.ReviewSyncWorkItem");
  ...
  private com.guidewire._generated.entity.ReviewSyncWorkItemInternal _internal;
   ...
   */
  public ReviewSyncWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReviewSyncWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.ReviewSyncWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReviewSyncWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReviewSyncWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReviewSyncWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.contact.entity.ReviewSyncWorkItem", "com.guidewire.cc.domain.contact.impl.ReviewSyncWorkItemImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReviewSyncWorkItem.class, config);
    com.guidewire._generated.entity.ReviewSyncWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReviewSyncWorkItem, com.guidewire._generated.entity.ReviewSyncWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.ReviewSyncWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReviewSyncWorkItemInternal getInternalInterface(entity.ReviewSyncWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReviewSyncWorkItem newEmptyInstance() {
        return new entity.ReviewSyncWorkItem((java.lang.Void)null);
      }
