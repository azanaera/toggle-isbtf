...
/**
 * DaysInitialContactWithClaimantExposureMetric
 * Initial Contact with Claimant
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "DaysInitialContactWithClaimantExposureMetric.eti;DaysInitialContactWithClaimantExposureMetric.eix;DaysInitialContactWithClaimantExposureMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "DaysInitialContactWithClaimantExposureMetric")
public class DaysInitialContactWithClaimantExposureMetric extends entity.TimeBasedExposureMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.DaysInitialContactWithClaimantExposureMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.DaysInitialContactWithClaimantExposureMetric>("entity.DaysInitialContactWithClaimantExposureMetric");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> ACTIVITYSKIPPED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ActivitySkipped");
   ...
   */
  public DaysInitialContactWithClaimantExposureMetric()  {
   ...
   */
  public DaysInitialContactWithClaimantExposureMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected DaysInitialContactWithClaimantExposureMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the ActivitySkipped field.
   * Did the user explicitly skip the initial contact with claimant activity?
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Boolean isActivitySkipped() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(ACTIVITYSKIPPED_PROP.get());
  }
  ...
  public void setActivitySkipped(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(ACTIVITYSKIPPED_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.DaysInitialContactWithClaimantExposureMetric.this.__getDelegateManager();
    }
    ...
    public entity.ExposureMetricLimit getMetricLimitDenorm() {
      return (entity.ExposureMetricLimit)__getInternalInterface().getFieldValue(METRICLIMITDENORM_PROP.get());
    }
    ...
    public typekey.ExposureMetric getSubtype() {
      return (typekey.ExposureMetric)__getInternalInterface().getFieldValue(SUBTYPE_PROP.get());
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.exposure.metric.general.DaysInitialContactWithClaimantExposureMetricMethodsImpl");
    config.put("gw.cc.exposure.metric.entity.ExposureMetric", "com.guidewire.cc.domain.exposure.metric.impl.TimeBasedExposureMetricImpl");
    config.put("gw.cc.exposure.metric.entity.TimeBasedExposureMetric", "com.guidewire.cc.domain.exposure.metric.impl.TimeBasedExposureMetricImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.DaysInitialContactWithClaimantExposureMetric.class, config);
    com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.DaysInitialContactWithClaimantExposureMetric, com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternal>() {
      public java.lang.Object getImplementation(entity.DaysInitialContactWithClaimantExposureMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.DaysInitialContactWithClaimantExposureMetricInternal getInternalInterface(entity.DaysInitialContactWithClaimantExposureMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.DaysInitialContactWithClaimantExposureMetric newEmptyInstance() {
        return new entity.DaysInitialContactWithClaimantExposureMetric((java.lang.Void)null);
      }
