...
/**
 * RuleExportTask
 * The task to export business rules.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "RuleExportTask.eti;RuleExportTask.eix;RuleExportTask.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "RuleExportTask")
public class RuleExportTask extends entity.RuleExportImportTask {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.RuleExportTask> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.RuleExportTask>("entity.RuleExportTask");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> TARGETNAME_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "TargetName");
   ...
   */
  public RuleExportTask(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected RuleExportTask(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.RuleExportTaskInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.RuleExportTaskInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.RuleExportTaskInternal)super.__getInternalInterface();
  }
  
  /**
   * Gets the value of the TargetName field.
   * The target name, e.g. the file name.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getTargetName() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(TARGETNAME_PROP.get());
  }
  
  /**
   * Sets the value of the TargetName field.
   */
  public void setTargetName(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(TARGETNAME_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.RuleExportTaskInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.RuleExportTask.this.__getDelegateManager();
    }
     ...
     * The typekey of the Rule subtype for the export/import task.
     */
    @gw.internal.gosu.parser.ExtendedProperty
    public typekey.Rule getRuleType() {
      return (typekey.Rule)__getInternalInterface().getFieldValue(RULETYPE_PROP.get());
    }
     ...
     */
    public void setRuleType(typekey.Rule value) {
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.RuleExportTask.class, config);
    com.guidewire._generated.entity.RuleExportTaskInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.RuleExportTask, com.guidewire._generated.entity.RuleExportTaskInternal>() {
      public java.lang.Object getImplementation(entity.RuleExportTask bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.RuleExportTaskInternal getInternalInterface(entity.RuleExportTask bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.RuleExportTask newEmptyInstance() {
        return new entity.RuleExportTask((java.lang.Void)null);
      }
