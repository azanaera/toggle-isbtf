 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimCloseReopenInfo.eti;ClaimCloseReopenInfo.eix;ClaimCloseReopenInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimCloseReopenInfo")
public class ClaimCloseReopenInfo extends entity.CloseReopenInfo {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimCloseReopenInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimCloseReopenInfo>("entity.ClaimCloseReopenInfo");
   ...
   */
  public ClaimCloseReopenInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimCloseReopenInfo(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimCloseReopenInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimCloseReopenInfoInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimCloseReopenInfoInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimCloseReopenInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimCloseReopenInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.ClaimCloseReopenInfo", "com.guidewire.cc.domain.claim.impl.ClaimCloseReopenInfoImpl");
    config.put("gw.cc.claim.entity.CloseReopenInfo", "com.guidewire.cc.domain.claim.impl.ClaimCloseReopenInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimCloseReopenInfo.class, config);
    com.guidewire._generated.entity.ClaimCloseReopenInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimCloseReopenInfo, com.guidewire._generated.entity.ClaimCloseReopenInfoInternal>() {
      public java.lang.Object getImplementation(entity.ClaimCloseReopenInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimCloseReopenInfoInternal getInternalInterface(entity.ClaimCloseReopenInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimCloseReopenInfo newEmptyInstance() {
        return new entity.ClaimCloseReopenInfo((java.lang.Void)null);
      }
