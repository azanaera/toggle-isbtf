...
public class User extends com.guidewire.pl.persistence.code.BeanBase implements entity.Validatable, entity.Retireable, entity.Obfuscatable, entity.EventAware, gw.api.obfuscation.Obfuscator {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> USERUIPREFERENCES_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "UserUIPreferences");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> USERUIPREFERENCESARRAY_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "UserUIPreferencesArray");
  ...
  public static final java.lang.String USERADDED_EVENT = "UserAdded";
  
  public static final java.lang.String USERCHANGED_EVENT = "UserChanged";
  
  public static final java.lang.String USERREMOVED_EVENT = "UserRemoved";
  ...
  public entity.UserUIPreferences getUserUIPreferences() {
    return (entity.UserUIPreferences)__getInternalInterface().getFieldValue(USERUIPREFERENCES_PROP.get());
  }
  ...
  public entity.UserUIPreferences[] getUserUIPreferencesArray() {
    return (entity.UserUIPreferences[])__getInternalInterface().getFieldValue(USERUIPREFERENCESARRAY_PROP.get());
  }
   ...
   */
  private void setUserUIPreferences(entity.UserUIPreferences value) {
    __getInternalInterface().setFieldValue(USERUIPREFERENCES_PROP.get(), value);
  }
  
  /**
   * Sets the value of the UserUIPreferencesArray field.
   */
  private void setUserUIPreferencesArray(entity.UserUIPreferences[] value) {
    __getInternalInterface().setFieldValue(USERUIPREFERENCESARRAY_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.UserInternal {
    ...
    public void addToUserUIPreferencesArray(entity.UserUIPreferences element) {
      __getInternalInterface().addArrayElement(USERUIPREFERENCESARRAY_PROP.get(), element);
    }
    ...
    public gw.pl.persistence.core.Key getUserUIPreferencesID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(USERUIPREFERENCES_PROP.get());
    }
    ...
    public void removeFromUserUIPreferencesArray(entity.UserUIPreferences element) {
      __getInternalInterface().removeArrayElement(USERUIPREFERENCESARRAY_PROP.get(), element);
    }
    ...
    public void removeFromUserUIPreferencesArray(gw.pl.persistence.core.Key elementID) {
      __getInternalInterface().removeArrayElement(USERUIPREFERENCESARRAY_PROP.get(), elementID);
    }
    ...
    public void setUserUIPreferencesID(gw.pl.persistence.core.Key value) {
      setFieldValue(USERUIPREFERENCES_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("gw.api.obfuscation.Obfuscator", "gw.personaldata.obfuscation.UserObfuscator");
