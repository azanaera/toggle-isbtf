...
/**
 * PercentExposureMetricLimit
 * Percent based exposure metric limit.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PercentExposureMetricLimit.eti;PercentExposureMetricLimit.eix;PercentExposureMetricLimit.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PercentExposureMetricLimit")
public class PercentExposureMetricLimit extends entity.ExposureMetricLimit implements entity.PercentMetricLimitDelegate, gw.api.metric.MetricLimit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PercentExposureMetricLimit> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PercentExposureMetricLimit>("entity.PercentExposureMetricLimit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTREDVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentRedValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTTARGETVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentTargetValue");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERCENTYELLOWVALUE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PercentYellowValue");
   ...
   */
  public PercentExposureMetricLimit()  {
   ...
   */
  public PercentExposureMetricLimit(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PercentExposureMetricLimit(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PercentExposureMetricLimitInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PercentExposureMetricLimitInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PercentExposureMetricLimitInternal)super.__getInternalInterface();
  }
  ...
  public java.math.BigDecimal getPercentRedValue() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PERCENTREDVALUE_PROP.get());
  }
  ...
  public java.math.BigDecimal getPercentTargetValue() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PERCENTTARGETVALUE_PROP.get());
  }
  ...
  public java.math.BigDecimal getPercentYellowValue() {
    return (java.math.BigDecimal)__getInternalInterface().getFieldValue(PERCENTYELLOWVALUE_PROP.get());
  }
  ...
  public void setPercentRedValue(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PERCENTREDVALUE_PROP.get(), value);
  }
  ...
  public void setPercentTargetValue(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PERCENTTARGETVALUE_PROP.get(), value);
  }
  ...
  public void setPercentYellowValue(java.math.BigDecimal value) {
    __getInternalInterface().setFieldValue(PERCENTYELLOWVALUE_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PercentExposureMetricLimitInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PercentExposureMetricLimit.this.__getDelegateManager();
    }
    ...
    public gw.api.metric.EditableMetricLimitValues createEditableValues() {
      return ((com.guidewire.cc.domain.metric.impl.PercentMetricLimitDelegateInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.metric.impl.PercentMetricLimitDelegateInternal")).createEditableValues();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.exposure.metric.impl.ExposureMetricLimitInternal", "com.guidewire.cc.domain.exposure.metric.impl.PercentExposureMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.CopyOnWriteMetricLimitDelegateInternal", "com.guidewire.cc.domain.exposure.metric.impl.PercentExposureMetricLimitImpl");
    config.put("com.guidewire.cc.domain.metric.impl.PercentMetricLimitDelegateInternal", "com.guidewire.cc.domain.metric.impl.PercentMetricLimitDelegateImpl");
    ...
    config.put("gw.api.metric.MetricLimit", "gw.api.exposure.metric.PercentExposureMetricLimitMethodsImpl");
    config.put("gw.api.metric.MetricLimitMethods", "gw.api.exposure.metric.PercentExposureMetricLimitMethodsImpl");
    config.put("gw.cc.exposure.metric.entity.ExposureMetricLimit", "com.guidewire.cc.domain.exposure.metric.impl.PercentExposureMetricLimitImpl");
    config.put("gw.cc.exposure.metric.entity.PercentExposureMetricLimit", "com.guidewire.cc.domain.exposure.metric.impl.PercentExposureMetricLimitImpl");
    config.put("gw.cc.metric.entity.CopyOnWriteMetricLimitDelegate", "com.guidewire.cc.domain.exposure.metric.impl.PercentExposureMetricLimitImpl");
    config.put("gw.cc.metric.entity.PercentMetricLimitDelegate", "com.guidewire.cc.domain.metric.impl.PercentMetricLimitDelegateImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PercentExposureMetricLimit.class, config);
    com.guidewire._generated.entity.PercentExposureMetricLimitInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PercentExposureMetricLimit, com.guidewire._generated.entity.PercentExposureMetricLimitInternal>() {
      public java.lang.Object getImplementation(entity.PercentExposureMetricLimit bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PercentExposureMetricLimitInternal getInternalInterface(entity.PercentExposureMetricLimit bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PercentExposureMetricLimit newEmptyInstance() {
        return new entity.PercentExposureMetricLimit((java.lang.Void)null);
      }
