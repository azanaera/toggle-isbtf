 ...
 * A monthly recurrence schedule. Subtype of CheckRecurrence.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "MonthlyCheckRecurrence.eti;MonthlyCheckRecurrence.eix;MonthlyCheckRecurrence.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "MonthlyCheckRecurrence")
public class MonthlyCheckRecurrence extends entity.CheckRecurrence {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.MonthlyCheckRecurrence> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.MonthlyCheckRecurrence>("entity.MonthlyCheckRecurrence");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> MONTHLYFREQUENCY_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "MonthlyFrequency");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RECURRENCEDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RecurrenceDate");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> RECURRENCEWEEK_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "RecurrenceWeek");
   ...
   */
  public MonthlyCheckRecurrence(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected MonthlyCheckRecurrence(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.MonthlyCheckRecurrenceInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.MonthlyCheckRecurrenceInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.MonthlyCheckRecurrenceInternal)super.__getInternalInterface();
  }
  ...
  public java.lang.Integer getMonthlyFrequency() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(MONTHLYFREQUENCY_PROP.get());
  }
  ...
  public java.lang.Integer getRecurrenceDate() {
    return (java.lang.Integer)__getInternalInterface().getFieldValue(RECURRENCEDATE_PROP.get());
  }
  ...
  public typekey.RecurrenceWeek getRecurrenceWeek() {
    return (typekey.RecurrenceWeek)__getInternalInterface().getFieldValue(RECURRENCEWEEK_PROP.get());
  }
  ...
  public void setMonthlyFrequency(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(MONTHLYFREQUENCY_PROP.get(), value);
  }
  ...
  public void setRecurrenceDate(java.lang.Integer value) {
    __getInternalInterface().setFieldValue(RECURRENCEDATE_PROP.get(), value);
  }
  ...
  public void setRecurrenceWeek(typekey.RecurrenceWeek value) {
    __getInternalInterface().setFieldValue(RECURRENCEWEEK_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.MonthlyCheckRecurrenceInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.MonthlyCheckRecurrence.this.__getDelegateManager();
    }
    ...
    public java.util.Calendar adjustSubsequentDateForMonthlyByDateRecurrence(java.util.Calendar c) {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).adjustSubsequentDateForMonthlyByDateRecurrence(c);
    }
    
    public java.util.Calendar adjustSubsequentDateForMonthlyByEveryLastDayOfMonthRecurrence(java.util.Calendar c) {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).adjustSubsequentDateForMonthlyByEveryLastDayOfMonthRecurrence(c);
    }
    
    public java.util.Calendar adjustSubsequentDateForMonthlyByNumberedDayOfMonthRecurrence(java.util.Calendar c) {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).adjustSubsequentDateForMonthlyByNumberedDayOfMonthRecurrence(c);
    }
    
    public java.util.Calendar adjustSubsequentDateForMonthlyBySpecifiedDayOfWeekRecurrence(java.util.Calendar c) {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).adjustSubsequentDateForMonthlyBySpecifiedDayOfWeekRecurrence(c);
    }
    ...
    public java.util.Date calculateFirstDateForMonthlyByDateRecurrence() {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).calculateFirstDateForMonthlyByDateRecurrence();
    }
    
    public java.util.Date calculateFirstDateForMonthlyByEveryLastDayOfMonthRecurrence() {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).calculateFirstDateForMonthlyByEveryLastDayOfMonthRecurrence();
    }
    
    public java.util.Date calculateFirstDateForMonthlyBySpecifiedDayOfWeekRecurrence() {
      return ((com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal")).calculateFirstDateForMonthlyBySpecifiedDayOfWeekRecurrence();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.check.impl.CheckRecurrenceInternal", "com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceImpl");
    config.put("com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceInternal", "com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceImpl");
    ...
    config.put("gw.cc.financials.check.entity.CheckRecurrence", "com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceImpl");
    config.put("gw.cc.financials.check.entity.MonthlyCheckRecurrence", "com.guidewire.cc.domain.financials.check.impl.MonthlyCheckRecurrenceImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.MonthlyCheckRecurrence.class, config);
    com.guidewire._generated.entity.MonthlyCheckRecurrenceInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.MonthlyCheckRecurrence, com.guidewire._generated.entity.MonthlyCheckRecurrenceInternal>() {
      public java.lang.Object getImplementation(entity.MonthlyCheckRecurrence bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.MonthlyCheckRecurrenceInternal getInternalInterface(entity.MonthlyCheckRecurrence bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.MonthlyCheckRecurrence newEmptyInstance() {
        return new entity.MonthlyCheckRecurrence((java.lang.Void)null);
      }
