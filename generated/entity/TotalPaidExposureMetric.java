...
/**
 * TotalPaidExposureMetric
 * Paid
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "TotalPaidExposureMetric.eti;TotalPaidExposureMetric.eix;TotalPaidExposureMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "TotalPaidExposureMetric")
public class TotalPaidExposureMetric extends entity.MoneyExposureMetric {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.TotalPaidExposureMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.TotalPaidExposureMetric>("entity.TotalPaidExposureMetric");
   ...
   */
  public TotalPaidExposureMetric()  {
   ...
   */
  public TotalPaidExposureMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected TotalPaidExposureMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.TotalPaidExposureMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.TotalPaidExposureMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.TotalPaidExposureMetricInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.TotalPaidExposureMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.TotalPaidExposureMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.exposure.metric.financials.TotalPaidExposureMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.TotalPaidExposureMetric.class, config);
    com.guidewire._generated.entity.TotalPaidExposureMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.TotalPaidExposureMetric, com.guidewire._generated.entity.TotalPaidExposureMetricInternal>() {
      public java.lang.Object getImplementation(entity.TotalPaidExposureMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.TotalPaidExposureMetricInternal getInternalInterface(entity.TotalPaidExposureMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.TotalPaidExposureMetric newEmptyInstance() {
        return new entity.TotalPaidExposureMetric((java.lang.Void)null);
      }
