 ...
 * ExpressionFragment to express a CONTAINS operation, which detects whether or not a list contains a element matching a nested condition
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ContainsExpressionFragment.eti;ContainsExpressionFragment.eix;ContainsExpressionFragment.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ContainsExpressionFragment")
public class ContainsExpressionFragment extends entity.ConditionExpressionFragment {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ContainsExpressionFragment> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ContainsExpressionFragment>("entity.ContainsExpressionFragment");
   ...
   */
  public ContainsExpressionFragment()  {
   ...
   */
  public ContainsExpressionFragment(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ContainsExpressionFragment(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ContainsExpressionFragmentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ContainsExpressionFragmentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ContainsExpressionFragmentInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ContainsExpressionFragmentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ContainsExpressionFragment.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("com.guidewire.bizrules.codegenerator.GosuTextBuilder", "com.guidewire.bizrules.codegenerator.ContainsExpressionFragmentGosuTextBuilder");
    ...
    config.put("com.guidewire.bizrules.domain.ExpressionFragmentDomainMethods", "com.guidewire.bizrules.domain.ConditionExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RuleSymbolRenamable", "com.guidewire.bizrules.domain.ConditionExpressionFragmentImpl");
    config.put("com.guidewire.bizrules.domain.RulesCascadingRemovable", "com.guidewire.bizrules.domain.ConditionExpressionFragmentImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ContainsExpressionFragment.class, config);
    com.guidewire._generated.entity.ContainsExpressionFragmentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ContainsExpressionFragment, com.guidewire._generated.entity.ContainsExpressionFragmentInternal>() {
      public java.lang.Object getImplementation(entity.ContainsExpressionFragment bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ContainsExpressionFragmentInternal getInternalInterface(entity.ContainsExpressionFragment bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ContainsExpressionFragment newEmptyInstance() {
        return new entity.ContainsExpressionFragment((java.lang.Void)null);
      }
