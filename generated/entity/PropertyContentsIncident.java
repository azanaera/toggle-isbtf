 ...
 * Report of an incident involving property contents. For example contents of a home, outbuilding etc
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "PropertyContentsIncident.eti;PropertyContentsIncident.eix;PropertyContentsIncident.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "PropertyContentsIncident")
public class PropertyContentsIncident extends entity.MobilePropertyIncident implements gw.cc.exposure.entity.ClaimantSupplier, gw.cc.exposure.entity.CoverageSupplier {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.PropertyContentsIncident> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.PropertyContentsIncident>("entity.PropertyContentsIncident");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IArrayPropertyInfo> PROPERTYCONTENTSSCHEDULEDITEMS_PROP = new com.guidewire.commons.metadata.types.ArrayPropertyInfoCache(TYPE, "PropertyContentsScheduledItems");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> PROPERTYLOCATION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "PropertyLocation");
   ...
   */
  public PropertyContentsIncident()  {
   ...
   */
  public PropertyContentsIncident(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected PropertyContentsIncident(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.PropertyContentsIncidentInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.PropertyContentsIncidentInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.PropertyContentsIncidentInternal)super.__getInternalInterface();
  }
  ...
  public void addToPropertyContentsScheduledItems(entity.PropertyContentsScheduledItem element) {
    __getInternalInterface().addArrayElement(PROPERTYCONTENTSSCHEDULEDITEMS_PROP.get(), element);
  }
  
  /**
   * Creates a new PropertyContentsScheduledItem and adds it to the PropertyContentsScheduledItems array,
   * setting its order property so that it will appear at the end of OrderedPropertyContentsScheduledItems
   * @param item the property item corresponding to this scheduled item, must not be null
   * @return the newly created scheduled item
   */
  public entity.PropertyContentsScheduledItem createOrderedPropertyContentsScheduledItem(entity.PropertyItem item) {
    return ((gw.cc.exposure.entity.PropertyContentsIncident)__getDelegateManager().getImplementation("gw.cc.exposure.entity.PropertyContentsIncident")).createOrderedPropertyContentsScheduledItem(item);
  }
  
  /**
   * Returns the property contents scheduled items for this incident, ordered by their ItemOrder field
   * @return ordered array of scheduled items
   */
  public entity.PropertyContentsScheduledItem[] getOrderedPropertyContentsScheduledItems() {
    return ((gw.cc.exposure.entity.PropertyContentsIncident)__getDelegateManager().getImplementation("gw.cc.exposure.entity.PropertyContentsIncident")).getOrderedPropertyContentsScheduledItems();
  }
  ...
  public entity.PropertyContentsScheduledItem[] getPropertyContentsScheduledItems() {
    return (entity.PropertyContentsScheduledItem[])__getInternalInterface().getFieldValue(PROPERTYCONTENTSSCHEDULEDITEMS_PROP.get());
  }
  ...
  public entity.PolicyLocation getPropertyLocation() {
    return (entity.PolicyLocation)__getInternalInterface().getFieldValue(PROPERTYLOCATION_PROP.get());
  }
  ...
  public void removeFromPropertyContentsScheduledItems(entity.PropertyContentsScheduledItem element) {
    __getInternalInterface().removeArrayElement(PROPERTYCONTENTSSCHEDULEDITEMS_PROP.get(), element);
  }
  ...
  public void removeFromPropertyContentsScheduledItems(gw.pl.persistence.core.Key elementID) {
    __getInternalInterface().removeArrayElement(PROPERTYCONTENTSSCHEDULEDITEMS_PROP.get(), elementID);
  }
  ...
  public void setPropertyContentsScheduledItems(entity.PropertyContentsScheduledItem[] value) {
    __getInternalInterface().setFieldValue(PROPERTYCONTENTSSCHEDULEDITEMS_PROP.get(), value);
  }
  ...
  public void setPropertyLocation(entity.PolicyLocation value) {
    __getInternalInterface().setFieldValue(PROPERTYLOCATION_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.PropertyContentsIncidentInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.PropertyContentsIncident.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getPropertyLocationID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(PROPERTYLOCATION_PROP.get());
    }
    ...
    public void setPropertyLocationID(gw.pl.persistence.core.Key value) {
      setFieldValue(PROPERTYLOCATION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.claim.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    config.put("com.guidewire.cc.domain.contact.EntityContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    ...
    config.put("gw.api.contact.ClaimContactRoleOwner", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    config.put("gw.cc.exposure.entity.ClaimantSupplier", "gw.api.exposure.claimant.InsuredClaimantSupplier");
    config.put("gw.cc.exposure.entity.CoverageSupplier", "gw.api.exposure.incident.PropertyContentsIncidentCoverageSupplier");
    config.put("gw.cc.exposure.entity.Incident", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    config.put("gw.cc.exposure.entity.MobilePropertyIncident", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyContentsIncident", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    config.put("gw.cc.exposure.entity.PropertyIncident", "com.guidewire.cc.domain.exposure.impl.PropertyContentsIncidentImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.PropertyContentsIncident.class, config);
    com.guidewire._generated.entity.PropertyContentsIncidentInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.PropertyContentsIncident, com.guidewire._generated.entity.PropertyContentsIncidentInternal>() {
      public java.lang.Object getImplementation(entity.PropertyContentsIncident bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.PropertyContentsIncidentInternal getInternalInterface(entity.PropertyContentsIncident bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.PropertyContentsIncident newEmptyInstance() {
        return new entity.PropertyContentsIncident((java.lang.Void)null);
      }
