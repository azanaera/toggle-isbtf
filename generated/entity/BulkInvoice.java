 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BulkInvoice.eti;BulkInvoice.eix;BulkInvoice.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BulkInvoice")
public class BulkInvoice extends com.guidewire.pl.persistence.code.BeanBase implements entity.Approvable, entity.EFTDataDelegate, entity.Retireable, entity.EventAware {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ITypekeyPropertyInfo> FAILEDOPERATION_PROP = new com.guidewire.commons.metadata.types.TypekeyPropertyInfoCache(TYPE, "FailedOperation");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> VOIDSTOPUSER_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "VoidStopUser");
  ...
  public static final java.lang.String BULKINVOICEADDED_EVENT = "BulkInvoiceAdded";
  
  public static final java.lang.String BULKINVOICECHANGED_EVENT = "BulkInvoiceChanged";
  
  public static final java.lang.String BULKINVOICEREMOVED_EVENT = "BulkInvoiceRemoved";
  
  public static final java.lang.String BULKINVOICESTATUSCHANGED_EVENT = "BulkInvoiceStatusChanged";
   ...
   * </ul>
   * @deprecated This method is synchronous and may perform poorly for large invoices; use deleteAsynchronously instead()
   */
  public void delete() {
  ...
  /**
   * Deletes the invoice.
   * This operation is asynchronous; when this method is called, the invoice's status will be set to Initiating Delete.
   * The InvoiceWorkQueue and InvoiceItemWorkQueue will process this invoice (delete its items) and eventually set its status to Retired.
   */
  public void deleteAsynchronously() {
    ((gw.cc.financials.bulkpay.entity.BulkInvoice)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoice")).deleteAsynchronously();
  }
  ...
  /**
   * Gets the value of the FailedOperation field.
   * The operation that was being performed when the failure occurred.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public typekey.BulkInvoiceStatus getFailedOperation() {
    return (typekey.BulkInvoiceStatus)__getInternalInterface().getFieldValue(FAILEDOPERATION_PROP.get());
  }
  ...
  /**
   * Gets the value of the VoidStopUser field.
   * User that requested void or stop of bulk invoice
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public entity.User getVoidStopUser() {
    return (entity.User)__getInternalInterface().getFieldValue(VOIDSTOPUSER_PROP.get());
  }
   ...
   * @return <code>true</code> if the BulkInvoice is currently in one of the states for work queue processing, else
  ...
  /**
   * If the BulkInvoice is AwaitingSubmission with a scheduled send date of today, escalates the BulkInvoice.
   * This operation is asynchronous; when this method is called, the invoice's status will be set to Initiating Escalation.
   * The InvoiceWorkQueue and InvoiceItemWorkQueue will process this invoice (escalate its items' checks) and eventually set its status to Requesting.
   */
  public void requestAsynchronously() {
    ((gw.cc.financials.bulkpay.entity.BulkInvoice)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoice")).requestAsynchronously();
  }
   ...
   * also be requested.
   * @deprecated This method is synchronous and may perform poorly for large invoices; use requestAsynchronously() instead
   */
  ...
  /**
   * Retries the recently failed operation.
   * @throws IllegalStateException if this invoice is not in ERRORDURINGPROCESSING status
   */
  public void retryProcessing() {
    ((gw.cc.financials.bulkpay.entity.BulkInvoice)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoice")).retryProcessing();
  }
  ...
  /**
   * Sets the value of the FailedOperation field.
   */
  private void setFailedOperation(typekey.BulkInvoiceStatus value) {
    __getInternalInterface().setFieldValue(FAILEDOPERATION_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the VoidStopUser field.
   */
  public void setVoidStopUser(entity.User value) {
    __getInternalInterface().setFieldValue(VOIDSTOPUSER_PROP.get(), value);
  }
  
  /**
   * Stops the invoice.
   * This operation is asynchronous; when this method is called, the invoice's status will be set to Initiating Stop.
   * The InvoiceWorkQueue and InvoiceItemWorkQueue will process this invoice (stop its items) and eventually set its status to Pending Stop.
   */
  public void stopAsynchronously() {
    ((gw.cc.financials.bulkpay.entity.BulkInvoice)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoice")).stopAsynchronously();
  }
   ...
   * @deprecated This method is synchronous and may perform poorly for large invoices; use stopAsynchronously() instead
   */
  ...
  /**
   * Voids the invoice.
   * This operation is asynchronous; when this method is called, the invoice's status will be set to Initiating Void.
   * The InvoiceWorkQueue and InvoiceItemWorkQueue will process this invoice (void its items) and eventually set its status to Pending Void.
   */
  public void voidAsynchronously() {
    ((gw.cc.financials.bulkpay.entity.BulkInvoice)__getDelegateManager().getImplementation("gw.cc.financials.bulkpay.entity.BulkInvoice")).voidAsynchronously();
  }
  
  /**
   * Marks the invoice and all associated approved InvoiceItems as PendingVoid, along with all associated checks.
   * @throws IllegalStateException If invoice does not have a valid status for voiding the invoice
   * @deprecated This method is synchronous and may perform poorly for large invoices; use voidAsynchronously instead()
   */
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BulkInvoiceInternal {
    ...
    public gw.pl.persistence.core.Key getVoidStopUserID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(VOIDSTOPUSER_PROP.get());
    }
     ...
     * Sets the value of the FailedOperation field.
     */
    public void setFailedOperation(typekey.BulkInvoiceStatus value) {
      __getInternalInterface().setFieldValue(FAILEDOPERATION_PROP.get(), value);
    }
    ...
    public void setVoidStopUserID(gw.pl.persistence.core.Key value) {
      setFieldValue(VOIDSTOPUSER_PROP.get(), value);
    }
    ...
    public void updateStatusForWorkflow() {
      ((com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.bulkpay.impl.BulkInvoiceInternal")).updateStatusForWorkflow();
    }
