...
/**
 * WorkStatus
 * Denotes changes in the employee's work capacity.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "WorkStatus.eti;WorkStatus.eix;WorkStatus.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "WorkStatus")
public class WorkStatus extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.Retireable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.WorkStatus> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.WorkStatus>("entity.WorkStatus");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PAIDFULLFORLASTWORKED_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PaidFullForLastWorked");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> STATUSENDDATE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "StatusEndDate");
  ...
  private com.guidewire._generated.entity.WorkStatusInternal _internal;
   ...
   */
  public WorkStatus(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected WorkStatus(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.WorkStatusInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.WorkStatusInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  public typekey.WorkCapacity getStatus() {
    return (typekey.WorkCapacity)__getInternalInterface().getFieldValue(STATUS_PROP.get());
  }
  ...
  public java.util.Date getStatusEndDate() {
    return (java.util.Date)__getInternalInterface().getFieldValue(STATUSENDDATE_PROP.get());
  }
  ...
  public java.lang.Boolean isPaidFullForLastWorked() {
    return (java.lang.Boolean)__getInternalInterface().getFieldValue(PAIDFULLFORLASTWORKED_PROP.get());
  }
  ...
  public void setPaidFullForLastWorked(java.lang.Boolean value) {
    __getInternalInterface().setFieldValue(PAIDFULLFORLASTWORKED_PROP.get(), value);
  }
  ...
  public void setStatusEndDate(java.util.Date value) {
    __getInternalInterface().setFieldValue(STATUSENDDATE_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.WorkStatusInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.WorkStatus.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.exposure.entity.WorkStatus", "com.guidewire.cc.domain.exposure.impl.WorkStatusImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.WorkStatus.class, config);
    com.guidewire._generated.entity.WorkStatusInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.WorkStatus, com.guidewire._generated.entity.WorkStatusInternal>() {
      public java.lang.Object getImplementation(entity.WorkStatus bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.WorkStatusInternal getInternalInterface(entity.WorkStatus bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.WorkStatus newEmptyInstance() {
        return new entity.WorkStatus((java.lang.Void)null);
      }
