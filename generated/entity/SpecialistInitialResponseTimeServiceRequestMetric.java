 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SpecialistInitialResponseTimeServiceRequestMetric.eti;SpecialistInitialResponseTimeServiceRequestMetric.eix;SpecialistInitialResponseTimeServiceRequestMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "SpecialistInitialResponseTimeServiceRequestMetric")
public class SpecialistInitialResponseTimeServiceRequestMetric extends entity.TimeBasedServiceRequestMetric implements entity.ServiceRequestMetricEscalationDelegate {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.SpecialistInitialResponseTimeServiceRequestMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.SpecialistInitialResponseTimeServiceRequestMetric>("entity.SpecialistInitialResponseTimeServiceRequestMetric");
   ...
   */
  public SpecialistInitialResponseTimeServiceRequestMetric()  {
   ...
   */
  public SpecialistInitialResponseTimeServiceRequestMetric(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected SpecialistInitialResponseTimeServiceRequestMetric(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.SpecialistInitialResponseTimeServiceRequestMetric.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.metric.MetricMethods", "gw.vendormanagement.metric.SpecialistInitialResponseTimeServiceRequestMetricMethodsImpl");
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.SpecialistInitialResponseTimeServiceRequestMetric.class, config);
    com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.SpecialistInitialResponseTimeServiceRequestMetric, com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternal>() {
      public java.lang.Object getImplementation(entity.SpecialistInitialResponseTimeServiceRequestMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.SpecialistInitialResponseTimeServiceRequestMetricInternal getInternalInterface(entity.SpecialistInitialResponseTimeServiceRequestMetric bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.SpecialistInitialResponseTimeServiceRequestMetric newEmptyInstance() {
        return new entity.SpecialistInitialResponseTimeServiceRequestMetric((java.lang.Void)null);
      }
