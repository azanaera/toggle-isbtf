...
/**
 * BizRulesValidatorWorkItem
 * Queue of biz rules validation to run. This is a system-internal entity.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BizRulesValidatorWorkItem.eti;BizRulesValidatorWorkItem.eix;BizRulesValidatorWorkItem.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "BizRulesValidatorWorkItem")
public class BizRulesValidatorWorkItem extends com.guidewire.pl.persistence.code.BeanBase implements entity.WorkItem, entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BizRulesValidatorWorkItem> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BizRulesValidatorWorkItem>("entity.BizRulesValidatorWorkItem");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> RULEID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "RuleID");
  ...
  private com.guidewire._generated.entity.BizRulesValidatorWorkItemInternal _internal;
   ...
   */
  public BizRulesValidatorWorkItem()  {
   ...
   */
  public BizRulesValidatorWorkItem(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected BizRulesValidatorWorkItem(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.BizRulesValidatorWorkItemInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.BizRulesValidatorWorkItemInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   * A reference to the Rule entity to be validated
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.Long getRuleID() {
    return (java.lang.Long)__getInternalInterface().getFieldValue(RULEID_PROP.get());
  }
  ...
  public void setRuleID(java.lang.Long value) {
    __getInternalInterface().setFieldValue(RULEID_PROP.get(), value);
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.BizRulesValidatorWorkItemInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.BizRulesValidatorWorkItem.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.BizRulesValidatorWorkItem.class, config);
    com.guidewire._generated.entity.BizRulesValidatorWorkItemInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.BizRulesValidatorWorkItem, com.guidewire._generated.entity.BizRulesValidatorWorkItemInternal>() {
      public java.lang.Object getImplementation(entity.BizRulesValidatorWorkItem bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BizRulesValidatorWorkItemInternal getInternalInterface(entity.BizRulesValidatorWorkItem bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.BizRulesValidatorWorkItem newEmptyInstance() {
        return new entity.BizRulesValidatorWorkItem((java.lang.Void)null);
      }
