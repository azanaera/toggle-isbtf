...
/**
 * ClaimMetric
 * Metrics related to a claim
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimMetric.eti;ClaimMetric.eix;ClaimMetric.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
public abstract class ClaimMetric extends com.guidewire.pl.persistence.code.BeanBase implements entity.Extractable, entity.MetricLimitTimeDelegate, entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimMetric> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimMetric>("entity.ClaimMetric");
  ...
  private com.guidewire._generated.entity.ClaimMetricInternal _internal;
  
  protected ClaimMetric(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.ClaimMetricInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.ClaimMetricInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.ClaimMetric value) {
  ...
  static {
    com.guidewire._generated.entity.ClaimMetricInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.ClaimMetric, com.guidewire._generated.entity.ClaimMetricInternal>() {
      public java.lang.Object getImplementation(entity.ClaimMetric bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimMetricInternal getInternalInterface(entity.ClaimMetric bean) {
        if(bean == null) {
          return null;
        };
