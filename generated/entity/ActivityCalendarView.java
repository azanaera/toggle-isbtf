 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ActivityCalendarView.eti;ActivityCalendarView.eix;ActivityCalendarView.etx")
...
public class ActivityCalendarView extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMDESCRIPTION_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimDescription");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> INSUREDDENORMID_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "InsuredDenormID");
  ...
  /**
   * Gets the value of the ClaimDescription field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getClaimDescription() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(CLAIMDESCRIPTION_PROP.get());
  }
  ...
  /**
   * Gets the value of the InsuredDenormID field.
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public gw.pl.persistence.core.Key getInsuredDenormID() {
    return (gw.pl.persistence.core.Key)__getInternalInterface().getFieldValue(INSUREDDENORMID_PROP.get());
  }
  ...
  /**
   * Sets the value of the ClaimDescription field.
   */
  public void setClaimDescription(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(CLAIMDESCRIPTION_PROP.get(), value);
  }
  ...
  /**
   * Sets the value of the InsuredDenormID field.
   */
  public void setInsuredDenormID(gw.pl.persistence.core.Key value) {
    __getInternalInterface().setFieldValue(INSUREDDENORMID_PROP.get(), value);
  }
