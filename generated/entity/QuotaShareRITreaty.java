...
/**
 * QuotaShareRITreaty
 * Quota share proportional reinsurance treaty agreement.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "QuotaShareRITreaty.eti;QuotaShareRITreaty.eix;QuotaShareRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "QuotaShareRITreaty")
public class QuotaShareRITreaty extends entity.ProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.QuotaShareRITreaty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.QuotaShareRITreaty>("entity.QuotaShareRITreaty");
   ...
   */
  public QuotaShareRITreaty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected QuotaShareRITreaty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.QuotaShareRITreatyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.QuotaShareRITreatyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.QuotaShareRITreatyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.QuotaShareRITreatyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.QuotaShareRITreaty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.ProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.QuotaShareRITreaty", "com.guidewire.cc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.QuotaShareRITreatyImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.QuotaShareRITreaty.class, config);
    com.guidewire._generated.entity.QuotaShareRITreatyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.QuotaShareRITreaty, com.guidewire._generated.entity.QuotaShareRITreatyInternal>() {
      public java.lang.Object getImplementation(entity.QuotaShareRITreaty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.QuotaShareRITreatyInternal getInternalInterface(entity.QuotaShareRITreaty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.QuotaShareRITreaty newEmptyInstance() {
        return new entity.QuotaShareRITreaty((java.lang.Void)null);
      }
