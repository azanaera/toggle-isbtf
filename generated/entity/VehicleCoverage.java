 ...
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "VehicleCoverage.eti;VehicleCoverage.eix;VehicleCoverage.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "VehicleCoverage")
public class VehicleCoverage extends entity.RUCoverage {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.VehicleCoverage> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.VehicleCoverage>("entity.VehicleCoverage");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> CLAIMAGGLIMIT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ClaimAggLimit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> NONMEDAGGLIMIT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "NonmedAggLimit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> PERSONAGGLIMIT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "PersonAggLimit");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> REPLACEAGGLIMIT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ReplaceAggLimit");
   ...
   */
  public VehicleCoverage(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected VehicleCoverage(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.VehicleCoverageInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.VehicleCoverageInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.VehicleCoverageInternal)super.__getInternalInterface();
  }
  ...
  public gw.api.financials.CurrencyAmount getClaimAggLimit() {
    return (gw.api.financials.CurrencyAmount)__getInternalInterface().getFieldValue(CLAIMAGGLIMIT_PROP.get());
  }
  ...
  public gw.api.financials.CurrencyAmount getNonmedAggLimit() {
    return (gw.api.financials.CurrencyAmount)__getInternalInterface().getFieldValue(NONMEDAGGLIMIT_PROP.get());
  }
  ...
  public gw.api.financials.CurrencyAmount getPersonAggLimit() {
    return (gw.api.financials.CurrencyAmount)__getInternalInterface().getFieldValue(PERSONAGGLIMIT_PROP.get());
  }
  ...
  public gw.api.financials.CurrencyAmount getReplaceAggLimit() {
    return (gw.api.financials.CurrencyAmount)__getInternalInterface().getFieldValue(REPLACEAGGLIMIT_PROP.get());
  }
  ...
  public void setClaimAggLimit(gw.api.financials.CurrencyAmount value) {
    __getInternalInterface().setFieldValue(CLAIMAGGLIMIT_PROP.get(), value);
  }
  ...
  public void setNonmedAggLimit(gw.api.financials.CurrencyAmount value) {
    __getInternalInterface().setFieldValue(NONMEDAGGLIMIT_PROP.get(), value);
  }
  ...
  public void setPersonAggLimit(gw.api.financials.CurrencyAmount value) {
    __getInternalInterface().setFieldValue(PERSONAGGLIMIT_PROP.get(), value);
  }
  ...
  public void setReplaceAggLimit(gw.api.financials.CurrencyAmount value) {
    __getInternalInterface().setFieldValue(REPLACEAGGLIMIT_PROP.get(), value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.VehicleCoverageInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.VehicleCoverage.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.api.financials.CoverageDeductibleMethods", "gw.api.financials.CoverageDeductibleMethodsImpl");
    config.put("gw.api.policy.CoverageMethods", "gw.api.policy.CoverageMethodsImpl");
    config.put("gw.cc.policy.entity.Coverage", "com.guidewire.cc.domain.policy.impl.VehicleCoverageImpl");
    config.put("gw.cc.policy.entity.RUCoverage", "com.guidewire.cc.domain.policy.impl.VehicleCoverageImpl");
    config.put("gw.cc.policy.entity.VehicleCoverage", "com.guidewire.cc.domain.policy.impl.VehicleCoverageImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.VehicleCoverage.class, config);
    com.guidewire._generated.entity.VehicleCoverageInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.VehicleCoverage, com.guidewire._generated.entity.VehicleCoverageInternal>() {
      public java.lang.Object getImplementation(entity.VehicleCoverage bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.VehicleCoverageInternal getInternalInterface(entity.VehicleCoverage bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.VehicleCoverage newEmptyInstance() {
        return new entity.VehicleCoverage((java.lang.Void)null);
      }
