...
/**
 * SurplusRITreaty
 * Surplus proportional reinsurance agreement.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "SurplusRITreaty.eti;SurplusRITreaty.eix;SurplusRITreaty.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "SurplusRITreaty")
public class SurplusRITreaty extends entity.ProportionalRIAgreement {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.SurplusRITreaty> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.SurplusRITreaty>("entity.SurplusRITreaty");
   ...
   */
  public SurplusRITreaty(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected SurplusRITreaty(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.SurplusRITreatyInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.SurplusRITreatyInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.SurplusRITreatyInternal)super.__getInternalInterface();
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.SurplusRITreatyInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.SurplusRITreaty.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.reinsurance.entity.ProportionalRIAgreement", "com.guidewire.cc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.RIAgreement", "com.guidewire.cc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("gw.cc.reinsurance.entity.SurplusRITreaty", "com.guidewire.cc.domain.reinsurance.impl.SurplusRITreatyImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.SurplusRITreaty.class, config);
    com.guidewire._generated.entity.SurplusRITreatyInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.SurplusRITreaty, com.guidewire._generated.entity.SurplusRITreatyInternal>() {
      public java.lang.Object getImplementation(entity.SurplusRITreaty bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.SurplusRITreatyInternal getInternalInterface(entity.SurplusRITreaty bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.SurplusRITreaty newEmptyInstance() {
        return new entity.SurplusRITreaty((java.lang.Void)null);
      }
