...
/**
 * ReserveSet
 * Subtype of TransactionSet that contains one or more reserve transactions submitted together for approval.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ReserveSet.eti;ReserveSet.eix;ReserveSet.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ReserveSet")
public class ReserveSet extends entity.TransactionSet {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ReserveSet> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ReserveSet>("entity.ReserveSet");
   ...
   */
  public ReserveSet(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ReserveSet(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ReserveSetInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ReserveSetInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ReserveSetInternal)super.__getInternalInterface();
  }
  ...
  public entity.Reserve[] getReserves() {
    return (entity.Reserve[])__getInternalInterface().getFieldValue(RESERVES_PROP.get());
  }
  
  /**
   * Creates a new Reserve with a status of draft, adds it to this ReserveSet and returns it. The ReserveLine of this
   * new Reserve is specified by the provided Exposure, CostType and CostCategory. A NULL Exposure indicates that this
   * is a claim-level Reserve. Also, the new Reserve will have its Transaction & Reserving Currencies set to the same
   * as Claim Currency.
   * 
   * If this ClaimCenter installation is using MultiCurrency Reserving, then you should be calling
   * {@link #newReserve(entity.Exposure, typekey.CostType, typekey.CostCategory, typekey.Currency)}
   * instead. The former recommendation (using this method to create a new Reserve and then explicitly setting a
   * different ReservingCurrency on it) is still valid, but no longer recommended.
   * @param exposure The Exposure of this new Reserve - can be NULL, in which case this will be a
   *                 claim-level Transaction
   * @param costType The CostType of this new Reserve - cannot be NULL.
   * @param costCategory The CostCategory of this new Reserve - cannot be NULL.
   * @return the new Reserve.
   */
  public entity.Reserve newReserve(entity.Exposure exposure, typekey.CostType costType, typekey.CostCategory costCategory) {
    return ((gw.cc.financials.reserve.entity.ReserveSet)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.ReserveSet")).newReserve(exposure, costType, costCategory);
  }
  
  /**
   * Creates a new Reserve with a status of draft, adds it to this ReserveSet and returns it. The ReserveLine of this
   * new Reserve is specified by the provided Exposure, CostType, CostCategory and ReservingCurrency. A NULL Exposure
   * indicates that this is a claim-level Reserve. Also, the Transaction Currency of the new Reserve will be set to the
   * same as Reserving Currency (or Claim Currency, if Reserving Currency is null).
   * @param exposure The Exposure of this new Reserve - can be NULL, in which case this will be a
   *                 claim-level Transaction
   * @param costType The CostType of this new Reserve - cannot be NULL.
   * @param costCategory The CostCategory of this new Reserve - cannot be NULL.
   * @param reservingCurrency The Reserving Currency of this new Reserve - can be NULL (defaults to Claim Currency).
   * @return the new Reserve.
   */
  public entity.Reserve newReserve(entity.Exposure exposure, typekey.CostType costType, typekey.CostCategory costCategory, typekey.Currency reservingCurrency) {
    return ((gw.cc.financials.reserve.entity.ReserveSet)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.ReserveSet")).newReserve(exposure, costType, costCategory, reservingCurrency);
  }
  
  /**
   * Saves the ReserveSet and submits it for approval after calling the
   * pre-setup rules on it.  If any of the line items
   * of the reserves in the ReserveSet have amount equal to zero, then those
   * line items will be removed and will not be saved.  Also ensures that each Reserve
   * in the ReserveSet has an associated ReserveLine.  If no matching ReserveLine
   * already exists then a new one is created.
   */
  public gw.plugin.approval.ApprovalResult prepareForCommit() {
    return ((gw.cc.financials.reserve.entity.ReserveSet)__getDelegateManager().getImplementation("gw.cc.financials.reserve.entity.ReserveSet")).prepareForCommit();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ReserveSetInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ReserveSet.this.__getDelegateManager();
    }
    ...
    public boolean containsMatchingReserve(entity.Reserve reserveToMatch) {
      return ((com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal")).containsMatchingReserve(reserveToMatch);
    }
    ...
    public gw.plugin.approval.ApprovalResult prepareForSave(boolean runPreSetupRules) throws com.guidewire.cc.system.exception.ClosedClaimException, com.guidewire.cc.system.exception.ClosedExposureException, com.guidewire.pl.system.exception.InsufficientAuthorityException, com.guidewire.pl.system.exception.InsufficientPermissionException, com.guidewire.cc.system.exception.MultipleLineItemsNotAllowedException, com.guidewire.cc.system.exception.NegativeCalculationException {
      return ((com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal")).prepareForSave(runPreSetupRules);
    }
    ...
    public void verifyEditable() throws com.guidewire.cc.system.exception.ClosedExposureException {
      ((com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal")).verifyEditable();
    }
    ...
    public void verifyOpenReserveNotNegative() throws com.guidewire.cc.system.exception.NegativeCalculationException {
      ((com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal)__getDelegateManager().getImplementation("com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal")).verifyOpenReserveNotNegative();
    }
  ...
  static {
    ...
    config.put("com.guidewire.cc.domain.financials.impl.TransactionSetInternal", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("com.guidewire.cc.domain.financials.reserve.impl.ReserveSetInternal", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("com.guidewire.commons.entity.Keyable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.commons.entity.Sourceable", "com.guidewire.pl.system.entity.proxy.AbstractVersionableBeanProxy");
    config.put("com.guidewire.pl.domain.approval.impl.ApprovableInternalMethods", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    ...
    config.put("com.guidewire.pl.domain.validation.ValidatablePublicMethods", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("com.guidewire.pl.domain.validation.impl.ValidatableInternalMethods", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("com.guidewire.pl.persistence.core.BeanMethods", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("com.guidewire.pl.system.bundle.InsertCallback", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("gw.cc.financials.entity.TransactionSet", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("gw.cc.financials.reserve.entity.ReserveSet", "com.guidewire.cc.domain.financials.reserve.impl.ReserveSetImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ReserveSet.class, config);
    com.guidewire._generated.entity.ReserveSetInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ReserveSet, com.guidewire._generated.entity.ReserveSetInternal>() {
      public java.lang.Object getImplementation(entity.ReserveSet bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ReserveSetInternal getInternalInterface(entity.ReserveSet bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ReserveSet newEmptyInstance() {
        return new entity.ReserveSet((java.lang.Void)null);
      }
