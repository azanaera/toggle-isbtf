...
/**
 * LocationInfo
 * location denormed fields
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "LocationInfo.eti;LocationInfo.eix;LocationInfo.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "LocationInfo")
public class LocationInfo extends com.guidewire.pl.persistence.code.BeanBase implements entity.GlobalAddress, entity.Editable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.LocationInfo> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.LocationInfo>("entity.LocationInfo");
  ...
  private com.guidewire._generated.entity.LocationInfoInternal _internal;
   ...
   */
  public LocationInfo(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected LocationInfo(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.LocationInfoInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.LocationInfoInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.LocationInfoInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.LocationInfo.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.archiving.entity.LocationInfo", "com.guidewire.cc.domain.claim.archiving.impl.LocationInfoImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.LocationInfo.class, config);
    com.guidewire._generated.entity.LocationInfoInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.LocationInfo, com.guidewire._generated.entity.LocationInfoInternal>() {
      public java.lang.Object getImplementation(entity.LocationInfo bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.LocationInfoInternal getInternalInterface(entity.LocationInfo bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.LocationInfo newEmptyInstance() {
        return new entity.LocationInfo((java.lang.Void)null);
      }
