...
/**
 * VehicleRU
 * RiskUnit containing a vehicle.
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "VehicleRU.eti;VehicleRU.eix;VehicleRU.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "VehicleRU")
public class VehicleRU extends entity.RiskUnit {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.VehicleRU> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.VehicleRU>("entity.VehicleRU");
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.ILinkPropertyInfo> VEHICLELOCATION_PROP = new com.guidewire.commons.metadata.types.LinkPropertyInfoCache(TYPE, "VehicleLocation");
   ...
   */
  public VehicleRU(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected VehicleRU(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.VehicleRUInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.VehicleRUInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.VehicleRUInternal)super.__getInternalInterface();
  }
  ...
  public entity.PolicyLocation getVehicleLocation() {
    return (entity.PolicyLocation)__getInternalInterface().getFieldValue(VEHICLELOCATION_PROP.get());
  }
  ...
  public void setVehicleLocation(entity.PolicyLocation value) {
    ((gw.cc.policy.entity.VehicleRU)__getDelegateManager().getImplementation("gw.cc.policy.entity.VehicleRU")).setVehicleLocation(value);
  }
  
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.VehicleRUInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.VehicleRU.this.__getDelegateManager();
    }
    ...
    public gw.pl.persistence.core.Key getVehicleLocationID() {
      return (gw.pl.persistence.core.Key)getRawFieldValue(VEHICLELOCATION_PROP.get());
    }
    ...
    public void setVehicleLocationID(gw.pl.persistence.core.Key value) {
      setFieldValue(VEHICLELOCATION_PROP.get(), value);
    }
  ...
  static {
    ...
    config.put("com.guidewire.pl.system.bundle.RemoveCallback", "com.guidewire.cc.domain.policy.impl.VehicleRUImpl");
    config.put("com.guidewire.pl.system.bundle.UpdateCallback", "com.guidewire.cc.domain.policy.impl.RiskUnitImpl");
    config.put("gw.cc.policy.entity.RiskUnit", "com.guidewire.cc.domain.policy.impl.VehicleRUImpl");
    config.put("gw.cc.policy.entity.VehicleRU", "com.guidewire.cc.domain.policy.impl.VehicleRUImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.VehicleRU.class, config);
    com.guidewire._generated.entity.VehicleRUInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.VehicleRU, com.guidewire._generated.entity.VehicleRUInternal>() {
      public java.lang.Object getImplementation(entity.VehicleRU bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.VehicleRUInternal getInternalInterface(entity.VehicleRU bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.VehicleRU newEmptyInstance() {
        return new entity.VehicleRU((java.lang.Void)null);
      }
