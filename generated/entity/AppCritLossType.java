...
/**
 * AppCritLossType
 * Loss Type Applicability Criteria 
 */
...
@gw.entity.EntityName(value = "AppCritLossType")
public class AppCritLossType extends com.guidewire.pl.persistence.code.BeanBase implements entity.RuleVersionDependent, entity.Versionable {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.AppCritLossType> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.AppCritLossType>("entity.AppCritLossType");
  ...
  private com.guidewire._generated.entity.AppCritLossTypeInternal _internal;
   ...
   */
  public AppCritLossType(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected AppCritLossType(java.lang.Void ignored)  {
    
  }
  
  protected com.guidewire._generated.entity.AppCritLossTypeInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.AppCritLossTypeInternal __getInternalInterface() {
    if(_internal == null) {
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.AppCritLossTypeInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.AppCritLossType.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.bizrules.domain.RuleVersionDependent", "com.guidewire.cc.domain.bizrules.AppCritLossTypeImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.AppCritLossType.class, config);
    com.guidewire._generated.entity.AppCritLossTypeInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.AppCritLossType, com.guidewire._generated.entity.AppCritLossTypeInternal>() {
      public java.lang.Object getImplementation(entity.AppCritLossType bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.AppCritLossTypeInternal getInternalInterface(entity.AppCritLossType bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.AppCritLossType newEmptyInstance() {
        return new entity.AppCritLossType((java.lang.Void)null);
      }
