 ...
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "CompanyVendor.eti;CompanyVendor.eix;CompanyVendor.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "CompanyVendor")
public class CompanyVendor extends entity.Company {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.CompanyVendor> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.CompanyVendor>("entity.CompanyVendor");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> SHOPLOCATIONCODE_EXT_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "ShopLocationCode_Ext");
   ...
   */
  public CompanyVendor(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected CompanyVendor(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.CompanyVendorInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.CompanyVendorInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.CompanyVendorInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.CompanyVendorInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.CompanyVendor.this.__getDelegateManager();
    }
  ...
  static {
    ...
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.CompanyVendor.class, config);
    com.guidewire._generated.entity.CompanyVendorInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.CompanyVendor, com.guidewire._generated.entity.CompanyVendorInternal>() {
      public java.lang.Object getImplementation(entity.CompanyVendor bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.CompanyVendorInternal getInternalInterface(entity.CompanyVendor bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.CompanyVendor newEmptyInstance() {
        return new entity.CompanyVendor((java.lang.Void)null);
      }
