 ...
 * ClusterMemberData
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClusterMemberData.eti;ClusterMemberData.eix;ClusterMemberData.etx")
...
public class ClusterMemberData extends com.guidewire.pl.persistence.code.BeanBase implements entity.KeyableBean {
  ...
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> COMPATIBILITYWITHSOURCE_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "CompatibilityWithSource");
  ...
  /**
   * Gets the value of the CompatibilityWithSource field.
   * Compatibility of configuration with current configuration, or during a rolling upgrade, with the source configuration
   */
  @gw.internal.gosu.parser.ExtendedProperty
  public java.lang.String getCompatibilityWithSource() {
    return (java.lang.String)__getInternalInterface().getFieldValueForCodegen(COMPATIBILITYWITHSOURCE_PROP.get());
  }
  ...
  /**
   * Sets the value of the CompatibilityWithSource field.
   */
  public void setCompatibilityWithSource(java.lang.String value) {
    __getInternalInterface().setFieldValueForCodegen(COMPATIBILITYWITHSOURCE_PROP.get(), value);
  }
