 ...
 * ClaimAssignmentView
 * 
 *         Supports the efficient creation of claim lists in ClaimCenter's views when the assignment related fields are
 *         displayed. The system uses this entity to list claims in the vacation, search, and team view in an optimum
 *         manner. This is a virtual entity and is not stored in the database.
 *       
 *     
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "ClaimAssignmentView.eti;ClaimAssignmentView.eix;ClaimAssignmentView.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
@gw.entity.EntityName(value = "ClaimAssignmentView")
public class ClaimAssignmentView extends entity.ClaimAbstractView implements entity.KeyableBean {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.ClaimAssignmentView> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.ClaimAssignmentView>("entity.ClaimAssignmentView");
   ...
   */
  public ClaimAssignmentView(gw.pl.persistence.core.BundleProvider bundleProvider)  {
    this((java.lang.Void)null);
    com.guidewire.pl.system.entity.proxy.BeanProxy.initNewBeanInstance(this, bundleProvider.getBundle(), java.util.Arrays.asList());
  }
  
  protected ClaimAssignmentView(java.lang.Void ignored)  {
    super(ignored);
  }
  
  protected com.guidewire._generated.entity.ClaimAssignmentViewInternal __createInternalInterface() {
  ...
  protected com.guidewire._generated.entity.ClaimAssignmentViewInternal __getInternalInterface() {
    return (com.guidewire._generated.entity.ClaimAssignmentViewInternal)super.__getInternalInterface();
  }
  ...
  private class _Internal extends com.guidewire.pl.persistence.code.BeanInternalBase implements com.guidewire._generated.entity.ClaimAssignmentViewInternal {
    protected com.guidewire.pl.persistence.code.DelegateLoader __getDelegateManager() {
      return entity.ClaimAssignmentView.this.__getDelegateManager();
    }
  ...
  static {
    ...
    config.put("gw.cc.claim.entity.ClaimAbstractView", "com.guidewire.cc.domain.claim.impl.ClaimAssignmentViewImpl");
    config.put("gw.cc.claim.entity.ClaimAssignmentView", "com.guidewire.cc.domain.claim.impl.ClaimAssignmentViewImpl");
    config.put("gw.pl.persistence.core.Bean", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("gw.pl.persistence.core.BundleProvider", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    config.put("java.lang.Comparable", "com.guidewire.pl.system.entity.proxy.BeanProxy");
    DELEGATE_MAP  =  com.guidewire.pl.persistence.code.DelegateMap.newInstance(entity.ClaimAssignmentView.class, config);
    com.guidewire._generated.entity.ClaimAssignmentViewInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.InstantiableEntityFriendAccess<entity.ClaimAssignmentView, com.guidewire._generated.entity.ClaimAssignmentViewInternal>() {
      public java.lang.Object getImplementation(entity.ClaimAssignmentView bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.ClaimAssignmentViewInternal getInternalInterface(entity.ClaimAssignmentView bean) {
        if(bean == null) {
          return null;
        };
      ...
      public entity.ClaimAssignmentView newEmptyInstance() {
        return new entity.ClaimAssignmentView((java.lang.Void)null);
      }
