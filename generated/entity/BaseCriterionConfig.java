 ...
 * BaseCriterionConfig
 */
@javax.annotation.processing.Generated(value = "com.guidewire.pl.metadata.codegen.Codegen", comments = "BaseCriterionConfig.eti;BaseCriterionConfig.eix;BaseCriterionConfig.etx")
@java.lang.SuppressWarnings(value = {"deprecation", "unchecked"})
@gw.internal.gosu.parser.ExtendedType
@gw.lang.SimplePropertyProcessing
public abstract class BaseCriterionConfig extends com.guidewire.pl.persistence.code.BeanBase implements entity.Editable, com.guidewire.cc.system.dynaction.config.CriterionOperatorRestriction {
  public static final gw.pl.persistence.type.EntityTypeReference<entity.BaseCriterionConfig> TYPE = new com.guidewire.commons.metadata.types.EntityIntrinsicTypeReference<entity.BaseCriterionConfig>("entity.BaseCriterionConfig");
  
  public static final gw.pl.persistence.type.EntityPropertyInfoReference<gw.entity.IColumnPropertyInfo> BEANPATH_PROP = new com.guidewire.commons.metadata.types.ColumnPropertyInfoCache(TYPE, "BeanPath");
  ...
  private com.guidewire._generated.entity.BaseCriterionConfigInternal _internal;
  
  protected BaseCriterionConfig(java.lang.Void ignored)  {
    
  }
  
  protected abstract com.guidewire._generated.entity.BaseCriterionConfigInternal __createInternalInterface();
  ...
  protected com.guidewire._generated.entity.BaseCriterionConfigInternal __getInternalInterface() {
    if(_internal == null) {
   ...
   */
  private void setSubtype(typekey.BaseCriterionConfig value) {
  ...
  static {
    com.guidewire._generated.entity.BaseCriterionConfigInternalAccess.FRIEND_ACCESSOR.init(new com.guidewire.pl.persistence.code.EntityFriendAccess<entity.BaseCriterionConfig, com.guidewire._generated.entity.BaseCriterionConfigInternal>() {
      public java.lang.Object getImplementation(entity.BaseCriterionConfig bean, java.lang.String interfaceName) {
        return bean.__getDelegateManager().getImplementation(interfaceName);
      }
      
      public com.guidewire._generated.entity.BaseCriterionConfigInternal getInternalInterface(entity.BaseCriterionConfig bean) {
        if(bean == null) {
          return null;
        };
