...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/transactions/TransactionsLV.recoveryreserve.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TransactionsLV_recoveryreserveExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TransactionsLVExpressionsImpl {
    ...
    // 'action' attribute on Link (id=TransactionAmountViewDetail) at TransactionsLV.recoveryreserve.pcf: line 44, column 106
    function action_18 () : void {
      TransactionViewDetailForward.drilldown(Claim, TransactionView)
    }
    
    // 'action' attribute on TextCell (id=Exposure_Cell) at TransactionsLV.recoveryreserve.pcf: line 52, column 42
    ...
    // 'outputConversion' attribute on TextCell (id=Exposure_Cell) at TransactionsLV.recoveryreserve.pcf: line 52, column 42
    ...
    // 'value' attribute on DateCell (id=CreateDate_Cell) at TransactionsLV.recoveryreserve.pcf: line 30, column 47
    ...
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at TransactionsLV.recoveryreserve.pcf: line 37, column 61
    function value_15 () : gw.api.financials.CurrencyAmountPair {
      return TransactionView.CurrencyAmount
    }
    
    // 'value' attribute on TextCell (id=Exposure_Cell) at TransactionsLV.recoveryreserve.pcf: line 52, column 42
    function value_23 () : java.lang.Integer {
      return TransactionView.ExposureName
    }
    
    // 'value' attribute on TypeKeyCell (id=CoverageType_Cell) at TransactionsLV.recoveryreserve.pcf: line 57, column 45
    function value_26 () : typekey.CoverageType {
      return TransactionView.CoverageType
    }
    
    // 'value' attribute on TypeKeyCell (id=CostType_Cell) at TransactionsLV.recoveryreserve.pcf: line 62, column 41
    function value_29 () : typekey.CostType {
      return TransactionView.CostType
    }
    
    // 'value' attribute on TypeKeyCell (id=CostCategory_Cell) at TransactionsLV.recoveryreserve.pcf: line 67, column 45
    function value_32 () : typekey.CostCategory {
      return TransactionView.CostCategory
    }
    
    // 'value' attribute on TypeKeyCell (id=RecoveryCategory_Cell) at TransactionsLV.recoveryreserve.pcf: line 72, column 49
    function value_35 () : typekey.RecoveryCategory {
      return TransactionView.RecoveryCategory
    }
    
    // 'value' attribute on TypeKeyCell (id=ReservingCurrency_Cell) at TransactionsLV.recoveryreserve.pcf: line 78, column 74
    function value_38 () : typekey.Currency {
      return TransactionView.ReservingCurrency
    }
    
    // 'value' attribute on TypeKeyCell (id=Status_Cell) at TransactionsLV.recoveryreserve.pcf: line 83, column 50
    function value_42 () : typekey.TransactionStatus {
      return TransactionView.Status
    }
    
    // 'value' attribute on TextCell (id=User_Cell) at TransactionsLV.recoveryreserve.pcf: line 87, column 41
    function value_45 () : java.lang.String {
      return TransactionView.User
    }
    
    // 'visible' attribute on TypeKeyCell (id=ReservingCurrency_Cell) at TransactionsLV.recoveryreserve.pcf: line 78, column 74
  ...
  public static class TransactionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on CurrencyCell (id=Amount_Cell) at TransactionsLV.recoveryreserve.pcf: line 37, column 61
    ...
    // 'value' attribute on TypeKeyCell (id=ReservingCurrency_Cell) at TransactionsLV.recoveryreserve.pcf: line 78, column 74
    function sortValue_8 (TransactionView :  RecoveryReserveView) : java.lang.Object {
      return TransactionView.ReservingCurrency
    }
