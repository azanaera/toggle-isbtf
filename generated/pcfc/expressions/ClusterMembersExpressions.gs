...
class ClusterMembersExpressions {
  ...
  public static class ClusterMembersExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=ClusterReconnect_Input) at ClusterMembers.pcf: line 87, column 95
    ...
    // 'available' attribute on ButtonInput (id=ClusterReconnect_Input) at ClusterMembers.pcf: line 87, column 95
    ...
    // 'value' attribute on TextInput (id=ServerId_Input) at ClusterMembers.pcf: line 61, column 52
    function value_12 () : java.lang.String {
      return ClusterMembersData.ServerId
    }
    
    // 'value' attribute on TextInput (id=Uuid_Input) at ClusterMembers.pcf: line 65, column 48
    function value_15 () : java.lang.String {
      return ClusterMembersData.Uuid
    }
    
    // 'value' attribute on TextInput (id=ServerRoles_Input) at ClusterMembers.pcf: line 69, column 63
  ...
  public static class IteratorEntry2ExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Type_Cell) at ClusterMembers.pcf: line 219, column 59
    function valueRoot_87 () : java.lang.Object {
      return Component.Type
    }
    
    // 'value' attribute on DateCell (id=StartTime_Cell) at ClusterMembers.pcf: line 229, column 50
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at ClusterMembers.pcf: line 223, column 65
    ...
    // 'value' attribute on TextCell (id=FailoverState_Cell) at ClusterMembers.pcf: line 233, column 74
    function value_94 () : java.lang.String {
      return Component.State.getDisplayName(Component)
    }
    
    // 'value' attribute on DateCell (id=RetryFailover_Cell) at ClusterMembers.pcf: line 239, column 56
  ...
  public static class IteratorEntry3ExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Host_Cell) at ClusterMembers.pcf: line 264, column 48
    ...
    // 'value' attribute on TextCell (id=Uuid_Cell) at ClusterMembers.pcf: line 269, column 41
    function value_104 () : java.lang.String {
      return Run.Uuid
    }
    
    // 'value' attribute on TextCell (id=Env_Cell) at ClusterMembers.pcf: line 274, column 40
    function value_107 () : java.lang.String {
      return Run.Env
    }
    
    // 'value' attribute on TextCell (id=RunLevel_Cell) at ClusterMembers.pcf: line 279, column 45
    function value_110 () : java.lang.String {
      return Run.RunLevel
    }
    
    // 'value' attribute on TextCell (id=ServerRoles_Cell) at ClusterMembers.pcf: line 285, column 36
    function value_113 () : java.lang.String {
      return ClusterMembersData.serverRolesToString(Run.ServerRoles)
    }
    
    // 'value' attribute on DateCell (id=ServerStarted_Cell) at ClusterMembers.pcf: line 293, column 50
    function value_115 () : java.util.Date {
      return Run.ServerStarted
    }
    
    // 'value' attribute on DateCell (id=LastUpdate_Cell) at ClusterMembers.pcf: line 300, column 54
  ...
  public static class IteratorEntryExpressionsImpl extends ListDetailPanelExpressionsImpl {
    ...
    // 'actionAvailable' attribute on TextCell (id=UserSessions_Cell) at ClusterMembers.pcf: line 125, column 50
    function actionAvailable_46 () : java.lang.Boolean {
      return Server.InCluster
    }
    
    // 'actionAvailable' attribute on TextCell (id=PlannedShutdown_Cell) at ClusterMembers.pcf: line 163, column 32
    function actionAvailable_63 () : java.lang.Boolean {
      return Server.InCluster and Server.Member.PlannedShutdownInitiated != null
    }
    
    // 'action' attribute on TextCell (id=UserSessions_Cell) at ClusterMembers.pcf: line 125, column 50
    function action_44 () : void {
      ClusterMemberUserSessionsPopup.push(Server.ServerId)
    }
    
    // 'action' attribute on TextCell (id=PlannedShutdown_Cell) at ClusterMembers.pcf: line 163, column 32
    function action_61 () : void {
      PlannedShutdownStatusPopup.push(Server.ServerId)
    }
    
    // 'action' attribute on Link (id=NodeFailed) at ClusterMembers.pcf: line 173, column 76
    function action_69 () : void {
      ClusterMembersData.nodeFailed(Server.ServerId)
    }
    
    // 'action' attribute on Link (id=StartPlannedShutdown) at ClusterMembers.pcf: line 180, column 100
    function action_73 () : void {
      PlannedShutdownPopup.push(Server.ServerId)
    }
    
    // 'action' attribute on Link (id=StopPlannedShutdown) at ClusterMembers.pcf: line 188, column 100
    ...
    // 'available' attribute on Link (id=NodeFailed) at ClusterMembers.pcf: line 173, column 76
    ...
    // 'available' attribute on Link (id=StartPlannedShutdown) at ClusterMembers.pcf: line 180, column 100
    ...
    // 'available' attribute on Link (id=StopPlannedShutdown) at ClusterMembers.pcf: line 188, column 100
    function available_75 () : java.lang.Boolean {
      return Server.InCluster and Server.Member.PlannedShutdownInitiated != null and (perm.User.EditCluster or perm.User.DevAllAccess)
    }
    
    // 'confirmMessage' attribute on Link (id=NodeFailed) at ClusterMembers.pcf: line 173, column 76
    ...
    // 'confirmMessage' attribute on Link (id=StopPlannedShutdown) at ClusterMembers.pcf: line 188, column 100
    ...
    // 'value' attribute on TextCell (id=ServerId_Cell) at ClusterMembers.pcf: line 110, column 44
    ...
    // 'value' attribute on TextCell (id=Status_Cell) at ClusterMembers.pcf: line 114, column 51
    function value_38 () : java.lang.String {
      return Server.StatusLocalized
    }
    
    // 'value' attribute on TextCell (id=Host_Cell) at ClusterMembers.pcf: line 118, column 47
    function value_41 () : java.lang.String {
      return Server.LogicalName
    }
    
    // 'value' attribute on TextCell (id=UserSessions_Cell) at ClusterMembers.pcf: line 125, column 50
    function value_47 () : java.lang.Integer {
      return Server.InCluster ? Server.Member.UserSessions : null
    }
    
    // 'value' attribute on TextCell (id=RunLevel_Cell) at ClusterMembers.pcf: line 129, column 79
    function value_49 () : java.lang.String {
      return not Server.Stopped ? Server.Member.RunLevel : null
    }
    
    // 'value' attribute on TextCell (id=Build_Cell) at ClusterMembers.pcf: line 133, column 76
    function value_51 () : java.lang.String {
      return not Server.Stopped ? Server.Member.Build : null
    }
    
    // 'value' attribute on TextCell (id=ServerRoles_Cell) at ClusterMembers.pcf: line 138, column 32
    function value_53 () : java.lang.String {
      return not Server.Stopped ? Server.ServerRolesAsString : null
    }
    
    // 'value' attribute on DateCell (id=ServerStarted_Cell) at ClusterMembers.pcf: line 144, column 84
    function value_55 () : java.util.Date {
      return not Server.Stopped ? Server.Member.ServerStarted : null
    }
    
    // 'value' attribute on DateCell (id=ConnectionStarted_Cell) at ClusterMembers.pcf: line 150, column 88
    function value_57 () : java.util.Date {
      return not Server.Stopped ? Server.Member.ConnectionStarted : null
    }
    
    // 'value' attribute on DateCell (id=LastUpdate_Cell) at ClusterMembers.pcf: line 156, column 87
    function value_59 () : java.util.Date {
      return not Server.Stopped ? Server.Member.LastUpdateAsDate : null
    }
    
    // 'value' attribute on TextCell (id=PlannedShutdown_Cell) at ClusterMembers.pcf: line 163, column 32
    function value_64 () : java.lang.String {
      return Server.PlannedShutdownStatusLocalized
    }
    
    // 'visible' attribute on Link (id=NodeFailed) at ClusterMembers.pcf: line 173, column 76
    function visible_68 () : java.lang.Boolean {
      return not Server.InCluster and not Server.Stopped
    }
    
    // 'visible' attribute on Link (id=StartPlannedShutdown) at ClusterMembers.pcf: line 180, column 100
  ...
  public static class ListDetailPanelExpressionsImpl extends ClusterMembersExpressionsImpl {
    ...
    // 'filters' attribute on ToolbarFilterOptionGroup at ClusterMembers.pcf: line 213, column 98
    function filters_80 () : gw.api.filters.IFilter[] {
    ...
    // 'value' attribute on RowIterator at ClusterMembers.pcf: line 258, column 96
    ...
    // 'value' attribute on RowIterator at ClusterMembers.pcf: line 208, column 89
