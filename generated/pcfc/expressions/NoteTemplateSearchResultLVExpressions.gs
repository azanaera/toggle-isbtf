...
@javax.annotation.processing.Generated("config/web/pcf/claim/newnote/NoteTemplateSearchResultLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NoteTemplateSearchResultLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends NoteTemplateSearchResultLVExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=Template_Cell) at NoteTemplateSearchResultLV.pcf: line 21, column 51
    function valueRoot_7 () : java.lang.Object {
      return NoteTemplateSearchResults
    }
    
    // 'value' attribute on TypeKeyCell (id=Type_Cell) at NoteTemplateSearchResultLV.pcf: line 31, column 41
    function value_12 () : typekey.NoteType {
      return NoteTemplateSearchResults.Type
    }
    
    // 'value' attribute on TypeKeyCell (id=Language_Cell) at NoteTemplateSearchResultLV.pcf: line 37, column 69
    function value_15 () : typekey.LanguageType {
      return NoteTemplateSearchResults.Language
    }
    
    // 'value' attribute on TextCell (id=LossType_Cell) at NoteTemplateSearchResultLV.pcf: line 42, column 56
    ...
    // 'value' attribute on TypeKeyCell (id=Topic_Cell) at NoteTemplateSearchResultLV.pcf: line 26, column 46
    function value_9 () : typekey.NoteTopicType {
      return NoteTemplateSearchResults.Topic
    }
    
    // 'visible' attribute on TypeKeyCell (id=Language_Cell) at NoteTemplateSearchResultLV.pcf: line 37, column 69
  ...
  public static class NoteTemplateSearchResultLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on TextCell (id=LossType_Cell) at NoteTemplateSearchResultLV.pcf: line 42, column 56
