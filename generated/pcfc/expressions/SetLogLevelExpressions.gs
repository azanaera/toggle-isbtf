...
class SetLogLevelExpressions {
  ...
  public static class SetLogLevelExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=SetLevel_Input) at SetLogLevel.pcf: line 73, column 114
    ...
    // 'value' attribute on RangeInput (id=NewLevel_Input) at SetLogLevel.pcf: line 65, column 50
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      PickedLoggerLevel = (__VALUE_TO_SET as gw.logging.LogLevel)
    }
    
    // 'value' attribute on RangeInput (id=Logger_Input) at SetLogLevel.pcf: line 37, column 44
    ...
    // 'optionLabel' attribute on RangeInput (id=NewLevel_Input) at SetLogLevel.pcf: line 65, column 50
    function optionLabel_21 (VALUE :  gw.logging.LogLevel) : java.lang.String {
      return VALUE.Name
    }
    
    // 'outputConversion' attribute on TextInput (id=CurConfigLevel_Input) at SetLogLevel.pcf: line 47, column 51
    function outputConversion_9 (VALUE :  gw.logging.LogLevel) : java.lang.String {
    ...
    // 'valueRange' attribute on RangeInput (id=NewLevel_Input) at SetLogLevel.pcf: line 65, column 50
    function valueRange_22 () : java.lang.Object {
      return gw.logging.LogLevel.values()
    }
    
    // 'valueRange' attribute on RangeInput (id=Logger_Input) at SetLogLevel.pcf: line 37, column 44
    function valueRange_4 () : java.lang.Object {
      return Data.LoggerNames.toList()
    }
    
    // 'value' attribute on TextInput (id=CurConfigLevel_Input) at SetLogLevel.pcf: line 47, column 51
    function value_10 () : gw.logging.LogLevel {
      return Data.getLoggerLevel(PickedLoggerName)
    }
    
    // 'value' attribute on TextInput (id=CurActualLevel_Input) at SetLogLevel.pcf: line 54, column 51
    function value_15 () : gw.logging.LogLevel {
    ...
    // 'valueRange' attribute on RangeInput (id=NewLevel_Input) at SetLogLevel.pcf: line 65, column 50
    function verifyValueRangeIsAllowedType_23 ($$arg :  gw.logging.LogLevel[]) : void {
    ...
    // 'visible' attribute on ButtonInput (id=SetLevel_Input) at SetLogLevel.pcf: line 73, column 114
    function visible_27 () : java.lang.Boolean {
      return PickedLoggerName != null and Data.getLoggerLevel(PickedLoggerName) != PickedLoggerLevel
    }
    
    // 'visible' attribute on TextInput (id=CurConfigLevel_Input) at SetLogLevel.pcf: line 47, column 51
