...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/CloneCheckWizard.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CloneCheckWizardExpressions {
  ...
  public static class CloneCheckWizardExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function beforeCommit_17 (pickedValue :  java.lang.Object) : void {
      gw.api.system.bundle.BundleCommitCondition.verify(claim); wizard.ensureNoCheckPayeesAreRetired(); wizard.performBeforeFinish()
    }
    ...
    function onExit_1 () : void {
      wizard.validateAllCheckPayees(); wizard.createNewCheckPortionsIfNecessary();  ext.config.check.CheckScreensHelper_Ext.CheckAddressLinesLength(wizard.Check) ;wizard.refreshBundle()
    }
