...
@javax.annotation.processing.Generated("config/web/pcf/claim/newdocument/NewTemplateDocumentDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewTemplateDocumentDVExpressions {
  ...
  public static class NewTemplateDocumentDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'pickLocation' attribute on DocumentTemplateInput (id=TemplatePicker_Input) at NewTemplateDocumentDV.pcf: line 51, column 69
    ...
    // 'def' attribute on InputSetRef at NewTemplateDocumentDV.pcf: line 85, column 45
    function def_onEnter_33 (def :  pcf.DocumentTemplateContextObjectIteratorInputSet_noticeofofferofmodoraltworkdwcad1013353pdf) : void {
      def.onEnter(documentCCContext,documentCreationInfo)
    }
    
    // 'def' attribute on InputSetRef at NewTemplateDocumentDV.pcf: line 88, column 45
    function def_onEnter_36 (def :  pcf.DocumentCreationInputSet) : void {
    ...
    // 'def' attribute on InputSetRef at NewTemplateDocumentDV.pcf: line 85, column 45
    function def_refreshVariables_34 (def :  pcf.DocumentTemplateContextObjectIteratorInputSet_noticeofofferofmodoraltworkdwcad1013353pdf) : void {
      def.refreshVariables(documentCCContext,documentCreationInfo)
    }
    
    // 'def' attribute on InputSetRef at NewTemplateDocumentDV.pcf: line 88, column 45
    function def_refreshVariables_37 (def :  pcf.DocumentCreationInputSet) : void {
      def.refreshVariables(documentCCContext,documentCreationInfo,Step3Label)
    }
    
    // 'value' attribute on TypeKeyInput (id=Language_Input) at NewTemplateDocumentDV.pcf: line 58, column 125
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      languageType = (__VALUE_TO_SET as typekey.LanguageType)
    }
    
    // 'value' attribute on RangeInput (id=RelatedTo_Input) at NewTemplateDocumentDV.pcf: line 77, column 51
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      document.RelatedTo = (__VALUE_TO_SET as gw.pl.persistence.core.Bean)
    }
    
    // 'value' attribute on DocumentTemplateInput (id=TemplatePicker_Input) at NewTemplateDocumentDV.pcf: line 51, column 69
    ...
    // 'editable' attribute on DocumentTemplateInput (id=TemplatePicker_Input) at NewTemplateDocumentDV.pcf: line 51, column 69
    ...
    // 'onChange' attribute on PostOnChange at NewTemplateDocumentDV.pcf: line 80, column 150
    ...
    // 'onPick' attribute on DocumentTemplateInput (id=TemplatePicker_Input) at NewTemplateDocumentDV.pcf: line 51, column 69
    ...
    // 'optionGroupLabel' attribute on RangeInput (id=RelatedTo_Input) at NewTemplateDocumentDV.pcf: line 77, column 51
    ...
    // 'optionLabel' attribute on RangeInput (id=RelatedTo_Input) at NewTemplateDocumentDV.pcf: line 77, column 51
    ...
    // 'valueRange' attribute on RangeInput (id=RelatedTo_Input) at NewTemplateDocumentDV.pcf: line 77, column 51
    ...
    // 'visible' attribute on TypeKeyInput (id=Language_Input) at NewTemplateDocumentDV.pcf: line 58, column 125
