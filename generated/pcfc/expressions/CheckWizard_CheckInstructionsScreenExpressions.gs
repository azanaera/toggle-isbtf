...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/CheckWizard_CheckInstructionsScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CheckWizard_CheckInstructionsScreenExpressions {
  ...
  public static class CheckWizard_CheckInstructionsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at CheckWizard_CheckInstructionsScreen.pcf: line 63, column 116
    ...
    // 'iconColor' attribute on Link (id=InvoiceWithNoQuoteAlert) at CheckWizard_CheckInstructionsScreen.pcf: line 54, column 43
    function iconColor_11 () : gw.api.web.color.GWColor {
      return gw.vendormanagement.ServiceRequestStatus.ATTENTION.IconColor
    }
    
    // 'icon' attribute on Link (id=InvoiceWithNoQuoteAlert) at CheckWizard_CheckInstructionsScreen.pcf: line 54, column 43
    ...
    // 'mode' attribute on PanelRef at CheckWizard_CheckInstructionsScreen.pcf: line 63, column 116
    function mode_17 () : java.lang.Object {
      return wizard.RecurrenceEditable and !wizard.Check.containsDeductible() ? "" : "single"
    }
