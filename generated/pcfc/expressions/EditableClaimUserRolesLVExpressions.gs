...
@javax.annotation.processing.Generated("config/web/pcf/claim/partiesinvolved/EditableClaimUserRolesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableClaimUserRolesLVExpressions {
  ...
  public static class EditableClaimUserRolesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=Role_Cell) at EditableClaimUserRolesLV.pcf: line 33, column 41
    function sortValue_0 (UserRoleAssignment :  entity.UserRoleAssignment) : java.lang.Object {
      return UserRoleAssignment.Role
    }
    
    // 'value' attribute on RangeCell (id=Exposure_Cell) at EditableClaimUserRolesLV.pcf: line 41, column 40
    function sortValue_1 (UserRoleAssignment :  entity.UserRoleAssignment) : java.lang.Object {
      return UserRoleAssignment.Exposure
    }
    
    // 'value' attribute on BooleanRadioCell (id=Active_Cell) at EditableClaimUserRolesLV.pcf: line 46, column 46
    function sortValue_2 (UserRoleAssignment :  entity.UserRoleAssignment) : java.lang.Object {
      return UserRoleAssignment.Active
    }
    
    // 'value' attribute on TextCell (id=Comments_Cell) at EditableClaimUserRolesLV.pcf: line 51, column 48
  ...
  public static class IteratorEntryExpressionsImpl extends EditableClaimUserRolesLVExpressionsImpl {
    ...
    // 'valueRange' attribute on RangeCell (id=Exposure_Cell) at EditableClaimUserRolesLV.pcf: line 41, column 40
    ...
    // 'valueRange' attribute on RangeCell (id=Exposure_Cell) at EditableClaimUserRolesLV.pcf: line 41, column 40
    function verifyValueRangeIsAllowedType_12 ($$arg :  entity.Exposure[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeCell (id=Exposure_Cell) at EditableClaimUserRolesLV.pcf: line 41, column 40
    function verifyValueRangeIsAllowedType_12 ($$arg :  gw.api.database.IQueryBeanResult<entity.Exposure>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
