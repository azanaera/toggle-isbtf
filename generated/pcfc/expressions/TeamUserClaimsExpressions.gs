...
@javax.annotation.processing.Generated("config/web/pcf/team/user/TeamUserClaims.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TeamUserClaimsExpressions {
  ...
  public static class TeamUserClaimsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamUserClaims_Print) at TeamUserClaims.pcf: line 58, column 25
    function action_7 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamUserClaims_Assign) at TeamUserClaims.pcf: line 45, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamUserClaims_RemoveFlag) at TeamUserClaims.pcf: line 51, column 76
    ...
    // 'available' attribute on ToolbarButton (id=TeamUserClaims_Print) at TeamUserClaims.pcf: line 58, column 25
    ...
    // 'def' attribute on PanelRef at TeamUserClaims.pcf: line 61, column 59
    ...
    // 'title' attribute on TitleBar at TeamUserClaims.pcf: line 37, column 89
