...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/600/ClaimSnapshotPolicyTrips600LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyTrips600LVExpressions {
  ...
  public static class ClaimSnapshotPolicyTrips600LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=TripNumber_Cell) at ClaimSnapshotPolicyTrips600LV.pcf: line 28, column 40
    function sortValue_1 (TripRU :  dynamic.Dynamic) : java.lang.Object {
      return (TripRU).RUNumber
    }
    
    // 'value' attribute on TextCell (id=TripDescription_Cell) at ClaimSnapshotPolicyTrips600LV.pcf: line 33, column 40
    function sortValue_2 (TripRU :  dynamic.Dynamic) : java.lang.Object {
      return (TripRU).TripDescription
    }
    
    // 'value' attribute on TextCell (id=StartDate_Cell) at ClaimSnapshotPolicyTrips600LV.pcf: line 38, column 40
    function sortValue_3 (TripRU :  dynamic.Dynamic) : java.lang.Object {
      return (TripRU).StartDate
    }
    
    // 'value' attribute on TextCell (id=EndDate_Cell) at ClaimSnapshotPolicyTrips600LV.pcf: line 43, column 40
    function sortValue_4 (TripRU :  dynamic.Dynamic) : java.lang.Object {
      return (TripRU).EndDate
    }
    
    // 'value' attribute on TextCell (id=GeographicalRegion_Cell) at ClaimSnapshotPolicyTrips600LV.pcf: line 48, column 40
