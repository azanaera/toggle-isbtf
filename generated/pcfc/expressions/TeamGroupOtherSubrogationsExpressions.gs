...
class TeamGroupOtherSubrogationsExpressions {
  ...
  public static class TeamGroupOtherSubrogationsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Print) at TeamGroupOtherSubrogations.pcf: line 31, column 25
    function action_2 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions("SubrogationsLV")
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Assign) at TeamGroupOtherSubrogations.pcf: line 24, column 25
    ...
    // 'available' attribute on ToolbarButton (id=Print) at TeamGroupOtherSubrogations.pcf: line 31, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupOtherSubrogations.pcf: line 34, column 78
