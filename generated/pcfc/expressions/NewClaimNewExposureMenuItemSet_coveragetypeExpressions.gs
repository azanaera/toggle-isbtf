...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimNewExposureMenuItemSet.coveragetype.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimNewExposureMenuItemSet_coveragetypeExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimNewExposureMenuItemSet.coveragetype.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class MenuItemTreeEntryExpressionsImpl extends NewClaimNewExposureMenuItemSetExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=item) at NewClaimNewExposureMenuItemSet.coveragetype.pcf: line 22, column 36
    ...
    // 'children' attribute on MenuItemTree at NewClaimNewExposureMenuItemSet.coveragetype.pcf: line 18, column 57
    function children_3 () : java.lang.Object {
      return item.Children
    }
    
    // 'label' attribute on MenuItem (id=item) at NewClaimNewExposureMenuItemSet.coveragetype.pcf: line 22, column 36
  ...
  public static class NewClaimNewExposureMenuItemSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on MenuItemTree at NewClaimNewExposureMenuItemSet.coveragetype.pcf: line 18, column 57
