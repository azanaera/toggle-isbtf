...
@javax.annotation.processing.Generated("config/web/pcf/desktop/pendingassignment/DesktopAwaitingAssignment.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DesktopAwaitingAssignmentExpressions {
  ...
  public static class DesktopAwaitingAssignmentExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=DesktopAwaitingAssignment_PrintButton) at DesktopAwaitingAssignment.pcf: line 48, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopAwaitingAssignment_AssignButton) at DesktopAwaitingAssignment.pcf: line 33, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopAwaitingAssignment_ReassignButton) at DesktopAwaitingAssignment.pcf: line 40, column 25
    ...
    // 'available' attribute on ToolbarButton (id=DesktopAwaitingAssignment_PrintButton) at DesktopAwaitingAssignment.pcf: line 48, column 25
    ...
    // 'def' attribute on PanelRef at DesktopAwaitingAssignment.pcf: line 51, column 72
