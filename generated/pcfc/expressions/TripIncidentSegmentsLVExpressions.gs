...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/TripIncidentSegmentsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TripIncidentSegmentsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TripIncidentSegmentsLVExpressionsImpl {
    ...
    // 'action' attribute on TypeKeyCell (id=CarrierType_Cell) at TripIncidentSegmentsLV.pcf: line 51, column 46
    function action_11 () : void {
      TripSegmentPopup.push( aTripSegment, aTripIncident, CurrentLocation.InEditMode )
    }
    
    // 'action' attribute on TextCell (id=AffectedSegmentName_Cell) at TripIncidentSegmentsLV.pcf: line 58, column 43
    ...
    // 'available' attribute on TextCell (id=ReasonForDenial_Cell) at TripIncidentSegmentsLV.pcf: line 82, column 77
    ...
    // 'value' attribute on TextCell (id=ReasonForDenial_Cell) at TripIncidentSegmentsLV.pcf: line 82, column 77
    function defaultSetter_31 (__VALUE_TO_SET :  java.lang.Object) : void {
      aTripSegment.ReasonForDenial = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextCell (id=ReasonForDenial_Cell) at TripIncidentSegmentsLV.pcf: line 82, column 77
    function editable_28 () : java.lang.Boolean {
      return aTripSegment.Assessment == TC_DENY ? true : false
    }
    
    // 'value' attribute on TypeKeyCell (id=CarrierType_Cell) at TripIncidentSegmentsLV.pcf: line 51, column 46
    function valueRoot_14 () : java.lang.Object {
      return aTripSegment
    }
    
    // 'value' attribute on TypeKeyCell (id=CarrierType_Cell) at TripIncidentSegmentsLV.pcf: line 51, column 46
    function value_13 () : typekey.TransportType {
      return aTripSegment.TransportType
    }
    
    // 'value' attribute on TextCell (id=AffectedSegmentName_Cell) at TripIncidentSegmentsLV.pcf: line 58, column 43
    function value_18 () : entity.TripSegment {
      return aTripSegment
    }
    
    // 'value' attribute on TextCell (id=SegmentStatus_Cell) at TripIncidentSegmentsLV.pcf: line 63, column 174
    ...
    // 'value' attribute on TypeKeyCell (id=Assessment_Cell) at TripIncidentSegmentsLV.pcf: line 69, column 49
    function value_22 () : typekey.AssessmentAction {
      return aTripSegment.Assessment
    }
    
    // 'value' attribute on CurrencyCell (id=SegmentCostIncurred_Cell) at TripIncidentSegmentsLV.pcf: line 74, column 81
