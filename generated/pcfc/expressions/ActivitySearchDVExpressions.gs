...
@javax.annotation.processing.Generated("config/web/pcf/search/activities/ActivitySearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ActivitySearchDVExpressions {
  ...
  public static class ActivitySearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at ActivitySearchDV.pcf: line 13, column 71
    function def_onEnter_0 (def :  pcf.ActivitySearchRequiredInputSet) : void {
      def.onEnter(ActivitySearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at ActivitySearchDV.pcf: line 17, column 71
    function def_onEnter_2 (def :  pcf.ActivitySearchOptionalInputSet) : void {
      def.onEnter(ActivitySearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at ActivitySearchDV.pcf: line 21, column 41
