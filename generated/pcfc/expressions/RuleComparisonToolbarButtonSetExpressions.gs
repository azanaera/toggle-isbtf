...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RuleComparisonToolbarButtonSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RuleComparisonToolbarButtonSetExpressions {
  ...
  public static class RuleComparisonToolbarButtonSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=ChooseExisting) at RuleComparisonToolbarButtonSet.pcf: line 23, column 46
    function action_1 () : void {
      importHelper.resolveConflict(importEntry, TC_EXISTING); CurrentLocation.cancel()
    }
    
    // 'action' attribute on ToolbarButton (id=ChooseImporting) at RuleComparisonToolbarButtonSet.pcf: line 30, column 46
    function action_3 () : void {
      importHelper.resolveConflict(importEntry, TC_IMPORTING); CurrentLocation.cancel()
    }
    
    // 'action' attribute on MenuItem (id=Existing) at RuleComparisonToolbarButtonSet.pcf: line 44, column 68
    function action_5 () : void {
      navSupport.pushRuleComparisonEditPopup(importEntry, importHelper, TC_EXISTING)
    }
    
    // 'action' attribute on MenuItem (id=Importing) at RuleComparisonToolbarButtonSet.pcf: line 51, column 68
    function action_7 () : void {
      navSupport.pushRuleComparisonEditPopup(importEntry, importHelper, TC_IMPORTING)
    }
    
    // 'available' attribute on ToolbarButton (id=EditNewMerge) at RuleComparisonToolbarButtonSet.pcf: line 37, column 134
    function available_8 () : java.lang.Boolean {
      return not importEntry.ExistingVersionDraft
    }
    
    // 'visible' attribute on ToolbarButton (id=ChooseExisting) at RuleComparisonToolbarButtonSet.pcf: line 23, column 46
    function visible_0 () : java.lang.Boolean {
      return importEntry.Status.Conflict
    }
    
    // 'visible' attribute on MenuItem (id=Existing) at RuleComparisonToolbarButtonSet.pcf: line 44, column 68
    function visible_4 () : java.lang.Boolean {
      return importEntry.Status != TC_EDITEDRESOLVEDCONFLICT
    }
    
    // 'visible' attribute on ToolbarButton (id=EditNewMerge) at RuleComparisonToolbarButtonSet.pcf: line 37, column 134
    function visible_9 () : java.lang.Boolean {
      return importEntry.Status.Conflict and gw.bizrules.pcf.RulePermissionUIHelper.canEditRule(importEntry.getExistingVersion())
    }
