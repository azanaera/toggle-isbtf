...
@javax.annotation.processing.Generated("config/web/pcf/claim/incidents/EditOtherStructureIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditOtherStructureIncidentPopupExpressions {
  ...
  public static class EditOtherStructureIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at EditOtherStructureIncidentPopup.pcf: line 38, column 51
    ...
    // 'icon' attribute on TitleBar at EditOtherStructureIncidentPopup.pcf: line 27, column 33
    function icon_0 () : java.lang.String {
      return incident.HeaderIcon
    }
    
    // EditButtons at EditOtherStructureIncidentPopup.pcf: line 29, column 23
