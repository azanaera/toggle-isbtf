...
class NewServiceRequestExpressions {
  ...
  public static class NewServiceRequestExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=SubmitButton) at NewServiceRequest.pcf: line 34, column 49
    ...
    // 'def' attribute on PanelRef (id=NewServiceRequestScreen) at NewServiceRequest.pcf: line 41, column 38
    ...
    // 'visible' attribute on ToolbarButton (id=SubmitButton) at NewServiceRequest.pcf: line 34, column 49
