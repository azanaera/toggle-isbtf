...
@javax.annotation.processing.Generated("config/web/pcf/shared/vehicle/VehicleDamageDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class VehicleDamageDVExpressions {
  ...
  public static class VehicleDamageDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at VehicleDamageDV.pcf: line 329, column 49
    function def_onEnter_208 (def :  pcf.DeductibleInfoInputSet) : void {
      def.onEnter(Exposure)
    }
    ...
    // 'def' attribute on InputSetRef at VehicleDamageDV.pcf: line 329, column 49
    function def_refreshVariables_209 (def :  pcf.DeductibleInfoInputSet) : void {
      def.refreshVariables(Exposure)
    }
    ...
    // 'value' attribute on TypeKeyInput (id=RepresentationLevel_Ext_Input) at VehicleDamageDV.pcf: line 290, column 54
    ...
    // 'value' attribute on TypeKeyInput (id=EscalationLevel_Ext_Input) at VehicleDamageDV.pcf: line 296, column 50
    ...
    // 'value' attribute on CurrencyInput (id=RemainingReserves_Input) at VehicleDamageDV.pcf: line 306, column 60
    ...
    // 'value' attribute on TypeKeyInput (id=RepresentationLevel_Ext_Input) at VehicleDamageDV.pcf: line 290, column 54
    function value_174 () : typekey.RepresentationLevel_Ext {
      return Exposure.RepresentationLevel_Ext
    }
    
    // 'value' attribute on TypeKeyInput (id=EscalationLevel_Ext_Input) at VehicleDamageDV.pcf: line 296, column 50
    function value_178 () : typekey.EscalationLevel_Ext {
    ...
    // 'value' attribute on CurrencyInput (id=FuturePayments_Input) at VehicleDamageDV.pcf: line 311, column 60
    function value_189 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.FuturePayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalPayments_Input) at VehicleDamageDV.pcf: line 316, column 60
    function value_194 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalPayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalRecoveries_Input) at VehicleDamageDV.pcf: line 321, column 62
    function value_199 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalRecoveries
    }
    
    // 'value' attribute on CurrencyInput (id=TotalIncurredNet_Input) at VehicleDamageDV.pcf: line 327, column 68
    ...
    // 'visible' attribute on Label at VehicleDamageDV.pcf: line 300, column 70
    function visible_182 () : java.lang.Boolean {
      return perm.Claim.viewtransactiondetails(Exposure.Claim)
    }
    
    // 'visible' attribute on CurrencyInput (id=RemainingReserves_Input) at VehicleDamageDV.pcf: line 306, column 60
    function visible_183 () : java.lang.Boolean {
      return perm.Claim.viewreserves(Exposure.Claim)
    }
    
    // 'visible' attribute on CurrencyInput (id=FuturePayments_Input) at VehicleDamageDV.pcf: line 311, column 60
    function visible_188 () : java.lang.Boolean {
      return perm.Claim.viewpayments(Exposure.Claim)
    }
    
    // 'visible' attribute on CurrencyInput (id=TotalRecoveries_Input) at VehicleDamageDV.pcf: line 321, column 62
    ...
    // 'visible' attribute on CurrencyInput (id=TotalIncurredNet_Input) at VehicleDamageDV.pcf: line 327, column 68
