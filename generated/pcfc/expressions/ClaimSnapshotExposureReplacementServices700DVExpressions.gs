...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotExposureReplacementServices700DV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotExposureReplacementServices700DVExpressions {
  ...
  public static class ClaimSnapshotExposureReplacementServices700DVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=EditableServiceProvider_Service_Cell) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 61, column 46
    function sortValue_10 (ClaimContactRole :  dynamic.Dynamic) : java.lang.Object {
      return ClaimContactRole.ClaimContact.Service
    }
    
    // 'value' attribute on TextCell (id=Exposure_RSBenProvider_Cell) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 40, column 46
    function sortValue_6 (ClaimContactRole :  dynamic.Dynamic) : java.lang.Object {
      return ClaimContactRole.ClaimContact.Contact
    }
    
    // 'value' attribute on TextCell (id=EditableServiceProvider_Phone_Cell) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 46, column 46
    ...
    // 'value' attribute on TextCell (id=EditableServiceProvider_ServiceType_Cell) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 51, column 46
    ...
    // 'value' attribute on TextCell (id=EditableServiceProvider_ProviderType_Cell) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 56, column 46
    function sortValue_9 (ClaimContactRole :  dynamic.Dynamic) : java.lang.Object {
      return ClaimContactRole.ClaimContact.ProviderType
    }
    
    // 'value' attribute on TextInput (id=LostWagesBenefits_BenefitsBeginDate_Input) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 17, column 38
    ...
    // 'value' attribute on TextInput (id=LostWagesBenefits_BenefitsEndDate_Input) at ClaimSnapshotExposureReplacementServices700DV.pcf: line 22, column 38
