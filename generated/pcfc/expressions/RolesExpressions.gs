...
@javax.annotation.processing.Generated("config/web/pcf/admin/usersandsecurity/Roles.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RolesExpressions {
  ...
  public static class RolesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Roles_AddRoleButton) at Roles.pcf: line 18, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Roles_DeleteButton) at Roles.pcf: line 26, column 39
    ...
    // 'def' attribute on PanelRef at Roles.pcf: line 29, column 62
    ...
    // 'visible' attribute on CheckedValuesToolbarButton (id=Roles_DeleteButton) at Roles.pcf: line 26, column 39
