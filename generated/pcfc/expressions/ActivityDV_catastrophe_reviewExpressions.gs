...
@javax.annotation.processing.Generated("config/web/pcf/workspace/activity/ActivityDV.catastrophe_review.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ActivityDV_catastrophe_reviewExpressions {
  ...
  public static class ActivityDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at ActivityDV.catastrophe_review.pcf: line 32, column 49
    function def_onEnter_14 (def :  pcf.ActivityBulkInvoiceWarningInputSet) : void {
      def.onEnter(Activity.BulkInvoice)
    }
    
    // 'def' attribute on InputSetRef at ActivityDV.catastrophe_review.pcf: line 34, column 51
    function def_onEnter_16 (def :  pcf.ActivityTrackingInputSet) : void {
      def.onEnter(Activity)
    }
    ...
    // 'def' attribute on InputSetRef at ActivityDV.catastrophe_review.pcf: line 34, column 51
    function def_refreshVariables_17 (def :  pcf.ActivityTrackingInputSet) : void {
      def.refreshVariables(Activity)
    }
    ...
    // 'visible' attribute on InputSetRef at ActivityDV.catastrophe_review.pcf: line 32, column 49
