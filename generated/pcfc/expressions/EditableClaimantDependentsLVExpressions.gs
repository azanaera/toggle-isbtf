...
@javax.annotation.processing.Generated("config/web/pcf/claim/shared/exposures/EditableClaimantDependentsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableClaimantDependentsLVExpressions {
  ...
  public static class EditableClaimantDependentsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at EditableClaimantDependentsLV.pcf: line 43, column 72
    function sortValue_0 (ClaimContactRole :  entity.ClaimContactRole) : java.lang.Object {
      return ClaimContactRole.Contact
    }
    
    // 'value' attribute on TypeKeyCell (id=EditableClaimantDependents_DependentType_Cell) at EditableClaimantDependentsLV.pcf: line 50, column 46
    ...
    // 'value' attribute on DateCell (id=EditableClaimantDependents_DateOfBirth_Cell) at EditableClaimantDependentsLV.pcf: line 54, column 123
    ...
    // 'value' attribute on TypeKeyCell (id=EditableClaimantDependents_BenefitEndReasonType_Cell) at EditableClaimantDependentsLV.pcf: line 64, column 53
    ...
    // 'value' attribute on DateCell (id=EditableClaimantDependents_BenefitEndDate_Cell) at EditableClaimantDependentsLV.pcf: line 69, column 65
  ...
  public static class IteratorEntryExpressionsImpl extends EditableClaimantDependentsLVExpressionsImpl {
    ...
    // 'action' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 18, column 285
    ...
    // 'action' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 12, column 273
    function action_12 () : void {
      ClaimContactDetailPopup.push(ClaimContactRole.Contact, ClaimContactRoleOwner.Claim)
    }
    
    // 'action' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 16, column 225
    ...
    // 'def' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 14, column 229
    ...
    // 'value' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'onPick' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'valueRange' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 12, column 273
    ...
    // 'visible' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 14, column 229
    function visible_5 () : java.lang.Boolean {
      return perm.Contact.createlocal
    }
    
    // 'visible' attribute on ClaimContactCell (id=EditableClaimantDependents_Dependent_Cell) at ClaimContactWidget.xml: line 16, column 225
