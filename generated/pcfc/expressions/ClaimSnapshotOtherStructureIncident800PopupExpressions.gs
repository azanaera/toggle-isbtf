...
class ClaimSnapshotOtherStructureIncident800PopupExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotOtherStructureIncident800Popup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotOtherStructureIncident800PopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'canVisit' attribute on Popup (id=ClaimSnapshotOtherStructureIncident800Popup) at ClaimSnapshotOtherStructureIncident800Popup.pcf: line 9, column 101
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotOtherStructureIncident800Popup.pcf: line 29, column 25
    ...
    // 'initialValue' attribute on Variable at ClaimSnapshotOtherStructureIncident800Popup.pcf: line 21, column 31
    function initialValue_0 () : dynamic.Dynamic {
      return gw.api.snapshot.ClaimSnapshotUtil.getSnapshot(Claim)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotOtherStructureIncident800Popup.pcf: line 25, column 22
    function initialValue_1 () : String {
      return gw.api.snapshot.ClaimSnapshotUtil.getPageVersion(Snapshot)
    }
    
    // 'mode' attribute on PanelRef at ClaimSnapshotOtherStructureIncident800Popup.pcf: line 29, column 25
    ...
    override property get CurrentLocation () : pcf.ClaimSnapshotOtherStructureIncident800Popup {
      return super.CurrentLocation as pcf.ClaimSnapshotOtherStructureIncident800Popup
    }
