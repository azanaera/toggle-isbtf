...
class ClaimSnapshotOtherStructureIncidentPopupExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotOtherStructureIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotOtherStructureIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'canVisit' attribute on Popup (id=ClaimSnapshotOtherStructureIncidentPopup) at ClaimSnapshotOtherStructureIncidentPopup.pcf: line 9, column 101
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotOtherStructureIncidentPopup.pcf: line 29, column 25
    ...
    // 'initialValue' attribute on Variable at ClaimSnapshotOtherStructureIncidentPopup.pcf: line 21, column 31
    function initialValue_0 () : dynamic.Dynamic {
      return gw.api.snapshot.ClaimSnapshotUtil.getSnapshot(Claim)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotOtherStructureIncidentPopup.pcf: line 25, column 22
    function initialValue_1 () : String {
      return gw.api.snapshot.ClaimSnapshotUtil.getPageVersion(Snapshot)
    }
    
    // 'mode' attribute on PanelRef at ClaimSnapshotOtherStructureIncidentPopup.pcf: line 29, column 25
    ...
    override property get CurrentLocation () : pcf.ClaimSnapshotOtherStructureIncidentPopup {
      return super.CurrentLocation as pcf.ClaimSnapshotOtherStructureIncidentPopup
    }
