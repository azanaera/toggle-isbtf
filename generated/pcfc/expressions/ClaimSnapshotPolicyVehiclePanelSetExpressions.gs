...
class ClaimSnapshotPolicyVehiclePanelSetExpressions {
  ...
  public static class ClaimSnapshotPolicyVehicleLDPExpressionsImpl extends ClaimSnapshotPolicyVehiclePanelSetExpressionsImpl {
    ...
    function def_onEnter_88 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyVehiclePanelSet.pcf: line 183, column 37
    function def_onEnter_90 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyVehiclePanelSet.pcf: line 183, column 37
    function def_onEnter_92 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyVehiclePanelSet.pcf: line 183, column 37
    function def_refreshVariables_89 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyVehiclePanelSet.pcf: line 183, column 37
    function def_refreshVariables_91 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyVehiclePanelSet.pcf: line 183, column 37
    function def_refreshVariables_93 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.refreshVariables(SelectedCoverage)
    }
