...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/TripRUScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TripRUScreenExpressions {
  ...
  public static class TripRUScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=GeographicalRegion_Input) at TripRUScreen.pcf: line 44, column 51
    function defaultSetter_12 (__VALUE_TO_SET :  java.lang.Object) : void {
      aTripRU.GeographicalRegion = (__VALUE_TO_SET as typekey.GeographicalRegion)
    }
    
    // 'value' attribute on DateInput (id=StartDate_Input) at TripRUScreen.pcf: line 51, column 38
    function defaultSetter_16 (__VALUE_TO_SET :  java.lang.Object) : void {
      aTripRU.StartDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateInput (id=EndDate_Input) at TripRUScreen.pcf: line 59, column 36
    function defaultSetter_21 (__VALUE_TO_SET :  java.lang.Object) : void {
      aTripRU.EndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TextInput (id=RUNumber_Input) at TripRUScreen.pcf: line 31, column 42
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      aTripRU.RUNumber = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on TextInput (id=TripDescription_Input) at TripRUScreen.pcf: line 36, column 44
    ...
    // 'validationExpression' attribute on DateInput (id=EndDate_Input) at TripRUScreen.pcf: line 59, column 36
