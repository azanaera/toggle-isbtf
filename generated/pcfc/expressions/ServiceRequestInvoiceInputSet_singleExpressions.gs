...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/ServiceRequestInvoiceInputSet.single.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ServiceRequestInvoiceInputSet_singleExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ServiceRequestInvoiceInputSetExpressionsImpl {
    ...
    // 'icon' attribute on BooleanRadioCell (id=Icon_Cell) at ServiceRequestInvoiceInputSet.single.pcf: line 61, column 36
  ...
  public static class ServiceRequestInvoiceInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=ServiceRequestNumber_Input) at ServiceRequestInvoiceInputSet.single.pcf: line 31, column 60
    function valueRoot_5 () : java.lang.Object {
      return invoice.ServiceRequest
    }
    
    // 'value' attribute on CurrencyInput (id=ServiceRequestInvoiceAmount_Input) at ServiceRequestInvoiceInputSet.single.pcf: line 35, column 31
    function valueRoot_8 () : java.lang.Object {
      return invoice
    }
    
    // 'value' attribute on TextInput (id=ServiceRequestInvoiceReferenceNumber_Input) at ServiceRequestInvoiceInputSet.single.pcf: line 27, column 189
    ...
    function value_21 () : java.util.List<gw.util.Pair<entity.ServiceRequestStatementDocumentLink, entity.Document>> {
