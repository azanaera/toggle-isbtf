...
@javax.annotation.processing.Generated("config/web/pcf/claim/reinsurance/AgreementDetailsDV.ExcessOfLossRITreaty.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AgreementDetailsDV_ExcessOfLossRITreatyExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/reinsurance/AgreementDetailsDV.ExcessOfLossRITreaty.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class AgreementDetailsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 27, column 35
    ...
    // 'value' attribute on TextInput (id=AgreementNumber_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 18, column 44
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.AgreementNumber = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=AgreementCurrency_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 37, column 62
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.Currency = (__VALUE_TO_SET as typekey.Currency)
    }
    
    // 'value' attribute on CurrencyInput (id=AttachmentPoint_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 46, column 44
    function defaultSetter_18 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.AttachmentPoint = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=TopOfLayer_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 53, column 39
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.TopOfLayer = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=RecoveryLimit_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 60, column 42
    function defaultSetter_26 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.RecoveryLimit = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextInput (id=CededShare_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 68, column 43
    function defaultSetter_30 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.CededShare = (__VALUE_TO_SET as java.math.BigDecimal)
    }
    
    // 'value' attribute on CurrencyInput (id=NotificationThreshold_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 75, column 50
    function defaultSetter_34 (__VALUE_TO_SET :  java.lang.Object) : void {
      agreement.NotificationThreshold = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextInput (id=AgreementName_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 24, column 42
    ...
    // 'value' attribute on BooleanRadioInput (id=ExceedsNotificationThreshold_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 79, column 57
    ...
    // 'visible' attribute on TypeKeyInput (id=AgreementCurrency_Input) at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 37, column 62
    function visible_11 () : java.lang.Boolean {
      return gw.api.util.CurrencyUtil.MultiCurrencyMode
    }
    
    // 'visible' attribute on InputSetRef at AgreementDetailsDV.ExcessOfLossRITreaty.pcf: line 27, column 35
