...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/shared/ClaimSnapshotCovTermPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotCovTermPopupExpressions {
  ...
  public static class ClaimSnapshotCovTermPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=CovTermPattern_Input) at ClaimSnapshotCovTermPopup.pcf: line 21, column 42
    ...
    // 'value' attribute on TextInput (id=Code_Input) at ClaimSnapshotCovTermPopup.pcf: line 45, column 44
    function value_12 () : dynamic.Dynamic {
      return CovTerm.Code
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at ClaimSnapshotCovTermPopup.pcf: line 50, column 44
    function value_15 () : dynamic.Dynamic {
      return CovTerm.Description
    }
    
    // 'value' attribute on TextInput (id=FinancialAmount_Input) at ClaimSnapshotCovTermPopup.pcf: line 58, column 44
    function value_19 () : dynamic.Dynamic {
      return CovTerm.FinancialAmount
    }
    
    // 'value' attribute on TextInput (id=NumericValue_Input) at ClaimSnapshotCovTermPopup.pcf: line 66, column 44
    function value_23 () : dynamic.Dynamic {
      return CovTerm.NumericValue
    }
    
    // 'value' attribute on TextInput (id=Units_Input) at ClaimSnapshotCovTermPopup.pcf: line 71, column 44
    function value_26 () : dynamic.Dynamic {
      return CovTerm.Units
    }
    
    // 'value' attribute on TextInput (id=ModelRestriction_Input) at ClaimSnapshotCovTermPopup.pcf: line 26, column 42
    function value_3 () : dynamic.Dynamic {
      return CovTerm.ModelRestriction
    }
    
    // 'value' attribute on TextInput (id=ModelAggregation_Input) at ClaimSnapshotCovTermPopup.pcf: line 31, column 42
    function value_6 () : dynamic.Dynamic {
      return CovTerm.ModelAggregation
    }
    
    // 'value' attribute on TextInput (id=Type_Input) at ClaimSnapshotCovTermPopup.pcf: line 38, column 42
