...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimLostWagesSummaryDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimLostWagesSummaryDVExpressions {
  ...
  public static class NewClaimLostWagesSummaryDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextInput (id=AssignedUser_Name_Input) at NewClaimLostWagesSummaryDV.pcf: line 41, column 49
    ...
    // 'action' attribute on PolicyStatCodePickerInput (id=StatLine_Input) at NewClaimLostWagesSummaryDV.pcf: line 75, column 63
    ...
    // 'available' attribute on TextInput (id=AssignedUser_Name_Input) at NewClaimLostWagesSummaryDV.pcf: line 41, column 49
    ...
    // 'value' attribute on CurrencyInput (id=AverageWeeklyWages_Input) at NewClaimLostWagesSummaryDV.pcf: line 105, column 46
    ...
    // 'value' attribute on TypeKeyInput (id=DaysInWeek_Input) at NewClaimLostWagesSummaryDV.pcf: line 111, column 45
    ...
    // 'value' attribute on DateInput (id=LastDayWorked_Input) at NewClaimLostWagesSummaryDV.pcf: line 116, column 41
    function defaultSetter_73 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.LastDayWorked = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TextInput (id=LWImpairment_Input) at NewClaimLostWagesSummaryDV.pcf: line 122, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=JurisdictionState_Input) at NewClaimLostWagesSummaryDV.pcf: line 134, column 43
    ...
    // 'filter' attribute on TypeKeyInput (id=JurisdictionState_Input) at NewClaimLostWagesSummaryDV.pcf: line 134, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=LossParty_Input) at NewClaimLostWagesSummaryDV.pcf: line 18, column 44
    ...
    // 'value' attribute on CurrencyInput (id=RemainingReserves_Input) at NewClaimLostWagesSummaryDV.pcf: line 157, column 57
    ...
    // 'value' attribute on CurrencyInput (id=TotalPayments_Input) at NewClaimLostWagesSummaryDV.pcf: line 165, column 53
    function value_100 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalPayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalRecoveries_Input) at NewClaimLostWagesSummaryDV.pcf: line 169, column 55
    function value_103 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalRecoveries
    }
    
    // 'value' attribute on CurrencyInput (id=TotalIncurredNet_Input) at NewClaimLostWagesSummaryDV.pcf: line 174, column 56
    function value_106 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalIncurredNet
    }
    
    // 'value' attribute on TypeKeyInput (id=ClosedOutcome_Input) at NewClaimLostWagesSummaryDV.pcf: line 34, column 50
    function value_12 () : typekey.ExposureClosedOutcomeType {
      return Exposure.ClosedOutcome
    }
    
    // 'value' attribute on TextInput (id=AssignedUser_Name_Input) at NewClaimLostWagesSummaryDV.pcf: line 41, column 49
    function value_19 () : java.lang.String {
      return Exposure.AssigneeDisplayString
    }
    
    // 'value' attribute on DateInput (id=ReOpenDate_Input) at NewClaimLostWagesSummaryDV.pcf: line 47, column 50
    function value_24 () : java.util.Date {
      return Exposure.ReOpenDate
    }
    
    // 'value' attribute on TextInput (id=AssignedGroup_Name_Input) at NewClaimLostWagesSummaryDV.pcf: line 51, column 58
    function value_28 () : java.lang.String {
      return Exposure.AssigneeGroupOnlyDisplayString
    }
    
    // 'value' attribute on TypeKeyInput (id=ReopenedReason_Input) at NewClaimLostWagesSummaryDV.pcf: line 57, column 50
    function value_32 () : typekey.ExposureReopenedReason {
      return Exposure.ReopenedReason
    }
    
    // 'value' attribute on TypeKeyInput (id=State_Input) at NewClaimLostWagesSummaryDV.pcf: line 62, column 44
    function value_36 () : typekey.ExposureState {
      return Exposure.State
    }
    
    // 'value' attribute on DateInput (id=CreateTime_Input) at NewClaimLostWagesSummaryDV.pcf: line 66, column 38
    function value_39 () : java.util.Date {
      return Exposure.CreateTime
    }
    
    // 'value' attribute on DateInput (id=ClosedDate_Input) at NewClaimLostWagesSummaryDV.pcf: line 23, column 50
    ...
    // 'value' attribute on TextInput (id=StatLine_Warning_Input) at NewClaimLostWagesSummaryDV.pcf: line 82, column 65
    ...
    // 'value' attribute on TypeKeyInput (id=PrimaryCoverage_Input) at NewClaimLostWagesSummaryDV.pcf: line 28, column 43
    ...
    // 'value' attribute on TypeKeyInput (id=Segment_Input) at NewClaimLostWagesSummaryDV.pcf: line 139, column 43
    function value_85 () : typekey.ClaimSegment {
      return Exposure.Segment
    }
    
    // 'value' attribute on TypeKeyInput (id=Strategy_Input) at NewClaimLostWagesSummaryDV.pcf: line 144, column 44
    function value_88 () : typekey.ClaimStrategy {
      return Exposure.Strategy
    }
    
    // 'value' attribute on TypeKeyInput (id=ValidationLevel_Input) at NewClaimLostWagesSummaryDV.pcf: line 149, column 46
    ...
    // 'value' attribute on CurrencyInput (id=FuturePayments_Input) at NewClaimLostWagesSummaryDV.pcf: line 161, column 54
    ...
    // 'visible' attribute on DateInput (id=ReOpenDate_Input) at NewClaimLostWagesSummaryDV.pcf: line 47, column 50
    function visible_23 () : java.lang.Boolean {
      return  Exposure.ReOpenDate != null 
    }
    
    // 'visible' attribute on DateInput (id=ClosedDate_Input) at NewClaimLostWagesSummaryDV.pcf: line 23, column 50
    function visible_3 () : java.lang.Boolean {
      return  Exposure.State == TC_CLOSED 
    }
    
    // 'visible' attribute on TextInput (id=StatLine_Warning_Input) at NewClaimLostWagesSummaryDV.pcf: line 82, column 65
