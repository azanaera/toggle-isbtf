...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/transactions/TransactionReserveDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TransactionReserveDVExpressions {
  ...
  public static class TransactionReserveDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_6 (def :  pcf.ReserveSetLV) : void {
      def.onEnter(gw.api.financials.FinancialsUtil.getReservesFromTransactionSet(Reserve.TransactionSet), false)
    }
    ...
    function def_refreshVariables_7 (def :  pcf.ReserveSetLV) : void {
      def.refreshVariables(gw.api.financials.FinancialsUtil.getReservesFromTransactionSet(Reserve.TransactionSet), false)
    }
