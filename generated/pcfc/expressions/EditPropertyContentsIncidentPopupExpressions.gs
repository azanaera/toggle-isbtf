...
@javax.annotation.processing.Generated("config/web/pcf/claim/incidents/EditPropertyContentsIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditPropertyContentsIncidentPopupExpressions {
  ...
  public static class EditPropertyContentsIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at EditPropertyContentsIncidentPopup.pcf: line 38, column 59
    ...
    // 'icon' attribute on TitleBar at EditPropertyContentsIncidentPopup.pcf: line 27, column 33
    function icon_0 () : java.lang.String {
      return incident.HeaderIcon
    }
    
    // EditButtons at EditPropertyContentsIncidentPopup.pcf: line 29, column 23
