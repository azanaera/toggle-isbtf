...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/CovTerm/CovTermPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CovTermPopupExpressions {
  ...
  public static class CovTermPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=ModelRestriction_Input) at CovTermPopup.pcf: line 50, column 51
    function defaultSetter_11 (__VALUE_TO_SET :  java.lang.Object) : void {
      CovTerm.ModelRestriction = (__VALUE_TO_SET as typekey.CovTermModelRest)
    }
    
    // 'value' attribute on TypeKeyInput (id=ModelAggregation_Input) at CovTermPopup.pcf: line 56, column 50
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      CovTerm.ModelAggregation = (__VALUE_TO_SET as typekey.CovTermModelAgg)
    }
    
    // 'value' attribute on RangeInput (id=CovTermPattern_Input) at CovTermPopup.pcf: line 44, column 49
    ...
    // EditButtons at CovTermPopup.pcf: line 34, column 80
    ...
    // 'valueRange' attribute on RangeInput (id=CovTermPattern_Input) at CovTermPopup.pcf: line 44, column 49
    ...
    // 'value' attribute on TypeKeyInput (id=Type_Input) at CovTermPopup.pcf: line 63, column 42
    ...
    // 'valueRange' attribute on RangeInput (id=CovTermPattern_Input) at CovTermPopup.pcf: line 44, column 49
    function verifyValueRangeIsAllowedType_7 ($$arg :  typekey.CovTermPattern[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'editVisible' attribute on EditButtons at CovTermPopup.pcf: line 34, column 80
    function visible_1 () : java.lang.Boolean {
      return new gw.api.policy.CovTermUIHelper(CovTerm).IsEditable
    }
