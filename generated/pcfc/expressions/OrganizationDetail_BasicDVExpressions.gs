...
@javax.annotation.processing.Generated("config/web/pcf/admin/groups/OrganizationDetail_BasicDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class OrganizationDetail_BasicDVExpressions {
  ...
  public static class OrganizationDetail_BasicDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at OrganizationDetail_BasicDV.pcf: line 47, column 27
    ...
    // 'value' attribute on TextInput (id=Name_Input) at OrganizationDetail_BasicDV.pcf: line 19, column 35
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      OrganizationName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=Email_Input) at OrganizationDetail_BasicDV.pcf: line 40, column 53
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      Organization.Contact.EmailAddress1 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=Type_Input) at OrganizationDetail_BasicDV.pcf: line 25, column 42
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      Organization.Type = (__VALUE_TO_SET as typekey.BusinessType)
    }
    
    // 'editable' attribute on TypeKeyInput (id=Type_Input) at OrganizationDetail_BasicDV.pcf: line 25, column 42
