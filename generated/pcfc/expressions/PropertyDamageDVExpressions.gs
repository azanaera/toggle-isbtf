...
@javax.annotation.processing.Generated("config/web/pcf/claim/exposures/PropertyDamageDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PropertyDamageDVExpressions {
  ...
  public static class PropertyDamageDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at PropertyDamageDV.pcf: line 224, column 27
    function def_onEnter_148 (def :  pcf.EditableOtherCoverageDetailsLV) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at PropertyDamageDV.pcf: line 256, column 49
    function def_onEnter_165 (def :  pcf.DeductibleInfoInputSet) : void {
      def.onEnter(Exposure)
    }
    ...
    // 'def' attribute on InputSetRef at PropertyDamageDV.pcf: line 256, column 49
    function def_refreshVariables_166 (def :  pcf.DeductibleInfoInputSet) : void {
      def.refreshVariables(Exposure)
    }
    ...
    // 'value' attribute on TypeKeyInput (id=RepresentationLevel_Ext_Input) at PropertyDamageDV.pcf: line 204, column 54
    ...
    // 'value' attribute on TypeKeyInput (id=EscalationLevel_Ext_Input) at PropertyDamageDV.pcf: line 210, column 50
    ...
    // 'value' attribute on BooleanRadioInput (id=Claimant_OtherCoverage_Input) at PropertyDamageDV.pcf: line 219, column 41
    ...
    // 'value' attribute on CurrencyInput (id=RemainingReserves_Input) at PropertyDamageDV.pcf: line 237, column 57
    ...
    // 'value' attribute on TypeKeyInput (id=RepresentationLevel_Ext_Input) at PropertyDamageDV.pcf: line 204, column 54
    function value_136 () : typekey.RepresentationLevel_Ext {
      return Exposure.RepresentationLevel_Ext
    }
    
    // 'value' attribute on TypeKeyInput (id=EscalationLevel_Ext_Input) at PropertyDamageDV.pcf: line 210, column 50
    function value_140 () : typekey.EscalationLevel_Ext {
    ...
    // 'value' attribute on CurrencyInput (id=FuturePayments_Input) at PropertyDamageDV.pcf: line 241, column 54
    function value_153 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.FuturePayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalPayments_Input) at PropertyDamageDV.pcf: line 245, column 53
    function value_156 () : gw.api.financials.CurrencyAmount {
      return Exposure.ExposureRpt.TotalPayments
    }
    
    // 'value' attribute on CurrencyInput (id=TotalRecoveries_Input) at PropertyDamageDV.pcf: line 249, column 55
    ...
    // 'value' attribute on CurrencyInput (id=TotalIncurredNet_Input) at PropertyDamageDV.pcf: line 254, column 56
