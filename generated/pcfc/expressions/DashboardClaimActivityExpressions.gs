...
class DashboardClaimActivityExpressions {
  ...
  public static class DashboardClaimActivityExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at DashboardClaimActivity.pcf: line 42, column 103
    function def_onEnter_11 (def :  pcf.ClaimActivityByLossTypeLV) : void {
      def.onEnter(Stats.LossTypeStats?.toTypedArray())
    }
    
    // 'def' attribute on PanelRef at DashboardClaimActivity.pcf: line 46, column 101
    function def_onEnter_14 (def :  pcf.ClaimActivityByCoverageTypeLV) : void {
      def.onEnter(Stats.CoverageTypeStats?.toTypedArray())
    }
    
    // 'def' attribute on PanelRef at DashboardClaimActivity.pcf: line 35, column 107
    ...
    // 'def' attribute on PanelRef at DashboardClaimActivity.pcf: line 38, column 103
    ...
    // 'visible' attribute on PanelRef at DashboardClaimActivity.pcf: line 46, column 101
    function visible_13 () : java.lang.Boolean {
      return GroupInfo.isRoot() && gw.api.dashboard.DashboardUtil.isShowByCoverage()
    }
    
    // 'visible' attribute on PanelRef at DashboardClaimActivity.pcf: line 38, column 103
