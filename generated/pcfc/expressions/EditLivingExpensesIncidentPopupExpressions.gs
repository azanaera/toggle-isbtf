...
@javax.annotation.processing.Generated("config/web/pcf/claim/incidents/EditLivingExpensesIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditLivingExpensesIncidentPopupExpressions {
  ...
  public static class EditLivingExpensesIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at EditLivingExpensesIncidentPopup.pcf: line 38, column 57
    ...
    // 'icon' attribute on TitleBar at EditLivingExpensesIncidentPopup.pcf: line 27, column 33
    function icon_0 () : java.lang.String {
      return incident.HeaderIcon
    }
    
    // EditButtons at EditLivingExpensesIncidentPopup.pcf: line 29, column 23
