...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/AvailableToRunInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AvailableToRunInputSetExpressions {
  ...
  public static class AvailableToRunInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on BooleanRadioInput (id=Value_Input) at AvailableToRunInputSet.pcf: line 14, column 43
    ...
    // 'value' attribute on TextInput (id=Note_Input) at AvailableToRunInputSet.pcf: line 20, column 45
    ...
    // 'visible' attribute on TextInput (id=Note_Input) at AvailableToRunInputSet.pcf: line 20, column 45
