...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotPolicyLocationPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyLocationPopupExpressions {
  ...
  public static class ClaimSnapshotPolicyLocationPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=ItemDescription_Cell) at ClaimSnapshotPolicyLocationPopup.pcf: line 79, column 50
    function sortValue_16 (PropertyItem :  dynamic.Dynamic) : java.lang.Object {
      return PropertyItem.Description
    }
    
    // 'value' attribute on TextCell (id=ItemValue_Cell) at ClaimSnapshotPolicyLocationPopup.pcf: line 85, column 50
    function sortValue_17 (PropertyItem :  dynamic.Dynamic) : java.lang.Object {
      return PropertyItem.AppraisedValue
    }
    
    // 'value' attribute on TextCell (id=Lienholder_Cell) at ClaimSnapshotPolicyLocationPopup.pcf: line 51, column 82
    ...
    // 'value' attribute on TextCell (id=OwnerType_Cell) at ClaimSnapshotPolicyLocationPopup.pcf: line 55, column 81
    ...
    // 'value' attribute on TextInput (id=LocationNumber_Input) at ClaimSnapshotPolicyLocationPopup.pcf: line 23, column 42
    function valueRoot_1 () : java.lang.Object {
      return PolicyLocation
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at ClaimSnapshotPolicyLocationPopup.pcf: line 31, column 42
