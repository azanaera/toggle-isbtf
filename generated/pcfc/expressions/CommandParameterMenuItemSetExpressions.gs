...
class CommandParameterMenuItemSetExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends CommandParameterMenuItemSetExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=modeItem) at CommandParameterMenuItemSet.pcf: line 22, column 54
    function action_2 () : void {
      parameterHolder.Mode = mode
    }
    
    // 'icon' attribute on MenuItem (id=modeItem) at CommandParameterMenuItemSet.pcf: line 22, column 54
    function icon_4 () : java.lang.String {
      return parameterHolder.getIconForCurrentlySelectedMenuItem(mode)
    }
    
    // 'label' attribute on MenuItem (id=modeItem) at CommandParameterMenuItemSet.pcf: line 22, column 54
    function label_3 () : java.lang.Object {
      return parameterHolder.getMenuItemDisplayForMode(mode)
    }
    
    // 'visible' attribute on MenuItem (id=modeItem) at CommandParameterMenuItemSet.pcf: line 22, column 54
