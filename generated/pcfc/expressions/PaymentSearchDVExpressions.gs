...
@javax.annotation.processing.Generated("config/web/pcf/search/checks/PaymentSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PaymentSearchDVExpressions {
  ...
  public static class PaymentSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at PaymentSearchDV.pcf: line 13, column 69
    function def_onEnter_0 (def :  pcf.PaymentSearchRequiredInputSet) : void {
      def.onEnter(PaymentSearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at PaymentSearchDV.pcf: line 17, column 69
    function def_onEnter_2 (def :  pcf.PaymentSearchOptionalInputSet) : void {
      def.onEnter(PaymentSearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at PaymentSearchDV.pcf: line 21, column 41
