...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotPolicyStatCodes800LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyStatCodes800LVExpressions {
  ...
  public static class ClaimSnapshotPolicyStatCodes800LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=LineNumber_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 23, column 40
    function sortValue_0 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.LineNumber
    }
    
    // 'value' attribute on TextCell (id=InsuranceLine_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 28, column 40
    function sortValue_1 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.InsuranceLine
    }
    
    // 'value' attribute on TextCell (id=InsuranceSubline_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 33, column 40
    function sortValue_2 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.InsuranceSubline
    }
    
    // 'value' attribute on TextCell (id=LocationNumber_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 38, column 40
    function sortValue_3 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.LocationNumber
    }
    
    // 'value' attribute on TextCell (id=BuildingNumber_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 43, column 40
    function sortValue_4 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.BuildingNumber
    }
    
    // 'value' attribute on TextCell (id=VehicleNumber_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 48, column 40
    function sortValue_5 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.VehicleNumber
    }
    
    // 'value' attribute on TextCell (id=ClassCode_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 53, column 40
    function sortValue_6 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.ClassCode
    }
    
    // 'value' attribute on TextCell (id=MajorPeril_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 58, column 40
    function sortValue_7 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.MajorPeril
    }
    
    // 'value' attribute on TextCell (id=State_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 63, column 40
    function sortValue_8 (StatCode :  dynamic.Dynamic) : java.lang.Object {
      return StatCode.State
    }
    
    // 'value' attribute on TextCell (id=Notes_Cell) at ClaimSnapshotPolicyStatCodes800LV.pcf: line 68, column 40
