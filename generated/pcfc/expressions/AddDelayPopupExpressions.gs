...
class AddDelayPopupExpressions {
  ...
  public static class AddDelayPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=ReasonForAddingDelay_Input) at AddDelayPopup.pcf: line 56, column 34
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      delayReason = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on DateInput (id=ExpectedCompletionDate_Input) at AddDelayPopup.pcf: line 50, column 48
    ...
    // 'label' attribute on DateInput (id=ExpectedCompletionDate_Input) at AddDelayPopup.pcf: line 50, column 48
    ...
    // 'validationExpression' attribute on DateInput (id=ExpectedCompletionDate_Input) at AddDelayPopup.pcf: line 50, column 48
