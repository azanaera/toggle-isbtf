...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/SyncStatusLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class SyncStatusLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends SyncStatusLVExpressionsImpl {
    ...
    // 'action' attribute on Link (id=ClaimSyncIcon_red) at SyncStatusLV.pcf: line 55, column 72
    function action_11 () : void {
      
    }
    
    // 'action' attribute on Link (id=ClaimSyncIcon_green) at SyncStatusLV.pcf: line 41, column 70
    function action_7 () : void {
      
    }
    
    // 'action' attribute on Link (id=ClaimSyncIcon_yellow) at SyncStatusLV.pcf: line 48, column 120
    function action_9 () : void {
      
    }
    
    // 'value' attribute on TextCell (id=Destination_Cell) at SyncStatusLV.pcf: line 30, column 65
    function valueRoot_4 () : java.lang.Object {
      return DestinationMessageStatistics
    }
    
    // 'value' attribute on TextCell (id=Unsent_Cell) at SyncStatusLV.pcf: line 61, column 42
    function value_12 () : java.lang.Integer {
      return DestinationMessageStatistics.TotalUnsent
    }
    
    // 'value' attribute on TextCell (id=Error_Cell) at SyncStatusLV.pcf: line 65, column 97
    ...
    // 'visible' attribute on Link (id=ClaimSyncIcon_red) at SyncStatusLV.pcf: line 55, column 72
    function visible_10 () : java.lang.Boolean {
      return DestinationMessageStatistics.TotalFailed > 0
    }
    
    // 'visible' attribute on Link (id=ClaimSyncIcon_green) at SyncStatusLV.pcf: line 41, column 70
    function visible_6 () : java.lang.Boolean {
      return DestinationMessageStatistics.TotalUnsent == 0
    }
    
    // 'visible' attribute on Link (id=ClaimSyncIcon_yellow) at SyncStatusLV.pcf: line 48, column 120
