...
@javax.annotation.processing.Generated("config/web/pcf/admin/workload/conditions/ExposureConditionsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ExposureConditionsLVExpressions {
  ...
  public static class ExposureConditionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeCell (id=CoverageType_Cell) at ExposureConditionsLV.pcf: line 29, column 44
    function sortValue_0 (exposure :  entity.ExposureConditionFilter) : java.lang.Object {
      return exposure.CoverageType
    }
    
    // 'value' attribute on TypeKeyCell (id=CoverageSubtype_Cell) at ExposureConditionsLV.pcf: line 39, column 47
    function sortValue_1 (exposure :  entity.ExposureConditionFilter) : java.lang.Object {
      return exposure.CoverageSubType
    }
    
    // 'value' attribute on TypeKeyCell (id=LossPartyType_Cell) at ExposureConditionsLV.pcf: line 50, column 46
  ...
  public static class IteratorEntryExpressionsImpl extends ExposureConditionsLVExpressionsImpl {
    ...
    // 'onChange' attribute on PostOnChange at ExposureConditionsLV.pcf: line 42, column 133
    ...
    // 'valueRange' attribute on RangeCell (id=CoverageType_Cell) at ExposureConditionsLV.pcf: line 29, column 44
