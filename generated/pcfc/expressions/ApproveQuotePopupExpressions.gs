...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/ApproveQuotePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ApproveQuotePopupExpressions {
  ...
  public static class ApproveQuotePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=RequestedServiceCompletionDate_Input) at ApproveQuotePopup.pcf: line 33, column 53
    ...
    // 'validationExpression' attribute on DateInput (id=RequestedServiceCompletionDate_Input) at ApproveQuotePopup.pcf: line 33, column 53
