...
@javax.annotation.processing.Generated("config/web/pcf/desktop/queues/DesktopQueuedActivities.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DesktopQueuedActivitiesExpressions {
  ...
  public static class DesktopQueuedActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=DesktopQueuedActivities_AssignNextButton) at DesktopQueuedActivities.pcf: line 62, column 73
    function action_16 () : void {
      gw.api.desktop.DesktopQueuedActivitiesUtil.assignNextQueuedActivityToMe()
    }
    
    // 'action' attribute on ToolbarButton (id=DesktopQueuedActivities_AssignNextButton2) at DesktopQueuedActivities.pcf: line 68, column 74
    function action_19 () : void {
      gw.api.desktop.DesktopQueuedActivitiesUtil.assignNextQueuedActivityToMe()
    }
    
    // 'action' attribute on ToolbarButton (id=DesktopQueuedActivities_RefreshButton) at DesktopQueuedActivities.pcf: line 73, column 63
    function action_20 () : void {
      gw.api.desktop.DesktopQueuedActivitiesUtil.refresh()
    }
    
    // 'action' attribute on ToolbarButton (id=DesktopQueuedActivities_PrintButton) at DesktopQueuedActivities.pcf: line 80, column 25
    function action_22 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopQueuedActivities_AssignSelectedButton) at DesktopQueuedActivities.pcf: line 46, column 50
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopQueuedActivities_AssignButton) at DesktopQueuedActivities.pcf: line 54, column 50
    ...
    // 'available' attribute on ToolbarButton (id=DesktopQueuedActivities_AssignNextButton) at DesktopQueuedActivities.pcf: line 62, column 73
    function available_14 () : java.lang.Boolean {
      return !gw.api.desktop.DesktopQueuedActivitiesUtil.isSelectedQueueEmpty()
    }
    
    // 'available' attribute on ToolbarButton (id=DesktopQueuedActivities_PrintButton) at DesktopQueuedActivities.pcf: line 80, column 25
    ...
    // 'def' attribute on PanelRef at DesktopQueuedActivities.pcf: line 83, column 118
    ...
    // 'value' attribute on ToolbarRangeInput (id=AvailableQueues_Input) at DesktopQueuedActivities.pcf: line 36, column 46
    ...
    // 'onChange' attribute on PostOnChange at DesktopQueuedActivities.pcf: line 38, column 102
    function onChange_2 () : void {
      gw.api.desktop.DesktopQueuedActivitiesUtil.setSelectedQueue( selectedQueue )
    }
    
    // 'optionLabel' attribute on ToolbarRangeInput (id=AvailableQueues_Input) at DesktopQueuedActivities.pcf: line 36, column 46
    function optionLabel_5 (VALUE :  entity.AssignableQueue) : java.lang.String {
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=AvailableQueues_Input) at DesktopQueuedActivities.pcf: line 36, column 46
    ...
    // 'valueRange' attribute on ToolbarRangeInput (id=AvailableQueues_Input) at DesktopQueuedActivities.pcf: line 36, column 46
    function verifyValueRangeIsAllowedType_7 ($$arg :  entity.AssignableQueue[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on ToolbarRangeInput (id=AvailableQueues_Input) at DesktopQueuedActivities.pcf: line 36, column 46
    function verifyValueRangeIsAllowedType_7 ($$arg :  gw.api.database.IQueryBeanResult<entity.AssignableQueue>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on CheckedValuesToolbarButton (id=DesktopQueuedActivities_AssignSelectedButton) at DesktopQueuedActivities.pcf: line 46, column 50
    function visible_10 () : java.lang.Boolean {
      return perm.Activity.pickfromqueue
    }
    
    // 'visible' attribute on ToolbarButton (id=DesktopQueuedActivities_AssignNextButton) at DesktopQueuedActivities.pcf: line 62, column 73
    function visible_15 () : java.lang.Boolean {
      return  hasPickPermission and perm.Activity.nextfromqueue
    }
    
    // 'visible' attribute on ToolbarButton (id=DesktopQueuedActivities_AssignNextButton2) at DesktopQueuedActivities.pcf: line 68, column 74
