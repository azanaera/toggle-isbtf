...
@javax.annotation.processing.Generated("config/web/pcf/workspace/financials/DuplicateCheckResultsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DuplicateCheckResultsLVExpressions {
  ...
  public static class DuplicateCheckResultsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=PayTo_Cell) at DuplicateCheckResultsLV.pcf: line 21, column 32
    function sortValue_0 (Check :  entity.Check) : java.lang.Object {
      return Check.PayTo
    }
    
    // 'value' attribute on TextCell (id=MailingAddress_Cell) at DuplicateCheckResultsLV.pcf: line 25, column 54
    function sortValue_1 (Check :  entity.Check) : java.lang.Object {
      return Check.FormatAddressSummary(false)
    }
    
    // 'value' attribute on DateCell (id=ScheduledSendDate_Cell) at DuplicateCheckResultsLV.pcf: line 29, column 44
    function sortValue_2 (Check :  entity.Check) : java.lang.Object {
      return Check.ScheduledSendDate
    }
    
    // 'value' attribute on TypeKeyCell (id=Status_Cell) at DuplicateCheckResultsLV.pcf: line 34, column 50
    function sortValue_3 (Check :  entity.Check) : java.lang.Object {
      return Check.Status
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at DuplicateCheckResultsLV.pcf: line 39, column 61
