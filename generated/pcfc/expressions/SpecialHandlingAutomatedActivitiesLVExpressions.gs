...
@javax.annotation.processing.Generated("config/web/pcf/admin/specialhandling/SpecialHandlingAutomatedActivitiesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class SpecialHandlingAutomatedActivitiesLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends SpecialHandlingAutomatedActivitiesLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Event_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 45, column 52
    ...
    // 'outputConversion' attribute on TextCell (id=PolicyType_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 53, column 43
    function outputConversion_15 (VALUE :  typekey.PolicyType) : java.lang.String {
      return convertPolicyTypeForOutput(VALUE)
    }
    
    // 'outputConversion' attribute on TextCell (id=ActivityPattern_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 60, column 47
    function outputConversion_19 (VALUE :  entity.ActivityPattern) : java.lang.String {
      return VALUE.Subject
    }
    
    // 'value' attribute on TextCell (id=PolicyType_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 53, column 43
    function valueRoot_17 () : java.lang.Object {
      return automatedActivity
    }
    
    // 'value' attribute on TextCell (id=Type_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 39, column 51
    function valueRoot_8 () : java.lang.Object {
      return automatedActivity.Trigger
    }
    
    // 'value' attribute on TextCell (id=Event_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 45, column 52
    ...
    // 'value' attribute on TextCell (id=ActivityPattern_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 60, column 47
    function value_20 () : entity.ActivityPattern {
      return automatedActivity.ActivityPattern
    }
    
    // 'value' attribute on TextCell (id=EmailTemplate_Cell) at SpecialHandlingAutomatedActivitiesLV.pcf: line 64, column 82
