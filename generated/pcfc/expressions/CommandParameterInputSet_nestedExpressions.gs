...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/CommandParameterInputSet.nested.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CommandParameterInputSet_nestedExpressions {
  ...
  public static class CommandParameterInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_7 (def :  pcf.CommandParameterMenuItemSet) : void {
      def.onEnter(parameterHolder)
    }
    
    // 'def' attribute on MenuItemSetRef at CommandParameterInputSet.nested.pcf: line 41, column 61
    function def_refreshVariables_8 (def :  pcf.CommandParameterMenuItemSet) : void {
    ...
    // 'value' attribute on TextInput (id=NestedText_Input) at CommandParameterInputSet.nested.pcf: line 39, column 47
    ...
    // 'visible' attribute on TextInput (id=NestedText_Input) at CommandParameterInputSet.nested.pcf: line 39, column 47
