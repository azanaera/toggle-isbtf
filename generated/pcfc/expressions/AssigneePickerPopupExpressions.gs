...
@javax.annotation.processing.Generated("config/web/pcf/shared/assignment/AssigneePickerPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AssigneePickerPopupExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends AssigneePickerPopupExpressionsImpl {
    ...
    // 'def' attribute on PanelRef at AssigneePickerPopup.pcf: line 33, column 254
    function def_onEnter_1 (def :  pcf.AssignmentSearchDV) : void {
      def.onEnter(new gw.api.assignment.AlwaysFromSearchAssignmentSelectionType(), gw.api.upgrade.Coercions.makeArray<typekey.AssignmentSearchType>(AssigneePicker.AllowedAssignmentSearchTypes), SearchCriteria, PageHelper, Claim)
    }
    ...
    function def_refreshVariables_2 (def :  pcf.AssignmentSearchDV) : void {
      def.refreshVariables(new gw.api.assignment.AlwaysFromSearchAssignmentSelectionType(), gw.api.upgrade.Coercions.makeArray<typekey.AssignmentSearchType>(AssigneePicker.AllowedAssignmentSearchTypes), SearchCriteria, PageHelper, Claim)
    }
