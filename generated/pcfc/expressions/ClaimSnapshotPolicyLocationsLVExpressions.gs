...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotPolicyLocationsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyLocationsLVExpressions {
  ...
  public static class ClaimSnapshotPolicyLocationsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Location_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 31, column 40
    function sortValue_1 (PolicyLocation :  dynamic.Dynamic) : java.lang.Object {
      return PolicyLocation.LocationNumber
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 36, column 40
    function sortValue_2 (PolicyLocation :  dynamic.Dynamic) : java.lang.Object {
      return PolicyLocation.Address.Description
    }
    
    // 'value' attribute on TextCell (id=Address_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 41, column 70
    ...
    // 'value' attribute on TextCell (id=Lienholders_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 46, column 75
    ...
    // 'value' attribute on TextCell (id=HighValueItems_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 50, column 51
    ...
    // 'visible' attribute on TextCell (id=Lienholders_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 46, column 75
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotPolicyLocationsLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Address_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 41, column 70
    function action_15 () : void {
      ClaimSnapshotPolicyLocationPopup.push(Claim, PolicyLocation)
    }
    
    // 'action' attribute on TextCell (id=Location_Cell) at ClaimSnapshotPolicyLocationsLV.pcf: line 31, column 40
