...
@javax.annotation.processing.Generated("config/web/pcf/admin/customerservicetiers/CustomerServiceTierDetailScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CustomerServiceTierDetailScreenExpressions {
  ...
  public static class CustomerServiceTierDetailScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=Code_Input) at CustomerServiceTierDetailScreen.pcf: line 40, column 57
    ...
    // 'valueRange' attribute on RangeInput (id=Code_Input) at CustomerServiceTierDetailScreen.pcf: line 40, column 57
    function valueRange_7 () : java.lang.Object {
      return availableServiceTiers
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at CustomerServiceTierDetailScreen.pcf: line 47, column 94
    ...
    // 'valueRange' attribute on RangeInput (id=Code_Input) at CustomerServiceTierDetailScreen.pcf: line 40, column 57
    function verifyValueRangeIsAllowedType_8 ($$arg :  typekey.CustomerServiceTier[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
  ...
  public static class IteratorEntry2ExpressionsImpl extends CustomerServiceTierDetailScreenExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=AutomatedActivitiesAddClaimIndicatorHandler) at CustomerServiceTierDetailScreen.pcf: line 113, column 140
    ...
    // 'label' attribute on MenuItem (id=AutomatedActivitiesAddClaimIndicatorHandler) at CustomerServiceTierDetailScreen.pcf: line 113, column 140
    function label_26 () : java.lang.Object {
      return gw.api.specialhandling.SpecialHandlingHelper.getServiceTierAutomatedActivitiesAddLabel(automatedHandlerSubtype)
    }
  ...
  public static class IteratorEntryExpressionsImpl extends CustomerServiceTierDetailScreenExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=AutomatedNotificationsAddClaimIndicatorHandler) at CustomerServiceTierDetailScreen.pcf: line 83, column 143
    ...
    // 'label' attribute on MenuItem (id=AutomatedNotificationsAddClaimIndicatorHandler) at CustomerServiceTierDetailScreen.pcf: line 83, column 143
    function label_18 () : java.lang.Object {
      return gw.api.specialhandling.SpecialHandlingHelper.getServiceTierAutomatedNotificationsAddLabel(automatedHandlerSubtype)
    }
