...
@javax.annotation.processing.Generated("config/web/pcf/shared/question/QuestionRowSet.BooleanCheckbox.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class QuestionRowSet_BooleanCheckboxExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends QuestionRowSetExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=subQuestionText_Cell) at QuestionRowSet.BooleanCheckbox.pcf: line 40, column 37
  ...
  public static class QuestionRowSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on CheckBoxCell (id=questionBooleanAnswerCheckbox_Cell) at QuestionRowSet.BooleanCheckbox.pcf: line 25, column 78
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      AnswerSetContainer.getOrCreateAnswer(Question).BooleanAnswer = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'editable' attribute on CheckBoxCell (id=questionBooleanAnswerCheckbox_Cell) at QuestionRowSet.BooleanCheckbox.pcf: line 25, column 78
    function editable_3 () : java.lang.Boolean {
      return !Question.isRetired()
    }
    
    // 'validationLabel' attribute on CheckBoxCell (id=questionBooleanAnswerCheckbox_Cell) at QuestionRowSet.BooleanCheckbox.pcf: line 25, column 78
    function label_4 () : java.lang.Object {
      return Question.Text
    }
    
    // 'required' attribute on CheckBoxCell (id=questionBooleanAnswerCheckbox_Cell) at QuestionRowSet.BooleanCheckbox.pcf: line 25, column 78
    function required_5 () : java.lang.Boolean {
      return Question.Required
    }
    
    // 'value' attribute on TextCell (id=questionText_Cell) at QuestionRowSet.BooleanCheckbox.pcf: line 19, column 22
    ...
    // 'value' attribute on RowIterator at QuestionRowSet.BooleanCheckbox.pcf: line 34, column 40
