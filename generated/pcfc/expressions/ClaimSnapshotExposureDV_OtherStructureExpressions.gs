...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.OtherStructure.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotExposureDV_OtherStructureExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.OtherStructure.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotExposureDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextInput (id=Other_Structure_Incident_Input) at ClaimSnapshotExposureDV.OtherStructure.pcf: line 27, column 38
    function action_8 () : void {
      ClaimSnapshotOtherStructureIncidentPopup.push(Claim, Exposure.OtherStructureIncident)
    }
    
    // 'action' attribute on TextInput (id=Other_Structure_Incident_Input) at ClaimSnapshotExposureDV.OtherStructure.pcf: line 27, column 38
    function action_dest_9 () : pcf.api.Destination {
      return pcf.ClaimSnapshotOtherStructureIncidentPopup.createDestination(Claim, Exposure.OtherStructureIncident)
    }
    
    // 'def' attribute on InputSetRef at ClaimSnapshotExposureDV.OtherStructure.pcf: line 17, column 37
    function def_onEnter_0 (def :  pcf.ClaimSnapshotExposureDetailInputSet_600) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at ClaimSnapshotExposureDV.OtherStructure.pcf: line 30, column 37
    ...
    // 'def' attribute on InputSetRef at ClaimSnapshotExposureDV.OtherStructure.pcf: line 35, column 37
    ...
    // 'value' attribute on TextInput (id=Other_Structure_Incident_Input) at ClaimSnapshotExposureDV.OtherStructure.pcf: line 27, column 38
