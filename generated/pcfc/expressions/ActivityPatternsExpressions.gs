...
@javax.annotation.processing.Generated("config/web/pcf/admin/businesssettings/ActivityPatterns.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ActivityPatternsExpressions {
  ...
  public static class ActivityPatternsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=ActivityPatterns_NewActivityPatternButton) at ActivityPatterns.pcf: line 26, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=ActivityPatterns_DeleteButton) at ActivityPatterns.pcf: line 33, column 62
    ...
    // 'available' attribute on ToolbarButton (id=ActivityPatterns_NewActivityPatternButton) at ActivityPatterns.pcf: line 26, column 25
    ...
    // 'available' attribute on CheckedValuesToolbarButton (id=ActivityPatterns_DeleteButton) at ActivityPatterns.pcf: line 33, column 62
    ...
    // 'def' attribute on PanelRef at ActivityPatterns.pcf: line 36, column 45
