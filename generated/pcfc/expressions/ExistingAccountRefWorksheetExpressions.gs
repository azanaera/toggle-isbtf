...
@javax.annotation.processing.Generated("config/web/pcf/admin/accounts/ExistingAccountRefWorksheet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ExistingAccountRefWorksheetExpressions {
  ...
  public static class ExistingAccountRefWorksheetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=PolicyNumber_Cell) at ExistingAccountRefWorksheet.pcf: line 38, column 44
    function sortValue_2 (policy :  entity.Policy) : java.lang.Object {
      return policy.PolicyNumber
    }
    
    // 'value' attribute on TextCell (id=InsuredName_Cell) at ExistingAccountRefWorksheet.pcf: line 43, column 43
    function sortValue_3 (policy :  entity.Policy) : java.lang.Object {
      return policy.insured
    }
    
    // 'value' attribute on DateCell (id=EffectiveDate_Cell) at ExistingAccountRefWorksheet.pcf: line 47, column 45
    function sortValue_4 (policy :  entity.Policy) : java.lang.Object {
      return policy.EffectiveDate
    }
    
    // 'value' attribute on DateCell (id=ExpirationDate_Cell) at ExistingAccountRefWorksheet.pcf: line 51, column 46
    function sortValue_5 (policy :  entity.Policy) : java.lang.Object {
      return policy.ExpirationDate
    }
    
    // 'value' attribute on TypeKeyCell (id=PolicyType_Cell) at ExistingAccountRefWorksheet.pcf: line 56, column 47
