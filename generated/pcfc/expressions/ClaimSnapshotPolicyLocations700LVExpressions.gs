...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/700/ClaimSnapshotPolicyLocations700LV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyLocations700LVExpressions {
  ...
  public static class ClaimSnapshotPolicyLocations700LVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Location_Cell) at ClaimSnapshotPolicyLocations700LV.pcf: line 31, column 40
    function sortValue_1 (PolicyLocation :  dynamic.Dynamic) : java.lang.Object {
      return PolicyLocation.LocationNumber
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at ClaimSnapshotPolicyLocations700LV.pcf: line 36, column 40
    function sortValue_2 (PolicyLocation :  dynamic.Dynamic) : java.lang.Object {
      return PolicyLocation.Address.Description
    }
    
    // 'value' attribute on TextCell (id=Address_Cell) at ClaimSnapshotPolicyLocations700LV.pcf: line 40, column 70
    ...
    // 'value' attribute on TextCell (id=Lienholders_Cell) at ClaimSnapshotPolicyLocations700LV.pcf: line 44, column 86
    ...
    // 'value' attribute on TextCell (id=HighValueItems_Cell) at ClaimSnapshotPolicyLocations700LV.pcf: line 48, column 51
  ...
  public static class IteratorEntryExpressionsImpl extends ClaimSnapshotPolicyLocations700LVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=Location_Cell) at ClaimSnapshotPolicyLocations700LV.pcf: line 31, column 40
