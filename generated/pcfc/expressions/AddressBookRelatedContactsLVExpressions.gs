...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookRelatedContactsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookRelatedContactsLVExpressions {
  ...
  public static class AddressBookRelatedContactsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'sortBy' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookRelatedContactsLV.pcf: line 45, column 107
    ...
    // 'value' attribute on RangeCell (id=Rel_Cell) at AddressBookRelatedContactsLV.pcf: line 57, column 46
  ...
  public static class IteratorEntryExpressionsImpl extends AddressBookRelatedContactsLVExpressionsImpl {
    ...
    // 'actionEnabled' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookContactWidget.xml: line 10, column 154
    function actionEnabled_13 () : java.lang.Boolean {
      return new util.lvwrapper.ContactContactLVWrapper(contactContact, primaryContact).OtherContact != null
    }
    
    // 'action' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookContactWidget.xml: line 12, column 225
    ...
    // 'action' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookContactWidget.xml: line 14, column 151
    function action_8 () : void {
      new util.lvwrapper.ContactContactLVWrapper(contactContact, primaryContact).setNoneSelected()
    }
    
    // 'action' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookContactWidget.xml: line 10, column 154
    ...
    // 'value' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookContactWidget.xml: line 10, column 154
    ...
    // 'valueRange' attribute on RangeCell (id=Rel_Cell) at AddressBookRelatedContactsLV.pcf: line 57, column 46
    ...
    // 'valueRange' attribute on RangeCell (id=Rel_Cell) at AddressBookRelatedContactsLV.pcf: line 57, column 46
    function verifyValueRangeIsAllowedType_19 ($$arg :  typekey.ContactBidiRel[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on AddressBookContactCell (id=Contact_Cell) at AddressBookContactWidget.xml: line 12, column 225
