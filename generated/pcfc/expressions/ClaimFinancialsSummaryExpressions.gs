...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/summary/ClaimFinancialsSummary.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimFinancialsSummaryExpressions {
  ...
  public static class ClaimFinancialsSummaryExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'canVisit' attribute on Page (id=ClaimFinancialsSummary) at ClaimFinancialsSummary.pcf: line 9, column 80
    ...
    // 'value' attribute on ToolbarRangeInput (id=floatingFinancialsInputWidget_Input) at ClaimFinancialsSummary.pcf: line 64, column 123
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      useFloatingFinancials = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on ToolbarRangeInput (id=FinancialsSummaryRangeInput_Input) at ClaimFinancialsSummary.pcf: line 49, column 42
    ...
    // 'onChange' attribute on PostOnChange at ClaimFinancialsSummary.pcf: line 67, column 106
    function onChange_11 () : void {
      financialSummaryBridge.changeFilterOption(filterOption, useFloatingFinancials)
    }
    
    // 'onChange' attribute on PostOnChange at ClaimFinancialsSummary.pcf: line 52, column 188
    ...
    // 'optionLabel' attribute on ToolbarRangeInput (id=floatingFinancialsInputWidget_Input) at ClaimFinancialsSummary.pcf: line 64, column 123
    function optionLabel_15 (VALUE :  java.lang.Boolean) : java.lang.String {
      return getViewAmountsOptionLabel(VALUE)
    }
    
    // 'optionLabel' attribute on ToolbarRangeInput (id=FinancialsSummaryRangeInput_Input) at ClaimFinancialsSummary.pcf: line 49, column 42
    function optionLabel_6 (VALUE :  java.lang.String) : java.lang.String {
      return getFilterOptionLabel(VALUE)
    }
    
    // Page (id=ClaimFinancialsSummary) at ClaimFinancialsSummary.pcf: line 9, column 80
    static function parent_37 (Claim :  Claim) : pcf.api.Destination {
      return pcf.ClaimFinancialsGroup.createDestination(Claim)
    }
    
    // 'valueRange' attribute on ToolbarRangeInput (id=floatingFinancialsInputWidget_Input) at ClaimFinancialsSummary.pcf: line 64, column 123
    function valueRange_16 () : java.lang.Object {
      return {false, true}
    }
    
    // 'valueRange' attribute on ToolbarRangeInput (id=FinancialsSummaryRangeInput_Input) at ClaimFinancialsSummary.pcf: line 49, column 42
    ...
    // 'visible' attribute on ToolbarRangeInput (id=floatingFinancialsInputWidget_Input) at ClaimFinancialsSummary.pcf: line 64, column 123
