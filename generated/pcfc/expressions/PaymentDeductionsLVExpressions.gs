...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/checks/PaymentDeductionsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PaymentDeductionsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PaymentDeductionsLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=DeductionType_Cell) at PaymentDeductionsLV.pcf: line 22, column 46
    function valueRoot_6 () : java.lang.Object {
      return Deduction
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at PaymentDeductionsLV.pcf: line 33, column 61
    ...
    // 'value' attribute on TextCell (id=Comments_Cell) at PaymentDeductionsLV.pcf: line 26, column 39
  ...
  public static class PaymentDeductionsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // '$$sumValue' attribute on RowIterator at PaymentDeductionsLV.pcf: line 33, column 61
    function sumValueRoot_4 (Deduction :  entity.Deduction) : java.lang.Object {
      return Deduction
    }
    
    // 'footerSumValue' attribute on RowIterator at PaymentDeductionsLV.pcf: line 33, column 61
