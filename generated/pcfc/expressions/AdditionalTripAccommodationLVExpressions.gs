...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/AdditionalTripAccommodationLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AdditionalTripAccommodationLVExpressions {
  ...
  public static class AdditionalTripAccommodationLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=AddnlTripAccommodation_DisplayName_Cell) at AdditionalTripAccommodationLV.pcf: line 45, column 57
    ...
    // 'value' attribute on TypeKeyCell (id=AddnlTripSegment_Assessment_Cell) at AdditionalTripAccommodationLV.pcf: line 51, column 49
    ...
    // 'value' attribute on CurrencyCell (id=AddnlTripSegment_TotalIncurred_Cell) at AdditionalTripAccommodationLV.pcf: line 56, column 93
    ...
    // 'value' attribute on TextCell (id=ReasonForDenial_Cell) at AdditionalTripAccommodationLV.pcf: line 64, column 89
  ...
  public static class IteratorEntryExpressionsImpl extends AdditionalTripAccommodationLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=AddnlTripAccommodation_DisplayName_Cell) at AdditionalTripAccommodationLV.pcf: line 45, column 57
    ...
    // 'available' attribute on TextCell (id=ReasonForDenial_Cell) at AdditionalTripAccommodationLV.pcf: line 64, column 89
    ...
    // 'editable' attribute on TextCell (id=ReasonForDenial_Cell) at AdditionalTripAccommodationLV.pcf: line 64, column 89
