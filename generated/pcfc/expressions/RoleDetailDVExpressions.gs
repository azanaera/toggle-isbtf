...
@javax.annotation.processing.Generated("config/web/pcf/admin/roles/RoleDetailDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RoleDetailDVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends RoleDetailDVExpressionsImpl {
    ...
    // 'value' attribute on RangeCell (id=Permission_Cell) at RoleDetailDV.pcf: line 61, column 58
    function defaultSetter_16 (__VALUE_TO_SET :  java.lang.Object) : void {
      rolePrivilege.Permission = (__VALUE_TO_SET as typekey.SystemPermissionType)
    }
    
    // 'editable' attribute on RangeCell (id=Permission_Cell) at RoleDetailDV.pcf: line 61, column 58
    function editable_14 () : java.lang.Boolean {
      return perm.RolePrivilege.edit
    }
    
    // 'valueRange' attribute on RangeCell (id=Permission_Cell) at RoleDetailDV.pcf: line 61, column 58
    ...
    // 'value' attribute on TextCell (id=Code_Cell) at RoleDetailDV.pcf: line 68, column 56
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at RoleDetailDV.pcf: line 72, column 63
    ...
    // 'valueRange' attribute on RangeCell (id=Permission_Cell) at RoleDetailDV.pcf: line 61, column 58
    function verifyValueRangeIsAllowedType_19 ($$arg :  typekey.SystemPermissionType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
  ...
  public static class RoleDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Name_Input) at RoleDetailDV.pcf: line 23, column 28
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      role.Name = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextAreaInput (id=Description_Input) at RoleDetailDV.pcf: line 29, column 35
    ...
    // 'sortBy' attribute on RangeCell (id=Permission_Cell) at RoleDetailDV.pcf: line 61, column 58
