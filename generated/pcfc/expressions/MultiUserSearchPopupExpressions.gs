...
@javax.annotation.processing.Generated("config/web/pcf/shared/usersearch/MultiUserSearchPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class MultiUserSearchPopupExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends MultiUserSearchPopupExpressionsImpl {
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=RetrieveRequested) at MultiUserSearchPopup.pcf: line 48, column 69
    ...
    // 'pickValue' attribute on CheckedValuesToolbarButton (id=MultiUserSearchPopup_SelectButton) at MultiUserSearchPopup.pcf: line 41, column 42
    ...
    // 'visible' attribute on CheckedValuesToolbarButton (id=RetrieveRequested) at MultiUserSearchPopup.pcf: line 48, column 69
