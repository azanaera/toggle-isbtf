...
class TeamGroupMattersExpressions {
  ...
  public static class TeamGroupMattersExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupMatters_Print) at TeamGroupMatters.pcf: line 41, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupMatters_Assign) at TeamGroupMatters.pcf: line 34, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupMatters_Print) at TeamGroupMatters.pcf: line 41, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupMatters.pcf: line 44, column 50
    ...
    // 'title' attribute on TitleBar at TeamGroupMatters.pcf: line 26, column 96
