...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/checks/PaymentTransferLineItemsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PaymentTransferLineItemsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends PaymentTransferLineItemsLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=LineCategory_Cell) at PaymentTransferLineItemsLV.pcf: line 24, column 45
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      TransactionLineItem.LineCategory = (__VALUE_TO_SET as typekey.LineCategory)
    }
    
    // 'editable' attribute on TypeKeyCell (id=LineCategory_Cell) at PaymentTransferLineItemsLV.pcf: line 24, column 45
    ...
    // 'filter' attribute on TypeKeyCell (id=LineCategory_Cell) at PaymentTransferLineItemsLV.pcf: line 24, column 45
    ...
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at PaymentTransferLineItemsLV.pcf: line 31, column 55
