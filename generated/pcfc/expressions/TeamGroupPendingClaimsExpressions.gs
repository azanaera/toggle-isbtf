...
@javax.annotation.processing.Generated("config/web/pcf/team/group/TeamGroupPendingClaims.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TeamGroupPendingClaimsExpressions {
  ...
  public static class TeamGroupPendingClaimsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupPendingClaims_Print) at TeamGroupPendingClaims.pcf: line 52, column 25
    function action_5 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupPendingClaims_Assign) at TeamGroupPendingClaims.pcf: line 39, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupPendingClaims_RemoveFlag) at TeamGroupPendingClaims.pcf: line 45, column 76
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupPendingClaims_Print) at TeamGroupPendingClaims.pcf: line 52, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupPendingClaims.pcf: line 55, column 116
