...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimReplacementServicesDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimReplacementServicesDVExpressions {
  ...
  public static class NewClaimReplacementServicesDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsBeginDate_Input) at NewClaimReplacementServicesDV.pcf: line 18, column 56
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CurrencyInput (id=LostWagesBenefits_MaxCompRate_Input) at NewClaimReplacementServicesDV.pcf: line 29, column 50
    function defaultSetter_11 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.MaxCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at NewClaimReplacementServicesDV.pcf: line 24, column 54
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.RSBenefits.BenefitsEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at NewClaimReplacementServicesDV.pcf: line 24, column 54
