...
@javax.annotation.processing.Generated("config/web/pcf/shared/question/QuestionRowSet.DateField.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class QuestionRowSet_DateFieldExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends QuestionRowSetExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=subQuestionText_Cell) at QuestionRowSet.DateField.pcf: line 41, column 37
  ...
  public static class QuestionRowSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=questionDateAnswer_Cell) at QuestionRowSet.DateField.pcf: line 26, column 75
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      AnswerSetContainer.getOrCreateAnswer(Question).DateAnswer = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'editable' attribute on DateCell (id=questionDateAnswer_Cell) at QuestionRowSet.DateField.pcf: line 26, column 75
    function editable_3 () : java.lang.Boolean {
      return !Question.isRetired()
    }
    
    // 'validationLabel' attribute on DateCell (id=questionDateAnswer_Cell) at QuestionRowSet.DateField.pcf: line 26, column 75
    function label_4 () : java.lang.Object {
      return Question.Text
    }
    
    // 'required' attribute on DateCell (id=questionDateAnswer_Cell) at QuestionRowSet.DateField.pcf: line 26, column 75
    function required_5 () : java.lang.Boolean {
      return Question.Required
    }
    
    // 'value' attribute on TextCell (id=questionText_Cell) at QuestionRowSet.DateField.pcf: line 19, column 22
    ...
    // 'value' attribute on RowIterator at QuestionRowSet.DateField.pcf: line 35, column 40
