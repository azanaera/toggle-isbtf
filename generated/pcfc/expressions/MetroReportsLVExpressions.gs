...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/metro/MetroReportsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class MetroReportsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends MetroReportsLVExpressionsImpl {
    ...
    // 'action' attribute on Link (id=MetroReportDocument) at MetroReportsLV.pcf: line 64, column 50
    function action_19 () : void {
      MetroReport.Document.downloadContent()
    }
    
    // 'action' attribute on Link (id=ReSubmit) at MetroReportsLV.pcf: line 75, column 38
    function action_23 () : void {
      MetroReport.Status = TC_NEW
    }
    
    // 'action' attribute on TypeKeyCell (id=MetroReportType_Cell) at MetroReportsLV.pcf: line 42, column 48
    ...
    // 'available' attribute on Link (id=MetroReportDocument) at MetroReportsLV.pcf: line 64, column 50
    function available_17 () : java.lang.Boolean {
      return documentsActionsHelper.isViewDocumentContentAvailable(MetroReport.Document)
    }
    
    // 'available' attribute on Link (id=ReSubmit) at MetroReportsLV.pcf: line 75, column 38
    ...
    // 'label' attribute on Link (id=MetroReportDocument) at MetroReportsLV.pcf: line 64, column 50
    function label_20 () : java.lang.Object {
      return MetroReport.Document.Name
    }
    
    // 'tooltip' attribute on Link (id=MetroReportDocument) at MetroReportsLV.pcf: line 64, column 50
    function tooltip_21 () : java.lang.String {
      return documentsActionsHelper.getViewDocumentContentTooltip(MetroReport.Document)
    }
    
    // 'value' attribute on TypeKeyCell (id=MetroReportType_Cell) at MetroReportsLV.pcf: line 42, column 48
    function valueRoot_9 () : java.lang.Object {
      return MetroReport
    }
    
    // 'value' attribute on TypeKeyCell (id=MetroReportStatus_Cell) at MetroReportsLV.pcf: line 48, column 50
    function value_11 () : typekey.MetroReportStatus {
      return MetroReport.Status
    }
    
    // 'value' attribute on DateCell (id=MetroReportOrderDate_Cell) at MetroReportsLV.pcf: line 53, column 41
    function value_14 () : java.util.Date {
      return MetroReport.SentDate
    }
    
    // 'value' attribute on TypeKeyCell (id=MetroReportType_Cell) at MetroReportsLV.pcf: line 42, column 48
    function value_8 () : typekey.MetroReportType {
      return MetroReport.MetroReportType
    }
    
    // 'visible' attribute on Link (id=MetroReportDocument) at MetroReportsLV.pcf: line 64, column 50
