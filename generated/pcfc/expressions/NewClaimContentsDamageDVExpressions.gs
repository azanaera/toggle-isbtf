...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimContentsDamageDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimContentsDamageDVExpressions {
  ...
  public static class NewClaimContentsDamageDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=Property_Contents_Incident_Input) at NewClaimContentsDamageDV.pcf: line 25, column 53
    function defaultSetter_9 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PropertyContentsIncident = (__VALUE_TO_SET as entity.PropertyContentsIncident)
    }
    
    // 'valueRange' attribute on RangeInput (id=Property_Contents_Incident_Input) at NewClaimContentsDamageDV.pcf: line 25, column 53
    ...
    // 'value' attribute on RangeInput (id=Property_Contents_Incident_Input) at NewClaimContentsDamageDV.pcf: line 25, column 53
    function value_8 () : entity.PropertyContentsIncident {
      return Exposure.PropertyContentsIncident
    }
    
    // 'valueRange' attribute on RangeInput (id=Property_Contents_Incident_Input) at NewClaimContentsDamageDV.pcf: line 25, column 53
    function verifyValueRangeIsAllowedType_12 ($$arg :  entity.PropertyContentsIncident[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeInput (id=Property_Contents_Incident_Input) at NewClaimContentsDamageDV.pcf: line 25, column 53
    function verifyValueRangeIsAllowedType_12 ($$arg :  gw.api.database.IQueryBeanResult<entity.PropertyContentsIncident>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
