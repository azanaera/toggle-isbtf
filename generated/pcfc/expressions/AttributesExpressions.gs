...
@javax.annotation.processing.Generated("config/web/pcf/admin/usersandsecurity/Attributes.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AttributesExpressions {
  ...
  public static class AttributesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Attributes_AddAttributeButton) at Attributes.pcf: line 22, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Attributes_DeleteButton) at Attributes.pcf: line 29, column 62
    ...
    // 'available' attribute on CheckedValuesToolbarButton (id=Attributes_DeleteButton) at Attributes.pcf: line 29, column 62
    ...
    // 'def' attribute on PanelRef at Attributes.pcf: line 32, column 41
