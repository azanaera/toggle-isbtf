...
class TeamUserActivitiesExpressions {
  ...
  public static class TeamUserActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamUserActivities_Print) at TeamUserActivities.pcf: line 48, column 25
    function action_5 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamUserActivities_Assign) at TeamUserActivities.pcf: line 41, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamUserActivities_Print) at TeamUserActivities.pcf: line 48, column 25
    ...
    // 'def' attribute on PanelRef at TeamUserActivities.pcf: line 51, column 130
    ...
    // 'title' attribute on TitleBar at TeamUserActivities.pcf: line 33, column 93
