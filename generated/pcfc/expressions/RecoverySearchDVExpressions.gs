...
@javax.annotation.processing.Generated("config/web/pcf/search/recoveries/RecoverySearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RecoverySearchDVExpressions {
  ...
  public static class RecoverySearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at RecoverySearchDV.pcf: line 13, column 71
    function def_onEnter_0 (def :  pcf.RecoverySearchRequiredInputSet) : void {
      def.onEnter(RecoverySearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at RecoverySearchDV.pcf: line 17, column 71
    function def_onEnter_2 (def :  pcf.RecoverySearchOptionalInputSet) : void {
      def.onEnter(RecoverySearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at RecoverySearchDV.pcf: line 21, column 41
