...
@javax.annotation.processing.Generated("config/web/pcf/address/GlobalAddressInputSet.PostCodeBeforeCity.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class GlobalAddressInputSet_PostCodeBeforeCityExpressions {
  ...
  public static class GlobalAddressInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on AddressAutoFillInput (id=PostalCode_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 87, column 87
    ...
    // 'action' attribute on AddressAutoFillInput (id=City_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 105, column 81
    ...
    function autoComplete_91 () : gw.api.contact.AutocompleteHandler {
      return cityhandler
    }
    
    // 'available' attribute on CheckBoxInput (id=CEDEX_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 117, column 82
    function available_110 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.CEDEX)
    }
    
    // 'available' attribute on TextInput (id=CEDEXBureau_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 129, column 128
    ...
    // 'available' attribute on AddressAutoFillInput (id=PostalCode_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 87, column 87
    ...
    // 'available' attribute on AddressAutoFillInput (id=City_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 105, column 81
    function available_92 () : java.lang.Boolean {
      return addressOwner.isAvailable(gw.api.address.AddressOwnerFieldId.CITY)
    }
    
    // 'value' attribute on CheckBoxInput (id=CEDEX_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 117, column 82
    ...
    // 'value' attribute on TextInput (id=CEDEXBureau_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 129, column 128
    ...
    // 'editable' attribute on CheckBoxInput (id=CEDEX_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 117, column 82
    function editable_111 () : java.lang.Boolean {
      return addressOwner.isEditable(gw.api.address.AddressOwnerFieldId.CEDEX)
    }
    
    // 'editable' attribute on TextInput (id=CEDEXBureau_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 129, column 128
    ...
    function inputMask_59 () : java.lang.String {
    ...
    // 'onChange' attribute on PostOnChange at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 120, column 113
    function onChange_109 () : void {
      if (not addressOwner.AddressDelegate.CEDEX) addressOwner.AddressDelegate.CEDEXBureau = null
    }
    
    // 'onChange' attribute on AddressAutoFillInput (id=PostalCode_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 90, column 171
    ...
    // 'onChange' attribute on AddressAutoFillInput (id=City_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 108, column 165
    ...
    // 'required' attribute on CheckBoxInput (id=CEDEX_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 117, column 82
    ...
    // 'required' attribute on TextInput (id=CEDEXBureau_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 129, column 128
    ...
    function required_87 () : java.lang.Boolean {
      return addressOwner.isRequired(gw.api.address.AddressOwnerFieldId.CITY)
    }
    
    // 'tooltip' attribute on AddressAutoFillInput (id=PostalCode_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 87, column 87
    ...
    // 'visible' attribute on CheckBoxInput (id=CEDEX_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 117, column 82
    function visible_112 () : java.lang.Boolean {
      return addressOwner.isVisible(gw.api.address.AddressOwnerFieldId.CEDEX)
    }
    
    // 'visible' attribute on TextInput (id=CEDEXBureau_Input) at GlobalAddressInputSet.PostCodeBeforeCity.pcf: line 129, column 128
