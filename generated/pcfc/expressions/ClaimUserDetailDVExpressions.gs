...
@javax.annotation.processing.Generated("config/web/pcf/claim/partiesinvolved/ClaimUserDetailDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimUserDetailDVExpressions {
  ...
  public static class ClaimUserDetailDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ClaimUserDetailDV.pcf: line 20, column 27
    function def_onEnter_0 (def :  pcf.ClaimUserAssignmentsLV) : void {
      def.onEnter(ClaimUserModel.BeansAssignedToUser)
    }
    
    // 'def' attribute on ListViewInput at ClaimUserDetailDV.pcf: line 29, column 81
    ...
    // 'validationExpression' attribute on ListViewInput at ClaimUserDetailDV.pcf: line 29, column 81
