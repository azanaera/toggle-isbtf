...
@javax.annotation.processing.Generated("config/web/pcf/dashboard/ClaimCountByOrgLevelLV.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimCountByOrgLevelLV_defaultExpressions {
  ...
  public static class ClaimCountByOrgLevelLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=ByOrgLevel_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 26, column 53
    function sortValue_0 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.Group.DisplayName
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_OpenExposures_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 32, column 42
    function sortValue_1 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.OpenExposures
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_OpenClaims_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 38, column 42
    function sortValue_2 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.OpenClaims
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_Handlers_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 44, column 42
    function sortValue_3 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.Handlers
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_AvgPending_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 50, column 41
    function sortValue_4 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.AvgPending
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_NoticeOnly_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 56, column 42
    function sortValue_5 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.NoticeOnly
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_Flagged_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 62, column 42
    function sortValue_6 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.Flagged
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_Litigated_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 68, column 42
    function sortValue_7 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.Litigated
    }
    
    // 'value' attribute on TextCell (id=ClaimCount_OverIncurredLimit_Cell) at ClaimCountByOrgLevelLV.default.pcf: line 74, column 42
    function sortValue_8 (DashboardStats :  entity.DashboardStats) : java.lang.Object {
      return DashboardStats.OverIncurredLimit
    }
    
    // 'value' attribute on RowIterator at ClaimCountByOrgLevelLV.default.pcf: line 20, column 43
