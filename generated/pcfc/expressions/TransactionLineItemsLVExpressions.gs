...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/transactions/TransactionLineItemsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TransactionLineItemsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TransactionLineItemsLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=LineCategory_Cell) at TransactionLineItemsLV.pcf: line 21, column 45
    ...
    // 'value' attribute on TextCell (id=Comments_Cell) at TransactionLineItemsLV.pcf: line 25, column 49
    function value_6 () : java.lang.String {
      return TransactionLineItem.Comments
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at TransactionLineItemsLV.pcf: line 31, column 55
