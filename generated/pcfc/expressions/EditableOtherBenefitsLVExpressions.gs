...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/EditableOtherBenefitsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableOtherBenefitsLVExpressions {
  ...
  public static class EditableOtherBenefitsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=ReferenceNumber_Cell) at EditableOtherBenefitsLV.pcf: line 28, column 49
    function sortValue_0 (OtherBenefit :  entity.OtherBenefit) : java.lang.Object {
      return OtherBenefit.ReferenceNumber
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at EditableOtherBenefitsLV.pcf: line 35, column 40
    function sortValue_1 (OtherBenefit :  entity.OtherBenefit) : java.lang.Object {
      return OtherBenefit.Amount
    }
    
    // 'value' attribute on DateCell (id=StartDate_Cell) at EditableOtherBenefitsLV.pcf: line 41, column 43
    function sortValue_2 (OtherBenefit :  entity.OtherBenefit) : java.lang.Object {
      return OtherBenefit.StartDate
    }
    
    // 'value' attribute on DateCell (id=EndDate_Cell) at EditableOtherBenefitsLV.pcf: line 47, column 41
    function sortValue_3 (OtherBenefit :  entity.OtherBenefit) : java.lang.Object {
      return OtherBenefit.EndDate
    }
    
    // 'value' attribute on TextCell (id=InitialContact_Cell) at EditableOtherBenefitsLV.pcf: line 53, column 48
    function sortValue_4 (OtherBenefit :  entity.OtherBenefit) : java.lang.Object {
      return OtherBenefit.InitialContact
    }
    
    // 'value' attribute on TextCell (id=Comment_Cell) at EditableOtherBenefitsLV.pcf: line 59, column 42
