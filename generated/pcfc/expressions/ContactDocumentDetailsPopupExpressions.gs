...
@javax.annotation.processing.Generated("config/web/pcf/contacts/ContactDocumentDetailsPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ContactDocumentDetailsPopupExpressions {
  ...
  public static class ContactDocumentDetailsPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on Link (id=DownloadLink) at ContactDocumentDetailsPopup.pcf: line 32, column 68
    function action_2 () : void {
      documentInfo.download()
    }
    
    // 'columns' attribute on Layout at ContactDocumentDetailsPopup.pcf: line 43, column 25
    function columns_6 () : java.lang.Double {
      return 1
    }
    
    // 'def' attribute on InputSetRef at ContactDocumentDetailsPopup.pcf: line 45, column 63
    ...
    // 'icon' attribute on Link (id=DownloadLink) at ContactDocumentDetailsPopup.pcf: line 32, column 68
    ...
    // 'tooltip' attribute on Link (id=DownloadLink) at ContactDocumentDetailsPopup.pcf: line 32, column 68
    function tooltip_3 () : java.lang.String {
      return contactDocumentsActionsHelper.DownloadDocumentContentTooltip
    }
    
    // 'visible' attribute on Link (id=DownloadLink) at ContactDocumentDetailsPopup.pcf: line 32, column 68
    function visible_1 () : java.lang.Boolean {
      return documentInfo != null and documentInfo.DMS
    }
    
    // 'visible' attribute on AlertBar (id=ContentlessNoActionsText) at ContactDocumentDetailsPopup.pcf: line 39, column 38
