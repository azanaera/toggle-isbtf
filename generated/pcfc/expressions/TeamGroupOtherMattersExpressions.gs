...
class TeamGroupOtherMattersExpressions {
  ...
  public static class TeamGroupOtherMattersExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupOtherMatters_Print) at TeamGroupOtherMatters.pcf: line 41, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupOtherMatters_Assign) at TeamGroupOtherMatters.pcf: line 34, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupOtherMatters_Print) at TeamGroupOtherMatters.pcf: line 41, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupOtherMatters.pcf: line 44, column 50
