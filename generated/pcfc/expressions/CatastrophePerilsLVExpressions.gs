...
@javax.annotation.processing.Generated("config/web/pcf/admin/catastrophes/CatastrophePerilsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CatastrophePerilsLVExpressions {
  ...
  public static class CatastrophePerilsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=LossType_Cell) at CatastrophePerilsLV.pcf: line 29, column 41
    function sortValue_0 (Peril :  entity.CatastrophePeril) : java.lang.Object {
      return Peril.LossType
    }
    
    // 'value' attribute on TypeKeyCell (id=Peril_Cell) at CatastrophePerilsLV.pcf: line 37, column 42
    function sortValue_1 (Peril :  entity.CatastrophePeril) : java.lang.Object {
      return Peril.LossCause
    }
    
    // 'value' attribute on TextCell (id=Comments_Cell) at CatastrophePerilsLV.pcf: line 42, column 35
