...
uses java.util.Date
@javax.annotation.processing.Generated("config/web/pcf/admin/catastrophes/AdminCatastrophePolicyPanelSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AdminCatastrophePolicyPanelSetExpressions {
  ...
  public static class AdminCatastrophePolicyPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=PolicyEffectiveDate_Input) at AdminCatastrophePolicyPanelSet.pcf: line 42, column 51
    ...
    // 'value' attribute on DateInput (id=PolicyRetrievalCompletionTime_Input) at AdminCatastrophePolicyPanelSet.pcf: line 56, column 72
    ...
    // 'value' attribute on TextInput (id=Status_Input) at AdminCatastrophePolicyPanelSet.pcf: line 49, column 38
    function value_9 () : java.lang.String {
      return retrievalStatus()
    }
    
    // 'visible' attribute on DateInput (id=PolicyRetrievalCompletionTime_Input) at AdminCatastrophePolicyPanelSet.pcf: line 56, column 72
    function visible_11 () : java.lang.Boolean {
      return catastrophe.PolicyRetrievalCompletionTime != null
    }
    
    // 'visible' attribute on TextInput (id=PolicyRetrievalCompletionTimeNever_Input) at AdminCatastrophePolicyPanelSet.pcf: line 61, column 72
  ...
  public static class SearchPanelExpressionsImpl extends AdminCatastrophePolicyPanelSetExpressionsImpl {
    ...
    // 'action' attribute on ButtonInput (id=SetCatastropheZone_Input) at AdminCatastrophePolicyPanelSet.pcf: line 87, column 77
    ...
    function renderCall_24 (__writer :  java.io.Writer, __escaper :  gw.lang.parser.template.StringEscaper, __helper :  gw.api.web.template.TemplatePanelHelper) : void {
    ...
    // 'visible' attribute on ButtonInput (id=SetCatastropheZone_Input) at AdminCatastrophePolicyPanelSet.pcf: line 87, column 77
