...
@javax.annotation.processing.Generated("config/web/pcf/search/claims/ClaimSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSearchDVExpressions {
  ...
  public static class ClaimSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at ClaimSearchDV.pcf: line 30, column 65
    function def_onEnter_10 (def :  pcf.ClaimSearchRequiredInputSet) : void {
      def.onEnter(ClaimSearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at ClaimSearchDV.pcf: line 34, column 65
    function def_onEnter_12 (def :  pcf.ClaimSearchOptionalInputSet) : void {
      def.onEnter(ClaimSearchCriteria)
    }
    
    // 'def' attribute on InputSetRef at ClaimSearchDV.pcf: line 38, column 46
    ...
    // 'value' attribute on RangeInput (id=ClaimSearchType_Input) at ClaimSearchDV.pcf: line 23, column 40
    ...
    // 'valueRange' attribute on RangeInput (id=ClaimSearchType_Input) at ClaimSearchDV.pcf: line 23, column 40
    ...
    // 'valueRange' attribute on RangeInput (id=ClaimSearchType_Input) at ClaimSearchDV.pcf: line 23, column 40
    function verifyValueRangeIsAllowedType_6 ($$arg :  typekey.ClaimSearchType[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    ...
    // 'visible' attribute on RangeInput (id=ClaimSearchType_Input) at ClaimSearchDV.pcf: line 23, column 40
