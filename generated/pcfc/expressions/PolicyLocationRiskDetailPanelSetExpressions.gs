...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/policylocations/PolicyLocationRiskDetailPanelSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PolicyLocationRiskDetailPanelSetExpressions {
  ...
  public static class PolicyLocationRiskDetailPanelSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'label' attribute on AddButton (id=AddMiscLocationRisk) at PolicyLocationRiskDetailPanelSet.pcf: line 28, column 176
    function label_2 () : java.lang.Object {
      return DisplayKey.get("NVV.Policy.LocationDetail.Property.Risks.Add", typekey.RiskUnit.TC_LOCATIONMISCRU.DisplayName)
    }
    
    // 'toCreateAndAdd' attribute on AddButton (id=AddMiscLocationRisk) at PolicyLocationRiskDetailPanelSet.pcf: line 28, column 176
    ...
    // 'visible' attribute on AddButton (id=AddMiscLocationRisk) at PolicyLocationRiskDetailPanelSet.pcf: line 28, column 176
    function visible_1 () : java.lang.Boolean {
      return not gw.config.LOBAbstraction.ForClaim.ForLOB.isWorkCompLine(Policy.Claim) and not gw.config.LOBAbstraction.ForClaim.ForLOB.isHomeownersLine(Policy.Claim)
    }
