...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/AddressBookContactExposuresLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookContactExposuresLVExpressions {
  ...
  public static class AddressBookContactExposuresLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=CaseID_Cell) at AddressBookContactExposuresLV.pcf: line 42, column 25
    ...
    // 'value' attribute on TextCell (id=Order_Cell) at AddressBookContactExposuresLV.pcf: line 49, column 42
    ...
    // 'value' attribute on TypeKeyCell (id=Type_Cell) at AddressBookContactExposuresLV.pcf: line 55, column 45
    ...
    // 'value' attribute on TypeKeyCell (id=Coverage_Cell) at AddressBookContactExposuresLV.pcf: line 60, column 45
    ...
    // 'value' attribute on TypeKeyCell (id=Status_Cell) at AddressBookContactExposuresLV.pcf: line 70, column 46
    function sortValue_8 (ExposureDesktopView :  entity.ExposureDesktopView) : java.lang.Object {
      return ExposureDesktopView.State
    }
    
    // 'value' attribute on CurrencyCell (id=TotalIncurredNet_Cell) at AddressBookContactExposuresLV.pcf: line 76, column 61
    ...
    // 'visible' attribute on CurrencyCell (id=TotalIncurredNet_Cell) at AddressBookContactExposuresLV.pcf: line 76, column 61
  ...
  public static class IteratorEntryExpressionsImpl extends AddressBookContactExposuresLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=CaseID_Cell) at AddressBookContactExposuresLV.pcf: line 42, column 25
    function action_11 () : void {
      pcf.Claim.go(ExposureDesktopView.ExposureClaim)
    }
    
    // 'action' attribute on TextCell (id=Order_Cell) at AddressBookContactExposuresLV.pcf: line 49, column 42
    function action_16 () : void {
      ExposureDetailForward.go(ExposureDesktopView.ExposureClaim, ExposureDesktopView.Exposure)
    }
    
    // 'action' attribute on TypeKeyCell (id=Type_Cell) at AddressBookContactExposuresLV.pcf: line 55, column 45
    ...
    // 'value' attribute on TextCell (id=Claimant_Cell) at AddressBookContactExposuresLV.pcf: line 65, column 53
