...
@javax.annotation.processing.Generated("config/web/pcf/shared/usersearch/UserSearchDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class UserSearchDVExpressions {
  ...
  public static class UserSearchDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Username_Input) at UserSearchDV.pcf: line 18, column 42
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      SearchCriteria.Username = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on RangeInput (id=Role_Input) at UserSearchDV.pcf: line 31, column 34
    ...
    // 'valueRange' attribute on RangeInput (id=Role_Input) at UserSearchDV.pcf: line 31, column 34
    ...
    // 'valueRange' attribute on RangeInput (id=Role_Input) at UserSearchDV.pcf: line 31, column 34
    function verifyValueRangeIsAllowedType_13 ($$arg :  entity.Role[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeInput (id=Role_Input) at UserSearchDV.pcf: line 31, column 34
    function verifyValueRangeIsAllowedType_13 ($$arg :  gw.api.database.IQueryBeanResult<entity.Role>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
