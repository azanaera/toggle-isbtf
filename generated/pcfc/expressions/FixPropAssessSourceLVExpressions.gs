...
@javax.annotation.processing.Generated("config/web/pcf/claim/assessment/AssessmentSource/FixPropAssessSourceLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class FixPropAssessSourceLVExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/assessment/AssessmentSource/FixPropAssessSourceLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FixPropAssessSourceLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'pickLocation' attribute on RowIterator at FixPropAssessSourceLV.pcf: line 22, column 45
    function pickLocation_37 () : void {
      NewFixPropAssessSourcePopup.push(FixedPropertyIncident)
    }
    
    // 'value' attribute on TextCell (id=Name_Cell) at FixPropAssessSourceLV.pcf: line 29, column 48
    function sortValue_0 (AssessmentSource :  entity.AssessmentSource) : java.lang.Object {
      return AssessmentSource.SourceName
    }
    
    // 'value' attribute on TypeKeyCell (id=Source_Cell) at FixPropAssessSourceLV.pcf: line 35, column 49
    function sortValue_1 (AssessmentSource :  entity.AssessmentSource) : java.lang.Object {
      return AssessmentSource.SourceType
    }
    
    // 'value' attribute on ClaimContactCell (id=Assessor_Cell) at FixPropAssessSourceLV.pcf: line 43, column 73
    function sortValue_2 (AssessmentSource :  entity.AssessmentSource) : java.lang.Object {
      return AssessmentSource.Assessor
    }
    
    // 'value' attribute on TextCell (id=Description_Cell) at FixPropAssessSourceLV.pcf: line 48, column 49
    function sortValue_3 (AssessmentSource :  entity.AssessmentSource) : java.lang.Object {
      return AssessmentSource.Description
    }
    
    // 'toAdd' attribute on RowIterator at FixPropAssessSourceLV.pcf: line 22, column 45
    function toAdd_38 (AssessmentSource :  entity.AssessmentSource) : void {
      FixedPropertyIncident.addToSourceLine(AssessmentSource)
    }
    
    // 'toRemove' attribute on RowIterator at FixPropAssessSourceLV.pcf: line 22, column 45
    function toRemove_39 (AssessmentSource :  entity.AssessmentSource) : void {
      FixedPropertyIncident.removeFromSourceLine(AssessmentSource)
    }
    
    // 'value' attribute on RowIterator at FixPropAssessSourceLV.pcf: line 22, column 45
  ...
  @javax.annotation.processing.Generated("config/web/pcf/claim/assessment/AssessmentSource/FixPropAssessSourceLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntryExpressionsImpl extends FixPropAssessSourceLVExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'action' attribute on TextCell (id=Name_Cell) at FixPropAssessSourceLV.pcf: line 29, column 48
    function action_4 () : void {
      FixPropAssessSourcePopup.push(AssessmentSource)
    }
    ...
    function action_dest_5 () : pcf.api.Destination {
      return pcf.FixPropAssessSourcePopup.createDestination(AssessmentSource)
    }
    ...
    // 'onPick' attribute on ClaimContactCell (id=Assessor_Cell) at FixPropAssessSourceLV.pcf: line 43, column 73
