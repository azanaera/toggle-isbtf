...
@javax.annotation.processing.Generated("config/web/pcf/admin/workload/conditions/LossCauseConditionsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LossCauseConditionsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends LossCauseConditionsLVExpressionsImpl {
    ...
    // 'value' attribute on RangeCell (id=LossCause_Cell) at LossCauseConditionsLV.pcf: line 29, column 41
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      losscause.LossCause = (__VALUE_TO_SET as typekey.LossCause)
    }
    
    // 'valueRange' attribute on RangeCell (id=LossCause_Cell) at LossCauseConditionsLV.pcf: line 29, column 41
    ...
    // 'valueRange' attribute on RangeCell (id=LossCause_Cell) at LossCauseConditionsLV.pcf: line 29, column 41
    function verifyValueRangeIsAllowedType_5 ($$arg :  typekey.LossCause[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
