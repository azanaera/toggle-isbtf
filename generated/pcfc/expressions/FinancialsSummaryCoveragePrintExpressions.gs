...
class FinancialsSummaryCoveragePrintExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/financials/summary/print/FinancialsSummaryCoveragePrint.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FinancialsSummaryCoveragePrintExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at FinancialsSummaryCoveragePrint.pcf: line 24, column 67
    ...
    // 'initialValue' attribute on Variable at FinancialsSummaryCoveragePrint.pcf: line 20, column 64
    function initialValue_0 () : gw.api.financials.summary.FinancialSummaryBridge {
      return new gw.api.financials.summary.FinancialSummaryBridge(Claim, "Coverage")
    }
    
    // 'parent' attribute on Page (id=FinancialsSummaryCoveragePrint) at FinancialsSummaryCoveragePrint.pcf: line 8, column 73
    ...
    override property get CurrentLocation () : pcf.FinancialsSummaryCoveragePrint {
      return super.CurrentLocation as pcf.FinancialsSummaryCoveragePrint
    }
