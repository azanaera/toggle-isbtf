...
class SystemAlertBarExpressions {
  ...
  public static class SystemAlertBarExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'label' attribute on SystemAlertBarElement (id=Message) at SystemAlertBar.pcf: line 13, column 93
    function label_0 () : java.lang.Object {
      return new gw.api.tools.ClusterMembersData().PlannedShutdownMessageForCurrentServer
    }
    
    // 'label' attribute on SystemAlertBar (id=SystemAlertBar) at SystemAlertBar.pcf: line 10, column 78
    function label_2 () : java.lang.Object {
      return new gw.api.tools.ClusterMembersData().PlannedShutdownTitleForCurrentServer
    }
    
    // 'visible' attribute on SystemAlertBar (id=SystemAlertBar) at SystemAlertBar.pcf: line 10, column 78
