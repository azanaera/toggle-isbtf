...
@javax.annotation.processing.Generated("config/web/pcf/contacts/ContactDetailScreen.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ContactDetailScreenExpressions {
  ...
  public static class ContactDetailScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ButtonInput (id=ShowActivitiesButton_Input) at ContactDetailScreen.pcf: line 110, column 116
    function action_28 () : void {
      helper.revealContent(ACTIVITIES)
    }
    
    // 'action' attribute on ButtonInput (id=ShowClaimsButton_Input) at ContactDetailScreen.pcf: line 133, column 113
    function action_35 () : void {
      helper.revealContent(CLAIMS)
    }
    
    // 'action' attribute on ButtonInput (id=ShowExposuresButton_Input) at ContactDetailScreen.pcf: line 156, column 116
    function action_42 () : void {
      helper.revealContent(EXPOSURES)
    }
    
    // 'action' attribute on ButtonInput (id=ShowMattersButton_Input) at ContactDetailScreen.pcf: line 179, column 114
