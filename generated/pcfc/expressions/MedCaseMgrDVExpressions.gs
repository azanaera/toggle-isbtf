...
@javax.annotation.processing.Generated("config/web/pcf/claim/medicalcasemgmt/MedCaseMgrDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class MedCaseMgrDVExpressions {
  ...
  public static class MedCaseMgrDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=Make_Primary) at MedCaseMgrDV.pcf: line 72, column 127
    ...
    // 'confirmMessage' attribute on CheckedValuesToolbarButton (id=Make_Primary) at MedCaseMgrDV.pcf: line 72, column 127
    ...
    // 'showConfirmMessage' attribute on CheckedValuesToolbarButton (id=Make_Primary) at MedCaseMgrDV.pcf: line 72, column 127
    function showConfirmMessage_12 () : java.lang.Boolean {
      return Claim.ensureClaimInjuryIncident().InjuryDiagnoses.hasMatch( \ i -> i.IsPrimary == true )
    }
