...
@javax.annotation.processing.Generated("config/web/pcf/team/group/TeamGroupOtherClaims.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TeamGroupOtherClaimsExpressions {
  ...
  public static class TeamGroupOtherClaimsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupOtherClaims_Print) at TeamGroupOtherClaims.pcf: line 51, column 25
    function action_5 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupOtherClaims_Assign) at TeamGroupOtherClaims.pcf: line 38, column 25
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupOtherClaims_RemoveFlag) at TeamGroupOtherClaims.pcf: line 44, column 76
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupOtherClaims_Print) at TeamGroupOtherClaims.pcf: line 51, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupOtherClaims.pcf: line 54, column 59
