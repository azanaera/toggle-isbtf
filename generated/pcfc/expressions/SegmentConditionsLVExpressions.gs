...
class SegmentConditionsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends SegmentConditionsLVExpressionsImpl {
    ...
    // 'value' attribute on RangeCell (id=SegmentType_Cell) at SegmentConditionsLV.pcf: line 29, column 44
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      segment.Segment = (__VALUE_TO_SET as typekey.ClaimSegment)
    }
    
    // 'valueRange' attribute on RangeCell (id=SegmentType_Cell) at SegmentConditionsLV.pcf: line 29, column 44
    ...
    // 'valueRange' attribute on RangeCell (id=SegmentType_Cell) at SegmentConditionsLV.pcf: line 29, column 44
    function verifyValueRangeIsAllowedType_5 ($$arg :  typekey.ClaimSegment[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
