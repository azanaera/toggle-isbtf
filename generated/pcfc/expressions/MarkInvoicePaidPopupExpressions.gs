...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/MarkInvoicePaidPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class MarkInvoicePaidPopupExpressions {
  ...
  public static class MarkInvoicePaidPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=ClaimChecks_Input) at MarkInvoicePaidPopup.pcf: line 30, column 41
    ...
    // 'valueRange' attribute on RangeInput (id=ClaimChecks_Input) at MarkInvoicePaidPopup.pcf: line 30, column 41
    ...
    // 'valueRange' attribute on RangeInput (id=ClaimChecks_Input) at MarkInvoicePaidPopup.pcf: line 30, column 41
    function verifyValueRangeIsAllowedType_5 ($$arg :  entity.Check[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeInput (id=ClaimChecks_Input) at MarkInvoicePaidPopup.pcf: line 30, column 41
    function verifyValueRangeIsAllowedType_5 ($$arg :  gw.api.database.IQueryBeanResult<entity.Check>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
