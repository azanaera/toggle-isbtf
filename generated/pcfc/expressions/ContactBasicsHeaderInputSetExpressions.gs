...
@javax.annotation.processing.Generated("config/web/pcf/shared/contacts/ContactBasicsHeaderInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ContactBasicsHeaderInputSetExpressions {
  ...
  public static class ContactBasicsHeaderInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=LinkStatusMessage_Input) at ContactBasicsHeaderInputSet.pcf: line 32, column 45
    ...
    // 'value' attribute on TextInput (id=LinkStatusRelationshipsMessage_Input) at ContactBasicsHeaderInputSet.pcf: line 38, column 67
    function value_4 () : java.lang.String {
      return linkStatus.DifferentRelationshipsMessage
    }
    
    // 'visible' attribute on TextInput (id=LinkStatusRelationshipsMessage_Input) at ContactBasicsHeaderInputSet.pcf: line 38, column 67
