...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/ServiceRequestInvoiceInputSet.multiple.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ServiceRequestInvoiceInputSet_multipleExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ServiceRequestInvoiceInputSetExpressionsImpl {
    ...
    // 'value' attribute on CurrencyCell (id=ServiceRequestInvoiceAmount_Cell) at ServiceRequestInvoiceInputSet.multiple.pcf: line 43, column 39
    function valueRoot_10 () : java.lang.Object {
      return invoice
    }
    
    // 'value' attribute on TextCell (id=ServiceRequestNumber_Cell) at ServiceRequestInvoiceInputSet.multiple.pcf: line 39, column 68
    function valueRoot_7 () : java.lang.Object {
      return invoice.ServiceRequest
    }
    
    // 'value' attribute on TextCell (id=ServiceRequestInvoiceReferenceNumber_Cell) at ServiceRequestInvoiceInputSet.multiple.pcf: line 34, column 197
