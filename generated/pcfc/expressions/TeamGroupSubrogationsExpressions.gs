...
class TeamGroupSubrogationsExpressions {
  ...
  public static class TeamGroupSubrogationsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=Print) at TeamGroupSubrogations.pcf: line 31, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions("SubrogationsLV")
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=Assign) at TeamGroupSubrogations.pcf: line 24, column 25
    ...
    // 'available' attribute on ToolbarButton (id=Print) at TeamGroupSubrogations.pcf: line 31, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupSubrogations.pcf: line 34, column 90
    ...
    // 'title' attribute on TitleBar at TeamGroupSubrogations.pcf: line 17, column 96
