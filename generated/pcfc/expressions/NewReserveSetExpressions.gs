...
class NewReserveSetExpressions {
  ...
  public static class NewReserveSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_21 (Claim :  Claim, CostCategory :  CostCategory, CostType :  CostType, Exposure :  Exposure, Reserve :  Reserve, ReservingCurrency :  Currency, addNew :  Boolean) : java.lang.Boolean {
      return perm.Claim.createreserve(Claim) and perm.Claim.viewreserves(Claim) and (Claim.State != ClaimState.TC_DRAFT)
    }
    
    // 'def' attribute on PanelRef at NewReserveSet.pcf: line 107, column 64
    function def_onEnter_14 (def :  pcf.ReservesSummaryDV) : void {
      def.onEnter(PageHelper, Exposure, addNew)
    }
    
    // 'def' attribute on PanelRef at NewReserveSet.pcf: line 107, column 64
    function def_refreshVariables_15 (def :  pcf.ReservesSummaryDV) : void {
    ...
    static function parent_23 (Claim :  Claim, CostCategory :  CostCategory, CostType :  CostType, Exposure :  Exposure, Reserve :  Reserve, ReservingCurrency :  Currency, addNew :  Boolean) : pcf.api.Destination {
      return pcf.Claim.createDestination(Claim)
    }
    
    // 'visible' attribute on AlertBar (id=IDCSDisabledAlert) at NewReserveSet.pcf: line 97, column 68
    function visible_11 () : java.lang.Boolean {
      return not documentsActionsHelper.ContentSourceEnabled
    }
    
    // 'visible' attribute on AlertBar (id=IDCSUnavailableAlert) at NewReserveSet.pcf: line 101, column 72
    function visible_12 () : java.lang.Boolean {
      return documentsActionsHelper.ShowContentServerDownWarning
    }
    
    // 'visible' attribute on AlertBar (id=IDMSUnavailableAlert) at NewReserveSet.pcf: line 105, column 73
