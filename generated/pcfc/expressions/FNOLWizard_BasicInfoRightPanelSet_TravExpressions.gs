...
class FNOLWizard_BasicInfoRightPanelSet_TravExpressions {
  ...
  @javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/FNOLWizard_BasicInfoRightPanelSet.Trav.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class IteratorEntry2ExpressionsImpl extends FNOLWizard_BasicInfoRightPanelSetExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'label' attribute on TextInput (id=CoverageDetails_Input) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 105, column 46
    function label_24 () : java.lang.Object {
      return coverage.Type
    }
    
    // 'value' attribute on TextInput (id=CoverageDetails_Input) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 105, column 46
  ...
  public static class IteratorEntryExpressionsImpl extends PanelIteratorEntryExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=CoverageType_Cell) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 77, column 36
    ...
    // 'value' attribute on TextCell (id=CoverageDetails_Cell) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 81, column 36
  ...
  @javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/FNOLWizard_BasicInfoRightPanelSet.Trav.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class PanelIteratorEntryExpressionsImpl extends FNOLWizard_BasicInfoRightPanelSetExpressionsImpl {
    public construct(widget :  Object) {
      super(widget, 1)
    }
    ...
    // 'value' attribute on TextInput (id=Trip_Input) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 50, column 41
    ...
    // 'value' attribute on TypeKeyInput (id=GeographicalRegion_Input) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 56, column 58
    ...
    // 'visible' attribute on TypeKeyInput (id=GeographicalRegion_Input) at FNOLWizard_BasicInfoRightPanelSet.Trav.pcf: line 56, column 58
