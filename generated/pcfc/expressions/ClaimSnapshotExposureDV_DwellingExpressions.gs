...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.Dwelling.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotExposureDV_DwellingExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotExposureDV.Dwelling.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotExposureDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextInput (id=Dwelling_Incident_Input) at ClaimSnapshotExposureDV.Dwelling.pcf: line 27, column 38
    function action_8 () : void {
      ClaimSnapshotDwellingIncidentPopup.push(Claim, Exposure.DwellingIncident)
    }
    
    // 'action' attribute on TextInput (id=Dwelling_Incident_Input) at ClaimSnapshotExposureDV.Dwelling.pcf: line 27, column 38
    function action_dest_9 () : pcf.api.Destination {
      return pcf.ClaimSnapshotDwellingIncidentPopup.createDestination(Claim, Exposure.DwellingIncident)
    }
    
    // 'def' attribute on InputSetRef at ClaimSnapshotExposureDV.Dwelling.pcf: line 17, column 37
    function def_onEnter_0 (def :  pcf.ClaimSnapshotExposureDetailInputSet_600) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at ClaimSnapshotExposureDV.Dwelling.pcf: line 30, column 37
    ...
    // 'def' attribute on InputSetRef at ClaimSnapshotExposureDV.Dwelling.pcf: line 35, column 37
    ...
    // 'value' attribute on TextInput (id=Dwelling_Incident_Input) at ClaimSnapshotExposureDV.Dwelling.pcf: line 27, column 38
