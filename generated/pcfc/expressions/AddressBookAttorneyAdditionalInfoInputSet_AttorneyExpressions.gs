...
@javax.annotation.processing.Generated("config/web/pcf/addressbook/AddressBookAttorneyAdditionalInfoInputSet.Attorney.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AddressBookAttorneyAdditionalInfoInputSet_AttorneyExpressions {
  ...
  public static class AddressBookAttorneyAdditionalInfoInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=AttorneyLicense_Input) at AddressBookAttorneyAdditionalInfoInputSet.Attorney.pcf: line 15, column 59
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      (personVendor as Attorney).AttorneyLicense = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=AttorneySpecialty_Input) at AddressBookAttorneyAdditionalInfoInputSet.Attorney.pcf: line 21, column 43
