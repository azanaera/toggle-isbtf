...
@javax.annotation.processing.Generated("config/web/pcf/desktop/activities/DesktopActivities.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class DesktopActivitiesExpressions {
  ...
  public static class DesktopActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=DesktopActivities_PrintButton) at DesktopActivities.pcf: line 67, column 25
    function action_7 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=DesktopActivities_AssignButton) at DesktopActivities.pcf: line 31, column 25
    ...
    // 'available' attribute on ToolbarButton (id=DesktopActivities_PrintButton) at DesktopActivities.pcf: line 67, column 25
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=DesktopActivities_SkipButton) at DesktopActivities.pcf: line 38, column 25
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=DesktopActivities_CompleteButton) at DesktopActivities.pcf: line 45, column 25
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=DesktopActivities_ApproveButton) at DesktopActivities.pcf: line 53, column 25
    ...
    // 'checkedRowAction' attribute on CheckedValuesToolbarButton (id=DesktopActivities_RejectButton) at DesktopActivities.pcf: line 59, column 77
    ...
    // 'def' attribute on PanelRef at DesktopActivities.pcf: line 70, column 61
