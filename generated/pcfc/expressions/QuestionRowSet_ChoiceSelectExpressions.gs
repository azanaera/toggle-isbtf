...
@javax.annotation.processing.Generated("config/web/pcf/shared/question/QuestionRowSet.ChoiceSelect.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class QuestionRowSet_ChoiceSelectExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends QuestionRowSetExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=subQuestionText_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 45, column 37
  ...
  public static class QuestionRowSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      AnswerSetContainer.getOrCreateAnswer(Question).ChoiceAnswer = (__VALUE_TO_SET as entity.QuestionChoice)
    }
    
    // 'editable' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function editable_3 () : java.lang.Boolean {
      return !Question.isRetired()
    }
    
    // 'validationLabel' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function label_4 () : java.lang.Object {
      return Question.Text
    }
    
    // 'required' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function required_5 () : java.lang.Boolean {
      return Question.Required
    }
    
    // 'valueRange' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function valueRange_9 () : java.lang.Object {
      return Question.getQuestionChoicesAsList()
    }
    
    // 'value' attribute on TextCell (id=questionText_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 19, column 22
    ...
    // 'value' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function value_6 () : entity.QuestionChoice {
      return AnswerSetContainer.getOrCreateAnswer(Question).ChoiceAnswer
    }
    
    // 'valueRange' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function verifyValueRangeIsAllowedType_10 ($$arg :  entity.QuestionChoice[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeCell (id=questionChoiceAnswer_Cell) at QuestionRowSet.ChoiceSelect.pcf: line 30, column 43
    function verifyValueRangeIsAllowedType_10 ($$arg :  gw.api.database.IQueryBeanResult<entity.QuestionChoice>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
