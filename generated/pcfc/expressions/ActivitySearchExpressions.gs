...
@javax.annotation.processing.Generated("config/web/pcf/search/activities/ActivitySearch.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ActivitySearchExpressions {
  ...
  public static class SearchPanelExpressionsImpl extends ActivitySearchExpressionsImpl {
    ...
    // 'action' attribute on ToolbarButton (id=ActivitySearch_PrintButton) at ActivitySearch.pcf: line 43, column 29
    ...
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=ActivitySearch_AssignButton) at ActivitySearch.pcf: line 36, column 29
    ...
    // 'available' attribute on ToolbarButton (id=ActivitySearch_PrintButton) at ActivitySearch.pcf: line 43, column 29
