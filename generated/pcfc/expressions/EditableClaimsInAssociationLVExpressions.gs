...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/associations/EditableClaimsInAssociationLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableClaimsInAssociationLVExpressions {
  ...
  public static class EditableClaimsInAssociationLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on BooleanRadioCell (id=IsPrimaryClaim_Cell) at EditableClaimsInAssociationLV.pcf: line 32, column 101
    ...
    // 'value' attribute on PickerCell (id=Claim_Cell) at EditableClaimsInAssociationLV.pcf: line 46, column 41
  ...
  public static class IteratorEntryExpressionsImpl extends EditableClaimsInAssociationLVExpressionsImpl {
    ...
    // 'pickLocation' attribute on PickerCell (id=Claim_Cell) at EditableClaimsInAssociationLV.pcf: line 46, column 41
    ...
    // 'conversionExpression' attribute on PickerCell (id=Claim_Cell) at EditableClaimsInAssociationLV.pcf: line 46, column 41
    function conversionExpression_7 (PickedValue :  Object) : entity.ClaimInfo {
    ...
    // 'value' attribute on PickerCell (id=Claim_Cell) at EditableClaimsInAssociationLV.pcf: line 46, column 41
    function value_8 () : entity.ClaimInfo {
      return ClaimInAssociation.ClaimInfo
    }
