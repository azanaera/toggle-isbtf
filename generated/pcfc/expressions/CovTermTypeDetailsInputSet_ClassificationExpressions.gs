...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/CovTerm/CovTermTypeDetailsInputSet.Classification.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CovTermTypeDetailsInputSet_ClassificationExpressions {
  ...
  public static class CovTermTypeDetailsInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=Code_Input) at CovTermTypeDetailsInputSet.Classification.pcf: line 19, column 43
    function defaultSetter_2 (__VALUE_TO_SET :  java.lang.Object) : void {
      ClassificationCovTerm.Code = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextInput (id=Description_Input) at CovTermTypeDetailsInputSet.Classification.pcf: line 24, column 50
