...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/OperationReasonPromptPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class OperationReasonPromptPopupExpressions {
  ...
  public static class OperationReasonPromptPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=ReasonForOperation_Input) at OperationReasonPromptPopup.pcf: line 54, column 38
    ...
    // 'label' attribute on TextAreaInput (id=ReasonForOperation_Input) at OperationReasonPromptPopup.pcf: line 54, column 38
