...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimPIPDeathBenefitsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewClaimPIPDeathBenefitsDVExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/NewClaimPIPDeathBenefitsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class NewClaimPIPDeathBenefitsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsBeginDate_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 18, column 62
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PIPDeathBenefits.BenefitsBeginDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CurrencyInput (id=LostWagesBenefits_WeeklyCompRate_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 30, column 59
    function defaultSetter_11 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PIPDeathBenefits.WeeklyCompRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TypeKeyInput (id=LostWagesBenefits_PaymentFrequency_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 36, column 51
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PIPDeathBenefits.PaymentFrequency = (__VALUE_TO_SET as typekey.PaymentFrequencyType)
    }
    
    // 'value' attribute on CurrencyInput (id=LostWagesBenefits_MaxBurialRate_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 42, column 58
    function defaultSetter_19 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PIPDeathBenefits.MaxBurialRate = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextInput (id=LostWagesBenefits_Description_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 47, column 56
    function defaultSetter_23 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PIPDeathBenefits.Description = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 24, column 60
    function defaultSetter_6 (__VALUE_TO_SET :  java.lang.Object) : void {
      Exposure.PIPDeathBenefits.BenefitsEndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=LostWagesBenefits_BenefitsEndDate_Input) at NewClaimPIPDeathBenefitsDV.pcf: line 24, column 60
