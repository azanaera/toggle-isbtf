...
@javax.annotation.processing.Generated("config/web/pcf/claim/subrogation/General/ReferSubrogationPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ReferSubrogationPopupExpressions {
  ...
  public static class ReferSubrogationPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaInput (id=SubroReferralComment_Input) at ReferSubrogationPopup.pcf: line 39, column 62
    ...
    // 'value' attribute on DateInput (id=SubroReferralDate_Input) at ReferSubrogationPopup.pcf: line 32, column 59
