...
@javax.annotation.processing.Generated("config/web/pcf/admin/reinsthreshold/ReinsuranceThresholdLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ReinsuranceThresholdLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends ReinsuranceThresholdLVExpressionsImpl {
    ...
    // 'value' attribute on TypeKeyCell (id=PolicyType_Cell) at ReinsuranceThresholdLV.pcf: line 40, column 42
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      ReinsuranceThreshold.PolicyType = (__VALUE_TO_SET as typekey.PolicyType)
    }
    
    // 'value' attribute on TextCell (id=ThresholdValue_Cell) at ReinsuranceThresholdLV.pcf: line 50, column 45
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      ReinsuranceThreshold.ThresholdValue = (__VALUE_TO_SET as java.math.BigDecimal)
    }
    
    // 'value' attribute on TextCell (id=ReportingThreshold_Cell) at ReinsuranceThresholdLV.pcf: line 57, column 42
    function defaultSetter_24 (__VALUE_TO_SET :  java.lang.Object) : void {
      ReinsuranceThreshold.ReportingThreshold = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on DateCell (id=StartDate_Cell) at ReinsuranceThresholdLV.pcf: line 63, column 51
    function defaultSetter_28 (__VALUE_TO_SET :  java.lang.Object) : void {
      ReinsuranceThreshold.StartDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on DateCell (id=EndDate_Cell) at ReinsuranceThresholdLV.pcf: line 70, column 49
    ...
    // 'editable' attribute on TypeKeyCell (id=PolicyType_Cell) at ReinsuranceThresholdLV.pcf: line 40, column 42
    ...
    // 'filter' attribute on TypeKeyCell (id=PolicyType_Cell) at ReinsuranceThresholdLV.pcf: line 40, column 42
    function filter_16 (VALUE :  typekey.PolicyType, VALUES :  typekey.PolicyType[]) : java.lang.Boolean {
    ...
    // 'validationExpression' attribute on DateCell (id=EndDate_Cell) at ReinsuranceThresholdLV.pcf: line 70, column 49
