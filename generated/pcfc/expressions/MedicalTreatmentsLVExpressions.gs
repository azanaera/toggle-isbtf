...
class MedicalTreatmentsLVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends MedicalTreatmentsLVExpressionsImpl {
    ...
    // 'value' attribute on RangeCell (id=MedicalTreatments_ProviderName_Cell) at MedicalTreatmentsLV.pcf: line 29, column 44
    function defaultSetter_10 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ClaimContact = (__VALUE_TO_SET as entity.ClaimContact)
    }
    
    // 'value' attribute on DateCell (id=MedicalTreatments_ActionDate_Cell) at MedicalTreatmentsLV.pcf: line 40, column 48
    function defaultSetter_20 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ActionDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on TypeKeyCell (id=MedicalTreatments_ApprovedTreatment_Cell) at MedicalTreatmentsLV.pcf: line 46, column 50
    function defaultSetter_24 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ApprovedTreatment = (__VALUE_TO_SET as typekey.ApprovedTreatment)
    }
    
    // 'value' attribute on TextCell (id=MedicalTreatments_TreatmentQuantity_Cell) at MedicalTreatmentsLV.pcf: line 52, column 42
    function defaultSetter_28 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.TreatmentQuantity = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'value' attribute on TextCell (id=MedicalTreatments_ICD1_Cell) at MedicalTreatmentsLV.pcf: line 57, column 42
    function defaultSetter_32 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ICD1 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextCell (id=MedicalTreatments_ICD2_Cell) at MedicalTreatmentsLV.pcf: line 62, column 42
    function defaultSetter_36 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ICD2 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextCell (id=MedicalTreatments_ICD3_Cell) at MedicalTreatmentsLV.pcf: line 67, column 42
    function defaultSetter_40 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ICD3 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextCell (id=MedicalTreatments_ICD4_Cell) at MedicalTreatmentsLV.pcf: line 72, column 42
    function defaultSetter_44 (__VALUE_TO_SET :  java.lang.Object) : void {
      MedicalTreatment.ICD4 = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'valueRange' attribute on RangeCell (id=MedicalTreatments_ProviderName_Cell) at MedicalTreatmentsLV.pcf: line 29, column 44
    ...
    // 'value' attribute on TypeKeyCell (id=MedicalTreatments_ProviderSpecialty_Cell) at MedicalTreatmentsLV.pcf: line 34, column 46
    ...
    // 'valueRange' attribute on RangeCell (id=MedicalTreatments_ProviderName_Cell) at MedicalTreatmentsLV.pcf: line 29, column 44
    function verifyValueRangeIsAllowedType_13 ($$arg :  entity.ClaimContact[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeCell (id=MedicalTreatments_ProviderName_Cell) at MedicalTreatmentsLV.pcf: line 29, column 44
    function verifyValueRangeIsAllowedType_13 ($$arg :  gw.api.database.IQueryBeanResult<entity.ClaimContact>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
