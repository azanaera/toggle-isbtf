...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/PropertyReferencePopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class PropertyReferencePopupExpressions {
  ...
  public static class PropertyReferencePopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'autoComplete' attribute on TextInput (id=Property_Input) at PropertyReferencePopup.pcf: line 30, column 68
    function autoComplete_6 () : gw.api.contact.AutocompleteHandler {
      return fragment.AutocompleteHandler
    }
    
    // 'def' attribute on InputSetRef at PropertyReferencePopup.pcf: line 34, column 78
    function def_onEnter_8 (def :  pcf.ValidationPopupErrorsInputSet) : void {
      def.onEnter(fragment.validate(), false)
    }
    
    // 'def' attribute on InputSetRef at PropertyReferencePopup.pcf: line 34, column 78
    function def_refreshVariables_9 (def :  pcf.ValidationPopupErrorsInputSet) : void {
      def.refreshVariables(fragment.validate(), false)
    }
    
    // 'value' attribute on TextInput (id=Property_Input) at PropertyReferencePopup.pcf: line 30, column 68
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      fragment.Fragment = (__VALUE_TO_SET as entity.PropertyReferenceExpressionFragment)
    }
    
    // 'inputConversion' attribute on TextInput (id=Property_Input) at PropertyReferencePopup.pcf: line 30, column 68
    ...
    // 'outputConversion' attribute on TextInput (id=Property_Input) at PropertyReferencePopup.pcf: line 30, column 68
    function outputConversion_2 (VALUE :  entity.PropertyReferenceExpressionFragment) : java.lang.String {
    ...
    // 'value' attribute on TextInput (id=Property_Input) at PropertyReferencePopup.pcf: line 30, column 68
    function value_3 () : entity.PropertyReferenceExpressionFragment {
