...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/summary/print/FinancialsSummaryExposurePrint.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class FinancialsSummaryExposurePrintExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/financials/summary/print/FinancialsSummaryExposurePrint.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class FinancialsSummaryExposurePrintExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at FinancialsSummaryExposurePrint.pcf: line 25, column 67
    ...
    // 'initialValue' attribute on Variable at FinancialsSummaryExposurePrint.pcf: line 20, column 64
    function initialValue_0 () : gw.api.financials.summary.FinancialSummaryBridge {
      return new gw.api.financials.summary.FinancialSummaryBridge(Claim, "Exposure")
    }
    
    // 'parent' attribute on Page (id=FinancialsSummaryExposurePrint) at FinancialsSummaryExposurePrint.pcf: line 8, column 73
    ...
    override property get CurrentLocation () : pcf.FinancialsSummaryExposurePrint {
      return super.CurrentLocation as pcf.FinancialsSummaryExposurePrint
    }
