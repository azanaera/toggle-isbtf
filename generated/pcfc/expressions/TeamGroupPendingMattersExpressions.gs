...
@javax.annotation.processing.Generated("config/web/pcf/team/group/TeamGroupPendingMatters.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TeamGroupPendingMattersExpressions {
  ...
  public static class TeamGroupPendingMattersExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupPendingMatters_Print) at TeamGroupPendingMatters.pcf: line 41, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupPendingMatters_Assign) at TeamGroupPendingMatters.pcf: line 34, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupPendingMatters_Print) at TeamGroupPendingMatters.pcf: line 41, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupPendingMatters.pcf: line 44, column 50
