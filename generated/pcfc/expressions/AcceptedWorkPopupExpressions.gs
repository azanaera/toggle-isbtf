...
@javax.annotation.processing.Generated("config/web/pcf/claim/servicerequests/AcceptedWorkPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AcceptedWorkPopupExpressions {
  ...
  public static class AcceptedWorkPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateInput (id=ExpectedCompletionDate_Input) at AcceptedWorkPopup.pcf: line 38, column 48
    ...
    // 'label' attribute on DateInput (id=ExpectedCompletionDate_Input) at AcceptedWorkPopup.pcf: line 38, column 48
    ...
    // 'validationExpression' attribute on DateInput (id=ExpectedCompletionDate_Input) at AcceptedWorkPopup.pcf: line 38, column 48
