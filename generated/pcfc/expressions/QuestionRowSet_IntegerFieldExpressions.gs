...
@javax.annotation.processing.Generated("config/web/pcf/shared/question/QuestionRowSet.IntegerField.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class QuestionRowSet_IntegerFieldExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends QuestionRowSetExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=subQuestionText_Cell) at QuestionRowSet.IntegerField.pcf: line 42, column 37
  ...
  public static class QuestionRowSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=questionNumberAnswer_Cell) at QuestionRowSet.IntegerField.pcf: line 27, column 39
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      AnswerSetContainer.getOrCreateAnswer(Question).IntegerAnswer = (__VALUE_TO_SET as java.lang.Integer)
    }
    
    // 'editable' attribute on TextCell (id=questionNumberAnswer_Cell) at QuestionRowSet.IntegerField.pcf: line 27, column 39
    function editable_3 () : java.lang.Boolean {
      return !Question.isRetired()
    }
    
    // 'validationLabel' attribute on TextCell (id=questionNumberAnswer_Cell) at QuestionRowSet.IntegerField.pcf: line 27, column 39
    function label_4 () : java.lang.Object {
      return Question.Text
    }
    
    // 'required' attribute on TextCell (id=questionNumberAnswer_Cell) at QuestionRowSet.IntegerField.pcf: line 27, column 39
    function required_5 () : java.lang.Boolean {
      return Question.Required
    }
    
    // 'value' attribute on TextCell (id=questionText_Cell) at QuestionRowSet.IntegerField.pcf: line 19, column 22
    ...
    // 'value' attribute on RowIterator at QuestionRowSet.IntegerField.pcf: line 36, column 40
