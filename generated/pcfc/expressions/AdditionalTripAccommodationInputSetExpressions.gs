...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/AdditionalTripAccommodationInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class AdditionalTripAccommodationInputSetExpressions {
  ...
  public static class AdditionalTripAccommodationInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=PropertyName_Input) at AdditionalTripAccommodationInputSet.pcf: line 21, column 54
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.PropertyName = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on DateInput (id=Checkout_Input) at AdditionalTripAccommodationInputSet.pcf: line 39, column 49
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.EndDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'value' attribute on CurrencyInput (id=PaidAmount_Input) at AdditionalTripAccommodationInputSet.pcf: line 48, column 52
    function defaultSetter_19 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.PaidAmount = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=AgentFees_Input) at AdditionalTripAccommodationInputSet.pcf: line 54, column 51
    function defaultSetter_23 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.AgentFees = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on CurrencyInput (id=OtherFees_Input) at AdditionalTripAccommodationInputSet.pcf: line 60, column 51
    function defaultSetter_27 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.OtherFees = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextAreaInput (id=ReasonForDenial_Input) at AdditionalTripAccommodationInputSet.pcf: line 115, column 66
    function defaultSetter_47 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.ReasonForDenial = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on DateInput (id=Checkin_Input) at AdditionalTripAccommodationInputSet.pcf: line 31, column 51
    function defaultSetter_8 (__VALUE_TO_SET :  java.lang.Object) : void {
      anAddnlTripAccommodation.StartDate = (__VALUE_TO_SET as java.util.Date)
    }
    
    // 'validationExpression' attribute on DateInput (id=Checkout_Input) at AdditionalTripAccommodationInputSet.pcf: line 39, column 49
    ...
    // 'validationExpression' attribute on DateInput (id=Checkin_Input) at AdditionalTripAccommodationInputSet.pcf: line 31, column 51
    ...
    // 'value' attribute on TypeKeyInput (id=Assessment_Input) at AdditionalTripAccommodationInputSet.pcf: line 68, column 45
    function value_30 () : typekey.AssessmentAction {
      return anAddnlTripAccommodation.Assessment
    }
    
    // 'value' attribute on CurrencyInput (id=FinancialImpact_Input) at AdditionalTripAccommodationInputSet.pcf: line 73, column 75
    ...
    // 'visible' attribute on TextAreaInput (id=ReasonForDenial_Input) at AdditionalTripAccommodationInputSet.pcf: line 115, column 66
