...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/summary/FinancialsSummaryRecoveriesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class FinancialsSummaryRecoveriesLVExpressions {
  ...
  public static class FinancialsSummaryRecoveriesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'visible' attribute on TextCell (id=TotalRecoveries_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 46, column 29
    function visible_2 () : java.lang.Boolean {
      return perm.Claim.viewrecoveries(Claim)
    }
    
    // 'visible' attribute on TextCell (id=OpenRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 57, column 29
    ...
    // 'visible' attribute on TextCell (id=TotalRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 68, column 29
  ...
  public static class RowTreeEntryExpressionsImpl extends FinancialsSummaryRecoveriesLVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=OpenRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 57, column 29
    ...
    // 'action' attribute on TextCell (id=TotalRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 68, column 29
    ...
    // 'action' attribute on TextCell (id=TotalRecoveries_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 46, column 29
    ...
    // 'available' attribute on TextCell (id=OpenRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 57, column 29
    ...
    // 'available' attribute on TextCell (id=TotalRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 68, column 29
    ...
    // 'available' attribute on TextCell (id=TotalRecoveries_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 46, column 29
    ...
    // 'value' attribute on TextCell (id=FinancialsSummaryLabel_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 35, column 32
    function valueRoot_6 () : java.lang.Object {
      return FSRow
    }
    
    // 'value' attribute on TextCell (id=TotalRecoveries_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 46, column 29
    ...
    // 'value' attribute on TextCell (id=OpenRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 57, column 29
    ...
    // 'value' attribute on TextCell (id=TotalRecoveryReserves_Cell) at FinancialsSummaryRecoveriesLV.pcf: line 68, column 29
