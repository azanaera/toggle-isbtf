...
@javax.annotation.processing.Generated("config/web/pcf/claim/financials/shared/WaitingPeriodInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class WaitingPeriodInputSetExpressions {
  ...
  public static class WaitingPeriodInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on BooleanRadioInput (id=WaitingPeriodApplied_Input) at WaitingPeriodInputSet.pcf: line 17, column 57
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      claim.ClaimWorkComp.WaitingPeriodApplied = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'value' attribute on CheckBoxInput (id=WCDoesnotApplytoPPD_Input) at WaitingPeriodInputSet.pcf: line 32, column 62
    ...
    // 'value' attribute on TextInput (id=WaitingPeriodDays_Input) at WaitingPeriodInputSet.pcf: line 22, column 37
    function value_4 () : java.lang.Double {
      return claim.getWCWaitingDays( null )
    }
    
    // 'value' attribute on TextInput (id=TTD_RetroactivePeriod_Input) at WaitingPeriodInputSet.pcf: line 27, column 37
    function value_6 () : java.lang.Double {
      return claim.getWCRetroactiveDays( null )
    }
    
    // 'visible' attribute on CheckBoxInput (id=WCDoesnotApplytoPTD_Input) at WaitingPeriodInputSet.pcf: line 37, column 62
    function visible_13 () : java.lang.Boolean {
      return claim.findWCBeneCalcRef().WPNotAppliedToPTD
    }
    
    // 'visible' attribute on CheckBoxInput (id=WCDoesnotApplytoPPD_Input) at WaitingPeriodInputSet.pcf: line 32, column 62
