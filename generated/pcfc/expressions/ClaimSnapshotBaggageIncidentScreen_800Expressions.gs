...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotBaggageIncidentScreen.800.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotBaggageIncidentScreen_800Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotBaggageIncidentScreen.800.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotBaggageIncidentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotBaggageIncidentScreen.800.pcf: line 20, column 67
    function def_onEnter_1 (def :  pcf.ClaimSnapshotBaggageIncident800DV) : void {
      def.onEnter(IncidentParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotBaggageIncidentScreen.800.pcf: line 20, column 67
    function def_refreshVariables_2 (def :  pcf.ClaimSnapshotBaggageIncident800DV) : void {
      def.refreshVariables(IncidentParam)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotBaggageIncidentScreen.800.pcf: line 14, column 31
