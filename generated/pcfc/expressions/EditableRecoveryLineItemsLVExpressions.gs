...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/recovery/EditableRecoveryLineItemsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableRecoveryLineItemsLVExpressions {
  ...
  public static class EditableRecoveryLineItemsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=LineCategory_Cell) at EditableRecoveryLineItemsLV.pcf: line 29, column 45
    ...
    // 'value' attribute on TextCell (id=Comments_Cell) at EditableRecoveryLineItemsLV.pcf: line 34, column 49
    function sortValue_1 (TransactionLineItem :  entity.TransactionLineItem) : java.lang.Object {
      return TransactionLineItem.Comments
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at EditableRecoveryLineItemsLV.pcf: line 43, column 55
  ...
  public static class IteratorEntryExpressionsImpl extends EditableRecoveryLineItemsLVExpressionsImpl {
    ...
    // 'filter' attribute on TypeKeyCell (id=LineCategory_Cell) at EditableRecoveryLineItemsLV.pcf: line 29, column 45
    function filter_8 (VALUE :  typekey.LineCategory, VALUES :  typekey.LineCategory[]) : java.lang.Boolean {
