...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/default/ClaimSnapshotPolicyScreen.default.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotPolicyScreen_defaultExpressions {
  ...
  public static class ClaimSnapshotPolicyScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function def_onEnter_53 (def :  pcf.ClaimSnapshotPolicyStatCodesLV) : void {
      def.onEnter(Claim, SnapshotParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 166, column 73
    function def_onEnter_56 (def :  pcf.ClaimSnapshotPolicyEndorsementsLV) : void {
      def.onEnter(Claim, SnapshotParam)
    }
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 157, column 70
    function def_refreshVariables_54 (def :  pcf.ClaimSnapshotPolicyStatCodesLV) : void {
      def.refreshVariables(Claim, SnapshotParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 166, column 73
    function def_refreshVariables_57 (def :  pcf.ClaimSnapshotPolicyEndorsementsLV) : void {
      def.refreshVariables(Claim, SnapshotParam)
    }
  ...
  public static class TripCoverageLDPExpressionsImpl extends ListDetailPanel3ExpressionsImpl {
    ...
    function def_onEnter_46 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 146, column 47
    function def_onEnter_48 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 146, column 47
    function def_onEnter_50 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.onEnter(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 146, column 47
    function def_refreshVariables_47 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_700) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 146, column 47
    function def_refreshVariables_49 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_800) : void {
      def.refreshVariables(SelectedCoverage)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotPolicyScreen.default.pcf: line 146, column 47
    function def_refreshVariables_51 (def :  pcf.ClaimSnapshotPolicyCovTermsCV_default) : void {
      def.refreshVariables(SelectedCoverage)
    }
