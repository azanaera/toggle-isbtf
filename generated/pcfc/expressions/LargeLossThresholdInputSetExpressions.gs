...
@javax.annotation.processing.Generated("config/web/pcf/admin/keymetrics/LargeLossThresholdInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class LargeLossThresholdInputSetExpressions {
  ...
  public static class LargeLossThresholdInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=ClaimCenterThreshold_Input) at LargeLossThresholdInputSet.pcf: line 23, column 43
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      ccThreshold.ThresholdValue = (__VALUE_TO_SET as java.math.BigDecimal)
    }
    
    // 'value' attribute on TextInput (id=PolicySystemThreshold_Input) at LargeLossThresholdInputSet.pcf: line 31, column 98
    ...
    // 'visible' attribute on TextInput (id=PolicySystemThreshold_Input) at LargeLossThresholdInputSet.pcf: line 31, column 98
