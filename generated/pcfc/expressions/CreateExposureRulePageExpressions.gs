...
class CreateExposureRulePageExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/bizrules/ExposureRules/CreateExposureRulePage.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class CreateExposureRulePageExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'afterCancel' attribute on Page (id=CreateExposureRulePage) at CreateExposureRulePage.pcf: line 14, column 19
    function afterCancel_3 () : void {
      context.goToRulesListPage()
    }
    
    // 'afterCommit' attribute on Page (id=CreateExposureRulePage) at CreateExposureRulePage.pcf: line 14, column 19
    function afterCommit_4 (TopLocation :  pcf.api.Location) : void {
      context.goToRulesListPage()
    }
    
    // 'def' attribute on ScreenRef at CreateExposureRulePage.pcf: line 36, column 63
    ...
    // 'initialValue' attribute on Variable at CreateExposureRulePage.pcf: line 34, column 117
    ...
    // 'parent' attribute on Page (id=CreateExposureRulePage) at CreateExposureRulePage.pcf: line 14, column 19
    ...
    // 'title' attribute on Page (id=CreateExposureRulePage) at CreateExposureRulePage.pcf: line 14, column 19
    ...
    override property get CurrentLocation () : pcf.CreateExposureRulePage {
      return super.CurrentLocation as pcf.CreateExposureRulePage
    }
