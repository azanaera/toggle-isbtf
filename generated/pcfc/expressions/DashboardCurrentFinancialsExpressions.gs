...
class DashboardCurrentFinancialsExpressions {
  ...
  public static class DashboardCurrentFinancialsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 46, column 103
    function def_onEnter_11 (def :  pcf.CurrentFinancialsByLossTypeLV) : void {
      def.onEnter(Stats.LossTypeStats?.toTypedArray())
    }
    
    // 'def' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 50, column 101
    function def_onEnter_14 (def :  pcf.CurrentFinancialsByCoverageTypeLV) : void {
      def.onEnter(Stats.CoverageTypeStats?.toTypedArray())
    }
    
    // 'def' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 39, column 111
    ...
    // 'def' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 42, column 102
    ...
    // 'visible' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 46, column 103
    function visible_10 () : java.lang.Boolean {
      return GroupInfo.isRoot() && gw.api.dashboard.DashboardUtil.isShowByLineOrLoss()
    }
    
    // 'visible' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 50, column 101
    function visible_13 () : java.lang.Boolean {
      return GroupInfo.isRoot() && gw.api.dashboard.DashboardUtil.isShowByCoverage()
    }
    
    // 'visible' attribute on PanelRef at DashboardCurrentFinancials.pcf: line 42, column 102
