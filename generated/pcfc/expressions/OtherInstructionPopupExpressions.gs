...
@javax.annotation.processing.Generated("config/web/pcf/admin/specialhandling/OtherInstructionPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class OtherInstructionPopupExpressions {
  ...
  public static class OtherInstructionPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyInput (id=InstructionCategory_Input) at OtherInstructionPopup.pcf: line 58, column 54
    function defaultSetter_14 (__VALUE_TO_SET :  java.lang.Object) : void {
      otherInstruction.InstructionCategory = (__VALUE_TO_SET as typekey.InstructionCategory)
    }
    
    // 'value' attribute on TypeKeyInput (id=InstructionType_Input) at OtherInstructionPopup.pcf: line 65, column 50
    function defaultSetter_18 (__VALUE_TO_SET :  java.lang.Object) : void {
      otherInstruction.InstructionType = (__VALUE_TO_SET as typekey.InstructionType)
    }
    
    // 'value' attribute on TextAreaInput (id=Comment_Input) at OtherInstructionPopup.pcf: line 75, column 43
    function defaultSetter_22 (__VALUE_TO_SET :  java.lang.Object) : void {
      otherInstruction.Comments = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TypeKeyInput (id=PolicyType_Input) at OtherInstructionPopup.pcf: line 51, column 51
    ...
    // 'value' attribute on TextInput (id=policyTypeReadOnly_Input) at OtherInstructionPopup.pcf: line 43, column 52
    ...
    // 'visible' attribute on TextInput (id=policyTypeReadOnly_Input) at OtherInstructionPopup.pcf: line 43, column 52
    function visible_3 () : java.lang.Boolean {
      return !CurrentLocation.InEditMode
    }
    
    // 'visible' attribute on TypeKeyInput (id=PolicyType_Input) at OtherInstructionPopup.pcf: line 51, column 51
