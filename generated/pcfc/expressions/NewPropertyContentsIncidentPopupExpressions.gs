...
@javax.annotation.processing.Generated("config/web/pcf/claim/incidents/NewPropertyContentsIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewPropertyContentsIncidentPopupExpressions {
  ...
  public static class NewPropertyContentsIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at NewPropertyContentsIncidentPopup.pcf: line 32, column 59
    ...
    // 'icon' attribute on TitleBar at NewPropertyContentsIncidentPopup.pcf: line 26, column 33
    ...
    function initialValue_0 () : entity.PropertyContentsIncident {
      return claim.initializePropertyContentsIncident()
    }
    
    // EditButtons at NewPropertyContentsIncidentPopup.pcf: line 29, column 33
    function label_3 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'pickValue' attribute on EditButtons at NewPropertyContentsIncidentPopup.pcf: line 29, column 33
