...
class ClaimSnapshotVehicleIncidentScreen_500Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/500/ClaimSnapshotVehicleIncidentScreen.500.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotVehicleIncidentScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on PanelRef at ClaimSnapshotVehicleIncidentScreen.500.pcf: line 23, column 70
    function def_onEnter_1 (def :  pcf.ClaimSnapshotVehicleIncident500DV) : void {
      def.onEnter(Claim, IncidentParam)
    }
    
    // 'def' attribute on PanelRef at ClaimSnapshotVehicleIncidentScreen.500.pcf: line 23, column 70
    function def_refreshVariables_2 (def :  pcf.ClaimSnapshotVehicleIncident500DV) : void {
      def.refreshVariables(Claim, IncidentParam)
    }
    
    // 'initialValue' attribute on Variable at ClaimSnapshotVehicleIncidentScreen.500.pcf: line 20, column 31
