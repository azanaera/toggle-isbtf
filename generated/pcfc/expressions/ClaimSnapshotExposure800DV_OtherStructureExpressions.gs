...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotExposure800DV.OtherStructure.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotExposure800DV_OtherStructureExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotExposure800DV.OtherStructure.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotExposure800DVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on TextInput (id=Other_Structure_Incident_Input) at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 27, column 38
    function action_9 () : void {
      ClaimSnapshotOtherStructureIncident800Popup.push(Claim, Exposure.OtherStructureIncident)
    }
    
    // 'action' attribute on TextInput (id=Other_Structure_Incident_Input) at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 27, column 38
    function action_dest_10 () : pcf.api.Destination {
      return pcf.ClaimSnapshotOtherStructureIncident800Popup.createDestination(Claim, Exposure.OtherStructureIncident)
    }
    
    // 'def' attribute on InputSetRef at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 17, column 21
    function def_onEnter_0 (def :  pcf.ClaimSnapshotExposureDetailInputSet_600) : void {
      def.onEnter(Exposure)
    }
    
    // 'def' attribute on InputSetRef at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 30, column 21
    ...
    // 'def' attribute on InputSetRef at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 35, column 21
    ...
    // 'mode' attribute on InputSetRef at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 17, column 21
    function mode_8 () : java.lang.Object {
      return 800
    }
    
    // 'value' attribute on TextInput (id=Other_Structure_Incident_Input) at ClaimSnapshotExposure800DV.OtherStructure.pcf: line 27, column 38
    ...
    function value_11 () : dynamic.Dynamic {
      return Exposure.OtherStructureIncident.DisplayName
    }
