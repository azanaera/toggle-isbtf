...
class FNOLInjuryIncidentPopupExpressions {
  ...
  public static class FNOLInjuryIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on InputSetRef at FNOLInjuryIncidentPopup.pcf: line 54, column 97
    function def_onEnter_11 (def :  pcf.FNOLContactInputSet) : void {
      def.onEnter( contactPerson, ContactRole.TC_INJURED, injuryIncident )
    }
    
    // 'def' attribute on InputSetRef at FNOLInjuryIncidentPopup.pcf: line 61, column 59
    ...
    // 'value' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLInjuryIncidentPopup.pcf: line 49, column 39
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      contactPerson = (__VALUE_TO_SET as entity.Person)
    }
    
    // 'icon' attribute on TitleBar at FNOLInjuryIncidentPopup.pcf: line 33, column 33
    function icon_0 () : java.lang.String {
      return injuryIncident.HeaderIcon
    }
    
    // EditButtons at FNOLInjuryIncidentPopup.pcf: line 36, column 39
    function label_2 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'onChange' attribute on PostOnChange at FNOLInjuryIncidentPopup.pcf: line 51, column 43
    function onChange_3 () : void {
      assignContact()
    }
    
    // 'optionLabel' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLInjuryIncidentPopup.pcf: line 49, column 39
    function optionLabel_6 (VALUE :  entity.Person) : java.lang.String {
      return VALUE == newPerson ? DisplayKey.get("Web.FNOLContactPopup.ContactDV.NewPerson.Value") : VALUE.DisplayName
    }
    
    // 'pickValue' attribute on EditButtons at FNOLInjuryIncidentPopup.pcf: line 36, column 39
    function pickValue_1 () : InjuryIncident {
      return injuryIncident
    }
    
    // 'valueRange' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLInjuryIncidentPopup.pcf: line 49, column 39
    ...
    // 'valueRange' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLInjuryIncidentPopup.pcf: line 49, column 39
    function verifyValueRangeIsAllowedType_8 ($$arg :  entity.Person[]) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
    
    // 'valueRange' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLInjuryIncidentPopup.pcf: line 49, column 39
    function verifyValueRangeIsAllowedType_8 ($$arg :  gw.api.database.IQueryBeanResult<entity.Person>) : void {
      // No-op:  This method is only for verification purposes and is never actually executed
    }
