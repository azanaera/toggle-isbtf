...
@javax.annotation.processing.Generated("config/web/pcf/search/claims/CatastropheSearch.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CatastropheSearchExpressions {
  ...
  public static class CatastropheSearchExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    static function canVisit_2 (catastrophe :  Catastrophe) : java.lang.Boolean {
      return perm.Claim.genericviewclaim and perm.System.viewsearch and perm.Catastrophe.view and gw.api.heatmap.HeatMapGenerator.HeatMapConfigured
    }
