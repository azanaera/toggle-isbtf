...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/RelatedToInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class RelatedToInputSetExpressions {
  ...
  public static class RelatedToInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=RelatedToInput_Input) at RelatedToInputSet.pcf: line 24, column 98
    ...
    // 'optionLabel' attribute on RangeInput (id=RelatedToInput_Input) at RelatedToInputSet.pcf: line 24, column 98
    function optionLabel_3 (VALUE :  gw.bizrules.ruleaction.behavioralcommandparam.relatedto.ActivityRulesRelatedTo) : java.lang.String {
      return VALUE.UIDisplayName
    }
    
    // 'valueRange' attribute on RangeInput (id=RelatedToInput_Input) at RelatedToInputSet.pcf: line 24, column 98
    ...
    // 'valueRange' attribute on RangeInput (id=RelatedToInput_Input) at RelatedToInputSet.pcf: line 24, column 98
    function verifyValueRangeIsAllowedType_5 ($$arg :  gw.bizrules.ruleaction.behavioralcommandparam.relatedto.ActivityRulesRelatedTo[]) : void {
