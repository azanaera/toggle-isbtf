...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/CommandDefinitionDV.generatehistoryevent.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CommandDefinitionDV_generatehistoryeventExpressions {
  ...
  public static class CommandDefinitionDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=TypeInput_Input) at CommandDefinitionDV.generatehistoryevent.pcf: line 27, column 84
    ...
    // 'valueRange' attribute on RangeInput (id=TypeInput_Input) at CommandDefinitionDV.generatehistoryevent.pcf: line 27, column 84
    ...
    // 'valueRange' attribute on RangeInput (id=TypeInput_Input) at CommandDefinitionDV.generatehistoryevent.pcf: line 27, column 84
    function verifyValueRangeIsAllowedType_6 ($$arg :  gw.bizrules.ruleaction.generatehistoryevent.HistoryTypeWrapper[]) : void {
