...
@javax.annotation.processing.Generated("config/web/pcf/claim/newexposure/NewExposure.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewExposureExpressions {
  ...
  public static class NewExposureExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function initialValue_1 () : Incident {
      return ext.config.exposure.ExposureUIHelper.initializeIncident(Exposure)
    }
