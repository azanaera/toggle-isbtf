...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/TripLDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TripLDVExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends TripLDVExpressionsImpl {
    ...
    // 'action' attribute on TextCell (id=TripRU_Name_Cell) at TripLDV.pcf: line 31, column 42
    ...
    // 'value' attribute on TextCell (id=TripRU_Name_Cell) at TripLDV.pcf: line 31, column 42
    function valueRoot_7 () : java.lang.Object {
      return aTripRU
    }
    
    // 'value' attribute on DateCell (id=EndDate_Cell) at TripLDV.pcf: line 41, column 38
    function value_12 () : java.util.Date {
      return aTripRU.EndDate
    }
    
    // 'value' attribute on TypeKeyCell (id=GeographicalRegion_Cell) at TripLDV.pcf: line 46, column 53
    ...
    // 'value' attribute on DateCell (id=StartDate_Cell) at TripLDV.pcf: line 36, column 40
