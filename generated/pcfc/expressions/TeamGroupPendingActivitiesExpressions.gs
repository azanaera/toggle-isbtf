...
class TeamGroupPendingActivitiesExpressions {
  ...
  public static class TeamGroupPendingActivitiesExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamGroupPendingActivities_Print) at TeamGroupPendingActivities.pcf: line 45, column 25
    function action_4 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamGroupPendingActivities_Assign) at TeamGroupPendingActivities.pcf: line 38, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamGroupPendingActivities_Print) at TeamGroupPendingActivities.pcf: line 45, column 25
    ...
    // 'def' attribute on PanelRef at TeamGroupPendingActivities.pcf: line 48, column 131
