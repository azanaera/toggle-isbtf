...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/EditFixedPropertyIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditFixedPropertyIncidentPopupExpressions {
  ...
  public static class EditFixedPropertyIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'beforeCommit' attribute on Popup (id=EditFixedPropertyIncidentPopup) at EditFixedPropertyIncidentPopup.pcf: line 11, column 253
    ...
    // 'canEdit' attribute on Popup (id=EditFixedPropertyIncidentPopup) at EditFixedPropertyIncidentPopup.pcf: line 11, column 253
    function canEdit_6 () : java.lang.Boolean {
      return perm.Incident.edit(fixedPropertyIncident)
    }
    
    // 'canVisit' attribute on Popup (id=EditFixedPropertyIncidentPopup) at EditFixedPropertyIncidentPopup.pcf: line 11, column 253
    ...
    // 'def' attribute on PanelRef at EditFixedPropertyIncidentPopup.pcf: line 40, column 86
    ...
    // 'icon' attribute on TitleBar at EditFixedPropertyIncidentPopup.pcf: line 29, column 33
    ...
    // EditButtons at EditFixedPropertyIncidentPopup.pcf: line 31, column 23
    function label_2 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'startInEditMode' attribute on Popup (id=EditFixedPropertyIncidentPopup) at EditFixedPropertyIncidentPopup.pcf: line 11, column 253
    function startInEditMode_8 () : java.lang.Boolean {
      return startInEditMode
    }
    
    // 'title' attribute on Popup (id=EditFixedPropertyIncidentPopup) at EditFixedPropertyIncidentPopup.pcf: line 11, column 253
    static function title_9 (fixedPropertyIncident :  FixedPropertyIncident, startInEditMode :  boolean) : java.lang.Object {
      return gw.config.LOBAbstraction.ForPolicy.isHomeownersPolicy(fixedPropertyIncident.Claim.Policy) ? DisplayKey.get("Web.EditFixedPropertyIncident.PropertyLiability.Title") : DisplayKey.get("Web.EditFixedPropertyIncident.Title")
    }
