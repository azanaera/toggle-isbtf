...
class SelectServicesPopupExpressions {
  ...
  public static class RowTreeEntryExpressionsImpl extends SelectServicesPopupExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=ServiceLeaf_Cell) at SelectServicesPopup.pcf: line 109, column 47
  ...
  public static class SelectServicesPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=AvailableServicesDescription_Input) at SelectServicesPopup.pcf: line 82, column 47
    function value_14 () : java.lang.String {
      return DisplayKey.get("Web.ServiceRequest.SelectServices.AvailableServicesDescription", serviceRequest.RelatedToName)
    }
    
    // 'value' attribute on TextInput (id=IncompatibleServicesAlert_Input) at SelectServicesPopup.pcf: line 87, column 65
    ...
    // 'visible' attribute on TextInput (id=AvailableServicesDescription_Input) at SelectServicesPopup.pcf: line 82, column 47
    function visible_13 () : java.lang.Boolean {
      return serviceRequest != null
    }
    
    // 'visible' attribute on TextInput (id=IncompatibleServicesAlert_Input) at SelectServicesPopup.pcf: line 87, column 65
    function visible_17 () : java.lang.Boolean {
      return IncompatibleServicesAlertMessage != null
    }
    
    // 'visible' attribute on DetailViewPanel at SelectServicesPopup.pcf: line 114, column 39
    ...
    property get IncompatibleServicesAlertMessage () : block() : String {
      return getVariableValue("IncompatibleServicesAlertMessage", 0) as block() : String
    }
    
    property set IncompatibleServicesAlertMessage ($arg :  block() : String) {
    ...
    property get CategoriesMatchingIncident() : java.util.List<SpecialistService> {
      ...
      var compatibleServices = Query.make(SpecialistService)
              .compare(SpecialistService#Parent, Relop.Equals, null)
      .select()
        
      var result = compatibleServices.where(\ s -> (
        incident == null 
              or 
        s.CompatibleIncidentTypes.hasMatch( \ cit -> cit.IncidentType==incident.Subtype)) 
              and 
        shouldShow(s))
