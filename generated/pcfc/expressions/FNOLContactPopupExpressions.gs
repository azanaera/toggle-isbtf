...
@javax.annotation.processing.Generated("config/web/pcf/claim/FNOL/FNOLContactPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class FNOLContactPopupExpressions {
  ...
  public static class FNOLContactPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    function beforeCommit_32 (pickedValue :  ClaimContact) : void {
      beforeExit()
    }
    ...
    // 'def' attribute on InputSetRef at FNOLContactPopup.pcf: line 96, column 32
    function def_onEnter_29 (def :  pcf.InjuryIncidentInputSet) : void {
    ...
    // 'def' attribute on InputSetRef at FNOLContactPopup.pcf: line 96, column 32
    function def_refreshVariables_30 (def :  pcf.InjuryIncidentInputSet) : void {
      def.refreshVariables(injuryIncident)
    }
    
    // 'value' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLContactPopup.pcf: line 75, column 40
    function defaultSetter_15 (__VALUE_TO_SET :  java.lang.Object) : void {
      contactPerson = (__VALUE_TO_SET as entity.Contact)
    }
    
    // 'value' attribute on BooleanRadioInput (id=InjuredBoolean_Input) at FNOLContactPopup.pcf: line 90, column 29
    function defaultSetter_26 (__VALUE_TO_SET :  java.lang.Object) : void {
      injured = (__VALUE_TO_SET as java.lang.Boolean)
    }
    
    // 'filter' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLContactPopup.pcf: line 75, column 40
    function filter_16 (VALUE :  entity.Contact, VALUES :  entity.Contact[]) : java.lang.Boolean {
    ...
    // 'onChange' attribute on PostOnChange at FNOLContactPopup.pcf: line 92, column 59
    function onChange_24 () : void {
      setLossPartyForInjuryIncident()
    }
    
    // 'optionLabel' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLContactPopup.pcf: line 75, column 40
    function optionLabel_17 (VALUE :  entity.Contact) : java.lang.String {
    ...
    static function title_33 (Wizard :  gw.api.claim.NewClaimWizardInfo, claim :  Claim, claimContact :  ClaimContact, role :  ContactRole, vehicleIncident :  VehicleIncident) : java.lang.Object {
      return pageTitle(role)
    }
    
    // 'valueRange' attribute on RangeInput (id=ClaimContactPerson_Input) at FNOLContactPopup.pcf: line 75, column 40
    function valueRange_18 () : java.lang.Object {
      return getContactPersonValueRange()
    }
    
    // 'value' attribute on TypeKeyInput (id=VehicleLossParty_Input) at FNOLContactPopup.pcf: line 59, column 58
    function valueRoot_4 () : java.lang.Object {
      return vehicleIncident
    }
    
    // 'value' attribute on TextInput (id=VehicleName_Input) at FNOLContactPopup.pcf: line 63, column 58
    ...
    // 'visible' attribute on TypeKeyInput (id=VehicleLossParty_Input) at FNOLContactPopup.pcf: line 59, column 58
    ...
    function getContactPersonValueRange() : java.util.List<Contact> {
       var result = claim.getRelatedContacts(claim.getContactTypes(role))?.toList()
    ...
    function setLossPartyForInjuryIncident() {
      // for vehicle incident
      if (injuryIncident != null and vehicleIncident != null) {
        injuryIncident.LossParty = vehicleIncident.LossParty
      } else if (injuryIncident != null and role == ContactRole.TC_PEDESTRIAN) {
        injuryIncident.LossParty = LossPartyType.TC_THIRD_PARTY
      }
    }
