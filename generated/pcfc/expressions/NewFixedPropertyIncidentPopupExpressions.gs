...
@javax.annotation.processing.Generated("config/web/pcf/claim/newexposure/NewFixedPropertyIncidentPopup.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class NewFixedPropertyIncidentPopupExpressions {
  ...
  public static class NewFixedPropertyIncidentPopupExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'beforeCommit' attribute on Popup (id=NewFixedPropertyIncidentPopup) at NewFixedPropertyIncidentPopup.pcf: line 12, column 229
    ...
    // 'canVisit' attribute on Popup (id=NewFixedPropertyIncidentPopup) at NewFixedPropertyIncidentPopup.pcf: line 12, column 229
    static function canVisit_8 (claim :  Claim) : java.lang.Boolean {
      return perm.Claim.createincident(claim)
    }
    
    // 'def' attribute on PanelRef at NewFixedPropertyIncidentPopup.pcf: line 42, column 86
    ...
    // 'icon' attribute on TitleBar at NewFixedPropertyIncidentPopup.pcf: line 30, column 33
    ...
    // EditButtons at NewFixedPropertyIncidentPopup.pcf: line 33, column 46
    function label_4 () : java.lang.Object {
      return gw.api.util.LocationUtil.hasOwnBundle(CurrentLocation) ? DisplayKey.get("Button.Update") : DisplayKey.get("Button.OK")
    }
    
    // 'pickValue' attribute on EditButtons at NewFixedPropertyIncidentPopup.pcf: line 33, column 46
    function pickValue_3 () : FixedPropertyIncident {
      return fixedPropertyIncident
    }
    
    // 'title' attribute on Popup (id=NewFixedPropertyIncidentPopup) at NewFixedPropertyIncidentPopup.pcf: line 12, column 229
    static function title_9 (claim :  Claim) : java.lang.Object {
      return gw.config.LOBAbstraction.ForPolicy.isHomeownersPolicy(claim.Policy) ? DisplayKey.get("Web.NewFixedPropertyIncident.PropertyLiability.Title") : DisplayKey.get("Web.NewFixedPropertyIncident.Title")
    }
