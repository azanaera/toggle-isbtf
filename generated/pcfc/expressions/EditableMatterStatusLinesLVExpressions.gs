...
@javax.annotation.processing.Generated("config/web/pcf/claim/litigation/EditableMatterStatusLinesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableMatterStatusLinesLVExpressions {
  ...
  public static class EditableMatterStatusLinesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TypeKeyCell (id=Status_Cell) at EditableMatterStatusLinesLV.pcf: line 29, column 29
    ...
    // 'value' attribute on DateCell (id=StartDate_Cell) at EditableMatterStatusLinesLV.pcf: line 34, column 48
    function sortValue_1 (LitStatusTypeLine :  entity.LitStatusTypeLine) : java.lang.Object {
      return LitStatusTypeLine.StartDate
    }
    
    // 'value' attribute on DateCell (id=CompletionDate_Cell) at EditableMatterStatusLinesLV.pcf: line 40, column 53
