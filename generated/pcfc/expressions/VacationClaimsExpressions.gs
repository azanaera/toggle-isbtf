...
class VacationClaimsExpressions {
  ...
  public static class VacationClaimsExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=VacationClaims_Print) at VacationClaims.pcf: line 41, column 25
    function action_3 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=VacationClaims_Assign) at VacationClaims.pcf: line 32, column 25
    ...
    // 'available' attribute on ToolbarButton (id=VacationClaims_Print) at VacationClaims.pcf: line 41, column 25
    ...
    // 'def' attribute on PanelRef at VacationClaims.pcf: line 44, column 56
