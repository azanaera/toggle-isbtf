...
@javax.annotation.processing.Generated("config/web/pcf/claim/reinsurance/ReinsuranceSummary.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ReinsuranceSummaryExpressions {
  ...
  public static class ReinsuranceSummaryExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextInput (id=NetPaidOnClaim_Input) at ReinsuranceSummary.pcf: line 26, column 127
    function value_0 () : java.lang.String {
      return currToString(gw.api.financials.FinancialsCalculations.getSubmittedNetPayments().withClaim(claim).Amount)
    }
    
    // 'value' attribute on TextInput (id=TotalRI_Input) at ReinsuranceSummary.pcf: line 55, column 129
    function value_10 () : java.lang.String {
      return safeCurrToString(gw.api.financials.FinancialsCalculations.getRITotalReinsurance().withClaim(claim).Amount)
    }
    
    // 'value' attribute on TextInput (id=NetNetOnClaim_Input) at ReinsuranceSummary.pcf: line 64, column 159
    ...
    // 'value' attribute on TextInput (id=NetNetReserves_Input) at ReinsuranceSummary.pcf: line 69, column 159
    ...
    // 'value' attribute on TextInput (id=TotalIncurredWithRI_Input) at ReinsuranceSummary.pcf: line 74, column 158
    ...
    // 'value' attribute on TextInput (id=OpenReserves_Input) at ReinsuranceSummary.pcf: line 31, column 132
    function value_2 () : java.lang.String {
      return safeCurrToString(gw.api.financials.FinancialsCalculations.getSubmittedOpenReserves().withClaim(claim).Amount)
    }
    
    // 'value' attribute on TextInput (id=TotalIncurred_Input) at ReinsuranceSummary.pcf: line 36, column 136
    ...
    // 'value' attribute on TextInput (id=TotalRIRecoverable_Input) at ReinsuranceSummary.pcf: line 45, column 130
    function value_6 () : java.lang.String {
      return safeCurrToString(gw.api.financials.FinancialsCalculations.getRITotalRecoverables().withClaim(claim).Amount)
    }
    
    // 'value' attribute on TextInput (id=CededReserves_Input) at ReinsuranceSummary.pcf: line 50, column 130
