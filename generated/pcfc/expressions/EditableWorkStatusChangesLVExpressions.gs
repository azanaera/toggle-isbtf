...
@javax.annotation.processing.Generated("config/web/pcf/claim/lossdetails/EditableWorkStatusChangesLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableWorkStatusChangesLVExpressions {
  ...
  public static class EditableWorkStatusChangesLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on DateCell (id=Date_Cell) at EditableWorkStatusChangesLV.pcf: line 30, column 42
    function sortValue_0 (WorkStatus :  entity.WorkStatus) : java.lang.Object {
      return WorkStatus.StatusDate
    }
    
    // 'value' attribute on DateCell (id=EndDate_Cell) at EditableWorkStatusChangesLV.pcf: line 34, column 45
    function sortValue_1 (WorkStatus :  entity.WorkStatus) : java.lang.Object {
      return WorkStatus.StatusEndDate
    }
    
    // 'value' attribute on TypeKeyCell (id=Type_Cell) at EditableWorkStatusChangesLV.pcf: line 40, column 45
  ...
  public static class IteratorEntryExpressionsImpl extends EditableWorkStatusChangesLVExpressionsImpl {
    ...
    // 'action' attribute on DateCell (id=Date_Cell) at EditableWorkStatusChangesLV.pcf: line 30, column 42
