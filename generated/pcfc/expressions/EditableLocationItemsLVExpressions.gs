...
@javax.annotation.processing.Generated("config/web/pcf/claim/policy/EditableLocationItemsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableLocationItemsLVExpressions {
  ...
  public static class EditableLocationItemsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Description_Cell) at EditableLocationItemsLV.pcf: line 29, column 45
    function sortValue_0 (PropertyItem :  entity.PropertyItem) : java.lang.Object {
      return PropertyItem.Description
    }
    
    // 'value' attribute on CurrencyCell (id=Value_Cell) at EditableLocationItemsLV.pcf: line 36, column 48
