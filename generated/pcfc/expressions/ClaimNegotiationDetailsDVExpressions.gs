...
@javax.annotation.processing.Generated("config/web/pcf/claim/planofaction/ClaimNegotiationDetailsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimNegotiationDetailsDVExpressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/planofaction/ClaimNegotiationDetailsDV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimNegotiationDetailsDVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'def' attribute on ListViewInput at ClaimNegotiationDetailsDV.pcf: line 105, column 27
    ...
    // 'value' attribute on TextInput (id=General_Name_Input) at ClaimNegotiationDetailsDV.pcf: line 17, column 35
    function defaultSetter_1 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.Name = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on CurrencyInput (id=General_TargetOffer_Input) at ClaimNegotiationDetailsDV.pcf: line 40, column 42
    function defaultSetter_13 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.TargetOffer = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextAreaInput (id=General_TargetOfferRationale_Input) at ClaimNegotiationDetailsDV.pcf: line 47, column 40
    function defaultSetter_17 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.Rationale = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on RangeInput (id=Note_RelatedTo_Input) at ClaimNegotiationDetailsDV.pcf: line 59, column 50
    ...
    // 'value' attribute on TextAreaInput (id=General_DefenseArgument_Input) at ClaimNegotiationDetailsDV.pcf: line 76, column 46
    function defaultSetter_49 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.DefenseArgument = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on CurrencyInput (id=General_OverallLiabilityAssessment_Input) at ClaimNegotiationDetailsDV.pcf: line 25, column 44
    function defaultSetter_5 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.LiabilityEval = (__VALUE_TO_SET as gw.api.financials.CurrencyAmount)
    }
    
    // 'value' attribute on TextAreaInput (id=General_PlaintiffArgument_Input) at ClaimNegotiationDetailsDV.pcf: line 83, column 48
    ...
    // 'value' attribute on TextAreaInput (id=General_SettlementPlan_Input) at ClaimNegotiationDetailsDV.pcf: line 90, column 45
    function defaultSetter_57 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.SettlementPlan = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on TextAreaInput (id=General_AlternativeToSettlement_Input) at ClaimNegotiationDetailsDV.pcf: line 97, column 54
    function defaultSetter_61 (__VALUE_TO_SET :  java.lang.Object) : void {
      Negotiation.AlternativeToSettlement = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'value' attribute on CurrencyInput (id=General_MaxOffer_Input) at ClaimNegotiationDetailsDV.pcf: line 32, column 39
    ...
    // 'optionGroupLabel' attribute on RangeInput (id=Note_RelatedTo_Input) at ClaimNegotiationDetailsDV.pcf: line 59, column 50
    ...
    // 'optionLabel' attribute on RangeInput (id=Note_RelatedTo_Input) at ClaimNegotiationDetailsDV.pcf: line 59, column 50
    ...
    // 'valueRange' attribute on RangeInput (id=Note_RelatedTo_Input) at ClaimNegotiationDetailsDV.pcf: line 59, column 50
