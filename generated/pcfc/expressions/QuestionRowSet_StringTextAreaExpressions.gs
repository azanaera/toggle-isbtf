...
@javax.annotation.processing.Generated("config/web/pcf/shared/question/QuestionRowSet.StringTextArea.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class QuestionRowSet_StringTextAreaExpressions {
  ...
  public static class IteratorEntryExpressionsImpl extends QuestionRowSetExpressionsImpl {
    ...
    // 'value' attribute on TextCell (id=subQuestionText_Cell) at QuestionRowSet.StringTextArea.pcf: line 42, column 37
  ...
  public static class QuestionRowSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextAreaCell (id=questionStringAnswer_Cell) at QuestionRowSet.StringTextArea.pcf: line 27, column 75
    function defaultSetter_7 (__VALUE_TO_SET :  java.lang.Object) : void {
      AnswerSetContainer.getOrCreateAnswer(Question).TextAnswer = (__VALUE_TO_SET as java.lang.String)
    }
    
    // 'editable' attribute on TextAreaCell (id=questionStringAnswer_Cell) at QuestionRowSet.StringTextArea.pcf: line 27, column 75
    function editable_3 () : java.lang.Boolean {
      return !Question.isRetired()
    }
    
    // 'validationLabel' attribute on TextAreaCell (id=questionStringAnswer_Cell) at QuestionRowSet.StringTextArea.pcf: line 27, column 75
    function label_4 () : java.lang.Object {
      return Question.Text
    }
    
    // 'required' attribute on TextAreaCell (id=questionStringAnswer_Cell) at QuestionRowSet.StringTextArea.pcf: line 27, column 75
    function required_5 () : java.lang.Boolean {
      return Question.Required
    }
    
    // 'value' attribute on TextCell (id=questionText_Cell) at QuestionRowSet.StringTextArea.pcf: line 19, column 22
    ...
    // 'value' attribute on RowIterator at QuestionRowSet.StringTextArea.pcf: line 36, column 40
