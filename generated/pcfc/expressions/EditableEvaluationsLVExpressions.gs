...
@javax.annotation.processing.Generated("config/web/pcf/claim/planofaction/EditableEvaluationsLV.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class EditableEvaluationsLVExpressions {
  ...
  public static class EditableEvaluationsLVExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at EditableEvaluationsLV.pcf: line 32, column 36
    function sortValue_0 (Evaluation :  entity.Evaluation) : java.lang.Object {
      return Evaluation.Name
    }
    
    // 'value' attribute on DateCell (id=CreateTime_Cell) at EditableEvaluationsLV.pcf: line 38, column 42
    function sortValue_1 (Evaluation :  entity.Evaluation) : java.lang.Object {
      return Evaluation.CreateTime
    }
    
    // 'value' attribute on CurrencyCell (id=Amount_Cell) at EditableEvaluationsLV.pcf: line 42, column 38
