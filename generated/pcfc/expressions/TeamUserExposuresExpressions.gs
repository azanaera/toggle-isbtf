...
@javax.annotation.processing.Generated("config/web/pcf/team/user/TeamUserExposures.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class TeamUserExposuresExpressions {
  ...
  public static class TeamUserExposuresExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'action' attribute on ToolbarButton (id=TeamUserExposures_Print) at TeamUserExposures.pcf: line 48, column 25
    function action_5 () : void {
      gw.api.print.ListViewPrintOptionPopupAction.printListViewWithOptions(PrintTargetLV)
    }
    
    // 'allCheckedRowsAction' attribute on CheckedValuesToolbarButton (id=TeamUserExposures_Assign) at TeamUserExposures.pcf: line 41, column 25
    ...
    // 'available' attribute on ToolbarButton (id=TeamUserExposures_Print) at TeamUserExposures.pcf: line 48, column 25
    ...
    // 'def' attribute on PanelRef at TeamUserExposures.pcf: line 51, column 65
    ...
    // 'title' attribute on TitleBar at TeamUserExposures.pcf: line 33, column 92
