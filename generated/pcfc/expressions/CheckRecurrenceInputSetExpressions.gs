...
@javax.annotation.processing.Generated("config/web/pcf/claim/newtransaction/check/CheckRecurrenceInputSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class CheckRecurrenceInputSetExpressions {
  ...
  public static class CheckRecurrenceInputSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on RangeInput (id=RecurrenceType_Input) at CheckRecurrenceInputSet.pcf: line 23, column 42
    function defaultSetter_4 (__VALUE_TO_SET :  java.lang.Object) : void {
      recurrenceHelper.RecurrenceType = (__VALUE_TO_SET as gw.financials.CheckRecurrenceType)
    }
    
    // 'editable' attribute on RangeInput (id=RecurrenceType_Input) at CheckRecurrenceInputSet.pcf: line 23, column 42
    ...
    // 'valueRange' attribute on RangeInput (id=RecurrenceType_Input) at CheckRecurrenceInputSet.pcf: line 23, column 42
    ...
    // 'valueRange' attribute on RangeInput (id=RecurrenceType_Input) at CheckRecurrenceInputSet.pcf: line 23, column 42
    function verifyValueRangeIsAllowedType_7 ($$arg :  gw.financials.CheckRecurrenceType[]) : void {
    ...
    // 'visible' attribute on RangeInput (id=RecurrenceType_Input) at CheckRecurrenceInputSet.pcf: line 23, column 42
