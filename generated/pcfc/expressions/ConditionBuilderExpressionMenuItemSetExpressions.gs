...
@javax.annotation.processing.Generated("config/web/pcf/bizrules/ConditionBuilderExpressionMenuItemSet.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ConditionBuilderExpressionMenuItemSetExpressions {
  ...
  public static class ConditionBuilderExpressionMenuItemSetExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on MenuItemIterator at ConditionBuilderExpressionMenuItemSet.pcf: line 18, column 172
    function value_5 () : gw.bizrules.pcf.ExpressionInputMode[] {
      return gw.bizrules.pcf.ExpressionInputMode.values()
    }
    
    // 'visible' attribute on MenuItemIterator at ConditionBuilderExpressionMenuItemSet.pcf: line 18, column 172
    function visible_0 () : java.lang.Boolean {
      return CurrentLocation.InEditMode and lineHolder.SwitchableLineExpressionModes.size() > 1 and not (fragHolder.getFragment() typeis ContainsExpressionFragment)
    }
  ...
  public static class IteratorEntryExpressionsImpl extends ConditionBuilderExpressionMenuItemSetExpressionsImpl {
    ...
    // 'action' attribute on MenuItem (id=modeItem) at ConditionBuilderExpressionMenuItemSet.pcf: line 25, column 76
    function action_2 () : void {
      lineHolder.updateModeForFragment(fragHolder, mode)
    }
    
    // 'icon' attribute on MenuItem (id=modeItem) at ConditionBuilderExpressionMenuItemSet.pcf: line 25, column 76
    function icon_4 () : java.lang.String {
      return fragHolder.getIconForCurrentlySelectedMenuItem(mode)
    }
    
    // 'label' attribute on MenuItem (id=modeItem) at ConditionBuilderExpressionMenuItemSet.pcf: line 25, column 76
    function label_3 () : java.lang.Object {
      return fragHolder.getMenuItemDisplayForMode(mode)
    }
    
    // 'visible' attribute on MenuItem (id=modeItem) at ConditionBuilderExpressionMenuItemSet.pcf: line 25, column 76
