...
@javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotDocumentsScreen.800.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
class ClaimSnapshotDocumentsScreen_800Expressions {
  @javax.annotation.processing.Generated("config/web/pcf/claim/snapshot/800/ClaimSnapshotDocumentsScreen.800.pcf", "", "com.guidewire.pcfgen.PCFClassGenerator")
  public static class ClaimSnapshotDocumentsScreenExpressionsImpl extends gw.api.web.ScopeBaseClass {
    ...
    // 'value' attribute on TextCell (id=Name_Cell) at ClaimSnapshotDocumentsScreen.800.pcf: line 27, column 42
    function sortValue_0 (Document :  dynamic.Dynamic) : java.lang.Object {
      return Document.Name
    }
    
    // 'value' attribute on TextCell (id=Type_Cell) at ClaimSnapshotDocumentsScreen.800.pcf: line 32, column 42
    function sortValue_1 (Document :  dynamic.Dynamic) : java.lang.Object {
      return Document.Type
    }
    
    // 'value' attribute on TextCell (id=Status_Cell) at ClaimSnapshotDocumentsScreen.800.pcf: line 37, column 42
    function sortValue_2 (Document :  dynamic.Dynamic) : java.lang.Object {
      return Document.Status
    }
    
    // 'value' attribute on TextCell (id=Author_Cell) at ClaimSnapshotDocumentsScreen.800.pcf: line 42, column 42
    function sortValue_3 (Document :  dynamic.Dynamic) : java.lang.Object {
      return Document.Author
    }
    
    // 'value' attribute on TextCell (id=DateModified_Cell) at ClaimSnapshotDocumentsScreen.800.pcf: line 46, column 71
    function sortValue_4 (Document :  dynamic.Dynamic) : java.lang.Object {
      return util.Snapshot.renderValue(Document.DateModified)
    }
    
    // 'value' attribute on RowIterator at ClaimSnapshotDocumentsScreen.800.pcf: line 21, column 37
