...
public class ManagedS3InboundConfigPlugin extends AbstractConfigFileLoadingPlugin<InboundFileConfig, ManagedS3InboundConfiguration> implements IManagedS3InboundConfig {
  ...
  protected function init() : void {
    ...
    loader = new ConfigFileLoader<InboundFileConfig, ManagedS3InboundConfiguration>(context)
