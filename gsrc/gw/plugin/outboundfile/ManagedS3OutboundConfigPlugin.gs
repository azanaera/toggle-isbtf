...
public class ManagedS3OutboundConfigPlugin extends AbstractConfigFileLoadingPlugin<OutboundFileConfig, ManagedS3OutboundConfiguration> implements IManagedS3OutboundConfig {
  ...
  protected function init() : void {
    ...
    loader = new ConfigFileLoader<OutboundFileConfig, ManagedS3OutboundConfiguration>(context)
