...
uses gw.api.databuilder.GeneralLiabilityRUBuilder
uses gw.api.databuilder.LocationMiscRUBuilder
...
uses gw.api.databuilder.PropertyCoverageBuilder
uses gw.api.databuilder.PropertyItemBuilder
uses gw.api.databuilder.PropertyRUBuilder
...
class PolicySearchPolicyGenerator {
  ...
  private function hasDemoAccounts(): boolean {
    var accounts = gw.api.database.Query.make(Account).select()
    // PublicID property is of database type "publicid", so we can't use string filters like .startsWith().
    // Results must be materialized first, matching taking place in-memory.
    return accounts.hasMatch(\el -> el.PublicID.startsWith("demo_account"))
  }
  ...
  function generatePolicies(): Policy[] {
          ...
          policies.add(new gw.api.databuilder.PolicyBuilder()
              ...
              .withRiskUnit(new gw.api.databuilder.VehicleRUBuilder()
                  ...
                  .withVehicle(new gw.api.databuilder.VehicleBuilder()
                      ...
                      .withVehicleStatus_Ext(PolicyStatus.TC_INFORCE))
                  ...
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_SAF_GLA_WAI_OF_DED_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_MED_COV_PA_EXT)
                  ...
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_TOW_AND_ROA_SER_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_NEW_CAR_REP_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_PRO_DAM_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_ORI_EQU_MAN_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_UNI_MOT_PD_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_UNI_MOT_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_UND_MOT_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_UM_UIMB_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_SD_HUS_BUS_INC_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_SD_HUS_BUS_PRP_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_TMP_RID_COV_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_PET_PAS_COV_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_GAP_COV_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_PER_INJ_PRO_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_PRI_PIP_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_INC_CON_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_ESS_SER_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_FUN_EXP_BEN_PA_EXT)
                      .withExposureLimit(15000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      .withIncidentLimit(30000bd.ofDefaultCurrency())
                      .withType(TC_PIP_EXT)
    ...
    runChunk(\->
        {
          ...
          policies.add(new gw.api.databuilder.PolicyBuilder()
              ...
              .withCoverage(new PolicyCoverageBuilder()
                  .withType(CoverageType.TC_CPBLDGCOV)
    ...
    runChunk(\->
        {
          contactMap.put("demo_sample:5071", new gw.api.databuilder.CompanyBuilder()
              .withPrimaryPhone(TC_WORK)
              .withPrimaryAddress(new gw.api.databuilder.AddressBuilder()
                  .withAddressLine1("52 Dove Ct.")
                  .withCountry(TC_US)
                  ...
                  .withCity("Riverside"))
              .withWorkPhone("309-384-3636")
              .withName("Cross Country Trucking")
              .create(bundle))

          contactMap.put("demo_sample:10342", new gw.api.databuilder.PersonBuilder()
              .withLastName("Good")
              .withFirstName("Buddy")
              .withPrimaryPhone(TC_WORK)
              .withPrimaryAddress(new gw.api.databuilder.AddressBuilder()
                  .withAddressLine1("255 Carolina St.")
                  .withCountry(TC_US)
                  .withPostalCode("60606")
                  .withState(State.TC_IL)
                  .withAddressType(TC_BUSINESS)
          ...
          policies.add(new gw.api.databuilder.PolicyBuilder()
              ...
              .withEffectiveDate(_baseDate.addDays(-90))
              .withStatus(TC_INFORCE)
              .withPolicyNumber("23-502017")
              .withTotalProperties(1)
              .withPolicyType(TC_INLANDMARINE)
              .withTotalVehicles(0)
              .withPolicyAccount(_accountMap.get("demo_account:8000"))
              .withContactInRole(contactMap.get("demo_sample:5071"), TC_INSURED)
              .withContactInRole(contactMap.get("demo_sample:10179"), ContactRole.TC_COVEREDPARTY)
              .create(bundle))
    ...
    runChunk(\->
        {
          ...
          contactMap.put("demo_sample:2027", new gw.api.databuilder.CompanyBuilder()
              ...
              .withName("Citi Mortgage")
              .create(bundle))
          //Fix for CLM-35713 - Ken Darion sample policy is missing Address, City, State, and Zip Code
          //Added "demo_sample:52014" to addressMap
          addressMap.put("demo_sample:52014", new gw.api.databuilder.AddressBuilder()
              .withAddressLine1("425 Madison St.")
              .withCountry(TC_US)
              .withPostalCode("60606")
              .withState(State.TC_IL)
    ...
    runChunk(\->
        {
          addressMap.put("demo_sample:52015", new gw.api.databuilder.AddressBuilder()
              .withAddressLine1("500 Madison St.")
              .withCountry(TC_US)
              .withPostalCode("60606")
              .withState(State.TC_IL)
              .withAddressType(TC_BUSINESS)
          ...
          contactMap.put("demo_sample:510197", new gw.api.databuilder.PersonBuilder()
              .withLastName("Egertson")
              .withFirstName("Karen")
              .withPrimaryPhone(TC_WORK)
              .withPrimaryAddress(new gw.api.databuilder.AddressBuilder()
          ...
          contactMap.put("demo_sample:510196", new gw.api.databuilder.PersonBuilder()
              .withLastName("Darion")
              .withFirstName("Ken")
              .withPrimaryPhone(TC_WORK)
              .withPrimaryAddress(addressMap.get("demo_sample:52014"))
              .withWorkPhone("626-473-9576")
              .create(bundle))

          contactMap.put("demo_sample:52035", new gw.api.databuilder.CompanyBuilder()
              .withPrimaryPhone(TC_WORK)
              .withPrimaryAddress(new gw.api.databuilder.AddressBuilder()
                  .withAddressLine1("55 California St")
                  .withCountry(TC_US)
          ...
          contactMap.put("demo_sample:52036", new gw.api.databuilder.CompanyBuilder()
              .withPrimaryPhone(TC_WORK)
              .withPrimaryAddress(new gw.api.databuilder.AddressBuilder()
                  .withAddressLine1("2000 Park Avenue")
                  .withCountry(TC_US)
          ...
          policies.add(new gw.api.databuilder.PolicyBuilder()
              ...
              .withTotalVehicles(0)
              .withCoverage(new PolicyCoverageBuilder()
                  .withType(CoverageType.TC_HOPCOVE)
                  .withIncidentLimit(30000bd.ofDefaultCurrency())
                  .withExposureLimit(20000bd.ofDefaultCurrency()))
              .withCoverage(new PolicyCoverageBuilder()
                  .withType(CoverageType.TC_HOPCOVD)
                  .withIncidentLimit(40000bd.ofDefaultCurrency())
                  .withExposureLimit(30000bd.ofDefaultCurrency()))
              .withRiskUnit(new gw.api.databuilder.PropertyRUBuilder()
                  .withRUNumber(1)
                  .withPolicyLocation(new gw.api.databuilder.PolicyLocationBuilder()
                      .withAddress(addressMap.get("demo_sample:52015"))
                      .withLienholder(new gw.api.databuilder.PropertyOwnerBuilder()
                          .withLienholder(contactMap.get("demo_sample:52035"))
                          .withOwnerType(TC_PARTIAL_OWNER))
                      .withLienholder(new gw.api.databuilder.PropertyOwnerBuilder()
                          .withLienholder(contactMap.get("demo_sample:52036"))
                          .withOwnerType(TC_PARTIAL_OWNER))
                  ...
                  .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                      .withType(CoverageType.TC_HOPCOVA)
                      .withIncidentLimit(750000bd.ofDefaultCurrency())
                      .withExposureLimit(500000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                      .withType(CoverageType.TC_HOPCOVB)
                      .withIncidentLimit(100000bd.ofDefaultCurrency())
                      .withExposureLimit(75000bd.ofDefaultCurrency()))
                  .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                      .withType(CoverageType.TC_HOPCOVC)
                  ...
                  .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                      .withType(CoverageType.TC_HOPCOVF)
              ...
              .withContactInRole(contactMap.get("demo_sample:510197"), TC_AGENT)
              .withContactInRole(contactMap.get("demo_sample:510196"), TC_INSURED)
              .create(bundle))
        })
...
//        .create(bundle)
          ...
          policies.add(new gw.api.databuilder.PolicyBuilder()
              ...
              .withRiskUnit(new gw.api.databuilder.VehicleRUBuilder()
                  ...
                  .withCoverage(new gw.api.databuilder.VehicleCoverageBuilder()
                      ...
                      .withCovTerm(new FinancialCovTermBuilder()
                          .withCovTermPattern(CovTermPattern.TC_BACOLLISIONDEDUCT)
    ...
    { // these two policies are identical except except for their currencies, public ids, and policy numbers
      runChunk(\->
          {
            addressMap.put("demo_sample:1027", new gw.api.databuilder.AddressBuilder()
                .withAddressLine1("215 Maple Ave.")
                .withCountry(TC_US)
                .withPostalCode("01079")
                .withState(State.TC_MA)
            ...
            policies.add(new gw.api.databuilder.PolicyBuilder()
                ...
                .withRiskUnit(new gw.api.databuilder.PropertyRUBuilder()
                    .withRUNumber(1)
                    .withPolicyLocation(new gw.api.databuilder.PolicyLocationBuilder()
                        .withAddress(addressMap.get("demo_sample:1027")))
                    .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
                        .withIncidentLimit(500000bd.ofDefaultCurrency())
      ...
      runChunk(\->
          {
            addressMap.put("demo_sample:10270", new gw.api.databuilder.AddressBuilder()
                .withAddressLine1("215 Maple Ave.")
                .withCountry(TC_US)
                .withPostalCode("01079")
                .withState(State.TC_MA)
            ...
            policies.add(new gw.api.databuilder.PolicyBuilder()
                ...
                .withRiskUnit(new gw.api.databuilder.PropertyRUBuilder()
                    .withRUNumber(1)
                    .withPolicyLocation(new gw.api.databuilder.PolicyLocationBuilder()
                        .withAddress(addressMap.get("demo_sample:10270")))
                    .withCoverage(new gw.api.databuilder.PropertyCoverageBuilder()
    ...
    runChunk(\->
        {
          addressMap.put("demo_sample:2015", new AddressBuilder()
              .withAddressLine1("1010 S. Main St.")
          ...
          addressMap.put("demo_sample:2016", new AddressBuilder()
              .withAddressLine1("1020 S. Main St.")
              .withCountry(TC_US)
              .withPostalCode("61761")
              .withState(State.TC_IL)
              .withAddressType(TC_BUSINESS)
          ...
          contactMap.put("demo_sample:4014", new CompanyBuilder()
              .withPrimaryPhone(TC_WORK)
              .withWorkPhone("309-223-7783")
              .withName("Johnston Financial Advisors")
              .withPrimaryAddress(addressMap.get("demo_sample:2015"))
              .create(bundle))

          contactMap.put("demo_sample:4015", new PersonBuilder()
              .withPrimaryPhone(TC_WORK)
              .withWorkPhone("309-223-7783")
              .withFirstName("Tim")
              .withLastName("Johnston")
          ...
          contactMap.put("demo_sample:10181", new CompanyBuilder()
              .withName("Armstrong and Sons")
              .withPrimaryPhone(TC_WORK)
              .withWorkPhone("317-333-5900")
              .withFaxPhone("317-333-5901")
              .withEmailAddress1("contact@armstrong.com")
              .withPrimaryAddress(new AddressBuilder()
                  .withAddressLine1("610 Fifth Avenue")
                  .withCity("Indianapolis")
                  .withState(State.TC_IN)
                  .withCountry(TC_US)
                  .withPostalCode("46201")
                  .withAddressType(TC_BUSINESS))
              .create(bundle))

          var policyLoc = new PolicyLocationBuilder()
              .withAddress(addressMap.get("demo_sample:2015"))
              .withLocationNumber("1")
              .create(bundle)

          policies.add(new PolicyBuilder()
              .withExpirationDate(_baseDate.addDays(365))
              .withUnderwritingCo(TC_PARENT)
              .withVerified(true)
              .withOrigEffectiveDate(_baseDate.addDays(-712))
              .withCurrency(CurrencyUtil.getDefaultCurrency())
              .withUnderwritingGroup(TC_ACME_PROP)
              .withEffectiveDate(_baseDate.addDays(-90))
              .withStatus(TC_INFORCE)
              .withPolicyNumber("25-300001")
              .withTotalProperties(2)
              .withPolicyType(TC_COMMERCIALPACKAGE)
              .withTotalVehicles(0)
              .withRiskUnit(new PropertyRUBuilder()
                  .withRUNumber(1)
                  .withPolicyLocation(policyLoc)
                  .withCoverage(new PropertyCoverageBuilder()
                      .withCurrency(CurrencyUtil.DefaultCurrency)
                      .withType(CoverageType.TC_CPBLDGCOV)
                      .withIncidentLimit(1000000bd.ofDefaultCurrency())
                      .withCovTerm(new FinancialCovTermBuilder()
                          .withCovTermPattern(CovTermPattern.TC_CPBLDGCOVDEDUCTIBLE)
                          .withFinancialAmount(2500bd))
                      .withCovTerm(new FinancialCovTermBuilder()
                          .withCovTermPattern(CovTermPattern.TC_CPBLDGCOVLIMIT)
                          .withFinancialAmount(1000000bd)))
                  .withCoverage(new PropertyCoverageBuilder()
                      .withCurrency(CurrencyUtil.DefaultCurrency)
                      .withType(CoverageType.TC_CPBPPCOV)
                      .withIncidentLimit(500000bd.ofDefaultCurrency())
                      .withCovTerm(new FinancialCovTermBuilder()
                          .withCovTermPattern(CovTermPattern.TC_CPBPPCOVDEDUCTIBLE)
                          .withFinancialAmount(2500bd))
                      .withCovTerm(new FinancialCovTermBuilder()
                          .withCovTermPattern(CovTermPattern.TC_CPBPPCOVLIMIT)
                          .withFinancialAmount(500000bd))))
              .withRiskUnit(new GeneralLiabilityRUBuilder()
                  .withRUNumber(2)
                  .withPolicyLocation(policyLoc)
                  .withDescription("Air Conditioning Equipment - dealers or distributors only"))
              .withRiskUnit(new LocationMiscRUBuilder()
                  .withRUNumber(3)
                  .withPolicyLocation(new PolicyLocationBuilder()
                      .withAddress(addressMap.get("demo_sample:2016"))
                      .withLocationNumber("2"))
                  .withCoverage(new PropertyCoverageBuilder()
                      .withCurrency(CurrencyUtil.DefaultCurrency)
                      .withType(TC_IMSIGNCOV)
                      .withIncidentLimit(150000bd.ofDefaultCurrency())
                      .withCovTerm(new FinancialCovTermBuilder()
                          .withCovTermPattern(CovTermPattern.TC_IMSIGNDEDUCTIBLE)
                          .withFinancialAmount(25000bd))))
              .withCoverage(new PolicyCoverageBuilder()
                  .withCurrency(CurrencyUtil.DefaultCurrency)
                  .withType(CoverageType.TC_GLCGLCOV)
                  .withExposureLimit(5000bd.ofDefaultCurrency())
                  .withIncidentLimit(100000bd.ofDefaultCurrency())
                  .withCovTerm(new FinancialCovTermBuilder()
                      .withCovTermPattern(TC_GLCGLOCCLIMIT)
                      .withFinancialAmount(100000bd))
                  .withCovTerm(new FinancialCovTermBuilder()
                      .withCovTermPattern(CovTermPattern.TC_GLCGLMEDPAYLIMIT)
                      .withFinancialAmount(5000bd))
                  .withCovTerm(new FinancialCovTermBuilder()
                      .withCovTermPattern(CovTermPattern.TC_GLCGLPERSADLIMIT)
                      .withFinancialAmount(100000bd))
                  .withCovTerm(new FinancialCovTermBuilder()
                      .withCovTermPattern(CovTermPattern.TC_GLCGLRENTEDPROPLIMIT)
                      .withFinancialAmount(100000bd))
                  .withCovTerm(new FinancialCovTermBuilder()
                      .withCovTermPattern(CovTermPattern.TC_GLCGLAGGLIMIT)
                      .withFinancialAmount(100000bd))
                  .withCovTerm(new FinancialCovTermBuilder()
                      .withCovTermPattern(CovTermPattern.TC_CGLPRODUCTSAGGLIM)
                      .withFinancialAmount(100000bd))
              )
              .withEndorsement(new gw.api.databuilder.EndorsementBuilder()
              ...
              .withPolicyAccount(_accountMap.get("demo_account:8001"))
              .withContactInRole(contactMap.get("demo_sample:4014"), TC_INSURED)
              .withContactInRole(contactMap.get("demo_sample:10181"), TC_AGENT)
              .withContactInRole(contactMap.get("demo_sample:4015"), TC_COVEREDPARTY)
              .create(bundle))
        })
