...
uses gw.webservice.cc.cc5000.vendormanagement.ContactDetail
uses gw.webservice.cc.cc5000.vendormanagement.ContactSummary
uses gw.webservice.cc.cc5000.vendormanagement.DocumentSummary
uses gw.webservice.cc.cc5000.vendormanagement.ServiceRequestSummary
uses gw.webservice.cc.cc5000.vendormanagement.Statement
 ...
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc5000/vendormanagement/ServiceRequestDetails")
final class ServiceRequestDetails {
   ...
   */
  var _quote : gw.webservice.cc.cc5000.vendormanagement.Statement as Quote

  /**
   * A list of all invoices related to this service request.
   */
  var _invoices : List<gw.webservice.cc.cc5000.vendormanagement.Statement> as Invoices
   ...
   */
  var _documents : List<gw.webservice.cc.cc5000.vendormanagement.DocumentSummary> as Documents
  ...
  */
  var _customerContactDetail : gw.webservice.cc.cc5000.vendormanagement.ContactDetail as CustomerContactDetail

  /**
   * The details of the Adjuster
  */
  var _adjusterDetail : gw.webservice.cc.cc5000.vendormanagement.ContactDetail as AdjusterDetail
   ...
   * service request
   */
  var _messages : List<gw.webservice.cc.cc5000.vendormanagement.Message> as Messages
  ...
  construct(serviceRequest : ServiceRequest) {
    ...
    if (serviceRequest.LatestQuote != null) {
      Quote = new gw.webservice.cc.cc5000.vendormanagement.Statement(serviceRequest.LatestQuote, documentCache)
    }
    ...
    while (orderedHistoryIterator.hasPrevious()) {
      ...
      if (change.Progress_Chg) {
        if (ServiceRequest.TerminalProgressValues.contains(change.New_Progress)) {
    ...
    CustomerContactDetail = new gw.webservice.cc.cc5000.vendormanagement.ContactDetail(serviceRequest.Instruction.CustomerContact)
    AdjusterDetail = new ContactDetail(serviceRequest.AssignedUser.Contact)
    Messages = serviceRequest.Messages.sortByDescending(\ message -> message.SendDate ).map(\ message -> new gw.webservice.cc.cc5000.vendormanagement.Message(message)).toList()
