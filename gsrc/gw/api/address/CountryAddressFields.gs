...
class CountryAddressFields {
  ...
  function getClaimFileHiddenFields(claim : Claim) : Set<AddressOwnerFieldId> {
    ...
    return LOBAbstraction.ForClaim.ForLossType.isWorkComp(claim) ? CCAddressOwnerFieldId.WC_HIDDEN_FIELDS : CCAddressOwnerFieldId.VALIDUNTIL_ADDRESSTYPE_HIDDEN
  }
