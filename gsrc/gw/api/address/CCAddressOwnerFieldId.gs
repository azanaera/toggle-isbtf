...
class CCAddressOwnerFieldId extends AddressOwnerFieldId {
  ...
  /** Added for Toggle - just state required */
  public static final var STATE_REQUIRED_Ext : Set<AddressOwnerFieldId>
      = normalizeRequiredFields(new HashSet<AddressOwnerFieldId>() {STATE}.freeze())
