  ...
  *************************************************************************************/
  ...
  function isViewDocumentContentAvailable(document: Document) : boolean {
    return DocumentContentActionsAvailable and document != null and perm.Document.view(document) and document.DMS and
        document.ContentExist and document.PendingDocUID == null
        // Removing the mimetype check as the document is previewed outside claimcenter - in Box (for videos)
        //and document.DocumentMimeTypeAllowed
  }
