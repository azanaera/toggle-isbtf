  ...
  override property get Mappings() : Set<CCPropertyMapping> {
    return new HashSet<CCPropertyMapping>() {
      ...
      fieldMapping(Contact#WorkPhoneExtension),
        fieldMapping(Contact#AltPhone_Ext),
        fieldMapping(Contact#AltPhoneCountry_Ext),
        fieldMapping(Contact#AltPhoneExtension_Ext),

        fieldMapping(Contact#Levy_Ext),
        fieldMapping(Contact#BLOCode_Ext),
        fieldMapping(Contact#VendorAvailability_Ext)
            .withABName("VendorAvailability"),
        fieldMapping(Contact#DoingBusinessAs_Ext),
        fieldMapping(Contact#Backupwithholding_Ext),


        //VendorCompany

        fieldMapping(CompanyVendor#ShopLocationCode_Ext),
